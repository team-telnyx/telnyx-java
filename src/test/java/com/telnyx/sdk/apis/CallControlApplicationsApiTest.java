...
public class CallControlApplicationsApiTest {
    ...
    public void createCallControlApplicationTest() throws ApiException {
        CreateCallControlApplicationRequest body = null;
        CallControlApplicationResponse response = api.createCallControlApplication(body);
    ...
    public void updateCallControlApplicationTest() throws ApiException {
        UpdateCallControlApplicationRequest body = null;
        String id = null;
        CallControlApplicationResponse response = api.updateCallControlApplication(body, id);
