...
public class IpConnectionsApiTest {
    ...
    @Ignore
    @Test
    public void createIpConnection_defaultParams_returnsCreatedIpConnection()
        throws ApiException {
        //given
        CreateIpConnectionRequest createIpConnectionRequest =
            prepareSampleCreateIpConnectionRequest();

        //when
        IpConnectionResponse response = api.createIpConnection(
    ...
    @Test
    @Ignore
    public void deleteIpConnection_ipConnectionIdProvided_ipConnectionWouldNotReturnAnymore()
        throws ApiException {
        //given
        String id = api
        ...
        IpConnectionResponse retrievedIpConnection = api.retrieveIpConnection(
            id
        );
    ...
    @Test
    @Ignore
    public void listIpConnections_defaultParams_returnsNotNullListOfIpConnections()
        throws ApiException {
        //given
        ...
        //when
        ListIpConnectionsResponse response = api
            .listIpConnections()
    ...
    @Ignore
    @Test
    public void retrieveIpConnection_ipConnectionIdProvided_returnsIpConnection()
        throws ApiException {
        //given
        String id = api
            .createIpConnection(prepareSampleCreateIpConnectionRequest())
    ...
    @Ignore
    @Test
    public void updateIpConnection_changedParams_returnsUpdatedIpConnection()
        throws ApiException {
        //given
        String id = api
            .createIpConnection(prepareSampleCreateIpConnectionRequest())
        ...
        UpdateIpConnectionRequest updateIpConnectionRequest =
            prepareSampleUpdateIpConnectionRequest();

        //when
        IpConnectionResponse response = api.updateIpConnection(
            id,
        ...
        assertNotNull(response);
        assertEquals(
            updateIpConnectionRequest.getConnectionName(),
            response.getData().getConnectionName()
        );
        assertEquals(
            updateIpConnectionRequest.getAnchorsiteOverride(),
            response.getData().getAnchorsiteOverride()
        );
        assertEquals(
            updateIpConnectionRequest.getOutbound().getAniOverride(),
            response.getData().getOutbound().getAniOverride()
        );
        assertEquals(
            updateIpConnectionRequest.getOutbound().getIpAuthenticationToken(),
            response.getData().getOutbound().getIpAuthenticationToken()
        );
        assertEquals(
            updateIpConnectionRequest.getOutbound().getLocalization(),
            response.getData().getOutbound().getLocalization()
        );
        assertEquals(
            updateIpConnectionRequest.getOutbound().getTechPrefix(),
            response.getData().getOutbound().getTechPrefix()
        );
    }
    ...
    private UpdateIpConnectionRequest prepareSampleUpdateIpConnectionRequest() {
        return new UpdateIpConnectionRequest()
            ...
            .transportProtocol(
                UpdateIpConnectionRequest.TransportProtocolEnum.UDP
            )
