...
public class MessagesApiTest {
    ...
    @Ignore
    @Test
    public void createLongCodeMessage_whenRequestIsValid_sendsMessage()
        throws ApiException {
        CreateLongCodeMessageRequest createLongCodeMessageRequest =
            new CreateLongCodeMessageRequest()
        ...
        MessageResponse actualResponse = api.createLongCodeMessage(
    ...
    @Ignore
    @Test
    public void createMessage_whenRequestIsValid_sendsMessage()
        throws ApiException {
    ...
    @Ignore
    @Test
    public void createNumberPoolMessage_whenRequestIsValid_sendsMessage()
        throws ApiException {
        CreateNumberPoolMessageRequest createNumberPoolMessageRequest =
            new CreateNumberPoolMessageRequest()
                .messagingProfileId(
                    TestConfiguration.EXISTING_MESSAGING_PROFILE_ID
                )
                .to(TestConfiguration.TEST_TO_NUMBER)
        ...
        MessageResponse actualResponse = api.createNumberPoolMessage(
    ...
    @Ignore
    @Test
    public void createShortCodeMessage_whenRequestIsValid_sendsMessage()
        throws ApiException {
    ...
    @Ignore
    @Test
    public void webhook_whenOutboundMessageSent_receivesMessageSentEvent()
        throws IOException {
        InputStream sentEventFixtureJson = getClass()
            .getClassLoader()
            .getResourceAsStream("webhook-message-sent-event.json");

        OutboundMessageEvent actualOutboundMessageEvent = mapper.readValue(
            sentEventFixtureJson,
    ...
    @Ignore
    @Test
    public void webhook_whenOutboundMessageFinalized_receivesMessageFinalizedEvent()
        throws IOException {
        InputStream finalizedEventFixtureJson = getClass()
            .getClassLoader()
            .getResourceAsStream("webhook-message-finalized-event.json");

        OutboundMessageEvent actualOutboundMessageEvent = mapper.readValue(
            finalizedEventFixtureJson,
            OutboundMessageEvent.class
        );
