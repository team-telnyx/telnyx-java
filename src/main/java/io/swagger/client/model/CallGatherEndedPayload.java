...
public class CallGatherEndedPayload {
  ...
  public CallGatherEndedPayload callControlId(UUID callControlId) {
  ...
  **/
   ...
   * @return digits
  **/
  @Schema(example = "5503", description = "The received DTMF digit or symbol.")
   ...
   * @return status
  **/
  @Schema(example = "valid", description = "Reflects how command ended.")
