...
import io.swagger.client.model.CallPlaybackEndedPayload;
...
public class CallPlaybackEnded {
  ...
  private CallPlaybackEndedPayload payload = null;
  ...
  **/
   ...
   * @return eventType
  **/
  @Schema(example = "call.playback.ended", description = "The type of event being delivered.")
