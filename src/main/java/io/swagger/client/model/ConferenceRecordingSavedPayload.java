...
public class ConferenceRecordingSavedPayload {
   ...
   * @return conferenceId
  **/
  @Schema(example = "428c31b6-7af4-4bcb-b7f5-5013ef9657c1", description = "ID that is unique to the conference and can be used to correlate webhook events.")
  ...
  **/
   ...
   * @return recordingId
  **/
  @Schema(example = "11111111-1111-1111-1111-111111111112", description = "ID of the recording.")
