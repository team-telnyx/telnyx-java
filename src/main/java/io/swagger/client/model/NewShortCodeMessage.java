...
public class NewShortCodeMessage {
  @SerializedName("from")
  ...
  public NewShortCodeMessage from(String from) {
    this.from = from;
    return this;
  }
  ...
  **/
  ...
  public NewShortCodeMessage to(String to) {
    this.to = to;
    return this;
  }
   ...
   * @return to
  **/
  @Schema(required = true, description = "Receiving short code.")
  public String getTo() {
    return to;
  }
  ...
  public NewShortCodeMessage text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public NewShortCodeMessage subject(String subject) {
  ...
  **/
  ...
  public NewShortCodeMessage mediaUrls(List<String> mediaUrls) {
    this.mediaUrls = mediaUrls;
    return this;
  }

  public NewShortCodeMessage addMediaUrlsItem(String mediaUrlsItem) {
  ...
  **/
  ...
  public NewShortCodeMessage webhookUrl(String webhookUrl) {
  ...
  **/
  ...
  public NewShortCodeMessage webhookFailoverUrl(String webhookFailoverUrl) {
  ...
  **/
  ...
  public NewShortCodeMessage useProfileWebhooks(Boolean useProfileWebhooks) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NewShortCodeMessage newShortCodeMessage = (NewShortCodeMessage) o;
    return Objects.equals(this.from, newShortCodeMessage.from) &&
        Objects.equals(this.to, newShortCodeMessage.to) &&
        Objects.equals(this.text, newShortCodeMessage.text) &&
        Objects.equals(this.subject, newShortCodeMessage.subject) &&
        Objects.equals(this.mediaUrls, newShortCodeMessage.mediaUrls) &&
        Objects.equals(this.webhookUrl, newShortCodeMessage.webhookUrl) &&
        Objects.equals(this.webhookFailoverUrl, newShortCodeMessage.webhookFailoverUrl) &&
        Objects.equals(this.useProfileWebhooks, newShortCodeMessage.useProfileWebhooks);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewShortCodeMessage {\n");
