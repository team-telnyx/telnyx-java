...
import com.telnyx.sdk.model.CreateCommentPortingOrder201Response;
...
public class PortingOrdersApi {
   ...
   * @return CreateCommentPortingOrder201Response
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public CreateCommentPortingOrder201Response createCommentPortingOrder(UUID id, CreatePortingOrderComment createPortingOrderComment) throws ApiException {
    return createCommentPortingOrderWithHttpInfo(id, createPortingOrderComment).getData();
  }
   ...
   * @param id Porting Order id (required)
   * @param createPortingOrderComment  (required)
   * @return ApiResponse&lt;CreateCommentPortingOrder201Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<CreateCommentPortingOrder201Response> createCommentPortingOrderWithHttpInfo(UUID id, CreatePortingOrderComment createPortingOrderComment) throws ApiException {
    Object localVarPostBody = createPortingOrderComment;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling createCommentPortingOrder");
    }
    
    // verify the required parameter 'createPortingOrderComment' is set
    if (createPortingOrderComment == null) {
      throw new ApiException(400, "Missing the required parameter 'createPortingOrderComment' when calling createCommentPortingOrder");
    }
    ...
    GenericType<CreateCommentPortingOrder201Response> localVarReturnType = new GenericType<CreateCommentPortingOrder201Response>() {};

    return apiClient.invokeAPI("PortingOrdersApi.createCommentPortingOrder", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   * @param createPortingPhoneNumberBlockRequest  (required)
   ...
   * @param portingOrderId Identifies the Porting Order associated with the phone number block (required)
   * @param createPortingPhoneNumberBlockRequest  (required)
   * @return ApiResponse&lt;CreatePortingPhoneNumberBlock201Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   * @param createPortingPhoneNumberExtensionRequest  (required)
   ...
   * @param portingOrderId Identifies the Porting Order associated with the phone number extension (required)
   * @param createPortingPhoneNumberExtensionRequest  (required)
   * @return ApiResponse&lt;CreatePortingPhoneNumberExtension201Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   * @param portingOrderId Identifies the Porting Order associated with the phone number block (required)
   * @param id Identifies the phone number block to be deleted (required)
   * @return CreatePortingPhoneNumberBlock201Response
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   * @param portingOrderId Identifies the Porting Order associated with the phone number extension (required)
   * @param id Identifies the phone number extension to be deleted (required)
   * @return CreatePortingPhoneNumberExtension201Response
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
   ...
   * @param filterPortingOrderStatus Filter results by a specific porting order status (optional)
   * @param filterPortingOrderStatusIn Filter results by specific porting order statuses (optional)
   ...
   * @param pageNumber The page number to load (optional, default to 1)
   * @param pageSize The size of the page (optional, default to 20)
   * @param filterType Filter by event type. (optional)
   * @param filterPortingOrderId Filter by porting order ID. (optional)
   ...
   * @param filterCreatedAtGte Filter by created at greater than or equal to. (optional)
   * @param filterCreatedAtLte Filter by created at less than or equal to. (optional)
   * @return ApiResponse&lt;ListPortingEvents200Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   * @param pageNumber The page number to load (optional, default to 1)
   * @param pageSize The size of the page (optional, default to 20)
   * @return ApiResponse&lt;ListPortingPhoneNumberBlocks200Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   * @param filterPhoneNumber Filter results by phone number (optional)
   * @param filterPhoneNumberIn Filter results by a list of phone numbers (optional)
   * @param filterPortingPhoneNumberId Filter results by porting phone number id (optional)
   * @param filterPortingPhoneNumberIdIn Filter results by a list of porting phone number ids (optional)
   * @param sort Specifies the sort order for results. If not given, results are sorted by created_at in descending order (optional)
   * @param pageNumber The page number to load (optional, default to 1)
   * @param pageSize The size of the page (optional, default to 20)
   ...
   * @param pageNumber The page number to load (optional, default to 1)
   * @param pageSize The size of the page (optional, default to 20)
   * @return ApiResponse&lt;ListPortingPhoneNumberExtensions200Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   * Show a specific porting event.
   * @param id Identifies the porting event. (required)
   * @return ApiResponse&lt;ShowPortingEvent200Response&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
