...
public class DetailRecordsApi {
   ...
   */
    public DetailRecordsSearchResponse searchDetailRecords(
        ...
        return searchDetailRecordsWithHttpInfo(
            filterRecordType,
            filterDateRange,
            filter,
            pageNumber,
   ...
   */
    ...
    > searchDetailRecordsWithHttpInfo(
        String filterRecordType,
        String filterDateRange,
        Map<String, Object> filter,
        Integer pageNumber,
        ...
        if (filterRecordType == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'filterRecordType' when calling searchDetailRecords"
            );
        }
        ...
        GenericType<DetailRecordsSearchResponse> localVarReturnType =
            new GenericType<DetailRecordsSearchResponse>() {};

        return apiClient.invokeAPI(
            "DetailRecordsApi.searchDetailRecords",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
