...
public class WhatsAppContactsApi {
  ...
  public ApiResponse<CheckContactResponse> checkContactWithHttpInfo(CheckContactRequestBody checkContactRequestBody) throws ApiException {
    ...
    if (checkContactRequestBody == null) {
      throw new ApiException(400, "Missing the required parameter 'checkContactRequestBody' when calling checkContact");
    }
    ...
    GenericType<CheckContactResponse> localVarReturnType = new GenericType<CheckContactResponse>() {};

    return apiClient.invokeAPI("WhatsAppContactsApi.checkContact", localVarPath, "POST", localVarQueryParams, localVarPostBody,
