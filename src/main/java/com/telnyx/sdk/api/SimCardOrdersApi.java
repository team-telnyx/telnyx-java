...
public class SimCardOrdersApi {
   ...
   */
    public CreateSimCardOrder200Response createSimCardOrder(
   ...
   */
    ...
    > createSimCardOrderWithHttpInfo(SimCardOrderCreate simCardOrderCreate)
        throws ApiException {
        ...
        if (simCardOrderCreate == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'simCardOrderCreate' when calling createSimCardOrder"
            );
        }
        ...
        GenericType<CreateSimCardOrder200Response> localVarReturnType =
            new GenericType<CreateSimCardOrder200Response>() {};

        return apiClient.invokeAPI(
            "SimCardOrdersApi.createSimCardOrder",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateSimCardOrder200Response getSimCardOrder(UUID id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        CreateSimCardOrder200Response
    > getSimCardOrderWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getSimCardOrder"
            );
        }

        // create path and map variables
        String localVarPath =
            "/sim_card_orders/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "SimCardOrdersApi.getSimCardOrder",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GetSimCardOrders200Response getSimCardOrders(
        ...
        Integer filterQuantity,
        String filterCostAmount,
        String filterCostCurrency,
        String filterAddressId,
        String filterAddressStreetAddress,
        String filterAddressExtendedAddress,
        String filterAddressLocality,
        String filterAddressAdministrativeArea,
        String filterAddressCountryCode,
        String filterAddressPostalCode,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return getSimCardOrdersWithHttpInfo(
            filterCreatedAt,
            filterUpdatedAt,
            filterQuantity,
            filterCostAmount,
            filterCostCurrency,
            filterAddressId,
            filterAddressStreetAddress,
            filterAddressExtendedAddress,
            filterAddressLocality,
            filterAddressAdministrativeArea,
            filterAddressCountryCode,
   ...
   */
    ...
    > getSimCardOrdersWithHttpInfo(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[quantity]", filterQuantity)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "",
        ...
        GenericType<GetSimCardOrders200Response> localVarReturnType =
            new GenericType<GetSimCardOrders200Response>() {};

        return apiClient.invokeAPI(
            "SimCardOrdersApi.getSimCardOrders",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public PreviewSimCardOrders202Response previewSimCardOrders(
        PreviewSimCardOrdersRequest previewSimCardOrdersRequest
    ) throws ApiException {
        return previewSimCardOrdersWithHttpInfo(
   ...
   */
    ...
    > previewSimCardOrdersWithHttpInfo(
        PreviewSimCardOrdersRequest previewSimCardOrdersRequest
    ) throws ApiException {
        ...
        GenericType<PreviewSimCardOrders202Response> localVarReturnType =
            new GenericType<PreviewSimCardOrders202Response>() {};

        return apiClient.invokeAPI(
            "SimCardOrdersApi.previewSimCardOrders",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
