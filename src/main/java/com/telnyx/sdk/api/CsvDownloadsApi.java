...
public class CsvDownloadsApi {
   ...
   */
    public CSVDownloadResponse createCsvDownload() throws ApiException {
        return createCsvDownloadWithHttpInfo().getData();
    }
   ...
   */
    public ApiResponse<CSVDownloadResponse> createCsvDownloadWithHttpInfo()
        throws ApiException {
        ...
        GenericType<CSVDownloadResponse> localVarReturnType = new GenericType<
            CSVDownloadResponse
        >() {};

        return apiClient.invokeAPI(
            "CsvDownloadsApi.createCsvDownload",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<CSVDownloadResponse> getCsvDownloadWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getCsvDownload"
            );
        }

        // create path and map variables
        String localVarPath =
            "/phone_numbers/csv_downloads/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "CsvDownloadsApi.getCsvDownload",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    private ApiResponse<ListCSVDownloadsResponse> listCsvDownloadsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListCSVDownloadsResponse> localVarReturnType =
            new GenericType<ListCSVDownloadsResponse>() {};

        return apiClient.invokeAPI(
            "CsvDownloadsApi.listCsvDownloads",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        public ApiResponse<ListCSVDownloadsResponse> executeWithHttpInfo()
            throws ApiException {
   ...
   * List CSV downloads
   * 
   * @return listCsvDownloadsRequest
   * @throws ApiException if fails to make API call
