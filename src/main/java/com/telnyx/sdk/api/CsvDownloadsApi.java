...
private ApiResponse<ListCSVDownloadsResponse> listCsvDownloadsWithHttpInfo(Integer pageNumber, Integer pageSize) throws ApiException {
    ...
    GenericType<ListCSVDownloadsResponse> localVarReturnType = new GenericType<ListCSVDownloadsResponse>() {};

    return apiClient.invokeAPI("CsvDownloadsApi.listCsvDownloads", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
