...
public class WhatsAppMessagesApi {
   ...
   */
    public ApiResponse<Void> markMessageAsReadWithHttpInfo(
        String messageId,
        MarkMessageAsReadRequestBody markMessageAsReadRequestBody
    ) throws ApiException {
        ...
        if (messageId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'messageId' when calling markMessageAsRead"
            );
        }
        ...
        if (markMessageAsReadRequestBody == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'markMessageAsReadRequestBody' when calling markMessageAsRead"
            );
        }

        // create path and map variables
        String localVarPath =
            "/whatsapp_messages/{message_id}".replaceAll(
                    "\\{" + "message_id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "WhatsAppMessagesApi.markMessageAsRead",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public SuccessfulResponseWithDetailsAboutTheWhatsAppMessageSent sendMessage(
   ...
   */
    ...
    > sendMessageWithHttpInfo(
        ...
        if (createWhatsAppMessageRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createWhatsAppMessageRequest' when calling sendMessage"
            );
        }
        ...
        return apiClient.invokeAPI(
            "WhatsAppMessagesApi.sendMessage",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
