...
public class IpRangesApi {
   ...
   */
    public AccessIPRangeResponseSchema accessIpRangesAccessIpRangeIdDelete(
        String accessIpRangeId
    ) throws ApiException {
        return accessIpRangesAccessIpRangeIdDeleteWithHttpInfo(
            accessIpRangeId
        ).getData();
    }
   ...
   */
    ...
    > accessIpRangesAccessIpRangeIdDeleteWithHttpInfo(String accessIpRangeId)
        throws ApiException {
        ...
        if (accessIpRangeId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accessIpRangeId' when calling accessIpRangesAccessIpRangeIdDelete"
            );
        }

        // create path and map variables
        String localVarPath =
            "/access_ip_ranges/{access_ip_range_id}".replaceAll(
                    "\\{" + "access_ip_range_id" + "\\}",
                    apiClient.escapeString(accessIpRangeId.toString())
                );
        ...
        GenericType<AccessIPRangeResponseSchema> localVarReturnType =
            new GenericType<AccessIPRangeResponseSchema>() {};

        return apiClient.invokeAPI(
            "IpRangesApi.accessIpRangesAccessIpRangeIdDelete",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public AccessIPRangeResponseSchema createAccessIPRange(
   ...
   */
    public ApiResponse<
        AccessIPRangeResponseSchema
    > createAccessIPRangeWithHttpInfo(AccessIPRangePOST accessIPRangePOST)
        throws ApiException {
        ...
        if (accessIPRangePOST == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accessIPRangePOST' when calling createAccessIPRange"
            );
        }
        ...
        return apiClient.invokeAPI(
            "IpRangesApi.createAccessIPRange",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public AccessIPRangeListResponseSchema listAccessIpRanges(
        String filterCidrBlock,
        String filterCidrBlockStartswith,
        String filterCidrBlockEndswith,
        String filterCidrBlockContains,
        OffsetDateTime filterCreatedAtGt,
        OffsetDateTime filterCreatedAtLt,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return listAccessIpRangesWithHttpInfo(
            filterCidrBlock,
            filterCidrBlockStartswith,
            filterCidrBlockEndswith,
            filterCidrBlockContains,
            filterCreatedAtGt,
            filterCreatedAtLt,
            pageNumber,
            pageSize
   ...
   */
    ...
    > listAccessIpRangesWithHttpInfo(
        String filterCidrBlock,
        String filterCidrBlockStartswith,
        String filterCidrBlockEndswith,
        String filterCidrBlockContains,
        ...
        GenericType<AccessIPRangeListResponseSchema> localVarReturnType =
            new GenericType<AccessIPRangeListResponseSchema>() {};

        return apiClient.invokeAPI(
            "IpRangesApi.listAccessIpRanges",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
