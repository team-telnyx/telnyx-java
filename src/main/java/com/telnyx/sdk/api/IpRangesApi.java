...
public class IpRangesApi {
   ...
   */
  public AccessIPRangeResponseSchema accessIPRangeCreate(AccessIPRangePOST accessIPRangePOST) throws ApiException {
    return accessIPRangeCreateWithHttpInfo(accessIPRangePOST).getData();
  }
   ...
   */
  public ApiResponse<AccessIPRangeResponseSchema> accessIPRangeCreateWithHttpInfo(AccessIPRangePOST accessIPRangePOST) throws ApiException {
    Object localVarPostBody = accessIPRangePOST;
    
    // verify the required parameter 'accessIPRangePOST' is set
    if (accessIPRangePOST == null) {
      throw new ApiException(400, "Missing the required parameter 'accessIPRangePOST' when calling accessIPRangeCreate");
    }
    ...
    return apiClient.invokeAPI("IpRangesApi.accessIPRangeCreate", localVarPath, "POST", localVarQueryParams, localVarPostBody,
   ...
   */
  public AccessIPRangeListResponseSchema accessIPRangeList(String filterCidrBlock, String filterCidrBlockStartswith, String filterCidrBlockEndswith, String filterCidrBlockContains, CloudflareSyncStatus filterStatus, OffsetDateTime filterCreatedAtGt, OffsetDateTime filterCreatedAtLt, Integer pageNumber, Integer pageSize) throws ApiException {
    return accessIPRangeListWithHttpInfo(filterCidrBlock, filterCidrBlockStartswith, filterCidrBlockEndswith, filterCidrBlockContains, filterStatus, filterCreatedAtGt, filterCreatedAtLt, pageNumber, pageSize).getData();
  }
   ...
   */
  public ApiResponse<AccessIPRangeListResponseSchema> accessIPRangeListWithHttpInfo(String filterCidrBlock, String filterCidrBlockStartswith, String filterCidrBlockEndswith, String filterCidrBlockContains, CloudflareSyncStatus filterStatus, OffsetDateTime filterCreatedAtGt, OffsetDateTime filterCreatedAtLt, Integer pageNumber, Integer pageSize) throws ApiException {
    ...
    return apiClient.invokeAPI("IpRangesApi.accessIPRangeList", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
