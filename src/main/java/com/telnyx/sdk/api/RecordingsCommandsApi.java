...
public class RecordingsCommandsApi {
    ...
    private ApiResponse<ListRecordingsResponse> listRecordingsWithHttpInfo(
        ...
        GenericType<ListRecordingsResponse> localVarReturnType =
            new GenericType<ListRecordingsResponse>() {};

        return apiClient.invokeAPI(
            "RecordingsCommandsApi.listRecordings",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistRecordingsRequest {
         ...
         */
        public APIlistRecordingsRequest filterConferenceId(
            String filterConferenceId
        ) {
         ...
         * @return APIlistRecordingsRequest
         */
        public APIlistRecordingsRequest filterCreatedAtGte(
            String filterCreatedAtGte
        ) {
         ...
         * @return APIlistRecordingsRequest
         */
        public APIlistRecordingsRequest filterCreatedAtLte(
            String filterCreatedAtLte
        ) {
     ...
     */
        public ApiResponse<ListRecordingsResponse> executeWithHttpInfo()
            throws ApiException {
            return listRecordingsWithHttpInfo(
                filterConferenceId,
                filterCreatedAtGte,
                filterCreatedAtLte,
                pageNumber,
   ...
   */
    public GetRecordingResponse retrieveRecording(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<GetRecordingResponse> retrieveRecordingWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveRecording"
            );
        }

        // create path and map variables
        String localVarPath =
            "/recordings/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<GetRecordingResponse> localVarReturnType = new GenericType<
            GetRecordingResponse
        >() {};

        return apiClient.invokeAPI(
            "RecordingsCommandsApi.retrieveRecording",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
