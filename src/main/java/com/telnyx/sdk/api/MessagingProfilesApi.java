...
public class MessagingProfilesApi {
   ...
   */
    public MessagingProfileResponse createMessagingProfile(
        CreateMessagingProfileRequest createMessagingProfileRequest
    ) throws ApiException {
        return createMessagingProfileWithHttpInfo(
    ...
    > createMessagingProfileWithHttpInfo(
        ...
        if (createMessagingProfileRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createMessagingProfileRequest' when calling createMessagingProfile"
            );
        }
        ...
        GenericType<MessagingProfileResponse> localVarReturnType =
            new GenericType<MessagingProfileResponse>() {};

        return apiClient.invokeAPI(
            "MessagingProfilesApi.createMessagingProfile",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public MessagingProfileResponse deleteMessagingProfile(UUID id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        MessagingProfileResponse
    > deleteMessagingProfileWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteMessagingProfile"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_profiles/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "MessagingProfilesApi.deleteMessagingProfile",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
    ...
    > getMessagingProfileMetricsWithHttpInfo(UUID id, String timeFrame)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getMessagingProfileMetrics"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_profiles/{id}/metrics".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "time_frame", timeFrame)
        );
        ...
        return apiClient.invokeAPI(
            "MessagingProfilesApi.getMessagingProfileMetrics",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIgetMessagingProfileMetricsRequest {
         ...
         */
        public APIgetMessagingProfileMetricsRequest timeFrame(
            String timeFrame
        ) {
     ...
     */
        ...
        public RetrieveMessagingProfileMetricsResponse execute()
            throws ApiException {
   ...
   */
    public APIgetMessagingProfileMetricsRequest getMessagingProfileMetrics(
        UUID id
    ) throws ApiException {
    ...
    > listMessagingProfilesWithHttpInfo(
        ...
        GenericType<ListMessagingProfilesResponse> localVarReturnType =
            new GenericType<ListMessagingProfilesResponse>() {};

        return apiClient.invokeAPI(
            "MessagingProfilesApi.listMessagingProfiles",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        public ApiResponse<ListMessagingProfilesResponse> executeWithHttpInfo()
            throws ApiException {
            return listMessagingProfilesWithHttpInfo(
                pageNumber,
                pageSize,
                filterName
            );
   ...
   */
    ...
    > listProfileMetricsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        UUID id,
        String timeFrame
        ...
        GenericType<ListMessagingProfileMetricsResponse> localVarReturnType =
            new GenericType<ListMessagingProfileMetricsResponse>() {};

        return apiClient.invokeAPI(
            "MessagingProfilesApi.listProfileMetrics",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        ...
        public ListMessagingProfileMetricsResponse execute()
            throws ApiException {
            return this.executeWithHttpInfo().getData();
        }
     ...
     */
        public ApiResponse<
            ListMessagingProfileMetricsResponse
        > executeWithHttpInfo() throws ApiException {
            return listProfileMetricsWithHttpInfo(
                pageNumber,
                pageSize,
                id,
                timeFrame
   ...
   */
    public APIlistProfileMetricsRequest listProfileMetrics()
        throws ApiException {
    ...
    > listProfilePhoneNumbersWithHttpInfo(
        UUID id,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling listProfilePhoneNumbers"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_profiles/{id}/phone_numbers".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        return apiClient.invokeAPI(
            "MessagingProfilesApi.listProfilePhoneNumbers",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistProfilePhoneNumbersRequest {
         ...
         */
        public APIlistProfilePhoneNumbersRequest pageNumber(
            Integer pageNumber
        ) {
            this.pageNumber = pageNumber;
            return this;
     ...
     */
        ...
        public ListMessagingProfilePhoneNumbersResponse execute()
            throws ApiException {
            return this.executeWithHttpInfo().getData();
        }
     ...
     */
        public ApiResponse<
            ListMessagingProfilePhoneNumbersResponse
        > executeWithHttpInfo() throws ApiException {
            return listProfilePhoneNumbersWithHttpInfo(
                id,
                pageNumber,
                pageSize
            );
   ...
   */
    public APIlistProfilePhoneNumbersRequest listProfilePhoneNumbers(UUID id)
        throws ApiException {
    ...
    > listProfileShortCodesWithHttpInfo(
        UUID id,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling listProfileShortCodes"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_profiles/{id}/short_codes".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        GenericType<ListMessagingProfileShortCodesResponse> localVarReturnType =
            new GenericType<ListMessagingProfileShortCodesResponse>() {};

        return apiClient.invokeAPI(
            "MessagingProfilesApi.listProfileShortCodes",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        ...
        public ListMessagingProfileShortCodesResponse execute()
            throws ApiException {
            return this.executeWithHttpInfo().getData();
        }
   ...
   */
    public APIlistProfileShortCodesRequest listProfileShortCodes(UUID id)
        throws ApiException {
   ...
   */
    public MessagingProfileResponse retrieveMessagingProfile(UUID id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        MessagingProfileResponse
    > retrieveMessagingProfileWithHttpInfo(UUID id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveMessagingProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "MessagingProfilesApi.retrieveMessagingProfile",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public MessagingProfileResponse updateMessagingProfile(
        UUID id,
        UpdateMessagingProfileRequest updateMessagingProfileRequest
    ) throws ApiException {
        return updateMessagingProfileWithHttpInfo(
            id,
   ...
   */
    ...
    > updateMessagingProfileWithHttpInfo(
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateMessagingProfile"
            );
        }
        ...
        if (updateMessagingProfileRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateMessagingProfileRequest' when calling updateMessagingProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "MessagingProfilesApi.updateMessagingProfile",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
