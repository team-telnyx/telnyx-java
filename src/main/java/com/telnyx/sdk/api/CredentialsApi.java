...
public class CredentialsApi {
   ...
   */
    public TelephonyCredentialResponse createTelephonyCredential(
        TelephonyCredentialCreateRequest telephonyCredentialCreateRequest
    ) throws ApiException {
        return createTelephonyCredentialWithHttpInfo(
   ...
   */
    ...
    > createTelephonyCredentialWithHttpInfo(
        TelephonyCredentialCreateRequest telephonyCredentialCreateRequest
    ) throws ApiException {
        ...
        if (telephonyCredentialCreateRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'telephonyCredentialCreateRequest' when calling createTelephonyCredential"
            );
        }
        ...
        GenericType<TelephonyCredentialResponse> localVarReturnType =
            new GenericType<TelephonyCredentialResponse>() {};

        return apiClient.invokeAPI(
            "CredentialsApi.createTelephonyCredential",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public TelephonyCredentialResponse deleteTelephonyCredential(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        TelephonyCredentialResponse
    > deleteTelephonyCredentialWithHttpInfo(String id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteTelephonyCredential"
            );
        }

        // create path and map variables
        String localVarPath =
            "/telephony_credentials/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "CredentialsApi.deleteTelephonyCredential",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
    ...
    > findTelephonyCredentialsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterTag,
        String filterName,
        ...
        GenericType<GetAllTelephonyCredentialResponse> localVarReturnType =
            new GenericType<GetAllTelephonyCredentialResponse>() {};

        return apiClient.invokeAPI(
            "CredentialsApi.findTelephonyCredentials",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIfindTelephonyCredentialsRequest {
         ...
         */
        public APIfindTelephonyCredentialsRequest pageNumber(
            Integer pageNumber
        ) {
         ...
         * @return APIfindTelephonyCredentialsRequest
         */
        public APIfindTelephonyCredentialsRequest filterName(
            String filterName
        ) {
         ...
         * @return APIfindTelephonyCredentialsRequest
         */
        public APIfindTelephonyCredentialsRequest filterStatus(
            String filterStatus
        ) {
         ...
         * @return APIfindTelephonyCredentialsRequest
         */
        public APIfindTelephonyCredentialsRequest filterResourceId(
            String filterResourceId
        ) {
         ...
         * @return APIfindTelephonyCredentialsRequest
         */
        public APIfindTelephonyCredentialsRequest filterSipUsername(
            String filterSipUsername
        ) {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return findTelephonyCredentialsWithHttpInfo(
                pageNumber,
                pageSize,
                filterTag,
                filterName,
   ...
   */
    public APIfindTelephonyCredentialsRequest findTelephonyCredentials()
        throws ApiException {
   ...
   */
    public TelephonyCredentialResponse getTelephonyCredential(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        TelephonyCredentialResponse
    > getTelephonyCredentialWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getTelephonyCredential"
            );
        }
        ...
        return apiClient.invokeAPI(
            "CredentialsApi.getTelephonyCredential",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public TelephonyCredentialResponse updateTelephonyCredential(
        String id,
        TelephonyCredentialUpdateRequest telephonyCredentialUpdateRequest
    ) throws ApiException {
        return updateTelephonyCredentialWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<
        TelephonyCredentialResponse
    > updateTelephonyCredentialWithHttpInfo(
        String id,
        TelephonyCredentialUpdateRequest telephonyCredentialUpdateRequest
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateTelephonyCredential"
            );
        }
        ...
        if (telephonyCredentialUpdateRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'telephonyCredentialUpdateRequest' when calling updateTelephonyCredential"
            );
        }
        ...
        return apiClient.invokeAPI(
            "CredentialsApi.updateTelephonyCredential",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
