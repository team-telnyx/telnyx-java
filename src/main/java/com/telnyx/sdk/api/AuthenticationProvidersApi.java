...
public class AuthenticationProvidersApi {
   ...
   */
    public CreateAuthenticationProvider200Response createAuthenticationProvider(
        AuthenticationProviderCreate authenticationProviderCreate
    ) throws ApiException {
        return createAuthenticationProviderWithHttpInfo(
   ...
   */
    ...
    > createAuthenticationProviderWithHttpInfo(
        AuthenticationProviderCreate authenticationProviderCreate
    ) throws ApiException {
        Object localVarPostBody = authenticationProviderCreate;

        // verify the required parameter 'authenticationProviderCreate' is set
        if (authenticationProviderCreate == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'authenticationProviderCreate' when calling createAuthenticationProvider"
            );
        }

        // create path and map variables
        String localVarPath = "/authentication_providers";
        ...
        return apiClient.invokeAPI(
            "AuthenticationProvidersApi.createAuthenticationProvider",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateAuthenticationProvider200Response deleteAuthenticationProvider(
        String id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        CreateAuthenticationProvider200Response
    > deleteAuthenticationProviderWithHttpInfo(String id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteAuthenticationProvider"
            );
        }

        // create path and map variables
        String localVarPath =
            "/authentication_providers/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "AuthenticationProvidersApi.deleteAuthenticationProvider",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public FindAuthenticationProviders200Response findAuthenticationProviders(
        Integer pageNumber,
        Integer pageSize,
        String sort
    ) throws ApiException {
        return findAuthenticationProvidersWithHttpInfo(
            pageNumber,
            pageSize,
            sort
        ).getData();
   ...
   */
    ...
    > findAuthenticationProvidersWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String sort
    ) throws ApiException {
        ...
        GenericType<FindAuthenticationProviders200Response> localVarReturnType =
            new GenericType<FindAuthenticationProviders200Response>() {};

        return apiClient.invokeAPI(
            "AuthenticationProvidersApi.findAuthenticationProviders",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateAuthenticationProvider200Response getAuthenticationProvider(
        String id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        CreateAuthenticationProvider200Response
    > getAuthenticationProviderWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getAuthenticationProvider"
            );
        }
        ...
        return apiClient.invokeAPI(
            "AuthenticationProvidersApi.getAuthenticationProvider",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateAuthenticationProvider200Response updateAuthenticationProvider(
        String id,
        UpdateAuthenticationProviderRequest updateAuthenticationProviderRequest
    ) throws ApiException {
        return updateAuthenticationProviderWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<
        CreateAuthenticationProvider200Response
    > updateAuthenticationProviderWithHttpInfo(
        String id,
        UpdateAuthenticationProviderRequest updateAuthenticationProviderRequest
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateAuthenticationProvider"
            );
        }

        // verify the required parameter 'updateAuthenticationProviderRequest' is set
        if (updateAuthenticationProviderRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateAuthenticationProviderRequest' when calling updateAuthenticationProvider"
            );
        }
        ...
        return apiClient.invokeAPI(
            "AuthenticationProvidersApi.updateAuthenticationProvider",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
