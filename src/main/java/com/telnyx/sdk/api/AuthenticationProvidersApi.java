...
public class AuthenticationProvidersApi {
  ...
  public ApiResponse<CreateAuthenticationProvider200Response> createAuthenticationProviderWithHttpInfo(AuthenticationProviderCreate authenticationProviderCreate) throws ApiException {
    ...
    if (authenticationProviderCreate == null) {
      throw new ApiException(400, "Missing the required parameter 'authenticationProviderCreate' when calling createAuthenticationProvider");
    }
  ...
  public ApiResponse<CreateAuthenticationProvider200Response> deleteAuthenticationProviderWithHttpInfo(String id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteAuthenticationProvider");
    }
    
    // create path and map variables
    String localVarPath = "/authentication_providers/{id}"
  ...
  public ApiResponse<CreateAuthenticationProvider200Response> getAuthenticationProviderWithHttpInfo(String id) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getAuthenticationProvider");
    }
  ...
  public ApiResponse<CreateAuthenticationProvider200Response> updateAuthenticationProviderWithHttpInfo(String id, UpdateAuthenticationProviderRequest updateAuthenticationProviderRequest) throws ApiException {
    ...
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateAuthenticationProvider");
    }
    
    // verify the required parameter 'updateAuthenticationProviderRequest' is set
    if (updateAuthenticationProviderRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'updateAuthenticationProviderRequest' when calling updateAuthenticationProvider");
    }
