...
public class OtaUpdatesApi {
   ...
   */
    public ApiResponse<GetOtaUpdate200Response> getOtaUpdateWithHttpInfo(
        UUID id
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getOtaUpdate"
            );
        }

        // create path and map variables
        String localVarPath =
            "/ota_updates/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<GetOtaUpdate200Response> localVarReturnType =
            new GenericType<GetOtaUpdate200Response>() {};

        return apiClient.invokeAPI(
            "OtaUpdatesApi.getOtaUpdate",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListOtaUpdates200Response listOtaUpdates(
        Integer pageNumber,
        Integer pageSize,
        String filterStatus,
        String filterSimCardId,
        String filterType
    ) throws ApiException {
        return listOtaUpdatesWithHttpInfo(
            pageNumber,
            pageSize,
            filterStatus,
            filterSimCardId,
   ...
   */
    public ApiResponse<ListOtaUpdates200Response> listOtaUpdatesWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterStatus,
        String filterSimCardId,
        ...
        GenericType<ListOtaUpdates200Response> localVarReturnType =
            new GenericType<ListOtaUpdates200Response>() {};

        return apiClient.invokeAPI(
            "OtaUpdatesApi.listOtaUpdates",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
