...
public class PushCredentialsApi {
   ...
   */
    public PushCredentialResponse createPushCredential(
        CreatePushCredentialRequest createPushCredentialRequest
    ) throws ApiException {
        return createPushCredentialWithHttpInfo(
   ...
   */
    public ApiResponse<PushCredentialResponse> createPushCredentialWithHttpInfo(
        CreatePushCredentialRequest createPushCredentialRequest
    ) throws ApiException {
        ...
        if (createPushCredentialRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createPushCredentialRequest' when calling createPushCredential"
            );
        }
        ...
        return apiClient.invokeAPI(
            "PushCredentialsApi.createPushCredential",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public void deletePushCredentialById(UUID pushCredentialId)
        throws ApiException {
   ...
   */
    public ApiResponse<Void> deletePushCredentialByIdWithHttpInfo(
        UUID pushCredentialId
    ) throws ApiException {
        ...
        if (pushCredentialId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'pushCredentialId' when calling deletePushCredentialById"
            );
        }

        // create path and map variables
        String localVarPath =
            "/mobile_push_credentials/{push_credential_id}".replaceAll(
                    "\\{" + "push_credential_id" + "\\}",
                    apiClient.escapeString(pushCredentialId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "PushCredentialsApi.deletePushCredentialById",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public PushCredentialResponse getPushCredentialById(UUID pushCredentialId)
        throws ApiException {
   ...
   */
    ...
    > getPushCredentialByIdWithHttpInfo(UUID pushCredentialId)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (pushCredentialId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'pushCredentialId' when calling getPushCredentialById"
            );
        }
        ...
        return apiClient.invokeAPI(
            "PushCredentialsApi.getPushCredentialById",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListPushCredentialsResponse listPushCredentials(
        String filterType,
        String filterAlias,
        Integer pageSize,
        Integer pageNumber
    ) throws ApiException {
        return listPushCredentialsWithHttpInfo(
            filterType,
            filterAlias,
            pageSize,
            pageNumber
   ...
   */
    ...
    > listPushCredentialsWithHttpInfo(
        String filterType,
        String filterAlias,
        Integer pageSize,
        Integer pageNumber
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[alias]", filterAlias)
        );
        localVarQueryParams.addAll(
        ...
        GenericType<ListPushCredentialsResponse> localVarReturnType =
            new GenericType<ListPushCredentialsResponse>() {};

        return apiClient.invokeAPI(
            "PushCredentialsApi.listPushCredentials",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
