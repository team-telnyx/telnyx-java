...
public class SimCardGroupActionsApi {
   ...
   */
    public GetSimCardGroupAction200Response getSimCardGroupAction(UUID id)
        throws ApiException {
   ...
   */
    ...
    > getSimCardGroupActionWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getSimCardGroupAction"
            );
        }

        // create path and map variables
        String localVarPath =
            "/sim_card_group_actions/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "SimCardGroupActionsApi.getSimCardGroupAction",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GetSimCardGroupActions200Response getSimCardGroupActions(
        Integer pageNumber,
        Integer pageSize,
        ...
        return getSimCardGroupActionsWithHttpInfo(
            pageNumber,
            pageSize,
   ...
   */
    ...
    > getSimCardGroupActionsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        UUID filterSimCardGroupId,
        String filterStatus,
        ...
        GenericType<GetSimCardGroupActions200Response> localVarReturnType =
            new GenericType<GetSimCardGroupActions200Response>() {};

        return apiClient.invokeAPI(
            "SimCardGroupActionsApi.getSimCardGroupActions",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
