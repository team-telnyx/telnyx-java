...
public class InventoryLevelApi {
   ...
   */
    public CreateInventoryCoverage200Response createInventoryCoverage(
        ...
        return createInventoryCoverageWithHttpInfo(
            filterGroupBy,
            filterNpa,
            filterNxx,
   ...
   */
    ...
    > createInventoryCoverageWithHttpInfo(
        String filterGroupBy,
        Integer filterNpa,
        Integer filterNxx,
        String filterAdministrativeArea,
        ...
        if (filterGroupBy == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'filterGroupBy' when calling createInventoryCoverage"
            );
        }
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[npa]", filterNpa)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[nxx]", filterNxx)
        );
        localVarQueryParams.addAll(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[count]", filterCount)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "multi",
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[groupBy]", filterGroupBy)
        );
        ...
        GenericType<CreateInventoryCoverage200Response> localVarReturnType =
            new GenericType<CreateInventoryCoverage200Response>() {};

        return apiClient.invokeAPI(
            "InventoryLevelApi.createInventoryCoverage",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
