...
public class ConnectionsApi {
    ...
    private ApiResponse<ListConnectionsResponse> listConnectionsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        ...
        GenericType<ListConnectionsResponse> localVarReturnType =
            new GenericType<ListConnectionsResponse>() {};
    ...
    public class APIlistConnectionsRequest {
         ...
         * @return APIlistConnectionsRequest
         */
        public APIlistConnectionsRequest filterConnectionNameContains(
            String filterConnectionNameContains
        ) {
         ...
         * @return APIlistConnectionsRequest
         */
        public APIlistConnectionsRequest filterOutboundVoiceProfileId(
            String filterOutboundVoiceProfileId
        ) {
     ...
     */
        public ApiResponse<ListConnectionsResponse> executeWithHttpInfo()
            throws ApiException {
            return listConnectionsWithHttpInfo(
                pageNumber,
                pageSize,
                filterConnectionNameContains,
                filterOutboundVoiceProfileId,
   ...
   */
    public ConnectionResponse retrieveConnection(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<ConnectionResponse> retrieveConnectionWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveConnection"
            );
        }

        // create path and map variables
        String localVarPath =
            "/connections/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<ConnectionResponse> localVarReturnType = new GenericType<
            ConnectionResponse
        >() {};

        return apiClient.invokeAPI(
            "ConnectionsApi.retrieveConnection",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
