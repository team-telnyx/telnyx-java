...
public class IpAddressesApi {
   ...
   */
  public AccessIPAddressResponseSchema accessIpAddressAccessIpAddressIdDelete(String accessIpAddressId) throws ApiException {
    return accessIpAddressAccessIpAddressIdDeleteWithHttpInfo(accessIpAddressId).getData();
  }
   ...
   */
  public ApiResponse<AccessIPAddressResponseSchema> accessIpAddressAccessIpAddressIdDeleteWithHttpInfo(String accessIpAddressId) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'accessIpAddressId' is set
    if (accessIpAddressId == null) {
      throw new ApiException(400, "Missing the required parameter 'accessIpAddressId' when calling accessIpAddressAccessIpAddressIdDelete");
    }
    ...
    return apiClient.invokeAPI("IpAddressesApi.accessIpAddressAccessIpAddressIdDelete", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
