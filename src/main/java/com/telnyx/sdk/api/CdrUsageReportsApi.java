...
public class CdrUsageReportsApi {
   ...
   */
    public CdrGetSyncUsageReportResponse getCDRUsageReportSync(
        String aggregationType,
        String productBreakdown,
        OffsetDateTime startDate,
        OffsetDateTime endDate,
        List<BigDecimal> connections
    ) throws ApiException {
        return getCDRUsageReportSyncWithHttpInfo(
            aggregationType,
            productBreakdown,
            startDate,
            endDate,
   ...
   */
    ...
    > getCDRUsageReportSyncWithHttpInfo(
        String aggregationType,
        String productBreakdown,
        OffsetDateTime startDate,
        OffsetDateTime endDate,
        ...
        if (aggregationType == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'aggregationType' when calling getCDRUsageReportSync"
            );
        }
        ...
        if (productBreakdown == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'productBreakdown' when calling getCDRUsageReportSync"
            );
        }
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("multi", "connections", connections)
        );
        ...
        GenericType<CdrGetSyncUsageReportResponse> localVarReturnType =
            new GenericType<CdrGetSyncUsageReportResponse>() {};

        return apiClient.invokeAPI(
            "CdrUsageReportsApi.getCDRUsageReportSync",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
