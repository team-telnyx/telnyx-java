...
public class MessagingHostedNumberApi {
   ...
   */
    public RetrieveMessagingHostedNumberOrderResponse createMessagingHostedNumberOrder(
        CreateMessagingHostedNumberOrderRequest createMessagingHostedNumberOrderRequest
    ) throws ApiException {
        return createMessagingHostedNumberOrderWithHttpInfo(
   ...
   */
    ...
    > createMessagingHostedNumberOrderWithHttpInfo(
        ...
        return apiClient.invokeAPI(
            "MessagingHostedNumberApi.createMessagingHostedNumberOrder",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public RetrieveMessagingHostedNumberResponse deleteMessagingHostedNumber(
        String id
    ) throws ApiException {
   ...
   */
    ...
    > deleteMessagingHostedNumberWithHttpInfo(String id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteMessagingHostedNumber"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_hosted_numbers/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<RetrieveMessagingHostedNumberResponse> localVarReturnType =
            new GenericType<RetrieveMessagingHostedNumberResponse>() {};

        return apiClient.invokeAPI(
            "MessagingHostedNumberApi.deleteMessagingHostedNumber",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public RetrieveMessagingHostedNumberOrderResponse getMessagingHostedNumberOrder(
        String id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        RetrieveMessagingHostedNumberOrderResponse
    > getMessagingHostedNumberOrderWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getMessagingHostedNumberOrder"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_hosted_number_orders/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        return apiClient.invokeAPI(
            "MessagingHostedNumberApi.getMessagingHostedNumberOrder",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listMessagingHostedNumberOrdersWithHttpInfo(
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListMessagingHostedNumberOrderResponse> localVarReturnType =
            new GenericType<ListMessagingHostedNumberOrderResponse>() {};

        return apiClient.invokeAPI(
            "MessagingHostedNumberApi.listMessagingHostedNumberOrders",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistMessagingHostedNumberOrdersRequest {
         ...
         */
        public APIlistMessagingHostedNumberOrdersRequest pageNumber(
            Integer pageNumber
        ) {
         ...
         * @return APIlistMessagingHostedNumberOrdersRequest
         */
        public APIlistMessagingHostedNumberOrdersRequest pageSize(
            Integer pageSize
        ) {
     ...
     */
        ...
        public ListMessagingHostedNumberOrderResponse execute()
            throws ApiException {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return listMessagingHostedNumberOrdersWithHttpInfo(
                pageNumber,
                pageSize
            );
        }
   ...
   */
    public APIlistMessagingHostedNumberOrdersRequest listMessagingHostedNumberOrders()
        throws ApiException {
   ...
   */
    public RetrieveMessagingHostedNumberOrderResponse uploadMessagingHostedNumberOrderFile(
        String id,
        File loa,
        File bill
    ) throws ApiException {
        return uploadMessagingHostedNumberOrderFileWithHttpInfo(
            id,
            loa,
            bill
        ).getData();
   ...
   */
    public ApiResponse<
        RetrieveMessagingHostedNumberOrderResponse
    > uploadMessagingHostedNumberOrderFileWithHttpInfo(
        String id,
        File loa,
        File bill
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling uploadMessagingHostedNumberOrderFile"
            );
        }

        // create path and map variables
        String localVarPath =
            "/messaging_hosted_number_orders/{id}/actions/file_upload".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        if (loa != null) localVarFormParams.put("loa", loa);
        if (bill != null) localVarFormParams.put("bill", bill);
        ...
        return apiClient.invokeAPI(
            "MessagingHostedNumberApi.uploadMessagingHostedNumberOrderFile",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
