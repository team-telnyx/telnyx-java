...
public class IpConnectionsApi {
   ...
   */
    public IpConnectionResponse createIpConnection(
        CreateIpConnectionRequest createIpConnectionRequest
    ) throws ApiException {
        return createIpConnectionWithHttpInfo(
   ...
   */
    public ApiResponse<IpConnectionResponse> createIpConnectionWithHttpInfo(
        CreateIpConnectionRequest createIpConnectionRequest
    ) throws ApiException {
        ...
        if (createIpConnectionRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createIpConnectionRequest' when calling createIpConnection"
            );
        }
        ...
        GenericType<IpConnectionResponse> localVarReturnType = new GenericType<
            IpConnectionResponse
        >() {};

        return apiClient.invokeAPI(
            "IpConnectionsApi.createIpConnection",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public IpConnectionResponse deleteIpConnection(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<IpConnectionResponse> deleteIpConnectionWithHttpInfo(
        String id
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteIpConnection"
            );
        }

        // create path and map variables
        String localVarPath =
            "/ip_connections/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "IpConnectionsApi.deleteIpConnection",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listIpConnectionsWithHttpInfo(
        ...
        GenericType<ListIpConnectionsResponse> localVarReturnType =
            new GenericType<ListIpConnectionsResponse>() {};

        return apiClient.invokeAPI(
            "IpConnectionsApi.listIpConnections",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistIpConnectionsRequest {
         ...
         * @return APIlistIpConnectionsRequest
         */
        public APIlistIpConnectionsRequest filterConnectionNameContains(
            String filterConnectionNameContains
        ) {
         ...
         * @return APIlistIpConnectionsRequest
         */
        public APIlistIpConnectionsRequest filterOutboundOutboundVoiceProfileId(
            String filterOutboundOutboundVoiceProfileId
        ) {
     ...
     */
        public ApiResponse<ListIpConnectionsResponse> executeWithHttpInfo()
            throws ApiException {
            return listIpConnectionsWithHttpInfo(
                pageNumber,
                pageSize,
                filterConnectionNameContains,
                filterOutboundOutboundVoiceProfileId,
   ...
   */
    public IpConnectionResponse retrieveIpConnection(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<IpConnectionResponse> retrieveIpConnectionWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveIpConnection"
            );
        }
        ...
        return apiClient.invokeAPI(
            "IpConnectionsApi.retrieveIpConnection",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public IpConnectionResponse updateIpConnection(
        String id,
        UpdateIpConnectionRequest updateIpConnectionRequest
    ) throws ApiException {
        return updateIpConnectionWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<IpConnectionResponse> updateIpConnectionWithHttpInfo(
        String id,
        UpdateIpConnectionRequest updateIpConnectionRequest
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateIpConnection"
            );
        }
        ...
        if (updateIpConnectionRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateIpConnectionRequest' when calling updateIpConnection"
            );
        }
        ...
        return apiClient.invokeAPI(
            "IpConnectionsApi.updateIpConnection",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
