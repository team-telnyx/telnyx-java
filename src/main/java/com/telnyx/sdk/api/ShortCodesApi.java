...
public class ShortCodesApi {
    ...
    private ApiResponse<ListShortCodesResponse> listShortCodesWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        ...
        GenericType<ListShortCodesResponse> localVarReturnType =
            new GenericType<ListShortCodesResponse>() {};

        return apiClient.invokeAPI(
            "ShortCodesApi.listShortCodes",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistShortCodesRequest {
         ...
         * @return APIlistShortCodesRequest
         */
        public APIlistShortCodesRequest filterMessagingProfileId(
            String filterMessagingProfileId
        ) {
     ...
     */
        public ApiResponse<ListShortCodesResponse> executeWithHttpInfo()
            throws ApiException {
            return listShortCodesWithHttpInfo(
                pageNumber,
                pageSize,
                filterMessagingProfileId
            );
   ...
   */
    public ApiResponse<ShortCodeResponse> retrieveShortCodeWithHttpInfo(
        UUID id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveShortCode"
            );
        }

        // create path and map variables
        String localVarPath =
            "/short_codes/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<ShortCodeResponse> localVarReturnType = new GenericType<
            ShortCodeResponse
        >() {};

        return apiClient.invokeAPI(
            "ShortCodesApi.retrieveShortCode",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ShortCodeResponse updateShortCode(
        UUID id,
        UpdateShortCodeRequest updateShortCodeRequest
    ) throws ApiException {
        return updateShortCodeWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<ShortCodeResponse> updateShortCodeWithHttpInfo(
        UUID id,
        UpdateShortCodeRequest updateShortCodeRequest
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateShortCode"
            );
        }
        ...
        if (updateShortCodeRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateShortCodeRequest' when calling updateShortCode"
            );
        }
