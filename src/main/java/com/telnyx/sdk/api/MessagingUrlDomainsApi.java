...
public class MessagingUrlDomainsApi {
    ...
    > listMessagingUrlDomainsWithHttpInfo(Integer pageNumber, Integer pageSize)
        throws ApiException {
        ...
        GenericType<ListMessagingProfileUrlDomainsResponse> localVarReturnType =
            new GenericType<ListMessagingProfileUrlDomainsResponse>() {};

        return apiClient.invokeAPI(
            "MessagingUrlDomainsApi.listMessagingUrlDomains",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistMessagingUrlDomainsRequest {
         ...
         */
        public APIlistMessagingUrlDomainsRequest pageNumber(
            Integer pageNumber
        ) {
     ...
     */
        ...
        public ListMessagingProfileUrlDomainsResponse execute()
            throws ApiException {
