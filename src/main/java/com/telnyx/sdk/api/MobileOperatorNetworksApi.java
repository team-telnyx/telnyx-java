...
public class MobileOperatorNetworksApi {
   ...
   */
    public MobileOperatorNetworksGet200Response mobileOperatorNetworksGet(
        Integer pageNumber,
        Integer pageSize,
        ...
        return mobileOperatorNetworksGetWithHttpInfo(
            pageNumber,
            pageSize,
   ...
   */
    ...
    > mobileOperatorNetworksGetWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterNameStartsWith,
        String filterNameContains,
        ...
        GenericType<MobileOperatorNetworksGet200Response> localVarReturnType =
            new GenericType<MobileOperatorNetworksGet200Response>() {};

        return apiClient.invokeAPI(
            "MobileOperatorNetworksApi.mobileOperatorNetworksGet",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
