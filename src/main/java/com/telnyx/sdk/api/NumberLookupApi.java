...
public class NumberLookupApi {
   ...
   */
    public NumberLookupResponse lookupNumber(String phoneNumber, String type)
        throws ApiException {
   ...
   */
    public ApiResponse<NumberLookupResponse> lookupNumberWithHttpInfo(
        String phoneNumber,
        String type
    ) throws ApiException {
        ...
        if (phoneNumber == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'phoneNumber' when calling lookupNumber"
            );
        }

        // create path and map variables
        String localVarPath =
            "/number_lookup/{phone_number}".replaceAll(
                    "\\{" + "phone_number" + "\\}",
        ...
        GenericType<NumberLookupResponse> localVarReturnType = new GenericType<
            NumberLookupResponse
        >() {};

        return apiClient.invokeAPI(
            "NumberLookupApi.lookupNumber",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
