...
public class BucketApi {
   ...
   * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucket.html">CreateBucket Documentation</a>
   */
    public ApiResponse<Void> createBucketWithHttpInfo(
        String bucketName,
        CreateBucketRequest createBucketRequest
    ) throws ApiException {
        ...
        if (bucketName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bucketName' when calling createBucket"
            );
        }
   ...
   * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucket.html">DeleteBucket Documentation</a>
   */
    public ApiResponse<Void> deleteBucketWithHttpInfo(String bucketName)
        throws ApiException {
        ...
        if (bucketName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bucketName' when calling deleteBucket"
            );
        }
   ...
   * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_HeadBucket.html">HeadBucket Documentation</a>
   */
    public ApiResponse<Void> headBucketWithHttpInfo(String bucketName)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (bucketName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bucketName' when calling headBucket"
            );
        }
   ...
   * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListBuckets.html">ListBuckets Documentation</a>
   */
    public ApiResponse<ListBuckets200Response> listBucketsWithHttpInfo()
        throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListBuckets200Response> localVarReturnType =
            new GenericType<ListBuckets200Response>() {};
