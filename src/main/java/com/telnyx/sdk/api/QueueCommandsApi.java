...
public class QueueCommandsApi {
   ...
   */
    public QueueResponse createQueue(CreateQueueRequest createQueueRequest)
        throws ApiException {
   ...
   */
    public ApiResponse<QueueResponse> createQueueWithHttpInfo(
        ...
        if (createQueueRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createQueueRequest' when calling createQueue"
            );
        }
        ...
        GenericType<QueueResponse> localVarReturnType = new GenericType<
            QueueResponse
        >() {};

        return apiClient.invokeAPI(
            "QueueCommandsApi.createQueue",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<Void> deleteQueueWithHttpInfo(String queueName)
        throws ApiException {
        ...
        if (queueName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'queueName' when calling deleteQueue"
            );
        }

        // create path and map variables
        String localVarPath =
            "/queues/{queue_name}".replaceAll(
                    "\\{" + "queue_name" + "\\}",
   ...
   */
    public ListQueueCallsResponse listQueueCalls(
        String queueName,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return listQueueCallsWithHttpInfo(
            queueName,
            pageNumber,
            pageSize
        ).getData();
   ...
   */
    public ApiResponse<ListQueueCallsResponse> listQueueCallsWithHttpInfo(
        String queueName,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        ...
        if (queueName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'queueName' when calling listQueueCalls"
            );
        }

        // create path and map variables
        String localVarPath =
            "/queues/{queue_name}/calls".replaceAll(
                    "\\{" + "queue_name" + "\\}",
                    apiClient.escapeString(queueName.toString())
                );
        ...
        GenericType<ListQueueCallsResponse> localVarReturnType =
            new GenericType<ListQueueCallsResponse>() {};

        return apiClient.invokeAPI(
            "QueueCommandsApi.listQueueCalls",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public QueueCallResponse retrieveCallFromQueue(
        String queueName,
        String callControlId
    ) throws ApiException {
        return retrieveCallFromQueueWithHttpInfo(
            queueName,
            callControlId
        ).getData();
    }
   ...
   */
    public ApiResponse<QueueCallResponse> retrieveCallFromQueueWithHttpInfo(
        String queueName,
        String callControlId
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (queueName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'queueName' when calling retrieveCallFromQueue"
            );
        }
        ...
        if (callControlId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'callControlId' when calling retrieveCallFromQueue"
            );
        }

        // create path and map variables
        String localVarPath =
            "/queues/{queue_name}/calls/{call_control_id}".replaceAll(
                    "\\{" + "queue_name" + "\\}",
                    apiClient.escapeString(queueName.toString())
                ).replaceAll(
                    "\\{" + "call_control_id" + "\\}",
        ...
        GenericType<QueueCallResponse> localVarReturnType = new GenericType<
            QueueCallResponse
        >() {};

        return apiClient.invokeAPI(
            "QueueCommandsApi.retrieveCallFromQueue",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public QueueResponse retrieveCallQueue(String queueName)
        throws ApiException {
   ...
   */
    public ApiResponse<QueueResponse> retrieveCallQueueWithHttpInfo(
        String queueName
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (queueName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'queueName' when calling retrieveCallQueue"
            );
        }
        ...
        return apiClient.invokeAPI(
            "QueueCommandsApi.retrieveCallQueue",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public QueueResponse updateQueueMaxSize(
        String queueName,
        UpdateQueueMaxSizeRequest updateQueueMaxSizeRequest
    ) throws ApiException {
        return updateQueueMaxSizeWithHttpInfo(
            queueName,
   ...
   */
    public ApiResponse<QueueResponse> updateQueueMaxSizeWithHttpInfo(
        String queueName,
        UpdateQueueMaxSizeRequest updateQueueMaxSizeRequest
    ) throws ApiException {
        ...
        if (queueName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'queueName' when calling updateQueueMaxSize"
            );
        }
        ...
        if (updateQueueMaxSizeRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateQueueMaxSizeRequest' when calling updateQueueMaxSize"
            );
        }
        ...
        return apiClient.invokeAPI(
            "QueueCommandsApi.updateQueueMaxSize",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
