...
public class RegisterCallApi {
   ...
   */
    public RegisterCallResponse registerCall(
   ...
   */
    public ApiResponse<RegisterCallResponse> registerCallWithHttpInfo(
        RegisterCallRequest registerCallRequest
    ) throws ApiException {
        ...
        if (registerCallRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'registerCallRequest' when calling registerCall"
            );
        }
        ...
        GenericType<RegisterCallResponse> localVarReturnType = new GenericType<
            RegisterCallResponse
        >() {};

        return apiClient.invokeAPI(
            "RegisterCallApi.registerCall",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
