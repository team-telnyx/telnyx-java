...
public class BulkSoleProprietorCreationApi {
   ...
   */
    public BulkCreationTasksResponse getAllTasks(
   ...
   */
    public ApiResponse<BulkCreationTasksResponse> getAllTasksWithHttpInfo(
        Object recordsPerPage,
        Object page
    ) throws ApiException {
        ...
        GenericType<BulkCreationTasksResponse> localVarReturnType =
            new GenericType<BulkCreationTasksResponse>() {};

        return apiClient.invokeAPI(
            "BulkSoleProprietorCreationApi.getAllTasks",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public BulkCreationStatusResponse getBulkCreationTaskStatus(String taskId)
        throws ApiException {
   ...
   */
    ...
    > getBulkCreationTaskStatusWithHttpInfo(String taskId) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (taskId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'taskId' when calling getBulkCreationTaskStatus"
            );
        }

        // create path and map variables
        String localVarPath =
            "/bulkCreation/{taskId}".replaceAll(
                    "\\{" + "taskId" + "\\}",
        ...
        GenericType<BulkCreationStatusResponse> localVarReturnType =
            new GenericType<BulkCreationStatusResponse>() {};

        return apiClient.invokeAPI(
            "BulkSoleProprietorCreationApi.getBulkCreationTaskStatus",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public BulkCreationDetailedStatusResponse getTaskDetailedStatus(
        String taskId,
        Object recordsPerPage,
        Object page
    ) throws ApiException {
        return getTaskDetailedStatusWithHttpInfo(
            taskId,
            recordsPerPage,
            page
        ).getData();
   ...
   */
    ...
    > getTaskDetailedStatusWithHttpInfo(
        String taskId,
        Object recordsPerPage,
        Object page
    ) throws ApiException {
        ...
        if (taskId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'taskId' when calling getTaskDetailedStatus"
            );
        }

        // create path and map variables
        String localVarPath =
            "/bulkCreation/{taskId}/detailedStatus".replaceAll(
                    "\\{" + "taskId" + "\\}",
                    apiClient.escapeString(taskId.toString())
                );
        ...
        GenericType<BulkCreationDetailedStatusResponse> localVarReturnType =
            new GenericType<BulkCreationDetailedStatusResponse>() {};

        return apiClient.invokeAPI(
            "BulkSoleProprietorCreationApi.getTaskDetailedStatus",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public BulkCreationResponse postBulkCreation(
   ...
   */
    public ApiResponse<BulkCreationResponse> postBulkCreationWithHttpInfo(
        BulkCreationRequest bulkCreationRequest
    ) throws ApiException {
        ...
        if (bulkCreationRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bulkCreationRequest' when calling postBulkCreation"
            );
        }
        ...
        GenericType<BulkCreationResponse> localVarReturnType = new GenericType<
            BulkCreationResponse
        >() {};

        return apiClient.invokeAPI(
            "BulkSoleProprietorCreationApi.postBulkCreation",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
