...
public class CredentialConnectionsApi {
   ...
   */
    public RegistrationStatusResponse checkRegistrationStatus(String id)
        throws ApiException {
   ...
   */
    ...
    > checkRegistrationStatusWithHttpInfo(String id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling checkRegistrationStatus"
            );
        }

        // create path and map variables
        String localVarPath =
            "/credential_connections/{id}/actions/check_registration_status".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<RegistrationStatusResponse> localVarReturnType =
            new GenericType<RegistrationStatusResponse>() {};

        return apiClient.invokeAPI(
            "CredentialConnectionsApi.checkRegistrationStatus",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CredentialConnectionResponse createCredentialConnection(
        CreateCredentialConnectionRequest createCredentialConnectionRequest
    ) throws ApiException {
        return createCredentialConnectionWithHttpInfo(
   ...
   */
    ...
    > createCredentialConnectionWithHttpInfo(
        CreateCredentialConnectionRequest createCredentialConnectionRequest
    ) throws ApiException {
        ...
        if (createCredentialConnectionRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createCredentialConnectionRequest' when calling createCredentialConnection"
            );
        }
        ...
        GenericType<CredentialConnectionResponse> localVarReturnType =
            new GenericType<CredentialConnectionResponse>() {};

        return apiClient.invokeAPI(
            "CredentialConnectionsApi.createCredentialConnection",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CredentialConnectionResponse deleteCredentialConnection(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        CredentialConnectionResponse
    > deleteCredentialConnectionWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteCredentialConnection"
            );
        }

        // create path and map variables
        String localVarPath =
            "/credential_connections/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        return apiClient.invokeAPI(
            "CredentialConnectionsApi.deleteCredentialConnection",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listCredentialConnectionsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterConnectionNameContains,
        String filterOutboundOutboundVoiceProfileId,
        String sort
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListCredentialConnectionsResponse> localVarReturnType =
            new GenericType<ListCredentialConnectionsResponse>() {};

        return apiClient.invokeAPI(
            "CredentialConnectionsApi.listCredentialConnections",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistCredentialConnectionsRequest {
         ...
         */
        public APIlistCredentialConnectionsRequest pageNumber(
            Integer pageNumber
        ) {
         ...
         * @return APIlistCredentialConnectionsRequest
         */
        public APIlistCredentialConnectionsRequest filterConnectionNameContains(
            String filterConnectionNameContains
        ) {
         ...
         * @return APIlistCredentialConnectionsRequest
         */
        public APIlistCredentialConnectionsRequest filterOutboundOutboundVoiceProfileId(
            String filterOutboundOutboundVoiceProfileId
        ) {
            this.filterOutboundOutboundVoiceProfileId =
                filterOutboundOutboundVoiceProfileId;
            return this;
        }
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return listCredentialConnectionsWithHttpInfo(
                pageNumber,
                pageSize,
                filterConnectionNameContains,
                filterOutboundOutboundVoiceProfileId,
   ...
   */
    public APIlistCredentialConnectionsRequest listCredentialConnections()
        throws ApiException {
   ...
   */
    public CredentialConnectionResponse retrieveCredentialConnection(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        CredentialConnectionResponse
    > retrieveCredentialConnectionWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveCredentialConnection"
            );
        }
        ...
        return apiClient.invokeAPI(
            "CredentialConnectionsApi.retrieveCredentialConnection",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CredentialConnectionResponse updateCredentialConnection(
        String id,
        UpdateCredentialConnectionRequest updateCredentialConnectionRequest
    ) throws ApiException {
        return updateCredentialConnectionWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<
        CredentialConnectionResponse
    > updateCredentialConnectionWithHttpInfo(
        String id,
        UpdateCredentialConnectionRequest updateCredentialConnectionRequest
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateCredentialConnection"
            );
        }
        ...
        if (updateCredentialConnectionRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateCredentialConnectionRequest' when calling updateCredentialConnection"
            );
        }
        ...
        return apiClient.invokeAPI(
            "CredentialConnectionsApi.updateCredentialConnection",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
