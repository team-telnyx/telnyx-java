...
public class ChatApi {
   ...
   */
    public Object chatPublicChatCompletionsPost(
        ChatCompletionRequest chatCompletionRequest
    ) throws ApiException {
        return chatPublicChatCompletionsPostWithHttpInfo(
   ...
   */
    public ApiResponse<Object> chatPublicChatCompletionsPostWithHttpInfo(
        ChatCompletionRequest chatCompletionRequest
    ) throws ApiException {
        ...
        if (chatCompletionRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'chatCompletionRequest' when calling chatPublicChatCompletionsPost"
            );
        }
        ...
        return apiClient.invokeAPI(
            "ChatApi.chatPublicChatCompletionsPost",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<ModelsResponse> getModelsPublicModelsGetWithHttpInfo()
        throws ApiException {
        ...
        GenericType<ModelsResponse> localVarReturnType = new GenericType<
            ModelsResponse
        >() {};

        return apiClient.invokeAPI(
            "ChatApi.getModelsPublicModelsGet",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public SummaryResponseData postSummary(SummaryRequest summaryRequest)
        throws ApiException {
   ...
   */
    public ApiResponse<SummaryResponseData> postSummaryWithHttpInfo(
        ...
        if (summaryRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'summaryRequest' when calling postSummary"
            );
        }
        ...
        GenericType<SummaryResponseData> localVarReturnType = new GenericType<
            SummaryResponseData
        >() {};
