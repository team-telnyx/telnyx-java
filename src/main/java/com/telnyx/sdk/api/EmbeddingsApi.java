...
public class EmbeddingsApi {
   ...
   */
    public void embeddingBucketFilesPublicEmbeddingBucketsBucketNameDelete(
        String bucketName
    ) throws ApiException {
        embeddingBucketFilesPublicEmbeddingBucketsBucketNameDeleteWithHttpInfo(
            bucketName
        );
    }
    ...
    > embeddingBucketFilesPublicEmbeddingBucketsBucketNameDeleteWithHttpInfo(
        ...
        if (bucketName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bucketName' when calling embeddingBucketFilesPublicEmbeddingBucketsBucketNameDelete"
            );
        }

        // create path and map variables
        String localVarPath =
            "/ai/embeddings/buckets/{bucket_name}".replaceAll(
                    "\\{" + "bucket_name" + "\\}",
        ...
        return apiClient.invokeAPI(
            "EmbeddingsApi.embeddingBucketFilesPublicEmbeddingBucketsBucketNameDelete",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public EmbeddingsBucketFilesData getBucketName(String bucketName)
        throws ApiException {
   ...
   */
    public ApiResponse<EmbeddingsBucketFilesData> getBucketNameWithHttpInfo(
        String bucketName
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (bucketName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bucketName' when calling getBucketName"
            );
        }
        ...
        GenericType<EmbeddingsBucketFilesData> localVarReturnType =
            new GenericType<EmbeddingsBucketFilesData>() {};

        return apiClient.invokeAPI(
            "EmbeddingsApi.getBucketName",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    ...
    > getEmbeddingBucketsWithHttpInfo() throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<UserEmbeddedBucketsData> localVarReturnType =
            new GenericType<UserEmbeddedBucketsData>() {};

        return apiClient.invokeAPI(
            "EmbeddingsApi.getEmbeddingBuckets",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public TaskStatusResponse getEmbeddingTask(String taskId)
        throws ApiException {
   ...
   */
    public ApiResponse<TaskStatusResponse> getEmbeddingTaskWithHttpInfo(
        String taskId
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (taskId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'taskId' when calling getEmbeddingTask"
            );
        }

        // create path and map variables
        String localVarPath =
            "/ai/embeddings/{task_id}".replaceAll(
                    "\\{" + "task_id" + "\\}",
        ...
        GenericType<TaskStatusResponse> localVarReturnType = new GenericType<
            TaskStatusResponse
        >() {};

        return apiClient.invokeAPI(
            "EmbeddingsApi.getEmbeddingTask",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public BackgroundTasksQueryResponseData getTasksByStatus(
        List<String> status
    ) throws ApiException {
   ...
   */
    ...
    > getTasksByStatusWithHttpInfo(List<String> status) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("multi", "status", status)
        );
        ...
        GenericType<BackgroundTasksQueryResponseData> localVarReturnType =
            new GenericType<BackgroundTasksQueryResponseData>() {};

        return apiClient.invokeAPI(
            "EmbeddingsApi.getTasksByStatus",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public EmbeddingResponse postEmbedding(
   ...
   */
    public ApiResponse<EmbeddingResponse> postEmbeddingWithHttpInfo(
        EmbeddingBucketRequest embeddingBucketRequest
    ) throws ApiException {
        ...
        if (embeddingBucketRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'embeddingBucketRequest' when calling postEmbedding"
            );
        }
        ...
        GenericType<EmbeddingResponse> localVarReturnType = new GenericType<
            EmbeddingResponse
        >() {};

        return apiClient.invokeAPI(
            "EmbeddingsApi.postEmbedding",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public EmbeddingSimilaritySearchResponse postEmbeddingSimilaritySearch(
        EmbeddingSimilaritySearchRequest embeddingSimilaritySearchRequest
    ) throws ApiException {
        return postEmbeddingSimilaritySearchWithHttpInfo(
   ...
   */
    ...
    > postEmbeddingSimilaritySearchWithHttpInfo(
        EmbeddingSimilaritySearchRequest embeddingSimilaritySearchRequest
    ) throws ApiException {
        ...
        if (embeddingSimilaritySearchRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'embeddingSimilaritySearchRequest' when calling postEmbeddingSimilaritySearch"
            );
        }
        ...
        GenericType<EmbeddingSimilaritySearchResponse> localVarReturnType =
            new GenericType<EmbeddingSimilaritySearchResponse>() {};

        return apiClient.invokeAPI(
            "EmbeddingsApi.postEmbeddingSimilaritySearch",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
