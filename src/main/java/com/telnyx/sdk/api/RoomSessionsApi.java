...
public class RoomSessionsApi {
   ...
   */
    public ApiResponse<EndSession200Response> endSessionWithHttpInfo(
        UUID roomSessionId
    ) throws ApiException {
        ...
        if (roomSessionId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomSessionId' when calling endSession"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_sessions/{room_session_id}/actions/end".replaceAll(
                    "\\{" + "room_session_id" + "\\}",
                    apiClient.escapeString(roomSessionId.toString())
                );
        ...
        GenericType<EndSession200Response> localVarReturnType = new GenericType<
            EndSession200Response
        >() {};

        return apiClient.invokeAPI(
            "RoomSessionsApi.endSession",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public EndSession200Response kickParticipantInSession(
        UUID roomSessionId,
        ActionsParticipantsRequest actionsParticipantsRequest
    ) throws ApiException {
        return kickParticipantInSessionWithHttpInfo(
            roomSessionId,
   ...
   */
    public ApiResponse<
        EndSession200Response
    > kickParticipantInSessionWithHttpInfo(
        UUID roomSessionId,
        ActionsParticipantsRequest actionsParticipantsRequest
    ) throws ApiException {
        ...
        if (roomSessionId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomSessionId' when calling kickParticipantInSession"
            );
        }
        ...
        if (actionsParticipantsRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'actionsParticipantsRequest' when calling kickParticipantInSession"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_sessions/{room_session_id}/actions/kick".replaceAll(
                    "\\{" + "room_session_id" + "\\}",
                    apiClient.escapeString(roomSessionId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "RoomSessionsApi.kickParticipantInSession",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListRoomSessions200Response listRoomSessions(
        LocalDate filterDateCreatedAtEq,
        LocalDate filterDateCreatedAtGte,
        LocalDate filterDateCreatedAtLte,
        LocalDate filterDateUpdatedAtEq,
        LocalDate filterDateUpdatedAtGte,
        LocalDate filterDateUpdatedAtLte,
        ...
        return listRoomSessionsWithHttpInfo(
            ...
            filterDateUpdatedAtEq,
            filterDateUpdatedAtGte,
            filterDateUpdatedAtLte,
            filterDateEndedAtEq,
   ...
   */
    ...
    > listRoomSessionsWithHttpInfo(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[active]", filterActive)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "",
        ...
        GenericType<ListRoomSessions200Response> localVarReturnType =
            new GenericType<ListRoomSessions200Response>() {};

        return apiClient.invokeAPI(
            "RoomSessionsApi.listRoomSessions",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public EndSession200Response muteParticipantInSession(
        UUID roomSessionId,
        ActionsParticipantsRequest actionsParticipantsRequest
    ) throws ApiException {
        return muteParticipantInSessionWithHttpInfo(
            roomSessionId,
            actionsParticipantsRequest
        ).getData();
    }
   ...
   */
    public ApiResponse<
        EndSession200Response
    > muteParticipantInSessionWithHttpInfo(
        UUID roomSessionId,
        ActionsParticipantsRequest actionsParticipantsRequest
    ) throws ApiException {
        Object localVarPostBody = actionsParticipantsRequest;
        ...
        if (roomSessionId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomSessionId' when calling muteParticipantInSession"
            );
        }
        ...
        if (actionsParticipantsRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'actionsParticipantsRequest' when calling muteParticipantInSession"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_sessions/{room_session_id}/actions/mute".replaceAll(
                    "\\{" + "room_session_id" + "\\}",
                    apiClient.escapeString(roomSessionId.toString())
                );
   ...
   */
    public ListRoomParticipants200Response retrieveListRoomParticipants(
        UUID roomSessionId,
        LocalDate filterDateJoinedAtEq,
        LocalDate filterDateJoinedAtGte,
        LocalDate filterDateJoinedAtLte,
        LocalDate filterDateUpdatedAtEq,
        LocalDate filterDateUpdatedAtGte,
        LocalDate filterDateUpdatedAtLte,
        LocalDate filterDateLeftAtEq,
        LocalDate filterDateLeftAtGte,
        LocalDate filterDateLeftAtLte,
        String filterContext,
        Integer pageSize,
        Integer pageNumber
    ) throws ApiException {
        return retrieveListRoomParticipantsWithHttpInfo(
            roomSessionId,
            filterDateJoinedAtEq,
            filterDateJoinedAtGte,
            filterDateJoinedAtLte,
            filterDateUpdatedAtEq,
            filterDateUpdatedAtGte,
            filterDateUpdatedAtLte,
            filterDateLeftAtEq,
   ...
   */
    ...
    > retrieveListRoomParticipantsWithHttpInfo(
        UUID roomSessionId,
        LocalDate filterDateJoinedAtEq,
        LocalDate filterDateJoinedAtGte,
        LocalDate filterDateJoinedAtLte,
        ...
        if (roomSessionId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomSessionId' when calling retrieveListRoomParticipants"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_sessions/{room_session_id}/participants".replaceAll(
                    "\\{" + "room_session_id" + "\\}",
                    apiClient.escapeString(roomSessionId.toString())
                );
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[context]", filterContext)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "page[size]", pageSize)
        );
        ...
        GenericType<ListRoomParticipants200Response> localVarReturnType =
            new GenericType<ListRoomParticipants200Response>() {};

        return apiClient.invokeAPI(
            "RoomSessionsApi.retrieveListRoomParticipants",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public EndSession200Response unmuteParticipantInSession(
        UUID roomSessionId,
        ActionsParticipantsRequest actionsParticipantsRequest
    ) throws ApiException {
        return unmuteParticipantInSessionWithHttpInfo(
            roomSessionId,
            actionsParticipantsRequest
        ).getData();
    }
   ...
   */
    public ApiResponse<
        EndSession200Response
    > unmuteParticipantInSessionWithHttpInfo(
        UUID roomSessionId,
        ActionsParticipantsRequest actionsParticipantsRequest
    ) throws ApiException {
        Object localVarPostBody = actionsParticipantsRequest;
        ...
        if (roomSessionId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomSessionId' when calling unmuteParticipantInSession"
            );
        }
        ...
        if (actionsParticipantsRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'actionsParticipantsRequest' when calling unmuteParticipantInSession"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_sessions/{room_session_id}/actions/unmute".replaceAll(
                    "\\{" + "room_session_id" + "\\}",
                    apiClient.escapeString(roomSessionId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "RoomSessionsApi.unmuteParticipantInSession",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ViewRoomSession200Response viewRoomSession(
        UUID roomSessionId,
        Boolean includeParticipants
    ) throws ApiException {
        return viewRoomSessionWithHttpInfo(
            roomSessionId,
            includeParticipants
        ).getData();
    }
   ...
   */
    public ApiResponse<ViewRoomSession200Response> viewRoomSessionWithHttpInfo(
        UUID roomSessionId,
        Boolean includeParticipants
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (roomSessionId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomSessionId' when calling viewRoomSession"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_sessions/{room_session_id}".replaceAll(
                    "\\{" + "room_session_id" + "\\}",
                    apiClient.escapeString(roomSessionId.toString())
                );
        ...
        GenericType<ViewRoomSession200Response> localVarReturnType =
            new GenericType<ViewRoomSession200Response>() {};

        return apiClient.invokeAPI(
            "RoomSessionsApi.viewRoomSession",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
