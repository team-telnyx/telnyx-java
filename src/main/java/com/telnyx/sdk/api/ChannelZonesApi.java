...
public class ChannelZonesApi {
   ...
   */
    public GcbPhoneNumber assignPhoneNumber(
        String channelZoneId,
        AssignPhoneNumberRequest body
    ) throws ApiException {
   ...
   */
    public ApiResponse<GcbPhoneNumber> assignPhoneNumberWithHttpInfo(
        String channelZoneId,
        AssignPhoneNumberRequest body
    ) throws ApiException {
        ...
        if (channelZoneId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'channelZoneId' when calling assignPhoneNumber"
            );
        }
        ...
        if (body == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'body' when calling assignPhoneNumber"
            );
        }

        // create path and map variables
        String localVarPath =
            "/channel_zones/{channel_zone_id}/channel_zone_phone_numbers".replaceAll(
                    "\\{" + "channel_zone_id" + "\\}",
                    apiClient.escapeString(channelZoneId.toString())
                );
        ...
        GenericType<GcbPhoneNumber> localVarReturnType = new GenericType<
            GcbPhoneNumber
        >() {};

        return apiClient.invokeAPI(
            "ChannelZonesApi.assignPhoneNumber",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GcbChannelZone getChannelZone(String channelZoneId)
        throws ApiException {
   ...
   */
    public ApiResponse<GcbChannelZone> getChannelZoneWithHttpInfo(
        String channelZoneId
    ) throws ApiException {
        ...
        if (channelZoneId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'channelZoneId' when calling getChannelZone"
            );
        }

        // create path and map variables
        String localVarPath =
            "/channel_zones/{channel_zone_id}".replaceAll(
                    "\\{" + "channel_zone_id" + "\\}",
                    apiClient.escapeString(channelZoneId.toString())
                );
        ...
        GenericType<GcbChannelZone> localVarReturnType = new GenericType<
            GcbChannelZone
        >() {};

        return apiClient.invokeAPI(
            "ChannelZonesApi.getChannelZone",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GetChannelZones200Response getChannelZones(
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
   ...
   */
    public ApiResponse<GetChannelZones200Response> getChannelZonesWithHttpInfo(
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<GetChannelZones200Response> localVarReturnType =
            new GenericType<GetChannelZones200Response>() {};

        return apiClient.invokeAPI(
            "ChannelZonesApi.getChannelZones",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GetPhoneNumbers200Response getPhoneNumbers(
        String channelZoneId,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return getPhoneNumbersWithHttpInfo(
            channelZoneId,
            pageNumber,
            pageSize
        ).getData();
   ...
   */
    public ApiResponse<GetPhoneNumbers200Response> getPhoneNumbersWithHttpInfo(
        String channelZoneId,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        ...
        if (channelZoneId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'channelZoneId' when calling getPhoneNumbers"
            );
        }
        ...
        GenericType<GetPhoneNumbers200Response> localVarReturnType =
            new GenericType<GetPhoneNumbers200Response>() {};

        return apiClient.invokeAPI(
            "ChannelZonesApi.getPhoneNumbers",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GcbChannelZone patchChannelZone(
        String channelZoneId,
        PatchChannelZoneRequest body
    ) throws ApiException {
   ...
   */
    public ApiResponse<GcbChannelZone> patchChannelZoneWithHttpInfo(
        String channelZoneId,
        PatchChannelZoneRequest body
    ) throws ApiException {
        Object localVarPostBody = body;
        ...
        if (channelZoneId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'channelZoneId' when calling patchChannelZone"
            );
        }
        ...
        if (body == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'body' when calling patchChannelZone"
            );
        }
        ...
        return apiClient.invokeAPI(
            "ChannelZonesApi.patchChannelZone",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public void unassignPhoneNumber(String channelZoneId, String phoneNumber)
        throws ApiException {
   ...
   */
    public ApiResponse<Void> unassignPhoneNumberWithHttpInfo(
        String channelZoneId,
        String phoneNumber
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (channelZoneId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'channelZoneId' when calling unassignPhoneNumber"
            );
        }
        ...
        if (phoneNumber == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'phoneNumber' when calling unassignPhoneNumber"
            );
        }

        // create path and map variables
        String localVarPath =
            "/channel_zones/{channel_zone_id}/channel_zone_phone_numbers/{phone_number}".replaceAll(
                    "\\{" + "channel_zone_id" + "\\}",
                    apiClient.escapeString(channelZoneId.toString())
                ).replaceAll(
                    "\\{" + "phone_number" + "\\}",
        ...
        return apiClient.invokeAPI(
            "ChannelZonesApi.unassignPhoneNumber",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
