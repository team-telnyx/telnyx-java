...
public class RequirementsApi {
   ...
   */
    public ListRequirements200Response listRequirements(
        ...
        return listRequirementsWithHttpInfo(
            filterCountryCode,
   ...
   */
    ...
    > listRequirementsWithHttpInfo(
        ...
        GenericType<ListRequirements200Response> localVarReturnType =
            new GenericType<ListRequirements200Response>() {};
   ...
   */
    public RetrieveDocumentRequirements200Response retrieveDocumentRequirements(
        UUID id
    ) throws ApiException {
   ...
   */
    ...
    > retrieveDocumentRequirementsWithHttpInfo(UUID id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrieveDocumentRequirements"
            );
        }

        // create path and map variables
        String localVarPath =
            "/requirements/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "RequirementsApi.retrieveDocumentRequirements",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
