...
public class OutboundVoiceProfilesApi {
   ...
   */
    public OutboundVoiceProfileResponse createVoiceProfile(
        CreateOutboundVoiceProfileRequest createOutboundVoiceProfileRequest
    ) throws ApiException {
        return createVoiceProfileWithHttpInfo(
   ...
   */
    ...
    > createVoiceProfileWithHttpInfo(
        CreateOutboundVoiceProfileRequest createOutboundVoiceProfileRequest
    ) throws ApiException {
        ...
        if (createOutboundVoiceProfileRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createOutboundVoiceProfileRequest' when calling createVoiceProfile"
            );
        }
        ...
        GenericType<OutboundVoiceProfileResponse> localVarReturnType =
            new GenericType<OutboundVoiceProfileResponse>() {};

        return apiClient.invokeAPI(
            "OutboundVoiceProfilesApi.createVoiceProfile",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public OutboundVoiceProfileResponse deleteOutboundVoiceProfile(UUID id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        OutboundVoiceProfileResponse
    > deleteOutboundVoiceProfileWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteOutboundVoiceProfile"
            );
        }

        // create path and map variables
        String localVarPath =
            "/outbound_voice_profiles/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "OutboundVoiceProfilesApi.deleteOutboundVoiceProfile",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public OutboundVoiceProfileResponse getOutboundVoiceProfile(UUID id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        OutboundVoiceProfileResponse
    > getOutboundVoiceProfileWithHttpInfo(UUID id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getOutboundVoiceProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "OutboundVoiceProfilesApi.getOutboundVoiceProfile",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listOutboundVoiceProfilesWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        ...
        GenericType<ListOutboundVoiceProfilesResponse> localVarReturnType =
            new GenericType<ListOutboundVoiceProfilesResponse>() {};

        return apiClient.invokeAPI(
            "OutboundVoiceProfilesApi.listOutboundVoiceProfiles",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistOutboundVoiceProfilesRequest {
         ...
         */
        public APIlistOutboundVoiceProfilesRequest pageNumber(
            Integer pageNumber
        ) {
         ...
         * @return APIlistOutboundVoiceProfilesRequest
         */
        public APIlistOutboundVoiceProfilesRequest filterNameContains(
            String filterNameContains
        ) {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return listOutboundVoiceProfilesWithHttpInfo(
                pageNumber,
                pageSize,
                filterNameContains,
                sort
   ...
   */
    public APIlistOutboundVoiceProfilesRequest listOutboundVoiceProfiles()
        throws ApiException {
   ...
   */
    public OutboundVoiceProfileResponse updateOutboundVoiceProfile(
        UUID id,
        UpdateOutboundVoiceProfileRequest updateOutboundVoiceProfileRequest
    ) throws ApiException {
        return updateOutboundVoiceProfileWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<
        OutboundVoiceProfileResponse
    > updateOutboundVoiceProfileWithHttpInfo(
        UUID id,
        UpdateOutboundVoiceProfileRequest updateOutboundVoiceProfileRequest
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateOutboundVoiceProfile"
            );
        }
        ...
        if (updateOutboundVoiceProfileRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateOutboundVoiceProfileRequest' when calling updateOutboundVoiceProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "OutboundVoiceProfilesApi.updateOutboundVoiceProfile",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
