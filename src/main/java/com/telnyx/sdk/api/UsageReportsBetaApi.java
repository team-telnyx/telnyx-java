...
public class UsageReportsBetaApi {
   ...
   * @param authorizationColonBearerLessThanTOKENGreaterThan  (optional)
   ...
   */
  public UsageReportsResponse getUsageReportProduct(String product, List<String> dimensions, List<String> metrics, String startDate, String endDate, String dateRange, String filter, Boolean managedAccounts, Integer pageNumber, Integer pageSize, List<String> sort, String format, String authorizationColonBearerLessThanTOKENGreaterThan) throws ApiException {
    return getUsageReportProductWithHttpInfo(product, dimensions, metrics, startDate, endDate, dateRange, filter, managedAccounts, pageNumber, pageSize, sort, format, authorizationColonBearerLessThanTOKENGreaterThan).getData();
  }
   ...
   */
  public ApiResponse<UsageReportsResponse> getUsageReportProductWithHttpInfo(String product, List<String> dimensions, List<String> metrics, String startDate, String endDate, String dateRange, String filter, Boolean managedAccounts, Integer pageNumber, Integer pageSize, List<String> sort, String format, String authorizationColonBearerLessThanTOKENGreaterThan) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'product' is set
    if (product == null) {
      throw new ApiException(400, "Missing the required parameter 'product' when calling getUsageReportProduct");
    }
    
    // verify the required parameter 'dimensions' is set
    if (dimensions == null) {
      throw new ApiException(400, "Missing the required parameter 'dimensions' when calling getUsageReportProduct");
    }
    
    // verify the required parameter 'metrics' is set
    if (metrics == null) {
      throw new ApiException(400, "Missing the required parameter 'metrics' when calling getUsageReportProduct");
    }
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "managed_accounts", managedAccounts));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "page[number]", pageNumber));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "page[size]", pageSize));
    localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "sort", sort));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "format", format));

    if (authorizationColonBearerLessThanTOKENGreaterThan != null)
      localVarHeaderParams.put("Authorization: Bearer &lt;TOKEN&gt;", apiClient.parameterToString(authorizationColonBearerLessThanTOKENGreaterThan));
    ...
    GenericType<UsageReportsResponse> localVarReturnType = new GenericType<UsageReportsResponse>() {};

    return apiClient.invokeAPI("UsageReportsBetaApi.getUsageReportProduct", localVarPath, "GET", localVarQueryParams, localVarPostBody,
   ...
   */
  public UsageReportsOptionsResponse listUsageReportsOptions(String product, String authorizationColonBearerLessThanTOKENGreaterThan) throws ApiException {
    return listUsageReportsOptionsWithHttpInfo(product, authorizationColonBearerLessThanTOKENGreaterThan).getData();
  }
   ...
   */
  public ApiResponse<UsageReportsOptionsResponse> listUsageReportsOptionsWithHttpInfo(String product, String authorizationColonBearerLessThanTOKENGreaterThan) throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<UsageReportsOptionsResponse> localVarReturnType = new GenericType<UsageReportsOptionsResponse>() {};

    return apiClient.invokeAPI("UsageReportsBetaApi.listUsageReportsOptions", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
