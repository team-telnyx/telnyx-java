...
public class UsageReportsBetaApi {
   ...
   */
  public UsageReportsResponse getUsageReport(String product, List<String> dimensions, List<String> metrics, String startDate, String endDate, String dateRange, String filter, Boolean managedAccounts, Integer pageNumber, Integer pageSize, List<String> sort, String format, String authorizationBearerLessThanTOKENGreaterThan) throws ApiException {
    return getUsageReportWithHttpInfo(product, dimensions, metrics, startDate, endDate, dateRange, filter, managedAccounts, pageNumber, pageSize, sort, format, authorizationBearerLessThanTOKENGreaterThan).getData();
  }
   ...
   */
  public ApiResponse<UsageReportsResponse> getUsageReportWithHttpInfo(String product, List<String> dimensions, List<String> metrics, String startDate, String endDate, String dateRange, String filter, Boolean managedAccounts, Integer pageNumber, Integer pageSize, List<String> sort, String format, String authorizationBearerLessThanTOKENGreaterThan) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'product' is set
    if (product == null) {
      throw new ApiException(400, "Missing the required parameter 'product' when calling getUsageReport");
    }
    
    // verify the required parameter 'dimensions' is set
    if (dimensions == null) {
      throw new ApiException(400, "Missing the required parameter 'dimensions' when calling getUsageReport");
    }
    
    // verify the required parameter 'metrics' is set
    if (metrics == null) {
      throw new ApiException(400, "Missing the required parameter 'metrics' when calling getUsageReport");
    }
    ...
    if (authorizationBearerLessThanTOKENGreaterThan != null)
      localVarHeaderParams.put("Authorization: Bearer &lt;TOKEN&gt;", apiClient.parameterToString(authorizationBearerLessThanTOKENGreaterThan));
    ...
    return apiClient.invokeAPI("UsageReportsBetaApi.getUsageReport", localVarPath, "GET", localVarQueryParams, localVarPostBody,
   ...
   */
  public UsageReportsOptionsResponse listUsageReportsOptions(String product, String authorizationBearerLessThanTOKENGreaterThan) throws ApiException {
    return listUsageReportsOptionsWithHttpInfo(product, authorizationBearerLessThanTOKENGreaterThan).getData();
  }
   ...
   */
  public ApiResponse<UsageReportsOptionsResponse> listUsageReportsOptionsWithHttpInfo(String product, String authorizationBearerLessThanTOKENGreaterThan) throws ApiException {
    Object localVarPostBody = null;
