...
public class PresignedObjectUrlsApi {
   ...
   */
    public PresignedObjectUrl createPresignedObjectUrl(
        String bucketName,
        String objectName,
        PresignedObjectUrlParams presignedObjectUrlParams
    ) throws ApiException {
        return createPresignedObjectUrlWithHttpInfo(
            bucketName,
            objectName,
   ...
   */
    public ApiResponse<PresignedObjectUrl> createPresignedObjectUrlWithHttpInfo(
        String bucketName,
        String objectName,
        PresignedObjectUrlParams presignedObjectUrlParams
    ) throws ApiException {
        ...
        if (bucketName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'bucketName' when calling createPresignedObjectUrl"
            );
        }
        ...
        if (objectName == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'objectName' when calling createPresignedObjectUrl"
            );
        }

        // create path and map variables
        String localVarPath =
            "/storage/buckets/{bucketName}/{objectName}/presigned_url".replaceAll(
                    "\\{" + "bucketName" + "\\}",
        ...
        GenericType<PresignedObjectUrl> localVarReturnType = new GenericType<
            PresignedObjectUrl
        >() {};

        return apiClient.invokeAPI(
            "PresignedObjectUrlsApi.createPresignedObjectUrl",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
