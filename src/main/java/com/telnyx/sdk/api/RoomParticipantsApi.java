...
public class RoomParticipantsApi {
   ...
   */
    public ListRoomParticipants200Response listRoomParticipants(
        ...
        return listRoomParticipantsWithHttpInfo(
   ...
   */
    ...
    > listRoomParticipantsWithHttpInfo(
        LocalDate filterDateJoinedAtEq,
        LocalDate filterDateJoinedAtGte,
        LocalDate filterDateJoinedAtLte,
        LocalDate filterDateUpdatedAtEq,
        ...
        return apiClient.invokeAPI(
            "RoomParticipantsApi.listRoomParticipants",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ViewRoomParticipant200Response viewRoomParticipant(
   ...
   */
    ...
    > viewRoomParticipantWithHttpInfo(UUID roomParticipantId)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (roomParticipantId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomParticipantId' when calling viewRoomParticipant"
            );
        }

        // create path and map variables
        String localVarPath =
            "/room_participants/{room_participant_id}".replaceAll(
                    "\\{" + "room_participant_id" + "\\}",
                    apiClient.escapeString(roomParticipantId.toString())
                );
        ...
        GenericType<ViewRoomParticipant200Response> localVarReturnType =
            new GenericType<ViewRoomParticipant200Response>() {};

        return apiClient.invokeAPI(
            "RoomParticipantsApi.viewRoomParticipant",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
