...
public class TeXmlTwilioCompatibleRestCommandsApi {
    ...
    private ApiResponse<Void> deleteTeXMLRecordingTranscriptionWithHttpInfo(
        String accountSid,
        UUID recordingTranscriptionSid
    ) throws ApiException {
        ...
        if (accountSid == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accountSid' when calling deleteTeXMLRecordingTranscription"
            );
        }
        ...
        if (recordingTranscriptionSid == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'recordingTranscriptionSid' when calling deleteTeXMLRecordingTranscription"
            );
        }

        // create path and map variables
        String localVarPath =
            "/texml/Accounts/{account_sid}/Transcriptions/{recording_transcription_sid}.json".replaceAll(
                    "\\{" + "account_sid" + "\\}",
                    apiClient.escapeString(accountSid.toString())
                ).replaceAll(
                    "\\{" + "recording_transcription_sid" + "\\}",
                    apiClient.escapeString(recordingTranscriptionSid.toString())
                );
        ...
        return apiClient.invokeAPI(
            "TeXmlTwilioCompatibleRestCommandsApi.deleteTeXMLRecordingTranscription",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIdeleteTeXMLRecordingTranscriptionRequest {
        ...
        private APIdeleteTeXMLRecordingTranscriptionRequest(
            String accountSid,
            UUID recordingTranscriptionSid
        ) {
     ...
     */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteTeXMLRecordingTranscriptionWithHttpInfo(
                accountSid,
   ...
   */
    public APIdeleteTeXMLRecordingTranscriptionRequest deleteTeXMLRecordingTranscription(
        String accountSid,
        UUID recordingTranscriptionSid
    ) throws ApiException {
        return new APIdeleteTeXMLRecordingTranscriptionRequest(
            accountSid,
            recordingTranscriptionSid
        );
    }
    ...
    > getTeXMLRecordingTranscriptionWithHttpInfo(
        String accountSid,
        UUID recordingTranscriptionSid
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (accountSid == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accountSid' when calling getTeXMLRecordingTranscription"
            );
        }
        ...
        if (recordingTranscriptionSid == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'recordingTranscriptionSid' when calling getTeXMLRecordingTranscription"
            );
        }
        ...
        GenericType<TexmlRecordingTranscription> localVarReturnType =
            new GenericType<TexmlRecordingTranscription>() {};

        return apiClient.invokeAPI(
            "TeXmlTwilioCompatibleRestCommandsApi.getTeXMLRecordingTranscription",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIgetTeXMLRecordingTranscriptionRequest {
        ...
        private APIgetTeXMLRecordingTranscriptionRequest(
            String accountSid,
            UUID recordingTranscriptionSid
        ) {
            this.accountSid = accountSid;
     ...
     */
        public ApiResponse<TexmlRecordingTranscription> executeWithHttpInfo()
            throws ApiException {
            return getTeXMLRecordingTranscriptionWithHttpInfo(
                accountSid,
                recordingTranscriptionSid
            );
        }
   ...
   */
    public APIgetTeXMLRecordingTranscriptionRequest getTeXMLRecordingTranscription(
        String accountSid,
        UUID recordingTranscriptionSid
    ) throws ApiException {
        return new APIgetTeXMLRecordingTranscriptionRequest(
            accountSid,
            recordingTranscriptionSid
        );
    }
    ...
    > getTeXMLRecordingTranscriptionsWithHttpInfo(
        String accountSid,
        String pageToken,
        Integer pageSize
    ) throws ApiException {
        ...
        if (accountSid == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accountSid' when calling getTeXMLRecordingTranscriptions"
            );
        }

        // create path and map variables
        String localVarPath =
            "/texml/Accounts/{account_sid}/Transcriptions.json".replaceAll(
                    "\\{" + "account_sid" + "\\}",
                    apiClient.escapeString(accountSid.toString())
                );
        ...
        GenericType<ListRecordingTranscriptionsResponse> localVarReturnType =
            new GenericType<ListRecordingTranscriptionsResponse>() {};

        return apiClient.invokeAPI(
            "TeXmlTwilioCompatibleRestCommandsApi.getTeXMLRecordingTranscriptions",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIgetTeXMLRecordingTranscriptionsRequest {
         ...
         */
        public APIgetTeXMLRecordingTranscriptionsRequest pageToken(
            String pageToken
        ) {
         ...
         * @return APIgetTeXMLRecordingTranscriptionsRequest
         */
        public APIgetTeXMLRecordingTranscriptionsRequest pageSize(
            Integer pageSize
        ) {
     ...
     */
        ...
        public ListRecordingTranscriptionsResponse execute()
            throws ApiException {
            return this.executeWithHttpInfo().getData();
        }
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return getTeXMLRecordingTranscriptionsWithHttpInfo(
                accountSid,
                pageToken,
                pageSize
            );
   ...
   */
    public APIgetTeXMLRecordingTranscriptionsRequest getTeXMLRecordingTranscriptions(
        String accountSid
    ) throws ApiException {
