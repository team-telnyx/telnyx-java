...
public class WhatsAppMessageTemplateApi {
   ...
   */
    public WhatsAppMessageTemplate1 createWhatsappMessageTemplates(
        UUID id,
        CreateWhatsappMessageTemplateRequestBody createWhatsappMessageTemplateRequestBody
    ) throws ApiException {
        return createWhatsappMessageTemplatesWithHttpInfo(
            id,
   ...
   */
    ...
    > createWhatsappMessageTemplatesWithHttpInfo(
        UUID id,
        CreateWhatsappMessageTemplateRequestBody createWhatsappMessageTemplateRequestBody
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling createWhatsappMessageTemplates"
            );
        }

        // create path and map variables
        String localVarPath =
            "/whatsapp_business_accounts/{id}/whatsapp_message_templates".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        GenericType<WhatsAppMessageTemplate1> localVarReturnType =
            new GenericType<WhatsAppMessageTemplate1>() {};

        return apiClient.invokeAPI(
            "WhatsAppMessageTemplateApi.createWhatsappMessageTemplates",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public void deleteWhatsappMessageTemplates(UUID id, String name)
        throws ApiException {
   ...
   */
    public ApiResponse<Void> deleteWhatsappMessageTemplatesWithHttpInfo(
        UUID id,
        String name
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteWhatsappMessageTemplates"
            );
        }
        ...
        if (name == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'name' when calling deleteWhatsappMessageTemplates"
            );
        }

        // create path and map variables
        String localVarPath =
            "/whatsapp_business_accounts/{id}/whatsapp_message_templates/{name}".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                ).replaceAll(
                    "\\{" + "name" + "\\}",
        ...
        return apiClient.invokeAPI(
            "WhatsAppMessageTemplateApi.deleteWhatsappMessageTemplates",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
    ...
    private ApiResponse<String> listWhatsappMessageTemplatesWithHttpInfo(
        UUID id,
        String category,
        String language,
        String name,
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling listWhatsappMessageTemplates"
            );
        }
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "quality_score", qualityScore)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "rejected_reason", rejectedReason)
        );
        localVarQueryParams.addAll(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "after", after)
        );
        localVarQueryParams.addAll(
        ...
        return apiClient.invokeAPI(
            "WhatsAppMessageTemplateApi.listWhatsappMessageTemplates",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistWhatsappMessageTemplatesRequest {
         ...
         */
        public APIlistWhatsappMessageTemplatesRequest category(
            String category
        ) {
         ...
         * @return APIlistWhatsappMessageTemplatesRequest
         */
        public APIlistWhatsappMessageTemplatesRequest language(
            String language
        ) {
         ...
         * @return APIlistWhatsappMessageTemplatesRequest
         */
        public APIlistWhatsappMessageTemplatesRequest rejectedReason(
            String rejectedReason
        ) {
     ...
     */
        public ApiResponse<String> executeWithHttpInfo() throws ApiException {
            return listWhatsappMessageTemplatesWithHttpInfo(
                id,
                category,
                language,
                name,
   ...
   */
    public APIlistWhatsappMessageTemplatesRequest listWhatsappMessageTemplates(
        UUID id
    ) throws ApiException {
