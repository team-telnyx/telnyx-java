...
public class RoomsClientTokensApi {
   ...
   */
    public CreateRoomClientToken201Response createRoomClientToken(
        UUID roomId,
        CreateRoomClientTokenRequest createRoomClientTokenRequest
    ) throws ApiException {
        return createRoomClientTokenWithHttpInfo(
            roomId,
   ...
   */
    ...
    > createRoomClientTokenWithHttpInfo(
        UUID roomId,
        CreateRoomClientTokenRequest createRoomClientTokenRequest
    ) throws ApiException {
        ...
        if (roomId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomId' when calling createRoomClientToken"
            );
        }
        ...
        if (createRoomClientTokenRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createRoomClientTokenRequest' when calling createRoomClientToken"
            );
        }

        // create path and map variables
        String localVarPath =
            "/rooms/{room_id}/actions/generate_join_client_token".replaceAll(
                    "\\{" + "room_id" + "\\}",
        ...
        GenericType<CreateRoomClientToken201Response> localVarReturnType =
            new GenericType<CreateRoomClientToken201Response>() {};

        return apiClient.invokeAPI(
            "RoomsClientTokensApi.createRoomClientToken",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public RefreshRoomClientToken201Response refreshRoomClientToken(
        UUID roomId,
        RefreshRoomClientTokenRequest refreshRoomClientTokenRequest
    ) throws ApiException {
        return refreshRoomClientTokenWithHttpInfo(
            roomId,
   ...
   */
    ...
    > refreshRoomClientTokenWithHttpInfo(
        UUID roomId,
        RefreshRoomClientTokenRequest refreshRoomClientTokenRequest
    ) throws ApiException {
        ...
        if (roomId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomId' when calling refreshRoomClientToken"
            );
        }
        ...
        if (refreshRoomClientTokenRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'refreshRoomClientTokenRequest' when calling refreshRoomClientToken"
            );
        }

        // create path and map variables
        String localVarPath =
            "/rooms/{room_id}/actions/refresh_client_token".replaceAll(
                    "\\{" + "room_id" + "\\}",
                    apiClient.escapeString(roomId.toString())
                );
        ...
        GenericType<RefreshRoomClientToken201Response> localVarReturnType =
            new GenericType<RefreshRoomClientToken201Response>() {};

        return apiClient.invokeAPI(
            "RoomsClientTokensApi.refreshRoomClientToken",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
