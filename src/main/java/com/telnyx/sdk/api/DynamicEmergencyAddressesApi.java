...
public class DynamicEmergencyAddressesApi {
   ...
   */
    public CreateDynamicEmergencyAddress201Response createDynamicEmergencyAddress(
        DynamicEmergencyAddress dynamicEmergencyAddress
    ) throws ApiException {
        return createDynamicEmergencyAddressWithHttpInfo(
   ...
   */
    ...
    > createDynamicEmergencyAddressWithHttpInfo(
        DynamicEmergencyAddress dynamicEmergencyAddress
    ) throws ApiException {
        ...
        if (dynamicEmergencyAddress == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'dynamicEmergencyAddress' when calling createDynamicEmergencyAddress"
            );
        }
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyAddressesApi.createDynamicEmergencyAddress",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateDynamicEmergencyAddress201Response deleteDynamicEmergencyAddress(
        UUID id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        CreateDynamicEmergencyAddress201Response
    > deleteDynamicEmergencyAddressWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteDynamicEmergencyAddress"
            );
        }

        // create path and map variables
        String localVarPath =
            "/dynamic_emergency_addresses/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyAddressesApi.deleteDynamicEmergencyAddress",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateDynamicEmergencyAddress201Response getDynamicEmergencyAddress(
        UUID id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        CreateDynamicEmergencyAddress201Response
    > getDynamicEmergencyAddressWithHttpInfo(UUID id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getDynamicEmergencyAddress"
            );
        }
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyAddressesApi.getDynamicEmergencyAddress",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListDynamicEmergencyAddresses200Response listDynamicEmergencyAddresses(
        String filterStatus,
        String filterCountryCode,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return listDynamicEmergencyAddressesWithHttpInfo(
            filterStatus,
            filterCountryCode,
            pageNumber,
            pageSize
   ...
   */
    ...
    > listDynamicEmergencyAddressesWithHttpInfo(
        String filterStatus,
        String filterCountryCode,
        Integer pageNumber,
        Integer pageSize
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyAddressesApi.listDynamicEmergencyAddresses",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
