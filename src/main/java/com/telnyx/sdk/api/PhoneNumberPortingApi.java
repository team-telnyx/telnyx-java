...
public class PhoneNumberPortingApi {
   ...
   */
    public PostPortabilityCheck201Response postPortabilityCheck(
        PostPortabilityCheckRequest postPortabilityCheckRequest
    ) throws ApiException {
        return postPortabilityCheckWithHttpInfo(
   ...
   */
    ...
    > postPortabilityCheckWithHttpInfo(
        PostPortabilityCheckRequest postPortabilityCheckRequest
    ) throws ApiException {
        ...
        if (postPortabilityCheckRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'postPortabilityCheckRequest' when calling postPortabilityCheck"
            );
        }
        ...
        GenericType<PostPortabilityCheck201Response> localVarReturnType =
            new GenericType<PostPortabilityCheck201Response>() {};

        return apiClient.invokeAPI(
            "PhoneNumberPortingApi.postPortabilityCheck",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
