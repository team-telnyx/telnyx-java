...
public class ProgrammableFaxCommandsApi {
   ...
   */
    public SuccessfulResponseUponAcceptingCancelFaxCommand cancelFax(UUID id)
        throws ApiException {
   ...
   */
    ...
    > cancelFaxWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling cancelFax"
            );
        }

        // create path and map variables
        String localVarPath =
            "/faxes/{id}/actions/cancel".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "ProgrammableFaxCommandsApi.cancelFax",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<Void> deleteFaxWithHttpInfo(UUID id)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteFax"
            );
        }
        ...
        return apiClient.invokeAPI(
            "ProgrammableFaxCommandsApi.deleteFax",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListFaxesResponse listFaxes(
        ...
        String filterDirectionEq,
        String filterFromEq,
        String filterToEq,
        Integer pageSize,
        Integer pageNumber
    ) throws ApiException {
        return listFaxesWithHttpInfo(
            filterCreatedAtGte,
            filterCreatedAtGt,
            filterCreatedAtLte,
            filterCreatedAtLt,
   ...
   */
    public ApiResponse<ListFaxesResponse> listFaxesWithHttpInfo(
        OffsetDateTime filterCreatedAtGte,
        OffsetDateTime filterCreatedAtGt,
        OffsetDateTime filterCreatedAtLte,
        OffsetDateTime filterCreatedAtLt,
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[from][eq]", filterFromEq)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[to][eq]", filterToEq)
        );
        localVarQueryParams.addAll(
        ...
        GenericType<ListFaxesResponse> localVarReturnType = new GenericType<
            ListFaxesResponse
        >() {};

        return apiClient.invokeAPI(
            "ProgrammableFaxCommandsApi.listFaxes",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<RefreshFaxResponse> refreshFaxWithHttpInfo(UUID id)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling refreshFax"
            );
        }

        // create path and map variables
        String localVarPath =
            "/faxes/{id}/actions/refresh".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        GenericType<RefreshFaxResponse> localVarReturnType = new GenericType<
            RefreshFaxResponse
        >() {};

        return apiClient.invokeAPI(
            "ProgrammableFaxCommandsApi.refreshFax",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<SendFaxResponse> sendFaxWithHttpInfo(
        ...
        if (sendFaxRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'sendFaxRequest' when calling sendFax"
            );
        }
        ...
        GenericType<SendFaxResponse> localVarReturnType = new GenericType<
            SendFaxResponse
        >() {};

        return apiClient.invokeAPI(
            "ProgrammableFaxCommandsApi.sendFax",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<GetFaxResponse> viewFaxWithHttpInfo(UUID id)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling viewFax"
            );
        }
        ...
        GenericType<GetFaxResponse> localVarReturnType = new GenericType<
            GetFaxResponse
        >() {};

        return apiClient.invokeAPI(
            "ProgrammableFaxCommandsApi.viewFax",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
