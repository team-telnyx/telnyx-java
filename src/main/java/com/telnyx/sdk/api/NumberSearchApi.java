...
public class NumberSearchApi {
   ...
   */
    public ListAvailablePhoneNumbersBlocksResponse listAvailablePhoneNumberBlocks(
        String filterPhoneNumberStartsWith,
        String filterPhoneNumberEndsWith,
        String filterPhoneNumberContains,
        String filterLocality,
        String filterAdministrativeArea,
        String filterCountryCode,
        String filterNationalDestinationCode,
        String filterRateCenter,
        String filterNumberType,
        List<String> filterFeatures,
        Integer filterMinimumBlockSize,
        Integer filterLimit
    ) throws ApiException {
        return listAvailablePhoneNumberBlocksWithHttpInfo(
            filterPhoneNumberStartsWith,
            filterPhoneNumberEndsWith,
            filterPhoneNumberContains,
            filterLocality,
            filterAdministrativeArea,
            filterCountryCode,
            filterNationalDestinationCode,
            filterRateCenter,
            filterNumberType,
            filterFeatures,
            filterMinimumBlockSize,
            filterLimit
        ).getData();
    }
   ...
   */
    ...
    > listAvailablePhoneNumberBlocksWithHttpInfo(
        String filterPhoneNumberStartsWith,
        String filterPhoneNumberEndsWith,
        String filterPhoneNumberContains,
        String filterLocality,
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[locality]", filterLocality)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "",
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[limit]", filterLimit)
        );
        ...
        return apiClient.invokeAPI(
            "NumberSearchApi.listAvailablePhoneNumberBlocks",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listAvailablePhoneNumbersWithHttpInfo(
        ...
        List<String> filterFeatures,
        Integer filterLimit,
        Boolean filterBestEffort,
        Boolean filterQuickship,
        Boolean filterReservable,
        Boolean filterExcludeHeldNumbers
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[quickship]", filterQuickship)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "",
        ...
        GenericType<ListAvailablePhoneNumbersResponse> localVarReturnType =
            new GenericType<ListAvailablePhoneNumbersResponse>() {};

        return apiClient.invokeAPI(
            "NumberSearchApi.listAvailablePhoneNumbers",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistAvailablePhoneNumbersRequest {
         ...
         */
        public APIlistAvailablePhoneNumbersRequest filterPhoneNumberStartsWith(
            String filterPhoneNumberStartsWith
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterPhoneNumberEndsWith(
            String filterPhoneNumberEndsWith
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterPhoneNumberContains(
            String filterPhoneNumberContains
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterLocality(
            String filterLocality
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterAdministrativeArea(
            String filterAdministrativeArea
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterCountryCode(
            String filterCountryCode
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterNationalDestinationCode(
            String filterNationalDestinationCode
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterRateCenter(
            String filterRateCenter
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterPhoneNumberType(
            String filterPhoneNumberType
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterFeatures(
            List<String> filterFeatures
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterLimit(
            Integer filterLimit
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterBestEffort(
            Boolean filterBestEffort
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterQuickship(
            Boolean filterQuickship
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterReservable(
            Boolean filterReservable
        ) {
         ...
         * @return APIlistAvailablePhoneNumbersRequest
         */
        public APIlistAvailablePhoneNumbersRequest filterExcludeHeldNumbers(
            Boolean filterExcludeHeldNumbers
        ) {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return listAvailablePhoneNumbersWithHttpInfo(
                filterPhoneNumberStartsWith,
                filterPhoneNumberEndsWith,
                filterPhoneNumberContains,
                filterLocality,
