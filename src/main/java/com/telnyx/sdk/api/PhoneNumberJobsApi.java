...
public class PhoneNumberJobsApi {
    ...
    > createPhoneNumbersJobDeletePhoneNumbersWithHttpInfo(
        ...
        return apiClient.invokeAPI(
            "PhoneNumberJobsApi.createPhoneNumbersJobDeletePhoneNumbers",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    ...
    > createPhoneNumbersJobUpdateEmergencySettingsWithHttpInfo(
        ...
        return apiClient.invokeAPI(
            "PhoneNumberJobsApi.createPhoneNumbersJobUpdateEmergencySettings",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listPhoneNumbersJobsWithHttpInfo(
        ...
        return apiClient.invokeAPI(
            "PhoneNumberJobsApi.listPhoneNumbersJobs",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        ...
        public ListPhoneNumbersAsynchronousJobsResponse execute()
            throws ApiException {
            return this.executeWithHttpInfo().getData();
        }
   ...
   */
    ...
    private ApiResponse<PhoneNumbersJob> retrievePhoneNumbersJobWithHttpInfo(
        ...
        return apiClient.invokeAPI(
            "PhoneNumberJobsApi.retrievePhoneNumbersJob",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
