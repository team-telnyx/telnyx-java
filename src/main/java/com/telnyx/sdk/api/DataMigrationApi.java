...
public class DataMigrationApi {
   ...
   */
    public CreateMigration200Response createMigration(
   ...
   */
    public ApiResponse<CreateMigration200Response> createMigrationWithHttpInfo(
        MigrationParams migrationParams
    ) throws ApiException {
        ...
        GenericType<CreateMigration200Response> localVarReturnType =
            new GenericType<CreateMigration200Response>() {};

        return apiClient.invokeAPI(
            "DataMigrationApi.createMigration",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateMigrationSource200Response createMigrationSource(
        MigrationSourceParams migrationSourceParams
    ) throws ApiException {
        return createMigrationSourceWithHttpInfo(
   ...
   */
    ...
    > createMigrationSourceWithHttpInfo(
        MigrationSourceParams migrationSourceParams
    ) throws ApiException {
        ...
        GenericType<CreateMigrationSource200Response> localVarReturnType =
            new GenericType<CreateMigrationSource200Response>() {};

        return apiClient.invokeAPI(
            "DataMigrationApi.createMigrationSource",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateMigrationSource200Response deleteMigrationSource(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        CreateMigrationSource200Response
    > deleteMigrationSourceWithHttpInfo(String id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteMigrationSource"
            );
        }

        // create path and map variables
        String localVarPath =
            "/storage/migration_sources/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "DataMigrationApi.deleteMigrationSource",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateMigration200Response getMigration(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<CreateMigration200Response> getMigrationWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath =
            "/storage/migrations/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
   ...
   */
    public CreateMigrationSource200Response getMigrationSource(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        CreateMigrationSource200Response
    > getMigrationSourceWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getMigrationSource"
            );
        }
        ...
        return apiClient.invokeAPI(
            "DataMigrationApi.getMigrationSource",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListMigrationSourceCoverage200Response listMigrationSourceCoverage()
        throws ApiException {
   ...
   */
    ...
    > listMigrationSourceCoverageWithHttpInfo() throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListMigrationSourceCoverage200Response> localVarReturnType =
            new GenericType<ListMigrationSourceCoverage200Response>() {};

        return apiClient.invokeAPI(
            "DataMigrationApi.listMigrationSourceCoverage",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListMigrationSources200Response listMigrationSources()
        throws ApiException {
   ...
   */
    ...
    > listMigrationSourcesWithHttpInfo() throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListMigrationSources200Response> localVarReturnType =
            new GenericType<ListMigrationSources200Response>() {};

        return apiClient.invokeAPI(
            "DataMigrationApi.listMigrationSources",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ApiResponse<ListMigrations200Response> listMigrationsWithHttpInfo()
        throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListMigrations200Response> localVarReturnType =
            new GenericType<ListMigrations200Response>() {};

        return apiClient.invokeAPI(
            "DataMigrationApi.listMigrations",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateMigration200Response stopMigration(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<CreateMigration200Response> stopMigrationWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling stopMigration"
            );
        }

        // create path and map variables
        String localVarPath =
            "/storage/migrations/{id}/actions/stop".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        return apiClient.invokeAPI(
            "DataMigrationApi.stopMigration",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
