...
public class SharedCampaignsApi {
   ...
   */
  public TelnyxDownstreamCampaign getSharedCampaign(String campaignId) throws ApiException {
   ...
   */
  public ApiResponse<TelnyxDownstreamCampaign> getSharedCampaignWithHttpInfo(String campaignId) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'campaignId' is set
    if (campaignId == null) {
      throw new ApiException(400, "Missing the required parameter 'campaignId' when calling getSharedCampaign");
    }
    
    // create path and map variables
    String localVarPath = "/partner_campaigns/{campaignId}"
      .replaceAll("\\{" + "campaignId" + "\\}", apiClient.escapeString(campaignId.toString()));
    ...
    GenericType<TelnyxDownstreamCampaign> localVarReturnType = new GenericType<TelnyxDownstreamCampaign>() {};

    return apiClient.invokeAPI("SharedCampaignsApi.getSharedCampaign", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   */
  public TelnyxDownstreamCampaignRecordSet getSharedCampaigns(Integer page, Integer recordsPerPage, String sort) throws ApiException {
    return getSharedCampaignsWithHttpInfo(page, recordsPerPage, sort).getData();
  }
   ...
   */
  public ApiResponse<TelnyxDownstreamCampaignRecordSet> getSharedCampaignsWithHttpInfo(Integer page, Integer recordsPerPage, String sort) throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<TelnyxDownstreamCampaignRecordSet> localVarReturnType = new GenericType<TelnyxDownstreamCampaignRecordSet>() {};

    return apiClient.invokeAPI("SharedCampaignsApi.getSharedCampaigns", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   */
  public TelnyxDownstreamCampaign updateSharedCampaign(String campaignId, UpdatePartnerCampaignRequest updatePartnerCampaignRequest) throws ApiException {
    return updateSharedCampaignWithHttpInfo(campaignId, updatePartnerCampaignRequest).getData();
  }
   ...
   */
  public ApiResponse<TelnyxDownstreamCampaign> updateSharedCampaignWithHttpInfo(String campaignId, UpdatePartnerCampaignRequest updatePartnerCampaignRequest) throws ApiException {
    Object localVarPostBody = updatePartnerCampaignRequest;
    
    // verify the required parameter 'campaignId' is set
    if (campaignId == null) {
      throw new ApiException(400, "Missing the required parameter 'campaignId' when calling updateSharedCampaign");
    }
    
    // verify the required parameter 'updatePartnerCampaignRequest' is set
    if (updatePartnerCampaignRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'updatePartnerCampaignRequest' when calling updateSharedCampaign");
    }
    ...
    return apiClient.invokeAPI("SharedCampaignsApi.updateSharedCampaign", localVarPath, "PATCH", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
