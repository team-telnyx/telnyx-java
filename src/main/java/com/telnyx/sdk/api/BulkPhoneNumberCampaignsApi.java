...
public class BulkPhoneNumberCampaignsApi {
   ...
   */
    public AssignmentTaskStatusResponse getAssignmentTaskStatus(String taskId)
        throws ApiException {
   ...
   */
    ...
    > getAssignmentTaskStatusWithHttpInfo(String taskId) throws ApiException {
        ...
        if (taskId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'taskId' when calling getAssignmentTaskStatus"
            );
        }

        // create path and map variables
        String localVarPath =
            "/phoneNumberAssignmentByProfile/{taskId}".replaceAll(
                    "\\{" + "taskId" + "\\}",
        ...
        GenericType<AssignmentTaskStatusResponse> localVarReturnType =
            new GenericType<AssignmentTaskStatusResponse>() {};

        return apiClient.invokeAPI(
            "BulkPhoneNumberCampaignsApi.getAssignmentTaskStatus",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public PhoneNumberStatusResponsePaginated getPhoneNumberStatus(
        String taskId,
        Object recordsPerPage,
        Object page
    ) throws ApiException {
        return getPhoneNumberStatusWithHttpInfo(
            taskId,
            recordsPerPage,
            page
        ).getData();
   ...
   */
    ...
    > getPhoneNumberStatusWithHttpInfo(
        String taskId,
        Object recordsPerPage,
        Object page
    ) throws ApiException {
        ...
        if (taskId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'taskId' when calling getPhoneNumberStatus"
            );
        }

        // create path and map variables
        String localVarPath =
            "/phoneNumberAssignmentByProfile/{taskId}/phoneNumbers".replaceAll(
                    "\\{" + "taskId" + "\\}",
                    apiClient.escapeString(taskId.toString())
                );
        ...
        GenericType<PhoneNumberStatusResponsePaginated> localVarReturnType =
            new GenericType<PhoneNumberStatusResponsePaginated>() {};

        return apiClient.invokeAPI(
            "BulkPhoneNumberCampaignsApi.getPhoneNumberStatus",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ResponseAssignMessagingProfileToCampaignPublicPhonenumberassignmentbyprofilePost postAssignMessagingProfileToCampaign(
        AssignProfileToCampaignRequest assignProfileToCampaignRequest
    ) throws ApiException {
        return postAssignMessagingProfileToCampaignWithHttpInfo(
   ...
   */
    ...
    > postAssignMessagingProfileToCampaignWithHttpInfo(
        AssignProfileToCampaignRequest assignProfileToCampaignRequest
    ) throws ApiException {
        ...
        if (assignProfileToCampaignRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'assignProfileToCampaignRequest' when calling postAssignMessagingProfileToCampaign"
            );
        }
        ...
        return apiClient.invokeAPI(
            "BulkPhoneNumberCampaignsApi.postAssignMessagingProfileToCampaign",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
