...
public class UserAddressesApi {
   ...
   */
    public CreateUserAddress200Response createUserAddress(
   ...
   */
    ...
    > createUserAddressWithHttpInfo(UserAddressCreate userAddressCreate)
        throws ApiException {
        ...
        if (userAddressCreate == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'userAddressCreate' when calling createUserAddress"
            );
        }
        ...
        GenericType<CreateUserAddress200Response> localVarReturnType =
            new GenericType<CreateUserAddress200Response>() {};

        return apiClient.invokeAPI(
            "UserAddressesApi.createUserAddress",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public FindUserAddress200Response findUserAddress(
        Integer pageNumber,
        Integer pageSize,
        ...
        return findUserAddressWithHttpInfo(
            pageNumber,
            pageSize,
   ...
   */
    public ApiResponse<FindUserAddress200Response> findUserAddressWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterCustomerReferenceEq,
        String filterCustomerReferenceContains,
        ...
        GenericType<FindUserAddress200Response> localVarReturnType =
            new GenericType<FindUserAddress200Response>() {};

        return apiClient.invokeAPI(
            "UserAddressesApi.findUserAddress",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateUserAddress200Response getUserAddress(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<CreateUserAddress200Response> getUserAddressWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getUserAddress"
            );
        }

        // create path and map variables
        String localVarPath =
            "/user_addresses/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "UserAddressesApi.getUserAddress",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
