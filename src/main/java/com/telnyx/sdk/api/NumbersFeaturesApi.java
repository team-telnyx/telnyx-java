...
public class NumbersFeaturesApi {
   ...
   */
    public PostNumbersFeatures200Response postNumbersFeatures(
        PostNumbersFeaturesRequest postNumbersFeaturesRequest
    ) throws ApiException {
        return postNumbersFeaturesWithHttpInfo(
   ...
   */
    ...
    > postNumbersFeaturesWithHttpInfo(
        PostNumbersFeaturesRequest postNumbersFeaturesRequest
    ) throws ApiException {
        ...
        if (postNumbersFeaturesRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'postNumbersFeaturesRequest' when calling postNumbersFeatures"
            );
        }
        ...
        GenericType<PostNumbersFeatures200Response> localVarReturnType =
            new GenericType<PostNumbersFeatures200Response>() {};

        return apiClient.invokeAPI(
            "NumbersFeaturesApi.postNumbersFeatures",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
