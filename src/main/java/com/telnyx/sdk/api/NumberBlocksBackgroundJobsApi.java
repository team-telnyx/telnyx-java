...
public class NumberBlocksBackgroundJobsApi {
    ...
    > createPhoneNumberBlocksJobDeletePhoneNumberBlockWithHttpInfo(
        ...
        if (phoneNumberBlocksJobDeletePhoneNumberBlockRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'phoneNumberBlocksJobDeletePhoneNumberBlockRequest' when calling createPhoneNumberBlocksJobDeletePhoneNumberBlock"
            );
        }
        ...
        return apiClient.invokeAPI(
            "NumberBlocksBackgroundJobsApi.createPhoneNumberBlocksJobDeletePhoneNumberBlock",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIcreatePhoneNumberBlocksJobDeletePhoneNumberBlockRequest {
         ...
         */
        public APIcreatePhoneNumberBlocksJobDeletePhoneNumberBlockRequest phoneNumberBlocksJobDeletePhoneNumberBlockRequest(
            PhoneNumberBlocksJobDeletePhoneNumberBlockRequest phoneNumberBlocksJobDeletePhoneNumberBlockRequest
        ) {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return createPhoneNumberBlocksJobDeletePhoneNumberBlockWithHttpInfo(
                phoneNumberBlocksJobDeletePhoneNumberBlockRequest
            );
        }
    }
   ...
   */
    public APIcreatePhoneNumberBlocksJobDeletePhoneNumberBlockRequest createPhoneNumberBlocksJobDeletePhoneNumberBlock()
        throws ApiException {
    ...
    > listPhoneNumberBlocksJobsWithHttpInfo(
        ...
        return apiClient.invokeAPI(
            "NumberBlocksBackgroundJobsApi.listPhoneNumberBlocksJobs",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    ...
    > retrievePhoneNumberBlocksJobWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling retrievePhoneNumberBlocksJob"
            );
        }
        ...
        return apiClient.invokeAPI(
            "NumberBlocksBackgroundJobsApi.retrievePhoneNumberBlocksJob",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public APIretrievePhoneNumberBlocksJobRequest retrievePhoneNumberBlocksJob(
        String id
    ) throws ApiException {
