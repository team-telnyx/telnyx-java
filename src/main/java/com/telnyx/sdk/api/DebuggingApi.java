...
public class DebuggingApi {
    ...
    private ApiResponse<ListCallEventsResponse> listCallEventsWithHttpInfo(
        UUID filterLegId,
        UUID filterApplicationSessionId,
        ...
        String filterType,
        String filterName,
        String filterOccurredAtGt,
        String filterOccurredAtGte,
        String filterOccurredAtLt,
        String filterOccurredAtLte,
        String filterOccurredAtEq,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[leg_id]", filterLegId)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "",
                "filter[application_session_id]",
                filterApplicationSessionId
            )
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[product]", filterProduct)
        );
        localVarQueryParams.addAll(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[failed]", filterFailed)
        );
        localVarQueryParams.addAll(
        ...
        GenericType<ListCallEventsResponse> localVarReturnType =
            new GenericType<ListCallEventsResponse>() {};

        return apiClient.invokeAPI(
            "DebuggingApi.listCallEvents",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistCallEventsRequest {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterApplicationSessionId(
            UUID filterApplicationSessionId
        ) {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterConnectionId(
            String filterConnectionId
        ) {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterOccurredAtGt(
            String filterOccurredAtGt
        ) {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterOccurredAtGte(
            String filterOccurredAtGte
        ) {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterOccurredAtLt(
            String filterOccurredAtLt
        ) {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterOccurredAtLte(
            String filterOccurredAtLte
        ) {
         ...
         * @return APIlistCallEventsRequest
         */
        public APIlistCallEventsRequest filterOccurredAtEq(
            String filterOccurredAtEq
        ) {
     ...
     */
        public ApiResponse<ListCallEventsResponse> executeWithHttpInfo()
            throws ApiException {
            return listCallEventsWithHttpInfo(
                filterLegId,
                filterApplicationSessionId,
                filterConnectionId,
                filterProduct,
