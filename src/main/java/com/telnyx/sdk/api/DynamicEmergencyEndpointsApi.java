...
public class DynamicEmergencyEndpointsApi {
   ...
   */
    public CreateDynamicEmergencyEndpoint201Response createDynamicEmergencyEndpoint(
        DynamicEmergencyEndpoint dynamicEmergencyEndpoint
    ) throws ApiException {
        return createDynamicEmergencyEndpointWithHttpInfo(
   ...
   */
    ...
    > createDynamicEmergencyEndpointWithHttpInfo(
        DynamicEmergencyEndpoint dynamicEmergencyEndpoint
    ) throws ApiException {
        ...
        if (dynamicEmergencyEndpoint == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'dynamicEmergencyEndpoint' when calling createDynamicEmergencyEndpoint"
            );
        }
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyEndpointsApi.createDynamicEmergencyEndpoint",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateDynamicEmergencyEndpoint201Response deleteDynamicEmergencyEndpoint(
        UUID id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        CreateDynamicEmergencyEndpoint201Response
    > deleteDynamicEmergencyEndpointWithHttpInfo(UUID id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteDynamicEmergencyEndpoint"
            );
        }

        // create path and map variables
        String localVarPath =
            "/dynamic_emergency_endpoints/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyEndpointsApi.deleteDynamicEmergencyEndpoint",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateDynamicEmergencyEndpoint201Response getDynamicEmergencyEndpoint(
        UUID id
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        CreateDynamicEmergencyEndpoint201Response
    > getDynamicEmergencyEndpointWithHttpInfo(UUID id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getDynamicEmergencyEndpoint"
            );
        }
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyEndpointsApi.getDynamicEmergencyEndpoint",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListDynamicEmergencyEndpoints200Response listDynamicEmergencyEndpoints(
        String filterStatus,
        String filterCountryCode,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return listDynamicEmergencyEndpointsWithHttpInfo(
            filterStatus,
            filterCountryCode,
            pageNumber,
            pageSize
   ...
   */
    ...
    > listDynamicEmergencyEndpointsWithHttpInfo(
        String filterStatus,
        String filterCountryCode,
        Integer pageNumber,
        Integer pageSize
        ...
        return apiClient.invokeAPI(
            "DynamicEmergencyEndpointsApi.listDynamicEmergencyEndpoints",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
