...
public class CallInformationApi {
    ...
    private ApiResponse<
        ActiveCallsResponse
    > listConnectionActiveCallsWithHttpInfo(
        ...
        if (connectionIdWireless == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'connectionIdWireless' when calling listConnectionActiveCalls"
            );
        }

        // create path and map variables
        String localVarPath =
            "/connections/{connection_id_wireless}/active_calls".replaceAll(
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "page[limit]", pageLimit)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "page[after]", pageAfter)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "page[before]", pageBefore)
        );
        ...
        GenericType<ActiveCallsResponse> localVarReturnType = new GenericType<
            ActiveCallsResponse
        >() {};

        return apiClient.invokeAPI(
            "CallInformationApi.listConnectionActiveCalls",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistConnectionActiveCallsRequest {
        ...
        private APIlistConnectionActiveCallsRequest(
            String connectionIdWireless
        ) {
         ...
         */
        public APIlistConnectionActiveCallsRequest pageLimit(
            Integer pageLimit
        ) {
         ...
         * @return APIlistConnectionActiveCallsRequest
         */
        public APIlistConnectionActiveCallsRequest pageBefore(
            String pageBefore
        ) {
     ...
     */
        public ApiResponse<ActiveCallsResponse> executeWithHttpInfo()
            throws ApiException {
            return listConnectionActiveCallsWithHttpInfo(
   ...
   */
    public APIlistConnectionActiveCallsRequest listConnectionActiveCalls(
        String connectionIdWireless
    ) throws ApiException {
   ...
   */
    public RetrieveCallStatusResponse retrieveCallStatus(String callControlId)
        throws ApiException {
   ...
   */
    ...
    > retrieveCallStatusWithHttpInfo(String callControlId) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (callControlId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'callControlId' when calling retrieveCallStatus"
            );
        }

        // create path and map variables
        String localVarPath =
            "/calls/{call_control_id}".replaceAll(
                    "\\{" + "call_control_id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "CallInformationApi.retrieveCallStatus",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
