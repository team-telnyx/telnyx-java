...
public class PhoneNumberBlockOrdersApi {

    private ApiClient apiClient;

    public PhoneNumberBlockOrdersApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PhoneNumberBlockOrdersApi(ApiClient apiClient) {
   ...
   */
    public NumberBlockOrderResponse createNumberBlockOrder(
        CreateNumberBlockOrderRequest createNumberBlockOrderRequest
    ) throws ApiException {
        return createNumberBlockOrderWithHttpInfo(
   ...
   */
    ...
    > createNumberBlockOrderWithHttpInfo(
        CreateNumberBlockOrderRequest createNumberBlockOrderRequest
    ) throws ApiException {
        ...
        if (createNumberBlockOrderRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createNumberBlockOrderRequest' when calling createNumberBlockOrder"
            );
        }
        ...
        GenericType<NumberBlockOrderResponse> localVarReturnType =
            new GenericType<NumberBlockOrderResponse>() {};

        return apiClient.invokeAPI(
            "PhoneNumberBlockOrdersApi.createNumberBlockOrder",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public ListNumberBlockOrdersResponse listNumberBlockOrders(
        String filterStatus,
        String filterCreatedAtGt,
        String filterCreatedAtLt,
        String filterPhoneNumbersStartingNumber,
        Integer pageNumber,
        Integer pageSize
    ) throws ApiException {
        return listNumberBlockOrdersWithHttpInfo(
            filterStatus,
            filterCreatedAtGt,
            filterCreatedAtLt,
            filterPhoneNumbersStartingNumber,
            pageNumber,
            pageSize
        ).getData();
    }
   ...
   */
    ...
    > listNumberBlockOrdersWithHttpInfo(
        String filterStatus,
        String filterCreatedAtGt,
        String filterCreatedAtLt,
        String filterPhoneNumbersStartingNumber,
        ...
        GenericType<ListNumberBlockOrdersResponse> localVarReturnType =
            new GenericType<ListNumberBlockOrdersResponse>() {};

        return apiClient.invokeAPI(
            "PhoneNumberBlockOrdersApi.listNumberBlockOrders",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public NumberBlockOrderResponse retrieveNumberBlockOrder(
        String numberBlockOrderId
    ) throws ApiException {
        return retrieveNumberBlockOrderWithHttpInfo(
            numberBlockOrderId
        ).getData();
    }
   ...
   */
    public ApiResponse<
        NumberBlockOrderResponse
    > retrieveNumberBlockOrderWithHttpInfo(String numberBlockOrderId)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (numberBlockOrderId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'numberBlockOrderId' when calling retrieveNumberBlockOrder"
            );
        }

        // create path and map variables
        String localVarPath =
            "/number_block_orders/{number_block_order_id}".replaceAll(
                    "\\{" + "number_block_order_id" + "\\}",
                    apiClient.escapeString(numberBlockOrderId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "PhoneNumberBlockOrdersApi.retrieveNumberBlockOrder",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
