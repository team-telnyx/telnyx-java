...
public class RoomsApi {
   ...
   */
    public CreateRoom201Response createRoom(
   ...
   */
    public ApiResponse<CreateRoom201Response> createRoomWithHttpInfo(
        CreateRoomRequest createRoomRequest
    ) throws ApiException {
        ...
        if (createRoomRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createRoomRequest' when calling createRoom"
            );
        }
        ...
        GenericType<CreateRoom201Response> localVarReturnType = new GenericType<
   ...
   */
    public ApiResponse<Void> deleteRoomWithHttpInfo(UUID roomId)
        throws ApiException {
        ...
        if (roomId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomId' when calling deleteRoom"
            );
        }

        // create path and map variables
        String localVarPath =
            "/rooms/{room_id}".replaceAll(
                    "\\{" + "room_id" + "\\}",
                    apiClient.escapeString(roomId.toString())
                );
   ...
   */
    public ListRooms200Response listRooms(
        ...
        String filterUniqueName,
        Boolean includeSessions,
        Integer pageSize,
        Integer pageNumber
    ) throws ApiException {
        return listRoomsWithHttpInfo(
   ...
   */
    public ApiResponse<ListRooms200Response> listRoomsWithHttpInfo(
        LocalDate filterDateCreatedAtEq,
        LocalDate filterDateCreatedAtGte,
        LocalDate filterDateCreatedAtLte,
        LocalDate filterDateUpdatedAtEq,
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "include_sessions", includeSessions)
        );
        localVarQueryParams.addAll(
        ...
        GenericType<ListRooms200Response> localVarReturnType = new GenericType<
   ...
   */
    public ListRoomSessions200Response retrieveListRoomSessions(
        UUID roomId,
        LocalDate filterDateCreatedAtEq,
        LocalDate filterDateCreatedAtGte,
        LocalDate filterDateCreatedAtLte,
        ...
        return retrieveListRoomSessionsWithHttpInfo(
            roomId,
            filterDateCreatedAtEq,
            filterDateCreatedAtGte,
            filterDateCreatedAtLte,
   ...
   */
    ...
    > retrieveListRoomSessionsWithHttpInfo(
        UUID roomId,
        LocalDate filterDateCreatedAtEq,
        LocalDate filterDateCreatedAtGte,
        LocalDate filterDateCreatedAtLte,
        ...
        if (roomId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomId' when calling retrieveListRoomSessions"
            );
        }

        // create path and map variables
        String localVarPath =
            "/rooms/{room_id}/sessions".replaceAll(
                    "\\{" + "room_id" + "\\}",
                    apiClient.escapeString(roomId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "RoomsApi.retrieveListRoomSessions",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public CreateRoom201Response updateRoom(
        UUID roomId,
   ...
   */
    public ApiResponse<CreateRoom201Response> updateRoomWithHttpInfo(
        UUID roomId,
        PatchRoomRequest patchRoomRequest
    ) throws ApiException {
        ...
        if (roomId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomId' when calling updateRoom"
            );
        }
        ...
        if (patchRoomRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'patchRoomRequest' when calling updateRoom"
            );
        }
   ...
   */
    public CreateRoom201Response viewRoom(UUID roomId, Boolean includeSessions)
        throws ApiException {
   ...
   */
    public ApiResponse<CreateRoom201Response> viewRoomWithHttpInfo(
        UUID roomId,
        Boolean includeSessions
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (roomId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'roomId' when calling viewRoom"
            );
        }
