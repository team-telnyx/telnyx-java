...
public class MobileNetworkOperatorsApi {
   ...
   */
    public GetMobileNetworkOperators200Response getMobileNetworkOperators(
        Integer pageNumber,
        Integer pageSize,
        String filterNameStartsWith,
        String filterNameContains,
        String filterNameEndsWith,
        String filterCountryCode,
        String filterMcc,
        String filterMnc,
        String filterTadig,
        Boolean filterNetworkPreferencesEnabled
    ) throws ApiException {
        return getMobileNetworkOperatorsWithHttpInfo(
            pageNumber,
            pageSize,
            ...
            filterMnc,
            filterTadig,
            filterNetworkPreferencesEnabled
        ).getData();
    }
   ...
   */
    ...
    > getMobileNetworkOperatorsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterNameStartsWith,
        String filterNameContains,
        ...
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[mcc]", filterMcc)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[mnc]", filterMnc)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs("", "filter[tadig]", filterTadig)
        );
        localVarQueryParams.addAll(
            apiClient.parameterToPairs(
                "",
        ...
        GenericType<GetMobileNetworkOperators200Response> localVarReturnType =
            new GenericType<GetMobileNetworkOperators200Response>() {};

        return apiClient.invokeAPI(
            "MobileNetworkOperatorsApi.getMobileNetworkOperators",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
