...
public class InboundChannelsApi {
   ...
   */
    public ListInboundChannels200Response listInboundChannels()
        throws ApiException {
   ...
   */
    ...
    > listInboundChannelsWithHttpInfo() throws ApiException {
        ...
        GenericType<ListInboundChannels200Response> localVarReturnType =
            new GenericType<ListInboundChannels200Response>() {};

        return apiClient.invokeAPI(
            "InboundChannelsApi.listInboundChannels",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public UpdateOutboundChannels200Response updateOutboundChannels(
        UpdateOutboundChannelsRequest updateOutboundChannelsRequest
    ) throws ApiException {
        return updateOutboundChannelsWithHttpInfo(
   ...
   */
    ...
    > updateOutboundChannelsWithHttpInfo(
        UpdateOutboundChannelsRequest updateOutboundChannelsRequest
    ) throws ApiException {
        ...
        if (updateOutboundChannelsRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateOutboundChannelsRequest' when calling updateOutboundChannels"
            );
        }
        ...
        GenericType<UpdateOutboundChannels200Response> localVarReturnType =
            new GenericType<UpdateOutboundChannels200Response>() {};

        return apiClient.invokeAPI(
            "InboundChannelsApi.updateOutboundChannels",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
