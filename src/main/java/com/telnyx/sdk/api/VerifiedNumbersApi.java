...
public class VerifiedNumbersApi {
   ...
   */
    public CreateVerifiedNumberResponse createVerifiedNumber(
        CreateVerifiedNumberRequest createVerifiedNumberRequest
    ) throws ApiException {
        return createVerifiedNumberWithHttpInfo(
   ...
   */
    ...
    > createVerifiedNumberWithHttpInfo(
        CreateVerifiedNumberRequest createVerifiedNumberRequest
    ) throws ApiException {
        ...
        if (createVerifiedNumberRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createVerifiedNumberRequest' when calling createVerifiedNumber"
            );
        }
        ...
        GenericType<CreateVerifiedNumberResponse> localVarReturnType =
            new GenericType<CreateVerifiedNumberResponse>() {};

        return apiClient.invokeAPI(
            "VerifiedNumbersApi.createVerifiedNumber",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public VerifiedNumberResponseDataWrapper deleteVerifiedNumber(
        String phoneNumber
    ) throws ApiException {
   ...
   */
    ...
    > deleteVerifiedNumberWithHttpInfo(String phoneNumber) throws ApiException {
        ...
        if (phoneNumber == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'phoneNumber' when calling deleteVerifiedNumber"
            );
        }

        // create path and map variables
        String localVarPath =
            "/verified_numbers/{phone_number}".replaceAll(
                    "\\{" + "phone_number" + "\\}",
        ...
        GenericType<VerifiedNumberResponseDataWrapper> localVarReturnType =
            new GenericType<VerifiedNumberResponseDataWrapper>() {};

        return apiClient.invokeAPI(
            "VerifiedNumbersApi.deleteVerifiedNumber",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public VerifiedNumberResponseDataWrapper getVerifiedNumber(
        String phoneNumber
    ) throws ApiException {
   ...
   */
    public ApiResponse<
        VerifiedNumberResponseDataWrapper
    > getVerifiedNumberWithHttpInfo(String phoneNumber) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (phoneNumber == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'phoneNumber' when calling getVerifiedNumber"
            );
        }
        ...
        return apiClient.invokeAPI(
            "VerifiedNumbersApi.getVerifiedNumber",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listVerifiedNumbersWithHttpInfo(Integer pageSize, Integer pageNumber)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        GenericType<ListVerifiedNumbersResponse> localVarReturnType =
            new GenericType<ListVerifiedNumbersResponse>() {};

        return apiClient.invokeAPI(
            "VerifiedNumbersApi.listVerifiedNumbers",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        public ApiResponse<ListVerifiedNumbersResponse> executeWithHttpInfo()
            throws ApiException {
   ...
   */
    public APIlistVerifiedNumbersRequest listVerifiedNumbers()
        throws ApiException {
   ...
   */
    public VerifiedNumberResponseDataWrapper verifyVerificationCode(
        String phoneNumber,
        VerifyVerificationCodeRequest verifyVerificationCodeRequest
    ) throws ApiException {
        return verifyVerificationCodeWithHttpInfo(
            phoneNumber,
   ...
   */
    public ApiResponse<
        VerifiedNumberResponseDataWrapper
    > verifyVerificationCodeWithHttpInfo(
        String phoneNumber,
        VerifyVerificationCodeRequest verifyVerificationCodeRequest
    ) throws ApiException {
        ...
        if (phoneNumber == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'phoneNumber' when calling verifyVerificationCode"
            );
        }
        ...
        if (verifyVerificationCodeRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'verifyVerificationCodeRequest' when calling verifyVerificationCode"
            );
        }

        // create path and map variables
        String localVarPath =
            "/verified_numbers/{phone_number}/actions/verify".replaceAll(
                    "\\{" + "phone_number" + "\\}",
                    apiClient.escapeString(phoneNumber.toString())
                );
        ...
        return apiClient.invokeAPI(
            "VerifiedNumbersApi.verifyVerificationCode",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
