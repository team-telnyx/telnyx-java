...
public class NumberPortoutApi {
   ...
   */
  public CreatePortoutReport201Response getPortingReportId(UUID id) throws ApiException {
    return getPortingReportIdWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<CreatePortoutReport201Response> getPortingReportIdWithHttpInfo(UUID id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPortingReportId");
    }
    ...
    return apiClient.invokeAPI("NumberPortoutApi.getPortingReportId", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
