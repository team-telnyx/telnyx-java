...
public class AccessControlIpsApi {
   ...
   */
    public AccessControlIpResponse createAccessControlIp(
        AccessControlIpCreate accessControlIpCreate
    ) throws ApiException {
        return createAccessControlIpWithHttpInfo(
   ...
   */
    ...
    > createAccessControlIpWithHttpInfo(
        AccessControlIpCreate accessControlIpCreate
    ) throws ApiException {
        ...
        if (accessControlIpCreate == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accessControlIpCreate' when calling createAccessControlIp"
            );
        }
        ...
        GenericType<AccessControlIpResponse> localVarReturnType =
            new GenericType<AccessControlIpResponse>() {};

        return apiClient.invokeAPI(
            "AccessControlIpsApi.createAccessControlIp",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public AccessControlIpResponse deleteAccessControlIp(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<
        AccessControlIpResponse
    > deleteAccessControlIpWithHttpInfo(String id) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling deleteAccessControlIp"
            );
        }

        // create path and map variables
        String localVarPath =
            "/access_control_ips/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "AccessControlIpsApi.deleteAccessControlIp",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public GetAllAccessControlIpResponse findAccessControlIps(
        Integer pageNumber,
        Integer pageSize,
        String filterIpAddressEq
    ) throws ApiException {
        return findAccessControlIpsWithHttpInfo(
            pageNumber,
            pageSize,
            filterIpAddressEq
        ).getData();
   ...
   */
    ...
    > findAccessControlIpsWithHttpInfo(
        Integer pageNumber,
        Integer pageSize,
        String filterIpAddressEq
    ) throws ApiException {
        ...
        GenericType<GetAllAccessControlIpResponse> localVarReturnType =
            new GenericType<GetAllAccessControlIpResponse>() {};

        return apiClient.invokeAPI(
            "AccessControlIpsApi.findAccessControlIps",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public AccessControlIpResponse getAccessControlIp(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<AccessControlIpResponse> getAccessControlIpWithHttpInfo(
        String id
    ) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling getAccessControlIp"
            );
        }
        ...
        return apiClient.invokeAPI(
            "AccessControlIpsApi.getAccessControlIp",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public AccessControlIpResponse updateAccessControlIp(
        String id,
        AccessControlIpUpdate accessControlIpUpdate
    ) throws ApiException {
        return updateAccessControlIpWithHttpInfo(
            id,
   ...
   */
    public ApiResponse<
        AccessControlIpResponse
    > updateAccessControlIpWithHttpInfo(
        String id,
        AccessControlIpUpdate accessControlIpUpdate
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling updateAccessControlIp"
            );
        }
        ...
        if (accessControlIpUpdate == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'accessControlIpUpdate' when calling updateAccessControlIp"
            );
        }
        ...
        return apiClient.invokeAPI(
            "AccessControlIpsApi.updateAccessControlIp",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
