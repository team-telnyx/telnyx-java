...
private ApiResponse<TexmlGetCallRecordingsResponseBody> getTeXMLCallRecordingsWithHttpInfo(String accountSid, Integer page, Integer pageSize, String dateCreated) throws ApiException {
  ...
  public ApiResponse<CallResourceIndex> getTexmlCallsWithHttpInfo(String accountSid, Integer page, Integer pageSize, String pageToken, String to, String from, String status, String startTime, String startTimeGreaterThan, String startTimeLessThan, String endTime, String endTimeGreaterThan, String endTimeLessThan) throws ApiException {
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "StartTime&gt;", startTimeGreaterThan));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "StartTime&lt;", startTimeLessThan));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "EndTime", endTime));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "EndTime&gt;", endTimeGreaterThan));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "EndTime&lt;", endTimeLessThan));
...
private ApiResponse<InitiateCallResult> initiateTexmlCallOutboundWithHttpInfo(String applicationId, InitiateCallRequest initiateCallRequest) throws ApiException {
    Object localVarPostBody = initiateCallRequest;
    
    // verify the required parameter 'applicationId' is set
    if (applicationId == null) {
      throw new ApiException(400, "Missing the required parameter 'applicationId' when calling initiateTexmlCallOutbound");
    }
    
    // verify the required parameter 'initiateCallRequest' is set
    if (initiateCallRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'initiateCallRequest' when calling initiateTexmlCallOutbound");
    }
    ...
    return apiClient.invokeAPI("TeXmlRestCommandsApi.initiateTexmlCallOutbound", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }

  public class APIinitiateTexmlCallOutboundRequest {
    private String applicationId;
    private InitiateCallRequest initiateCallRequest;

    private APIinitiateTexmlCallOutboundRequest(String applicationId) {
     ...
     * Set initiateCallRequest
     * @param initiateCallRequest Iniatiate Call request object (required)
     * @return APIinitiateTexmlCallOutboundRequest
     */
    public APIinitiateTexmlCallOutboundRequest initiateCallRequest(InitiateCallRequest initiateCallRequest) {
      this.initiateCallRequest = initiateCallRequest;
      return this;
    }

    /**
     * Execute initiateTexmlCallOutbound request
     * @return InitiateCallResult
     * @throws ApiException if fails to make API call
     * @http.response.details
       <table summary="Response Details" border="1">
    ...
    /**
     * Execute initiateTexmlCallOutbound request with HTTP info returned
     * @return ApiResponse&lt;InitiateCallResult&gt;
     * @throws ApiException if fails to make API call
     * @http.response.details
       <table summary="Response Details" border="1">
     ...
     */
    public ApiResponse<InitiateCallResult> executeWithHttpInfo() throws ApiException {
      return initiateTexmlCallOutboundWithHttpInfo(applicationId, initiateCallRequest);
    }
  }
   ...
   * @return initiateTexmlCallOutboundRequest
   * @throws ApiException if fails to make API call
   
   
   */
  public APIinitiateTexmlCallOutboundRequest initiateTexmlCallOutbound(String applicationId) throws ApiException {
    return new APIinitiateTexmlCallOutboundRequest(applicationId);
  }
...
private ApiResponse<TexmlUpdateSiprecSessionResponseBody> updateTeXMLSiprecSessionWithHttpInfo(String accountSid, String callSid, String siprecSid, String status) throws ApiException {
    Object localVarPostBody = null;
    ...
    // verify the required parameter 'siprecSid' is set
    if (siprecSid == null) {
      throw new ApiException(400, "Missing the required parameter 'siprecSid' when calling updateTeXMLSiprecSession");
    }
    ...
    String localVarPath = "/texml/Accounts/{account_sid}/Calls/{call_sid}/Siprec/{siprec_sid}.json"
      .replaceAll("\\{" + "account_sid" + "\\}", apiClient.escapeString(accountSid.toString()))
      .replaceAll("\\{" + "call_sid" + "\\}", apiClient.escapeString(callSid.toString()))
      .replaceAll("\\{" + "siprec_sid" + "\\}", apiClient.escapeString(siprecSid.toString()));
  ...
  public class APIupdateTeXMLSiprecSessionRequest {
    private String accountSid;
    private String callSid;
    private String siprecSid;
    private String status;

    private APIupdateTeXMLSiprecSessionRequest(String accountSid, String callSid, String siprecSid) {
      this.accountSid = accountSid;
      this.callSid = callSid;
      this.siprecSid = siprecSid;
    }
    ...
    public ApiResponse<TexmlUpdateSiprecSessionResponseBody> executeWithHttpInfo() throws ApiException {
      return updateTeXMLSiprecSessionWithHttpInfo(accountSid, callSid, siprecSid, status);
    }
  }
   ...
   * @param accountSid The id of the account the resource belongs to. (required)
   * @param callSid The CallSid that identifies the call to update. (required)
   * @param siprecSid The siprec_sid that identifies the call to update. (required)
   * @return updateTeXMLSiprecSessionRequest
   * @throws ApiException if fails to make API call
   
   
   */
  public APIupdateTeXMLSiprecSessionRequest updateTeXMLSiprecSession(String accountSid, String callSid, String siprecSid) throws ApiException {
    return new APIupdateTeXMLSiprecSessionRequest(accountSid, callSid, siprecSid);
  }
...
private ApiResponse<TeXMLRESTCommandResponse> updateTexmlCallsWithHttpInfo(String callSid, UpdateCallRequest updateCallRequest) throws ApiException {
    Object localVarPostBody = updateCallRequest;
    
    // verify the required parameter 'callSid' is set
    if (callSid == null) {
      throw new ApiException(400, "Missing the required parameter 'callSid' when calling updateTexmlCalls");
    }
    
    // verify the required parameter 'updateCallRequest' is set
    if (updateCallRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'updateCallRequest' when calling updateTexmlCalls");
    }
    ...
    return apiClient.invokeAPI("TeXmlRestCommandsApi.updateTexmlCalls", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }

  public class APIupdateTexmlCallsRequest {
    private String callSid;
    private UpdateCallRequest updateCallRequest;

    private APIupdateTexmlCallsRequest(String callSid) {
      this.callSid = callSid;
    }
     ...
     * @return APIupdateTexmlCallsRequest
     */
    public APIupdateTexmlCallsRequest updateCallRequest(UpdateCallRequest updateCallRequest) {
      this.updateCallRequest = updateCallRequest;
      return this;
    }

    /**
     * Execute updateTexmlCalls request
    ...
    /**
     * Execute updateTexmlCalls request with HTTP info returned
    ...
    public ApiResponse<TeXMLRESTCommandResponse> executeWithHttpInfo() throws ApiException {
      return updateTexmlCallsWithHttpInfo(callSid, updateCallRequest);
    }
  }
   ...
   * Update TeXML call. Please note that the keys present in the payload MUST BE formatted in CamelCase as specified in the example.
   * @param callSid The CallSid that identifies the call to update. (required)
   * @return updateTexmlCallsRequest
   * @throws ApiException if fails to make API call
   
   
   */
  public APIupdateTexmlCallsRequest updateTexmlCalls(String callSid) throws ApiException {
    return new APIupdateTexmlCallsRequest(callSid);
  }
  /**
   ...
   * @param accountSid The id of the account the resource belongs to. (required)
   * @param conferenceSid The ConferenceSid that uniquely identifies a conference. (required)
   * @param status The new status of the resource. Specifying &#x60;completed&#x60; will end the conference and hang up all participants. (optional)
   ...
   */
  public ConferenceResource updateTexmlConference(String accountSid, String conferenceSid, String status, String announceUrl, String announceMethod) throws ApiException {
    return updateTexmlConferenceWithHttpInfo(accountSid, conferenceSid, status, announceUrl, announceMethod).getData();
  }
   ...
   */
  public ApiResponse<ConferenceResource> updateTexmlConferenceWithHttpInfo(String accountSid, String conferenceSid, String status, String announceUrl, String announceMethod) throws ApiException {
    Object localVarPostBody = null;
