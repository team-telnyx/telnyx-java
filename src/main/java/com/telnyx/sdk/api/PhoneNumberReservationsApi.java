...
public class PhoneNumberReservationsApi {
   ...
   */
    public NumberReservationResponse createNumberReservation(
        CreateNumberReservationRequest createNumberReservationRequest
    ) throws ApiException {
        return createNumberReservationWithHttpInfo(
    ...
    > createNumberReservationWithHttpInfo(
        ...
        if (createNumberReservationRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createNumberReservationRequest' when calling createNumberReservation"
            );
        }
        ...
        GenericType<NumberReservationResponse> localVarReturnType =
            new GenericType<NumberReservationResponse>() {};

        return apiClient.invokeAPI(
            "PhoneNumberReservationsApi.createNumberReservation",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public NumberReservationResponse extendNumberReservationExpiryTime(
        String numberReservationId
    ) throws ApiException {
        return extendNumberReservationExpiryTimeWithHttpInfo(
            numberReservationId
        ).getData();
    }
   ...
   */
    public ApiResponse<
        NumberReservationResponse
    > extendNumberReservationExpiryTimeWithHttpInfo(String numberReservationId)
        throws ApiException {
        ...
        if (numberReservationId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'numberReservationId' when calling extendNumberReservationExpiryTime"
            );
        }

        // create path and map variables
        String localVarPath =
            "/number_reservations/{number_reservation_id}/actions/extend".replaceAll(
                    "\\{" + "number_reservation_id" + "\\}",
                    apiClient.escapeString(numberReservationId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "PhoneNumberReservationsApi.extendNumberReservationExpiryTime",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
    ...
    > listNumberReservationsWithHttpInfo(
        ...
        String filterPhoneNumbersPhoneNumber,
        ...
        GenericType<ListNumberReservationsResponse> localVarReturnType =
            new GenericType<ListNumberReservationsResponse>() {};

        return apiClient.invokeAPI(
            "PhoneNumberReservationsApi.listNumberReservations",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIlistNumberReservationsRequest {
         ...
         */
        public APIlistNumberReservationsRequest filterStatus(
            String filterStatus
        ) {
         ...
         * @return APIlistNumberReservationsRequest
         */
        public APIlistNumberReservationsRequest filterCreatedAtGt(
            String filterCreatedAtGt
        ) {
         ...
         * @return APIlistNumberReservationsRequest
         */
        public APIlistNumberReservationsRequest filterCreatedAtLt(
            String filterCreatedAtLt
        ) {
         ...
         * @return APIlistNumberReservationsRequest
         */
        public APIlistNumberReservationsRequest filterPhoneNumbersPhoneNumber(
            String filterPhoneNumbersPhoneNumber
        ) {
         ...
         * @return APIlistNumberReservationsRequest
         */
        public APIlistNumberReservationsRequest filterCustomerReference(
            String filterCustomerReference
        ) {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return listNumberReservationsWithHttpInfo(
                filterStatus,
                filterCreatedAtGt,
                filterCreatedAtLt,
                filterPhoneNumbersPhoneNumber,
   ...
   */
    public NumberReservationResponse retrieveNumberReservation(
        String numberReservationId
    ) throws ApiException {
        return retrieveNumberReservationWithHttpInfo(
            numberReservationId
        ).getData();
    }
   ...
   */
    public ApiResponse<
        NumberReservationResponse
    > retrieveNumberReservationWithHttpInfo(String numberReservationId)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        if (numberReservationId == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'numberReservationId' when calling retrieveNumberReservation"
            );
        }

        // create path and map variables
        String localVarPath =
            "/number_reservations/{number_reservation_id}".replaceAll(
                    "\\{" + "number_reservation_id" + "\\}",
                    apiClient.escapeString(numberReservationId.toString())
                );
        ...
        return apiClient.invokeAPI(
            "PhoneNumberReservationsApi.retrieveNumberReservation",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
