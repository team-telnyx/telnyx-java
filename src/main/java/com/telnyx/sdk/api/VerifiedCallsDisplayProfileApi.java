...
public class VerifiedCallsDisplayProfileApi {
    ...
    > createProfileWithHttpInfo(
        ...
        if (createVerifiedCallsDisplayProfileRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'createVerifiedCallsDisplayProfileRequest' when calling createProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "VerifiedCallsDisplayProfileApi.createProfile",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIcreateProfileRequest {
         ...
         */
        public APIcreateProfileRequest createVerifiedCallsDisplayProfileRequest(
            CreateVerifiedCallsDisplayProfileRequest createVerifiedCallsDisplayProfileRequest
        ) {
            this.createVerifiedCallsDisplayProfileRequest =
     ...
     */
        ...
        public ShowVerifiedCallsDisplayProfileResponse execute()
            throws ApiException {
     ...
     */
        ...
        > executeWithHttpInfo() throws ApiException {
            return createProfileWithHttpInfo(
                createVerifiedCallsDisplayProfileRequest
            );
        }
    }
   ...
   */
    public void createProfileVerificationRequest(String id)
        throws ApiException {
   ...
   */
    public ApiResponse<Void> createProfileVerificationRequestWithHttpInfo(
        String id
    ) throws ApiException {
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling createProfileVerificationRequest"
            );
        }

        // create path and map variables
        String localVarPath =
            "/verified_calls_display_profiles/{id}/verification_request".replaceAll(
                    "\\{" + "id" + "\\}",
        ...
        return apiClient.invokeAPI(
            "VerifiedCallsDisplayProfileApi.createProfileVerificationRequest",
            localVarPath,
            "POST",
            localVarQueryParams,
            localVarPostBody,
    ...
    private ApiResponse<
        ShowVerifiedCallsDisplayProfileResponse
    > deleteProfileWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath =
            "/verified_calls_display_profiles/{id}".replaceAll(
                    "\\{" + "id" + "\\}",
                    apiClient.escapeString(id.toString())
                );
        ...
        return apiClient.invokeAPI(
            "VerifiedCallsDisplayProfileApi.deleteProfile",
            localVarPath,
            "DELETE",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public APIdeleteProfileRequest deleteProfile(String id)
        throws ApiException {
    ...
    private ApiResponse<
        ShowVerifiedCallsDisplayProfileResponse
    > displayProfileWithHttpInfo(String id) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (id == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'id' when calling displayProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "VerifiedCallsDisplayProfileApi.displayProfile",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
   ...
   */
    public APIdisplayProfileRequest displayProfile(String id)
        throws ApiException {
    ...
    > listProfilesWithHttpInfo(Integer pageNumber, Integer pageSize)
        throws ApiException {
        Object localVarPostBody = null;
        ...
        return apiClient.invokeAPI(
            "VerifiedCallsDisplayProfileApi.listProfiles",
            localVarPath,
            "GET",
            localVarQueryParams,
            localVarPostBody,
     ...
     */
        ...
        public ListVerifiedCallsDisplayProfilesResponse execute()
            throws ApiException {
            return this.executeWithHttpInfo().getData();
        }
   ...
   */
    ...
    private ApiResponse<Void> updateProfileWithHttpInfo(
        String id,
        ...
        if (updateVerifiedCallsDisplayProfileRequest == null) {
            throw new ApiException(
                400,
                "Missing the required parameter 'updateVerifiedCallsDisplayProfileRequest' when calling updateProfile"
            );
        }
        ...
        return apiClient.invokeAPI(
            "VerifiedCallsDisplayProfileApi.updateProfile",
            localVarPath,
            "PATCH",
            localVarQueryParams,
            localVarPostBody,
    ...
    public class APIupdateProfileRequest {
         ...
         */
        public APIupdateProfileRequest updateVerifiedCallsDisplayProfileRequest(
            UpdateVerifiedCallsDisplayProfileRequest updateVerifiedCallsDisplayProfileRequest
        ) {
            this.updateVerifiedCallsDisplayProfileRequest =
     ...
     */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return updateProfileWithHttpInfo(
                id,
                updateVerifiedCallsDisplayProfileRequest
            );
        }
   ...
   */
    public APIupdateProfileRequest updateProfile(String id)
        throws ApiException {
