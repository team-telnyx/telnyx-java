  ...
  public enum HangupCauseEnum {
    ...
    public static class Adapter extends TypeAdapter<HangupCauseEnum> {
      ...
      public HangupCauseEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return HangupCauseEnum.fromValue(value);
      }
    }
  }
  ...
  public enum HangupSourceEnum {
    ...
    public static class Adapter extends TypeAdapter<HangupSourceEnum> {
      ...
      public HangupSourceEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return HangupSourceEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_HANGUP_SOURCE = "hangup_source";
  @SerializedName(SERIALIZED_NAME_HANGUP_SOURCE)
  private HangupSourceEnum hangupSource;

  public static final String SERIALIZED_NAME_SIP_HANGUP_CAUSE = "sip_hangup_cause";
  @SerializedName(SERIALIZED_NAME_SIP_HANGUP_CAUSE)
