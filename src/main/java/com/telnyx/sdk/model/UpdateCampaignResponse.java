 ...
 */
@JsonPropertyOrder({
  UpdateCampaignResponse.JSON_PROPERTY_CAMPAIGN_ID,
  UpdateCampaignResponse.JSON_PROPERTY_CSP_ID,
  UpdateCampaignResponse.JSON_PROPERTY_RESELLER_ID,
  UpdateCampaignResponse.JSON_PROPERTY_STATUS,
  UpdateCampaignResponse.JSON_PROPERTY_CREATE_DATE,
  UpdateCampaignResponse.JSON_PROPERTY_AUTO_RENEWAL,
  UpdateCampaignResponse.JSON_PROPERTY_BILLED_DATE,
  UpdateCampaignResponse.JSON_PROPERTY_BRAND_ID,
  UpdateCampaignResponse.JSON_PROPERTY_VERTICAL,
  UpdateCampaignResponse.JSON_PROPERTY_USECASE,
  UpdateCampaignResponse.JSON_PROPERTY_SUB_USECASES,
  UpdateCampaignResponse.JSON_PROPERTY_DESCRIPTION,
  UpdateCampaignResponse.JSON_PROPERTY_EMBEDDED_LINK,
  UpdateCampaignResponse.JSON_PROPERTY_EMBEDDED_PHONE,
  UpdateCampaignResponse.JSON_PROPERTY_AFFILIATE_MARKETING,
  UpdateCampaignResponse.JSON_PROPERTY_NUMBER_POOL,
  UpdateCampaignResponse.JSON_PROPERTY_AGE_GATED,
  UpdateCampaignResponse.JSON_PROPERTY_DIRECT_LENDING,
  UpdateCampaignResponse.JSON_PROPERTY_SUBSCRIBER_OPTIN,
  UpdateCampaignResponse.JSON_PROPERTY_SUBSCRIBER_OPTOUT,
  UpdateCampaignResponse.JSON_PROPERTY_SUBSCRIBER_HELP,
  UpdateCampaignResponse.JSON_PROPERTY_SAMPLE1,
  UpdateCampaignResponse.JSON_PROPERTY_SAMPLE2,
  UpdateCampaignResponse.JSON_PROPERTY_SAMPLE3,
  UpdateCampaignResponse.JSON_PROPERTY_SAMPLE4,
  UpdateCampaignResponse.JSON_PROPERTY_SAMPLE5,
  UpdateCampaignResponse.JSON_PROPERTY_MESSAGE_FLOW,
  UpdateCampaignResponse.JSON_PROPERTY_HELP_MESSAGE
})
...
public class UpdateCampaignResponse {
  ...
  public UpdateCampaignResponse campaignId(String campaignId) {
  ...
  **/
  ...
  public UpdateCampaignResponse cspId(String cspId) {
    this.cspId = cspId;
    return this;
  }
  ...
  **/
  ...
  public UpdateCampaignResponse resellerId(String resellerId) {
  ...
  **/
  ...
  public UpdateCampaignResponse status(Status status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public UpdateCampaignResponse createDate(OffsetDateTime createDate) {
  ...
  **/
  ...
  public UpdateCampaignResponse autoRenewal(Boolean autoRenewal) {
  ...
  **/
  ...
  public UpdateCampaignResponse billedDate(OffsetDateTime billedDate) {
  ...
  **/
  ...
  public UpdateCampaignResponse brandId(String brandId) {
  ...
  **/
  ...
  public UpdateCampaignResponse vertical(Vertical vertical) {
  ...
  **/
  ...
  public UpdateCampaignResponse usecase(Usecase usecase) {
  ...
  **/
  ...
  public UpdateCampaignResponse subUsecases(Usecase subUsecases) {
  ...
  **/
  ...
  public UpdateCampaignResponse description(String description) {
  ...
  **/
  ...
  public UpdateCampaignResponse embeddedLink(Boolean embeddedLink) {
  ...
  **/
  ...
  public UpdateCampaignResponse embeddedPhone(Boolean embeddedPhone) {
  ...
  **/
  ...
  public UpdateCampaignResponse affiliateMarketing(Boolean affiliateMarketing) {
  ...
  **/
  ...
  public UpdateCampaignResponse numberPool(Boolean numberPool) {
  ...
  **/
  ...
  public UpdateCampaignResponse ageGated(Boolean ageGated) {
  ...
  **/
  ...
  public UpdateCampaignResponse directLending(Boolean directLending) {
  ...
  **/
  ...
  public UpdateCampaignResponse subscriberOptin(Boolean subscriberOptin) {
  ...
  **/
  ...
  public UpdateCampaignResponse subscriberOptout(Boolean subscriberOptout) {
  ...
  **/
  ...
  public UpdateCampaignResponse subscriberHelp(Boolean subscriberHelp) {
  ...
  **/
  ...
  public UpdateCampaignResponse sample1(String sample1) {
  ...
  **/
  ...
  public UpdateCampaignResponse sample2(String sample2) {
  ...
  **/
  ...
  public UpdateCampaignResponse sample3(String sample3) {
  ...
  **/
  ...
  public UpdateCampaignResponse sample4(String sample4) {
  ...
  **/
  ...
  public UpdateCampaignResponse sample5(String sample5) {
  ...
  **/
  ...
  public UpdateCampaignResponse messageFlow(String messageFlow) {
  ...
  **/
  ...
  public UpdateCampaignResponse helpMessage(String helpMessage) {
  ...
  **/
  ...
  /**
   * Return true if this UpdateCampaignResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.campaignId, updateCampaignResponse.campaignId) &&
        Objects.equals(this.cspId, updateCampaignResponse.cspId) &&
        Objects.equals(this.resellerId, updateCampaignResponse.resellerId) &&
        Objects.equals(this.status, updateCampaignResponse.status) &&
        Objects.equals(this.createDate, updateCampaignResponse.createDate) &&
        Objects.equals(this.autoRenewal, updateCampaignResponse.autoRenewal) &&
        Objects.equals(this.billedDate, updateCampaignResponse.billedDate) &&
        Objects.equals(this.brandId, updateCampaignResponse.brandId) &&
        Objects.equals(this.vertical, updateCampaignResponse.vertical) &&
        Objects.equals(this.usecase, updateCampaignResponse.usecase) &&
        Objects.equals(this.subUsecases, updateCampaignResponse.subUsecases) &&
        Objects.equals(this.description, updateCampaignResponse.description) &&
        Objects.equals(this.embeddedLink, updateCampaignResponse.embeddedLink) &&
        Objects.equals(this.embeddedPhone, updateCampaignResponse.embeddedPhone) &&
        Objects.equals(this.affiliateMarketing, updateCampaignResponse.affiliateMarketing) &&
        Objects.equals(this.numberPool, updateCampaignResponse.numberPool) &&
        Objects.equals(this.ageGated, updateCampaignResponse.ageGated) &&
        Objects.equals(this.directLending, updateCampaignResponse.directLending) &&
        Objects.equals(this.subscriberOptin, updateCampaignResponse.subscriberOptin) &&
        Objects.equals(this.subscriberOptout, updateCampaignResponse.subscriberOptout) &&
        Objects.equals(this.subscriberHelp, updateCampaignResponse.subscriberHelp) &&
        Objects.equals(this.sample1, updateCampaignResponse.sample1) &&
        Objects.equals(this.sample2, updateCampaignResponse.sample2) &&
        Objects.equals(this.sample3, updateCampaignResponse.sample3) &&
        Objects.equals(this.sample4, updateCampaignResponse.sample4) &&
        Objects.equals(this.sample5, updateCampaignResponse.sample5) &&
        Objects.equals(this.messageFlow, updateCampaignResponse.messageFlow) &&
        Objects.equals(this.helpMessage, updateCampaignResponse.helpMessage);
  }
