 ...
 */
@JsonPropertyOrder({
  BaseMessageRequest.JSON_PROPERTY_TEXT,
  BaseMessageRequest.JSON_PROPERTY_SUBJECT,
  BaseMessageRequest.JSON_PROPERTY_MEDIA_URLS,
  BaseMessageRequest.JSON_PROPERTY_WEBHOOK_URL,
  BaseMessageRequest.JSON_PROPERTY_WEBHOOK_FAILOVER_URL,
  BaseMessageRequest.JSON_PROPERTY_USE_PROFILE_WEBHOOKS,
  BaseMessageRequest.JSON_PROPERTY_TYPE,
  BaseMessageRequest.JSON_PROPERTY_AUTO_DETECT
})
...
public class BaseMessageRequest {
  ...
  **/
  ...
  /**
   * Return true if this BaseMessageRequest object is equal to o.
   */
  @Override
