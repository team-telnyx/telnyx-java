 ...
 */
@JsonPropertyOrder(
    { Language.JSON_PROPERTY_POLICY, Language.JSON_PROPERTY_CODE }
)
...
public class Language {
    ...
    @ApiModelProperty(
        required = true,
        value = "The language policy the message should follow"
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "The code of the language or locale to use — Accepts both language and language_locale formats (e.g., en and en_US)."
    )
