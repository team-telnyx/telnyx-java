...
public class Loopcount extends AbstractOpenApiSchema {
    ...
    public static class LoopcountDeserializer extends StdDeserializer<Loopcount> {
        ...
        public LoopcountDeserializer(Class<?> vc) {
            super(vc);
        }
    ...
    public Loopcount(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Loopcount(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
