 ...
 */
@ApiModel(
    description = "The URL shortener feature allows automatic replacement of URLs that were generated using a public URL shortener service. Some examples include bit.do, bit.ly, goo.gl, ht.ly, is.gd, ow.ly, rebrand.ly, t.co, tiny.cc, and tinyurl.com. Such URLs are replaced with with links generated by Telnyx. The use of custom links can improve branding and message deliverability.  To disable this feature, set the object field to `null`. "
)
@JsonPropertyOrder(
    {
...
public class UrlShortenerSettings {
    ...
    public static final String JSON_PROPERTY_REPLACE_BLACKLIST_ONLY =
    ...
    @ApiModelProperty(
        example = "acct.fyi",
        required = true,
        value = "One of the domains provided by the Telnyx URL shortener service. "
    )
    ...
    @ApiModelProperty(
        example = "",
        value = "Optional prefix that can be used to identify your brand, and will appear in the Telnyx generated URLs after the domain name. "
    )
    ...
    public UrlShortenerSettings replaceBlacklistOnly(
        Boolean replaceBlacklistOnly
    ) {
    ...
    @ApiModelProperty(
        example = "true",
        value = "Use the link replacement tool only for links that are specifically blacklisted by Telnyx. "
    )
    ...
    @ApiModelProperty(
        example = "false",
        value = "Receive webhooks for when your replaced links are clicked. Webhooks are sent to the webhooks on the messaging profile. "
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.domain, urlShortenerSettings.domain) &&
            Objects.equals(this.prefix, urlShortenerSettings.prefix) &&
            Objects.equals(
                this.replaceBlacklistOnly,
                urlShortenerSettings.replaceBlacklistOnly
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    replaceBlacklistOnly: ")
            .append(toIndentedString(replaceBlacklistOnly))
            .append("\n");
        sb
            .append("    sendWebhooks: ")
            .append(toIndentedString(sendWebhooks))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
