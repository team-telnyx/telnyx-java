...
public class DocReqsRequirementTypeAcceptanceCriteria {
    ...
    public DocReqsRequirementTypeAcceptanceCriteria timeLimit(
        String timeLimit
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "Specifies time-based acceptance criteria"
    )
    ...
    public DocReqsRequirementTypeAcceptanceCriteria localityLimit(
    ...
    @ApiModelProperty(
        ...
        value = "Specifies geography-based acceptance criteria"
    )
    ...
    public DocReqsRequirementTypeAcceptanceCriteria acceptableValues(
    ...
    public DocReqsRequirementTypeAcceptanceCriteria addacceptableValuesItem(
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Specifies the list of strictly possible values for the requirement. Ignored when empty"
    )
    ...
    public DocReqsRequirementTypeAcceptanceCriteria maxLength(
        Integer maxLength
    ) {
    ...
    @ApiModelProperty(
        example = "20",
        value = "Maximum length allowed for the value"
    )
    ...
    public DocReqsRequirementTypeAcceptanceCriteria minLength(
        Integer minLength
    ) {
    ...
    @ApiModelProperty(
        example = "16",
        value = "Minimum length allowed for the value"
    )
    ...
    public DocReqsRequirementTypeAcceptanceCriteria acceptableCharacters(
    ...
    @ApiModelProperty(
        ...
        value = "Specifies the allowed characters as a string"
    )
    ...
    public DocReqsRequirementTypeAcceptanceCriteria caseSensitive(
    ...
    @ApiModelProperty(
        example = "true",
        value = "Specifies whether string matching should be case sensitive"
    )
    ...
    @ApiModelProperty(
        example = "^[A-Z0-9]+$",
        value = "A regular expression pattern that the value must match"
    )
    ...
    public boolean equals(Object o) {
        ...
        DocReqsRequirementTypeAcceptanceCriteria docReqsRequirementTypeAcceptanceCriteria =
            (DocReqsRequirementTypeAcceptanceCriteria) o;
        return (
            Objects.equals(
                this.timeLimit,
                docReqsRequirementTypeAcceptanceCriteria.timeLimit
            ) &&
            Objects.equals(
                this.localityLimit,
                docReqsRequirementTypeAcceptanceCriteria.localityLimit
            ) &&
            Objects.equals(
                this.acceptableValues,
                docReqsRequirementTypeAcceptanceCriteria.acceptableValues
            ) &&
            Objects.equals(
                this.maxLength,
                docReqsRequirementTypeAcceptanceCriteria.maxLength
            ) &&
            Objects.equals(
                this.minLength,
                docReqsRequirementTypeAcceptanceCriteria.minLength
            ) &&
            Objects.equals(
                this.acceptableCharacters,
                docReqsRequirementTypeAcceptanceCriteria.acceptableCharacters
            ) &&
            Objects.equals(
                this.caseSensitive,
                docReqsRequirementTypeAcceptanceCriteria.caseSensitive
            ) &&
            Objects.equals(
                this.regex,
                docReqsRequirementTypeAcceptanceCriteria.regex
            )
        );
    }
