...
public class ConferenceRecordingSavedPayload {
    ...
    public static final String JSON_PROPERTY_PUBLIC_RECORDING_URLS =
    ...
    @ApiModelProperty(
        example = "single",
        value = "Whether recording was recorded in `single` or `dual` channel."
    )
    ...
    @ApiModelProperty(
        example = "428c31b6-abf3-3bc1-b7f4-5013ef9657c1",
        value = "ID of the conference that is being recorded."
    )
    ...
    public ConferenceRecordingSavedPayload publicRecordingUrls(
        CallRecordingSavedPayloadPublicRecordingUrls publicRecordingUrls
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_PUBLIC_RECORDING_URLS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPublicRecordingUrls(
        CallRecordingSavedPayloadPublicRecordingUrls publicRecordingUrls
    ) {
        this.publicRecordingUrls = publicRecordingUrls;
    }

    public ConferenceRecordingSavedPayload recordingEndedAt(
        OffsetDateTime recordingEndedAt
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 datetime of when recording ended."
    )
    ...
    @ApiModelProperty(
        ...
        value = "ID of the conference recording."
    )
    ...
    public ConferenceRecordingSavedPayload recordingStartedAt(
        OffsetDateTime recordingStartedAt
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 datetime of when recording started."
    )
    ...
    public ConferenceRecordingSavedPayload recordingUrls(
        CallRecordingSavedPayloadRecordingUrls recordingUrls
    ) {
    ...
    public boolean equals(Object o) {
        ...
        ConferenceRecordingSavedPayload conferenceRecordingSavedPayload =
            (ConferenceRecordingSavedPayload) o;
        return (
            Objects.equals(
                this.callControlId,
                conferenceRecordingSavedPayload.callControlId
            ) &&
            Objects.equals(
                this.callSessionId,
                conferenceRecordingSavedPayload.callSessionId
            ) &&
            Objects.equals(
                this.clientState,
                conferenceRecordingSavedPayload.clientState
            ) &&
            Objects.equals(
                this.channels,
                conferenceRecordingSavedPayload.channels
            ) &&
            Objects.equals(
                this.conferenceId,
                conferenceRecordingSavedPayload.conferenceId
            ) &&
            Objects.equals(
                this.connectionId,
                conferenceRecordingSavedPayload.connectionId
            ) &&
            Objects.equals(
                this.format,
                conferenceRecordingSavedPayload.format
            ) &&
            Objects.equals(
                this.publicRecordingUrls,
                conferenceRecordingSavedPayload.publicRecordingUrls
            ) &&
            Objects.equals(
                this.recordingEndedAt,
                conferenceRecordingSavedPayload.recordingEndedAt
            ) &&
            Objects.equals(
                this.recordingId,
                conferenceRecordingSavedPayload.recordingId
            ) &&
            Objects.equals(
                this.recordingStartedAt,
                conferenceRecordingSavedPayload.recordingStartedAt
            ) &&
            Objects.equals(
                this.recordingUrls,
                conferenceRecordingSavedPayload.recordingUrls
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    publicRecordingUrls: ")
            .append(toIndentedString(publicRecordingUrls))
            .append("\n");
        sb
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    recordingUrls: ")
            .append(toIndentedString(recordingUrls))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
