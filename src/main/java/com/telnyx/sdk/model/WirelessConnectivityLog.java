...
public class WirelessConnectivityLog {
    ...
    public static final String JSON_PROPERTY_MOBILE_COUNTRY_CODE =
        "mobile_country_code";
    private String mobileCountryCode;

    public static final String JSON_PROPERTY_MOBILE_NETWORK_CODE =
        "mobile_network_code";
    ...
    public static final String JSON_PROPERTY_RADIO_ACCESS_TECHNOLOGY =
    ...
    public WirelessConnectivityLog(
        ...
        @JsonProperty(
            JSON_PROPERTY_MOBILE_COUNTRY_CODE
        ...
        @JsonProperty(
            JSON_PROPERTY_RADIO_ACCESS_TECHNOLOGY
    ...
    @ApiModelProperty(
        example = "137509451",
        value = "Uniquely identifies the session."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The identification UUID of the related SIM card resource."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The type of the session, 'registration' being the initial authentication session and 'data' the actual data transfer sessions."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The International Mobile Equipment Identity (or IMEI) is a number, usually unique, that identifies the device currently being used connect to the network."
    )
    ...
    @ApiModelProperty(
        example = "310",
        value = "It's a three decimal digit that identifies a country.<br/><br/> This code is commonly seen joined with a Mobile Network Code (MNC) in a tuple that allows identifying a carrier known as PLMN (Public Land Mobile Network) code."
    )
    ...
    @ApiModelProperty(
        example = "410",
        value = "It's a two to three decimal digits that identify a network.<br/><br/>  This code is commonly seen joined with a Mobile Country Code (MCC) in a tuple that allows identifying a carrier known as PLMN (Public Land Mobile Network) code."
    )
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 formatted date-time indicating when the session started."
    )
    ...
    @ApiModelProperty(
        example = "2018-02-02T22:25:27.521Z",
        value = "ISO 8601 formatted date-time indicating when the session ended."
    )
    ...
    @ApiModelProperty(
        example = "2018-02-02T22:25:27.521Z",
        value = "ISO 8601 formatted date-time indicating when the record was created."
    )
    ...
    @ApiModelProperty(
        example = "2018-02-02T22:25:27.521Z",
        value = "ISO 8601 formatted date-time indicating when the last heartbeat to the device was successfully recorded."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The Access Point Name (APN) identifies the packet data network that a mobile data user wants to communicate with."
    )
    ...
    @ApiModelProperty(
        example = "LTE",
        value = "The radio technology the SIM card used during the session."
    )
    ...
    @ApiModelProperty(
        example = "provisioned",
        value = "The state of the SIM card after when the session happened."
    )
    ...
    @ApiModelProperty(
        example = "311210-6813",
        value = "The cell ID to which the SIM connected."
    )
    ...
    public boolean equals(Object o) {
        ...
        WirelessConnectivityLog wirelessConnectivityLog =
            (WirelessConnectivityLog) o;
        return (
            Objects.equals(
                this.recordType,
                wirelessConnectivityLog.recordType
            ) &&
            ...
            Objects.equals(
                ...
                wirelessConnectivityLog.mobileCountryCode
            ) &&
            Objects.equals(
                this.mobileNetworkCode,
                wirelessConnectivityLog.mobileNetworkCode
            ) &&
            ...
            Objects.equals(
                ...
                wirelessConnectivityLog.radioAccessTechnology
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    logType: ")
            .append(toIndentedString(logType))
            .append("\n");
        sb.append("    imsi: ").append(toIndentedString(imsi)).append("\n");
        sb.append("    imei: ").append(toIndentedString(imei)).append("\n");
        sb
            .append("    mobileCountryCode: ")
            .append(toIndentedString(mobileCountryCode))
            .append("\n");
        sb
            .append("    mobileNetworkCode: ")
            .append(toIndentedString(mobileNetworkCode))
            .append("\n");
        sb
            .append("    startTime: ")
        ...
        sb
            .append("    stopTime: ")
            .append(toIndentedString(stopTime))
            .append("\n");
        sb
            .append("    createdAt: ")
        ...
        sb
            .append("    radioAccessTechnology: ")
            .append(toIndentedString(radioAccessTechnology))
            .append("\n");
