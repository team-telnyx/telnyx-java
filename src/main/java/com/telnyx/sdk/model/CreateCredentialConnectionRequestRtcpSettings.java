...
public class CreateCredentialConnectionRequestRtcpSettings {
    ...
    public static final String JSON_PROPERTY_CAPTURE_ENABLED =
        "capture_enabled";
    private Boolean captureEnabled = false;

    public static final String JSON_PROPERTY_REPORT_FREQUENCY_SECONDS =
    ...
    @ApiModelProperty(
        value = "RTCP port by default is rtp+1, it can also be set to rtcp-mux"
    )
    ...
    public CreateCredentialConnectionRequestRtcpSettings captureEnabled(
    ...
    @ApiModelProperty(
        example = "true",
        value = "BETA - Enable the capture and storage of RTCP messages to create QoS reports on the Telnyx Mission Control Portal."
    )
    ...
    public CreateCredentialConnectionRequestRtcpSettings reportFrequencySeconds(
        Integer reportFrequencySeconds
    ) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "RTCP reports are sent to customers based on the frequency set. Frequency is in seconds and it can be set to values from 5 to 3000 seconds."
    )
    ...
    public boolean equals(Object o) {
        ...
        CreateCredentialConnectionRequestRtcpSettings createCredentialConnectionRequestRtcpSettings =
            (CreateCredentialConnectionRequestRtcpSettings) o;
        return (
            Objects.equals(
                this.port,
                createCredentialConnectionRequestRtcpSettings.port
            ) &&
            Objects.equals(
                this.captureEnabled,
                createCredentialConnectionRequestRtcpSettings.captureEnabled
            ) &&
            Objects.equals(
                this.reportFrequencySeconds,
                createCredentialConnectionRequestRtcpSettings.reportFrequencySeconds
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    captureEnabled: ")
            .append(toIndentedString(captureEnabled))
            .append("\n");
        sb
            .append("    reportFrequencySeconds: ")
            .append(toIndentedString(reportFrequencySeconds))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
