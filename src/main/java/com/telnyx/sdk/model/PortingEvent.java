...
public class PortingEvent {
  ...
  public enum EventTypeEnum {
    ...
    PORTING_ORDER_MESSAGING_CHANGED(String.valueOf("porting_order.messaging_changed")),
    
    PORTING_ORDER_STATUS_CHANGED(String.valueOf("porting_order.status_changed")),
    
    PORTING_ORDER_SHARING_TOKEN_EXPIRED(String.valueOf("porting_order.sharing_token_expired")),
