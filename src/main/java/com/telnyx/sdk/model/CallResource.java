...
public class CallResource {
    ...
    @ApiModelProperty(
        example = "human",
        value = "The value of the answering machine detection result, if this feature was enabled for the call."
    )
    ...
    @ApiModelProperty(
        example = "inbound",
        value = "The direction of this call."
    )
    ...
    @ApiModelProperty(
        example = "12",
        value = "The duration of this call, given in seconds."
    )
    ...
    @ApiModelProperty(
        example = "Thu, 15 Jun 2023 09:56:45 +0000",
        value = "The end time of this call."
    )
    ...
    @ApiModelProperty(
        example = "+13123456789",
        value = "The phone number or SIP address that made this call."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The from number formatted for display."
    )
    ...
    @ApiModelProperty(
        example = "0.10",
        value = "The price of this call, the currency is specified in the price_unit field. Only populated when the call cost feature is enabled for the account."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The identifier of this call."
    )
    ...
    @ApiModelProperty(
        example = "Thu, 15 Jun 2023 09:56:45 +0000",
        value = "The start time of this call."
    )
    ...
    @ApiModelProperty(
        example = "+13987654321",
        value = "The phone number or SIP address that received this call."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The to number formatted for display."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The relative URI for this call."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.accountSid, callResource.accountSid) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append(toIndentedString(fromFormatted))
            .append("\n");
        ...
        sb
            .append("    toFormatted: ")
            .append(toIndentedString(toFormatted))
            .append("\n");
