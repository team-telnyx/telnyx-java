...
public class VerifiedCallsDisplayProfile {
    ...
    public static final String JSON_PROPERTY_BUSINESS_IDENTITY =
        "business_identity";
    ...
    private List<VerifiedCallsDisplayProfilePhoneNumbersInner> phoneNumbers =
        null;

    public static final String JSON_PROPERTY_CALL_REASONS = "call_reasons";
    private List<VerifiedCallsDisplayProfileCallReasonsInner> callReasons =
        null;
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        example = "My Verified Calls Display Profile",
        value = "The Verified Calls Display Profile's name"
    )
    ...
    @ApiModelProperty(
        example = "Acme Inc.",
        value = "The display name to be shown as the caller name in phones"
    )
    ...
    @ApiModelProperty(
        ...
        value = "The URL pointing to a public image file that will be displayed during calls in phones"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The approval status of the Verified Calls Display Profile in Google"
    )
    ...
    public VerifiedCallsDisplayProfile businessIdentity(
        VerifiedCallsDisplayProfileBusinessIdentity businessIdentity
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_BUSINESS_IDENTITY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setBusinessIdentity(
        VerifiedCallsDisplayProfileBusinessIdentity businessIdentity
    ) {
        this.businessIdentity = businessIdentity;
    }

    public VerifiedCallsDisplayProfile phoneNumbers(
        List<VerifiedCallsDisplayProfilePhoneNumbersInner> phoneNumbers
    ) {
        this.phoneNumbers = phoneNumbers;
        return this;
    }

    public VerifiedCallsDisplayProfile addPhoneNumbersItem(
        VerifiedCallsDisplayProfilePhoneNumbersInner phoneNumbersItem
    ) {
    ...
    public VerifiedCallsDisplayProfile callReasons(
        List<VerifiedCallsDisplayProfileCallReasonsInner> callReasons
    ) {
        this.callReasons = callReasons;
        return this;
    }

    public VerifiedCallsDisplayProfile addCallReasonsItem(
        VerifiedCallsDisplayProfileCallReasonsInner callReasonsItem
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "An ISO 8601 datetime string for when the display profile was added to the Telnyx platform"
    )
    ...
    @ApiModelProperty(
        example = "2018-01-01T00:00:00Z",
        value = "An ISO 8601 datetime string for when the display profile was updated"
    )
    ...
    public boolean equals(Object o) {
        ...
        VerifiedCallsDisplayProfile verifiedCallsDisplayProfile =
            (VerifiedCallsDisplayProfile) o;
        return (
            Objects.equals(
                this.recordType,
                verifiedCallsDisplayProfile.recordType
            ) &&
            Objects.equals(this.id, verifiedCallsDisplayProfile.id) &&
            Objects.equals(this.name, verifiedCallsDisplayProfile.name) &&
            Objects.equals(
                this.displayName,
                verifiedCallsDisplayProfile.displayName
            ) &&
            ...
            Objects.equals(
                ...
                verifiedCallsDisplayProfile.businessIdentity
            ) &&
            Objects.equals(
                this.phoneNumbers,
                verifiedCallsDisplayProfile.phoneNumbers
            ) &&
            Objects.equals(
                this.callReasons,
                verifiedCallsDisplayProfile.callReasons
            ) &&
            Objects.equals(
                this.createdAt,
                verifiedCallsDisplayProfile.createdAt
            ) &&
            Objects.equals(
                this.updatedAt,
                verifiedCallsDisplayProfile.updatedAt
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    businessIdentity: ")
            .append(toIndentedString(businessIdentity))
            .append("\n");
        sb
            .append("    phoneNumbers: ")
        ...
        sb
            .append("    callReasons: ")
            .append(toIndentedString(callReasons))
            .append("\n");
        sb
            .append("    createdAt: ")
