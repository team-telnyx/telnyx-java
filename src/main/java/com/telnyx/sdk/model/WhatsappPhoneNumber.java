...
public class WhatsappPhoneNumber {
    ...
    public static final String JSON_PROPERTY_WHATSAPP_SETTINGS =
        "whatsapp_settings";
    ...
    @ApiModelProperty(
        example = "12ade33a-21c0-473b-b055-b3c836e1c292",
        value = "The owning organization's ID"
    )
    ...
    public WhatsappPhoneNumber whatsappBusinessAccountId(
        UUID whatsappBusinessAccountId
    ) {
    ...
    @ApiModelProperty(
        example = "12ade33a-21c0-473b-b055-b3c836e1c292",
        value = "The associated WhatsApp Business Account ID"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The configuration status for the phone number in the Telnyx platform"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        example = "http://mydomain.com/webhook",
        value = "The webhook url to be used by facebook"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        example = "This is our about section",
        value = "The WhatsApp about section content"
    )
    ...
    public WhatsappPhoneNumber whatsappSettings(
        WhatsappPhoneNumberWhatsappSettings whatsappSettings
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_WHATSAPP_SETTINGS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setWhatsappSettings(
        WhatsappPhoneNumberWhatsappSettings whatsappSettings
    ) {
        this.whatsappSettings = whatsappSettings;
    }
    ...
    @ApiModelProperty(
        ...
        value = "An ISO 8601 datetime string denoting when the account was added to the Telnyx platform"
    )
    ...
    @ApiModelProperty(
        example = "2018-01-01T00:00:00.000000Z",
        value = "An ISO 8601 datetime string for when the number order was updated."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, whatsappPhoneNumber.recordType) &&
            Objects.equals(this.id, whatsappPhoneNumber.id) &&
            Objects.equals(
                this.organizationId,
                whatsappPhoneNumber.organizationId
            ) &&
            Objects.equals(
                this.whatsappBusinessAccountId,
                whatsappPhoneNumber.whatsappBusinessAccountId
            ) &&
            ...
            Objects.equals(
                this.whatsappUserId,
                whatsappPhoneNumber.whatsappUserId
            ) &&
            Objects.equals(
                this.whatsappSettings,
                whatsappPhoneNumber.whatsappSettings
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    whatsappSettings: ")
            .append(toIndentedString(whatsappSettings))
            .append("\n");
        sb
            .append("    createdAt: ")
