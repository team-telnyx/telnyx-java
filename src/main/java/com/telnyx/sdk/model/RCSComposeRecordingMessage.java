 ...
 */
@ApiModel(description = "Initiate the recording and sending of an audio or video message.")
@JsonPropertyOrder({
...
public class RCSComposeRecordingMessage {
  ...
  public enum TypeEnum {
    COMPOSE_RECORDING_ACTION_TYPE_UNSPECIFIED(String.valueOf("COMPOSE_RECORDING_ACTION_TYPE_UNSPECIFIED")),
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The type of the recording action.")
  ...
  public boolean equals(Object o) {
    ...
    RCSComposeRecordingMessage rcSComposeRecordingMessage = (RCSComposeRecordingMessage) o;
    return Objects.equals(this.phoneNumber, rcSComposeRecordingMessage.phoneNumber) &&
