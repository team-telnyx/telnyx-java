...
public class UploadPortingOrderDocumentsRequest {
    ...
    private List<UploadPortingOrderDocumentsRequestDocumentsInner> documents =
        new ArrayList<>();

    public UploadPortingOrderDocumentsRequest() {}

    public UploadPortingOrderDocumentsRequest documents(
        List<UploadPortingOrderDocumentsRequestDocumentsInner> documents
    ) {
        this.documents = documents;
        return this;
    }

    public UploadPortingOrderDocumentsRequest addDocumentsItem(
        UploadPortingOrderDocumentsRequestDocumentsInner documentsItem
    ) {
    ...
    @ApiModelProperty(
        required = true,
        value = "A list of documents to be associated with a porting order."
    )
    ...
    public boolean equals(Object o) {
        ...
        UploadPortingOrderDocumentsRequest uploadPortingOrderDocumentsRequest =
            (UploadPortingOrderDocumentsRequest) o;
        return Objects.equals(
            this.documents,
            uploadPortingOrderDocumentsRequest.documents
        );
    }
