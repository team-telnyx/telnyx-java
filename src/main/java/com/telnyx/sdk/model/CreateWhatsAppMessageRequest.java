...
public class CreateWhatsAppMessageRequest {
    ...
    @ApiModelProperty(
        required = true,
        value = "The WhatsApp ID (phone number) returned from contacts endpoint."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Specifying preview_url in the request is optional when not including a URL in your message. To include a URL preview, set preview_url to true in the message body and make sure the URL begins with http:// or https://."
    )
    ...
    public boolean equals(Object o) {
        ...
        CreateWhatsAppMessageRequest createWhatsAppMessageRequest =
            (CreateWhatsAppMessageRequest) o;
        return (
            Objects.equals(
                this.whatsappUserId,
                createWhatsAppMessageRequest.whatsappUserId
            ) &&
            ...
            Objects.equals(
                this.document,
                createWhatsAppMessageRequest.document
            ) &&
            Objects.equals(this.video, createWhatsAppMessageRequest.video) &&
            Objects.equals(
                this.location,
                createWhatsAppMessageRequest.location
            ) &&
            Objects.equals(
                this.previewUrl,
                createWhatsAppMessageRequest.previewUrl
            ) &&
