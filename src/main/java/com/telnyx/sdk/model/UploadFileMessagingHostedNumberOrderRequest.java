...
public class UploadFileMessagingHostedNumberOrderRequest {
    ...
    @ApiModelProperty(
        value = "Must be a signed LOA for the numbers in the order in PDF format."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Must be the last month's bill with proof of ownership of all of the numbers in the order in PDF format."
    )
    ...
    public boolean equals(Object o) {
        ...
        UploadFileMessagingHostedNumberOrderRequest uploadFileMessagingHostedNumberOrderRequest =
            (UploadFileMessagingHostedNumberOrderRequest) o;
        return (
            Objects.equals(
                this.loa,
                uploadFileMessagingHostedNumberOrderRequest.loa
            ) &&
            Objects.equals(
                this.bill,
                uploadFileMessagingHostedNumberOrderRequest.bill
            )
        );
    }
