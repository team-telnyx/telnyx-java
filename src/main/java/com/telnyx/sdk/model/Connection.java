...
public class Connection {
    ...
    public static final String JSON_PROPERTY_WEBHOOK_EVENT_URL =
        "webhook_event_url";
    private JsonNullable<String> webhookEventUrl = JsonNullable.<
            String
        >undefined();
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the specific resource."
    )
    ...
    public Connection anchorsiteOverride(
    ...
    @ApiModelProperty(
        ...
        value = "The URL where webhooks related to this connection will be sent."
    )
    @JsonIgnore
    ...
    @JsonProperty(JSON_PROPERTY_WEBHOOK_EVENT_URL)
    public void setWebhookEventUrl_JsonNullable(
        JsonNullable<String> webhookEventUrl
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "The failover URL where webhooks related to this connection will be sent if sending to the primary URL fails."
    )
    @JsonIgnore
    ...
    public Connection webhookApiVersion(
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            equalsNullable(
                ...
                connection.webhookEventFailoverUrl
            ) &&
            Objects.equals(
                this.webhookApiVersion,
                connection.webhookApiVersion
            ) &&
            Objects.equals(
                this.outboundVoiceProfileId,
                connection.outboundVoiceProfileId
            )
        );
    }
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            createdAt,
            updatedAt,
            hashCodeNullable(webhookEventUrl),
