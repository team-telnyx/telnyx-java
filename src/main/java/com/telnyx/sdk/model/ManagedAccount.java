...
public class ManagedAccount {
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "x6oexQNHTs-fZ7-QsDMOeg", required = true, value = "The managed account's V1 API token")
  ...
  **/
  ...
  public ManagedAccount managedAccountAllowCustomPricing(Boolean managedAccountAllowCustomPricing) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.recordType, managedAccount.recordType) &&
        ...
        Objects.equals(this.organizationName, managedAccount.organizationName) &&
        Objects.equals(this.managerAccountId, managedAccount.managerAccountId) &&
        ...
        Objects.equals(this.managedAccountAllowCustomPricing, managedAccount.managedAccountAllowCustomPricing) &&
        Objects.equals(this.rollupBilling, managedAccount.rollupBilling);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recordType, id, email, apiKey, apiUser, apiToken, organizationName, managerAccountId, balance, createdAt, updatedAt, managedAccountAllowCustomPricing, rollupBilling);
  }
