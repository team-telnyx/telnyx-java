...
public class InteractiveSection {
    ...
    @ApiModelProperty(
        value = "Title of the section. Required if the message has more than one section."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Contains a list of rows. Limited to 10 rows across all sections. Required for List Messages."
    )
    ...
    public InteractiveSection productItems(
        List<InteractiveProduct> productItems
    ) {
        this.productItems = productItems;
        return this;
    }

    public InteractiveSection addProductItemsItem(
        InteractiveProduct productItemsItem
    ) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Array of product objects. There is a minimum of 1 product per section. There is a maximum of 30 products across all sections."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.title, interactiveSection.title) &&
