...
public class InboundIp {
    ...
    public static final String JSON_PROPERTY_DEFAULT_PRIMARY_IP_ID =
        "default_primary_ip_id";
    private String defaultPrimaryIpId;

    public static final String JSON_PROPERTY_DEFAULT_SECONDARY_IP_ID =
        "default_secondary_ip_id";
    private String defaultSecondaryIpId;

    public static final String JSON_PROPERTY_DEFAULT_TERTIARY_IP_ID =
    ...
    @ApiModelProperty(
        example = "192.168.0.0",
        value = "The default primary IP to use for the number. Only settable if the connection is               of IP authentication type. Value must be the ID of an authorized IP set on the connection."
    )
    ...
    @ApiModelProperty(
        example = "192.168.0.0",
        value = "The default secondary IP to use for the number. Only settable if the connection is               of IP authentication type. Value must be the ID of an authorized IP set on the connection."
    )
    ...
    @ApiModelProperty(
        example = "192.168.0.0",
        value = "The default tertiary IP to use for the number. Only settable if the connection is               of IP authentication type. Value must be the ID of an authorized IP set on the connection."
    )
    ...
    public InboundIp defaultRoutingMethod(
    ...
    public InboundIp sipCompactHeadersEnabled(
    ...
    public InboundIp sipSubdomainReceiveSettings(
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.aniNumberFormat, inboundIp.aniNumberFormat) &&
            Objects.equals(this.dnisNumberFormat, inboundIp.dnisNumberFormat) &&
            Objects.equals(this.codecs, inboundIp.codecs) &&
            Objects.equals(
                this.defaultPrimaryIpId,
                inboundIp.defaultPrimaryIpId
            ) &&
            Objects.equals(
                this.defaultSecondaryIpId,
                inboundIp.defaultSecondaryIpId
            ) &&
            Objects.equals(
                this.defaultTertiaryIpId,
                inboundIp.defaultTertiaryIpId
            ) &&
            Objects.equals(
            ...
            Objects.equals(
                ...
                inboundIp.sipSubdomainReceiveSettings
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    defaultPrimaryIpId: ")
            .append(toIndentedString(defaultPrimaryIpId))
            .append("\n");
        sb
            .append("    defaultSecondaryIpId: ")
            .append(toIndentedString(defaultSecondaryIpId))
            .append("\n");
        sb
            .append("    defaultTertiaryIpId: ")
            .append(toIndentedString(defaultTertiaryIpId))
            .append("\n");
        sb
