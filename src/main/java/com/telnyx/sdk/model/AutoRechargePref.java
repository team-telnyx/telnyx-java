...
public class AutoRechargePref {
    ...
    public static final String JSON_PROPERTY_THRESHOLD_AMOUNT =
        "threshold_amount";
    private BigDecimal thresholdAmount;

    public static final String JSON_PROPERTY_RECHARGE_AMOUNT =
        "recharge_amount";
    ...
    public static final String JSON_PROPERTY_INVOICE_ENABLED =
        "invoice_enabled";
    ...
    @ApiModelProperty(
        ...
        value = "The unique identifier for the auto recharge preference."
    )
    ...
    @ApiModelProperty(
        example = "104.00",
        value = "The threshold amount at which the account will be recharged."
    )
    ...
    @ApiModelProperty(
        example = "104.00",
        value = "The amount to recharge the account, the actual recharge amount will be the amount necessary to reach the threshold amount plus the recharge amount."
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Whether auto recharge is enabled."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The payment preference for auto recharge."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, autoRechargePref.id) &&
            Objects.equals(this.recordType, autoRechargePref.recordType) &&
            Objects.equals(
                this.thresholdAmount,
                autoRechargePref.thresholdAmount
            ) &&
            Objects.equals(
                this.rechargeAmount,
                autoRechargePref.rechargeAmount
            ) &&
            Objects.equals(this.enabled, autoRechargePref.enabled) &&
            Objects.equals(
                this.invoiceEnabled,
                autoRechargePref.invoiceEnabled
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    thresholdAmount: ")
            .append(toIndentedString(thresholdAmount))
            .append("\n");
        sb
            .append("    rechargeAmount: ")
            .append(toIndentedString(rechargeAmount))
            .append("\n");
        sb
            .append("    enabled: ")
            ...
            .append("\n");
        sb
            .append("    invoiceEnabled: ")
            .append(toIndentedString(invoiceEnabled))
            .append("\n");
        sb
            .append("    preference: ")
            .append(toIndentedString(preference))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
