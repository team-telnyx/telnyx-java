...
public class TranscriptionStartRequest {
    ...
    public static final String JSON_PROPERTY_INTERIM_RESULTS =
        "interim_results";
    private Boolean interimResults = false;

    public static final String JSON_PROPERTY_ENABLE_SPEAKER_DIARIZATION =
        "enable_speaker_diarization";
    private Boolean enableSpeakerDiarization = false;

    public static final String JSON_PROPERTY_MIN_SPEAKER_COUNT =
        "min_speaker_count";
    private Integer minSpeakerCount = 2;

    public static final String JSON_PROPERTY_MAX_SPEAKER_COUNT =
        "max_speaker_count";
    ...
    public static final String JSON_PROPERTY_TRANSCRIPTION_TRACKS =
    ...
    public TranscriptionStartRequest transcriptionEngine(
    ...
    public TranscriptionStartRequest language(
        TranscriptionStartRequestLanguage language
    ) {
    ...
    @ApiModelProperty(
        example = "true",
        value = "Whether to send also interim results. If set to false, only final results will be sent. Applies to `google` engine only."
    )
    ...
    public TranscriptionStartRequest enableSpeakerDiarization(
    ...
    public TranscriptionStartRequest transcriptionTracks(
    ...
    @ApiModelProperty(
        example = "both",
        value = "Indicates which leg of the call will be transcribed. Use `inbound` for the leg that requested the transcription, `outbound` for the other leg, and `both` for both legs of the call. Will default to `inbound`."
    )
    ...
    public boolean equals(Object o) {
        ...
        TranscriptionStartRequest transcriptionStartRequest =
            (TranscriptionStartRequest) o;
        return (
            Objects.equals(
                this.transcriptionEngine,
                transcriptionStartRequest.transcriptionEngine
            ) &&
            Objects.equals(this.language, transcriptionStartRequest.language) &&
            Objects.equals(
                this.interimResults,
                transcriptionStartRequest.interimResults
            ) &&
            Objects.equals(
                this.enableSpeakerDiarization,
                transcriptionStartRequest.enableSpeakerDiarization
            ) &&
            Objects.equals(
                this.minSpeakerCount,
                transcriptionStartRequest.minSpeakerCount
            ) &&
            Objects.equals(
                this.maxSpeakerCount,
                transcriptionStartRequest.maxSpeakerCount
            ) &&
            Objects.equals(
                this.clientState,
                transcriptionStartRequest.clientState
            ) &&
            Objects.equals(
                this.transcriptionTracks,
                transcriptionStartRequest.transcriptionTracks
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    interimResults: ")
            .append(toIndentedString(interimResults))
            .append("\n");
        sb
            .append("    enableSpeakerDiarization: ")
            .append(toIndentedString(enableSpeakerDiarization))
            .append("\n");
        sb
            .append("    minSpeakerCount: ")
            .append(toIndentedString(minSpeakerCount))
            .append("\n");
        sb
            .append("    maxSpeakerCount: ")
            .append(toIndentedString(maxSpeakerCount))
            .append("\n");
        sb
            .append("    clientState: ")
            ...
            .append("\n");
        sb
            .append("    transcriptionTracks: ")
            .append(toIndentedString(transcriptionTracks))
            .append("\n");
        sb
            .append("    commandId: ")
