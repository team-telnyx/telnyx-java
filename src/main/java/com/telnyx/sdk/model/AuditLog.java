...
public class AuditLog {
  ...
  public static final String JSON_PROPERTY_ALTERNATE_RESOURCE_ID = "alternate_resource_id";
  private JsonNullable<String> alternateResourceId = JsonNullable.<String>undefined();
  ...
  private JsonNullable<List<List<AuditEventChangesInner>>> changes = JsonNullable.<List<List<AuditEventChangesInner>>>undefined();
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALTERNATE_RESOURCE_ID)
  public void setAlternateResourceId_JsonNullable(JsonNullable<String> alternateResourceId) {
  ...
  **/
  ...
  public AuditLog changes(List<List<AuditEventChangesInner>> changes) {
    this.changes = JsonNullable.<List<List<AuditEventChangesInner>>>of(changes);
    return this;
  }

  public AuditLog addchangesItem(List<AuditEventChangesInner> changesItem) {
    if (this.changes == null || !this.changes.isPresent()) {
      this.changes = JsonNullable.<List<List<AuditEventChangesInner>>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  public JsonNullable<List<List<AuditEventChangesInner>>> getChanges_JsonNullable() {
    return changes;
  }
  
  @JsonProperty(JSON_PROPERTY_CHANGES)
  public void setChanges_JsonNullable(JsonNullable<List<List<AuditEventChangesInner>>> changes) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, auditLog.id) &&
        ...
        equalsNullable(this.alternateResourceId, auditLog.alternateResourceId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, recordType, resourceId, hashCodeNullable(alternateResourceId), changeMadeBy, hashCodeNullable(changes), organizationId, changeType, createdAt);
  }
  ...
  public String toString() {
    ...
    sb.append("    alternateResourceId: ").append(toIndentedString(alternateResourceId)).append("\n");
