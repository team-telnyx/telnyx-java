...
public class GlobalIpAssignmentUpdate {
    ...
    public static final String JSON_PROPERTY_WIREGUARD_PEER_ID =
        "wireguard_peer_id";
    private JsonNullable<Object> wireguardPeerId = JsonNullable.<Object>of(
        null
    );
    ...
    public static final String JSON_PROPERTY_IS_IN_MAINTENANCE =
        "is_in_maintenance";
    ...
    @JsonProperty(JSON_PROPERTY_WIREGUARD_PEER_ID)
    private void setWireguardPeerId_JsonNullable(
        JsonNullable<Object> wireguardPeerId
    ) {
    ...
    public boolean equals(Object o) {
        ...
        GlobalIpAssignmentUpdate globalIpAssignmentUpdate =
            (GlobalIpAssignmentUpdate) o;
        return (
            Objects.equals(this.id, globalIpAssignmentUpdate.id) &&
            Objects.equals(
                this.recordType,
                globalIpAssignmentUpdate.recordType
            ) &&
            Objects.equals(
                this.createdAt,
                globalIpAssignmentUpdate.createdAt
            ) &&
            Objects.equals(
                this.updatedAt,
                globalIpAssignmentUpdate.updatedAt
            ) &&
            equalsNullable(
                this.globalIpId,
                globalIpAssignmentUpdate.globalIpId
            ) &&
            equalsNullable(
                this.wireguardPeerId,
                globalIpAssignmentUpdate.wireguardPeerId
            ) &&
            Objects.equals(this.status, globalIpAssignmentUpdate.status) &&
            Objects.equals(
                this.isConnected,
                globalIpAssignmentUpdate.isConnected
            ) &&
            Objects.equals(
                this.isInMaintenance,
                globalIpAssignmentUpdate.isInMaintenance
            ) &&
            Objects.equals(
                this.isAnnounced,
                globalIpAssignmentUpdate.isAnnounced
            )
        );
    }
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            createdAt,
            updatedAt,
            hashCodeNullable(globalIpId),
            hashCodeNullable(wireguardPeerId),
            status,
            isConnected,
            isInMaintenance,
            isAnnounced
    ...
    public String toString() {
        ...
        sb
            .append("    isConnected: ")
            .append(toIndentedString(isConnected))
            .append("\n");
        sb
            .append("    isInMaintenance: ")
            .append(toIndentedString(isInMaintenance))
            .append("\n");
        sb
            .append("    isAnnounced: ")
            .append(toIndentedString(isAnnounced))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
