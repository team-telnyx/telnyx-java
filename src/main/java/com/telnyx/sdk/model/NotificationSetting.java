...
public class NotificationSetting {
    ...
    public static final String JSON_PROPERTY_NOTIFICATION_EVENT_CONDITION_ID =
        "notification_event_condition_id";
    private String notificationEventConditionId;

    public static final String JSON_PROPERTY_NOTIFICATION_PROFILE_ID =
    ...
    public static final String JSON_PROPERTY_ASSOCIATED_RECORD_TYPE_VALUE =
    ...
    public static final String JSON_PROPERTY_NOTIFICATION_CHANNEL_ID =
    ...
    public NotificationSetting(
        ...
        @JsonProperty(
            JSON_PROPERTY_ASSOCIATED_RECORD_TYPE
    ...
    public NotificationSetting notificationEventConditionId(
    ...
    @ApiModelProperty(
        ...
        value = "A UUID reference to the associated Notification Event Condition."
    )
    ...
    @JsonProperty(JSON_PROPERTY_NOTIFICATION_EVENT_CONDITION_ID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setNotificationEventConditionId(
        String notificationEventConditionId
    ) {
        this.notificationEventConditionId = notificationEventConditionId;
    }

    public NotificationSetting notificationProfileId(
    ...
    @ApiModelProperty(
        ...
        value = "A UUID reference to the associated Notification Profile."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Most preferences apply immediately; however, other may needs to propagate."
    )
    ...
    public NotificationSetting notificationChannelId(
    ...
    @ApiModelProperty(
        example = "12455643-3cf1-4683-ad23-1cd32f7d5e0a",
        value = "A UUID reference to the associated Notification Channel."
    )
    ...
    public NotificationSetting parameters(
        List<NotificationSettingParametersInner> parameters
    ) {
        this.parameters = parameters;
        return this;
    }

    public NotificationSetting addparametersItem(
        NotificationSettingParametersInner parametersItem
    ) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(
                this.notificationEventConditionId,
                notificationSetting.notificationEventConditionId
            ) &&
            Objects.equals(
                this.notificationProfileId,
                notificationSetting.notificationProfileId
            ) &&
            Objects.equals(
                this.associatedRecordType,
                notificationSetting.associatedRecordType
            ) &&
            Objects.equals(
                this.associatedRecordTypeValue,
                notificationSetting.associatedRecordTypeValue
            ) &&
            Objects.equals(this.status, notificationSetting.status) &&
            Objects.equals(
                this.notificationChannelId,
                notificationSetting.notificationChannelId
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    notificationEventConditionId: ")
            .append(toIndentedString(notificationEventConditionId))
            .append("\n");
        sb
            .append("    notificationProfileId: ")
            .append(toIndentedString(notificationProfileId))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    associatedRecordTypeValue: ")
            .append(toIndentedString(associatedRecordTypeValue))
            .append("\n");
        sb.append("    status: ").append(toIndentedString(status)).append("\n");
        sb
            .append("    notificationChannelId: ")
            .append(toIndentedString(notificationChannelId))
            .append("\n");
        sb
            .append("    parameters: ")
