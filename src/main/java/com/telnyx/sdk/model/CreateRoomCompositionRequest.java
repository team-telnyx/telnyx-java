...
public class CreateRoomCompositionRequest {
    ...
    private JsonNullable<String> resolution = JsonNullable.<String>of(
        "1280x720"
    );
    ...
    @ApiModelProperty(
        example = "mp4",
        value = "The desired format of the room composition."
    )
    @JsonIgnore
    ...
    @ApiModelProperty(
        example = "800x600",
        value = "The desired resolution (width/height in pixels) of the resulting video of the room composition. Both width and height are required to be between 16 and 1280; and width * height should not exceed 1280 * 720"
    )
    @JsonIgnore
    ...
    @ApiModelProperty(
        ...
        value = "id of the room session associated with the room composition."
    )
    @JsonIgnore
    ...
    public CreateRoomCompositionRequest videoLayout(
        Map<String, VideoRegion> videoLayout
    ) {
        this.videoLayout = videoLayout;
        return this;
    }

    public CreateRoomCompositionRequest putvideoLayoutItem(
        String key,
        VideoRegion videoLayoutItem
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Describes the video layout of the room composition in terms of regions."
    )
    ...
    public CreateRoomCompositionRequest webhookEventUrl(
    ...
    @ApiModelProperty(
        ...
        value = "The URL where webhooks related to this room composition will be sent. Must include a scheme, such as 'https'."
    )
    ...
    public CreateRoomCompositionRequest webhookEventFailoverUrl(
    ...
    @ApiModelProperty(
        ...
        value = "The failover URL where webhooks related to this room composition will be sent if sending to the primary URL fails. Must include a scheme, such as 'https'."
    )
    @JsonIgnore
    ...
    public CreateRoomCompositionRequest webhookTimeoutSecs(
    ...
    public boolean equals(Object o) {
        ...
        CreateRoomCompositionRequest createRoomCompositionRequest =
            (CreateRoomCompositionRequest) o;
        return (
            equalsNullable(this.format, createRoomCompositionRequest.format) &&
            equalsNullable(
                this.resolution,
                createRoomCompositionRequest.resolution
            ) &&
            equalsNullable(
                this.sessionId,
                createRoomCompositionRequest.sessionId
            ) &&
            Objects.equals(
                this.videoLayout,
                createRoomCompositionRequest.videoLayout
            ) &&
            Objects.equals(
                this.webhookEventUrl,
                createRoomCompositionRequest.webhookEventUrl
            ) &&
            equalsNullable(
                this.webhookEventFailoverUrl,
                createRoomCompositionRequest.webhookEventFailoverUrl
            ) &&
            equalsNullable(
                this.webhookTimeoutSecs,
                createRoomCompositionRequest.webhookTimeoutSecs
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    videoLayout: ")
            .append(toIndentedString(videoLayout))
            .append("\n");
        sb
