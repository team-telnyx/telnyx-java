...
public class RCSCarouselCard {
    ...
    @ApiModelProperty(
        example = "SMALL",
        required = true,
        value = "The width of the cards in the carousel."
    )
    ...
    public RCSCarouselCard addcardContentsItem(
        RCSCardContent cardContentsItem
    ) {
    ...
    @ApiModelProperty(
        required = true,
        value = "The list of contents for each card in the carousel. A carousel can have a minimum of 2 cards and a maximum 10 cards."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.cardWidth, rcSCarouselCard.cardWidth) &&
    ...
    public String toString() {
        ...
        sb
            .append("    cardContents: ")
            .append(toIndentedString(cardContents))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
