...
public class InlineResponse2002 {
  ...
  public InlineResponse2002 data(List<TexmlApplication> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(TexmlApplication dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public InlineResponse2002 meta(PaginationMeta meta) {
    this.meta = meta;
    return this;
  }
