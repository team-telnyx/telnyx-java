...
public class TemplateButtonParameter {
    ...
    @ApiModelProperty(
        required = true,
        value = "Indicates the type of parameter for the button."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Required for quick_reply buttons. Developer-defined payload that will be returned when the button is clicked in addition to the display text on the button."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Required for url buttons. Developer provided suffix that will be appended to a previously created dynamic URL button."
    )
    ...
    public boolean equals(Object o) {
        ...
        TemplateButtonParameter templateButtonParameter =
            (TemplateButtonParameter) o;
        return (
            Objects.equals(this.type, templateButtonParameter.type) &&
