...
public class PortoutComment {
    ...
    @ApiModelProperty(
        example = "0ccc7b54-4df3-4bca-a65a-3da1ecc777f0",
        required = true,
        value = "Identifies the user who created the comment. Will be null if created by Telnyx Admin"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Comment creation timestamp in ISO 8601 format"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, portoutComment.id) &&
