...
public class TnUploadEntry {
    ...
    public enum ErrorCodeEnum {
        ...
        UNABLE_TO_RETRIEVE_DEFAULT_LOCATION(
            String.valueOf("unable_to_retrieve_default_location")
        ),

        UNKNOWN_COUNTRY_CODE(String.valueOf("unknown_country_code")),

        UNABLE_TO_RETRIEVE_LOCATION(
            String.valueOf("unable_to_retrieve_location")
        ),

        UNABLE_TO_RETRIEVE_PARTNER_INFO(
            String.valueOf("unable_to_retrieve_partner_info")
        ),

        UNABLE_TO_MATCH_GEOGRAPHY_ENTRY(
            String.valueOf("unable_to_match_geography_entry")
        );
    ...
    public enum InternalStatusEnum {
        ...
        ALL_INTERNAL_JOBS_COMPLETED(
            String.valueOf("all_internal_jobs_completed")
        ),
    ...
    public static final String JSON_PROPERTY_INTERNAL_STATUS =
        "internal_status";
    private InternalStatusEnum internalStatus =
        InternalStatusEnum.PENDING_ASSIGNMENT;
    ...
    @ApiModelProperty(
        example = "error",
        value = "Represents the status of the phone number entry upload on Microsoft Teams."
    )
    ...
    @ApiModelProperty(
        ...
        value = "A code returned by Microsoft Teams if there is an error with the phone number entry upload."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "A message returned by Microsoft Teams if there is an error with the upload process."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Identifies the civic address assigned to the phone number entry."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Identifies the location assigned to the phone number entry."
    )
    ...
    @ApiModelProperty(
        example = "error",
        value = "Represents the status of the phone number entry upload on Telnyx."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.numberId, tnUploadEntry.numberId) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append(toIndentedString(internalStatus))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
