...
@JsonPropertyOrder(
    {
        InteractiveAction.JSON_PROPERTY_BUTTON,
        InteractiveAction.JSON_PROPERTY_BUTTONS,
        InteractiveAction.JSON_PROPERTY_SECTIONS,
...
public class InteractiveAction {
    ...
    public InteractiveAction button(String button) {
        this.button = button;
        return this;
    }
    ...
    @ApiModelProperty(
        value = "Button content. It cannot be an empty string and must be unique within the message. Emojis are supported, markdown is not. Required for List Messages."
    )
    ...
    public InteractiveAction buttons(List<InteractiveButton> buttons) {
        this.buttons = buttons;
        return this;
    }

    public InteractiveAction addButtonsItem(InteractiveButton buttonsItem) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "A list of buttons. Required for Reply Button Messages."
    )
    ...
    public InteractiveAction sections(List<InteractiveSection> sections) {
        this.sections = sections;
        return this;
    }

    public InteractiveAction addSectionsItem(InteractiveSection sectionsItem) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Array of section objects. Required for List Messages and Multi-Product Messages."
    )
    ...
    public InteractiveAction catalogId(String catalogId) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Unique identifier of the Facebook catalog linked to your WhatsApp Business Account. This ID can be retrieved via Commerce Manager. Required for Single Product Messages and Multi-Product Messages."
    )
    ...
    public InteractiveAction productRetailerId(String productRetailerId) {
    ...
    /**
     * Return true if this InteractiveAction object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        InteractiveAction interactiveAction = (InteractiveAction) o;
        return (
            Objects.equals(this.button, interactiveAction.button) &&
            Objects.equals(this.buttons, interactiveAction.buttons) &&
            Objects.equals(this.sections, interactiveAction.sections) &&
            Objects.equals(this.catalogId, interactiveAction.catalogId) &&
            Objects.equals(
                this.productRetailerId,
                interactiveAction.productRetailerId
            )
        );
    }
    ...
    public String toString() {
        ...
        sb.append("class InteractiveAction {\n");
