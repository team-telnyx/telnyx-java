...
public class Http {
  ...
  private JsonNullable<Integer> response = JsonNullable.<Integer>undefined();
  ...
  **/
  ...
  public Http response(Integer response) {
    this.response = JsonNullable.<Integer>of(response);
    return this;
  }
  ...
  **/
  ...
  public JsonNullable<Integer> getResponse_JsonNullable() {
    return response;
  }
  
  @JsonProperty(JSON_PROPERTY_RESPONSE)
  public void setResponse_JsonNullable(JsonNullable<Integer> response) {
