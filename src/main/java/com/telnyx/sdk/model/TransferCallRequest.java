...
public class TransferCallRequest {
    ...
    public static final String JSON_PROPERTY_TARGET_LEG_CLIENT_STATE =
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The DID or SIP URI to dial out to."
    )
    ...
    @ApiModelProperty(
        example = "+18005550101",
        value = "The `from` number to be used as the caller id presented to the destination (`to` number). The number should be in +E164 format. This attribute will default to the `to` number of the original call if omitted."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The URL of a file to be played back when the transfer destination answers before bridging the call. The URL can point to either a WAV or MP3 file. media_name and audio_url cannot be used together in one request."
    )
    ...
    @ApiModelProperty(
        example = "false",
        value = "If set to false, early media will not be passed to the originating leg."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The media_name of a file to be played back when the transfer destination answers before bridging the call. The media_name must point to a file previously uploaded to api.telnyx.com/v2/media by the same user/organization. The file must either be a WAV or MP3 file."
    )
    ...
    @ApiModelProperty(
        example = "60",
        value = "The number of seconds that Telnyx will wait for the call to be answered by the destination to which it is being transferred. If the timeout is reached before an answer is received, the call will hangup and a `call.hangup` webhook with a `hangup_cause` of `timeout` will be sent. Minimum value is 5 seconds. Maximum value is 600 seconds."
    )
    ...
    public TransferCallRequest answeringMachineDetection(
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Enables Answering Machine Detection. When a call is answered, Telnyx runs real-time detection to determine if it was picked up by a human or a machine and sends an `call.machine.detection.ended` webhook with the analysis result. If 'greeting_end' or 'detect_words' is used and a 'machine' is detected, you will receive another 'call.machine.greeting.ended' webhook when the answering machine greeting ends with a beep or silence. If `detect_beep` is used, you will only receive 'call.machine.greeting.ended' if a beep is detected."
    )
    ...
    public TransferCallRequest answeringMachineDetectionConfig(
    ...
    public TransferCallRequest customHeaders(
    ...
    public TransferCallRequest addcustomHeadersItem(
    ...
    public TransferCallRequest targetLegClientState(
    ...
    @ApiModelProperty(
        example = "aGF2ZSBhIG5pY2UgZGF5ID1d",
        value = "Use this field to add state to every subsequent webhook for the new leg. It must be a valid Base-64 encoded string."
    )
    ...
    public TransferCallRequest mediaEncryption(
        MediaEncryptionEnum mediaEncryption
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Defines whether media should be encrypted on the new call leg."
    )
    ...
    @ApiModelProperty(
        ...
        value = "SIP headers to be added to the SIP INVITE. Currently only User-to-User header is supported."
    )
    ...
    public TransferCallRequest sipTransportProtocol(
    ...
    public TransferCallRequest soundModifications(
    ...
    public TransferCallRequest webhookUrlMethod(
        WebhookUrlMethodEnum webhookUrlMethod
    ) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.to, transferCallRequest.to) &&
            Objects.equals(this.from, transferCallRequest.from) &&
            Objects.equals(
                this.fromDisplayName,
                transferCallRequest.fromDisplayName
            ) &&
            ...
            Objects.equals(
                this.timeLimitSecs,
                transferCallRequest.timeLimitSecs
            ) &&
            Objects.equals(
                this.answeringMachineDetection,
                transferCallRequest.answeringMachineDetection
            ) &&
            Objects.equals(
                this.answeringMachineDetectionConfig,
                transferCallRequest.answeringMachineDetectionConfig
            ) &&
            Objects.equals(
                this.customHeaders,
                transferCallRequest.customHeaders
            ) &&
            Objects.equals(this.clientState, transferCallRequest.clientState) &&
            Objects.equals(
                this.targetLegClientState,
                transferCallRequest.targetLegClientState
            ) &&
            Objects.equals(this.commandId, transferCallRequest.commandId) &&
            Objects.equals(
                this.mediaEncryption,
                transferCallRequest.mediaEncryption
            ) &&
            Objects.equals(
                this.sipAuthUsername,
                transferCallRequest.sipAuthUsername
            ) &&
            Objects.equals(
                this.sipAuthPassword,
                transferCallRequest.sipAuthPassword
            ) &&
            Objects.equals(this.sipHeaders, transferCallRequest.sipHeaders) &&
            Objects.equals(
                this.sipTransportProtocol,
                transferCallRequest.sipTransportProtocol
            ) &&
            Objects.equals(
                this.soundModifications,
                transferCallRequest.soundModifications
            ) &&
            Objects.equals(this.webhookUrl, transferCallRequest.webhookUrl) &&
            Objects.equals(
                this.webhookUrlMethod,
                transferCallRequest.webhookUrlMethod
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    targetLegClientState: ")
            .append(toIndentedString(targetLegClientState))
            .append("\n");
        sb
            .append("    commandId: ")
