...
public class StartRecordingRequest {
    ...
    public static final String JSON_PROPERTY_RECORDING_TRACK =
        "recording_track";
    ...
    public static final String JSON_PROPERTY_TRANSCRIPTION_ENGINE =
        "transcription_engine";
    private TranscriptionEngineEnum transcriptionEngine =
        TranscriptionEngineEnum.A;

    public static final String JSON_PROPERTY_TRANSCRIPTION_LANGUAGE =
        "transcription_language";
    private TranscriptionStartRequestLanguage transcriptionLanguage;

    public static final String JSON_PROPERTY_TRANSCRIPTION_PROFANITY_FILTER =
        "transcription_profanity_filter";
    private Boolean transcriptionProfanityFilter = false;

    public static final String JSON_PROPERTY_TRANSCRIPTION_SPEAKER_DIARIZATION =
        "transcription_speaker_diarization";
    private Boolean transcriptionSpeakerDiarization = false;

    public static final String JSON_PROPERTY_TRANSCRIPTION_MIN_SPEAKER_COUNT =
        "transcription_min_speaker_count";
    private Integer transcriptionMinSpeakerCount = 2;

    public static final String JSON_PROPERTY_TRANSCRIPTION_MAX_SPEAKER_COUNT =
    ...
    @ApiModelProperty(
        example = "mp3",
        required = true,
        value = "The audio file format used when storing the call recording. Can be either `mp3` or `wav`."
    )
    ...
    @ApiModelProperty(
        example = "single",
        required = true,
        value = "When `dual`, final audio file will be stereo recorded with the first leg on channel A, and the rest on channel B."
    )
    ...
    @ApiModelProperty(
        example = "100",
        value = "Defines the maximum length for the recording in seconds. The minimum value is 0. The maximum value is 14400. The default value is 0 (infinite)"
    )
    ...
    public StartRecordingRequest recordingTrack(
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enable post recording transcription. The default value is false."
    )
    ...
    public StartRecordingRequest transcriptionEngine(
        TranscriptionEngineEnum transcriptionEngine
    ) {
    ...
    @ApiModelProperty(
        example = "A",
        value = "Engine to use for speech recognition. `A` - `Google`, `B` - `Telnyx`."
    )
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_ENGINE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionEngine(
        TranscriptionEngineEnum transcriptionEngine
    ) {
        this.transcriptionEngine = transcriptionEngine;
    }

    public StartRecordingRequest transcriptionLanguage(
        TranscriptionStartRequestLanguage transcriptionLanguage
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_LANGUAGE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionLanguage(
        TranscriptionStartRequestLanguage transcriptionLanguage
    ) {
        this.transcriptionLanguage = transcriptionLanguage;
    }

    public StartRecordingRequest transcriptionProfanityFilter(
        Boolean transcriptionProfanityFilter
    ) {
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enables profanity_filter. Applies to `google` engine only."
    )
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_PROFANITY_FILTER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionProfanityFilter(
        Boolean transcriptionProfanityFilter
    ) {
        this.transcriptionProfanityFilter = transcriptionProfanityFilter;
    }

    public StartRecordingRequest transcriptionSpeakerDiarization(
        Boolean transcriptionSpeakerDiarization
    ) {
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enables speaker diarization. Applies to `google` engine only."
    )
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_SPEAKER_DIARIZATION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionSpeakerDiarization(
        Boolean transcriptionSpeakerDiarization
    ) {
        this.transcriptionSpeakerDiarization = transcriptionSpeakerDiarization;
    }

    public StartRecordingRequest transcriptionMinSpeakerCount(
        Integer transcriptionMinSpeakerCount
    ) {
    ...
    @ApiModelProperty(
        example = "4",
        value = "Defines minimum number of speakers in the conversation. Applies to `google` engine only."
    )
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_MIN_SPEAKER_COUNT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionMinSpeakerCount(
        Integer transcriptionMinSpeakerCount
    ) {
        this.transcriptionMinSpeakerCount = transcriptionMinSpeakerCount;
    }

    public StartRecordingRequest transcriptionMaxSpeakerCount(
        Integer transcriptionMaxSpeakerCount
    ) {
    ...
    @ApiModelProperty(
        example = "4",
        value = "Defines maximum number of speakers in the conversation. Applies to `google` engine only."
    )
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_MAX_SPEAKER_COUNT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionMaxSpeakerCount(
        Integer transcriptionMaxSpeakerCount
    ) {
        this.transcriptionMaxSpeakerCount = transcriptionMaxSpeakerCount;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.format, startRecordingRequest.format) &&
            Objects.equals(this.channels, startRecordingRequest.channels) &&
            Objects.equals(
                this.clientState,
                startRecordingRequest.clientState
            ) &&
            ...
            Objects.equals(
                this.timeoutSecs,
                startRecordingRequest.timeoutSecs
            ) &&
            Objects.equals(
                this.recordingTrack,
                startRecordingRequest.recordingTrack
            ) &&
            Objects.equals(this.trim, startRecordingRequest.trim) &&
            Objects.equals(
                this.customFileName,
                startRecordingRequest.customFileName
            ) &&
            Objects.equals(
                this.transcription,
                startRecordingRequest.transcription
            ) &&
            Objects.equals(
                this.transcriptionEngine,
                startRecordingRequest.transcriptionEngine
            ) &&
            Objects.equals(
                this.transcriptionLanguage,
                startRecordingRequest.transcriptionLanguage
            ) &&
            Objects.equals(
                this.transcriptionProfanityFilter,
                startRecordingRequest.transcriptionProfanityFilter
            ) &&
            Objects.equals(
                this.transcriptionSpeakerDiarization,
                startRecordingRequest.transcriptionSpeakerDiarization
            ) &&
            Objects.equals(
                this.transcriptionMinSpeakerCount,
                startRecordingRequest.transcriptionMinSpeakerCount
            ) &&
            Objects.equals(
                this.transcriptionMaxSpeakerCount,
                startRecordingRequest.transcriptionMaxSpeakerCount
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    transcriptionEngine: ")
            .append(toIndentedString(transcriptionEngine))
            .append("\n");
        sb
            .append("    transcriptionLanguage: ")
            .append(toIndentedString(transcriptionLanguage))
            .append("\n");
        sb
            .append("    transcriptionProfanityFilter: ")
            .append(toIndentedString(transcriptionProfanityFilter))
            .append("\n");
        sb
            .append("    transcriptionSpeakerDiarization: ")
            .append(toIndentedString(transcriptionSpeakerDiarization))
            .append("\n");
        sb
            .append("    transcriptionMinSpeakerCount: ")
            .append(toIndentedString(transcriptionMinSpeakerCount))
            .append("\n");
        sb
            .append("    transcriptionMaxSpeakerCount: ")
            .append(toIndentedString(transcriptionMaxSpeakerCount))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
