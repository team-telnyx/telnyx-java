...
public class CreateVerificationRequest {
    ...
    @ApiModelProperty(
        example = "300",
        value = "This is the number of seconds before the code of the request is expired. Once this request has expired, the code will no longer verify the user. Note: this will override the `default_timeout_secs` on the Verify profile."
    )
    ...
    public boolean equals(Object o) {
        ...
        CreateVerificationRequest createVerificationRequest =
            (CreateVerificationRequest) o;
        return (
            Objects.equals(
                this.phoneNumber,
                createVerificationRequest.phoneNumber
            ) &&
            Objects.equals(
                this.verifyProfileId,
                createVerificationRequest.verifyProfileId
            ) &&
            Objects.equals(this.type, createVerificationRequest.type) &&
            Objects.equals(
                this.timeoutSecs,
                createVerificationRequest.timeoutSecs
            )
        );
    }
