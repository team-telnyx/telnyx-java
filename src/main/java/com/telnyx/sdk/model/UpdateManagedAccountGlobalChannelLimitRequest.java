...
public class UpdateManagedAccountGlobalChannelLimitRequest {
    ...
    public UpdateManagedAccountGlobalChannelLimitRequest channelLimit(
    ...
    @ApiModelProperty(
        example = "30",
        value = "Integer value that indicates the number of allocatable global outbound channels that should be allocated to the managed account. Must be 0 or more. If the value is 0 then the account will have no usable channels and will not be able to perform outbound calling."
    )
    ...
    public boolean equals(Object o) {
        ...
        UpdateManagedAccountGlobalChannelLimitRequest updateManagedAccountGlobalChannelLimitRequest =
            (UpdateManagedAccountGlobalChannelLimitRequest) o;
        return Objects.equals(
            this.channelLimit,
            updateManagedAccountGlobalChannelLimitRequest.channelLimit
        );
    }
