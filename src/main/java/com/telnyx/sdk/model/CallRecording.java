...
public class CallRecording {
    ...
    public static final String JSON_PROPERTY_INBOUND_CALL_RECORDING_ENABLED =
    ...
    public static final String JSON_PROPERTY_INBOUND_CALL_RECORDING_FORMAT =
        "inbound_call_recording_format";
    private InboundCallRecordingFormatEnum inboundCallRecordingFormat =
        InboundCallRecordingFormatEnum.WAV;
    ...
    public static final String JSON_PROPERTY_INBOUND_CALL_RECORDING_CHANNELS =
        "inbound_call_recording_channels";
    private InboundCallRecordingChannelsEnum inboundCallRecordingChannels =
        InboundCallRecordingChannelsEnum.SINGLE;

    public CallRecording() {}

    public CallRecording inboundCallRecordingEnabled(
        Boolean inboundCallRecordingEnabled
    ) {
    ...
    @ApiModelProperty(
        value = "When enabled, any inbound call to this number will be recorded."
    )
    ...
    @JsonProperty(JSON_PROPERTY_INBOUND_CALL_RECORDING_ENABLED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setInboundCallRecordingEnabled(
        Boolean inboundCallRecordingEnabled
    ) {
        this.inboundCallRecordingEnabled = inboundCallRecordingEnabled;
    }

    public CallRecording inboundCallRecordingFormat(
        InboundCallRecordingFormatEnum inboundCallRecordingFormat
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_INBOUND_CALL_RECORDING_FORMAT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setInboundCallRecordingFormat(
        InboundCallRecordingFormatEnum inboundCallRecordingFormat
    ) {
        this.inboundCallRecordingFormat = inboundCallRecordingFormat;
    }

    public CallRecording inboundCallRecordingChannels(
        InboundCallRecordingChannelsEnum inboundCallRecordingChannels
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "When using 'dual' channels, final audio file will be stereo recorded with the first leg on channel A, and the rest on channel B."
    )
    ...
    @JsonProperty(JSON_PROPERTY_INBOUND_CALL_RECORDING_CHANNELS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setInboundCallRecordingChannels(
        InboundCallRecordingChannelsEnum inboundCallRecordingChannels
    ) {
        this.inboundCallRecordingChannels = inboundCallRecordingChannels;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                this.inboundCallRecordingEnabled,
                callRecording.inboundCallRecordingEnabled
            ) &&
            Objects.equals(
                this.inboundCallRecordingFormat,
                callRecording.inboundCallRecordingFormat
            ) &&
            Objects.equals(
                this.inboundCallRecordingChannels,
                callRecording.inboundCallRecordingChannels
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    inboundCallRecordingEnabled: ")
            .append(toIndentedString(inboundCallRecordingEnabled))
            .append("\n");
        sb
            .append("    inboundCallRecordingFormat: ")
            .append(toIndentedString(inboundCallRecordingFormat))
            .append("\n");
        sb
            .append("    inboundCallRecordingChannels: ")
            .append(toIndentedString(inboundCallRecordingChannels))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
