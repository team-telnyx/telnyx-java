...
public class Upload {
    ...
    public static final String JSON_PROPERTY_AVAILABLE_USAGES =
        "available_usages";
    ...
    public static final String JSON_PROPERTY_TN_UPLOAD_ENTRIES =
        "tn_upload_entries";
    ...
    @ApiModelProperty(
        example = "error",
        value = "Represents the status of the upload on Microsoft Teams."
    )
    ...
    public Upload addavailableUsagesItem(
        AvailableUsagesEnum availableUsagesItem
    ) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "A code returned by Microsoft Teams if there is an error with the upload process."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "A message set if there is an error with the upload process."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.ticketId, upload.ticketId) &&
    ...
    public String toString() {
        ...
        sb
            .append("    tenantId: ")
            .append(toIndentedString(tenantId))
            .append("\n");
        sb
            .append("    locationId: ")
        ...
        sb
            .append("    availableUsages: ")
            .append(toIndentedString(availableUsages))
            .append("\n");
        sb
            .append("    errorCode: ")
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    tnUploadEntries: ")
            .append(toIndentedString(tnUploadEntries))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
