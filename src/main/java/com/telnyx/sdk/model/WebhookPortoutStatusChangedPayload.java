...
public class WebhookPortoutStatusChangedPayload {
    ...
    public static final String JSON_PROPERTY_SUBSCRIBER_NAME =
        "subscriber_name";
    private String subscriberName;

    public static final String JSON_PROPERTY_REJECTION_REASON =
        "rejection_reason";
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the port out that was moved."
    )
    ...
    @ApiModelProperty(
        example = "authorized",
        value = "The new status of the port out."
    )
    ...
    public WebhookPortoutStatusChangedPayload phoneNumbers(
    ...
    public WebhookPortoutStatusChangedPayload addphoneNumbersItem(
    ...
    @ApiModelProperty(
        example = "[\"+35312345678\"]",
        value = "Phone numbers associated with this port-out order"
    )
    ...
    @ApiModelProperty(
        example = "96dfa9e4-c753-4fd3-97cd-42d66f26cf0c",
        value = "Identifies the user that the port-out order belongs to."
    )
    ...
    public WebhookPortoutStatusChangedPayload subscriberName(
    ...
    @ApiModelProperty(
        example = "John Doe",
        value = "The name of the port-out's end user."
    )
    ...
    public WebhookPortoutStatusChangedPayload rejectionReason(
    ...
    public WebhookPortoutStatusChangedPayload attemptedPin(
        String attemptedPin
    ) {
    ...
    @ApiModelProperty(
        example = "1234",
        value = "The PIN that was attempted to be used to authorize the port out."
    )
    ...
    public boolean equals(Object o) {
        ...
        WebhookPortoutStatusChangedPayload webhookPortoutStatusChangedPayload =
            (WebhookPortoutStatusChangedPayload) o;
        return (
            Objects.equals(this.id, webhookPortoutStatusChangedPayload.id) &&
            Objects.equals(
                this.status,
                webhookPortoutStatusChangedPayload.status
            ) &&
            Objects.equals(
                this.phoneNumbers,
                webhookPortoutStatusChangedPayload.phoneNumbers
            ) &&
            Objects.equals(
                this.carrierName,
                webhookPortoutStatusChangedPayload.carrierName
            ) &&
            Objects.equals(
                this.spid,
                webhookPortoutStatusChangedPayload.spid
            ) &&
            Objects.equals(
                this.userId,
                webhookPortoutStatusChangedPayload.userId
            ) &&
            Objects.equals(
                this.subscriberName,
                webhookPortoutStatusChangedPayload.subscriberName
            ) &&
            Objects.equals(
                this.rejectionReason,
                webhookPortoutStatusChangedPayload.rejectionReason
            ) &&
            Objects.equals(
                this.attemptedPin,
                webhookPortoutStatusChangedPayload.attemptedPin
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append(toIndentedString(subscriberName))
            .append("\n");
        sb
        ...
        sb
            .append("    attemptedPin: ")
            .append(toIndentedString(attemptedPin))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
