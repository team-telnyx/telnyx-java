...
public class RCSStandaloneCard {
    ...
    public enum CardOrientationEnum {
        CARD_ORIENTATION_UNSPECIFIED(
            String.valueOf("CARD_ORIENTATION_UNSPECIFIED")
        ),
    ...
    public static final String JSON_PROPERTY_CARD_ORIENTATION =
        "card_orientation";
    ...
    public enum ThumbnailImageAlignmentEnum {
        THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED(
            String.valueOf("THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED")
        ),
    ...
    public static final String JSON_PROPERTY_THUMBNAIL_IMAGE_ALIGNMENT =
    ...
    public RCSStandaloneCard cardOrientation(
        CardOrientationEnum cardOrientation
    ) {
    ...
    public RCSStandaloneCard thumbnailImageAlignment(
        ThumbnailImageAlignmentEnum thumbnailImageAlignment
    ) {
    ...
    @ApiModelProperty(
        example = "LEFT",
        required = true,
        value = "Image preview alignment for standalone cards with horizontal layout."
    )
    ...
    @JsonProperty(JSON_PROPERTY_THUMBNAIL_IMAGE_ALIGNMENT)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setThumbnailImageAlignment(
        ThumbnailImageAlignmentEnum thumbnailImageAlignment
    ) {
        this.thumbnailImageAlignment = thumbnailImageAlignment;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                ...
                rcSStandaloneCard.cardOrientation
            ) &&
            Objects.equals(
                this.thumbnailImageAlignment,
                rcSStandaloneCard.thumbnailImageAlignment
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    cardOrientation: ")
            .append(toIndentedString(cardOrientation))
            .append("\n");
        sb
            .append("    thumbnailImageAlignment: ")
            .append(toIndentedString(thumbnailImageAlignment))
            .append("\n");
        sb
            .append("    cardContent: ")
            .append(toIndentedString(cardContent))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
