...
public class WebhookPortoutFocDateChangedPayload {
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the port-out order that have the FOC date changed."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the organization that port-out order belongs to."
    )
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 formatted date indicating the new FOC date."
    )
    ...
    public boolean equals(Object o) {
        ...
        WebhookPortoutFocDateChangedPayload webhookPortoutFocDateChangedPayload =
            (WebhookPortoutFocDateChangedPayload) o;
        return (
            Objects.equals(this.id, webhookPortoutFocDateChangedPayload.id) &&
            Objects.equals(
                this.userId,
                webhookPortoutFocDateChangedPayload.userId
            ) &&
            Objects.equals(
                this.focDate,
                webhookPortoutFocDateChangedPayload.focDate
            )
        );
    }
