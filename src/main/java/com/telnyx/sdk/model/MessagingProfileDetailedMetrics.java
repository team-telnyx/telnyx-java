...
public class MessagingProfileDetailedMetrics {
    ...
    public MessagingProfileDetailedMetrics overview(
        MessagingProfileHighLevelMetrics overview
    ) {
    ...
    public MessagingProfileDetailedMetrics detailed(
        List<MessagingProfileDetailedMetric> detailed
    ) {
        this.detailed = detailed;
        return this;
    }

    public MessagingProfileDetailedMetrics adddetailedItem(
        MessagingProfileDetailedMetric detailedItem
    ) {
    ...
    public boolean equals(Object o) {
        ...
        MessagingProfileDetailedMetrics messagingProfileDetailedMetrics =
            (MessagingProfileDetailedMetrics) o;
        return (
            Objects.equals(
                this.overview,
                messagingProfileDetailedMetrics.overview
            ) &&
            Objects.equals(
                this.detailed,
                messagingProfileDetailedMetrics.detailed
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    overview: ")
            .append(toIndentedString(overview))
            .append("\n");
        sb
            .append("    detailed: ")
            .append(toIndentedString(detailed))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
