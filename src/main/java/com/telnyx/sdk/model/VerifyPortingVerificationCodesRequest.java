...
public class VerifyPortingVerificationCodesRequest {
    ...
    public static final String JSON_PROPERTY_VERIFICATION_CODES =
        "verification_codes";
    private List<
    ...
    public VerifyPortingVerificationCodesRequest verificationCodes(
        List<
            VerifyPortingVerificationCodesRequestVerificationCodesInner
        > verificationCodes
    ) {
    ...
    public VerifyPortingVerificationCodesRequest addverificationCodesItem(
        VerifyPortingVerificationCodesRequestVerificationCodesInner verificationCodesItem
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_VERIFICATION_CODES)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setVerificationCodes(
        List<
            VerifyPortingVerificationCodesRequestVerificationCodesInner
        > verificationCodes
    ) {
    ...
    public boolean equals(Object o) {
        ...
        VerifyPortingVerificationCodesRequest verifyPortingVerificationCodesRequest =
            (VerifyPortingVerificationCodesRequest) o;
        return Objects.equals(
            this.verificationCodes,
            verifyPortingVerificationCodesRequest.verificationCodes
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    verificationCodes: ")
            .append(toIndentedString(verificationCodes))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
