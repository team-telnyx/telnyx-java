...
public class GlobalIpLatencyMetric {
    ...
    public static final String JSON_PROPERTY_PROBER_LOCATION =
        "prober_location";
    ...
    public static final String JSON_PROPERTY_PERCENTILE_LATENCY =
        "percentile_latency";
    ...
    public GlobalIpLatencyMetric globalIp(
    ...
    public GlobalIpLatencyMetric proberLocation(
        GlobalIpLatencyMetricProberLocation proberLocation
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_PROBER_LOCATION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setProberLocation(
        GlobalIpLatencyMetricProberLocation proberLocation
    ) {
        this.proberLocation = proberLocation;
    }

    public GlobalIpLatencyMetric meanLatency(
        GlobalIpLatencyMetricMeanLatency meanLatency
    ) {
    ...
    public GlobalIpLatencyMetric percentileLatency(
        GlobalIpLatencyMetricPercentileLatency percentileLatency
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_PERCENTILE_LATENCY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPercentileLatency(
        GlobalIpLatencyMetricPercentileLatency percentileLatency
    ) {
        this.percentileLatency = percentileLatency;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.timestamp, globalIpLatencyMetric.timestamp) &&
            Objects.equals(this.globalIp, globalIpLatencyMetric.globalIp) &&
            Objects.equals(
                this.proberLocation,
                globalIpLatencyMetric.proberLocation
            ) &&
            Objects.equals(
                this.meanLatency,
                globalIpLatencyMetric.meanLatency
            ) &&
            Objects.equals(
                this.percentileLatency,
                globalIpLatencyMetric.percentileLatency
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    proberLocation: ")
            .append(toIndentedString(proberLocation))
            .append("\n");
        sb
            .append("    meanLatency: ")
            .append(toIndentedString(meanLatency))
            .append("\n");
        sb
            .append("    percentileLatency: ")
            .append(toIndentedString(percentileLatency))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
