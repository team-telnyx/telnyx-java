...
public class ButtonParameter {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Developer-defined payload that will be returned when the button is clicked in addition to the display text on the button. Required for quick_reply buttons."
    )
    @JsonIgnore
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Developer provided suffix that will be appended to a previously created dynamic URL button. Required for url buttons."
    )
    @JsonIgnore
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.type, buttonParameter.type) &&
    ...
    public int hashCode() {
        return Objects.hash(
            type,
            hashCodeNullable(payload),
            hashCodeNullable(text)
        );
    }
