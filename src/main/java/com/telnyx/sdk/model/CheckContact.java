...
public class CheckContact {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The value you sent in the contacts field of the JSON request."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "WhatsApp user identifier that can be used in other API calls. Only returned if the status is valid."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, checkContact.recordType) &&
