...
public class DocReqsRequirement {
    ...
    public static final String JSON_PROPERTY_REQUIREMENTS_TYPES =
        "requirements_types";
    ...
    public DocReqsRequirement(
        ...
        @JsonProperty(JSON_PROPERTY_REQUIREMENTS_TYPES) List<
    ...
    @ApiModelProperty(
        example = "FR",
        value = "The 2-character (ISO 3166-1 alpha-2) country code where this requirement applies"
    )
    ...
    @ApiModelProperty(
        example = "Nice",
        value = "The locality where this requirement applies"
    )
    ...
    public DocReqsRequirement phoneNumberType(
    ...
    @ApiModelProperty(
        example = "local",
        value = "Indicates the phone_number_type this requirement applies to. Leave blank if this requirement applies to all number_types."
    )
    ...
    @ApiModelProperty(
        example = "ordering",
        value = "Indicates whether this requirement applies to ordering, porting, or both"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Lists the requirement types necessary to fulfill this requirement"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, docReqsRequirement.recordType) &&
    ...
    public String toString() {
        ...
        sb
            .append("    requirementsTypes: ")
            .append(toIndentedString(requirementsTypes))
            .append("\n");
