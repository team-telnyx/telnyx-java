...
public class ListNumberOrderRegulatoryRequirementsResponse {
    ...
    public ListNumberOrderRegulatoryRequirementsResponse() {}

    public ListNumberOrderRegulatoryRequirementsResponse data(
        List<RegulatoryRequirement> data
    ) {
        this.data = data;
        return this;
    }

    public ListNumberOrderRegulatoryRequirementsResponse addDataItem(
        RegulatoryRequirement dataItem
    ) {
        if (this.data == null) {
    ...
    public ListNumberOrderRegulatoryRequirementsResponse meta(
        PaginationMeta meta
    ) {
        this.meta = meta;
        return this;
    ...
    public boolean equals(Object o) {
        ...
        ListNumberOrderRegulatoryRequirementsResponse listNumberOrderRegulatoryRequirementsResponse =
            (ListNumberOrderRegulatoryRequirementsResponse) o;
        return (
            Objects.equals(
                this.data,
                listNumberOrderRegulatoryRequirementsResponse.data
            ) &&
            Objects.equals(
                this.meta,
                listNumberOrderRegulatoryRequirementsResponse.meta
            )
        );
    }
