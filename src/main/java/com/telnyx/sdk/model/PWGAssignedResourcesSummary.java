...
public class PWGAssignedResourcesSummary {
    ...
    @ApiModelProperty(
        ...
        value = "The type of the resource assigned to the Private Wireless Gateway."
    )
    ...
    @ApiModelProperty(
        example = "1",
        value = "The current count of a resource type assigned to the Private Wireless Gateway."
    )
    ...
    public boolean equals(Object o) {
        ...
        PWGAssignedResourcesSummary pwGAssignedResourcesSummary =
            (PWGAssignedResourcesSummary) o;
        return (
            Objects.equals(
                this.recordType,
                pwGAssignedResourcesSummary.recordType
            ) &&
