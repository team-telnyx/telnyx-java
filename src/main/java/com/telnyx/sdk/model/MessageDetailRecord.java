...
public class MessageDetailRecord {
    ...
    public static final String JSON_PROPERTY_DELIVERY_STATUS_FAILOVER_URL =
        "delivery_status_failover_url";
    private String deliveryStatusFailoverUrl;

    public static final String JSON_PROPERTY_DELIVERY_STATUS_WEBHOOK_URL =
    ...
    public static final String JSON_PROPERTY_SOURCE_COUNTRY_CODE =
        "source_country_code";
    ...
    @ApiModelProperty(
        ...
        value = "Unique identifier of the message"
    )
    ...
    @ApiModelProperty(
        example = "3ca7bd3d-7d82-4e07-9df4-009123068320",
        value = "Identifier of the Telnyx account who owns the message"
    )
    ...
    @ApiModelProperty(
        example = "2020-07-01T00:00Z",
        value = "Time when the message was sent"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Country-specific carrier used to send or receive the message"
    )
    ...
    @ApiModelProperty(
        example = "0.003",
        value = "Fee charged by certain carriers in order to deliver certain message types. Telnyx passes this fee on to the customer according to our pricing table"
    )
    ...
    @ApiModelProperty(
        example = "+1555123456",
        value = "The recipient of the message (to parameter in the Messaging API)"
    )
    ...
    @ApiModelProperty(
        example = "+1555123456",
        value = "The sender of the message (from parameter in the Messaging API). For Alphanumeric ID messages, this is the sender ID value"
    )
    ...
    @ApiModelProperty(
        example = "US",
        value = "Two-letter representation of the country of the cld property using the ISO 3166-1 alpha-2 format"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Final webhook delivery status"
    )
    ...
    public MessageDetailRecord deliveryStatusFailoverUrl(
    ...
    @ApiModelProperty(
        ...
        value = "Failover customer-provided URL which Telnyx posts delivery status webhooks to"
    )
    ...
    public MessageDetailRecord deliveryStatusWebhookUrl(
    ...
    @ApiModelProperty(
        example = "https://api.example.com/sms/telnyx/inbound",
        value = "Primary customer-provided URL which Telnyx posts delivery status webhooks to"
    )
    ...
    @ApiModelProperty(
        example = "outbound",
        value = "Logical direction of the message from the Telnyx customer's perspective. It's inbound when the Telnyx customer receives the message, or outbound otherwise"
    )
    ...
    @ApiModelProperty(
        example = "false",
        value = "Indicates whether this is a Free-To-End-User (FTEU) short code message"
    )
    ...
    @ApiModelProperty(
        example = "204",
        value = "Mobile country code. Only available for certain products, such as Global Outbound-Only from Alphanumeric Sender ID"
    )
    ...
    @ApiModelProperty(
        example = "01",
        value = "Mobile network code. Only available for certain products, such as Global Outbound-Only from Alphanumeric Sender ID"
    )
    ...
    @ApiModelProperty(
        example = "SMS",
        value = "Describes the Messaging service used to send the message. Available services are: Short Message Service (SMS), Multimedia Messaging Service (MMS), and Rich Communication Services (RCS)"
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Indicates whether both sender and recipient numbers are Telnyx-managed"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Unique identifier of the Messaging Profile used to send or receive the message"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Name of the Messaging Profile used to send or receive the message"
    )
    ...
    @ApiModelProperty(
        example = "US",
        value = "Two-letter representation of the country of the cli property using the ISO 3166-1 alpha-2 format"
    )
    ...
    @ApiModelProperty(
        example = "delivered",
        value = "Final status of the message after the delivery attempt"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Comma-separated tags assigned to the Telnyx number associated with the message"
    )
    ...
    @ApiModelProperty(
        example = "0.003",
        value = "Amount, in the user currency, for the Telnyx billing cost"
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Telnyx API error codes returned by the Telnyx gateway"
    )
    ...
    @ApiModelProperty(
        example = "2",
        value = "Number of message parts. The message is broken down in multiple parts when its length surpasses the limit of 160 characters"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Identifies the record schema"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.uuid, messageDetailRecord.uuid) &&
            ...
            Objects.equals(
                this.deliveryStatus,
                messageDetailRecord.deliveryStatus
            ) &&
            Objects.equals(
                this.deliveryStatusFailoverUrl,
                messageDetailRecord.deliveryStatusFailoverUrl
            ) &&
            Objects.equals(
                this.deliveryStatusWebhookUrl,
                messageDetailRecord.deliveryStatusWebhookUrl
            ) &&
            ...
            Objects.equals(
                ...
                messageDetailRecord.sourceCountryCode
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    completedAt: ")
            .append(toIndentedString(completedAt))
            .append("\n");
        sb
            .append("    createdAt: ")
        ...
        sb
            .append("    carrierFee: ")
            .append(toIndentedString(carrierFee))
            .append("\n");
        ...
        sb
            ...
            .append(toIndentedString(deliveryStatus))
            .append("\n");
        sb
            .append("    deliveryStatusFailoverUrl: ")
            .append(toIndentedString(deliveryStatusFailoverUrl))
            .append("\n");
        sb
            .append("    deliveryStatusWebhookUrl: ")
            .append(toIndentedString(deliveryStatusWebhookUrl))
            .append("\n");
        sb
            .append("    direction: ")
        ...
        sb
            .append("    profileId: ")
            .append(toIndentedString(profileId))
            .append("\n");
        sb
            .append("    profileName: ")
            ...
            .append("\n");
        sb
            .append("    sourceCountryCode: ")
            .append(toIndentedString(sourceCountryCode))
            .append("\n");
