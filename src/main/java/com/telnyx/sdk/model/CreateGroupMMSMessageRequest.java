...
public class CreateGroupMMSMessageRequest {
    ...
    @ApiModelProperty(
        required = true,
        value = "A list of destinations. No more than 8 destinations are allowed."
    )
    ...
    @ApiModelProperty(
        value = "Message body (i.e., content) as a non-empty string."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A list of media URLs. The total media size must be less than 1 MB."
    )
    ...
    public CreateGroupMMSMessageRequest webhookFailoverUrl(
    ...
    public CreateGroupMMSMessageRequest useProfileWebhooks(
    ...
    public boolean equals(Object o) {
        ...
        CreateGroupMMSMessageRequest createGroupMMSMessageRequest =
            (CreateGroupMMSMessageRequest) o;
        return (
            Objects.equals(this.from, createGroupMMSMessageRequest.from) &&
            Objects.equals(this.to, createGroupMMSMessageRequest.to) &&
            Objects.equals(this.text, createGroupMMSMessageRequest.text) &&
            Objects.equals(
                this.subject,
                createGroupMMSMessageRequest.subject
            ) &&
            Objects.equals(
                this.mediaUrls,
                createGroupMMSMessageRequest.mediaUrls
            ) &&
            Objects.equals(
                this.webhookUrl,
                createGroupMMSMessageRequest.webhookUrl
            ) &&
            Objects.equals(
                this.webhookFailoverUrl,
                createGroupMMSMessageRequest.webhookFailoverUrl
            ) &&
            Objects.equals(
                this.useProfileWebhooks,
                createGroupMMSMessageRequest.useProfileWebhooks
            )
        );
    }
