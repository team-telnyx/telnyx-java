...
public class InboundMessagePayload {
    ...
    private JsonNullable<OffsetDateTime> sentAt = JsonNullable.<
            OffsetDateTime
        >undefined();

    public static final String JSON_PROPERTY_COMPLETED_AT = "completed_at";
    private JsonNullable<OffsetDateTime> completedAt = JsonNullable.<
            OffsetDateTime
        >undefined();
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The type of message. This value can be either 'sms' or 'mms'."
    )
    ...
    public InboundMessagePayload addtoItem(
        InboundMessagePayloadToInner toItem
    ) {
        if (this.to == null) {
    ...
    public InboundMessagePayload addccItem(
        InboundMessagePayloadCcInner ccItem
    ) {
        if (this.cc == null) {
    ...
    public InboundMessagePayload media(
        List<InboundMessagePayloadMediaInner> media
    ) {
        this.media = media;
        return this;
    }

    public InboundMessagePayload addmediaItem(
        InboundMessagePayloadMediaInner mediaItem
    ) {
        if (this.media == null) {
    ...
    public InboundMessagePayload cost(OutboundMessagePayloadCost cost) {
    ...
    @JsonProperty(JSON_PROPERTY_COMPLETED_AT)
    public void setCompletedAt_JsonNullable(
        JsonNullable<OffsetDateTime> completedAt
    ) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, inboundMessagePayload.recordType) &&
            ...
            Objects.equals(
                ...
                inboundMessagePayload.messagingProfileId
            ) &&
            ...
            equalsNullable(
                ...
                inboundMessagePayload.webhookFailoverUrl
            ) &&
            ...
            equalsNullable(
                this.completedAt,
                inboundMessagePayload.completedAt
            ) &&
