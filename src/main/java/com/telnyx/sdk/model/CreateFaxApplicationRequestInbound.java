...
public class CreateFaxApplicationRequestInbound {
    ...
    public static final String JSON_PROPERTY_INBOUND_FAX_FILE_TYPE =
        "inbound_fax_file_type";
    private InboundFaxFileTypeEnum inboundFaxFileType =
        InboundFaxFileTypeEnum.PDF;
    ...
    public CreateFaxApplicationRequestInbound channelLimit(
    ...
    @ApiModelProperty(
        example = "10",
        value = "When set, this will limit the number of concurrent inbound calls to phone numbers associated with this connection."
    )
    ...
    public CreateFaxApplicationRequestInbound inboundFaxFileType(
        InboundFaxFileTypeEnum inboundFaxFileType
    ) {
    ...
    @ApiModelProperty(
        example = "pdf",
        value = "The file type used for inbound faxes."
    )
    ...
    @JsonProperty(JSON_PROPERTY_INBOUND_FAX_FILE_TYPE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setInboundFaxFileType(
        InboundFaxFileTypeEnum inboundFaxFileType
    ) {
        this.inboundFaxFileType = inboundFaxFileType;
    }

    public CreateFaxApplicationRequestInbound sipSubdomain(
        String sipSubdomain
    ) {
    ...
    public CreateFaxApplicationRequestInbound sipSubdomainReceiveSettings(
    ...
    public boolean equals(Object o) {
        ...
        CreateFaxApplicationRequestInbound createFaxApplicationRequestInbound =
            (CreateFaxApplicationRequestInbound) o;
        return (
            Objects.equals(
                this.channelLimit,
                createFaxApplicationRequestInbound.channelLimit
            ) &&
            Objects.equals(
                this.inboundFaxFileType,
                createFaxApplicationRequestInbound.inboundFaxFileType
            ) &&
            Objects.equals(
                this.sipSubdomain,
                createFaxApplicationRequestInbound.sipSubdomain
            ) &&
            Objects.equals(
                this.sipSubdomainReceiveSettings,
                createFaxApplicationRequestInbound.sipSubdomainReceiveSettings
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    inboundFaxFileType: ")
            .append(toIndentedString(inboundFaxFileType))
            .append("\n");
        sb
            .append("    sipSubdomain: ")
