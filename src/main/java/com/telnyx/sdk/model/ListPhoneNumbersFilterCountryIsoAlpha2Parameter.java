 ...
 */
 ...
 public class ListPhoneNumbersFilterCountryIsoAlpha2Parameter extends AbstractOpenApiSchema {
     ...
     public static class ListPhoneNumbersFilterCountryIsoAlpha2ParameterSerializer
         ...
         @Override
         public void serialize(ListPhoneNumbersFilterCountryIsoAlpha2Parameter value,
                               JsonGenerator jgen,
     ...
     public static class ListPhoneNumbersFilterCountryIsoAlpha2ParameterDeserializer
             extends StdDeserializer<ListPhoneNumbersFilterCountryIsoAlpha2Parameter> {
         ...
         @Override
         public ListPhoneNumbersFilterCountryIsoAlpha2Parameter deserialize(JsonParser jp,
             ...
             if (token == JsonToken.START_ARRAY) {
                 try {
                     deserialized = tree.traverse(jp.getCodec()).readValueAs(
         ...
         @Override
         public ListPhoneNumbersFilterCountryIsoAlpha2Parameter getNullValue(DeserializationContext ctxt)
     ...
     static {
         ...
         JSON.registerDescendants(ListPhoneNumbersFilterCountryIsoAlpha2Parameter.class,
