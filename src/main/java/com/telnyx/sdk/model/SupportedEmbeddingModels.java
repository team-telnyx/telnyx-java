...
public enum SupportedEmbeddingModels {
    ...
    SupportedEmbeddingModels(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static SupportedEmbeddingModels fromValue(String value) {
        for (SupportedEmbeddingModels b : SupportedEmbeddingModels.values()) {
