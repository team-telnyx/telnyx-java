...
public class PortingPhoneNumberBlock {
  ...
  private List<PortingPhoneNumberBlockActivationRangesInner> activationRanges = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "f24151b6-3389-41d3-8747-7dd8c681e5e2", value = "Uniquely identifies this porting phone number block.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DE", value = "Specifies the country code for this porting phone number block. It is a two-letter ISO 3166-1 alpha-2 country code.")
  ...
  public PortingPhoneNumberBlock phoneNumberType(PhoneNumberTypeEnum phoneNumberType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "local", value = "Specifies the phone number type for this porting phone number block.")
  ...
  public PortingPhoneNumberBlock phoneNumberRange(PortingPhoneNumberBlockPhoneNumberRange phoneNumberRange) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_PHONE_NUMBER_RANGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPhoneNumberRange(PortingPhoneNumberBlockPhoneNumberRange phoneNumberRange) {
    this.phoneNumberRange = phoneNumberRange;
  }


  public PortingPhoneNumberBlock activationRanges(List<PortingPhoneNumberBlockActivationRangesInner> activationRanges) {
    this.activationRanges = activationRanges;
    return this;
  }

  public PortingPhoneNumberBlock addactivationRangesItem(PortingPhoneNumberBlockActivationRangesInner activationRangesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the activation ranges for this porting phone number block. The activation range must be within the phone number range and should not overlap with other activation ranges.")
  @JsonProperty(JSON_PROPERTY_ACTIVATION_RANGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<PortingPhoneNumberBlockActivationRangesInner> getActivationRanges() {
    return activationRanges;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACTIVATION_RANGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setActivationRanges(List<PortingPhoneNumberBlockActivationRangesInner> activationRanges) {
    this.activationRanges = activationRanges;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "porting_phone_number_block", value = "Identifies the type of the resource.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PortingPhoneNumberBlock portingPhoneNumberBlock = (PortingPhoneNumberBlock) o;
    return Objects.equals(this.id, portingPhoneNumberBlock.id) &&
        Objects.equals(this.countryCode, portingPhoneNumberBlock.countryCode) &&
        Objects.equals(this.phoneNumberType, portingPhoneNumberBlock.phoneNumberType) &&
        Objects.equals(this.phoneNumberRange, portingPhoneNumberBlock.phoneNumberRange) &&
        Objects.equals(this.activationRanges, portingPhoneNumberBlock.activationRanges) &&
        Objects.equals(this.recordType, portingPhoneNumberBlock.recordType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, countryCode, phoneNumberType, phoneNumberRange, activationRanges, recordType, createdAt, updatedAt);
  }
