...
public class CheckContactRequestBody {
    ...
    @ApiModelProperty(
        value = "Blocking determines whether the request should wait for the processing to complete (synchronous) or not (asynchronous)."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "Array of contact phone numbers. The numbers can be in any standard telephone number format."
    )
    ...
    public boolean equals(Object o) {
        ...
        CheckContactRequestBody checkContactRequestBody =
            (CheckContactRequestBody) o;
        return (
            Objects.equals(
                this.whatsappUserId,
                checkContactRequestBody.whatsappUserId
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    blocking: ")
            .append(toIndentedString(blocking))
            .append("\n");
        sb
            .append("    contacts: ")
