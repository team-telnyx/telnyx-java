...
public class StartSiprecRequest {
    ...
    public static final String JSON_PROPERTY_INCLUDE_METADATA_CUSTOM_HEADERS =
    ...
    public static final String JSON_PROPERTY_SESSION_TIMEOUT_SECS =
    ...
    @ApiModelProperty(
        ...
        value = "Name of configured SIPREC connector to be used."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Specifies which track should be sent on siprec session."
    )
    ...
    public StartSiprecRequest includeMetadataCustomHeaders(
    ...
    @ApiModelProperty(
        example = "true",
        value = "When set, custom parameters will be added as metadata (recording.session.ExtensionParameters). Otherwise, they’ll be added to sip headers."
    )
    ...
    @JsonProperty(JSON_PROPERTY_INCLUDE_METADATA_CUSTOM_HEADERS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setIncludeMetadataCustomHeaders(
        Boolean includeMetadataCustomHeaders
    ) {
        this.includeMetadataCustomHeaders = includeMetadataCustomHeaders;
    }
    ...
    @ApiModelProperty(
        example = "true",
        value = "Controls whether to encrypt media sent to your SRS using SRTP and TLS. When set you need to configure SRS port in your connector to 5061."
    )
    ...
    @ApiModelProperty(
        example = "900",
        value = "Sets `Session-Expires` header to the INVITE. A reinvite is sent every half the value set. Usefull for session keep alive. Minimum value is 90, set to 0 to disable."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                this.connectorName,
                startSiprecRequest.connectorName
            ) &&
            Objects.equals(this.siprecTrack, startSiprecRequest.siprecTrack) &&
            Objects.equals(
                this.includeMetadataCustomHeaders,
                startSiprecRequest.includeMetadataCustomHeaders
            ) &&
            Objects.equals(this.secure, startSiprecRequest.secure) &&
            Objects.equals(
                this.sessionTimeoutSecs,
                startSiprecRequest.sessionTimeoutSecs
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append(toIndentedString(connectorName))
            .append("\n");
        sb
            .append("    siprecTrack: ")
            .append(toIndentedString(siprecTrack))
            .append("\n");
        sb
            .append("    includeMetadataCustomHeaders: ")
            .append(toIndentedString(includeMetadataCustomHeaders))
            .append("\n");
        sb.append("    secure: ").append(toIndentedString(secure)).append("\n");
        sb
            .append("    sessionTimeoutSecs: ")
            .append(toIndentedString(sessionTimeoutSecs))
            .append("\n");
        sb
            .append("    clientState: ")
