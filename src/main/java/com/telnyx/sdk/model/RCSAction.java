...
public class RCSAction {
    ...
    public static final String JSON_PROPERTY_VIEW_LOCATION_ACTION =
        "view_location_action";
    private RCSViewLocationAction viewLocationAction;

    public static final String JSON_PROPERTY_CREATE_CALENDAR_EVENT_ACTION =
        "create_calendar_event_action";
    private RCSCreateCalendarEventAction createCalendarEventAction;

    public static final String JSON_PROPERTY_OPEN_URL_ACTION =
        "open_url_action";
    private RCSOpenUrlAction openUrlAction;

    public static final String JSON_PROPERTY_SHARE_LOCATION_ACTION =
    ...
    @ApiModelProperty(
        example = "Hello world",
        value = "Text that is shown in the suggested action. Maximum 25 characters."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Fallback URL to use if a client doesn't support a suggested action. Fallback URLs open in new browser windows. Maximum 2048 characters."
    )
    ...
    public RCSAction viewLocationAction(
        RCSViewLocationAction viewLocationAction
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_VIEW_LOCATION_ACTION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setViewLocationAction(
        RCSViewLocationAction viewLocationAction
    ) {
        this.viewLocationAction = viewLocationAction;
    }

    public RCSAction createCalendarEventAction(
        RCSCreateCalendarEventAction createCalendarEventAction
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_CREATE_CALENDAR_EVENT_ACTION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setCreateCalendarEventAction(
        RCSCreateCalendarEventAction createCalendarEventAction
    ) {
        this.createCalendarEventAction = createCalendarEventAction;
    }
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Opens the RCS app's location chooser so the user can pick a location to send back to the agent."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.text, rcSAction.text) &&
    ...
    public String toString() {
        ...
        sb
            .append("    dialAction: ")
            .append(toIndentedString(dialAction))
            .append("\n");
        sb
            .append("    viewLocationAction: ")
            .append(toIndentedString(viewLocationAction))
            .append("\n");
        sb
            .append("    createCalendarEventAction: ")
            .append(toIndentedString(createCalendarEventAction))
            .append("\n");
        sb
            .append("    openUrlAction: ")
            .append(toIndentedString(openUrlAction))
            .append("\n");
        sb
            .append("    shareLocationAction: ")
            .append(toIndentedString(shareLocationAction))
            .append("\n");
        sb
            .append("    composeAction: ")
            .append(toIndentedString(composeAction))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
