...
public class CreateRoomClientTokenRequest {
    ...
    public static final String JSON_PROPERTY_REFRESH_TOKEN_TTL_SECS =
    ...
    public CreateRoomClientTokenRequest refreshTokenTtlSecs(
        Integer refreshTokenTtlSecs
    ) {
    ...
    @ApiModelProperty(
        example = "3600",
        value = "The time to live in seconds of the Refresh Token, after that time the Refresh Token is invalid and can't be used to refresh Client Token."
    )
    ...
    public boolean equals(Object o) {
        ...
        CreateRoomClientTokenRequest createRoomClientTokenRequest =
            (CreateRoomClientTokenRequest) o;
        return (
            Objects.equals(
                this.tokenTtlSecs,
                createRoomClientTokenRequest.tokenTtlSecs
            ) &&
            Objects.equals(
                this.refreshTokenTtlSecs,
                createRoomClientTokenRequest.refreshTokenTtlSecs
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    refreshTokenTtlSecs: ")
            .append(toIndentedString(refreshTokenTtlSecs))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
