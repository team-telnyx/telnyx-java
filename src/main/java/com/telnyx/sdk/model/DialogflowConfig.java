...
public class DialogflowConfig {
    ...
    public static final String JSON_PROPERTY_ANALYZE_SENTIMENT =
        "analyze_sentiment";
    private Boolean analyzeSentiment = false;

    public static final String JSON_PROPERTY_PARTIAL_AUTOMATED_AGENT_REPLY =
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enable sentiment analysis from Dialogflow."
    )
    ...
    public DialogflowConfig partialAutomatedAgentReply(
        Boolean partialAutomatedAgentReply
    ) {
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enable partial automated agent reply from Dialogflow."
    )
    ...
    @JsonProperty(JSON_PROPERTY_PARTIAL_AUTOMATED_AGENT_REPLY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPartialAutomatedAgentReply(
        Boolean partialAutomatedAgentReply
    ) {
        this.partialAutomatedAgentReply = partialAutomatedAgentReply;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                ...
                dialogflowConfig.analyzeSentiment
            ) &&
            Objects.equals(
                this.partialAutomatedAgentReply,
                dialogflowConfig.partialAutomatedAgentReply
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    analyzeSentiment: ")
            .append(toIndentedString(analyzeSentiment))
            .append("\n");
        sb
            .append("    partialAutomatedAgentReply: ")
            .append(toIndentedString(partialAutomatedAgentReply))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
