...
public class BulkSIMCardActionDetailed {
    ...
    public static final String JSON_PROPERTY_SIM_CARD_ACTIONS_SUMMARY =
    ...
    @ApiModelProperty(
        ...
        value = "The operation type. It can be one of the following: <br/> <ul> <li><code>bulk_set_public_ips</code> - set a public IP for each specified SIM card.</li> </ul>"
    )
    ...
    @ApiModelProperty(
        example = "{}",
        value = "A JSON object representation of the bulk action payload."
    )
    ...
    public BulkSIMCardActionDetailed simCardActionsSummary(
        List<SIMCardActionsSummary> simCardActionsSummary
    ) {
        this.simCardActionsSummary = simCardActionsSummary;
        return this;
    }

    public BulkSIMCardActionDetailed addsimCardActionsSummaryItem(
        SIMCardActionsSummary simCardActionsSummaryItem
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_SIM_CARD_ACTIONS_SUMMARY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSimCardActionsSummary(
        List<SIMCardActionsSummary> simCardActionsSummary
    ) {
        this.simCardActionsSummary = simCardActionsSummary;
    }
    ...
    public boolean equals(Object o) {
        ...
        BulkSIMCardActionDetailed bulkSIMCardActionDetailed =
            (BulkSIMCardActionDetailed) o;
        return (
            Objects.equals(this.id, bulkSIMCardActionDetailed.id) &&
            Objects.equals(
                this.recordType,
                bulkSIMCardActionDetailed.recordType
            ) &&
            Objects.equals(
                this.actionType,
                bulkSIMCardActionDetailed.actionType
            ) &&
            Objects.equals(this.settings, bulkSIMCardActionDetailed.settings) &&
            Objects.equals(
                this.simCardActionsSummary,
                bulkSIMCardActionDetailed.simCardActionsSummary
            ) &&
            Objects.equals(
                this.createdAt,
                bulkSIMCardActionDetailed.createdAt
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    simCardActionsSummary: ")
            .append(toIndentedString(simCardActionsSummary))
            .append("\n");
        sb
            .append("    createdAt: ")
