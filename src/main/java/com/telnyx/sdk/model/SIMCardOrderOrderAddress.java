...
public class SIMCardOrderOrderAddress {
    ...
    @ApiModelProperty(
        example = "John",
        value = "The first name of the shipping recipient."
    )
    ...
    @ApiModelProperty(
        example = "Smith",
        value = "The last name of the shipping recipient."
    )
    ...
    @ApiModelProperty(
        example = "Telnyx LLC",
        value = "The name of the business where the address is located."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The name of the street where the address is located."
    )
    ...
    @ApiModelProperty(
        example = "14th Floor",
        value = "Supplemental field for address information."
    )
    ...
    @ApiModelProperty(
        example = "Austin",
        value = "The name of the city where the address is located."
    )
    ...
    public SIMCardOrderOrderAddress administrativeArea(
    ...
    @ApiModelProperty(
        example = "TX",
        value = "State or province where the address is located."
    )
    ...
    public boolean equals(Object o) {
        ...
        SIMCardOrderOrderAddress siMCardOrderOrderAddress =
            (SIMCardOrderOrderAddress) o;
        return (
            Objects.equals(this.id, siMCardOrderOrderAddress.id) &&
            Objects.equals(
                this.firstName,
                siMCardOrderOrderAddress.firstName
            ) &&
            Objects.equals(this.lastName, siMCardOrderOrderAddress.lastName) &&
            Objects.equals(
                this.businessName,
                siMCardOrderOrderAddress.businessName
            ) &&
            Objects.equals(
                this.streetAddress,
                siMCardOrderOrderAddress.streetAddress
            ) &&
            Objects.equals(
                this.extendedAddress,
                siMCardOrderOrderAddress.extendedAddress
            ) &&
            Objects.equals(this.locality, siMCardOrderOrderAddress.locality) &&
            Objects.equals(
                this.administrativeArea,
                siMCardOrderOrderAddress.administrativeArea
            ) &&
            Objects.equals(
                this.countryCode,
                siMCardOrderOrderAddress.countryCode
            ) &&
