...
public class Participant {
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Uniquely identifies the participant"
    )
    ...
    @ApiModelProperty(
        example = "3fa85f64-5717-4562-b3fc-2c963f66afa6",
        required = true,
        value = "Uniquely identifies the call leg associated with the participant"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Call Control ID associated with the partiipant of the conference"
    )
    ...
    public Participant whisperCallControlIds(
    ...
    public Participant addwhisperCallControlIdsItem(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Array of unique call_control_ids the participant can whisper to.."
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "ISO 8601 formatted date of when the participant was created"
    )
    ...
    @ApiModelProperty(
        example = "2019-01-23T18:10:02.574Z",
        required = true,
        value = "ISO 8601 formatted date of when the participant was last updated"
    )
    ...
    @ApiModelProperty(
        example = "true",
        required = true,
        value = "Whether the conference will end and all remaining participants be hung up after the participant leaves the conference."
    )
    ...
    public Participant softEndConferenceOnExit(
    ...
    @ApiModelProperty(
        example = "true",
        required = true,
        value = "Whether the conference will end after the participant leaves the conference."
    )
    ...
    @ApiModelProperty(
        example = "joining",
        required = true,
        value = "The status of the participant with respect to the lifecycle within the conference"
    )
    ...
    @ApiModelProperty(
        example = "true",
        required = true,
        value = "Whether the participant is put on_hold."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, participant.recordType) &&
            ...
            Objects.equals(
                ...
                participant.whisperCallControlIds
            ) &&
            ...
            Objects.equals(
                ...
                participant.softEndConferenceOnExit
            ) &&
