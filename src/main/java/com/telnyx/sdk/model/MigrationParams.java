...
public class MigrationParams {
    ...
    public static final String JSON_PROPERTY_TARGET_BUCKET_NAME =
        "target_bucket_name";
    ...
    public static final String JSON_PROPERTY_BYTES_TO_MIGRATE =
        "bytes_to_migrate";
    ...
    @ApiModelProperty(
        required = true,
        value = "ID of the Migration Source from which to migrate data."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "Bucket name to migrate the data into. Will default to the same name as the `source_bucket_name`."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "Telnyx Cloud Storage region to migrate the data to."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "If true, will continue to poll the source bucket to ensure new data is continually migrated over."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Time when data migration was last copied from the source."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Total amount of data found in source bucket to migrate."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Total amount of data that has been succesfully migrated."
    )
    ...
    @ApiModelProperty(
        example = "2020-01-01T00:00Z",
        value = "Estimated time the migration will complete."
    )
    ...
    @ApiModelProperty(
        example = "2020-01-01T00:00Z",
        value = "Time when data migration was created"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(
                this.bytesToMigrate,
                migrationParams.bytesToMigrate
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    targetBucketName: ")
            .append(toIndentedString(targetBucketName))
            .append("\n");
        sb
            .append("    targetRegion: ")
            .append(toIndentedString(targetRegion))
            .append("\n");
        sb
            .append("    refresh: ")
            .append(toIndentedString(refresh))
            .append("\n");
        sb
            .append("    lastCopy: ")
            .append(toIndentedString(lastCopy))
            .append("\n");
        sb.append("    status: ").append(toIndentedString(status)).append("\n");
        sb
            .append("    bytesToMigrate: ")
            .append(toIndentedString(bytesToMigrate))
            .append("\n");
        sb
            .append("    bytesMigrated: ")
            .append(toIndentedString(bytesMigrated))
            .append("\n");
