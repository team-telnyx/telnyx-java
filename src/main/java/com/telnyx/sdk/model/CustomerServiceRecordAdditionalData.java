...
public class CustomerServiceRecordAdditionalData {
    ...
    @ApiModelProperty(
        example = "Entity Inc.",
        value = "The name of the administrator of CSR."
    )
    ...
    public CustomerServiceRecordAdditionalData authorizedPersonName(
    ...
    @ApiModelProperty(
        example = "John Doe",
        value = "The name of the authorized person."
    )
    ...
    @ApiModelProperty(
        example = "1234",
        value = "The PIN of the customer service record."
    )
    ...
    public CustomerServiceRecordAdditionalData accountNumber(
    ...
    public CustomerServiceRecordAdditionalData customerCode(
        String customerCode
    ) {
    ...
    @ApiModelProperty(
        example = "123456789",
        value = "The customer code of the customer service record."
    )
    ...
    public CustomerServiceRecordAdditionalData addressLine1(
        String addressLine1
    ) {
    ...
    @ApiModelProperty(
        example = "123 Main St",
        value = "The first line of the address of the customer service record."
    )
    ...
    @ApiModelProperty(
        example = "New York",
        value = "The city of the customer service record."
    )
    ...
    @ApiModelProperty(
        example = "NY",
        value = "The state of the customer service record."
    )
    ...
    @ApiModelProperty(
        example = "10001",
        value = "The zip code of the customer service record."
    )
    ...
    public CustomerServiceRecordAdditionalData billingPhoneNumber(
    ...
    public boolean equals(Object o) {
        ...
        CustomerServiceRecordAdditionalData customerServiceRecordAdditionalData =
            (CustomerServiceRecordAdditionalData) o;
        return (
            Objects.equals(
                this.name,
                customerServiceRecordAdditionalData.name
            ) &&
            Objects.equals(
                this.authorizedPersonName,
                customerServiceRecordAdditionalData.authorizedPersonName
            ) &&
            Objects.equals(this.pin, customerServiceRecordAdditionalData.pin) &&
            Objects.equals(
                this.accountNumber,
                customerServiceRecordAdditionalData.accountNumber
            ) &&
            Objects.equals(
                this.customerCode,
                customerServiceRecordAdditionalData.customerCode
            ) &&
            Objects.equals(
                this.addressLine1,
                customerServiceRecordAdditionalData.addressLine1
            ) &&
            Objects.equals(
                this.city,
                customerServiceRecordAdditionalData.city
            ) &&
            Objects.equals(
                this.state,
                customerServiceRecordAdditionalData.state
            ) &&
            Objects.equals(
                this.zipCode,
                customerServiceRecordAdditionalData.zipCode
            ) &&
            Objects.equals(
                this.billingPhoneNumber,
                customerServiceRecordAdditionalData.billingPhoneNumber
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    customerCode: ")
            .append(toIndentedString(customerCode))
            .append("\n");
        sb
            .append("    addressLine1: ")
            .append(toIndentedString(addressLine1))
            .append("\n");
