...
public class PortabilityCheckDetails {
    ...
    public static final String JSON_PROPERTY_NOT_PORTABLE_REASON =
        "not_portable_reason";
    ...
    public PortabilityCheckDetails(
        ...
        @JsonProperty(
            JSON_PROPERTY_NOT_PORTABLE_REASON
        ) String notPortableReason,
    ...
    @ApiModelProperty(
        example = "true",
        value = "Indicates whether this phone number is FastPort eligible"
    )
    ...
    @ApiModelProperty(
        example = "No coverage",
        value = "If this phone number is not portable, explains why. Empty string if the number is portable."
    )
    ...
    @ApiModelProperty(
        example = "+13125550123",
        value = "The +E.164 formatted phone number this result is about"
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Indicates whether this phone number is portable"
    )
    ...
    public boolean equals(Object o) {
        ...
        PortabilityCheckDetails portabilityCheckDetails =
            (PortabilityCheckDetails) o;
        return (
            Objects.equals(
                this.recordType,
                portabilityCheckDetails.recordType
            ) &&
            Objects.equals(
                this.fastPortable,
                portabilityCheckDetails.fastPortable
            ) &&
            Objects.equals(
                this.notPortableReason,
                portabilityCheckDetails.notPortableReason
            ) &&
            Objects.equals(
                this.phoneNumber,
                portabilityCheckDetails.phoneNumber
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    fastPortable: ")
            .append(toIndentedString(fastPortable))
            .append("\n");
        sb
            .append("    notPortableReason: ")
            .append(toIndentedString(notPortableReason))
            .append("\n");
        sb
            .append("    phoneNumber: ")
        ...
        sb
            .append("    portable: ")
            .append(toIndentedString(portable))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
