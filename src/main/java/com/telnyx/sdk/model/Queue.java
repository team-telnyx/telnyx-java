...
public class Queue {
    ...
    public static final String JSON_PROPERTY_AVERAGE_WAIT_TIME_SECS =
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Uniquely identifies the queue"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "ISO 8601 formatted date of when the queue was created"
    )
    ...
    @ApiModelProperty(
        example = "2019-01-23T18:10:02.574Z",
        required = true,
        value = "ISO 8601 formatted date of when the queue was last updated"
    )
    ...
    @ApiModelProperty(
        example = "20",
        required = true,
        value = "The number of calls currently in the queue"
    )
    ...
    @ApiModelProperty(
        example = "175",
        required = true,
        value = "The average time that the calls currently in the queue have spent waiting, given in seconds."
    )
    ...
    public boolean equals(Object o) {
        ...
        Queue queue = (Queue) o;
        return (
            Objects.equals(this.recordType, queue.recordType) &&
    ...
    public String toString() {
        ...
        sb
            .append("    currentSize: ")
            .append(toIndentedString(currentSize))
            .append("\n");
        sb
            .append("    maxSize: ")
            ...
            .append("\n");
        sb
            .append("    averageWaitTimeSecs: ")
            .append(toIndentedString(averageWaitTimeSecs))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
