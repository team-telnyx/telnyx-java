...
public class EnqueueRequest {
    ...
    public static final String JSON_PROPERTY_MAX_WAIT_TIME_SECS =
        "max_wait_time_secs";
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The name of the queue the call should be put in. If a queue with a given name doesn't exist yet it will be created."
    )
    ...
    @ApiModelProperty(
        example = "600",
        value = "The number of seconds after which the call will be removed from the queue."
    )
    ...
    @ApiModelProperty(
        example = "200",
        value = "The maximum number of calls allowed in the queue at a given time. Can't be modified for an existing queue."
    )
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    maxWaitTimeSecs: ")
            .append(toIndentedString(maxWaitTimeSecs))
            .append("\n");
        sb
            .append("    maxSize: ")
