...
public class StopForkingRequest {
    ...
    @ApiModelProperty(
        example = "decrypted",
        value = "Optionally specify a `stream_type`. This should match the `stream_type` that was used in `fork_start` command to properly stop the fork."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.clientState, stopForkingRequest.clientState) &&
