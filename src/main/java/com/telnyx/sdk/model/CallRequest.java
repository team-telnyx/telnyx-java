...
public class CallRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(to, from, fromDisplayName, connectionId, audioUrl, mediaName, preferredCodecs, timeoutSecs, timeLimitSecs, answeringMachineDetection, answeringMachineDetectionConfig, conferenceConfig, customHeaders, billingGroupId, clientState, commandId, linkTo, mediaEncryption, sipAuthUsername, sipAuthPassword, sipHeaders, sipTransportProtocol, soundModifications, streamUrl, streamTrack, streamBidirectionalMode, streamBidirectionalCodec, sendSilenceWhenIdle, webhookUrl, webhookUrlMethod, record, recordChannels, recordFormat, recordMaxLength, recordTimeoutSecs, recordTrack, recordTrim, recordCustomFileName, enableDialogflow, dialogflowConfig, transcription, transcriptionConfig);
  }
