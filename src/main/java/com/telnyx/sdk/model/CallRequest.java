...
public class CallRequest {
    ...
    public static final String JSON_PROPERTY_TIME_LIMIT_SECS =
        "time_limit_secs";
    ...
    public static final String JSON_PROPERTY_ANSWERING_MACHINE_DETECTION =
        "answering_machine_detection";
    private AnsweringMachineDetectionEnum answeringMachineDetection =
        AnsweringMachineDetectionEnum.DISABLED;

    public static final String JSON_PROPERTY_ANSWERING_MACHINE_DETECTION_CONFIG =
        "answering_machine_detection_config";
    private CallRequestAnsweringMachineDetectionConfig answeringMachineDetectionConfig;

    public static final String JSON_PROPERTY_CONFERENCE_CONFIG =
        "conference_config";
    ...
    public static final String JSON_PROPERTY_MEDIA_ENCRYPTION =
        "media_encryption";
    ...
    public static final String JSON_PROPERTY_SIP_TRANSPORT_PROTOCOL =
        "sip_transport_protocol";
    private SipTransportProtocolEnum sipTransportProtocol =
        SipTransportProtocolEnum.UDP;

    public static final String JSON_PROPERTY_SOUND_MODIFICATIONS =
        "sound_modifications";
    ...
    public static final String JSON_PROPERTY_STREAM_BIDIRECTIONAL_MODE =
        "stream_bidirectional_mode";
    private StreamBidirectionalMode streamBidirectionalMode =
        StreamBidirectionalMode.MP3;

    public static final String JSON_PROPERTY_STREAM_BIDIRECTIONAL_CODEC =
        "stream_bidirectional_codec";
    private StreamBidirectionalCodec streamBidirectionalCodec =
        StreamBidirectionalCodec.PCMU;

    public static final String JSON_PROPERTY_STREAM_BIDIRECTIONAL_TARGET_LEGS =
        "stream_bidirectional_target_legs";
    private StreamBidirectionalTargetLegs streamBidirectionalTargetLegs =
        StreamBidirectionalTargetLegs.OPPOSITE;

    public static final String JSON_PROPERTY_STREAM_BIDIRECTIONAL_SAMPLING_RATE =
        "stream_bidirectional_sampling_rate";
    private StreamBidirectionalSamplingRate streamBidirectionalSamplingRate =
        StreamBidirectionalSamplingRate.NUMBER_8000;

    public static final String JSON_PROPERTY_SEND_SILENCE_WHEN_IDLE =
    ...
    public static final String JSON_PROPERTY_WEBHOOK_URL_METHOD =
        "webhook_url_method";
    ...
    public static final String JSON_PROPERTY_SUPERVISE_CALL_CONTROL_ID =
    ...
    public static final String JSON_PROPERTY_ENABLE_DIALOGFLOW =
        "enable_dialogflow";
    private Boolean enableDialogflow = false;

    public static final String JSON_PROPERTY_DIALOGFLOW_CONFIG =
        "dialogflow_config";
    ...
    public static final String JSON_PROPERTY_TRANSCRIPTION_CONFIG =
    ...
    @ApiModelProperty(
        example = "+18005550101",
        required = true,
        value = "The `from` number to be used as the caller id presented to the destination (`to` number). The number should be in +E164 format."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The `from_display_name` string to be used as the caller id name (SIP From Display Name) presented to the destination (`to` number). The string should have a maximum of 128 characters, containing only letters, numbers, spaces, and -_~!.+ special characters. If ommited, the display name will be the same as the number in the `from` field."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "The ID of the Call Control App (formerly ID of the connection) to be used when dialing the destination."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The URL of a file to be played back to the callee when the call is answered. The URL can point to either a WAV or MP3 file. media_name and audio_url cannot be used together in one request."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The media_name of a file to be played back to the callee when the call is answered. The media_name must point to a file previously uploaded to api.telnyx.com/v2/media by the same user/organization. The file must either be a WAV or MP3 file."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The list of comma-separated codecs in a preferred order for the forked media to be received."
    )
    ...
    @ApiModelProperty(
        example = "60",
        value = "The number of seconds that Telnyx will wait for the call to be answered by the destination to which it is being called. If the timeout is reached before an answer is received, the call will hangup and a `call.hangup` webhook with a `hangup_cause` of `timeout` will be sent. Minimum value is 5 seconds. Maximum value is 600 seconds."
    )
    ...
    public CallRequest answeringMachineDetection(
        AnsweringMachineDetectionEnum answeringMachineDetection
    ) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Enables Answering Machine Detection. Telnyx offers Premium and Standard detections. With Premium detection, when a call is answered, Telnyx runs real-time detection and sends a `call.machine.premium.detection.ended` webhook with one of the following results: `human_residence`, `human_business`, `machine`, `silence` or `fax_detected`. If we detect a beep, we also send a `call.machine.premium.greeting.ended` webhook with the result of `beep_detected`. If we detect a beep before `call.machine.premium.detection.ended` we only send `call.machine.premium.greeting.ended`, and if we detect a beep after `call.machine.premium.detection.ended`, we send both webhooks. With Standard detection, when a call is answered, Telnyx runs real-time detection to determine if it was picked up by a human or a machine and sends an `call.machine.detection.ended` webhook with the analysis result. If `greeting_end` or `detect_words` is used and a `machine` is detected, you will receive another `call.machine.greeting.ended` webhook when the answering machine greeting ends with a beep or silence. If `detect_beep` is used, you will only receive `call.machine.greeting.ended` if a beep is detected."
    )
    ...
    @JsonProperty(JSON_PROPERTY_ANSWERING_MACHINE_DETECTION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setAnsweringMachineDetection(
        AnsweringMachineDetectionEnum answeringMachineDetection
    ) {
        this.answeringMachineDetection = answeringMachineDetection;
    }

    public CallRequest answeringMachineDetectionConfig(
        CallRequestAnsweringMachineDetectionConfig answeringMachineDetectionConfig
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_ANSWERING_MACHINE_DETECTION_CONFIG)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setAnsweringMachineDetectionConfig(
        CallRequestAnsweringMachineDetectionConfig answeringMachineDetectionConfig
    ) {
        this.answeringMachineDetectionConfig = answeringMachineDetectionConfig;
    }

    public CallRequest conferenceConfig(
        CallRequestConferenceConfig conferenceConfig
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_CONFERENCE_CONFIG)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setConferenceConfig(
        CallRequestConferenceConfig conferenceConfig
    ) {
        this.conferenceConfig = conferenceConfig;
    }
    ...
    @ApiModelProperty(
        ...
        value = "Use this field to set the Billing Group ID for the call. Must be a valid and existing Billing Group ID."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Use this field to avoid duplicate commands. Telnyx will ignore others Dial commands with the same `command_id`."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Use another call's control id for sharing the same call session id"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Defines whether media should be encrypted on the call."
    )
    ...
    @ApiModelProperty(
        ...
        value = "SIP headers to be added to the SIP INVITE request. Currently only User-to-User header is supported."
    )
    ...
    public CallRequest sipTransportProtocol(
        SipTransportProtocolEnum sipTransportProtocol
    ) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Defines SIP transport protocol to be used on the call."
    )
    ...
    @JsonProperty(JSON_PROPERTY_SIP_TRANSPORT_PROTOCOL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSipTransportProtocol(
        SipTransportProtocolEnum sipTransportProtocol
    ) {
        this.sipTransportProtocol = sipTransportProtocol;
    }

    public CallRequest soundModifications(
    ...
    public CallRequest streamBidirectionalMode(
    ...
    @JsonProperty(JSON_PROPERTY_STREAM_BIDIRECTIONAL_MODE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setStreamBidirectionalMode(
        StreamBidirectionalMode streamBidirectionalMode
    ) {
        this.streamBidirectionalMode = streamBidirectionalMode;
    }

    public CallRequest streamBidirectionalCodec(
    ...
    @JsonProperty(JSON_PROPERTY_STREAM_BIDIRECTIONAL_CODEC)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setStreamBidirectionalCodec(
        StreamBidirectionalCodec streamBidirectionalCodec
    ) {
        this.streamBidirectionalCodec = streamBidirectionalCodec;
    }

    public CallRequest streamBidirectionalTargetLegs(
    ...
    @JsonProperty(JSON_PROPERTY_STREAM_BIDIRECTIONAL_TARGET_LEGS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setStreamBidirectionalTargetLegs(
        StreamBidirectionalTargetLegs streamBidirectionalTargetLegs
    ) {
        this.streamBidirectionalTargetLegs = streamBidirectionalTargetLegs;
    }

    public CallRequest streamBidirectionalSamplingRate(
    ...
    @JsonProperty(JSON_PROPERTY_STREAM_BIDIRECTIONAL_SAMPLING_RATE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setStreamBidirectionalSamplingRate(
        StreamBidirectionalSamplingRate streamBidirectionalSamplingRate
    ) {
        this.streamBidirectionalSamplingRate = streamBidirectionalSamplingRate;
    }
    ...
    @ApiModelProperty(
        example = "true",
        value = "Generate silence RTP packets when no transmission available."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Use this field to override the URL for which Telnyx will send subsequent webhooks to for this call."
    )
    ...
    @ApiModelProperty(
        example = "GET",
        value = "HTTP request type used for `webhook_url`."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The call leg which will be supervised by the new call."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The role of the supervisor call. 'barge' means that supervisor call hears and is being heard by both ends of the call (caller & callee). 'whisper' means that only supervised_call_control_id hears supervisor but supervisor can hear everything. 'monitor' means that nobody can hear supervisor call, but supervisor can hear everything on the call."
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enables Dialogflow for the current call. The default value is false."
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enable transcription upon call answer. The default value is false."
    )
    ...
    public CallRequest transcriptionConfig(
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCRIPTION_CONFIG)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscriptionConfig(
        TranscriptionStartRequest transcriptionConfig
    ) {
        this.transcriptionConfig = transcriptionConfig;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.to, callRequest.to) &&
            ...
            Objects.equals(
                ...
                callRequest.answeringMachineDetection
            ) &&
            Objects.equals(
                this.answeringMachineDetectionConfig,
                callRequest.answeringMachineDetectionConfig
            ) &&
            Objects.equals(
                this.conferenceConfig,
                callRequest.conferenceConfig
            ) &&
            ...
            Objects.equals(
                this.sipTransportProtocol,
                callRequest.sipTransportProtocol
            ) &&
            Objects.equals(
                this.soundModifications,
                callRequest.soundModifications
            ) &&
            Objects.equals(this.streamUrl, callRequest.streamUrl) &&
            Objects.equals(this.streamTrack, callRequest.streamTrack) &&
            Objects.equals(
                this.streamBidirectionalMode,
                callRequest.streamBidirectionalMode
            ) &&
            Objects.equals(
                this.streamBidirectionalCodec,
                callRequest.streamBidirectionalCodec
            ) &&
            Objects.equals(
                this.streamBidirectionalTargetLegs,
                callRequest.streamBidirectionalTargetLegs
            ) &&
            Objects.equals(
                this.streamBidirectionalSamplingRate,
                callRequest.streamBidirectionalSamplingRate
            ) &&
            Objects.equals(
                this.sendSilenceWhenIdle,
                callRequest.sendSilenceWhenIdle
            ) &&
            Objects.equals(this.webhookUrl, callRequest.webhookUrl) &&
            Objects.equals(
                this.webhookUrlMethod,
                callRequest.webhookUrlMethod
            ) &&
            ...
            Objects.equals(
                ...
                callRequest.recordCustomFileName
            ) &&
            Objects.equals(
                this.superviseCallControlId,
                callRequest.superviseCallControlId
            ) &&
            Objects.equals(this.supervisorRole, callRequest.supervisorRole) &&
            Objects.equals(
                this.enableDialogflow,
                callRequest.enableDialogflow
            ) &&
            Objects.equals(
                this.dialogflowConfig,
                callRequest.dialogflowConfig
            ) &&
            Objects.equals(this.transcription, callRequest.transcription) &&
            Objects.equals(
                this.transcriptionConfig,
                callRequest.transcriptionConfig
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    timeLimitSecs: ")
            .append(toIndentedString(timeLimitSecs))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    answeringMachineDetectionConfig: ")
            .append(toIndentedString(answeringMachineDetectionConfig))
            .append("\n");
        sb
            .append("    conferenceConfig: ")
            .append(toIndentedString(conferenceConfig))
            .append("\n");
        sb
        ...
        sb
            .append("    mediaEncryption: ")
            .append(toIndentedString(mediaEncryption))
            .append("\n");
        sb
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    sipTransportProtocol: ")
            .append(toIndentedString(sipTransportProtocol))
            .append("\n");
        sb
            .append("    soundModifications: ")
            .append(toIndentedString(soundModifications))
            .append("\n");
        sb
            .append("    streamUrl: ")
        ...
        sb
            .append("    streamTrack: ")
            .append(toIndentedString(streamTrack))
            .append("\n");
        sb
            .append("    streamBidirectionalMode: ")
            .append(toIndentedString(streamBidirectionalMode))
            .append("\n");
        sb
            .append("    streamBidirectionalCodec: ")
            .append(toIndentedString(streamBidirectionalCodec))
            .append("\n");
        sb
            .append("    streamBidirectionalTargetLegs: ")
            .append(toIndentedString(streamBidirectionalTargetLegs))
            .append("\n");
        sb
            .append("    streamBidirectionalSamplingRate: ")
            .append(toIndentedString(streamBidirectionalSamplingRate))
            .append("\n");
        sb
            .append("    sendSilenceWhenIdle: ")
            .append(toIndentedString(sendSilenceWhenIdle))
            .append("\n");
        sb
            .append("    webhookUrl: ")
            ...
            .append("\n");
        sb
            .append("    webhookUrlMethod: ")
            .append(toIndentedString(webhookUrlMethod))
            .append("\n");
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    superviseCallControlId: ")
            .append(toIndentedString(superviseCallControlId))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    enableDialogflow: ")
            .append(toIndentedString(enableDialogflow))
            .append("\n");
        sb
            .append("    dialogflowConfig: ")
            .append(toIndentedString(dialogflowConfig))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    transcriptionConfig: ")
            .append(toIndentedString(transcriptionConfig))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
