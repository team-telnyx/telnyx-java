...
public class SendDTMFRequest {
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "DTMF digits to send. Valid digits are 0-9, A-D, *, and #. Pauses can be added using w (0.5s) and W (1s)."
    )
    ...
    @ApiModelProperty(
        example = "500",
        value = "Specifies for how many milliseconds each digit will be played in the audio stream. Ranges from 100 to 500ms"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.digits, sendDTMFRequest.digits) &&
            Objects.equals(
                this.durationMillis,
                sendDTMFRequest.durationMillis
            ) &&
