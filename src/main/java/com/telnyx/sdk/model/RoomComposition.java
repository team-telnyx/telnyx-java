...
public class RoomComposition {
    ...
    @ApiModelProperty(
        ...
        value = "A unique identifier for the room composition."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Identify the room associated with the room composition."
    )
    ...
    @ApiModelProperty(
        example = "0ccc7b54-4df3-4bca-a65a-3da1ecc777b0",
        value = "Identify the room session associated with the room composition."
    )
    ...
    @ApiModelProperty(
        example = "0ccc7b54-4df3-4bca-a65a-3da1ecc777b0",
        value = "Identify the user associated with the room composition."
    )
    ...
    @ApiModelProperty(
        example = "completed",
        value = "Shows the room composition status."
    )
    ...
    @ApiModelProperty(
        example = "10.5",
        value = "Shows the room composition size in MB."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Url to download the composition."
    )
    ...
    @ApiModelProperty(
        example = "67",
        value = "Shows the room composition duration in seconds."
    )
    ...
    @ApiModelProperty(
        example = "mp4",
        value = "Shows format of the room composition."
    )
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 timestamp when the room composition was created."
    )
    ...
    @ApiModelProperty(
        example = "2021-03-26T17:51:59.588408Z",
        value = "ISO 8601 timestamp when the room composition was updated."
    )
    ...
    @ApiModelProperty(
        example = "2021-03-26T17:51:59.588408Z",
        value = "ISO 8601 timestamp when the room composition has ended."
    )
    ...
    @ApiModelProperty(
        example = "2021-03-26T17:51:59.588408Z",
        value = "ISO 8601 timestamp when the room composition has stated."
    )
    ...
    @ApiModelProperty(
        example = "2021-03-26T17:51:59.588408Z",
        value = "ISO 8601 timestamp when the room composition has completed."
    )
    ...
    public RoomComposition putvideoLayoutItem(
        String key,
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Describes the video layout of the room composition in terms of regions. Limited to 2 regions."
    )
    ...
    public RoomComposition webhookEventFailoverUrl(
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, roomComposition.id) &&
            ...
            Objects.equals(
                ...
                roomComposition.webhookEventUrl
            ) &&
            equalsNullable(
                this.webhookEventFailoverUrl,
                roomComposition.webhookEventFailoverUrl
            ) &&
            equalsNullable(
                this.webhookTimeoutSecs,
                roomComposition.webhookTimeoutSecs
            ) &&
