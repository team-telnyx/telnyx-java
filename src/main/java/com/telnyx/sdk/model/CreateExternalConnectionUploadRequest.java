...
public class CreateExternalConnectionUploadRequest {
    ...
    public enum UsageEnum {
        ...
        FIRST_PARTY_APP_ASSIGNMENT(
            String.valueOf("first_party_app_assignment")
        );
    ...
    public static final String JSON_PROPERTY_ADDITIONAL_USAGES =
        "additional_usages";
    ...
    public CreateExternalConnectionUploadRequest numberIds(
        List<String> numberIds
    ) {
        this.numberIds = numberIds;
        return this;
    }

    public CreateExternalConnectionUploadRequest addnumberIdsItem(
        String numberIdsItem
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The use case of the upload request. NOTE: `calling_user_assignment` is not supported for toll free numbers."
    )
    ...
    public CreateExternalConnectionUploadRequest additionalUsages(
        List<AdditionalUsagesEnum> additionalUsages
    ) {
        this.additionalUsages = additionalUsages;
        return this;
    }

    public CreateExternalConnectionUploadRequest addadditionalUsagesItem(
        AdditionalUsagesEnum additionalUsagesItem
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_ADDITIONAL_USAGES)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setAdditionalUsages(
        List<AdditionalUsagesEnum> additionalUsages
    ) {
        this.additionalUsages = additionalUsages;
    }
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Identifies the location to assign all phone numbers to."
    )
    ...
    public CreateExternalConnectionUploadRequest civicAddressId(
        UUID civicAddressId
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Identifies the civic address to assign all phone numbers to."
    )
    ...
    public boolean equals(Object o) {
        ...
        CreateExternalConnectionUploadRequest createExternalConnectionUploadRequest =
            (CreateExternalConnectionUploadRequest) o;
        return (
            Objects.equals(
                this.numberIds,
                createExternalConnectionUploadRequest.numberIds
            ) &&
            Objects.equals(
                this.usage,
                createExternalConnectionUploadRequest.usage
            ) &&
            Objects.equals(
                this.additionalUsages,
                createExternalConnectionUploadRequest.additionalUsages
            ) &&
            Objects.equals(
                this.locationId,
                createExternalConnectionUploadRequest.locationId
            ) &&
            Objects.equals(
                this.civicAddressId,
                createExternalConnectionUploadRequest.civicAddressId
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    numberIds: ")
            .append(toIndentedString(numberIds))
            .append("\n");
        sb.append("    usage: ").append(toIndentedString(usage)).append("\n");
        sb
            .append("    additionalUsages: ")
            .append(toIndentedString(additionalUsages))
            .append("\n");
        sb
            .append("    locationId: ")
