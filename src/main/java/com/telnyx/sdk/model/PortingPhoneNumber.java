...
public class PortingPhoneNumber {
    ...
    public static final String JSON_PROPERTY_PORTING_ORDER_STATUS =
    ...
    public static final String JSON_PROPERTY_ACTIVATION_STATUS =
        "activation_status";
    private PortingOrderActivationStatus activationStatus;

    public static final String JSON_PROPERTY_PORTABILITY_STATUS =
        "portability_status";
    ...
    public PortingPhoneNumber portingOrderStatus(
        PortingOrderStatusEnum portingOrderStatus
    ) {
    ...
    @ApiModelProperty(
        example = "in-process",
        value = "The current status of the porting order"
    )
    ...
    @JsonProperty(JSON_PROPERTY_PORTING_ORDER_STATUS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPortingOrderStatus(
        PortingOrderStatusEnum portingOrderStatus
    ) {
        this.portingOrderStatus = portingOrderStatus;
    }

    public PortingPhoneNumber phoneNumberType(
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the associated port request"
    )
    ...
    @ApiModelProperty(
        example = "sr_a12345",
        value = "A key to reference this porting order when contacting Telnyx customer support"
    )
    ...
    public PortingPhoneNumber activationStatus(
        PortingOrderActivationStatus activationStatus
    ) {
    ...
    public PortingPhoneNumber portabilityStatus(
    ...
    public PortingPhoneNumber requirementsStatus(
    ...
    @ApiModelProperty(
        example = "approved",
        value = "The current status of the requirements in a INTL porting order"
    )
    ...
    @JsonProperty(JSON_PROPERTY_REQUIREMENTS_STATUS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRequirementsStatus(
        RequirementsStatusEnum requirementsStatus
    ) {
        this.requirementsStatus = requirementsStatus;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                ...
                portingPhoneNumber.portingOrderStatus
            ) &&
            Objects.equals(
                this.phoneNumberType,
                portingPhoneNumber.phoneNumberType
            ) &&
            Objects.equals(this.phoneNumber, portingPhoneNumber.phoneNumber) &&
            Objects.equals(
                this.portingOrderId,
                portingPhoneNumber.portingOrderId
            ) &&
            Objects.equals(this.supportKey, portingPhoneNumber.supportKey) &&
            Objects.equals(
                this.activationStatus,
                portingPhoneNumber.activationStatus
            ) &&
            Objects.equals(
                this.portabilityStatus,
                portingPhoneNumber.portabilityStatus
            ) &&
            Objects.equals(
                this.requirementsStatus,
                portingPhoneNumber.requirementsStatus
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    portingOrderStatus: ")
            .append(toIndentedString(portingOrderStatus))
            .append("\n");
        sb
        ...
        sb
            ...
            .append(toIndentedString(activationStatus))
            .append("\n");
        sb
            .append("    portabilityStatus: ")
            .append(toIndentedString(portabilityStatus))
            .append("\n");
        sb
