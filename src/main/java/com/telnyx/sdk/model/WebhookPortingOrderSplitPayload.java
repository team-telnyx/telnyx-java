...
public class WebhookPortingOrderSplitPayload {
  ...
  public static final String JSON_PROPERTY_PORTING_PHONE_NUMBERS = "porting_phone_numbers";
  private List<WebhookPortingOrderSplitPayloadPortingPhoneNumbersInner> portingPhoneNumbers = null;

  public WebhookPortingOrderSplitPayload() { 
  }

  public WebhookPortingOrderSplitPayload from(WebhookPortingOrderSplitPayloadFrom from) {
    this.from = from;
    return this;
  }
  ...
  **/
  ...
  public WebhookPortingOrderSplitPayload to(WebhookPortingOrderSplitPayloadTo to) {
    this.to = to;
    return this;
  }
  ...
  **/
  ...
  public WebhookPortingOrderSplitPayload portingPhoneNumbers(List<WebhookPortingOrderSplitPayloadPortingPhoneNumbersInner> portingPhoneNumbers) {
    this.portingPhoneNumbers = portingPhoneNumbers;
    return this;
  }

  public WebhookPortingOrderSplitPayload addportingPhoneNumbersItem(WebhookPortingOrderSplitPayloadPortingPhoneNumbersInner portingPhoneNumbersItem) {
  ...
  **/
  ...
  public List<WebhookPortingOrderSplitPayloadPortingPhoneNumbersInner> getPortingPhoneNumbers() {
    return portingPhoneNumbers;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PORTING_PHONE_NUMBERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPortingPhoneNumbers(List<WebhookPortingOrderSplitPayloadPortingPhoneNumbersInner> portingPhoneNumbers) {
    this.portingPhoneNumbers = portingPhoneNumbers;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookPortingOrderSplitPayload webhookPortingOrderSplitPayload = (WebhookPortingOrderSplitPayload) o;
    return Objects.equals(this.from, webhookPortingOrderSplitPayload.from) &&
        Objects.equals(this.to, webhookPortingOrderSplitPayload.to) &&
        Objects.equals(this.portingPhoneNumbers, webhookPortingOrderSplitPayload.portingPhoneNumbers);
  }
  ...
  public String toString() {
    ...
    sb.append("    portingPhoneNumbers: ").append(toIndentedString(portingPhoneNumbers)).append("\n");
    sb.append("}");
    return sb.toString();
  }
