...
public class WhatsappPhoneNumberWhatsappSettings {
    ...
    public static final String JSON_PROPERTY_DISPLAY_NAME_STATUS =
        "display_name_status";
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The display name of the phone number in the WhatsApp app"
    )
    ...
    public WhatsappPhoneNumberWhatsappSettings displayNameStatus(
        DisplayNameStatusEnum displayNameStatus
    ) {
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The Facebook approval status of the phone numbers display name"
    )
    ...
    public WhatsappPhoneNumberWhatsappSettings qualityRating(
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The quality rating of the number in the WhatsApp app"
    )
    ...
    public boolean equals(Object o) {
        ...
        WhatsappPhoneNumberWhatsappSettings whatsappPhoneNumberWhatsappSettings =
            (WhatsappPhoneNumberWhatsappSettings) o;
        return (
            Objects.equals(this.id, whatsappPhoneNumberWhatsappSettings.id) &&
            Objects.equals(
                this.displayName,
                whatsappPhoneNumberWhatsappSettings.displayName
            ) &&
            Objects.equals(
                this.displayNameStatus,
                whatsappPhoneNumberWhatsappSettings.displayNameStatus
            ) &&
            Objects.equals(
                this.qualityRating,
                whatsappPhoneNumberWhatsappSettings.qualityRating
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    displayNameStatus: ")
            .append(toIndentedString(displayNameStatus))
            .append("\n");
        sb
