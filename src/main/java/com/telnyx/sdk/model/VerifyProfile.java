...
public class VerifyProfile {
    ...
    public static final String JSON_PROPERTY_MESSAGING_ENABLED =
        "messaging_enabled";
    ...
    public static final String JSON_PROPERTY_MESSAGING_TEMPLATE =
        "messaging_template";
    private String messagingTemplate;

    public static final String JSON_PROPERTY_DEFAULT_TIMEOUT_SECS =
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The name of the Verify profile."
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enables SMS text messaging for the Verify profile."
    )
    ...
    @ApiModelProperty(
        example = "true",
        required = true,
        value = "Enables RCS messaging for the Verify profile."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Optionally sets a messaging text template when sending the verification code. Uses `{code}` to template in the actual verification code."
    )
    ...
    @ApiModelProperty(
        example = "true",
        value = "Enables VSMS for the Verify profile."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, verifyProfile.id) &&
            ...
            Objects.equals(
                ...
                verifyProfile.messagingEnabled
            ) &&
            Objects.equals(this.rcsEnabled, verifyProfile.rcsEnabled) &&
            Objects.equals(
                this.messagingTemplate,
                verifyProfile.messagingTemplate
            ) &&
            Objects.equals(
                this.defaultTimeoutSecs,
                verifyProfile.defaultTimeoutSecs
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    messagingEnabled: ")
            .append(toIndentedString(messagingEnabled))
            .append("\n");
        sb
            .append("    rcsEnabled: ")
            .append(toIndentedString(rcsEnabled))
            .append("\n");
        sb
            .append("    messagingTemplate: ")
            .append(toIndentedString(messagingTemplate))
            .append("\n");
        sb
            .append("    defaultTimeoutSecs: ")
            .append(toIndentedString(defaultTimeoutSecs))
            .append("\n");
        sb
            .append("    vsmsEnabled: ")
            .append(toIndentedString(vsmsEnabled))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
