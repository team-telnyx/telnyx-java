...
public class PortingOrderMisc {
    ...
    public static final String JSON_PROPERTY_REMAINING_NUMBERS_ACTION =
        "remaining_numbers_action";
    private RemainingNumbersActionEnum remainingNumbersAction;

    public static final String JSON_PROPERTY_NEW_BILLING_PHONE_NUMBER =
    ...
    public PortingOrderMisc remainingNumbersAction(
        RemainingNumbersActionEnum remainingNumbersAction
    ) {
    ...
    @ApiModelProperty(
        example = "disconnect",
        value = "Remaining numbers can be either kept with their current service provider or disconnected. 'new_billing_telephone_number' is required when 'remaining_numbers_action' is 'keep'."
    )
    ...
    @JsonProperty(JSON_PROPERTY_REMAINING_NUMBERS_ACTION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRemainingNumbersAction(
        RemainingNumbersActionEnum remainingNumbersAction
    ) {
        this.remainingNumbersAction = remainingNumbersAction;
    }

    public PortingOrderMisc newBillingPhoneNumber(
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "New billing phone number for the remaining numbers. Used in case the current billing phone number is being ported to Telnyx. This will be set on your account with your current service provider and should be one of the numbers remaining on that account."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.type, portingOrderMisc.type) &&
            Objects.equals(
                this.remainingNumbersAction,
                portingOrderMisc.remainingNumbersAction
            ) &&
            Objects.equals(
                this.newBillingPhoneNumber,
                portingOrderMisc.newBillingPhoneNumber
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    remainingNumbersAction: ")
            .append(toIndentedString(remainingNumbersAction))
            .append("\n");
        sb
            .append("    newBillingPhoneNumber: ")
            .append(toIndentedString(newBillingPhoneNumber))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
