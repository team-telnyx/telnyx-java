...
public class PortingOrderDocument {
    ...
    @ApiModelProperty(
        ...
        value = "Uniquely identifies the document in the porting order"
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        example = "porting_order_document",
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        example = "2020-03-19T10:07:15.527Z",
        value = "ISO 8601 formatted date/time when document was associated for the porting order."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, portingOrderDocument.id) &&
            Objects.equals(
                this.documentType,
                portingOrderDocument.documentType
            ) &&
