...
public class PhoneNumberWithMessagingSettingsFeatures {
    ...
    private JsonNullable<MessagingFeatureSet> sms = JsonNullable.<
            MessagingFeatureSet
        >undefined();

    public static final String JSON_PROPERTY_MMS = "mms";
    private JsonNullable<MessagingFeatureSet> mms = JsonNullable.<
            MessagingFeatureSet
        >undefined();

    public PhoneNumberWithMessagingSettingsFeatures() {}

    public PhoneNumberWithMessagingSettingsFeatures sms(
        MessagingFeatureSet sms
    ) {
    ...
    public PhoneNumberWithMessagingSettingsFeatures mms(
        MessagingFeatureSet mms
    ) {
    ...
    public boolean equals(Object o) {
        ...
        PhoneNumberWithMessagingSettingsFeatures phoneNumberWithMessagingSettingsFeatures =
            (PhoneNumberWithMessagingSettingsFeatures) o;
        return (
            equalsNullable(
                this.sms,
                phoneNumberWithMessagingSettingsFeatures.sms
            ) &&
            equalsNullable(
                this.mms,
                phoneNumberWithMessagingSettingsFeatures.mms
            )
        );
    }
