...
public class Room {
    ...
    public static final String JSON_PROPERTY_ACTIVE_SESSION_ID =
        "active_session_id";
    ...
    @JsonCreator
    public Room(@JsonProperty(JSON_PROPERTY_RECORD_TYPE) String recordType) {
        this();
    ...
    @ApiModelProperty(
        ...
        value = "A unique identifier for the room."
    )
    ...
    @ApiModelProperty(
        example = "50",
        value = "Maximum participants allowed in the room."
    )
    ...
    @ApiModelProperty(
        example = "0ccc7b54-4df3-4bca-a65a-3da1ecc777f0",
        value = "The identifier of the active room session if any."
    )
    ...
    public String toString() {
        ...
        sb
            ...
            .append(toIndentedString(activeSessionId))
            .append("\n");
        sb
            .append("    sessions: ")
