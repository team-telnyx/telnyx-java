...
public class HostedNumber {
    ...
    @JsonCreator
    public HostedNumber(@JsonProperty(JSON_PROPERTY_ID) UUID id) {
        this();
        this.id = id;
    }
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The messaging hosted phone number (+E.164 format)"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, hostedNumber.recordType) &&
