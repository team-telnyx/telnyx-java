...
public class LeaveConferenceRequest {
    ...
    @ApiModelProperty(
        example = "on_exit",
        value = "Whether a beep sound should be played when the participant leaves the conference. Can be used to override the conference-level setting."
    )
    ...
    public boolean equals(Object o) {
        ...
        LeaveConferenceRequest leaveConferenceRequest =
            (LeaveConferenceRequest) o;
        return (
            Objects.equals(
                this.callControlId,
                leaveConferenceRequest.callControlId
            ) &&
