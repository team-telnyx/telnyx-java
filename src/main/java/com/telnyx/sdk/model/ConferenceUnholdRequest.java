 ...
 */
@JsonPropertyOrder({ ConferenceUnholdRequest.JSON_PROPERTY_CALL_CONTROL_IDS })
...
public class ConferenceUnholdRequest {
    ...
    public ConferenceUnholdRequest addcallControlIdsItem(
    ...
    @ApiModelProperty(
        required = true,
        value = "List of unique identifiers and tokens for controlling the call. Enter each call control ID to be unheld."
    )
    ...
    public boolean equals(Object o) {
        ...
        ConferenceUnholdRequest conferenceUnholdRequest =
            (ConferenceUnholdRequest) o;
        return Objects.equals(
            this.callControlIds,
            conferenceUnholdRequest.callControlIds
        );
    }
