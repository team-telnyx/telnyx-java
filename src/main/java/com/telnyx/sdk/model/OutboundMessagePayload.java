...
public class OutboundMessagePayload {
    ...
    private JsonNullable<OutboundMessagePayloadCost> cost = JsonNullable.<
    ...
    private JsonNullable<OffsetDateTime> validUntil = JsonNullable.<
            OffsetDateTime
        >undefined();
    ...
    @ApiModelProperty(
        example = "outbound",
        value = "The direction of the message. Inbound messages are sent to you whereas outbound messages are sent from you."
    )
    ...
    public OutboundMessagePayload messagingProfileId(
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The id of the organization the messaging profile belongs to."
    )
    ...
    public OutboundMessagePayload addtoItem(
        OutboundMessagePayloadToInner toItem
    ) {
        if (this.to == null) {
    ...
    public OutboundMessagePayload media(
        List<OutboundMessagePayloadMediaInner> media
    ) {
        this.media = media;
        return this;
    }

    public OutboundMessagePayload addmediaItem(
        OutboundMessagePayloadMediaInner mediaItem
    ) {
        if (this.media == null) {
    ...
    public OutboundMessagePayload webhookFailoverUrl(
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Number of parts into which the message's body must be split."
    )
    ...
    @JsonProperty(JSON_PROPERTY_COST)
    public void setCost_JsonNullable(
        JsonNullable<OutboundMessagePayloadCost> cost
    ) {
        this.cost = cost;
    }
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "ISO 8601 formatted date indicating when the message was sent."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "ISO 8601 formatted date indicating when the message was finalized."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Message must be out of the queue by this time or else it will be discarded and marked as 'sending_failed'. Once the message moves out of the queue, this field will be nulled"
    )
    @JsonIgnore
    ...
    @JsonProperty(JSON_PROPERTY_VALID_UNTIL)
    public void setValidUntil_JsonNullable(
        JsonNullable<OffsetDateTime> validUntil
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "These errors may point at addressees when referring to unsuccessful/unconfirmed delivery statuses."
    )
    ...
    public boolean equals(Object o) {
        ...
        OutboundMessagePayload outboundMessagePayload =
            (OutboundMessagePayload) o;
        return (
            Objects.equals(
                this.recordType,
                outboundMessagePayload.recordType
            ) &&
            ...
            Objects.equals(
                ...
                outboundMessagePayload.messagingProfileId
            ) &&
            Objects.equals(
                this.organizationId,
                outboundMessagePayload.organizationId
            ) &&
            ...
            equalsNullable(
                this.webhookUrl,
                outboundMessagePayload.webhookUrl
            ) &&
            equalsNullable(
                this.webhookFailoverUrl,
                outboundMessagePayload.webhookFailoverUrl
            ) &&
            ...
            Objects.equals(
                this.receivedAt,
                outboundMessagePayload.receivedAt
            ) &&
            Objects.equals(this.sentAt, outboundMessagePayload.sentAt) &&
            Objects.equals(
                this.completedAt,
                outboundMessagePayload.completedAt
            ) &&
            equalsNullable(
                this.validUntil,
                outboundMessagePayload.validUntil
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    validUntil: ")
            .append(toIndentedString(validUntil))
            .append("\n");
