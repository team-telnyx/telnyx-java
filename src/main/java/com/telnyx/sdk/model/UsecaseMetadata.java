...
public class UsecaseMetadata {
    ...
    public static final String JSON_PROPERTY_MAX_SUB_USECASES =
        "maxSubUsecases";
    private Integer maxSubUsecases;

    public static final String JSON_PROPERTY_MIN_SUB_USECASES =
        "minSubUsecases";
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Maximum number of sub-usecases declaration required."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Minimum number of sub-usecases declaration required."
    )
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Map of usecase metadata for each MNO. Key is the network ID of the MNO (e.g. 10017), Value is the mno metadata for the usecase."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.annualFee, usecaseMetadata.annualFee) &&
            Objects.equals(
                this.maxSubUsecases,
                usecaseMetadata.maxSubUsecases
            ) &&
            Objects.equals(
                this.minSubUsecases,
                usecaseMetadata.minSubUsecases
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    annualFee: ")
            .append(toIndentedString(annualFee))
            .append("\n");
        sb
            .append("    maxSubUsecases: ")
            .append(toIndentedString(maxSubUsecases))
            .append("\n");
        sb
            .append("    minSubUsecases: ")
            .append(toIndentedString(minSubUsecases))
            .append("\n");
        sb
            .append("    mnoMetadata: ")
            .append(toIndentedString(mnoMetadata))
            .append("\n");
        sb
            .append("    monthlyFee: ")
            .append(toIndentedString(monthlyFee))
            .append("\n");
        sb
            .append("    quarterlyFee: ")
            .append(toIndentedString(quarterlyFee))
            .append("\n");
        sb
            .append("    usecase: ")
