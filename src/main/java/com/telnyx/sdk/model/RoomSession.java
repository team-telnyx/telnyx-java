...
public class RoomSession {
    ...
    @ApiModelProperty(
        ...
        value = "A unique identifier for the room session."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Identify the room hosting that room session."
    )
    ...
    @ApiModelProperty(
        example = "false",
        value = "Shows if the room session is active or not."
    )
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 timestamp when the room session was created."
    )
    ...
    @ApiModelProperty(
        example = "2021-03-26T17:51:59.588408Z",
        value = "ISO 8601 timestamp when the room session was updated."
    )
    ...
    @ApiModelProperty(
        example = "2021-03-26T17:51:59.588408Z",
        value = "ISO 8601 timestamp when the room session has ended."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, roomSession.id) &&
