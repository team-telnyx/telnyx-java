...
public class BrandFeedbackCategory {
    ...
    @ApiModelProperty(
        example = "TAX_ID",
        required = true,
        value = "One of `TAX_ID`, `STOCK_SYMBOL`, `GOVERNMENT_ENTITY`, `NONPROFIT`, and `OTHERS`"
    )
    ...
    @ApiModelProperty(
        example = "Tax Id",
        required = true,
        value = "Human-readable version of the `id` field"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Long-form description of the feedback with additional information"
    )
    ...
    @jakarta.annotation.Nonnull
    @ApiModelProperty(
        example = "[\"ein\",\"companyName\",\"entityType\"]",
        required = true,
        value = "List of relevant fields in the originally-submitted brand json"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, brandFeedbackCategory.id) &&
            Objects.equals(
                this.displayName,
                brandFeedbackCategory.displayName
            ) &&
            Objects.equals(
                this.description,
                brandFeedbackCategory.description
            ) &&
