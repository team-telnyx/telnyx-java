...
public class WhatsAppDetailRecord {
    ...
    public static final String JSON_PROPERTY_RECIPIENT_REGION_CODE =
    ...
    public static final String JSON_PROPERTY_WHATSAPP_ERROR_CODE =
        "whatsapp_error_code";
    ...
    public static final String JSON_PROPERTY_WEBHOOK_RECEIVED_AT =
        "webhook_received_at";
    ...
    public static final String JSON_PROPERTY_CONVERSATION_ID =
        "conversation_id";
    ...
    public static final String JSON_PROPERTY_CONVERSATION_ORIGIN =
        "conversation_origin";
    ...
    @ApiModelProperty(
        example = "session",
        value = "WhatsApp Message Type. Consult WhatsApp API documentation to see all available types"
    )
    ...
    @ApiModelProperty(
        example = "delivered",
        value = "WhatsApp Message Status. Consult WhatsApp API documentation to see all available status"
    )
    ...
    public WhatsAppDetailRecord recipientRegionCode(
        String recipientRegionCode
    ) {
    ...
    @ApiModelProperty(
        example = "US",
        value = "CLDR two-letter region-code of recipient"
    )
    ...
    @ApiModelProperty(
        example = "490",
        value = "A string representing Whatsapp error code. Consult WhatsApp API documentation to see all available error codes"
    )
    ...
    @ApiModelProperty(
        ...
        value = "UTC time when the message was created"
    )
    ...
    public WhatsAppDetailRecord webhookReceivedAt(
        OffsetDateTime webhookReceivedAt
    ) {
    ...
    @ApiModelProperty(
        example = "2021-08-06T03:32:01.125Z",
        value = "UTC time when the webhook was received"
    )
    ...
    @ApiModelProperty(
        ...
        value = "UUID representation of the webhook unique identifier"
    )
    ...
    @ApiModelProperty(
        example = "0.003",
        value = "Currency amount for WhatsApp cost"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Whatsapp Conversation ID"
    )
    ...
    public WhatsAppDetailRecord conversationOrigin(
        ConversationOriginEnum conversationOrigin
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_CONVERSATION_ORIGIN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setConversationOrigin(
        ConversationOriginEnum conversationOrigin
    ) {
        this.conversationOrigin = conversationOrigin;
    }

    public WhatsAppDetailRecord whatsappBusinessAccountId(
    ...
    public String toString() {
        ...
        sb
            .append("    recipientId: ")
            .append(toIndentedString(recipientId))
            .append("\n");
        sb
            .append("    messageType: ")
        ...
        sb
            ...
            .append(toIndentedString(messageStatus))
            .append("\n");
        sb
            .append("    direction: ")
            ...
            .append("\n");
        sb
            .append("    recipientRegionCode: ")
            .append(toIndentedString(recipientRegionCode))
            .append("\n");
        sb
            .append("    currency: ")
            ...
            .append("\n");
        sb
            .append("    whatsappErrorCode: ")
            .append(toIndentedString(whatsappErrorCode))
            .append("\n");
        sb
            .append("    createdAt: ")
            ...
            .append("\n");
        sb
            .append("    webhookReceivedAt: ")
            .append(toIndentedString(webhookReceivedAt))
            .append("\n");
        sb
            .append("    webhookId: ")
            .append(toIndentedString(webhookId))
            .append("\n");
        sb
            .append("    telnyxFee: ")
            .append(toIndentedString(telnyxFee))
            .append("\n");
        sb
            .append("    whatsappFee: ")
            .append(toIndentedString(whatsappFee))
            .append("\n");
        sb
            .append("    conversationId: ")
            .append(toIndentedString(conversationId))
            .append("\n");
        sb
            .append("    conversationOrigin: ")
            .append(toIndentedString(conversationOrigin))
            .append("\n");
        sb
            .append("    whatsappBusinessAccountId: ")
            .append(toIndentedString(whatsappBusinessAccountId))
            .append("\n");
        sb
            .append("    recordType: ")
