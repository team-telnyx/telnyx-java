...
public class VerifyDetailRecord {
    ...
    public static final String JSON_PROPERTY_DESTINATION_PHONE_NUMBER =
    ...
    public static final String JSON_PROPERTY_VERIFY_CHANNEL_TYPE =
        "verify_channel_type";
    private VerifyChannelTypeEnum verifyChannelType;

    public static final String JSON_PROPERTY_VERIFY_CHANNEL_ID =
        "verify_channel_id";
    ...
    public static final String JSON_PROPERTY_VERIFY_USAGE_FEE =
        "verify_usage_fee";
    ...
    @ApiModelProperty(
        ...
        value = "Unique ID of the verification"
    )
    ...
    public VerifyDetailRecord destinationPhoneNumber(
    ...
    @ApiModelProperty(
        example = "+13124515883",
        value = "E.164 formatted phone number"
    )
    ...
    public VerifyDetailRecord verifyChannelType(
        VerifyChannelTypeEnum verifyChannelType
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Depending on the type of verification, the `verify_channel_id` points to one of the following channel ids; --- verify_channel_type | verify_channel_id ------------------- | ----------------- sms, psd2           | messaging_id call, flashcall     | call_control_id whatsapp            | messaging_whatsapp_id --- "
    )
    ...
    @ApiModelProperty(
        example = "0.002",
        value = "Currency amount per billing unit used to calculate the Telnyx billing costs"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Billing unit used to calculate the Telnyx billing costs"
    )
    ...
    @ApiModelProperty(
        example = "0.002",
        value = "Currency amount for Verify Usage Fee"
    )
    ...
    @ApiModelProperty(
        example = "USD",
        value = "Telnyx account currency used to describe monetary values, including billing costs"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, verifyDetailRecord.id) &&
            Objects.equals(
                this.verifyProfileId,
                verifyDetailRecord.verifyProfileId
            ) &&
            Objects.equals(
                this.deliveryStatus,
                verifyDetailRecord.deliveryStatus
            ) &&
            Objects.equals(
                this.verificationStatus,
                verifyDetailRecord.verificationStatus
            ) &&
            Objects.equals(
                this.destinationPhoneNumber,
                verifyDetailRecord.destinationPhoneNumber
            ) &&
            Objects.equals(
                this.verifyChannelType,
                verifyDetailRecord.verifyChannelType
            ) &&
            Objects.equals(
                this.verifyChannelId,
                verifyDetailRecord.verifyChannelId
            ) &&
            ...
            Objects.equals(
                this.rateMeasuredIn,
                verifyDetailRecord.rateMeasuredIn
            ) &&
            Objects.equals(
                this.verifyUsageFee,
                verifyDetailRecord.verifyUsageFee
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    destinationPhoneNumber: ")
            .append(toIndentedString(destinationPhoneNumber))
            .append("\n");
        sb
            .append("    verifyChannelType: ")
            .append(toIndentedString(verifyChannelType))
            .append("\n");
        sb
            .append("    verifyChannelId: ")
            .append(toIndentedString(verifyChannelId))
            .append("\n");
        sb
            .append("    createdAt: ")
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    verifyUsageFee: ")
            .append(toIndentedString(verifyUsageFee))
            .append("\n");
        sb
            .append("    currency: ")
