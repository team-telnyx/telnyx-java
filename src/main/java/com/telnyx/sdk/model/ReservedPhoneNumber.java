...
public class ReservedPhoneNumber {
    ...
    @ApiModelProperty(
        example = "success",
        value = "The status of the phone number's reservation."
    )
    ...
    @ApiModelProperty(
        ...
        value = "An ISO 8901 datetime string denoting when the individual number reservation was created."
    )
    ...
    @ApiModelProperty(
        example = "2018-01-01T00:00:00.000000Z",
        value = "An ISO 8901 datetime string for when the the individual number reservation was updated."
    )
    ...
    @ApiModelProperty(
        example = "2018-01-01T00:00:00.000000Z",
        value = "An ISO 8901 datetime string for when the individual number reservation is going to expire"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, reservedPhoneNumber.id) &&
    ...
    public String toString() {
        ...
        sb
            .append("    expiredAt: ")
            .append(toIndentedString(expiredAt))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
