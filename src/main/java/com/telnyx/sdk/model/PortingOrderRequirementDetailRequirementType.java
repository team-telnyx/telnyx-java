...
public class PortingOrderRequirementDetailRequirementType {
    ...
    public PortingOrderRequirementDetailRequirementType acceptanceCriteria(
    ...
    @ApiModelProperty(
        example = "{\"acceptable_values\":[]}",
        value = "The acceptance criteria for the requirement type"
    )
    ...
    public PortingOrderRequirementDetailRequirementType description(
        String description
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "A description of the requirement type"
    )
    ...
    public PortingOrderRequirementDetailRequirementType example(
        String example
    ) {
    ...
    @ApiModelProperty(
        ...
        value = "An example of the requirement type"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the requirement type"
    )
    ...
    @ApiModelProperty(
        ...
        value = "The name of the requirement type"
    )
    ...
    @ApiModelProperty(
        example = "document",
        value = "The type of the requirement type"
    )
    ...
    public boolean equals(Object o) {
        ...
        PortingOrderRequirementDetailRequirementType portingOrderRequirementDetailRequirementType =
            (PortingOrderRequirementDetailRequirementType) o;
        return (
            Objects.equals(
                this.acceptanceCriteria,
                portingOrderRequirementDetailRequirementType.acceptanceCriteria
            ) &&
            Objects.equals(
                this.description,
                portingOrderRequirementDetailRequirementType.description
            ) &&
            Objects.equals(
                this.example,
                portingOrderRequirementDetailRequirementType.example
            ) &&
            Objects.equals(
                this.id,
                portingOrderRequirementDetailRequirementType.id
            ) &&
            Objects.equals(
                this.name,
                portingOrderRequirementDetailRequirementType.name
            ) &&
            Objects.equals(
                this.type,
                portingOrderRequirementDetailRequirementType.type
            )
        );
    }
