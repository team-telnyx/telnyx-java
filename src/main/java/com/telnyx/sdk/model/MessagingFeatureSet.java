 ...
 */
@ApiModel(
    description = "The set of features available for a specific messaging use case (SMS or MMS). Features can vary depending on the characteristics the phone number, as well as its current product configuration. "
)
@JsonPropertyOrder(
    {
...
public class MessagingFeatureSet {
    ...
    public static final String JSON_PROPERTY_DOMESTIC_TWO_WAY =
        "domestic_two_way";
    private Boolean domesticTwoWay;

    public static final String JSON_PROPERTY_INTERNATIONAL_INBOUND =
        "international_inbound";
    private Boolean internationalInbound;

    public static final String JSON_PROPERTY_INTERNATIONAL_OUTBOUND =
    ...
    @ApiModelProperty(
        required = true,
        value = "Send messages to and receive messages from numbers in the same country."
    )
    ...
    public MessagingFeatureSet internationalInbound(
        Boolean internationalInbound
    ) {
    ...
    @ApiModelProperty(
        required = true,
        value = "Receive messages from numbers in other countries."
    )
    ...
    public MessagingFeatureSet internationalOutbound(
        Boolean internationalOutbound
    ) {
    ...
    @ApiModelProperty(
        required = true,
        value = "Send messages to numbers in other countries."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                this.domesticTwoWay,
                messagingFeatureSet.domesticTwoWay
            ) &&
            Objects.equals(
                this.internationalInbound,
                messagingFeatureSet.internationalInbound
            ) &&
            Objects.equals(
                this.internationalOutbound,
                messagingFeatureSet.internationalOutbound
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    domesticTwoWay: ")
            .append(toIndentedString(domesticTwoWay))
            .append("\n");
        sb
            .append("    internationalInbound: ")
            .append(toIndentedString(internationalInbound))
            .append("\n");
        sb
            .append("    internationalOutbound: ")
            .append(toIndentedString(internationalOutbound))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
