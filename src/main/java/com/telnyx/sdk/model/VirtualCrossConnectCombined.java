...
public class VirtualCrossConnectCombined {
    ...
    public static final String JSON_PROPERTY_CLOUD_PROVIDER_REGION =
    ...
    public static final String JSON_PROPERTY_PRIMARY_CLOUD_ACCOUNT_ID =
        "primary_cloud_account_id";
    private String primaryCloudAccountId;

    public static final String JSON_PROPERTY_PRIMARY_TELNYX_IP =
        "primary_telnyx_ip";
    ...
    public static final String JSON_PROPERTY_PRIMARY_BGP_KEY =
        "primary_bgp_key";
    ...
    public static final String JSON_PROPERTY_SECONDARY_CLOUD_ACCOUNT_ID =
        "secondary_cloud_account_id";
    private String secondaryCloudAccountId;

    public static final String JSON_PROPERTY_SECONDARY_TELNYX_IP =
        "secondary_telnyx_ip";
    ...
    public static final String JSON_PROPERTY_SECONDARY_BGP_KEY =
        "secondary_bgp_key";
    ...
    public VirtualCrossConnectCombined cloudProvider(
    ...
    public VirtualCrossConnectCombined cloudProviderRegion(
    ...
    @ApiModelProperty(
        example = "us-east-1",
        required = true,
        value = "The region where your Virtual Private Cloud hosts are located.<br /><br />The available regions can be found using the /virtual_cross_connect_regions endpoint."
    )
    ...
    @ApiModelProperty(
        example = "1234",
        required = true,
        value = "The Border Gateway Protocol (BGP) Autonomous System Number (ASN). If null, value will be assigned by Telnyx."
    )
    ...
    @ApiModelProperty(
        example = "50",
        value = "The desired throughput in Megabits per Second (Mbps) for your Virtual Cross Connect.<br /><br />The available bandwidths can be found using the /virtual_cross_connect_regions endpoint."
    )
    ...
    public VirtualCrossConnectCombined primaryCloudAccountId(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The identifier for your Virtual Private Cloud. The number will be different based upon your Cloud provider."
    )
    ...
    @ApiModelProperty(
        example = "169.254.0.1",
        value = "The IP address assigned to the Telnyx side of the Virtual Cross Connect.<br /><br />If none is provided, one will be generated for you.<br /><br />This value should be null for GCE as Google will only inform you of your assigned IP once the connection has been accepted."
    )
    ...
    public VirtualCrossConnectCombined secondaryEnabled(
    ...
    public VirtualCrossConnectCombined secondaryCloudAccountId(
    ...
    @ApiModelProperty(
        example = "",
        value = "The identifier for your Virtual Private Cloud. The number will be different based upon your Cloud provider.<br /><br />This attribute is only necessary for GCE."
    )
    ...
    public VirtualCrossConnectCombined secondaryTelnyxIp(
        String secondaryTelnyxIp
    ) {
    ...
    public VirtualCrossConnectCombined secondaryCloudIp(
        String secondaryCloudIp
    ) {
    ...
    @ApiModelProperty(
        example = "ashburn-va",
        required = true,
        value = "The region interface is deployed to."
    )
    ...
    public VirtualCrossConnectCombined primaryRoutingAnnouncement(
    ...
    public VirtualCrossConnectCombined secondaryRoutingAnnouncement(
    ...
    public boolean equals(Object o) {
        ...
        VirtualCrossConnectCombined virtualCrossConnectCombined =
            (VirtualCrossConnectCombined) o;
        return (
            Objects.equals(this.id, virtualCrossConnectCombined.id) &&
            Objects.equals(
                this.recordType,
                virtualCrossConnectCombined.recordType
            ) &&
            Objects.equals(
                this.createdAt,
                virtualCrossConnectCombined.createdAt
            ) &&
            Objects.equals(
                this.updatedAt,
                virtualCrossConnectCombined.updatedAt
            ) &&
            Objects.equals(
                this.networkId,
                virtualCrossConnectCombined.networkId
            ) &&
            Objects.equals(this.name, virtualCrossConnectCombined.name) &&
            Objects.equals(this.status, virtualCrossConnectCombined.status) &&
            Objects.equals(
                this.cloudProvider,
                virtualCrossConnectCombined.cloudProvider
            ) &&
            Objects.equals(
                this.cloudProviderRegion,
                virtualCrossConnectCombined.cloudProviderRegion
            ) &&
            Objects.equals(this.bgpAsn, virtualCrossConnectCombined.bgpAsn) &&
            Objects.equals(
                this.bandwidthMbps,
                virtualCrossConnectCombined.bandwidthMbps
            ) &&
            Objects.equals(
                this.primaryEnabled,
                virtualCrossConnectCombined.primaryEnabled
            ) &&
            Objects.equals(
                this.primaryCloudAccountId,
                virtualCrossConnectCombined.primaryCloudAccountId
            ) &&
            Objects.equals(
                this.primaryTelnyxIp,
                virtualCrossConnectCombined.primaryTelnyxIp
            ) &&
            Objects.equals(
                this.primaryCloudIp,
                virtualCrossConnectCombined.primaryCloudIp
            ) &&
            Objects.equals(
                this.primaryBgpKey,
                virtualCrossConnectCombined.primaryBgpKey
            ) &&
            Objects.equals(
                this.secondaryEnabled,
                virtualCrossConnectCombined.secondaryEnabled
            ) &&
            Objects.equals(
                this.secondaryCloudAccountId,
                virtualCrossConnectCombined.secondaryCloudAccountId
            ) &&
            Objects.equals(
                this.secondaryTelnyxIp,
                virtualCrossConnectCombined.secondaryTelnyxIp
            ) &&
            Objects.equals(
                this.secondaryCloudIp,
                virtualCrossConnectCombined.secondaryCloudIp
            ) &&
            Objects.equals(
                this.secondaryBgpKey,
                virtualCrossConnectCombined.secondaryBgpKey
            ) &&
            Objects.equals(
                this.regionCode,
                virtualCrossConnectCombined.regionCode
            ) &&
            Objects.equals(
                this.primaryRoutingAnnouncement,
                virtualCrossConnectCombined.primaryRoutingAnnouncement
            ) &&
            Objects.equals(
                this.secondaryRoutingAnnouncement,
                virtualCrossConnectCombined.secondaryRoutingAnnouncement
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    cloudProviderRegion: ")
            .append(toIndentedString(cloudProviderRegion))
            .append("\n");
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    primaryCloudAccountId: ")
            .append(toIndentedString(primaryCloudAccountId))
            .append("\n");
        sb
            .append("    primaryTelnyxIp: ")
            .append(toIndentedString(primaryTelnyxIp))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    primaryBgpKey: ")
            .append(toIndentedString(primaryBgpKey))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    secondaryCloudAccountId: ")
            .append(toIndentedString(secondaryCloudAccountId))
            .append("\n");
        sb
            .append("    secondaryTelnyxIp: ")
            .append(toIndentedString(secondaryTelnyxIp))
            .append("\n");
        sb
            ...
            .append("\n");
        sb
            .append("    secondaryBgpKey: ")
            .append(toIndentedString(secondaryBgpKey))
            .append("\n");
        sb
            .append("    regionCode: ")
