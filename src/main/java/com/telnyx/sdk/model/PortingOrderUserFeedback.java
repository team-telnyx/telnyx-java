...
public class PortingOrderUserFeedback {
    ...
    @ApiModelProperty(
        example = "5",
        value = "Once an order is ported, cancellation is requested or the request is cancelled, the user may rate their experience"
    )
    ...
    @ApiModelProperty(
        ...
        value = "A comment related to the customer rating."
    )
    ...
    public boolean equals(Object o) {
        ...
        PortingOrderUserFeedback portingOrderUserFeedback =
            (PortingOrderUserFeedback) o;
        return (
            Objects.equals(
                this.userRating,
                portingOrderUserFeedback.userRating
            ) &&
            Objects.equals(
                this.userComment,
                portingOrderUserFeedback.userComment
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            .append("    userRating: ")
            .append(toIndentedString(userRating))
            .append("\n");
        sb
            .append("    userComment: ")
            .append(toIndentedString(userComment))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
