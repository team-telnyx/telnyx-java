...
public class QueueCall {
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "ISO 8601 formatted date of when the call was put in the queue"
    )
    ...
    @ApiModelProperty(
        example = "272",
        required = true,
        value = "The time the call has been waiting in the queue, given in seconds"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Unique identifier of the queue the call is in."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, queueCall.recordType) &&
    ...
    public String toString() {
        ...
        sb
            .append("    enqueuedAt: ")
            .append(toIndentedString(enqueuedAt))
            .append("\n");
        sb
            .append("    waitTimeSecs: ")
        ...
        sb
            .append("    queueId: ")
            .append(toIndentedString(queueId))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
