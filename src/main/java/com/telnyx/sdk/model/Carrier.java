...
public class Carrier {
    ...
    public static final String JSON_PROPERTY_NORMALIZED_CARRIER =
        "normalized_carrier";
    ...
    @ApiModelProperty(
        example = "US",
        value = "Region code that matches the specific country calling code if the requested phone number type is mobile"
    )
    ...
    @ApiModelProperty(
        example = "0866",
        value = "National destination code (NDC), with a 0 prefix, if an NDC is found and the requested phone number type is mobile"
    )
    ...
    @ApiModelProperty(
        example = "Telnyx/4",
        value = "SPID (Service Provider ID) name, if the requested phone number has been ported; otherwise, the name of carrier who owns the phone number block"
    )
    ...
    @ApiModelProperty(
        example = "voip",
        value = "A phone number type that identifies the type of service associated with the requested phone number"
    )
    ...
    @ApiModelProperty(
        example = "AT&T",
        value = "If known to Telnyx and applicable, the primary network carrier."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.mobileCountryCode, carrier.mobileCountryCode) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    normalizedCarrier: ")
            .append(toIndentedString(normalizedCarrier))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
