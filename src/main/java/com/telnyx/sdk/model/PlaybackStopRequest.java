...
public class PlaybackStopRequest {
    ...
    @ApiModelProperty(
        example = "true",
        value = "When enabled, it stops the audio being played in the overlay queue."
    )
    ...
    @ApiModelProperty(
        example = "current",
        value = "Use `current` to stop the current audio being played. Use `all` to stop the current audio file being played and clear all audio files from the queue."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.overlay, playbackStopRequest.overlay) &&
