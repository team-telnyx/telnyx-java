...
public class ListBulkSIMCardActions200Response {
    ...
    public ListBulkSIMCardActions200Response data(
        List<BulkSIMCardActionDetailed> data
    ) {
        this.data = data;
        return this;
    }

    public ListBulkSIMCardActions200Response adddataItem(
        BulkSIMCardActionDetailed dataItem
    ) {
        if (this.data == null) {
    ...
    public List<BulkSIMCardActionDetailed> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<BulkSIMCardActionDetailed> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        ListBulkSIMCardActions200Response listBulkSIMCardActions200Response =
            (ListBulkSIMCardActions200Response) o;
        return (
            Objects.equals(this.data, listBulkSIMCardActions200Response.data) &&
