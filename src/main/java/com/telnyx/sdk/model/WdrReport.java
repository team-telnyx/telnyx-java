...
public class WdrReport {
    ...
    @ApiModelProperty(
        example = "pending",
        value = "Indicates the status of the report, which is updated asynchronously."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The URL where the report content, when generated, will be published to."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.id, wdrReport.id) &&
