 ...
 */
@JsonPropertyOrder({
  ResourceNotFoundErrorAllOf.JSON_PROPERTY_CODE,
  ResourceNotFoundErrorAllOf.JSON_PROPERTY_TITLE,
  ResourceNotFoundErrorAllOf.JSON_PROPERTY_DETAIL,
  ResourceNotFoundErrorAllOf.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ResourceNotFoundErrorAllOf {
  ...
  public ResourceNotFoundErrorAllOf() { 
  }

  public ResourceNotFoundErrorAllOf code(Object code) {
  ...
  **/
  ...
  public ResourceNotFoundErrorAllOf title(Object title) {
  ...
  **/
  ...
  public ResourceNotFoundErrorAllOf detail(Object detail) {
  ...
  **/
  ...
  public ResourceNotFoundErrorAllOf meta(ResourceNotFoundErrorAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this ResourceNotFoundError_allOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResourceNotFoundErrorAllOf resourceNotFoundErrorAllOf = (ResourceNotFoundErrorAllOf) o;
    return equalsNullable(this.code, resourceNotFoundErrorAllOf.code) &&
        equalsNullable(this.title, resourceNotFoundErrorAllOf.title) &&
        equalsNullable(this.detail, resourceNotFoundErrorAllOf.detail) &&
        Objects.equals(this.meta, resourceNotFoundErrorAllOf.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceNotFoundErrorAllOf {\n");
