...
public class SendFaxRequest {
    ...
    @ApiModelProperty(
        example = "234423",
        required = true,
        value = "The connection ID to send the fax with."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The flag to enable monochrome, true black and white fax results."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Should fax media be stored on temporary URL. It does not support media_name, they can't be submitted together."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The format for the preview file in case the `store_preview` is `true`."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Use this field to override the URL to which Telnyx will send subsequent webhooks for this fax."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.connectionId, sendFaxRequest.connectionId) &&
            ...
            Objects.equals(
                ...
                sendFaxRequest.fromDisplayName
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    t38Enabled: ")
            .append(toIndentedString(t38Enabled))
            .append("\n");
        sb
            .append("    monochrome: ")
            .append(toIndentedString(monochrome))
            .append("\n");
        sb
            .append("    storeMedia: ")
        ...
        sb
            .append("    storePreview: ")
            .append(toIndentedString(storePreview))
            .append("\n");
        sb
            .append("    previewFormat: ")
            .append(toIndentedString(previewFormat))
            .append("\n");
        sb
            .append("    webhookUrl: ")
