...
public class PortingOrderStatus {
    ...
    public PortingOrderStatus details(
        List<PortingOrdersExceptionType> details
    ) {
        this.details = details;
        return this;
    }

    public PortingOrderStatus adddetailsItem(
        PortingOrdersExceptionType detailsItem
    ) {
    ...
    @ApiModelProperty(
        value = "A list of 0 or more details about this porting order's status"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.details, portingOrderStatus.details) &&
