...
public class PortoutDetails {
    ...
    public static final String JSON_PROPERTY_AUTHORIZED_NAME =
        "authorized_name";
    ...
    public static final String JSON_PROPERTY_CURRENT_CARRIER =
        "current_carrier";
    ...
    public static final String JSON_PROPERTY_SERVICE_ADDRESS =
        "service_address";
    ...
    public static final String JSON_PROPERTY_REQUESTED_FOC_DATE =
        "requested_foc_date";
    ...
    @ApiModelProperty(
        example = "[\"+35312345678\"]",
        value = "Phone numbers associated with this portout"
    )
    ...
    @ApiModelProperty(
        example = "test",
        value = "Carrier the number will be ported out to"
    )
    ...
    @ApiModelProperty(
        example = "Chicago",
        value = "City or municipality of billing address"
    )
    ...
    @ApiModelProperty(
        example = "IL",
        value = "State, province, or similar of billing address"
    )
    ...
    @ApiModelProperty(
        example = "00000",
        value = "Postal Code of billing address"
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        example = "[\"https://example.com/files/lsr.pdf\"]",
        value = "The Local Service Request"
    )
    ...
    @ApiModelProperty(
        example = "00000000",
        value = "Port order number assigned by the carrier the number will be ported out to"
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The reason why the order is being rejected by the user. If the order is authorized, this field can be left null"
    )
    ...
    @ApiModelProperty(
        example = "1002",
        value = "The rejection code for one of the valid rejections to reject a port out order"
    )
    ...
    @ApiModelProperty(
        ...
        value = "First line of billing address (street address)"
    )
    ...
    @ApiModelProperty(
        ...
        value = "ISO 8601 formatted Date/Time of the FOC date"
    )
    ...
    @ApiModelProperty(
        example = "2018-02-02T22:25:27.521Z",
        value = "ISO 8601 formatted Date/Time of the user requested FOC date"
    )
    ...
    @ApiModelProperty(
        example = "0ccc7b54-4df3-4bca-a65a-3da1ecc777f0",
        value = "New service provider spid"
    )
    ...
    @ApiModelProperty(
        example = "PO_764725",
        value = "A key to reference this port out request when contacting Telnyx customer support"
    )
    ...
    @ApiModelProperty(
        example = "false",
        value = "Is true when the number is already ported"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the user (or organization) who requested the port out"
    )
    ...
    @ApiModelProperty(
        ...
        value = "Telnyx partner providing network coverage"
    )
    ...
    @ApiModelProperty(
        example = "2018-02-02T22:25:27.521Z",
        value = "ISO 8601 formatted date of when the portout was created"
    )
    ...
    @ApiModelProperty(
        example = "2018-02-02T22:25:27.521Z",
        value = "ISO 8601 formatted date of when the portout was last updated"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(
                this.serviceAddress,
                portoutDetails.serviceAddress
            ) &&
            Objects.equals(this.focDate, portoutDetails.focDate) &&
            Objects.equals(
                this.requestedFocDate,
                portoutDetails.requestedFocDate
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    authorizedName: ")
            .append(toIndentedString(authorizedName))
            .append("\n");
        sb
            .append("    carrierName: ")
            .append(toIndentedString(carrierName))
            .append("\n");
        sb
            .append("    currentCarrier: ")
            .append(toIndentedString(currentCarrier))
            .append("\n");
        sb
            .append("    endUserName: ")
        ...
        sb
            .append("    rejectionCode: ")
            .append(toIndentedString(rejectionCode))
            .append("\n");
        sb
            .append("    serviceAddress: ")
            .append(toIndentedString(serviceAddress))
            .append("\n");
        sb
            .append("    focDate: ")
            .append(toIndentedString(focDate))
            .append("\n");
        sb
            .append("    requestedFocDate: ")
            .append(toIndentedString(requestedFocDate))
            .append("\n");
        ...
        sb
            .append("    alreadyPorted: ")
            .append(toIndentedString(alreadyPorted))
            .append("\n");
