...
public class AssignProfileToCampaignResponse {
  ...
  public AssignProfileToCampaignResponse messagingProfileId(String messagingProfileId) {
  ...
  **/
  @jakarta.annotation.Nonnull
  @ApiModelProperty(example = "667a80f8-b0a9-49d0-b9ab-a7a1bcc45086", required = true, value = "The ID of the task associated with assigning a messaging profile to a campaign.")
  ...
  public boolean equals(Object o) {
    ...
    AssignProfileToCampaignResponse assignProfileToCampaignResponse = (AssignProfileToCampaignResponse) o;
    return Objects.equals(this.messagingProfileId, assignProfileToCampaignResponse.messagingProfileId) &&
        Objects.equals(this.tcrCampaignId, assignProfileToCampaignResponse.tcrCampaignId) &&
        Objects.equals(this.campaignId, assignProfileToCampaignResponse.campaignId) &&
        Objects.equals(this.taskId, assignProfileToCampaignResponse.taskId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(messagingProfileId, tcrCampaignId, campaignId, taskId);
  }
