...
@JsonPropertyOrder(
    {
        AssignProfileToCampaignResponse.JSON_PROPERTY_MESSAGING_PROFILE_ID,
        AssignProfileToCampaignResponse.JSON_PROPERTY_TCR_CAMPAIGN_ID,
...
public class AssignProfileToCampaignResponse {
    ...
    public AssignProfileToCampaignResponse messagingProfileId(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The ID of the messaging profile that you want to link to the specified campaign."
    )
    ...
    public AssignProfileToCampaignResponse tcrCampaignId(String tcrCampaignId) {
    ...
    @ApiModelProperty(
        example = "CWZTFH1",
        value = "The TCR ID of the shared campaign you want to link to the specified messaging profile (for campaigns not created using Telnyx 10DLC services only). If you supply this ID in the request, do not also include a campaignId."
    )
    ...
    public AssignProfileToCampaignResponse campaignId(String campaignId) {
    ...
    @ApiModelProperty(
        ...
        value = "The ID of the campaign you want to link to the specified messaging profile. If you supply this ID in the request, do not also include a tcrCampaignId."
    )
    ...
    public AssignProfileToCampaignResponse taskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The ID of the task associated with assigning a messaging profile to a campaign."
    )
    ...
    /**
     * Return true if this AssignProfileToCampaignResponse object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                ...
                assignProfileToCampaignResponse.messagingProfileId
            ) &&
            Objects.equals(
                this.tcrCampaignId,
                assignProfileToCampaignResponse.tcrCampaignId
            ) &&
            Objects.equals(
                this.campaignId,
                assignProfileToCampaignResponse.campaignId
            ) &&
            Objects.equals(this.taskId, assignProfileToCampaignResponse.taskId)
        );
    }
    ...
    public String toString() {
        ...
        sb.append("class AssignProfileToCampaignResponse {\n");
        sb
