 ...
 */
@JsonPropertyOrder({ ConferenceStopRequest.JSON_PROPERTY_CALL_CONTROL_IDS })
...
public class ConferenceStopRequest {
    ...
    public ConferenceStopRequest addcallControlIdsItem(
    ...
    @ApiModelProperty(
        value = "List of call control ids identifying participants the audio file should stop be played to. If not given, the audio will be stoped to the entire conference."
    )
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(
            this.callControlIds,
            conferenceStopRequest.callControlIds
        );
    }
