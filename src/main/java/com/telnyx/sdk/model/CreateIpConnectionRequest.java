...
public class CreateIpConnectionRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Chicago, IL", value = "`Latency` directs Telnyx to route media through the site with the lowest round-trip time to the user's connection. Telnyx calculates this time using ICMP ping messages. This can be disabled by specifying a site to handle all media.")
