 ...
 */
@JsonPropertyOrder({
  InboundMessagePayloadToInner.JSON_PROPERTY_PHONE_NUMBER,
  InboundMessagePayloadToInner.JSON_PROPERTY_STATUS,
  InboundMessagePayloadToInner.JSON_PROPERTY_CARRIER,
  InboundMessagePayloadToInner.JSON_PROPERTY_LINE_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class InboundMessagePayloadToInner {
  ...
  public enum StatusEnum {
    ...
    WEBHOOK_DELIVERED(String.valueOf("webhook_delivered"));
  ...
  public InboundMessagePayloadToInner() { 
  }

  public InboundMessagePayloadToInner phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public InboundMessagePayloadToInner status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InboundMessagePayloadToInner carrier(String carrier) {
  ...
  **/
  ...
  public InboundMessagePayloadToInner lineType(LineTypeEnum lineType) {
  ...
  **/
  ...
  /**
   * Return true if this InboundMessagePayload_to_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InboundMessagePayloadToInner inboundMessagePayloadToInner = (InboundMessagePayloadToInner) o;
    return Objects.equals(this.phoneNumber, inboundMessagePayloadToInner.phoneNumber) &&
        Objects.equals(this.status, inboundMessagePayloadToInner.status) &&
        Objects.equals(this.carrier, inboundMessagePayloadToInner.carrier) &&
        Objects.equals(this.lineType, inboundMessagePayloadToInner.lineType);
  }
  ...
  public String toString() {
    ...
    sb.append("class InboundMessagePayloadToInner {\n");
