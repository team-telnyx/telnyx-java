...
public class CallEvent {
    ...
    public static final String JSON_PROPERTY_EVENT_TIMESTAMP =
        "event_timestamp";
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Uniquely identifies an individual call leg."
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Uniquely identifies the call control session. A session may include multiple call leg events."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "Event metadata, which includes raw event, and extra information based on event type"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, callEvent.recordType) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append(toIndentedString(eventTimestamp))
            .append("\n");
