...
public class NumberHealthMetrics {
    ...
    public static final String JSON_PROPERTY_INBOUND_OUTBOUND_RATIO =
    ...
    @ApiModelProperty(
        required = true,
        value = "The number of messages analyzed for the health metrics."
    )
    ...
    public NumberHealthMetrics inboundOutboundRatio(
    ...
    @ApiModelProperty(
        required = true,
        value = "The ratio of messages received to the number of messages sent."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "The ratio of messages sucessfully delivered to the number of messages attempted."
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "The ratio of messages blocked for spam to the number of messages attempted."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(
                this.messageCount,
                numberHealthMetrics.messageCount
            ) &&
            Objects.equals(
                this.inboundOutboundRatio,
                numberHealthMetrics.inboundOutboundRatio
            ) &&
            Objects.equals(
                this.successRatio,
                numberHealthMetrics.successRatio
            ) &&
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    inboundOutboundRatio: ")
            .append(toIndentedString(inboundOutboundRatio))
            .append("\n");
        sb
            .append("    successRatio: ")
            .append(toIndentedString(successRatio))
            .append("\n");
        sb
            .append("    spamRatio: ")
            .append(toIndentedString(spamRatio))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
