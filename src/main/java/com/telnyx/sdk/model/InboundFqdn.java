...
public class InboundFqdn {
    ...
    private JsonNullable<DefaultRoutingMethodEnum> defaultRoutingMethod =
        JsonNullable.<DefaultRoutingMethodEnum>of(
            DefaultRoutingMethodEnum.SEQUENTIAL
        );

    public static final String JSON_PROPERTY_DEFAULT_PRIMARY_FQDN_ID =
        "default_primary_fqdn_id";
    private JsonNullable<String> defaultPrimaryFqdnId = JsonNullable.<
            String
        >undefined();

    public static final String JSON_PROPERTY_DEFAULT_SECONDARY_FQDN_ID =
        "default_secondary_fqdn_id";
    private JsonNullable<String> defaultSecondaryFqdnId = JsonNullable.<
            String
        >undefined();

    public static final String JSON_PROPERTY_DEFAULT_TERTIARY_FQDN_ID =
        "default_tertiary_fqdn_id";
    private JsonNullable<String> defaultTertiaryFqdnId = JsonNullable.<
            String
        >undefined();

    public static final String JSON_PROPERTY_CHANNEL_LIMIT = "channel_limit";
    private JsonNullable<Integer> channelLimit = JsonNullable.<
            Integer
        >undefined();
    ...
    private JsonNullable<String> sipSubdomain = JsonNullable.<
            String
        >undefined();
    ...
    public InboundFqdn defaultRoutingMethod(
        DefaultRoutingMethodEnum defaultRoutingMethod
    ) {
        this.defaultRoutingMethod = JsonNullable.<DefaultRoutingMethodEnum>of(
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "Default routing method to be used when a number is associated with the connection. Must be one of the routing method types or null, other values are not allowed."
    )
    @JsonIgnore
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public JsonNullable<
        DefaultRoutingMethodEnum
    > getDefaultRoutingMethod_JsonNullable() {
        return defaultRoutingMethod;
    }

    @JsonProperty(JSON_PROPERTY_DEFAULT_ROUTING_METHOD)
    public void setDefaultRoutingMethod_JsonNullable(
        JsonNullable<DefaultRoutingMethodEnum> defaultRoutingMethod
    ) {
    ...
    public InboundFqdn defaultPrimaryFqdnId(String defaultPrimaryFqdnId) {
        this.defaultPrimaryFqdnId = JsonNullable.<String>of(
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The default primary FQDN to use for the number. Only settable if the connection is of FQDN type. Value must be the ID of an FQDN set on the connection."
    )
    @JsonIgnore
    ...
    @JsonProperty(JSON_PROPERTY_DEFAULT_PRIMARY_FQDN_ID)
    public void setDefaultPrimaryFqdnId_JsonNullable(
        JsonNullable<String> defaultPrimaryFqdnId
    ) {
    ...
    public InboundFqdn defaultSecondaryFqdnId(String defaultSecondaryFqdnId) {
        this.defaultSecondaryFqdnId = JsonNullable.<String>of(
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The default secondary FQDN to use for the number. Only settable if the connection is of FQDN type. Value must be the ID of an FQDN set on the connection."
    )
    @JsonIgnore
    ...
    @JsonProperty(JSON_PROPERTY_DEFAULT_SECONDARY_FQDN_ID)
    public void setDefaultSecondaryFqdnId_JsonNullable(
        JsonNullable<String> defaultSecondaryFqdnId
    ) {
    ...
    public InboundFqdn defaultTertiaryFqdnId(String defaultTertiaryFqdnId) {
        this.defaultTertiaryFqdnId = JsonNullable.<String>of(
    ...
    @jakarta.annotation.Nullable
    @ApiModelProperty(
        value = "The default tertiary FQDN to use for the number. Only settable if the connection is of FQDN type. Value must be the ID of an FQDN set on the connection."
    )
    @JsonIgnore
    ...
    @JsonProperty(JSON_PROPERTY_DEFAULT_TERTIARY_FQDN_ID)
    public void setDefaultTertiaryFqdnId_JsonNullable(
        JsonNullable<String> defaultTertiaryFqdnId
    ) {
    ...
    @JsonProperty(JSON_PROPERTY_CHANNEL_LIMIT)
    public void setChannelLimit_JsonNullable(
        JsonNullable<Integer> channelLimit
    ) {
    ...
    public InboundFqdn sipCompactHeadersEnabled(
    ...
    @JsonProperty(JSON_PROPERTY_SIP_SUBDOMAIN)
    public void setSipSubdomain_JsonNullable(
        JsonNullable<String> sipSubdomain
    ) {
    ...
    public InboundFqdn sipSubdomainReceiveSettings(
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.aniNumberFormat, inboundFqdn.aniNumberFormat) &&
            Objects.equals(
                this.dnisNumberFormat,
                inboundFqdn.dnisNumberFormat
            ) &&
            Objects.equals(this.codecs, inboundFqdn.codecs) &&
            equalsNullable(
                this.defaultRoutingMethod,
                inboundFqdn.defaultRoutingMethod
            ) &&
            equalsNullable(
                this.defaultPrimaryFqdnId,
                inboundFqdn.defaultPrimaryFqdnId
            ) &&
            equalsNullable(
                this.defaultSecondaryFqdnId,
                inboundFqdn.defaultSecondaryFqdnId
            ) &&
            equalsNullable(
                this.defaultTertiaryFqdnId,
                inboundFqdn.defaultTertiaryFqdnId
            ) &&
            equalsNullable(this.channelLimit, inboundFqdn.channelLimit) &&
            Objects.equals(
                this.generateRingbackTone,
                inboundFqdn.generateRingbackTone
            ) &&
            Objects.equals(
                this.isupHeadersEnabled,
                inboundFqdn.isupHeadersEnabled
            ) &&
            Objects.equals(this.prackEnabled, inboundFqdn.prackEnabled) &&
            Objects.equals(
                this.sipCompactHeadersEnabled,
                inboundFqdn.sipCompactHeadersEnabled
            ) &&
            ...
            Objects.equals(
                ...
                inboundFqdn.sipSubdomainReceiveSettings
            ) &&
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            dnisNumberFormat,
            codecs,
            hashCodeNullable(defaultRoutingMethod),
            hashCodeNullable(defaultPrimaryFqdnId),
            hashCodeNullable(defaultSecondaryFqdnId),
            hashCodeNullable(defaultTertiaryFqdnId),
            hashCodeNullable(channelLimit),
            generateRingbackTone,
            isupHeadersEnabled,
            prackEnabled,
            sipCompactHeadersEnabled,
            sipRegion,
            hashCodeNullable(sipSubdomain),
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    defaultPrimaryFqdnId: ")
            .append(toIndentedString(defaultPrimaryFqdnId))
            .append("\n");
        sb
            .append("    defaultSecondaryFqdnId: ")
            .append(toIndentedString(defaultSecondaryFqdnId))
            .append("\n");
        sb
            .append("    defaultTertiaryFqdnId: ")
            .append(toIndentedString(defaultTertiaryFqdnId))
            .append("\n");
        sb
            .append("    channelLimit: ")
