...
public class ActionsParticipantsRequest {
    ...
    public ActionsParticipantsRequest participants(
        ActionsParticipantsRequestParticipants participants
    ) {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "List of participant id to exclude from the action."
    )
    ...
    public boolean equals(Object o) {
        ...
        ActionsParticipantsRequest actionsParticipantsRequest =
            (ActionsParticipantsRequest) o;
        return (
            Objects.equals(
                this.participants,
                actionsParticipantsRequest.participants
            ) &&
    ...
    public String toString() {
        ...
        sb
            .append("    exclude: ")
            .append(toIndentedString(exclude))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
