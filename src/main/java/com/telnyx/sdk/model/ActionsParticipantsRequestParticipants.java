 ...
 */
 ...
 public class ActionsParticipantsRequestParticipants extends AbstractOpenApiSchema {
     ...
     public static class ActionsParticipantsRequestParticipantsSerializer
         ...
         @Override
         public void serialize(ActionsParticipantsRequestParticipants value,
                               JsonGenerator jgen,
     ...
     public static class ActionsParticipantsRequestParticipantsDeserializer
         ...
         @Override
         public ActionsParticipantsRequestParticipants deserialize(JsonParser jp,
             ...
             try {
                 deserialized = tree.traverse(jp.getCodec())
             ...
             try {
                 ...
                 if (typeCoercion || tree.isTextual()) {
                     String s = tree.traverse(jp.getCodec()).readValueAs(String.class);
                     deserialized = s;
                     match++;
             ...
             throw new IOException(String.format("Failed deserialization for ActionsParticipantsRequestParticipants: " +
                                                 "%d classes match result, expected 1", match));
         }
 
         @Override
         public ActionsParticipantsRequestParticipants getNullValue(DeserializationContext ctxt)
     ...
     public void setActualInstance(Object instance) {
         ...
         throw new RuntimeException("Invalid instance type. Must be List<UUID> or String");
     }
