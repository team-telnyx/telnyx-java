...
public class DialogflowConnection {
    ...
    public static final String JSON_PROPERTY_CONVERSATION_PROFILE_ID =
    ...
    @ApiModelProperty(
        example = "1234541231",
        value = "Uniquely identifies a Telnyx application (Call Control)."
    )
    ...
    public DialogflowConnection conversationProfileId(
    ...
    @ApiModelProperty(
        ...
        value = "The id of a configured conversation profile on your Dialogflow account. (If you use Dialogflow CX, this param is required)"
    )
    ...
    @ApiModelProperty(
        example = "development",
        value = "Which Dialogflow environment will be used."
    )
    ...
    @ApiModelProperty(
        example = "****",
        value = "The JSON map to connect your Dialoglow account."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, dialogflowConnection.recordType) &&
            Objects.equals(
                this.connectionId,
                dialogflowConnection.connectionId
            ) &&
            Objects.equals(
                this.conversationProfileId,
                dialogflowConnection.conversationProfileId
            ) &&
            Objects.equals(
                this.environment,
                dialogflowConnection.environment
            ) &&
            Objects.equals(
                this.serviceAccount,
                dialogflowConnection.serviceAccount
            )
        );
    }
    ...
    public String toString() {
        ...
        sb
            ...
            .append("\n");
        sb
            .append("    conversationProfileId: ")
            .append(toIndentedString(conversationProfileId))
            .append("\n");
        sb
            .append("    environment: ")
        ...
        sb
            ...
            .append(toIndentedString(serviceAccount))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
