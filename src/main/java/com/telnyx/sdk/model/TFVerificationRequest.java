...
public class TFVerificationRequest {
    ...
    @ApiModelProperty(
        example = "Telnyx LLC",
        required = true,
        value = "Name of the business; there are no specific formatting requirements"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "A URL, including the scheme, pointing to the corporate website"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Line 1 of the business address"
    )
    ...
    @ApiModelProperty(
        example = "14th Floor",
        value = "Line 2 of the business address"
    )
    ...
    @ApiModelProperty(
        example = "Austin",
        required = true,
        value = "The city of the business address; the first letter should be capitalized"
    )
    ...
    @ApiModelProperty(
        example = "Texas",
        required = true,
        value = "The full name of the state (not the 2 letter code) of the business address; the first letter should be capitalized"
    )
    ...
    @ApiModelProperty(
        example = "78701",
        required = true,
        value = "The ZIP code of the business address"
    )
    ...
    public TFVerificationRequest businessContactFirstName(
    ...
    @ApiModelProperty(
        example = "John",
        required = true,
        value = "First name of the business contact; there are no specific requirements on formatting"
    )
    ...
    public TFVerificationRequest businessContactLastName(
    ...
    @ApiModelProperty(
        example = "Doe",
        required = true,
        value = "Last name of the business contact; there are no specific requirements on formatting"
    )
    ...
    public TFVerificationRequest businessContactEmail(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The email address of the business contact"
    )
    ...
    public TFVerificationRequest businessContactPhone(
    ...
    @ApiModelProperty(
        example = "+18005550100",
        required = true,
        value = "The phone number of the business contact in E.164 format"
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "Estimated monthly volume of messages from the given phone numbers"
    )
    ...
    public TFVerificationRequest phoneNumbers(
    ...
    public TFVerificationRequest addphoneNumbersItem(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The phone numbers to request the verification of"
    )
    ...
    @ApiModelProperty(
        required = true,
        value = "Machine-readable use-case for the phone numbers"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Human-readable summary of the desired use-case"
    )
    ...
    public TFVerificationRequest productionMessageContent(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "An example of a message that will be sent from the given phone numbers"
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Human-readable description of how end users will opt into receiving messages from the given phone numbers"
    )
    ...
    public TFVerificationRequest optInWorkflowImageURLs(
    ...
    public TFVerificationRequest addoptInWorkflowImageURLsItem(
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Images showing the opt-in workflow"
    )
    ...
    public TFVerificationRequest additionalInformation(
    ...
    @ApiModelProperty(
        ...
        value = "URL that should receive webhooks relating to this verification request"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(
                ...
                tfVerificationRequest.corporateWebsite
            ) &&
            Objects.equals(
                this.businessAddr1,
                tfVerificationRequest.businessAddr1
            ) &&
            Objects.equals(
                this.businessAddr2,
                tfVerificationRequest.businessAddr2
            ) &&
            Objects.equals(
                this.businessCity,
                tfVerificationRequest.businessCity
            ) &&
            Objects.equals(
                this.businessState,
                tfVerificationRequest.businessState
            ) &&
            Objects.equals(
                this.businessZip,
                tfVerificationRequest.businessZip
            ) &&
            Objects.equals(
                this.businessContactFirstName,
                tfVerificationRequest.businessContactFirstName
            ) &&
            Objects.equals(
                this.businessContactLastName,
                tfVerificationRequest.businessContactLastName
            ) &&
            Objects.equals(
                this.businessContactEmail,
                tfVerificationRequest.businessContactEmail
            ) &&
            Objects.equals(
                this.businessContactPhone,
                tfVerificationRequest.businessContactPhone
            ) &&
            Objects.equals(
                this.messageVolume,
                tfVerificationRequest.messageVolume
            ) &&
            Objects.equals(
                this.phoneNumbers,
                tfVerificationRequest.phoneNumbers
            ) &&
            Objects.equals(this.useCase, tfVerificationRequest.useCase) &&
            Objects.equals(
                this.useCaseSummary,
                tfVerificationRequest.useCaseSummary
            ) &&
            Objects.equals(
                this.productionMessageContent,
                tfVerificationRequest.productionMessageContent
            ) &&
            Objects.equals(
                this.optInWorkflow,
                tfVerificationRequest.optInWorkflow
            ) &&
            Objects.equals(
                this.optInWorkflowImageURLs,
                tfVerificationRequest.optInWorkflowImageURLs
            ) &&
            Objects.equals(
                this.additionalInformation,
                tfVerificationRequest.additionalInformation
            ) &&
            Objects.equals(
                this.isvReseller,
                tfVerificationRequest.isvReseller
            ) &&
