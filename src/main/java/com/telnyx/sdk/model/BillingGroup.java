...
public class BillingGroup {
    ...
    private JsonNullable<OffsetDateTime> deletedAt = JsonNullable.<
            OffsetDateTime
        >undefined();
    ...
    @ApiModelProperty(
        ...
        value = "Identifies the organization that owns the resource."
    )
    ...
    @ApiModelProperty(
        ...
        value = "A user-specified name for the billing group"
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "ISO 8601 formatted date indicating when the resource was removed."
    )
    @JsonIgnore
    ...
    @JsonProperty(JSON_PROPERTY_DELETED_AT)
    public void setDeletedAt_JsonNullable(
        JsonNullable<OffsetDateTime> deletedAt
    ) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.recordType, billingGroup.recordType) &&
