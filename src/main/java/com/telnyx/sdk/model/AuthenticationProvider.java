...
public class AuthenticationProvider {
    ...
    @ApiModelProperty(
        ...
        value = "Uniquely identifies the authentication provider."
    )
    ...
    @ApiModelProperty(
        ...
        value = "The id from the Organization the authentication provider belongs to."
    )
    ...
    public AuthenticationProvider settings(
        AuthenticationProviderSettings settings
    ) {
    ...
    public AuthenticationProvider createdAt(OffsetDateTime createdAt) {
    ...
    public AuthenticationProvider updatedAt(OffsetDateTime updatedAt) {
