...
internal class CallConversationInsightsGeneratedTest {
    ...
    fun create() {
        val callConversationInsightsGenerated =
            CallConversationInsightsGenerated.builder()
                ...
                .eventType(
                    CallConversationInsightsGenerated.EventType.CALL_CONVERSATION_INSIGHTS_GENERATED
                )
        ...
        assertThat(callConversationInsightsGenerated.id())
            .contains("898e96ef-be63-45aa-9e7d-01332bff9a97")
        assertThat(callConversationInsightsGenerated.eventType())
            .contains(
                CallConversationInsightsGenerated.EventType.CALL_CONVERSATION_INSIGHTS_GENERATED
            )
        assertThat(callConversationInsightsGenerated.occurredAt())
            .contains(OffsetDateTime.parse("2025-02-19T17:02:49.371454Z"))
        assertThat(callConversationInsightsGenerated.payload())
            .contains(
                CallConversationInsightsGenerated.Payload.builder()
                    .callControlId("v3:MdI91X4lWFEs7IgbBEOT9M4AigoY08M0WWZFISt1Yw2axZ_IiE4pqg")
                    .callLegId("428c31b6-7af4-4bcb-b7f5-5013ef9657c1")
        ...
        assertThat(callConversationInsightsGenerated.recordType())
            .contains(CallConversationInsightsGenerated.RecordType.EVENT)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCallConversationInsightsGenerated =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(callConversationInsightsGenerated),
                jacksonTypeRef<CallConversationInsightsGenerated>(),
            )

        assertThat(roundtrippedCallConversationInsightsGenerated)
            .isEqualTo(callConversationInsightsGenerated)
    }
}
