...
internal class OpenAICreateResponseParamsTest {
    ...
    fun create() {
        OpenAICreateResponseParams.builder()
            ...
            .mode(OpenAICreateResponseParams.Mode.PREFERRED)
            ...
            .region(OpenAICreateResponseParams.Region.USA)
    ...
    fun body() {
        ...
        assertThat(body.mode()).contains(OpenAICreateResponseParams.Mode.PREFERRED)
        ...
        assertThat(body.region()).contains(OpenAICreateResponseParams.Region.USA)
