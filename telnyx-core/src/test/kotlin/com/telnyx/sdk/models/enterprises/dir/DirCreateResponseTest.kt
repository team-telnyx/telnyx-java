...
internal class DirCreateResponseTest {

    @Test
    fun create() {
        val dirCreateResponse =
            DirCreateResponse.builder()
                .data(
                    DirCreateResponse.Data.builder()
                        .id("16635d38-75a6-4481-82e8-69af60e05011")
                        .authorizerEmail("sam@acmeplumbing.example.com")
                        .authorizerName("Sam Owner")
                        .addCallReason(
                            DirCreateResponse.Data.CallReason.builder()
                        ...
                        .addDocument(
                            DirCreateResponse.Data.Document.builder()
                                .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                                .documentType(
                                    DirCreateResponse.Data.Document.DocumentType
                        ...
                        .addRejectionReason(
                            DirCreateResponse.Data.RejectionReason.builder()
                        ...
                        .reselling(false)
                        .status(DirCreateResponse.Data.Status.DRAFT)
        ...
        assertThat(dirCreateResponse.data())
            .isEqualTo(
                DirCreateResponse.Data.builder()
                    .id("16635d38-75a6-4481-82e8-69af60e05011")
                    .authorizerEmail("sam@acmeplumbing.example.com")
                    ...
                    .addDocument(
                        DirCreateResponse.Data.Document.builder()
                            .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                            .documentType(
                                DirCreateResponse.Data.Document.DocumentType.BUSINESS_REGISTRATION
                            )
                            .description("Certificate of incorporation.")
                            .build()
                    )
    ...
    fun roundtrip() {
        ...
        val roundtrippedDirCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dirCreateResponse),
                jacksonTypeRef<DirCreateResponse>(),
            )

        assertThat(roundtrippedDirCreateResponse).isEqualTo(dirCreateResponse)
    }
}
