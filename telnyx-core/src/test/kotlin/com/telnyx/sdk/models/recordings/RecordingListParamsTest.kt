        ...
        RecordingListParams.builder()
            .filter(
                RecordingListParams.Filter.builder()
                    ...
                    .endTime(
                        RecordingListParams.Filter.EndTime.builder()
                            .gte("2019-03-29T11:10:00Z")
                            .lte("2019-03-29T11:10:00Z")
                            .build()
                    )
                    ...
                    .startTime(
                        RecordingListParams.Filter.StartTime.builder()
                            .gte("2019-03-29T11:10:00Z")
                            .lte("2019-03-29T11:10:00Z")
                            .build()
                    )
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    ...
                    .put("filter[conference_region]", "us")
                    ...
                    .put("filter[end_time][gte]", "2019-03-29T11:10:00Z")
                    .put("filter[end_time][lte]", "2019-03-29T11:10:00Z")
                    .put("filter[from]", "1234567890")
                    .put("filter[sip_call_id]", "428c31b6-7af4-4bcb-b7f5-5013ef9657c1")
                    .put("filter[start_time][gte]", "2019-03-29T11:10:00Z")
                    .put("filter[start_time][lte]", "2019-03-29T11:10:00Z")
