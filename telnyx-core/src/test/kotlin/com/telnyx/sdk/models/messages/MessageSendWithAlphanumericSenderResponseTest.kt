...
internal class MessageSendWithAlphanumericSenderResponseTest {

    @Test
    fun create() {
        val messageSendWithAlphanumericSenderResponse =
            MessageSendWithAlphanumericSenderResponse.builder()
                .data(
        ...
        assertThat(messageSendWithAlphanumericSenderResponse.data())
            .contains(
                OutboundMessagePayload.builder()
                    .id("40385f64-5717-4562-b3fc-2c963f66afa6")
                    .addCc(
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessageSendWithAlphanumericSenderResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messageSendWithAlphanumericSenderResponse),
                jacksonTypeRef<MessageSendWithAlphanumericSenderResponse>(),
            )

        assertThat(roundtrippedMessageSendWithAlphanumericSenderResponse)
            .isEqualTo(messageSendWithAlphanumericSenderResponse)
    }
}
