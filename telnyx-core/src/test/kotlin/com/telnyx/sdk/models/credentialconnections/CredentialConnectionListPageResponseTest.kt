...
internal class CredentialConnectionListPageResponseTest {

    @Test
    fun create() {
        val credentialConnectionListPageResponse =
        ...
        assertThat(credentialConnectionListPageResponse.meta())
            .contains(
                ConnectionsPaginationMeta.builder()
                    .pageNumber(2L)
                    .totalPages(3L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCredentialConnectionListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(credentialConnectionListPageResponse),
                jacksonTypeRef<CredentialConnectionListPageResponse>(),
            )

        assertThat(roundtrippedCredentialConnectionListPageResponse)
            .isEqualTo(credentialConnectionListPageResponse)
    }
}
