...
internal class MessagingProfileDeleteResponseTest {

    @Test
    fun create() {
        val messagingProfileDeleteResponse =
            MessagingProfileDeleteResponse.builder()
                .data(
        ...
        assertThat(messagingProfileDeleteResponse.data())
            .contains(
                MessagingProfile.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .aiAssistantId("ai_assistant_id")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingProfileDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingProfileDeleteResponse),
                jacksonTypeRef<MessagingProfileDeleteResponse>(),
            )

        assertThat(roundtrippedMessagingProfileDeleteResponse)
            .isEqualTo(messagingProfileDeleteResponse)
    }
}
