...
internal class CallHangupTest {
    ...
    fun create() {
                    ...
                    CallHangup.Payload.builder()
                        ...
                        .addSipHeader(
                            InboundSipHeader.builder()
                                .name(InboundSipHeader.Name.USER_TO_USER)
                                .value("1234")
                                .build()
                        )
                        .addSipHeader(
        ...
        assertThat(callHangup.id()).contains("0ccc7b54-4df3-4bca-a65a-3da1ecc777f0")
        assertThat(callHangup.eventType()).contains(CallHangup.EventType.CALL_HANGUP)
        assertThat(callHangup.occurredAt())
            .contains(OffsetDateTime.parse("2018-02-02T22:25:27.521992Z"))
        assertThat(callHangup.payload())
            .contains(
                CallHangup.Payload.builder()
                    .callControlId("v3:MdI91X4lWFEs7IgbBEOT9M4AigoY08M0WWZFISt1Yw2axZ_IiE4pqg")
                    .callLegId("428c31b6-7af4-4bcb-b7f5-5013ef9657c1")
        ...
        assertThat(callHangup.recordType()).contains(CallHangup.RecordType.EVENT)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCallHangup =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(callHangup),
                jacksonTypeRef<CallHangup>(),
            )

        assertThat(roundtrippedCallHangup).isEqualTo(callHangup)
    }
}
