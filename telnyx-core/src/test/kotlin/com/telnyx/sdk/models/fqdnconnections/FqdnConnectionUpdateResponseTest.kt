...
internal class FqdnConnectionUpdateResponseTest {

    @Test
    fun create() {
        val fqdnConnectionUpdateResponse =
            FqdnConnectionUpdateResponse.builder()
                .data(
        ...
        assertThat(fqdnConnectionUpdateResponse.data())
            .contains(
                FqdnConnection.builder()
                    .connectionName("string")
                    .id("1293384261075731499")
    ...
    fun roundtrip() {
        ...
        val roundtrippedFqdnConnectionUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fqdnConnectionUpdateResponse),
                jacksonTypeRef<FqdnConnectionUpdateResponse>(),
            )

        assertThat(roundtrippedFqdnConnectionUpdateResponse).isEqualTo(fqdnConnectionUpdateResponse)
    }
}
