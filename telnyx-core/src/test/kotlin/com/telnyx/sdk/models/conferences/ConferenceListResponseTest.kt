...
internal class ConferenceListResponseTest {

    @Test
    fun create() {
        val conferenceListResponse =
            ConferenceListResponse.builder()
                .addData(
                    Conference.builder()
        ...
        assertThat(conferenceListResponse.data().getOrNull())
            .containsExactly(
                Conference.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .createdAt("2019-01-23T18:10:02.574Z")
        ...
        assertThat(conferenceListResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedConferenceListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(conferenceListResponse),
                jacksonTypeRef<ConferenceListResponse>(),
            )

        assertThat(roundtrippedConferenceListResponse).isEqualTo(conferenceListResponse)
    }
}
