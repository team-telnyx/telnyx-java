...
internal class ParticipantParticipantsParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.machineDetectionBeepMaxFrequency()).contains(2000)
        assertThat(body.machineDetectionBeepMinFrequency()).contains(550)
        assertThat(body.machineDetectionBeepMinToneDuration()).contains(300)
        assertThat(body.machineDetectionBeepProfile())
            .contains(ParticipantParticipantsParams.MachineDetectionBeepProfile.FREQ_ONLY)
        assertThat(body.machineDetectionBeepSpectralConfirmation()).contains(true)
        assertThat(body.machineDetectionBeepSpectralMinPurity()).contains(0.8)
        assertThat(body.machineDetectionBeepSpectralRejectFaxCng()).contains(true)
        assertThat(body.machineDetectionBeepSpectralWindow()).contains(100)
