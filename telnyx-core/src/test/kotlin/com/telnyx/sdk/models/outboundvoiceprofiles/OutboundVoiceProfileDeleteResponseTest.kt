...
internal class OutboundVoiceProfileDeleteResponseTest {

    @Test
    fun create() {
        val outboundVoiceProfileDeleteResponse =
            OutboundVoiceProfileDeleteResponse.builder()
                .data(
        ...
        assertThat(outboundVoiceProfileDeleteResponse.data())
            .contains(
                OutboundVoiceProfile.builder()
                    .name("office")
                    .id("1293384261075731499")
    ...
    fun roundtrip() {
        ...
        val roundtrippedOutboundVoiceProfileDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(outboundVoiceProfileDeleteResponse),
                jacksonTypeRef<OutboundVoiceProfileDeleteResponse>(),
            )

        assertThat(roundtrippedOutboundVoiceProfileDeleteResponse)
            .isEqualTo(outboundVoiceProfileDeleteResponse)
    }
}
