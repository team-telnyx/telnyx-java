...
internal class MessageSendGroupMmsResponseTest {

    @Test
    fun create() {
        val messageSendGroupMmsResponse =
            MessageSendGroupMmsResponse.builder()
                .data(
        ...
        assertThat(messageSendGroupMmsResponse.data())
            .contains(
                OutboundMessagePayload.builder()
                    .id("40385f64-5717-4562-b3fc-2c963f66afa6")
                    .addCc(
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessageSendGroupMmsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messageSendGroupMmsResponse),
                jacksonTypeRef<MessageSendGroupMmsResponse>(),
            )

        assertThat(roundtrippedMessageSendGroupMmsResponse).isEqualTo(messageSendGroupMmsResponse)
    }
}
