...
internal class CallCallsParamsTest {
    ...
    fun create() {
        CallCallsParams.builder()
            ...
            .deepfakeDetection(CallCallsParams.DeepfakeDetection.ENABLE)
            .deepfakeDetectionCallbackMethod(CallCallsParams.DeepfakeDetectionCallbackMethod.GET)
    ...
    fun body() {
        val params =
            CallCallsParams.builder()
                ...
                .deepfakeDetectionCallbackMethod(
                    CallCallsParams.DeepfakeDetectionCallbackMethod.GET
                )
                .deepfakeDetectionCallbackUrl("https://www.example.com/deepfake-callback")
                .detectionMode(CallCallsParams.DetectionMode.PREMIUM)
                .fallbackUrl("https://www.example.com/instructions-fallback.xml")
        ...
        assertThat(body.deepfakeDetection()).contains(CallCallsParams.DeepfakeDetection.ENABLE)
        assertThat(body.deepfakeDetectionCallbackMethod())
            .contains(CallCallsParams.DeepfakeDetectionCallbackMethod.GET)
        assertThat(body.deepfakeDetectionCallbackUrl())
            .contains("https://www.example.com/deepfake-callback")
        ...
        assertThat(body.mediaEncryption()).contains(CallCallsParams.MediaEncryption.DISABLED)
        ...
        assertThat(body.superviseCallSid())
            .contains("v3:MdI91X4lWFEs7IgbBEOT9M4AigoY08M0WWZFISt1Yw2axZ_IiE4pqg")
        assertThat(body.supervisingRole()).contains(CallCallsParams.SupervisingRole.MONITOR)
        assertThat(body.texml())
            .contains(
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Response><Say>Hello</Say></Response>"
            )
