...
internal class PhoneNumberGetParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = PhoneNumberGetParams.builder().pageNumber(0L).pageSize(0L).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = PhoneNumberGetParams.builder().build()
