...
internal class VoiceDesignDataTest {
    ...
    fun create() {
        ...
        assertThat(voiceDesignData.provider()).contains(VoiceDesignData.Provider.TELNYX)
        assertThat(voiceDesignData.providerSupportedModels().getOrNull()).containsExactly("string")
        assertThat(voiceDesignData.providerVoiceId()).contains("provider_voice_id")
