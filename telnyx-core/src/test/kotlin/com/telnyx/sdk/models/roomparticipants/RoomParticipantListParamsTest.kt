        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    ...
                    .put("filter[date_joined_at][eq]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_joined_at][gte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_joined_at][lte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_left_at][eq]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_left_at][gte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_left_at][lte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_updated_at][eq]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_updated_at][gte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_updated_at][lte]", LocalDate.parse("2021-04-25").toString())
