...
internal class ActionEnableVoiceResponseTest {

    @Test
    fun create() {
        val actionEnableVoiceResponse =
            ActionEnableVoiceResponse.builder()
                .data(
        ...
        assertThat(actionEnableVoiceResponse.data())
            .contains(
                WirelessSimCardAction.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .actionType(WirelessSimCardAction.ActionType.ENABLE)
    ...
    fun roundtrip() {
        ...
        val roundtrippedActionEnableVoiceResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(actionEnableVoiceResponse),
                jacksonTypeRef<ActionEnableVoiceResponse>(),
            )

        assertThat(roundtrippedActionEnableVoiceResponse).isEqualTo(actionEnableVoiceResponse)
    }
}
