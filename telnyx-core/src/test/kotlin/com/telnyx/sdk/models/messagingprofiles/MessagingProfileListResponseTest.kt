...
internal class MessagingProfileListResponseTest {

    @Test
    fun create() {
        val messagingProfileListResponse =
            MessagingProfileListResponse.builder()
                .addData(
        ...
        assertThat(messagingProfileListResponse.data().getOrNull())
            .containsExactly(
                MessagingProfile.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .alphaSender("sqF")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingProfileListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingProfileListResponse),
                jacksonTypeRef<MessagingProfileListResponse>(),
            )

        assertThat(roundtrippedMessagingProfileListResponse).isEqualTo(messagingProfileListResponse)
    }
}
