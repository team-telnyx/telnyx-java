...
internal class RemediationRequestWrappedTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedRemediationRequestWrapped =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(remediationRequestWrapped),
                jacksonTypeRef<RemediationRequestWrapped>(),
            )

        assertThat(roundtrippedRemediationRequestWrapped).isEqualTo(remediationRequestWrapped)
    }
}
