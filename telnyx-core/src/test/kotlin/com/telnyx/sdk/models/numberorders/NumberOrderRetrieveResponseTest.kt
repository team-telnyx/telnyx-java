...
internal class NumberOrderRetrieveResponseTest {

    @Test
    fun create() {
        val numberOrderRetrieveResponse =
            NumberOrderRetrieveResponse.builder()
                .data(
        ...
        assertThat(numberOrderRetrieveResponse.data())
            .contains(
                NumberOrderWithPhoneNumbers.builder()
                    .id("12ade33a-21c0-473b-b055-b3c836e1c292")
                    .billingGroupId("abc85f64-5717-4562-b3fc-2c9600")
    ...
    fun roundtrip() {
        ...
        val roundtrippedNumberOrderRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(numberOrderRetrieveResponse),
                jacksonTypeRef<NumberOrderRetrieveResponse>(),
            )

        assertThat(roundtrippedNumberOrderRetrieveResponse).isEqualTo(numberOrderRetrieveResponse)
    }
}
