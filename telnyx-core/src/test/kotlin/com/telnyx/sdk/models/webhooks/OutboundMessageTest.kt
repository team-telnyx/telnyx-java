...
internal class OutboundMessageTest {
    ...
    fun create() {
        ...
        assertThat(outboundMessage.id()).contains("86f58db9-0fe3-4adc-9d1f-46e66e6e9323")
        assertThat(outboundMessage.eventType()).contains(OutboundMessage.EventType.MESSAGE_SENT)
        assertThat(outboundMessage.occurredAt())
        ...
        assertThat(outboundMessage.recordType()).contains(OutboundMessage.RecordType.EVENT)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedOutboundMessage =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(outboundMessage),
                jacksonTypeRef<OutboundMessage>(),
            )

        assertThat(roundtrippedOutboundMessage).isEqualTo(outboundMessage)
    }
}
