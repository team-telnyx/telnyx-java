...
internal class FaxQueuedTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedFaxQueued =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(faxQueued),
                jacksonTypeRef<FaxQueued>(),
            )

        assertThat(roundtrippedFaxQueued).isEqualTo(faxQueued)
    }
}
