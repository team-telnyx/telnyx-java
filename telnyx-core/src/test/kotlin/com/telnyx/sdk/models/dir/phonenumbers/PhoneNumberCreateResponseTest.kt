...
internal class PhoneNumberCreateResponseTest {

    @Test
    fun create() {
        val phoneNumberCreateResponse =
            PhoneNumberCreateResponse.builder()
                .addData(
        ...
        assertThat(phoneNumberCreateResponse.data())
            .containsExactly(
                DirPhoneNumber.builder()
                    .id("1f56eb76-4078-4af7-ad4d-564b027256ee")
                    .batchId("0a4b1f5e-2f12-4c0c-9a98-9b3a7d8b8e62")
    ...
    fun roundtrip() {
        ...
        val roundtrippedPhoneNumberCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(phoneNumberCreateResponse),
                jacksonTypeRef<PhoneNumberCreateResponse>(),
            )

        assertThat(roundtrippedPhoneNumberCreateResponse).isEqualTo(phoneNumberCreateResponse)
    }
}
