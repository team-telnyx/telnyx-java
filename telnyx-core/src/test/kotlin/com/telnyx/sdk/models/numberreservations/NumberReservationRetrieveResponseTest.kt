...
internal class NumberReservationRetrieveResponseTest {

    @Test
    fun create() {
        val numberReservationRetrieveResponse =
            NumberReservationRetrieveResponse.builder()
                .data(
        ...
        assertThat(numberReservationRetrieveResponse.data())
            .contains(
                NumberReservation.builder()
                    .id("12ade33a-21c0-473b-b055-b3c836e1c292")
                    .createdAt(OffsetDateTime.parse("2018-01-01T00:00:00.000000Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedNumberReservationRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(numberReservationRetrieveResponse),
                jacksonTypeRef<NumberReservationRetrieveResponse>(),
            )

        assertThat(roundtrippedNumberReservationRetrieveResponse)
            .isEqualTo(numberReservationRetrieveResponse)
    }
}
