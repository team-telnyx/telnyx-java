...
internal class RoomCompositionRetrieveResponseTest {

    @Test
    fun create() {
        val roomCompositionRetrieveResponse =
            RoomCompositionRetrieveResponse.builder()
                .data(
        ...
        assertThat(roomCompositionRetrieveResponse.data())
            .contains(
                RoomComposition.builder()
                    .id("7103dc53-ee59-4b54-a58b-c77d99ceb037")
                    .completedAt(OffsetDateTime.parse("2022-02-25T05:39:56.377426Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoomCompositionRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(roomCompositionRetrieveResponse),
                jacksonTypeRef<RoomCompositionRetrieveResponse>(),
            )

        assertThat(roundtrippedRoomCompositionRetrieveResponse)
            .isEqualTo(roomCompositionRetrieveResponse)
    }
}
