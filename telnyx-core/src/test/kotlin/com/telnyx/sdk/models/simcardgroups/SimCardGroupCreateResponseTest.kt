...
internal class SimCardGroupCreateResponseTest {

    @Test
    fun create() {
        val simCardGroupCreateResponse =
            SimCardGroupCreateResponse.builder()
                .data(
        ...
        assertThat(simCardGroupCreateResponse.data())
            .contains(
                SimCardGroup.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .consumedData(ConsumedData.builder().amount("2048.1").unit("MB").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSimCardGroupCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(simCardGroupCreateResponse),
                jacksonTypeRef<SimCardGroupCreateResponse>(),
            )

        assertThat(roundtrippedSimCardGroupCreateResponse).isEqualTo(simCardGroupCreateResponse)
    }
}
