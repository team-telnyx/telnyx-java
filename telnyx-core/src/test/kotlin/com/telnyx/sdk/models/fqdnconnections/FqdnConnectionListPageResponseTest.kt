...
internal class FqdnConnectionListPageResponseTest {

    @Test
    fun create() {
        val fqdnConnectionListPageResponse =
            FqdnConnectionListPageResponse.builder()
                .addData(
        ...
        assertThat(fqdnConnectionListPageResponse.data().getOrNull())
            .containsExactly(
                FqdnConnection.builder()
                    .connectionName("string")
                    .id("id")
        ...
        assertThat(fqdnConnectionListPageResponse.meta())
            .contains(
                ConnectionsPaginationMeta.builder()
                    .pageNumber(2L)
                    .totalPages(3L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedFqdnConnectionListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fqdnConnectionListPageResponse),
                jacksonTypeRef<FqdnConnectionListPageResponse>(),
            )

        assertThat(roundtrippedFqdnConnectionListPageResponse)
            .isEqualTo(fqdnConnectionListPageResponse)
    }
}
