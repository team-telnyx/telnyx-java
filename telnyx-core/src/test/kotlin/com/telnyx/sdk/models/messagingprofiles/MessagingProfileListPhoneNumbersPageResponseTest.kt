...
internal class MessagingProfileListPhoneNumbersPageResponseTest {

    @Test
    fun create() {
        val messagingProfileListPhoneNumbersPageResponse =
            MessagingProfileListPhoneNumbersPageResponse.builder()
                .addData(
        ...
        assertThat(messagingProfileListPhoneNumbersPageResponse.data().getOrNull())
            .containsExactly(
                PhoneNumberWithMessagingSettings.builder()
                    .id("1293384261075731499")
                    .countryCode("US")
        ...
        assertThat(messagingProfileListPhoneNumbersPageResponse.meta())
            .contains(
                MessagingPaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingProfileListPhoneNumbersPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingProfileListPhoneNumbersPageResponse),
                jacksonTypeRef<MessagingProfileListPhoneNumbersPageResponse>(),
            )

        assertThat(roundtrippedMessagingProfileListPhoneNumbersPageResponse)
            .isEqualTo(messagingProfileListPhoneNumbersPageResponse)
    }
}
