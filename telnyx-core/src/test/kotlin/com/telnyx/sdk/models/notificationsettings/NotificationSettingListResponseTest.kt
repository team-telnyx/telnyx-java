...
internal class NotificationSettingListResponseTest {

    @Test
    fun create() {
        val notificationSettingListResponse =
            NotificationSettingListResponse.builder()
                .addData(
        ...
        assertThat(notificationSettingListResponse.data().getOrNull())
            .containsExactly(
                NotificationSetting.builder()
                    .id("8eb5b5f9-5893-423c-9f15-b487713d44d4")
                    .associatedRecordType("phone_number")
        ...
        assertThat(notificationSettingListResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedNotificationSettingListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(notificationSettingListResponse),
                jacksonTypeRef<NotificationSettingListResponse>(),
            )

        assertThat(roundtrippedNotificationSettingListResponse)
            .isEqualTo(notificationSettingListResponse)
    }
}
