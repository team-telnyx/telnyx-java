...
internal class InworldVoiceSettingsTest {
    ...
    fun create() {
        val inworldVoiceSettings =
            InworldVoiceSettings.builder()
                .type(InworldVoiceSettings.Type.INWORLD)
                .deliveryMode(InworldVoiceSettings.DeliveryMode.STABLE)
                .build()

        assertThat(inworldVoiceSettings.type()).isEqualTo(InworldVoiceSettings.Type.INWORLD)
        assertThat(inworldVoiceSettings.deliveryMode())
            .contains(InworldVoiceSettings.DeliveryMode.STABLE)
    }
