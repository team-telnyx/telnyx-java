...
internal class SimCardListPageResponseTest {

    @Test
    fun create() {
        val simCardListPageResponse =
            SimCardListPageResponse.builder()
                .addData(
        ...
        assertThat(simCardListPageResponse.data().getOrNull())
            .containsExactly(
                SimpleSimCard.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .actionsInProgress(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSimCardListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(simCardListPageResponse),
                jacksonTypeRef<SimCardListPageResponse>(),
            )

        assertThat(roundtrippedSimCardListPageResponse).isEqualTo(simCardListPageResponse)
    }
}
