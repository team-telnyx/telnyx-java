...
internal class ModelsResponseTest {

    @Test
    fun create() {
        val modelsResponse =
            ModelsResponse.builder()
                .addData(
        ...
        assertThat(modelsResponse.data())
            .containsExactly(
                ModelMetadata.builder()
                    .id("moonshotai/Kimi-K2.6")
                    .contextLength(262144L)
        ...
        assertThat(modelsResponse.modelObject()).contains("object")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedModelsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(modelsResponse),
                jacksonTypeRef<ModelsResponse>(),
            )

        assertThat(roundtrippedModelsResponse).isEqualTo(modelsResponse)
    }
}
