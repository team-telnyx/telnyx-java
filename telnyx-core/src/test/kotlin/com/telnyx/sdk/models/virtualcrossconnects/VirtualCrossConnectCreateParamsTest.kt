...
internal class VirtualCrossConnectCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.bgpAsn()).isEqualTo(1234.0)
        assertThat(body.cloudProvider())
            .isEqualTo(VirtualCrossConnectCreateParams.CloudProvider.AWS)
        assertThat(body.cloudProviderRegion()).isEqualTo("us-east-1")
        assertThat(body.primaryCloudAccountId()).isEqualTo("123456789012")
