...
internal class MessageScheduleResponseTest {

    @Test
    fun create() {
        val messageScheduleResponse =
            MessageScheduleResponse.builder()
                .data(
        ...
        assertThat(messageScheduleResponse.data())
            .contains(
                OutboundMessagePayload.builder()
                    .id("40385f64-5717-4562-b3fc-2c963f66afa6")
                    .completedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessageScheduleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messageScheduleResponse),
                jacksonTypeRef<MessageScheduleResponse>(),
            )

        assertThat(roundtrippedMessageScheduleResponse).isEqualTo(messageScheduleResponse)
    }
}
