...
internal class TelephonySettingsTest {
    ...
    fun create() {
        ...
        assertThat(telephonySettings.noiseSuppression())
            .contains(TelephonySettings.NoiseSuppression.AICOUSTICS)
        ...
        assertThat(telephonySettings.recordingSettings())
            .contains(
                TelephonySettings.RecordingSettings.builder()
                    .channels(TelephonySettings.RecordingSettings.Channels.SINGLE)
                    .enabled(true)
        ...
        assertThat(telephonySettings.sendMessageHistoryUpdates()).contains(true)
        ...
        assertThat(telephonySettings.userIdleReplySecs()).contains(0L)
