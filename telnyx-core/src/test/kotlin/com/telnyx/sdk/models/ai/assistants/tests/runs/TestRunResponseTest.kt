    ...
    fun create() {
        val testRunResponse =
            TestRunResponse.builder()
                .createdAt(OffsetDateTime.parse("2024-01-20T10:30:00Z"))
        ...
        assertThat(testRunResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2024-01-20T10:30:00Z"))
        ...
        assertThat(testRunResponse.triggeredBy()).isEqualTo("cron")
