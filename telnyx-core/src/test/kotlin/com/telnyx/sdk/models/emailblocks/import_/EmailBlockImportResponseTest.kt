    ...
    fun create() {
        val emailBlockImportResponse =
            EmailBlockImportResponse.builder()
                .data(
                    EmailBlockImportResponse.Data.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .recordType(EmailBlockImportResponse.Data.RecordType.EMAIL_BLOCK_IMPORT)
                        .status(EmailBlockImportResponse.Data.Status.PENDING)
                        .total(0L)
                        ...
                        .errorCount(0L)
                        .errors(
                            EmailBlockImportResponse.Data.Errors.builder()
                        ...
                        .processedRows(0L)
                        .provider(EmailBlockImportResponse.Data.Provider.SENDGRID)
                        .skippedCount(0L)
                        .build()
                )
                .build()
