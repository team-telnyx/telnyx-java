...
internal class ReputationPhoneNumberListWithReputationTest {

    @Test
    fun create() {
        val reputationPhoneNumberListWithReputation =
            ReputationPhoneNumberListWithReputation.builder()
                .addData(
        ...
        assertThat(reputationPhoneNumberListWithReputation.data())
            .containsExactly(
                ReputationPhoneNumber.builder()
                    .id("8a4b1f5e-2f12-4c0c-9a98-9b3a7d8b8e62")
                    .createdAt(OffsetDateTime.parse("2026-04-26T18:06:51.940749Z"))
        ...
        assertThat(reputationPhoneNumberListWithReputation.meta())
            .isEqualTo(
                NumberReputationPaginationMeta.builder()
                    .pageNumber(1L)
                    .pageSize(20L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedReputationPhoneNumberListWithReputation =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(reputationPhoneNumberListWithReputation),
                jacksonTypeRef<ReputationPhoneNumberListWithReputation>(),
            )

        assertThat(roundtrippedReputationPhoneNumberListWithReputation)
            .isEqualTo(reputationPhoneNumberListWithReputation)
    }
}
