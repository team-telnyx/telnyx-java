...
internal class TexmlApplicationUpdateResponseTest {

    @Test
    fun create() {
        val texmlApplicationUpdateResponse =
            TexmlApplicationUpdateResponse.builder()
                .data(
        ...
        assertThat(texmlApplicationUpdateResponse.data())
            .contains(
                TexmlApplication.builder()
                    .id("1293384261075731499")
                    .active(false)
    ...
    fun roundtrip() {
        ...
        val roundtrippedTexmlApplicationUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(texmlApplicationUpdateResponse),
                jacksonTypeRef<TexmlApplicationUpdateResponse>(),
            )

        assertThat(roundtrippedTexmlApplicationUpdateResponse)
            .isEqualTo(texmlApplicationUpdateResponse)
    }
}
