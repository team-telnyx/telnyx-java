...
internal class DirWrappedTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedDirWrapped =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dirWrapped),
                jacksonTypeRef<DirWrapped>(),
            )

        assertThat(roundtrippedDirWrapped).isEqualTo(dirWrapped)
    }
}
