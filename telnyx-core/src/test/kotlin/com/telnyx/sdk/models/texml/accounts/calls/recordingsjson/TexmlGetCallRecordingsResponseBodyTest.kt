...
internal class TexmlGetCallRecordingsResponseBodyTest {

    @Test
    fun create() {
        val texmlGetCallRecordingsResponseBody =
            TexmlGetCallRecordingsResponseBody.builder()
                .end(19L)
        ...
        assertThat(texmlGetCallRecordingsResponseBody.end()).contains(19L)
        assertThat(texmlGetCallRecordingsResponseBody.firstPageUri())
            .contains("https://example.com")
        assertThat(texmlGetCallRecordingsResponseBody.nextPageUri())
            .contains(
                "/v2/texml/Accounts/61bf923e-5e4d-4595-a110-56190ea18a1b/Calls.json?Page=1&PageSize=1"
            )
        assertThat(texmlGetCallRecordingsResponseBody.page()).contains(0L)
        assertThat(texmlGetCallRecordingsResponseBody.pageSize()).contains(20L)
        assertThat(texmlGetCallRecordingsResponseBody.previousPageUri())
            .contains("https://example.com")
        assertThat(texmlGetCallRecordingsResponseBody.recordings().getOrNull())
            .containsExactly(
                TexmlGetCallRecordingResponseBody.builder()
                    .accountSid("61bf923e-5e4d-4595-a110-56190ea18a1b")
                    .callSid("v3:KBnLO0ZK3DhKM5s7bE9VluaSmKsOchKht_fUYvxcp8ysbmzCCtpkmA")
        ...
        assertThat(texmlGetCallRecordingsResponseBody.start()).contains(0L)
        assertThat(texmlGetCallRecordingsResponseBody.uri())
            .contains(
                "/v2/texml/Accounts/61bf923e-5e4d-4595-a110-56190ea18a1b/Recordings.json?Page=0&PageSize=1"
            )
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedTexmlGetCallRecordingsResponseBody =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(texmlGetCallRecordingsResponseBody),
                jacksonTypeRef<TexmlGetCallRecordingsResponseBody>(),
            )

        assertThat(roundtrippedTexmlGetCallRecordingsResponseBody)
            .isEqualTo(texmlGetCallRecordingsResponseBody)
    }
}
