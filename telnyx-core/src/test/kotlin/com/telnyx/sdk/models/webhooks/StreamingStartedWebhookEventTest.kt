...
internal class StreamingStartedWebhookEventTest {

    @Test
    fun create() {
        val streamingStartedWebhookEvent =
        ...
        assertThat(streamingStartedWebhookEvent.data())
            .contains(
                CallStreamingStarted.builder()
                    .id("7d743d69-f7e8-4761-b7d4-8cacf9d3c031")
                    .eventType(CallStreamingStarted.EventType.STREAMING_STARTED)
    ...
    fun roundtrip() {
        ...
        val roundtrippedStreamingStartedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(streamingStartedWebhookEvent),
                jacksonTypeRef<StreamingStartedWebhookEvent>(),
            )

        assertThat(roundtrippedStreamingStartedWebhookEvent).isEqualTo(streamingStartedWebhookEvent)
    }
}
