...
internal class IpConnectionUpdateResponseTest {

    @Test
    fun create() {
        val ipConnectionUpdateResponse =
            IpConnectionUpdateResponse.builder()
                .data(
        ...
        assertThat(ipConnectionUpdateResponse.data())
            .contains(
                IpConnection.builder()
                    .id("id")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedIpConnectionUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(ipConnectionUpdateResponse),
                jacksonTypeRef<IpConnectionUpdateResponse>(),
            )

        assertThat(roundtrippedIpConnectionUpdateResponse).isEqualTo(ipConnectionUpdateResponse)
    }
}
