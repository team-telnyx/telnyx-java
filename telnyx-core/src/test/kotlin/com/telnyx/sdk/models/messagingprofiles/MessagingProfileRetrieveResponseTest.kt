...
internal class MessagingProfileRetrieveResponseTest {

    @Test
    fun create() {
        val messagingProfileRetrieveResponse =
            MessagingProfileRetrieveResponse.builder()
                .data(
        ...
        assertThat(messagingProfileRetrieveResponse.data())
            .contains(
                MessagingProfile.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .alphaSender("sqF")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingProfileRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingProfileRetrieveResponse),
                jacksonTypeRef<MessagingProfileRetrieveResponse>(),
            )

        assertThat(roundtrippedMessagingProfileRetrieveResponse)
            .isEqualTo(messagingProfileRetrieveResponse)
    }
}
