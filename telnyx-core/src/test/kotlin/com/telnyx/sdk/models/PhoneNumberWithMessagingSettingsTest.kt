...
internal class PhoneNumberWithMessagingSettingsTest {
    ...
    fun create() {
        ...
        assertThat(phoneNumberWithMessagingSettings.organizationId()).contains("organization_id")
        ...
        assertThat(phoneNumberWithMessagingSettings.tags().getOrNull()).containsExactly("string")
