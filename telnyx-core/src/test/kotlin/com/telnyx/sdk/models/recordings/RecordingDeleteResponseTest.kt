...
internal class RecordingDeleteResponseTest {

    @Test
    fun create() {
        val recordingDeleteResponse =
            RecordingDeleteResponse.builder()
                .data(
                    RecordingResponseData.builder()
                        ...
                        .from("+15551234567")
                        .initiatedBy("StartCallRecordingAPI")
        ...
        assertThat(recordingDeleteResponse.data())
            .contains(
                RecordingResponseData.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .callControlId("v3:e-31OnvjEM7Y4wvxr3TKNk8M3QyLcGZPiUIzCGtwQtOtEjY-B0urkw")
    ...
    fun roundtrip() {
        ...
        val roundtrippedRecordingDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(recordingDeleteResponse),
                jacksonTypeRef<RecordingDeleteResponse>(),
            )

        assertThat(roundtrippedRecordingDeleteResponse).isEqualTo(recordingDeleteResponse)
    }
}
