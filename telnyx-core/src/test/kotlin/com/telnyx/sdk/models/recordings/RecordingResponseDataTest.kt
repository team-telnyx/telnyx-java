...
internal class RecordingResponseDataTest {
    ...
    fun create() {
        ...
        assertThat(recordingResponseData.conferenceId())
            .contains("84a97d76-e40f-11ed-9074-02420a0daa69")
        assertThat(recordingResponseData.connectionId()).contains("175237942907135762")
        ...
        assertThat(recordingResponseData.from()).contains("+15551234567")
        assertThat(recordingResponseData.initiatedBy()).contains("StartCallRecordingAPI")
        ...
        assertThat(recordingResponseData.to()).contains("+15557654321")
