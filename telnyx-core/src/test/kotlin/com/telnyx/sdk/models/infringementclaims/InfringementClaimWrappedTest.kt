...
internal class InfringementClaimWrappedTest {

    @Test
    fun create() {
        val infringementClaimWrapped =
            InfringementClaimWrapped.builder()
                .data(
        ...
        assertThat(infringementClaimWrapped.data())
            .isEqualTo(
                InfringementClaim.builder()
                    .id("e379fbc8-cd83-4bef-a280-a0ac9d00dcf8")
                    .claimDate(OffsetDateTime.parse("2026-04-22T02:12:54Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedInfringementClaimWrapped =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(infringementClaimWrapped),
                jacksonTypeRef<InfringementClaimWrapped>(),
            )

        assertThat(roundtrippedInfringementClaimWrapped).isEqualTo(infringementClaimWrapped)
    }
}
