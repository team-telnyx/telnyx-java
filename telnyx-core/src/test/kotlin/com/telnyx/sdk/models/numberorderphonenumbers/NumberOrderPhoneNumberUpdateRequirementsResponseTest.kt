...
internal class NumberOrderPhoneNumberUpdateRequirementsResponseTest {

    @Test
    fun create() {
        val numberOrderPhoneNumberUpdateRequirementsResponse =
            NumberOrderPhoneNumberUpdateRequirementsResponse.builder()
                .data(
        ...
        assertThat(numberOrderPhoneNumberUpdateRequirementsResponse.data())
            .contains(
                NumberOrderPhoneNumber.builder()
                    .id("dc8e4d67-33a0-4cbb-af74-7b58f05bd494")
                    .bundleId(null)
    ...
    fun roundtrip() {
        ...
        val roundtrippedNumberOrderPhoneNumberUpdateRequirementsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(numberOrderPhoneNumberUpdateRequirementsResponse),
                jacksonTypeRef<NumberOrderPhoneNumberUpdateRequirementsResponse>(),
            )

        assertThat(roundtrippedNumberOrderPhoneNumberUpdateRequirementsResponse)
            .isEqualTo(numberOrderPhoneNumberUpdateRequirementsResponse)
    }
}
