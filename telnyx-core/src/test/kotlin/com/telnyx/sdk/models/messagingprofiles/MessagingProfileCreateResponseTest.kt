...
internal class MessagingProfileCreateResponseTest {

    @Test
    fun create() {
        val messagingProfileCreateResponse =
            MessagingProfileCreateResponse.builder()
                .data(
        ...
        assertThat(messagingProfileCreateResponse.data())
            .contains(
                MessagingProfile.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .aiAssistantId("ai_assistant_id")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingProfileCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingProfileCreateResponse),
                jacksonTypeRef<MessagingProfileCreateResponse>(),
            )

        assertThat(roundtrippedMessagingProfileCreateResponse)
            .isEqualTo(messagingProfileCreateResponse)
    }
}
