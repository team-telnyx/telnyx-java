...
internal class CredentialConnectionDeleteResponseTest {

    @Test
    fun create() {
        val credentialConnectionDeleteResponse =
            CredentialConnectionDeleteResponse.builder()
                .data(
        ...
        assertThat(credentialConnectionDeleteResponse.data())
            .contains(
                CredentialConnection.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCredentialConnectionDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(credentialConnectionDeleteResponse),
                jacksonTypeRef<CredentialConnectionDeleteResponse>(),
            )

        assertThat(roundtrippedCredentialConnectionDeleteResponse)
            .isEqualTo(credentialConnectionDeleteResponse)
    }
}
