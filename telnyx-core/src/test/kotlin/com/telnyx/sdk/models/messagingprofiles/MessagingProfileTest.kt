...
internal class MessagingProfileTest {
    ...
    fun create() {
        ...
        assertThat(messagingProfile.healthWebhookUrl()).isEmpty
        ...
        assertThat(messagingProfile.organizationId()).contains("organization_id")
        ...
        assertThat(messagingProfile.resourceGroupId()).contains("resource_group_id")
        ...
        assertThat(messagingProfile.webhookApiVersion())
            .contains(MessagingProfile.WebhookApiVersion.V2)
