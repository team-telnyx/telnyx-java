...
internal class VerificationCodeListPageResponseTest {
    ...
    fun create() {
        ...
        assertThat(verificationCodeListPageResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(1L)
                    .pageSize(2L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedVerificationCodeListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(verificationCodeListPageResponse),
                jacksonTypeRef<VerificationCodeListPageResponse>(),
            )

        assertThat(roundtrippedVerificationCodeListPageResponse)
            .isEqualTo(verificationCodeListPageResponse)
    }
}
