...
internal class RoomRecordingListParamsTest {
    ...
    fun queryParams() {
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    .put("filter[date_ended_at][eq]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_ended_at][gte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_ended_at][lte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_started_at][eq]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_started_at][gte]", LocalDate.parse("2021-04-25").toString())
                    .put("filter[date_started_at][lte]", LocalDate.parse("2021-04-25").toString())
