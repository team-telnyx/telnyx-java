...
internal class LabelDeleteAllParamsTest {
    ...
    fun create() {
        LabelDeleteAllParams.builder()
            ...
            .labelMutationRequest(LabelMutationRequest.builder().addLabel("needs_review").build())
            .build()
    }
    ...
    fun body() {
        ...
        assertThat(body).isEqualTo(LabelMutationRequest.builder().addLabel("needs_review").build())
    }
}
