...
internal class NotificationSettingListParamsTest {
                ...
                NotificationSettingListParams.Filter.builder()
                    ...
                    .channelTypeId(
                        NotificationSettingListParams.Filter.ChannelTypeId.builder()
                            .eq(NotificationSettingListParams.Filter.ChannelTypeId.Eq.WEBHOOK)
                            .build()
                    )
                    .notificationChannel(
                    ...
                    .notificationEventConditionId(
                        NotificationSettingListParams.Filter.NotificationEventConditionId.builder()
                            .eq("12455643-3cf1-4683-ad23-1cd32f7d5e0a")
                            .build()
                    )
                    ...
                    .status(
                        NotificationSettingListParams.Filter.Status.builder()
                            .eq(NotificationSettingListParams.Filter.Status.Eq.ENABLE_RECEIVED)
                            .build()
                    )
                    .build()
            )
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = NotificationSettingListParams.builder().build()
