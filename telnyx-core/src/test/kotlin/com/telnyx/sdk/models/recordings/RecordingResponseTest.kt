...
internal class RecordingResponseTest {

    @Test
    fun create() {
        val recordingResponse =
        ...
        assertThat(recordingResponse.data())
            .contains(
                RecordingResponseData.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .callControlId("v3:e-31OnvjEM7Y4wvxr3TKNk8M3QyLcGZPiUIzCGtwQtOtEjY-B0urkw")
    ...
    fun roundtrip() {
        ...
        val roundtrippedRecordingResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(recordingResponse),
                jacksonTypeRef<RecordingResponse>(),
            )

        assertThat(roundtrippedRecordingResponse).isEqualTo(recordingResponse)
    }
}
