...
internal class AuditEventListParamsTest {
        ...
        AuditEventListParams.builder()
            .filter(
                AuditEventListParams.Filter.builder()
                    .createdAfter(OffsetDateTime.parse("2021-01-06T00:00:00Z"))
                    .createdBefore(OffsetDateTime.parse("2021-01-06T00:00:00Z"))
                    .build()
            )
            .pageNumber(0L)
            .pageSize(0L)
    ...
    fun queryParams() {
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    .put("filter[created_after]", "2021-01-06T00:00:00Z")
                    .put("filter[created_before]", "2021-01-06T00:00:00Z")
                    .put("page[number]", "0")
                    .put("page[size]", "0")
                    .put("sort", "desc")
                    .build()
