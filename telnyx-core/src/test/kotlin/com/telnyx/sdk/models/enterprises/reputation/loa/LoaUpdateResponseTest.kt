...
internal class LoaUpdateResponseTest {

    @Test
    fun create() {
        val loaUpdateResponse =
            LoaUpdateResponse.builder()
                .data(
        ...
        assertThat(loaUpdateResponse.data())
            .isEqualTo(
                EnterpriseReputationPublic.builder()
                    .checkFrequency(EnterpriseReputationPublic.CheckFrequency.BUSINESS_DAILY)
                    .createdAt(OffsetDateTime.parse("2026-04-26T18:06:51.940749Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedLoaUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(loaUpdateResponse),
                jacksonTypeRef<LoaUpdateResponse>(),
            )

        assertThat(roundtrippedLoaUpdateResponse).isEqualTo(loaUpdateResponse)
    }
}
