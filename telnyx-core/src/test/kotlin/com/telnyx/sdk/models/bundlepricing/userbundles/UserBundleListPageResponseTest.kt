...
internal class UserBundleListPageResponseTest {

    @Test
    fun create() {
        val userBundleListPageResponse =
            UserBundleListPageResponse.builder()
                .addData(
                    UserBundle.builder()
        ...
        assertThat(userBundleListPageResponse.data())
            .containsExactly(
                UserBundle.builder()
                    .id("ca1d2263-d1f1-43ac-ba53-248e7a4bb26a")
                    .active(true)
        ...
        assertThat(userBundleListPageResponse.meta())
            .isEqualTo(
                PaginationResponse.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserBundleListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userBundleListPageResponse),
                jacksonTypeRef<UserBundleListPageResponse>(),
            )

        assertThat(roundtrippedUserBundleListPageResponse).isEqualTo(userBundleListPageResponse)
    }
}
