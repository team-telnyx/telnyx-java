    ...
    fun create() {
        val reputationEnableResponse =
            ReputationEnableResponse.builder()
                .data(
                    ReputationEnableResponse.Data.builder()
                        .checkFrequency(ReputationEnableResponse.Data.CheckFrequency.BUSINESS_DAILY)
                        .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .enterpriseId("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                        .loaDocumentId("loa_document_id")
                        .addRejectionReason("string")
                        .status(ReputationEnableResponse.Data.Status.PENDING)
