...
internal class MdrUsageReportCreateResponseTest {

    @Test
    fun create() {
        val mdrUsageReportCreateResponse =
            MdrUsageReportCreateResponse.builder()
                .data(
        ...
        assertThat(mdrUsageReportCreateResponse.data())
            .contains(
                MdrUsageReport.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .aggregationType(MdrUsageReport.AggregationType.NO_AGGREGATION)
    ...
    fun roundtrip() {
        ...
        val roundtrippedMdrUsageReportCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(mdrUsageReportCreateResponse),
                jacksonTypeRef<MdrUsageReportCreateResponse>(),
            )

        assertThat(roundtrippedMdrUsageReportCreateResponse).isEqualTo(mdrUsageReportCreateResponse)
    }
}
