...
internal class CallDeepfakeDetectionResultWebhookEventTest {

    @Test
    fun create() {
        val callDeepfakeDetectionResultWebhookEvent =
        ...
        assertThat(callDeepfakeDetectionResultWebhookEvent.data())
            .contains(
                CallDeepfakeDetectionResultWebhookEvent.Data.builder()
                    .id("0ccc7b54-4df3-4bca-a65a-3da1ecc777f0")
                    .eventType(
    ...
    fun roundtrip() {
        ...
        val roundtrippedCallDeepfakeDetectionResultWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(callDeepfakeDetectionResultWebhookEvent),
                jacksonTypeRef<CallDeepfakeDetectionResultWebhookEvent>(),
            )

        assertThat(roundtrippedCallDeepfakeDetectionResultWebhookEvent)
            .isEqualTo(callDeepfakeDetectionResultWebhookEvent)
    }
}
