...
internal class MeetingSessionResponseTest {

    @Test
    fun create() {
        val meetingSessionResponse =
            MeetingSessionResponse.builder()
                .data(
        ...
        assertThat(meetingSessionResponse.data())
            .isEqualTo(
                MeetingSession.builder()
                    .id("id")
                    .accountId("account_id")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMeetingSessionResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(meetingSessionResponse),
                jacksonTypeRef<MeetingSessionResponse>(),
            )

        assertThat(roundtrippedMeetingSessionResponse).isEqualTo(meetingSessionResponse)
    }
}
