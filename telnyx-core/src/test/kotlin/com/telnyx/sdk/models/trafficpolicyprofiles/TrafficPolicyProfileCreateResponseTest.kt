...
internal class TrafficPolicyProfileCreateResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedTrafficPolicyProfileCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(trafficPolicyProfileCreateResponse),
                jacksonTypeRef<TrafficPolicyProfileCreateResponse>(),
            )

        assertThat(roundtrippedTrafficPolicyProfileCreateResponse)
            .isEqualTo(trafficPolicyProfileCreateResponse)
    }
}
