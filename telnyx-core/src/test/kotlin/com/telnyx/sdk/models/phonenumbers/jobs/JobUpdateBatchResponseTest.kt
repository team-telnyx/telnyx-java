...
internal class JobUpdateBatchResponseTest {

    @Test
    fun create() {
        val jobUpdateBatchResponse =
            JobUpdateBatchResponse.builder()
                .data(
        ...
        assertThat(jobUpdateBatchResponse.data())
            .contains(
                PhoneNumbersJob.builder()
                    .id("42587e44-3a3e-46de-9255-0c9a7a1d1ec7")
                    .createdAt("2020-10-23T18:10:00.000Z")
    ...
    fun roundtrip() {
        ...
        val roundtrippedJobUpdateBatchResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(jobUpdateBatchResponse),
                jacksonTypeRef<JobUpdateBatchResponse>(),
            )

        assertThat(roundtrippedJobUpdateBatchResponse).isEqualTo(jobUpdateBatchResponse)
    }
}
