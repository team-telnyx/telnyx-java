...
internal class InboundMessageTest {
    ...
    fun create() {
        ...
        assertThat(inboundMessage.id()).contains("bf6307bd-884d-4c1f-b6ea-c62b8c495d3c")
        assertThat(inboundMessage.eventType()).contains(InboundMessage.EventType.MESSAGE_RECEIVED)
        assertThat(inboundMessage.occurredAt())
            .contains(OffsetDateTime.parse("2019-01-23T18:10:02.574Z"))
        assertThat(inboundMessage.payload())
            .contains(
                InboundMessagePayload.builder()
                    .id("7ee4241c-f127-47e5-9c34-3aac291f8058")
                    .addCc(
        ...
        assertThat(inboundMessage.recordType()).contains(InboundMessage.RecordType.EVENT)
    }
