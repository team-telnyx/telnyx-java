...
internal class RoomUpdateResponseTest {

    @Test
    fun create() {
        val roomUpdateResponse =
            RoomUpdateResponse.builder()
                .data(
                    Room.builder()
        ...
        assertThat(roomUpdateResponse.data())
            .contains(
                Room.builder()
                    .id("7b61621f-62e0-4aad-ab11-9fd19e272e73")
                    .activeSessionId("7b61621f-62e0-4aad-ab11-9fd19e272e74")
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoomUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(roomUpdateResponse),
                jacksonTypeRef<RoomUpdateResponse>(),
            )

        assertThat(roundtrippedRoomUpdateResponse).isEqualTo(roomUpdateResponse)
    }
}
