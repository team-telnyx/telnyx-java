...
internal class EnterprisePublicWrappedTest {

    @Test
    fun create() {
        val enterprisePublicWrapped =
            EnterprisePublicWrapped.builder()
                .data(
        ...
        assertThat(enterprisePublicWrapped.data())
            .contains(
                EnterprisePublic.builder()
                    .id("4a6192a4-573d-446d-b3ce-aff9117272a6")
                    .billingAddress(
    ...
    fun roundtrip() {
        ...
        val roundtrippedEnterprisePublicWrapped =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(enterprisePublicWrapped),
                jacksonTypeRef<EnterprisePublicWrapped>(),
            )

        assertThat(roundtrippedEnterprisePublicWrapped).isEqualTo(enterprisePublicWrapped)
    }
}
