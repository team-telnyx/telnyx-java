...
internal class PronunciationDictResponseTest {

    @Test
    fun create() {
        val pronunciationDictResponse =
            PronunciationDictResponse.builder()
                .data(
        ...
        assertThat(pronunciationDictResponse.data())
            .contains(
                PronunciationDictData.builder()
                    .id("c215a3e1-be41-4701-97e8-1d3c22f9a5b7")
                    .createdAt(OffsetDateTime.parse("2026-03-25T12:00:00.000Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedPronunciationDictResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(pronunciationDictResponse),
                jacksonTypeRef<PronunciationDictResponse>(),
            )

        assertThat(roundtrippedPronunciationDictResponse).isEqualTo(pronunciationDictResponse)
    }
}
