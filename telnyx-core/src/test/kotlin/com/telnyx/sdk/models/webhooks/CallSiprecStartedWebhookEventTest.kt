...
internal class CallSiprecStartedWebhookEventTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedCallSiprecStartedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(callSiprecStartedWebhookEvent),
                jacksonTypeRef<CallSiprecStartedWebhookEvent>(),
            )

        assertThat(roundtrippedCallSiprecStartedWebhookEvent)
            .isEqualTo(callSiprecStartedWebhookEvent)
    }
}
