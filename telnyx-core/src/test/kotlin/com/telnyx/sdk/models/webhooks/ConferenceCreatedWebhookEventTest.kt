...
internal class ConferenceCreatedWebhookEventTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedConferenceCreatedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(conferenceCreatedWebhookEvent),
                jacksonTypeRef<ConferenceCreatedWebhookEvent>(),
            )

        assertThat(roundtrippedConferenceCreatedWebhookEvent)
            .isEqualTo(conferenceCreatedWebhookEvent)
    }
}
