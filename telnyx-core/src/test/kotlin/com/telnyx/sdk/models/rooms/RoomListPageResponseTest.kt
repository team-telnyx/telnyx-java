...
internal class RoomListPageResponseTest {

    @Test
    fun create() {
        val roomListPageResponse =
            RoomListPageResponse.builder()
                .addData(
                    Room.builder()
        ...
        assertThat(roomListPageResponse.data().getOrNull())
            .containsExactly(
                Room.builder()
                    .id("7b61621f-62e0-4aad-ab11-9fd19e272e73")
                    .activeSessionId("7b61621f-62e0-4aad-ab11-9fd19e272e74")
        ...
        assertThat(roomListPageResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoomListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(roomListPageResponse),
                jacksonTypeRef<RoomListPageResponse>(),
            )

        assertThat(roundtrippedRoomListPageResponse).isEqualTo(roomListPageResponse)
    }
}
