...
internal class CredentialConnectionUpdateResponseTest {

    @Test
    fun create() {
        val credentialConnectionUpdateResponse =
            CredentialConnectionUpdateResponse.builder()
                .data(
        ...
        assertThat(credentialConnectionUpdateResponse.data())
            .contains(
                CredentialConnection.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCredentialConnectionUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(credentialConnectionUpdateResponse),
                jacksonTypeRef<CredentialConnectionUpdateResponse>(),
            )

        assertThat(roundtrippedCredentialConnectionUpdateResponse)
            .isEqualTo(credentialConnectionUpdateResponse)
    }
}
