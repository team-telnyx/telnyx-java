...
internal class RoomCompositionListPageResponseTest {

    @Test
    fun create() {
        val roomCompositionListPageResponse =
            RoomCompositionListPageResponse.builder()
                .addData(
        ...
        assertThat(roomCompositionListPageResponse.data().getOrNull())
            .containsExactly(
                RoomComposition.builder()
                    .id("7103dc53-ee59-4b54-a58b-c77d99ceb037")
                    .completedAt(OffsetDateTime.parse("2022-02-25T05:39:56.377426Z"))
        ...
        assertThat(roomCompositionListPageResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoomCompositionListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(roomCompositionListPageResponse),
                jacksonTypeRef<RoomCompositionListPageResponse>(),
            )

        assertThat(roundtrippedRoomCompositionListPageResponse)
            .isEqualTo(roomCompositionListPageResponse)
    }
}
