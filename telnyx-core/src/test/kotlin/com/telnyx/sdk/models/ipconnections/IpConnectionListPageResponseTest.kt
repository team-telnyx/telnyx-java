...
internal class IpConnectionListPageResponseTest {

    @Test
    fun create() {
        val ipConnectionListPageResponse =
        ...
        assertThat(ipConnectionListPageResponse.meta())
            .contains(
                ConnectionsPaginationMeta.builder()
                    .pageNumber(2L)
                    .totalPages(3L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedIpConnectionListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(ipConnectionListPageResponse),
                jacksonTypeRef<IpConnectionListPageResponse>(),
            )

        assertThat(roundtrippedIpConnectionListPageResponse).isEqualTo(ipConnectionListPageResponse)
    }
}
