...
internal class MessageSendNumberPoolResponseTest {

    @Test
    fun create() {
        val messageSendNumberPoolResponse =
            MessageSendNumberPoolResponse.builder()
                .data(
        ...
        assertThat(messageSendNumberPoolResponse.data())
            .contains(
                OutboundMessagePayload.builder()
                    .id("40385f64-5717-4562-b3fc-2c963f66afa6")
                    .completedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessageSendNumberPoolResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messageSendNumberPoolResponse),
                jacksonTypeRef<MessageSendNumberPoolResponse>(),
            )

        assertThat(roundtrippedMessageSendNumberPoolResponse)
            .isEqualTo(messageSendNumberPoolResponse)
    }
}
