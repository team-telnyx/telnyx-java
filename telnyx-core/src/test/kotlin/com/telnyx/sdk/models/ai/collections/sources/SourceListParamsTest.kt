...
internal class SourceListParamsTest {
    ...
    @Test
    fun create() {
        SourceListParams.builder().uuid("6a09ccbd-8f9b-4c3a-9b0e-2f1d3c4b5a6e").build()
    }

    @Test
    fun pathParams() {
        val params = SourceListParams.builder().uuid("6a09ccbd-8f9b-4c3a-9b0e-2f1d3c4b5a6e").build()
