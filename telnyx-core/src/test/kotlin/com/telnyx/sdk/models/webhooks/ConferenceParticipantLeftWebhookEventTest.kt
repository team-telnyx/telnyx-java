...
internal class ConferenceParticipantLeftWebhookEventTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedConferenceParticipantLeftWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(conferenceParticipantLeftWebhookEvent),
                jacksonTypeRef<ConferenceParticipantLeftWebhookEvent>(),
            )

        assertThat(roundtrippedConferenceParticipantLeftWebhookEvent)
            .isEqualTo(conferenceParticipantLeftWebhookEvent)
    }
}
