...
internal class InboundFqdnTest {
    ...
    fun create() {
        ...
        assertThat(inboundFqdn.defaultPrimaryFqdnId()).contains("1293384261075731497")
        assertThat(inboundFqdn.defaultRoutingMethod())
            .contains(InboundFqdn.DefaultRoutingMethod.SEQUENTIAL)
        assertThat(inboundFqdn.defaultSecondaryFqdnId()).contains("1293384261075731498")
        assertThat(inboundFqdn.defaultTertiaryFqdnId()).contains("1293384261075731499")
