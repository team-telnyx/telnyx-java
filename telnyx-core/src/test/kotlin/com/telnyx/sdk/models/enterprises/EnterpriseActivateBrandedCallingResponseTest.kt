...
internal class EnterpriseActivateBrandedCallingResponseTest {

    @Test
    fun create() {
        val enterpriseActivateBrandedCallingResponse =
            EnterpriseActivateBrandedCallingResponse.builder()
                .data(
        ...
        assertThat(enterpriseActivateBrandedCallingResponse.data())
            .isEqualTo(
                EnterprisePublic.builder()
                    .id("4a6192a4-573d-446d-b3ce-aff9117272a6")
                    .billingAddress(
    ...
    fun roundtrip() {
        ...
        val roundtrippedEnterpriseActivateBrandedCallingResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(enterpriseActivateBrandedCallingResponse),
                jacksonTypeRef<EnterpriseActivateBrandedCallingResponse>(),
            )

        assertThat(roundtrippedEnterpriseActivateBrandedCallingResponse)
            .isEqualTo(enterpriseActivateBrandedCallingResponse)
    }
}
