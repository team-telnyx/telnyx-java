...
internal class MessagingHostedNumberRetrieveResponseTest {

    @Test
    fun create() {
        val messagingHostedNumberRetrieveResponse =
            MessagingHostedNumberRetrieveResponse.builder()
                .data(
        ...
        assertThat(messagingHostedNumberRetrieveResponse.data())
            .contains(
                PhoneNumberWithMessagingSettings.builder()
                    .id("1293384261075731499")
                    .countryCode("US")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingHostedNumberRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingHostedNumberRetrieveResponse),
                jacksonTypeRef<MessagingHostedNumberRetrieveResponse>(),
            )

        assertThat(roundtrippedMessagingHostedNumberRetrieveResponse)
            .isEqualTo(messagingHostedNumberRetrieveResponse)
    }
}
