    ...
    fun create() {
        val voiceCloneListResponse =
            VoiceCloneListResponse.builder()
                ...
                .language("language")
                .name("name")
                .provider(VoiceCloneListResponse.Provider.TELNYX)
        ...
        assertThat(voiceCloneListResponse.provider())
            .contains(VoiceCloneListResponse.Provider.TELNYX)
        assertThat(voiceCloneListResponse.providerSupportedModels().getOrNull())
            .containsExactly("string")
        assertThat(voiceCloneListResponse.providerVoiceId()).contains("provider_voice_id")
