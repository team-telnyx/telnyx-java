    ...
    fun create() {
        val numberRetrieveResponse =
            NumberRetrieveResponse.builder()
                .data(
                    NumberRetrieveResponse.Data.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .enterpriseId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        .phoneNumber("+16035551234")
                        .reputationData(
                            NumberRetrieveResponse.Data.ReputationData.InnerReputationData.builder()
                                .connectionScore(0L)
                                .engagementScore(0L)
                                ...
                                .spamRisk(
                                    NumberRetrieveResponse.Data.ReputationData.InnerReputationData
                                        .SpamRisk
                                        .LOW
                                )
                                .build()
