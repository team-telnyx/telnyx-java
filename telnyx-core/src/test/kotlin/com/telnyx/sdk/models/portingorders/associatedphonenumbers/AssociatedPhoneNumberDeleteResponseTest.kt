...
internal class AssociatedPhoneNumberDeleteResponseTest {

    @Test
    fun create() {
        val associatedPhoneNumberDeleteResponse =
            AssociatedPhoneNumberDeleteResponse.builder()
                .data(
        ...
        assertThat(associatedPhoneNumberDeleteResponse.data())
            .contains(
                PortingAssociatedPhoneNumber.builder()
                    .id("f24151b6-3389-41d3-8747-7dd8c681e5e2")
                    .action(PortingAssociatedPhoneNumber.Action.KEEP)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAssociatedPhoneNumberDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(associatedPhoneNumberDeleteResponse),
                jacksonTypeRef<AssociatedPhoneNumberDeleteResponse>(),
            )

        assertThat(roundtrippedAssociatedPhoneNumberDeleteResponse)
            .isEqualTo(associatedPhoneNumberDeleteResponse)
    }
}
