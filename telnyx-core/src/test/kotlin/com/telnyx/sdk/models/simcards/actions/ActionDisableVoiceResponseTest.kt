...
internal class ActionDisableVoiceResponseTest {

    @Test
    fun create() {
        val actionDisableVoiceResponse =
            ActionDisableVoiceResponse.builder()
                .data(
        ...
        assertThat(actionDisableVoiceResponse.data())
            .contains(
                WirelessSimCardAction.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .actionType(WirelessSimCardAction.ActionType.ENABLE)
    ...
    fun roundtrip() {
        ...
        val roundtrippedActionDisableVoiceResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(actionDisableVoiceResponse),
                jacksonTypeRef<ActionDisableVoiceResponse>(),
            )

        assertThat(roundtrippedActionDisableVoiceResponse).isEqualTo(actionDisableVoiceResponse)
    }
}
