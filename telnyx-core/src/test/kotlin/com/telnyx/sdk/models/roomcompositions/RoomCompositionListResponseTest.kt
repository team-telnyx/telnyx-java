...
internal class RoomCompositionListResponseTest {

    @Test
    fun create() {
        val roomCompositionListResponse =
            RoomCompositionListResponse.builder()
                .addData(
        ...
        assertThat(roomCompositionListResponse.data().getOrNull())
            .containsExactly(
                RoomComposition.builder()
                    .id("7103dc53-ee59-4b54-a58b-c77d99ceb037")
                    .completedAt(OffsetDateTime.parse("2022-02-25T05:39:56.377426Z"))
        ...
        assertThat(roomCompositionListResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoomCompositionListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(roomCompositionListResponse),
                jacksonTypeRef<RoomCompositionListResponse>(),
            )

        assertThat(roundtrippedRoomCompositionListResponse).isEqualTo(roomCompositionListResponse)
    }
}
