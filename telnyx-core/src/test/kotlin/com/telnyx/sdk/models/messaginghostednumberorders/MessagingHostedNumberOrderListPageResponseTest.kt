...
internal class MessagingHostedNumberOrderListPageResponseTest {

    @Test
    fun create() {
        val messagingHostedNumberOrderListPageResponse =
            MessagingHostedNumberOrderListPageResponse.builder()
                .addData(
        ...
        assertThat(messagingHostedNumberOrderListPageResponse.data().getOrNull())
            .containsExactly(
                MessagingHostedNumberOrder.builder()
                    .id("86f58db9-0fe3-4adc-9d1f-46e66e6e9323")
                    .messagingProfileId("dc8f39ac-953d-4520-b93b-786ae87db0da")
        ...
        assertThat(messagingHostedNumberOrderListPageResponse.meta())
            .contains(
                MessagingPaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingHostedNumberOrderListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingHostedNumberOrderListPageResponse),
                jacksonTypeRef<MessagingHostedNumberOrderListPageResponse>(),
            )

        assertThat(roundtrippedMessagingHostedNumberOrderListPageResponse)
            .isEqualTo(messagingHostedNumberOrderListPageResponse)
    }
}
