...
internal class VoiceCloneResponseTest {

    @Test
    fun create() {
        val voiceCloneResponse =
            VoiceCloneResponse.builder()
                .data(
        ...
        assertThat(voiceCloneResponse.data())
            .contains(
                VoiceCloneData.builder()
                    .id("660f9511-f3ac-52e5-b827-557766551111")
                    .createdAt(OffsetDateTime.parse("2024-01-01T00:00:00Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedVoiceCloneResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(voiceCloneResponse),
                jacksonTypeRef<VoiceCloneResponse>(),
            )

        assertThat(roundtrippedVoiceCloneResponse).isEqualTo(voiceCloneResponse)
    }
}
