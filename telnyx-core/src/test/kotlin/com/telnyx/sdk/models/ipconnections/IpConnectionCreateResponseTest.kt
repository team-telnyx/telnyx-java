...
internal class IpConnectionCreateResponseTest {

    @Test
    fun create() {
        val ipConnectionCreateResponse =
            IpConnectionCreateResponse.builder()
                .data(
        ...
        assertThat(ipConnectionCreateResponse.data())
            .contains(
                IpConnection.builder()
                    .id("id")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedIpConnectionCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(ipConnectionCreateResponse),
                jacksonTypeRef<IpConnectionCreateResponse>(),
            )

        assertThat(roundtrippedIpConnectionCreateResponse).isEqualTo(ipConnectionCreateResponse)
    }
}
