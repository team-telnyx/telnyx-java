...
internal class DirUpdateResponseTest {

    @Test
    fun create() {
        val dirUpdateResponse =
            DirUpdateResponse.builder()
                .data(
                    DirUpdateResponse.Data.builder()
                        .id("16635d38-75a6-4481-82e8-69af60e05011")
                        .authorizerEmail("sam@acmeplumbing.example.com")
                        .authorizerName("Sam Owner")
                        .addCallReason(
                            DirUpdateResponse.Data.CallReason.builder()
                        ...
                        .addDocument(
                            DirUpdateResponse.Data.Document.builder()
                                .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                                .documentType(
                                    DirUpdateResponse.Data.Document.DocumentType
                        ...
                        .addRejectionReason(
                            DirUpdateResponse.Data.RejectionReason.builder()
                        ...
                        .reselling(false)
                        .status(DirUpdateResponse.Data.Status.DRAFT)
        ...
        assertThat(dirUpdateResponse.data())
            .isEqualTo(
                DirUpdateResponse.Data.builder()
                    .id("16635d38-75a6-4481-82e8-69af60e05011")
                    .authorizerEmail("sam@acmeplumbing.example.com")
                    ...
                    .addDocument(
                        DirUpdateResponse.Data.Document.builder()
                            .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                            .documentType(
                                DirUpdateResponse.Data.Document.DocumentType.BUSINESS_REGISTRATION
                            )
                            .description("Certificate of incorporation.")
                            .build()
                    )
    ...
    fun roundtrip() {
        ...
        val roundtrippedDirUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dirUpdateResponse),
                jacksonTypeRef<DirUpdateResponse>(),
            )

        assertThat(roundtrippedDirUpdateResponse).isEqualTo(dirUpdateResponse)
    }
}
