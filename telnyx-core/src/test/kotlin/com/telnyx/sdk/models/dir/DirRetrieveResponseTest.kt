...
internal class DirRetrieveResponseTest {

    @Test
    fun create() {
        val dirRetrieveResponse =
            DirRetrieveResponse.builder()
                .data(
                    DirRetrieveResponse.Data.builder()
                        .id("16635d38-75a6-4481-82e8-69af60e05011")
                        .authorizerEmail("sam@acmeplumbing.example.com")
                        .authorizerName("Sam Owner")
                        .addCallReason(
                            DirRetrieveResponse.Data.CallReason.builder()
                        ...
                        .addDocument(
                            DirRetrieveResponse.Data.Document.builder()
                                .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                                .documentType(
                                    DirRetrieveResponse.Data.Document.DocumentType
                        ...
                        .addRejectionReason(
                            DirRetrieveResponse.Data.RejectionReason.builder()
                        ...
                        .reselling(false)
                        .status(DirRetrieveResponse.Data.Status.DRAFT)
        ...
        assertThat(dirRetrieveResponse.data())
            .isEqualTo(
                DirRetrieveResponse.Data.builder()
                    .id("16635d38-75a6-4481-82e8-69af60e05011")
                    .authorizerEmail("sam@acmeplumbing.example.com")
                    ...
                    .addDocument(
                        DirRetrieveResponse.Data.Document.builder()
                            .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                            .documentType(
                                DirRetrieveResponse.Data.Document.DocumentType.BUSINESS_REGISTRATION
                            )
                            .description("Certificate of incorporation.")
                            .build()
                    )
    ...
    fun roundtrip() {
        ...
        val roundtrippedDirRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dirRetrieveResponse),
                jacksonTypeRef<DirRetrieveResponse>(),
            )

        assertThat(roundtrippedDirRetrieveResponse).isEqualTo(dirRetrieveResponse)
    }
}
