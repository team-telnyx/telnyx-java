...
internal class FqdnConnectionCreateResponseTest {

    @Test
    fun create() {
        val fqdnConnectionCreateResponse =
            FqdnConnectionCreateResponse.builder()
                .data(
        ...
        assertThat(fqdnConnectionCreateResponse.data())
            .contains(
                FqdnConnection.builder()
                    .connectionName("string")
                    .id("id")
    ...
    fun roundtrip() {
        ...
        val roundtrippedFqdnConnectionCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fqdnConnectionCreateResponse),
                jacksonTypeRef<FqdnConnectionCreateResponse>(),
            )

        assertThat(roundtrippedFqdnConnectionCreateResponse).isEqualTo(fqdnConnectionCreateResponse)
    }
}
