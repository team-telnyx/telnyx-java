...
internal class GlobalIpListPageResponseTest {
    ...
    fun create() {
        ...
        assertThat(globalIpListPageResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .totalPages(3L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedGlobalIpListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(globalIpListPageResponse),
                jacksonTypeRef<GlobalIpListPageResponse>(),
            )

        assertThat(roundtrippedGlobalIpListPageResponse).isEqualTo(globalIpListPageResponse)
    }
}
