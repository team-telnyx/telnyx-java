...
internal class NumberOrderStatusUpdateTest {
    ...
    fun create() {
        ...
        assertThat(numberOrderStatusUpdate.data())
            .isEqualTo(
                NumberOrderStatusUpdate.Data.builder()
                    .id("d578b093-a0e7-4b64-b0d3-6b689a6ff170")
                    .eventType("number_order.complete")
        ...
        assertThat(numberOrderStatusUpdate.meta())
            .isEqualTo(
                NumberOrderStatusUpdate.Meta.builder()
                    .attempt(1L)
                    .deliveredTo("https://sample-api.com/webhook")
    ...
    fun roundtrip() {
        ...
        val roundtrippedNumberOrderStatusUpdate =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(numberOrderStatusUpdate),
                jacksonTypeRef<NumberOrderStatusUpdate>(),
            )

        assertThat(roundtrippedNumberOrderStatusUpdate).isEqualTo(numberOrderStatusUpdate)
    }
}
