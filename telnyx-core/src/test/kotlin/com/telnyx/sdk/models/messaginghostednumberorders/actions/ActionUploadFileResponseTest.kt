...
internal class ActionUploadFileResponseTest {

    @Test
    fun create() {
        val actionUploadFileResponse =
            ActionUploadFileResponse.builder()
                .data(
        ...
        assertThat(actionUploadFileResponse.data())
            .contains(
                MessagingHostedNumberOrder.builder()
                    .id("86f58db9-0fe3-4adc-9d1f-46e66e6e9323")
                    .messagingProfileId("dc8f39ac-953d-4520-b93b-786ae87db0da")
    ...
    fun roundtrip() {
        ...
        val roundtrippedActionUploadFileResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(actionUploadFileResponse),
                jacksonTypeRef<ActionUploadFileResponse>(),
            )

        assertThat(roundtrippedActionUploadFileResponse).isEqualTo(actionUploadFileResponse)
    }
}
