...
internal class ConferenceParticipantPlaybackStartedWebhookEventTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedConferenceParticipantPlaybackStartedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(conferenceParticipantPlaybackStartedWebhookEvent),
                jacksonTypeRef<ConferenceParticipantPlaybackStartedWebhookEvent>(),
            )

        assertThat(roundtrippedConferenceParticipantPlaybackStartedWebhookEvent)
            .isEqualTo(conferenceParticipantPlaybackStartedWebhookEvent)
    }
}
