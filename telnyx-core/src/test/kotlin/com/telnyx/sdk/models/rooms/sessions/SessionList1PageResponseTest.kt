...
internal class SessionList1PageResponseTest {

    @Test
    fun create() {
        val sessionList1PageResponse =
            SessionList1PageResponse.builder()
                .addData(
                    RoomSession.builder()
        ...
        assertThat(sessionList1PageResponse.data().getOrNull())
            .containsExactly(
                RoomSession.builder()
                    .id("7b61621f-62e0-4aad-ab11-9fd19e272e73")
                    .active(false)
        ...
        assertThat(sessionList1PageResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSessionList1PageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sessionList1PageResponse),
                jacksonTypeRef<SessionList1PageResponse>(),
            )

        assertThat(roundtrippedSessionList1PageResponse).isEqualTo(sessionList1PageResponse)
    }
}
