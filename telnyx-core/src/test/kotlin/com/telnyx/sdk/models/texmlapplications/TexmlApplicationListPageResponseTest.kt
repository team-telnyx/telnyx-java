...
internal class TexmlApplicationListPageResponseTest {

    @Test
    fun create() {
        val texmlApplicationListPageResponse =
            TexmlApplicationListPageResponse.builder()
                .addData(
                ...
                .meta(
                    TexmlApplicationListPageResponse.Meta.builder()
                        .pageNumber(2L)
                        .pageSize(25L)
                        .totalPages(3L)
                        .totalResults(55L)
        ...
        assertThat(texmlApplicationListPageResponse.data().getOrNull())
            .containsExactly(
                TexmlApplication.builder()
                    .id("1293384261075731499")
                    .active(false)
        ...
        assertThat(texmlApplicationListPageResponse.meta())
            .contains(
                TexmlApplicationListPageResponse.Meta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedTexmlApplicationListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(texmlApplicationListPageResponse),
                jacksonTypeRef<TexmlApplicationListPageResponse>(),
            )

        assertThat(roundtrippedTexmlApplicationListPageResponse)
            .isEqualTo(texmlApplicationListPageResponse)
    }
}
