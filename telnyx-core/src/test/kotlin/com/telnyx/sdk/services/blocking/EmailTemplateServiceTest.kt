...
internal class EmailTemplateServiceTest {
    ...
    fun retrieve() {
        ...
        val emailTemplateResponse =
            emailTemplateService.retrieve("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun delete() {
        ...
        emailTemplateService.delete("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
