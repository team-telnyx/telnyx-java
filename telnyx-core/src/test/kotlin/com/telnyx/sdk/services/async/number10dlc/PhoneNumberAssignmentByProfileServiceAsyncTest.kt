...
internal class PhoneNumberAssignmentByProfileServiceAsyncTest {
    ...
    fun retrieve() {
        ...
        val phoneNumberAssignmentByProfileFuture =
            phoneNumberAssignmentByProfileServiceAsync.retrieve("taskId")

        val phoneNumberAssignmentByProfile = phoneNumberAssignmentByProfileFuture.get()
        phoneNumberAssignmentByProfile.validate()
    }
    ...
    fun retrievePhoneNumbers() {
        ...
        val responseFuture =
            phoneNumberAssignmentByProfileServiceAsync.retrievePhoneNumbers(
                PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams.builder()
                    .taskId("taskId")
                    .page(0L)
                    .recordsPerPage(0L)
                    .build()
