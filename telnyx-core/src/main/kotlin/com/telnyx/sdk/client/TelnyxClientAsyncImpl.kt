...
import com.telnyx.sdk.services.async.CallReasonServiceAsyncImpl
...
import com.telnyx.sdk.services.async.DirServiceAsyncImpl
...
import com.telnyx.sdk.services.async.InfringementClaimServiceAsyncImpl
...
import com.telnyx.sdk.services.async.Messaging10dlcServiceAsyncImpl
...
import com.telnyx.sdk.services.async.SessionAnalysisServiceAsyncImpl
...
class TelnyxClientAsyncImpl(private val clientOptions: ClientOptions) : TelnyxClientAsync {
    ...
    private val messaging10dlc: Messaging10dlcServiceAsync by lazy {
        Messaging10dlcServiceAsyncImpl(clientOptionsWithUserAgent)
    }
    ...
    private val sessionAnalysis: SessionAnalysisServiceAsync by lazy {
    ...
    private val dir: DirServiceAsync by lazy { DirServiceAsyncImpl(clientOptionsWithUserAgent) }

    private val infringementClaims: InfringementClaimServiceAsync by lazy {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val messaging10dlc: Messaging10dlcServiceAsync.WithRawResponse by lazy {
            Messaging10dlcServiceAsyncImpl.WithRawResponseImpl(clientOptions)
        }
        ...
        private val sessionAnalysis: SessionAnalysisServiceAsync.WithRawResponse by lazy {
        ...
        private val infringementClaims: InfringementClaimServiceAsync.WithRawResponse by lazy {
         ...
         * Static reference values the API accepts: call reasons, document types, rejection types.
         */
        override fun callReasons(): CallReasonServiceAsync.WithRawResponse = callReasons
