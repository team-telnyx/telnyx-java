...
import com.telnyx.sdk.services.async.ai.assistants.TagServiceAsyncImpl
...
class AssistantServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun chat(
        ...
        withRawResponse().chat(params, requestOptions).mapCancellable { it.parse() }
    ...
    override fun clone(
        ...
        withRawResponse().clone(params, requestOptions).mapCancellable { it.parse() }
    ...
    override fun getTexml(
        ...
        withRawResponse().getTexml(params, requestOptions).mapCancellable { it.parse() }
