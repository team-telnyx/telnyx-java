...
interface ImportServiceAsync {
     ...
     */
    fun create(params: ImportCreateParams): CompletableFuture<EmailBlockImportResponse> =
    ...
    ): CompletableFuture<EmailBlockImportResponse>
     ...
     * failure.
     */
    fun retrieve(id: String): CompletableFuture<EmailBlockImportResponse> =
    ...
    fun retrieve(
        id: String,
        params: ImportRetrieveParams = ImportRetrieveParams.none(),
    ): CompletableFuture<EmailBlockImportResponse> = retrieve(id, params, RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: ImportRetrieveParams): CompletableFuture<EmailBlockImportResponse> =
    ...
    interface WithRawResponse {
        ...
        fun create(
            params: ImportCreateParams
        ): CompletableFuture<HttpResponseFor<EmailBlockImportResponse>> =
            create(params, RequestOptions.none())
         ...
         * same as [ImportServiceAsync.retrieve].
         */
        fun retrieve(id: String): CompletableFuture<HttpResponseFor<EmailBlockImportResponse>> =
            retrieve(id, ImportRetrieveParams.none())
