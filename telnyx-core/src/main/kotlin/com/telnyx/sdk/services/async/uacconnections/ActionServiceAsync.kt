...
interface ActionServiceAsync {
    ...
    /**
     * Returns the live SIP registration status for a UAC connection. Reports whether the endpoint
     * is currently registered (`status`) and the timestamp of the last SIP registration event
     * (`last_registration`).
     */
    ...
    interface WithRawResponse {
         ...
         * /uac_connections/{id}/actions/check_registration_status`, but is otherwise the same as
         * [ActionServiceAsync.checkRegistrationStatus].
         */
        fun checkRegistrationStatus(
            id: String
