...
class ActionServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun generateJoinClientToken(
        ...
        withRawResponse().generateJoinClientToken(params, requestOptions).mapCancellable {
            it.parse()
        }
    ...
    override fun refreshClientToken(
        ...
        withRawResponse().refreshClientToken(params, requestOptions).mapCancellable { it.parse() }
