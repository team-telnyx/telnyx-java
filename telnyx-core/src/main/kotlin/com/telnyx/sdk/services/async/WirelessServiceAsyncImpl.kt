...
import com.telnyx.sdk.services.async.wireless.DetailRecordsReportServiceAsyncImpl
...
class WirelessServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun retrieveRegions(
        ...
        withRawResponse().retrieveRegions(params, requestOptions).mapCancellable { it.parse() }
