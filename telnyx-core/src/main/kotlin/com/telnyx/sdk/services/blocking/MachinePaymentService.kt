 ...
 * Tempo.
 */
interface MachinePaymentService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): MachinePaymentService
    ...
    ): MachinePaymentAccountCreditResponse = accountCredit(params, RequestOptions.none())
    ...
    /**
     * A view of [MachinePaymentService] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
         ...
         * the same as [MachinePaymentService.accountCredit].
         */
        @MustBeClosed
        fun accountCredit(
            params: MachinePaymentAccountCreditParams
