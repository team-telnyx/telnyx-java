...
import com.telnyx.sdk.services.async.ai.AnthropicServiceAsyncImpl
...
class AiServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun retrieveConversationHistories(
        ...
        withRawResponse().retrieveConversationHistories(params, requestOptions).mapCancellable {
            it.parse()
        }
    ...
    override fun summarize(
        ...
        // post /ai/summarize
        withRawResponse().summarize(params, requestOptions).mapCancellable { it.parse() }
