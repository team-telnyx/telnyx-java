...
class WhatsappMessageTemplateServiceImpl
internal constructor(private val clientOptions: ClientOptions) : WhatsappMessageTemplateService {

    private val withRawResponse: WhatsappMessageTemplateService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): WhatsappMessageTemplateService.WithRawResponse = withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): WhatsappMessageTemplateService =
        WhatsappMessageTemplateServiceImpl(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            WhatsappMessageTemplateServiceImpl.WithRawResponseImpl(
                clientOptions.toBuilder().apply(modifier::accept).build()
            )

        private val retrieveHandler: Handler<WhatsappMessageTemplateRetrieveResponse> =
            jsonHandler<WhatsappMessageTemplateRetrieveResponse>(clientOptions.jsonMapper)
        ...
        private val updateHandler: Handler<WhatsappMessageTemplateUpdateResponse> =
            jsonHandler<WhatsappMessageTemplateUpdateResponse>(clientOptions.jsonMapper)
