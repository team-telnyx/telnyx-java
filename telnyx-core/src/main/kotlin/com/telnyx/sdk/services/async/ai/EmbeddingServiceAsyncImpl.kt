...
import com.telnyx.sdk.services.async.ai.embeddings.BucketServiceAsyncImpl
...
class EmbeddingServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun similaritySearch(
        ...
        withRawResponse().similaritySearch(params, requestOptions).mapCancellable { it.parse() }
    ...
    override fun url(
        ...
        withRawResponse().url(params, requestOptions).mapCancellable { it.parse() }
