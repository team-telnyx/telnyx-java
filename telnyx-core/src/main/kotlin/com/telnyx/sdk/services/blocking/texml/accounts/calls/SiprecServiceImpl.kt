...
class SiprecServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: SiprecService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SiprecService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SiprecService =
        SiprecServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun siprecSidJson(
        ...
        withRawResponse().siprecSidJson(params, requestOptions).parse()

    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        SiprecService.WithRawResponse {
        ...
        override fun withOptions(
            ...
            SiprecServiceImpl.WithRawResponseImpl(
