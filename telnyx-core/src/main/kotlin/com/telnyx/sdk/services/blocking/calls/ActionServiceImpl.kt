...
class ActionServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun joinAiAssistant(
        ...
        withRawResponse().joinAiAssistant(params, requestOptions).parse()
    ...
    override fun startConversationRelay(
        ...
        withRawResponse().startConversationRelay(params, requestOptions).parse()
    ...
    override fun stopConversationRelay(
        ...
        withRawResponse().stopConversationRelay(params, requestOptions).parse()
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun joinAiAssistant(
            params: ActionJoinAiAssistantParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<ActionJoinAiAssistantResponse> {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("callControlId", params.callControlId().getOrNull())
            val request =
