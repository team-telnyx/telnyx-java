...
class EmailTemplateServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    EmailTemplateServiceAsync {

    private val withRawResponse: EmailTemplateServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): EmailTemplateServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): EmailTemplateServiceAsync =
        EmailTemplateServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun render(
        ...
        withRawResponse().render(params, requestOptions).mapCancellable { it.parse() }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EmailTemplateServiceAsyncImpl.WithRawResponseImpl(
