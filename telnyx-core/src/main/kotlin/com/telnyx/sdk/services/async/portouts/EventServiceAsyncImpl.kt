...
class EventServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun republish(
        ...
        withRawResponse().republish(params, requestOptions).mapCancellable { null }
        ...
        override fun retrieve(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("portouts", "events", params._pathParam(0))
                    .build()
        ...
        override fun list(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("portouts", "events")
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            return request
        ...
        override fun republish(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("portouts", "events", params._pathParam(0), "republish")
