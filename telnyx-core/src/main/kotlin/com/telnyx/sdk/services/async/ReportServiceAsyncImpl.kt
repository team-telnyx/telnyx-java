...
import com.telnyx.sdk.services.async.reports.MdrUsageReportServiceAsyncImpl
...
class ReportServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun listMdrs(
        ...
        // get /reports/mdrs
        withRawResponse().listMdrs(params, requestOptions).mapCancellable { it.parse() }
    ...
    override fun listWdrs(
        ...
        // get /reports/wdrs
        withRawResponse().listWdrs(params, requestOptions).mapCancellable { it.parse() }
