...
interface BucketServiceAsync {
    ...
    /**
     * Returns a timed and authenticated URL to download (GET) or upload (PUT) an object. This is
     * the equivalent to AWS S3’s “presigned” URL. Please note that Telnyx performs authentication
