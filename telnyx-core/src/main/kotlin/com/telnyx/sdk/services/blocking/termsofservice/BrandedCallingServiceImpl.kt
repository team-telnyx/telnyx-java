...
class BrandedCallingServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    BrandedCallingService {

    private val withRawResponse: BrandedCallingService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): BrandedCallingService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BrandedCallingService =
        BrandedCallingServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            BrandedCallingServiceImpl.WithRawResponseImpl(
