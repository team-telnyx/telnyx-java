...
internal constructor(private val clientOptions: ClientOptions) : VirtualCrossConnectService {
    ...
    private val withRawResponse: VirtualCrossConnectService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): VirtualCrossConnectService.WithRawResponse = withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): VirtualCrossConnectService =
        VirtualCrossConnectServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            VirtualCrossConnectServiceImpl.WithRawResponseImpl(
