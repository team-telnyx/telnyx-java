...
interface DirServiceAsync {
     ...
     */
    fun list(enterpriseId: String): CompletableFuture<DirListPageAsync> =
    ...
    fun list(
        enterpriseId: String,
        params: DirListParams = DirListParams.none(),
    ): CompletableFuture<DirListPageAsync> = list(enterpriseId, params, RequestOptions.none())
    ...
    /** @see list */
    fun list(params: DirListParams): CompletableFuture<DirListPageAsync> =
    ...
    interface WithRawResponse {
         ...
         * the same as [DirServiceAsync.create].
         */
        fun create(
            enterpriseId: String,
            params: DirCreateParams,
         ...
         * the same as [DirServiceAsync.list].
         */
        fun list(enterpriseId: String): CompletableFuture<HttpResponseFor<DirListPageAsync>> =
            list(enterpriseId, DirListParams.none())
        ...
        /** @see list */
        fun list(params: DirListParams): CompletableFuture<HttpResponseFor<DirListPageAsync>> =
            list(params, RequestOptions.none())
