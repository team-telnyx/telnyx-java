...
interface SourceService {
     ...
     */
    fun retrieve(sourceId: String, params: SourceRetrieveParams): SourceRetrieveResponse =
    ...
    /** @see retrieve */
    fun retrieve(params: SourceRetrieveParams): SourceRetrieveResponse =
     ...
     */
    fun list(profileId: String, params: SourceListParams): SourceListPage =
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SourceListPage = list(params.toBuilder().profileId(profileId).build(), requestOptions)

    /** @see list */
    fun list(params: SourceListParams): SourceListPage = list(params, RequestOptions.none())
     ...
     */
    fun delete(sourceId: String, params: SourceDeleteParams): SourceDeleteResponse =
    ...
    fun delete(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): SourceDeleteResponse = delete(params.toBuilder().sourceId(sourceId).build(), requestOptions)

    /** @see delete */
    fun delete(params: SourceDeleteParams): SourceDeleteResponse =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [SourceService.retrieve].
         */
        @MustBeClosed
        fun retrieve(
            sourceId: String,
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: SourceRetrieveParams): HttpResponseFor<SourceRetrieveResponse> =
            retrieve(params, RequestOptions.none())
         ...
         * same as [SourceService.list].
         */
        @MustBeClosed
        fun list(profileId: String, params: SourceListParams): HttpResponseFor<SourceListPage> =
            list(profileId, params, RequestOptions.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: SourceListParams): HttpResponseFor<SourceListPage> =
         ...
         * /ai/memory/namespaces/{namespace}/profiles/{profile_id}/sources/{source_id}`, but is
         * otherwise the same as [SourceService.delete].
         */
        @MustBeClosed
        fun delete(
            sourceId: String,
            params: SourceDeleteParams,
        ): HttpResponseFor<SourceDeleteResponse> = delete(sourceId, params, RequestOptions.none())
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: SourceDeleteParams): HttpResponseFor<SourceDeleteResponse> =
            delete(params, RequestOptions.none())
