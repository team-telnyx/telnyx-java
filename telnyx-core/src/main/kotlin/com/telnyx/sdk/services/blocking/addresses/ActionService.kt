...
interface ActionService {
    ...
    /** @see acceptSuggestions */
    fun acceptSuggestions(params: ActionAcceptSuggestionsParams): ActionAcceptSuggestionsResponse =
    ...
    interface WithRawResponse {
         ...
         * same as [ActionService.validate].
         */
        @MustBeClosed
        fun validate(params: ActionValidateParams): HttpResponseFor<ActionValidateResponse> =
            validate(params, RequestOptions.none())
