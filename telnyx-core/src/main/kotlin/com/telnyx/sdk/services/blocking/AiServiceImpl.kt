...
import com.telnyx.sdk.models.ai.AiListConversationHistoriesPage
import com.telnyx.sdk.models.ai.AiListConversationHistoriesPageResponse
...
class AiServiceImpl internal constructor(private val clientOptions: ClientOptions) : AiService {
    ...
    override fun listConversationHistories(
        params: AiListConversationHistoriesParams,
        requestOptions: RequestOptions,
    ): AiListConversationHistoriesPage =
        // get /ai/conversation_histories
        withRawResponse().listConversationHistories(params, requestOptions).parse()
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val listConversationHistoriesHandler:
            Handler<AiListConversationHistoriesPageResponse> =
            jsonHandler<AiListConversationHistoriesPageResponse>(clientOptions.jsonMapper)

        override fun listConversationHistories(
            params: AiListConversationHistoriesParams,
            requestOptions: RequestOptions,
        ): HttpResponseFor<AiListConversationHistoriesPage> {
            val request =
                HttpRequest.builder()
            ...
            return errorHandler.handle(response).parseable {
                response
                    .use { listConversationHistoriesHandler.handle(it) }
                    .also {
                        if (requestOptions.responseValidation!!) {
                            it.validate()
                        }
                    ...
                    .let {
                        AiListConversationHistoriesPage.builder()
