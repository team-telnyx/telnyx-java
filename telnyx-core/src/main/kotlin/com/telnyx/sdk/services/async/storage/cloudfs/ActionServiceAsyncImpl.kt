...
class ActionServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun rotateMetaToken(
        ...
        withRawResponse().rotateMetaToken(params, requestOptions).mapCancellable { it.parse() }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val rotateMetaTokenHandler: Handler<CloudfsFilesystemResponseWrapper> =
            ...
            return request
                ...
                .mapCancellable { response ->
                    errorHandler.handle(response).parseable {
                        response
                            .use { rotateMetaTokenHandler.handle(it) }
                            .also {
