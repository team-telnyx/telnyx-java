...
interface ActionService {
     ...
     */
    fun removePrivateWirelessGateway(id: String): ActionRemovePrivateWirelessGatewayResponse =
    ...
    ): ActionSetWirelessBlocklistResponse = setWirelessBlocklist(id, params, RequestOptions.none())
    ...
    fun setWirelessBlocklist(
        params: ActionSetWirelessBlocklistParams
    ): ActionSetWirelessBlocklistResponse = setWirelessBlocklist(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * as [ActionService.removePrivateWirelessGateway].
         */
        @MustBeClosed
        fun removePrivateWirelessGateway(
            id: String
         ...
         * [ActionService.removeWirelessBlocklist].
         */
        @MustBeClosed
        fun removeWirelessBlocklist(
            id: String
