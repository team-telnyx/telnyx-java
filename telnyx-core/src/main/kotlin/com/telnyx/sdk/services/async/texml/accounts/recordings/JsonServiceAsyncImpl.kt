...
class JsonServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun deleteRecordingSidJson(
        ...
        withRawResponse().deleteRecordingSidJson(params, requestOptions).mapCancellable { null }
    ...
    override fun retrieveRecordingSidJson(
        ...
        withRawResponse().retrieveRecordingSidJson(params, requestOptions).mapCancellable {
            it.parse()
        }
