...
interface ResearchService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): ResearchService
     ...
     * retrieve the answer.
     */
    fun create(params: ResearchCreateParams): ResearchCreateResponse =
     ...
     */
    fun retrieve(taskId: String): ResearchRetrieveResponse =
    ...
    fun retrieve(
        taskId: String,
        params: ResearchRetrieveParams = ResearchRetrieveParams.none(),
    ): ResearchRetrieveResponse = retrieve(taskId, params, RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: ResearchRetrieveParams): ResearchRetrieveResponse =
        retrieve(params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(taskId: String, requestOptions: RequestOptions): ResearchRetrieveResponse =
        retrieve(taskId, ResearchRetrieveParams.none(), requestOptions)

    /** A view of [ResearchService] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ResearchService.WithRawResponse
         ...
         */
        @MustBeClosed
        fun create(params: ResearchCreateParams): HttpResponseFor<ResearchCreateResponse> =
            create(params, RequestOptions.none())
        ...
        fun create(
            params: ResearchCreateParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<ResearchCreateResponse>

        /**
         * Returns a raw HTTP response for `get /web_search/research/{task_id}`, but is otherwise
         * the same as [ResearchService.retrieve].
         */
        @MustBeClosed
        fun retrieve(taskId: String): HttpResponseFor<ResearchRetrieveResponse> =
            retrieve(taskId, ResearchRetrieveParams.none())
        ...
        fun retrieve(
            ...
            params: ResearchRetrieveParams = ResearchRetrieveParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<ResearchRetrieveResponse> =
            retrieve(params.toBuilder().taskId(taskId).build(), requestOptions)
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: ResearchRetrieveParams): HttpResponseFor<ResearchRetrieveResponse> =
            retrieve(params, RequestOptions.none())
