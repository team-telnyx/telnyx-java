...
interface EmailDomainService {
     ...
     */
    fun rotateDkim(domainId: String): EmailDomainRotateDkimResponse =
    ...
    fun rotateDkim(
        domainId: String,
        params: EmailDomainRotateDkimParams = EmailDomainRotateDkimParams.none(),
    ): EmailDomainRotateDkimResponse = rotateDkim(domainId, params, RequestOptions.none())
    ...
    /** @see rotateDkim */
    fun rotateDkim(params: EmailDomainRotateDkimParams): EmailDomainRotateDkimResponse =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [EmailDomainService.rotateDkim].
         */
        @MustBeClosed
        fun rotateDkim(domainId: String): HttpResponseFor<EmailDomainRotateDkimResponse> =
            rotateDkim(domainId, EmailDomainRotateDkimParams.none())
