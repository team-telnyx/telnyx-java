...
class ReferenceServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(params: ReferenceListParams, requestOptions: RequestOptions): ReferenceList =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val createHandler: Handler<ReferenceList> =
            jsonHandler<ReferenceList>(clientOptions.jsonMapper)
        ...
        private val listHandler: Handler<ReferenceList> =
            jsonHandler<ReferenceList>(clientOptions.jsonMapper)
