...
class EnterpriseServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: EnterpriseService.WithRawResponse by lazy {
    ...
    override fun delete(params: EnterpriseDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EnterpriseServiceImpl.WithRawResponseImpl(
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        EnterpriseListPage.builder()
                            .service(EnterpriseServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
