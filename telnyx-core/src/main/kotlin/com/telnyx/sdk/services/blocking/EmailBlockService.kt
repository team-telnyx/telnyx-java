...
interface EmailBlockService {
     ...
     * created_at,updated_at,expires_at,group_id,bounce_category,dsn_code, meta` (15 columns). The
     * first 12 columns are the stable native signature; `bounce_category`, `dsn_code`, and `meta`
     * are optional backup fields (empty when unset). The CSV carries the `group_id` column so
