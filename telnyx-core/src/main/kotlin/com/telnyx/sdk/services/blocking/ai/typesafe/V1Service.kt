...
interface V1Service {
     ...
     */
    fun systemone(params: V1SystemoneParams): V1SystemoneResponse =
    ...
    interface WithRawResponse {
         ...
         * same as [V1Service.systemone].
         */
        @MustBeClosed
        fun systemone(params: V1SystemoneParams): HttpResponseFor<V1SystemoneResponse> =
            systemone(params, RequestOptions.none())
        ...
        fun systemone(
            params: V1SystemoneParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<V1SystemoneResponse>
    }
}
