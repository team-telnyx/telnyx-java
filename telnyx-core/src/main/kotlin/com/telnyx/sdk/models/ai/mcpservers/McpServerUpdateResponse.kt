...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [McpServerUpdateResponse].
         *
    ...
    /** A builder for [McpServerUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mcpServerUpdateResponse: McpServerUpdateResponse) = apply {
            id = mcpServerUpdateResponse.id
            createdAt = mcpServerUpdateResponse.createdAt
            name = mcpServerUpdateResponse.name
            type = mcpServerUpdateResponse.type
            url = mcpServerUpdateResponse.url
            allowedTools = mcpServerUpdateResponse.allowedTools.map { it.toMutableList() }
            apiKeyRef = mcpServerUpdateResponse.apiKeyRef
            additionalProperties = mcpServerUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [McpServerUpdateResponse].
         *
         ...
         */
        fun build(): McpServerUpdateResponse =
    ...
    fun validate(): McpServerUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is McpServerUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "McpServerUpdateResponse{id=$id, createdAt=$createdAt, name=$name, type=$type, url=$url, allowedTools=$allowedTools, apiKeyRef=$apiKeyRef, additionalProperties=$additionalProperties}"
}
