...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CsvDownloadListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CsvDownloadListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(csvDownloadListResponse: CsvDownloadListResponse) = apply {
            data = csvDownloadListResponse.data.map { it.toMutableList() }
            meta = csvDownloadListResponse.meta
            additionalProperties = csvDownloadListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CsvDownloadListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CsvDownloadListResponse =
    ...
    fun validate(): CsvDownloadListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CsvDownloadListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "CsvDownloadListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
