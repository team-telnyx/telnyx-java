...
class MessagingInboundMessage
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val id: JsonField<String>,
    private val eventType: JsonField<EventType>,
    private val occurredAt: JsonField<OffsetDateTime>,
    private val payload: JsonField<MessagingInboundMessagePayload>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        payload: JsonField<MessagingInboundMessagePayload> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun payload(): Optional<MessagingInboundMessagePayload> = payload.getOptional("payload")
    ...
    @JsonProperty("payload")
    @ExcludeMissing
    fun _payload(): JsonField<MessagingInboundMessagePayload> = payload
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MessagingInboundMessage]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessagingInboundMessage]. */
    class Builder internal constructor() {

        private var id: JsonField<String> = JsonMissing.of()
        private var eventType: JsonField<EventType> = JsonMissing.of()
        private var occurredAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var payload: JsonField<MessagingInboundMessagePayload> = JsonMissing.of()
        private var recordType: JsonField<RecordType> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(messagingInboundMessage: MessagingInboundMessage) = apply {
            id = messagingInboundMessage.id
            eventType = messagingInboundMessage.eventType
            occurredAt = messagingInboundMessage.occurredAt
            payload = messagingInboundMessage.payload
            recordType = messagingInboundMessage.recordType
            additionalProperties = messagingInboundMessage.additionalProperties.toMutableMap()
        }
        ...
        fun payload(payload: MessagingInboundMessagePayload) = payload(JsonField.of(payload))

        /**
         * Sets [Builder.payload] to an arbitrary JSON value.
         *
         * You should usually call [Builder.payload] with a well-typed
         * [MessagingInboundMessagePayload] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun payload(payload: JsonField<MessagingInboundMessagePayload>) = apply {
        ...
        /**
         * Returns an immutable instance of [MessagingInboundMessage].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingInboundMessage =
     ...
     *   expected type.
     */
    fun validate(): MessagingInboundMessage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingInboundMessage &&
            id == other.id &&
    ...
    override fun toString() =
        "MessagingInboundMessage{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
