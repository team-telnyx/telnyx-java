...
private constructor(
    private val data: JsonField<Release>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<Release> = JsonMissing.of()
     ...
     */
    fun data(): Optional<Release> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Release> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<Release> = JsonMissing.of()
        ...
        fun data(data: Release) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Release] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Release>) = apply { this.data = data }
