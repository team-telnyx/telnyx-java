...
class DirListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<DirListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<DirListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<DirListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<DirListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirListPageResponse].
         *
    ...
    /** A builder for [DirListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<DirListResponse>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(dirListPageResponse: DirListPageResponse) = apply {
            data = dirListPageResponse.data.map { it.toMutableList() }
            meta = dirListPageResponse.meta
            additionalProperties = dirListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<DirListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<DirListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<DirListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [DirListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: DirListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [DirListPageResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): DirListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DirListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
