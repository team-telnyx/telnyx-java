 ...
 * events only. New per-call dispatch options should be added here rather than as top-level event
 * fields.
 */
class ScheduledCallSettings
...
private constructor(
    ...
    /**
     * SIP region passed to Telnyx when initiating an outbound call. Values match the Telnyx TeXML
     * `SipRegion` parameter exactly. Telnyx defaults to `US` when omitted.
     *
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ScheduledCallSettings]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ScheduledCallSettings]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduledCallSettings: ScheduledCallSettings) = apply {
            sipRegion = scheduledCallSettings.sipRegion
            additionalProperties = scheduledCallSettings.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScheduledCallSettings].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScheduledCallSettings =
            ScheduledCallSettings(sipRegion, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ScheduledCallSettings = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (sipRegion.asKnown().getOrNull()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScheduledCallSettings &&
    ...
    override fun toString() =
        "ScheduledCallSettings{sipRegion=$sipRegion, additionalProperties=$additionalProperties}"
}
