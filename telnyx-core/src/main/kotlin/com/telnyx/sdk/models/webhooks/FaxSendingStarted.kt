...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FaxSendingStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FaxSendingStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxSendingStarted: FaxSendingStarted) = apply {
            data = faxSendingStarted.data
            meta = faxSendingStarted.meta
            additionalProperties = faxSendingStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxSendingStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxSendingStarted =
            FaxSendingStarted(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FaxSendingStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxSendingStarted &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FaxSendingStarted{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
