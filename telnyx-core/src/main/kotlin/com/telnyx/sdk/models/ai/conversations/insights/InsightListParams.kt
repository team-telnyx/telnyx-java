...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): InsightListParams =
            InsightListParams(page, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "InsightListParams{page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
