...
class ExternalVettingOrderResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalVettingOrderResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExternalVettingOrderResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVettingOrderResponse: ExternalVettingOrderResponse) = apply {
            createDate = externalVettingOrderResponse.createDate
            evpId = externalVettingOrderResponse.evpId
            vettedDate = externalVettingOrderResponse.vettedDate
            vettingClass = externalVettingOrderResponse.vettingClass
            vettingId = externalVettingOrderResponse.vettingId
            vettingScore = externalVettingOrderResponse.vettingScore
            vettingToken = externalVettingOrderResponse.vettingToken
            additionalProperties = externalVettingOrderResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingOrderResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVettingOrderResponse =
    ...
    fun validate(): ExternalVettingOrderResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingOrderResponse &&
    ...
    override fun toString() =
        "ExternalVettingOrderResponse{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
