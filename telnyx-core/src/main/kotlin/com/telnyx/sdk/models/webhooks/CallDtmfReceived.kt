...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallDtmfReceived]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallDtmfReceived]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callDtmfReceived: CallDtmfReceived) = apply {
            id = callDtmfReceived.id
            eventType = callDtmfReceived.eventType
            occurredAt = callDtmfReceived.occurredAt
            payload = callDtmfReceived.payload
            recordType = callDtmfReceived.recordType
            additionalProperties = callDtmfReceived.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallDtmfReceived].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallDtmfReceived =
            CallDtmfReceived(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallDtmfReceived = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallDtmfReceived &&
            id == other.id &&
    ...
    override fun toString() =
        "CallDtmfReceived{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
