...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = globalIpHealthCheckListPageResponse.data.map { it.toMutableList() }
            meta = globalIpHealthCheckListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [GlobalIpHealthCheckListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GlobalIpHealthCheckListPageResponse =
            GlobalIpHealthCheckListPageResponse(
    ...
    fun validate(): GlobalIpHealthCheckListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalIpHealthCheckListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "GlobalIpHealthCheckListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
