...
private constructor(
    ...
    private constructor(
         ...
         *
         * Unlike [averageWaitTimeSecs], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("average_wait_time_secs")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                id = data.id
                averageWaitTimeSecs = data.averageWaitTimeSecs
        ...
        override fun toString() =
            "Data{id=$id, averageWaitTimeSecs=$averageWaitTimeSecs, createdAt=$createdAt, currentSize=$currentSize, maxSize=$maxSize, name=$name, recordType=$recordType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
