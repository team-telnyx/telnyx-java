...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VerificationRequestStatus].
         *
    ...
    /** A builder for [VerificationRequestStatus]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verificationRequestStatus: VerificationRequestStatus) = apply {
            id = verificationRequestStatus.id
            additionalInformation = verificationRequestStatus.additionalInformation
            businessAddr1 = verificationRequestStatus.businessAddr1
            businessCity = verificationRequestStatus.businessCity
            businessContactEmail = verificationRequestStatus.businessContactEmail
            businessContactFirstName = verificationRequestStatus.businessContactFirstName
            businessContactLastName = verificationRequestStatus.businessContactLastName
            businessContactPhone = verificationRequestStatus.businessContactPhone
            businessName = verificationRequestStatus.businessName
            businessState = verificationRequestStatus.businessState
            businessZip = verificationRequestStatus.businessZip
            corporateWebsite = verificationRequestStatus.corporateWebsite
            messageVolume = verificationRequestStatus.messageVolume
            optInWorkflow = verificationRequestStatus.optInWorkflow
            optInWorkflowImageUrls =
                verificationRequestStatus.optInWorkflowImageUrls.map { it.toMutableList() }
            phoneNumbers = verificationRequestStatus.phoneNumbers.map { it.toMutableList() }
            productionMessageContent = verificationRequestStatus.productionMessageContent
            useCase = verificationRequestStatus.useCase
            useCaseSummary = verificationRequestStatus.useCaseSummary
            verificationStatus = verificationRequestStatus.verificationStatus
            ageGatedContent = verificationRequestStatus.ageGatedContent
            businessAddr2 = verificationRequestStatus.businessAddr2
            ...
            helpMessageResponse = verificationRequestStatus.helpMessageResponse
            isvReseller = verificationRequestStatus.isvReseller
            optInConfirmationResponse = verificationRequestStatus.optInConfirmationResponse
            optInKeywords = verificationRequestStatus.optInKeywords
            privacyPolicyUrl = verificationRequestStatus.privacyPolicyUrl
            reason = verificationRequestStatus.reason
            termsAndConditionUrl = verificationRequestStatus.termsAndConditionUrl
            updatedAt = verificationRequestStatus.updatedAt
            webhookUrl = verificationRequestStatus.webhookUrl
            additionalProperties = verificationRequestStatus.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VerificationRequestStatus].
         *
         ...
         */
        fun build(): VerificationRequestStatus =
    ...
    fun validate(): VerificationRequestStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerificationRequestStatus &&
            id == other.id &&
