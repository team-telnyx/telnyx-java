...
private constructor(
    private val data: JsonField<CallDtmfReceived>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CallDtmfReceived> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallDtmfReceived> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CallDtmfReceived> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallDtmfReceived> = JsonMissing.of()
        ...
        fun data(data: CallDtmfReceived) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CallDtmfReceived] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CallDtmfReceived>) = apply { this.data = data }
