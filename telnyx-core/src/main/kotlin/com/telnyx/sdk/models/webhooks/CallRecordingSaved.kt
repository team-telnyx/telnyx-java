...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallRecordingSaved]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallRecordingSaved]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callRecordingSaved: CallRecordingSaved) = apply {
            id = callRecordingSaved.id
            eventType = callRecordingSaved.eventType
            occurredAt = callRecordingSaved.occurredAt
            payload = callRecordingSaved.payload
            recordType = callRecordingSaved.recordType
            additionalProperties = callRecordingSaved.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallRecordingSaved].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallRecordingSaved =
            CallRecordingSaved(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallRecordingSaved = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallRecordingSaved &&
            id == other.id &&
    ...
    override fun toString() =
        "CallRecordingSaved{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
