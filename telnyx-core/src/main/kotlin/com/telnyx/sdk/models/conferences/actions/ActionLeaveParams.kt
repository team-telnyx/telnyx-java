...
private constructor(
    ...
    private constructor(
        ...
        ) : this(callControlId, beepEnabled, commandId, region, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(callControlId, beepEnabled, commandId, region, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{callControlId=$callControlId, beepEnabled=$beepEnabled, commandId=$commandId, region=$region, additionalProperties=$additionalProperties}"
    }
