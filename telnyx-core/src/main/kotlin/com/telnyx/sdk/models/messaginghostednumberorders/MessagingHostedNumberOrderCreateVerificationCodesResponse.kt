...
private constructor(
    ...
    private constructor(
        ...
        ) : this(phoneNumber, error, type, verificationCodeId, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun verificationCodeId(): Optional<String> =
            verificationCodeId.getOptional("verification_code_id")
        ...
        class Builder internal constructor() {
            ...
            private var verificationCodeId: JsonField<String> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
             ...
             *
             * You should usually call [Builder.verificationCodeId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(phoneNumber, error, type, verificationCodeId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{phoneNumber=$phoneNumber, error=$error, type=$type, verificationCodeId=$verificationCodeId, additionalProperties=$additionalProperties}"
    }
