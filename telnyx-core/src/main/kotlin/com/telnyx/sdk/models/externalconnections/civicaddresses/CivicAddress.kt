...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun countryOrDistrict(): Optional<String> = countryOrDistrict.getOptional("country_or_district")
     ...
     *   server responded with an unexpected value).
     */
    fun defaultLocationId(): Optional<String> = defaultLocationId.getOptional("default_location_id")
     ...
     *   server responded with an unexpected value).
     */
    fun houseNumberSuffix(): Optional<String> = houseNumberSuffix.getOptional("house_number_suffix")
     ...
     */
    @JsonProperty("city_or_town") @ExcludeMissing fun _cityOrTown(): JsonField<String> = cityOrTown

    /**
     * Returns the raw JSON value of [cityOrTownAlias].
     *
     * Unlike [cityOrTownAlias], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("city_or_town_alias")
    @ExcludeMissing
     ...
     *
     * Unlike [postalOrZipCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("postal_or_zip_code")
    @ExcludeMissing
     ...
     *
     * Unlike [stateOrProvince], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("state_or_province")
    @ExcludeMissing
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CivicAddress]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CivicAddress]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(civicAddress: CivicAddress) = apply {
            id = civicAddress.id
            cityOrTown = civicAddress.cityOrTown
            cityOrTownAlias = civicAddress.cityOrTownAlias
            companyName = civicAddress.companyName
            country = civicAddress.country
            countryOrDistrict = civicAddress.countryOrDistrict
            defaultLocationId = civicAddress.defaultLocationId
            description = civicAddress.description
            houseNumber = civicAddress.houseNumber
            houseNumberSuffix = civicAddress.houseNumberSuffix
            locations = civicAddress.locations.map { it.toMutableList() }
            postalOrZipCode = civicAddress.postalOrZipCode
            recordType = civicAddress.recordType
            stateOrProvince = civicAddress.stateOrProvince
            streetName = civicAddress.streetName
            streetSuffix = civicAddress.streetSuffix
            additionalProperties = civicAddress.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.cityOrTown] with a well-typed [String] value instead.
        ...
        /**
         * Returns an immutable instance of [CivicAddress].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CivicAddress =
            CivicAddress(
                id,
                cityOrTown,
                cityOrTownAlias,
    ...
    fun validate(): CivicAddress = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CivicAddress{id=$id, cityOrTown=$cityOrTown, cityOrTownAlias=$cityOrTownAlias, companyName=$companyName, country=$country, countryOrDistrict=$countryOrDistrict, defaultLocationId=$defaultLocationId, description=$description, houseNumber=$houseNumber, houseNumberSuffix=$houseNumberSuffix, locations=$locations, postalOrZipCode=$postalOrZipCode, recordType=$recordType, stateOrProvince=$stateOrProvince, streetName=$streetName, streetSuffix=$streetSuffix, additionalProperties=$additionalProperties}"
}
