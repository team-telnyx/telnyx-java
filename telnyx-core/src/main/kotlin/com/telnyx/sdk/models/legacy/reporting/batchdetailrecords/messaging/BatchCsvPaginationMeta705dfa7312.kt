...
class BatchCsvPaginationMeta705dfa7312
...
private constructor(
    ...
    /** A builder for [BatchCsvPaginationMeta705dfa7312]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchCsvPaginationMeta705dfa7312: BatchCsvPaginationMeta705dfa7312) =
            apply {
                pageNumber = batchCsvPaginationMeta705dfa7312.pageNumber
                pageSize = batchCsvPaginationMeta705dfa7312.pageSize
                totalPages = batchCsvPaginationMeta705dfa7312.totalPages
                totalResults = batchCsvPaginationMeta705dfa7312.totalResults
                additionalProperties =
                    batchCsvPaginationMeta705dfa7312.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BatchCsvPaginationMeta705dfa7312].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatchCsvPaginationMeta705dfa7312 =
            BatchCsvPaginationMeta705dfa7312(
                pageNumber,
                pageSize,
                totalPages,
     ...
     *   expected type.
     */
    fun validate(): BatchCsvPaginationMeta705dfa7312 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchCsvPaginationMeta705dfa7312 &&
    ...
    override fun toString() =
        "BatchCsvPaginationMeta705dfa7312{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
