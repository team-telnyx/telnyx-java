...
private constructor(
    private val data: JsonField<EmailBlockImport>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<EmailBlockImport> = JsonMissing.of()
     ...
     */
    fun data(): EmailBlockImport = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<EmailBlockImport> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<EmailBlockImport>? = null
         ...
         * fields use the omit-nullable pattern.
         */
        fun data(data: EmailBlockImport) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [EmailBlockImport] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<EmailBlockImport>) = apply { this.data = data }
