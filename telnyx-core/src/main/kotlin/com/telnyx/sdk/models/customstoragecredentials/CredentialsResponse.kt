...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CredentialsResponse].
         *
    ...
    /** A builder for [CredentialsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(credentialsResponse: CredentialsResponse) = apply {
            connectionId = credentialsResponse.connectionId
            data = credentialsResponse.data
            recordType = credentialsResponse.recordType
            additionalProperties = credentialsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CredentialsResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): CredentialsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CredentialsResponse &&
    ...
    override fun toString() =
        "CredentialsResponse{connectionId=$connectionId, data=$data, recordType=$recordType, additionalProperties=$additionalProperties}"
}
