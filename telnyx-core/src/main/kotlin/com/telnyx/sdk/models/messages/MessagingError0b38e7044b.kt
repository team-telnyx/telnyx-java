...
class MessagingError0b38e7044b
...
private constructor(
     ...
     * ```java
     * MyClass myObject = messagingError0b38e7044b.meta().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessagingError0b38e7044b].
         *
    ...
    /** A builder for [MessagingError0b38e7044b]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingError0b38e7044b: MessagingError0b38e7044b) = apply {
            code = messagingError0b38e7044b.code
            title = messagingError0b38e7044b.title
            detail = messagingError0b38e7044b.detail
            meta = messagingError0b38e7044b.meta
            source = messagingError0b38e7044b.source
            additionalProperties = messagingError0b38e7044b.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingError0b38e7044b].
         *
         ...
         */
        fun build(): MessagingError0b38e7044b =
     ...
     *   expected type.
     */
    fun validate(): MessagingError0b38e7044b = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingError0b38e7044b &&
            code == other.code &&
            title == other.title &&
            detail == other.detail &&
            meta == other.meta &&
    ...
    override fun toString() =
        "MessagingError0b38e7044b{code=$code, title=$title, detail=$detail, meta=$meta, source=$source, additionalProperties=$additionalProperties}"
}
