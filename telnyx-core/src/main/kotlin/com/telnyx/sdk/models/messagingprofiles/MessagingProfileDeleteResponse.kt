...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingProfileDeleteResponse: MessagingProfileDeleteResponse) = apply {
            data = messagingProfileDeleteResponse.data
        ...
        /**
         * Returns an immutable instance of [MessagingProfileDeleteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingProfileDeleteResponse =
            MessagingProfileDeleteResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): MessagingProfileDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingProfileDeleteResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MessagingProfileDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
