...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ToolListResponse].
         *
    ...
    /** A builder for [ToolListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(toolListResponse: ToolListResponse) = apply {
            id = toolListResponse.id
            toolDefinition = toolListResponse.toolDefinition
            type = toolListResponse.type
            createdAt = toolListResponse.createdAt
            displayName = toolListResponse.displayName
            timeoutMs = toolListResponse.timeoutMs
            additionalProperties = toolListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ToolListResponse].
         *
    ...
    fun validate(): ToolListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ToolListResponse{id=$id, toolDefinition=$toolDefinition, type=$type, createdAt=$createdAt, displayName=$displayName, timeoutMs=$timeoutMs, additionalProperties=$additionalProperties}"
}
