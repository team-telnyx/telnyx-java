...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookListParams: WebhookListParams) = apply {
            domainId = webhookListParams.domainId
            pageNumber = webhookListParams.pageNumber
            pageSize = webhookListParams.pageSize
            sort = webhookListParams.sort
    ...
    override fun hashCode(): Int =
        Objects.hash(domainId, pageNumber, pageSize, sort, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "WebhookListParams{domainId=$domainId, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
