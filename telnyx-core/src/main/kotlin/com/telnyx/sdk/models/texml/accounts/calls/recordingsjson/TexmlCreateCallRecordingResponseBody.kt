...
class TexmlCreateCallRecordingResponseBody
...
private constructor(
    ...
    /** A builder for [TexmlCreateCallRecordingResponseBody]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            accountSid = texmlCreateCallRecordingResponseBody.accountSid
            callSid = texmlCreateCallRecordingResponseBody.callSid
            channels = texmlCreateCallRecordingResponseBody.channels
            conferenceSid = texmlCreateCallRecordingResponseBody.conferenceSid
            dateCreated = texmlCreateCallRecordingResponseBody.dateCreated
            dateUpdated = texmlCreateCallRecordingResponseBody.dateUpdated
            duration = texmlCreateCallRecordingResponseBody.duration
            errorCode = texmlCreateCallRecordingResponseBody.errorCode
            price = texmlCreateCallRecordingResponseBody.price
            priceUnit = texmlCreateCallRecordingResponseBody.priceUnit
            sid = texmlCreateCallRecordingResponseBody.sid
            source = texmlCreateCallRecordingResponseBody.source
            startTime = texmlCreateCallRecordingResponseBody.startTime
            track = texmlCreateCallRecordingResponseBody.track
            uri = texmlCreateCallRecordingResponseBody.uri
            additionalProperties =
                texmlCreateCallRecordingResponseBody.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TexmlCreateCallRecordingResponseBody].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlCreateCallRecordingResponseBody =
            TexmlCreateCallRecordingResponseBody(
                accountSid,
                callSid,
                channels,
     ...
     *   expected type.
     */
    fun validate(): TexmlCreateCallRecordingResponseBody = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlCreateCallRecordingResponseBody &&
