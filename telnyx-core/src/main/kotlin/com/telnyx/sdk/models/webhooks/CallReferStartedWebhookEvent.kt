...
class CallReferStartedWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallReferStartedWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallReferStartedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callReferStartedWebhookEvent: CallReferStartedWebhookEvent) = apply {
            data = callReferStartedWebhookEvent.data
            additionalProperties = callReferStartedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallReferStartedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallReferStartedWebhookEvent =
            CallReferStartedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallReferStartedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [sipNotifyResponse], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("sip_notify_response")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.sipNotifyResponse] with a well-typed [Long]
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReferStartedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallReferStartedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
