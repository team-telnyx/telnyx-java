...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WhatsappAccountUpdate].
         *
    ...
    /** A builder for [WhatsappAccountUpdate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(whatsappAccountUpdate: WhatsappAccountUpdate) = apply {
            data = whatsappAccountUpdate.data
            additionalProperties = whatsappAccountUpdate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WhatsappAccountUpdate].
         *
         ...
         */
        fun build(): WhatsappAccountUpdate =
            WhatsappAccountUpdate(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): WhatsappAccountUpdate = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val WHATSAPP_ACCOUNT_UPDATE = of("whatsapp.account.update")
            ...
            fun value(): Value =
                when (this) {
                    WHATSAPP_ACCOUNT_UPDATE -> Value.WHATSAPP_ACCOUNT_UPDATE
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    WHATSAPP_ACCOUNT_UPDATE -> Known.WHATSAPP_ACCOUNT_UPDATE
        ...
        private constructor(
            ...
            ) : this(event, recordType, wabaId, mutableMapOf())

            /**
             * Account event reported by Meta. Coexistence lifecycle values include
             * `ACCOUNT_OFFBOARDED`, `ACCOUNT_RECONNECTED`, and `PARTNER_REMOVED`. Preserve unknown
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val WHATSAPP_ACCOUNT = of("whatsapp_account")
                ...
                fun value(): Value =
                    when (this) {
                        WHATSAPP_ACCOUNT -> Value.WHATSAPP_ACCOUNT
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        WHATSAPP_ACCOUNT -> Known.WHATSAPP_ACCOUNT
            ...
            private val hashCode: Int by lazy {
                Objects.hash(event, recordType, wabaId, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "Payload{event=$event, recordType=$recordType, wabaId=$wabaId, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappAccountUpdate &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "WhatsappAccountUpdate{data=$data, additionalProperties=$additionalProperties}"
}
