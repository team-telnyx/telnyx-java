...
private constructor(
     ...
     */
    @JsonProperty("enqueued_at") @ExcludeMissing fun _enqueuedAt(): JsonField<String> = enqueuedAt
     ...
     *
     * Unlike [queuePosition], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("queue_position")
    @ExcludeMissing
     ...
     *
     * Unlike [waitTimeSecs], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("wait_time_secs")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [QueueCall].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(queueCall: QueueCall) = apply {
            callControlId = queueCall.callControlId
            callLegId = queueCall.callLegId
            callSessionId = queueCall.callSessionId
            connectionId = queueCall.connectionId
            enqueuedAt = queueCall.enqueuedAt
            from = queueCall.from
            queueId = queueCall.queueId
            queuePosition = queueCall.queuePosition
            recordType = queueCall.recordType
            to = queueCall.to
            waitTimeSecs = queueCall.waitTimeSecs
            isAlive = queueCall.isAlive
            additionalProperties = queueCall.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.enqueuedAt] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.queuePosition] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.waitTimeSecs] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [QueueCall].
         *
    ...
    override fun toString() =
        "QueueCall{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, connectionId=$connectionId, enqueuedAt=$enqueuedAt, from=$from, queueId=$queueId, queuePosition=$queuePosition, recordType=$recordType, to=$to, waitTimeSecs=$waitTimeSecs, isAlive=$isAlive, additionalProperties=$additionalProperties}"
}
