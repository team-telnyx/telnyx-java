...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlanStepData].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planStepData: PlanStepData) = apply {
            description = planStepData.description
            runId = planStepData.runId
            sequence = planStepData.sequence
            status = planStepData.status
            stepId = planStepData.stepId
            completedAt = planStepData.completedAt
            metadata = planStepData.metadata
            parentStepId = planStepData.parentStepId
            startedAt = planStepData.startedAt
            additionalProperties = planStepData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlanStepData].
         *
    ...
    fun validate(): PlanStepData = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PlanStepData{description=$description, runId=$runId, sequence=$sequence, status=$status, stepId=$stepId, completedAt=$completedAt, metadata=$metadata, parentStepId=$parentStepId, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
