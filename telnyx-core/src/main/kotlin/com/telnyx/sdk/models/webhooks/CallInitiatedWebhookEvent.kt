...
private constructor(
    private val data: JsonField<CallInitiated>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CallInitiated> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallInitiated> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CallInitiated> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallInitiated> = JsonMissing.of()
        ...
        fun data(data: CallInitiated) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CallInitiated] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<CallInitiated>) = apply { this.data = data }
