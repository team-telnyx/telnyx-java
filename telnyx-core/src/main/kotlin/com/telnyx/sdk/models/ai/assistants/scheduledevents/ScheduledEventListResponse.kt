...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = scheduledEventListResponse.accept(new ScheduledEventListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitPhoneCallEvent(ScheduledPhoneCallEventResponse phoneCallEvent) {
     *         return Optional.of(phoneCallEvent.toString());
     *     }
     *
     *     // ...
     *
