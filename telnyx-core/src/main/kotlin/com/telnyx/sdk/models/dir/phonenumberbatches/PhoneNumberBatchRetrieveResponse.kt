...
class PhoneNumberBatchRetrieveResponse
...
private constructor(
    ...
    /**
     * A phone-number batch groups all numbers added in a single bulk-add request. Telnyx vets the
     * batch as a unit. The response embeds the full `phone_numbers` array so you can read
     * per-number status without a separate call, plus a batch-level `status` summarising the unit's
     * progress.
     *
    ...
    /** A builder for [PhoneNumberBatchRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberBatchRetrieveResponse: PhoneNumberBatchRetrieveResponse) =
            apply {
                data = phoneNumberBatchRetrieveResponse.data
                additionalProperties =
                    phoneNumberBatchRetrieveResponse.additionalProperties.toMutableMap()
            }

        /**
         * A phone-number batch groups all numbers added in a single bulk-add request. Telnyx vets
         * the batch as a unit. The response embeds the full `phone_numbers` array so you can read
         * per-number status without a separate call, plus a batch-level `status` summarising the
         * unit's progress.
         */
        ...
        /**
         * Returns an immutable instance of [PhoneNumberBatchRetrieveResponse].
         *
         ...
         */
        fun build(): PhoneNumberBatchRetrieveResponse =
            PhoneNumberBatchRetrieveResponse(
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberBatchRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [dirDisplayName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("dir_display_name")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                dirDisplayName = data.dirDisplayName
                dirId = data.dirId
            ...
            /** The DIR's display name at the time the batch was read. */
            fun dirDisplayName(dirDisplayName: String) =
                dirDisplayName(JsonField.of(dirDisplayName))
            ...
            /**
             * Documents attached to this batch (e.g. a Letter of Authorization). Empty when none
             * were supplied at add time.
             */
        ...
        private constructor(
             ...
             *
             * Unlike [verifiedAt], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("verified_at")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.rejectionReason] with a well-typed
                 * [RejectionReason] value instead. This method is primarily for setting the field
                 ...
                 *
                 * You should usually call [Builder.verifiedAt] with a well-typed [OffsetDateTime]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
        ...
        override fun toString() =
            "Data{batchId=$batchId, dirDisplayName=$dirDisplayName, dirId=$dirId, documents=$documents, enterpriseId=$enterpriseId, phoneNumbers=$phoneNumbers, status=$status, submittedAt=$submittedAt, totalCount=$totalCount, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberBatchRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PhoneNumberBatchRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
