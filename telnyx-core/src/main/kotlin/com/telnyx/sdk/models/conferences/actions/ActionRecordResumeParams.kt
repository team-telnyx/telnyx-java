...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionRecordResumeParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ActionRecordResumeParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionRecordResumeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionRecordResumeParams: ActionRecordResumeParams) = apply {
            id = actionRecordResumeParams.id
            body = actionRecordResumeParams.body.toBuilder()
            additionalHeaders = actionRecordResumeParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionRecordResumeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRecordResumeParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionRecordResumeParams =
    ...
    private constructor(
        ...
        ) : this(commandId, recordingId, region, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(commandId, recordingId, region, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(commandId, recordingId, region, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{commandId=$commandId, recordingId=$recordingId, region=$region, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRecordResumeParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ActionRecordResumeParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
