...
class ExternalVettingExternalVettingResponse
...
private constructor(
    ...
    /** A builder for [ExternalVettingExternalVettingResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            externalVettingExternalVettingResponse: ExternalVettingExternalVettingResponse
        ) = apply {
            createDate = externalVettingExternalVettingResponse.createDate
            evpId = externalVettingExternalVettingResponse.evpId
            vettedDate = externalVettingExternalVettingResponse.vettedDate
            vettingClass = externalVettingExternalVettingResponse.vettingClass
            vettingId = externalVettingExternalVettingResponse.vettingId
            vettingScore = externalVettingExternalVettingResponse.vettingScore
            vettingToken = externalVettingExternalVettingResponse.vettingToken
            additionalProperties =
                externalVettingExternalVettingResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingExternalVettingResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVettingExternalVettingResponse =
            ExternalVettingExternalVettingResponse(
                createDate,
                evpId,
                vettedDate,
    ...
    fun validate(): ExternalVettingExternalVettingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingExternalVettingResponse &&
    ...
    override fun toString() =
        "ExternalVettingExternalVettingResponse{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
