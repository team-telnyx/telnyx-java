 ...
 */
class DirUpdateInfringementUpdateParams
private constructor(
    ...
    /** A builder for [DirUpdateInfringementUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirUpdateInfringementUpdateParams: DirUpdateInfringementUpdateParams) =
            apply {
                dirId = dirUpdateInfringementUpdateParams.dirId
                body = dirUpdateInfringementUpdateParams.body.toBuilder()
                additionalHeaders = dirUpdateInfringementUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    dirUpdateInfringementUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DirUpdateInfringementUpdateParams].
         *
         ...
         */
        fun build(): DirUpdateInfringementUpdateParams =
            DirUpdateInfringementUpdateParams(
                dirId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirUpdateInfringementUpdateParams &&
            dirId == other.dirId &&
            body == other.body &&
    ...
    override fun toString() =
        "DirUpdateInfringementUpdateParams{dirId=$dirId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
