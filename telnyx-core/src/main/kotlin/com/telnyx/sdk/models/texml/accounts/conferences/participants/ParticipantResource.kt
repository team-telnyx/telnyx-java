...
private constructor(
     ...
     *
     * Unlike [callSidLegacy], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("call_sid_legacy")
    @ExcludeMissing
     ...
     *
     * Unlike [coachingCallSidLegacy], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("coaching_call_sid_legacy")
    @ExcludeMissing
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ParticipantResource]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ParticipantResource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantResource: ParticipantResource) = apply {
            accountSid = participantResource.accountSid
            apiVersion = participantResource.apiVersion
            callSid = participantResource.callSid
            callSidLegacy = participantResource.callSidLegacy
            coaching = participantResource.coaching
            coachingCallSid = participantResource.coachingCallSid
            coachingCallSidLegacy = participantResource.coachingCallSidLegacy
            conferenceSid = participantResource.conferenceSid
            dateCreated = participantResource.dateCreated
            dateUpdated = participantResource.dateUpdated
            endConferenceOnExit = participantResource.endConferenceOnExit
            hold = participantResource.hold
            muted = participantResource.muted
            status = participantResource.status
            uri = participantResource.uri
            additionalProperties = participantResource.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.callSidLegacy] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.coachingCallSidLegacy] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [ParticipantResource].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ParticipantResource =
            ParticipantResource(
                accountSid,
                apiVersion,
                callSid,
     ...
     *   expected type.
     */
    fun validate(): ParticipantResource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantResource &&
