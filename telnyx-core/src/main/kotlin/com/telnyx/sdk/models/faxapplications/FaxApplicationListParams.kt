...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(faxApplicationListParams: FaxApplicationListParams) = apply {
            ...
            pageNumber = faxApplicationListParams.pageNumber
            pageSize = faxApplicationListParams.pageSize
    ...
    override fun toString() =
        "FaxApplicationListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
