...
/**
 * Updates one or more fields on an agent while its status is `CREATED`. Submitted agents cannot be
...
private constructor(
     ...
     */
    fun configuration(): Optional<AgentConfiguration> = body.configuration()
     ...
     *   server responded with an unexpected value).
     */
    fun useCase(): Optional<AgentUseCase> = body.useCase()
    ...
    private constructor(
        ...
        ) : this(configuration, displayName, hostingRegion, profileId, useCase, mutableMapOf())

        /**
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun configuration(): Optional<AgentConfiguration> =
         ...
         *   server responded with an unexpected value).
         */
        fun useCase(): Optional<AgentUseCase> = useCase.getOptional("use_case")
        ...
        class Builder internal constructor() {
            ...
            private var configuration: JsonField<AgentConfiguration> = JsonMissing.of()
            ...
            private var useCase: JsonField<AgentUseCase> = JsonMissing.of()
            ...
            fun hostingRegion(hostingRegion: String) = hostingRegion(JsonField.of(hostingRegion))
        ...
        override fun toString() =
            "Body{configuration=$configuration, displayName=$displayName, hostingRegion=$hostingRegion, profileId=$profileId, useCase=$useCase, additionalProperties=$additionalProperties}"
    }
