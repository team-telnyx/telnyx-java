...
class NumbersFeatureCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumbersFeatureCreateParams].
         *
    ...
    /** A builder for [NumbersFeatureCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numbersFeatureCreateParams: NumbersFeatureCreateParams) = apply {
            body = numbersFeatureCreateParams.body.toBuilder()
            additionalHeaders = numbersFeatureCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = numbersFeatureCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NumbersFeatureCreateParams].
         *
         ...
         */
        fun build(): NumbersFeatureCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumbersFeatureCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "NumbersFeatureCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
