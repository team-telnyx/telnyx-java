...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignListParams: CampaignListParams) = apply {
            ...
            recordsPerPage = campaignListParams.recordsPerPage
    ...
    class Sort @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CAMPAIGN_ID = of("campaignId")

            @JvmField val CAMPAIGN_ID_DESC = of("-campaignId")
        ...
        fun value(): Value =
            when (this) {
                ...
                CAMPAIGN_ID_DESC -> Value.CAMPAIGN_ID_DESC
        ...
        fun known(): Known =
            when (this) {
                ...
                CAMPAIGN_ID_DESC -> Known.CAMPAIGN_ID_DESC
    ...
    override fun hashCode(): Int =
        Objects.hash(brandId, page, recordsPerPage, sort, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CampaignListParams{brandId=$brandId, page=$page, recordsPerPage=$recordsPerPage, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
