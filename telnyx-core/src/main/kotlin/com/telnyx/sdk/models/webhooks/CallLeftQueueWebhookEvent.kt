...
class CallLeftQueueWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallLeftQueueWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallLeftQueueWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callLeftQueueWebhookEvent: CallLeftQueueWebhookEvent) = apply {
            data = callLeftQueueWebhookEvent.data
            additionalProperties = callLeftQueueWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallLeftQueueWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallLeftQueueWebhookEvent =
            CallLeftQueueWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallLeftQueueWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_DEQUEUED = of("call.dequeued")
            ...
            fun value(): Value =
                when (this) {
                    CALL_DEQUEUED -> Value.CALL_DEQUEUED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_DEQUEUED -> Known.CALL_DEQUEUED
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun queuePosition(): Optional<Long> = queuePosition.getOptional("queue_position")
             ...
             *   the server responded with an unexpected value).
             */
            fun waitTimeSecs(): Optional<Long> = waitTimeSecs.getOptional("wait_time_secs")
            ...
            class Builder internal constructor() {
                ...
                private var queuePosition: JsonField<Long> = JsonMissing.of()
                private var reason: JsonField<Reason> = JsonMissing.of()
                private var waitTimeSecs: JsonField<Long> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                internal fun from(payload: Payload) = apply {
                    ...
                    waitTimeSecs = payload.waitTimeSecs
            ...
            class Reason @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    @JvmField val BRIDGED = of("bridged")

                    @JvmField val BRIDGING_IN_PROCESS = of("bridging-in-process")
                ...
                fun value(): Value =
                    when (this) {
                        BRIDGED -> Value.BRIDGED
                        BRIDGING_IN_PROCESS -> Value.BRIDGING_IN_PROCESS
                        HANGUP -> Value.HANGUP
                        LEAVE -> Value.LEAVE
                ...
                fun known(): Known =
                    when (this) {
                        BRIDGED -> Known.BRIDGED
                        BRIDGING_IN_PROCESS -> Known.BRIDGING_IN_PROCESS
                        HANGUP -> Known.HANGUP
                        LEAVE -> Known.LEAVE
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, queue=$queue, queuePosition=$queuePosition, reason=$reason, waitTimeSecs=$waitTimeSecs, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallLeftQueueWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallLeftQueueWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
