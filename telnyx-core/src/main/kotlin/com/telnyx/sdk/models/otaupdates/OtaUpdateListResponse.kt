...
private constructor(
    ...
    ) : this(id, createdAt, recordType, simCardId, status, type, updatedAt, mutableMapOf())
    ...
    /**
     * Represents the type of the operation requested. This will relate directly to the source of
     * the request.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OtaUpdateListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OtaUpdateListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(otaUpdateListResponse: OtaUpdateListResponse) = apply {
            id = otaUpdateListResponse.id
            createdAt = otaUpdateListResponse.createdAt
            recordType = otaUpdateListResponse.recordType
            simCardId = otaUpdateListResponse.simCardId
            status = otaUpdateListResponse.status
            type = otaUpdateListResponse.type
            updatedAt = otaUpdateListResponse.updatedAt
            additionalProperties = otaUpdateListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OtaUpdateListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OtaUpdateListResponse =
    ...
    fun validate(): OtaUpdateListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OtaUpdateListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "OtaUpdateListResponse{id=$id, createdAt=$createdAt, recordType=$recordType, simCardId=$simCardId, status=$status, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
