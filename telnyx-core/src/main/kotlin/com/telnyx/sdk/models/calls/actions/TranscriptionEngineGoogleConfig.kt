...
class TranscriptionEngineGoogleConfig
...
private constructor(
    ...
    /** A builder for [TranscriptionEngineGoogleConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transcriptionEngineGoogleConfig: TranscriptionEngineGoogleConfig) =
            apply {
                enableSpeakerDiarization = transcriptionEngineGoogleConfig.enableSpeakerDiarization
                hints = transcriptionEngineGoogleConfig.hints.map { it.toMutableList() }
                interimResults = transcriptionEngineGoogleConfig.interimResults
                language = transcriptionEngineGoogleConfig.language
                maxSpeakerCount = transcriptionEngineGoogleConfig.maxSpeakerCount
                minSpeakerCount = transcriptionEngineGoogleConfig.minSpeakerCount
                model = transcriptionEngineGoogleConfig.model
                profanityFilter = transcriptionEngineGoogleConfig.profanityFilter
                speechContext =
                    transcriptionEngineGoogleConfig.speechContext.map { it.toMutableList() }
                transcriptionEngine = transcriptionEngineGoogleConfig.transcriptionEngine
                useEnhanced = transcriptionEngineGoogleConfig.useEnhanced
                additionalProperties =
                    transcriptionEngineGoogleConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TranscriptionEngineGoogleConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TranscriptionEngineGoogleConfig =
            TranscriptionEngineGoogleConfig(
                enableSpeakerDiarization,
    ...
    fun validate(): TranscriptionEngineGoogleConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranscriptionEngineGoogleConfig &&
