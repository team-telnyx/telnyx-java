...
class EmailMessageRetrieveEventsPageResponse
...
private constructor(
    ...
    /** A builder for [EmailMessageRetrieveEventsPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = emailMessageRetrieveEventsPageResponse.data.map { it.toMutableList() }
            meta = emailMessageRetrieveEventsPageResponse.meta
            additionalProperties =
                emailMessageRetrieveEventsPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailMessageRetrieveEventsPageResponse].
         *
         ...
         */
        fun build(): EmailMessageRetrieveEventsPageResponse =
            EmailMessageRetrieveEventsPageResponse(
     ...
     *   expected type.
     */
    fun validate(): EmailMessageRetrieveEventsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailMessageRetrieveEventsPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "EmailMessageRetrieveEventsPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
