...
private constructor(
    ...
    ) : this(id, body, createdAt, userId, portoutId, recordType, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortoutComment].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portoutComment: PortoutComment) = apply {
            id = portoutComment.id
            body = portoutComment.body
            createdAt = portoutComment.createdAt
            userId = portoutComment.userId
            portoutId = portoutComment.portoutId
            recordType = portoutComment.recordType
            additionalProperties = portoutComment.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortoutComment].
         *
    ...
    fun validate(): PortoutComment = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortoutComment &&
            id == other.id &&
            body == other.body &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, body, createdAt, userId, portoutId, recordType, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PortoutComment{id=$id, body=$body, createdAt=$createdAt, userId=$userId, portoutId=$portoutId, recordType=$recordType, additionalProperties=$additionalProperties}"
}
