...
private constructor(
     ...
     * be changed, but there may be time lag between when the value is changed and pricing changes
     * take effect.
     *
    ...
    companion object {
        ...
        @JvmStatic fun none(): ManagedAccountUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ManagedAccountUpdateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ManagedAccountUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(managedAccountUpdateParams: ManagedAccountUpdateParams) = apply {
            id = managedAccountUpdateParams.id
            body = managedAccountUpdateParams.body.toBuilder()
            additionalHeaders = managedAccountUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = managedAccountUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ManagedAccountUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ManagedAccountUpdateParams =
    ...
    private constructor(
        ...
        ) : this(managedAccountAllowCustomPricing, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(managedAccountAllowCustomPricing, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(managedAccountAllowCustomPricing, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{managedAccountAllowCustomPricing=$managedAccountAllowCustomPricing, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ManagedAccountUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ManagedAccountUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
