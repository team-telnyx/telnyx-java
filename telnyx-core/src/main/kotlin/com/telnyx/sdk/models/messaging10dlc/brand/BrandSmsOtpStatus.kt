...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandSmsOtpStatus].
         *
    ...
    /** A builder for [BrandSmsOtpStatus]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandSmsOtpStatus: BrandSmsOtpStatus) = apply {
            brandId = brandSmsOtpStatus.brandId
            deliveryStatus = brandSmsOtpStatus.deliveryStatus
            mobilePhone = brandSmsOtpStatus.mobilePhone
            referenceId = brandSmsOtpStatus.referenceId
            requestDate = brandSmsOtpStatus.requestDate
            deliveryStatusDate = brandSmsOtpStatus.deliveryStatusDate
            deliveryStatusDetails = brandSmsOtpStatus.deliveryStatusDetails
            verifyDate = brandSmsOtpStatus.verifyDate
            additionalProperties = brandSmsOtpStatus.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandSmsOtpStatus].
         *
     ...
     *   expected type.
     */
    fun validate(): BrandSmsOtpStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandSmsOtpStatus &&
    ...
    override fun toString() =
        "BrandSmsOtpStatus{brandId=$brandId, deliveryStatus=$deliveryStatus, mobilePhone=$mobilePhone, referenceId=$referenceId, requestDate=$requestDate, deliveryStatusDate=$deliveryStatusDate, deliveryStatusDetails=$deliveryStatusDetails, verifyDate=$verifyDate, additionalProperties=$additionalProperties}"
}
