...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(roomRecordingListResponse: RoomRecordingListResponse) = apply {
            id = roomRecordingListResponse.id
            codec = roomRecordingListResponse.codec
            completedAt = roomRecordingListResponse.completedAt
            createdAt = roomRecordingListResponse.createdAt
            downloadUrl = roomRecordingListResponse.downloadUrl
            durationSecs = roomRecordingListResponse.durationSecs
            endedAt = roomRecordingListResponse.endedAt
            participantId = roomRecordingListResponse.participantId
            recordType = roomRecordingListResponse.recordType
            roomId = roomRecordingListResponse.roomId
            sessionId = roomRecordingListResponse.sessionId
            sizeMb = roomRecordingListResponse.sizeMb
            startedAt = roomRecordingListResponse.startedAt
            status = roomRecordingListResponse.status
            type = roomRecordingListResponse.type
            updatedAt = roomRecordingListResponse.updatedAt
