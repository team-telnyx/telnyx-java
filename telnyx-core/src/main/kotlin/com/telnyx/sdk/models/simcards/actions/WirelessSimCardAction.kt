...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WirelessSimCardAction]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WirelessSimCardAction]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(wirelessSimCardAction: WirelessSimCardAction) = apply {
            id = wirelessSimCardAction.id
            actionType = wirelessSimCardAction.actionType
            createdAt = wirelessSimCardAction.createdAt
            recordType = wirelessSimCardAction.recordType
            settings = wirelessSimCardAction.settings
            simCardId = wirelessSimCardAction.simCardId
            status = wirelessSimCardAction.status
            updatedAt = wirelessSimCardAction.updatedAt
            additionalProperties = wirelessSimCardAction.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WirelessSimCardAction].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WirelessSimCardAction =
     ...
     *   expected type.
     */
    fun validate(): WirelessSimCardAction = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private val value: JsonField<SimCardActionStatusValue>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @JsonProperty("value")
            @ExcludeMissing
            value: JsonField<SimCardActionStatusValue> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun value(): Optional<SimCardActionStatusValue> = value.getOptional("value")
        ...
        @JsonProperty("value")
        @ExcludeMissing
        fun _value(): JsonField<SimCardActionStatusValue> = value
        ...
        class Builder internal constructor() {
            ...
            private var value: JsonField<SimCardActionStatusValue> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            /** The current status of the SIM card action. */
            fun value(value: SimCardActionStatusValue) = value(JsonField.of(value))

            /**
             * Sets [Builder.value] to an arbitrary JSON value.
             *
             * You should usually call [Builder.value] with a well-typed [SimCardActionStatusValue]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun value(value: JsonField<SimCardActionStatusValue>) = apply { this.value = value }
        ...
        /** The current status of the SIM card action. */
        class SimCardActionStatusValue
        @JsonCreator
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmStatic fun of(value: String) = SimCardActionStatusValue(JsonField.of(value))
            }

            /** An enum containing [SimCardActionStatusValue]'s known values. */
            enum class Known {
                IN_PROGRESS,
                COMPLETED,
                FAILED,
            ...
            /**
             * An enum containing [SimCardActionStatusValue]'s known values, as well as an
             * [_UNKNOWN] member.
             *
             * An instance of [SimCardActionStatusValue] can contain an unknown value in a couple of
             * cases:
            ...
            enum class Value {
                ...
                INTERRUPTED,
                /**
                 * An enum member indicating that [SimCardActionStatusValue] was instantiated with
                 * an unknown value.
                 */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    INTERRUPTED -> Known.INTERRUPTED
                        ...
                        throw TelnyxInvalidDataException("Unknown SimCardActionStatusValue: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): SimCardActionStatusValue = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is SimCardActionStatusValue && value == other.value
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WirelessSimCardAction &&
            id == other.id &&
    ...
    override fun toString() =
        "WirelessSimCardAction{id=$id, actionType=$actionType, createdAt=$createdAt, recordType=$recordType, settings=$settings, simCardId=$simCardId, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
