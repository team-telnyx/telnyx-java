 ...
 */
class PhoneNumberDeleteAllParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberDeleteAllParams].
         *
    ...
    /** A builder for [PhoneNumberDeleteAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberDeleteAllParams: PhoneNumberDeleteAllParams) = apply {
            dirId = phoneNumberDeleteAllParams.dirId
            body = phoneNumberDeleteAllParams.body.toBuilder()
            additionalHeaders = phoneNumberDeleteAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = phoneNumberDeleteAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberDeleteAllParams].
         *
         ...
         */
        fun build(): PhoneNumberDeleteAllParams =
            PhoneNumberDeleteAllParams(
                dirId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberDeleteAllParams &&
            dirId == other.dirId &&
            body == other.body &&
    ...
    override fun toString() =
        "PhoneNumberDeleteAllParams{dirId=$dirId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
