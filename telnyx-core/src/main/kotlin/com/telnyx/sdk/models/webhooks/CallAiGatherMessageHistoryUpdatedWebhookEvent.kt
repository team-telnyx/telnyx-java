...
private constructor(
    private val data: JsonField<CallAiGatherMessageHistoryUpdated>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CallAiGatherMessageHistoryUpdated> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallAiGatherMessageHistoryUpdated> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<CallAiGatherMessageHistoryUpdated> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallAiGatherMessageHistoryUpdated> = JsonMissing.of()
        ...
        fun data(data: CallAiGatherMessageHistoryUpdated) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * [CallAiGatherMessageHistoryUpdated] value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<CallAiGatherMessageHistoryUpdated>) = apply { this.data = data }
