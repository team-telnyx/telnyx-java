...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferenceEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceEnded: ConferenceEnded) = apply {
            id = conferenceEnded.id
            eventType = conferenceEnded.eventType
            payload = conferenceEnded.payload
            recordType = conferenceEnded.recordType
            additionalProperties = conferenceEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceEnded =
            ConferenceEnded(id, eventType, payload, recordType, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ConferenceEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_ENDED = of("conference.ended")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_ENDED -> Value.CONFERENCE_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_ENDED -> Known.CONFERENCE_ENDED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, conferenceId=$conferenceId, connectionId=$connectionId, occurredAt=$occurredAt, reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceEnded{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
