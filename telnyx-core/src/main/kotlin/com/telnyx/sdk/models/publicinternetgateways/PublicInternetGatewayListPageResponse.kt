...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = publicInternetGatewayListPageResponse.data.map { it.toMutableList() }
            meta = publicInternetGatewayListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [PublicInternetGatewayListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PublicInternetGatewayListPageResponse =
            PublicInternetGatewayListPageResponse(
    ...
    fun validate(): PublicInternetGatewayListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicInternetGatewayListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "PublicInternetGatewayListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
