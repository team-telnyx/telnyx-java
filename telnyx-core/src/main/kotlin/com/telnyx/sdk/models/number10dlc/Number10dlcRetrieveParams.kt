...
/** Get Enum */
class Number10dlcRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): Number10dlcRetrieveParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [Number10dlcRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [Number10dlcRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(number10dlcRetrieveParams: Number10dlcRetrieveParams) = apply {
            endpoint = number10dlcRetrieveParams.endpoint
            additionalHeaders = number10dlcRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = number10dlcRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [Number10dlcRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): Number10dlcRetrieveParams =
            Number10dlcRetrieveParams(
                endpoint,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Number10dlcRetrieveParams &&
    ...
    override fun toString() =
        "Number10dlcRetrieveParams{endpoint=$endpoint, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
