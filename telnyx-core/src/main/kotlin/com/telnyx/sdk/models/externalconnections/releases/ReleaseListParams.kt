...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(releaseListParams: ReleaseListParams) = apply {
            ...
            pageNumber = releaseListParams.pageNumber
            pageSize = releaseListParams.pageSize
    ...
    override fun toString() =
        "ReleaseListParams{id=$id, filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
