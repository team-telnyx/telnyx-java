...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionRecordPauseParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ActionRecordPauseParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionRecordPauseParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionRecordPauseParams: ActionRecordPauseParams) = apply {
            id = actionRecordPauseParams.id
            body = actionRecordPauseParams.body.toBuilder()
            additionalHeaders = actionRecordPauseParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionRecordPauseParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRecordPauseParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionRecordPauseParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRecordPauseParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ActionRecordPauseParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
