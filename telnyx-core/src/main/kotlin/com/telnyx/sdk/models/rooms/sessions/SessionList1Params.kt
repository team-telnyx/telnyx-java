...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SessionList1Params = builder().build()

        /** Returns a mutable builder for constructing an instance of [SessionList1Params]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SessionList1Params]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionList1Params: SessionList1Params) = apply {
            roomId = sessionList1Params.roomId
            filter = sessionList1Params.filter
            includeParticipants = sessionList1Params.includeParticipants
            pageNumber = sessionList1Params.pageNumber
            pageSize = sessionList1Params.pageSize
            additionalHeaders = sessionList1Params.additionalHeaders.toBuilder()
            additionalQueryParams = sessionList1Params.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SessionList1Params].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SessionList1Params =
            SessionList1Params(
                roomId,
                filter,
                includeParticipants,
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(active, dateCreatedAt, dateEndedAt, dateUpdatedAt, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{active=$active, dateCreatedAt=$dateCreatedAt, dateEndedAt=$dateEndedAt, dateUpdatedAt=$dateUpdatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionList1Params &&
            roomId == other.roomId &&
            filter == other.filter &&
    ...
    override fun toString() =
        "SessionList1Params{roomId=$roomId, filter=$filter, includeParticipants=$includeParticipants, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
