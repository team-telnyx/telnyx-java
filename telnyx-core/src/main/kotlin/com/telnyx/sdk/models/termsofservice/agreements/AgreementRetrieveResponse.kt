...
class AgreementRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgreementRetrieveResponse].
         *
    ...
    /** A builder for [AgreementRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(agreementRetrieveResponse: AgreementRetrieveResponse) = apply {
            data = agreementRetrieveResponse.data
            additionalProperties = agreementRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgreementRetrieveResponse].
         *
         ...
         */
        fun build(): AgreementRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): AgreementRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgreementRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AgreementRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
