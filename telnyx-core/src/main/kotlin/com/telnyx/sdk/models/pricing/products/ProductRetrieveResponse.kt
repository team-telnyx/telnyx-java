 ...
 * cached_input_rate, and their respective tier arrays. Rate-deck products include pricing_type and
 * note fields with null rate and empty tiers.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("input_rate") @ExcludeMissing inputRate: JsonField<String> = JsonMissing.of(),
     ...
     *
     * Unlike [cachedInputRate], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("cached_input_rate")
    @ExcludeMissing
     ...
     */
    @JsonProperty("country_iso") @ExcludeMissing fun _countryIso(): JsonField<String> = countryIso
     ...
     */
    @JsonProperty("output_rate") @ExcludeMissing fun _outputRate(): JsonField<String> = outputRate
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productRetrieveResponse: ProductRetrieveResponse) = apply {
            cachedInputRate = productRetrieveResponse.cachedInputRate
            cachedInputTiers = productRetrieveResponse.cachedInputTiers.map { it.toMutableList() }
            countryIso = productRetrieveResponse.countryIso
            currency = productRetrieveResponse.currency
            direction = productRetrieveResponse.direction
            inputRate = productRetrieveResponse.inputRate
            inputTiers = productRetrieveResponse.inputTiers.map { it.toMutableList() }
            model = productRetrieveResponse.model
            name = productRetrieveResponse.name
            note = productRetrieveResponse.note
            outputRate = productRetrieveResponse.outputRate
            outputTiers = productRetrieveResponse.outputTiers.map { it.toMutableList() }
            pricingType = productRetrieveResponse.pricingType
            rate = productRetrieveResponse.rate
            tiers = productRetrieveResponse.tiers.map { it.toMutableList() }
            type = productRetrieveResponse.type
            unit = productRetrieveResponse.unit
         ...
         *
         * You should usually call [Builder.cachedInputTiers] with a well-typed `List<PricingTier>`
         ...
         *
         * You should usually call [Builder.countryIso] with a well-typed [String] value instead.
         ...
         *
         * You should usually call [Builder.inputTiers] with a well-typed `List<PricingTier>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.outputRate] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.outputTiers] with a well-typed `List<PricingTier>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.pricingType] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun pricingType(pricingType: JsonField<String>) = apply { this.pricingType = pricingType }
