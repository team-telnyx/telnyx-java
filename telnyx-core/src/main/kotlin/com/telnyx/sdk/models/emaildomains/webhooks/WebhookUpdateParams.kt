...
/**
 * Update a webhook's URL and/or event subscription. A webhook is bound to its domain — `domain_id`
 * is not mutable.
 */
...
private constructor(
     ...
     */
    fun events(): Optional<List<EmailWebhookEvent>> = body.events()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookUpdateParams: WebhookUpdateParams) = apply {
            domainId = webhookUpdateParams.domainId
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun events(): Optional<List<EmailWebhookEvent>> = events.getOptional("events")
    ...
    override fun hashCode(): Int =
        Objects.hash(domainId, id, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "WebhookUpdateParams{domainId=$domainId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
