...
class EmbeddingListModelsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmbeddingListModelsResponse].
         *
    ...
    /** A builder for [EmbeddingListModelsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(embeddingListModelsResponse: EmbeddingListModelsResponse) = apply {
            data = embeddingListModelsResponse.data.map { it.toMutableList() }
            object_ = embeddingListModelsResponse.object_
            additionalProperties = embeddingListModelsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmbeddingListModelsResponse].
         *
         ...
         */
        fun build(): EmbeddingListModelsResponse =
    ...
    fun validate(): EmbeddingListModelsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmbeddingListModelsResponse &&
            data == other.data &&
            object_ == other.object_ &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EmbeddingListModelsResponse{data=$data, object_=$object_, additionalProperties=$additionalProperties}"
}
