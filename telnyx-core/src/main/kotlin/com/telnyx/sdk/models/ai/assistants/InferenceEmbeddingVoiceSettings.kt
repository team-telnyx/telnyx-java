...
class InferenceEmbeddingVoiceSettings
...
private constructor(
     ...
     * [available voices](https://developers.telnyx.com/docs/tts-stt/tts-available-voices) via our
     * voices API. To use ElevenLabs, you must reference your ElevenLabs API key as an integration
     ...
     * Telnyx.KokoroTTS.af_heart). For Soniox voices, use `Soniox.tts-rt-v2.<voice_id>` (e.g.
     * Soniox.tts-rt-v2.Emma); every Soniox voice speaks all supported languages. The voice portion
     * of the identifier supports
     ...
     * when using MiniMax voices.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun languageBoost(): Optional<LanguageBoost> = languageBoost.getOptional("language_boost")
     ...
     * voices and Soniox voices (0.7 to 1.3 for Soniox).
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    @JsonProperty("language_boost")
    @ExcludeMissing
    fun _languageBoost(): JsonField<LanguageBoost> = languageBoost
    ...
    /** A builder for [InferenceEmbeddingVoiceSettings]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inferenceEmbeddingVoiceSettings: InferenceEmbeddingVoiceSettings) =
            apply {
                voice = inferenceEmbeddingVoiceSettings.voice
                apiKeyRef = inferenceEmbeddingVoiceSettings.apiKeyRef
                backgroundAudio = inferenceEmbeddingVoiceSettings.backgroundAudio
                expressiveMode = inferenceEmbeddingVoiceSettings.expressiveMode
                languageBoost = inferenceEmbeddingVoiceSettings.languageBoost
                similarityBoost = inferenceEmbeddingVoiceSettings.similarityBoost
                speed = inferenceEmbeddingVoiceSettings.speed
                style = inferenceEmbeddingVoiceSettings.style
                temperature = inferenceEmbeddingVoiceSettings.temperature
                useSpeakerBoost = inferenceEmbeddingVoiceSettings.useSpeakerBoost
                voiceSpeed = inferenceEmbeddingVoiceSettings.voiceSpeed
                additionalProperties =
                    inferenceEmbeddingVoiceSettings.additionalProperties.toMutableMap()
            }

        /**
         * The voice to be used by the voice assistant. Check the full list of
         * [available voices](https://developers.telnyx.com/docs/tts-stt/tts-available-voices) via
         * our voices API. To use ElevenLabs, you must reference your ElevenLabs API key as an
         * integration secret under the `api_key_ref` field. See
         * [integration secrets documentation](https://developers.telnyx.com/api-reference/integration-secrets/create-a-secret)
         * for details. For Telnyx voices, use `Telnyx.<model_id>.<voice_id>` (e.g.
         * Telnyx.KokoroTTS.af_heart). For Soniox voices, use `Soniox.tts-rt-v2.<voice_id>` (e.g.
         * Soniox.tts-rt-v2.Emma); every Soniox voice speaks all supported languages. The voice
         * portion of the identifier supports
         * [dynamic variables](https://developers.telnyx.com/docs/inference/ai-assistants/dynamic-variables)
         ...
         */
        fun languageBoost(languageBoost: LanguageBoost?) =
            languageBoost(JsonField.ofNullable(languageBoost))

        /** Alias for calling [Builder.languageBoost] with `languageBoost.orElse(null)`. */
        fun languageBoost(languageBoost: Optional<LanguageBoost>) =
            languageBoost(languageBoost.getOrNull())

        /**
         * Sets [Builder.languageBoost] to an arbitrary JSON value.
         *
         * You should usually call [Builder.languageBoost] with a well-typed [LanguageBoost] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun languageBoost(languageBoost: JsonField<LanguageBoost>) = apply {
         ...
         * Natural voices and Soniox voices (0.7 to 1.3 for Soniox).
         */
        ...
        /**
         * Returns an immutable instance of [InferenceEmbeddingVoiceSettings].
         *
         ...
         */
        fun build(): InferenceEmbeddingVoiceSettings =
            InferenceEmbeddingVoiceSettings(
     ...
     *   expected type.
     */
    fun validate(): InferenceEmbeddingVoiceSettings = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = backgroundAudio.accept(new BackgroundAudio.Visitor<Optional<String>>() {
         *     @Override
        ...
        private constructor(
            ...
            override fun toString() =
                "UnionMember0{type=$type, value=$value, volume=$volume, additionalProperties=$additionalProperties}"
        }
     ...
     * when using MiniMax voices.
     */
    class LanguageBoost @JsonCreator private constructor(private val value: JsonField<String>) :
        Enum {
        ...
        companion object {
            ...
            @JvmField val CHINESE = of("Chinese")

            @JvmField val CHINESE_YUE = of("Chinese,Yue")
            ...
            @JvmField val JAPANESE = of("Japanese")
            ...
            @JvmField val HEBREW = of("Hebrew")

            @JvmField val MALAY = of("Malay")

            @JvmField val PERSIAN = of("Persian")
            ...
            @JvmField val FILIPINO = of("Filipino")

            @JvmField val HUNGARIAN = of("Hungarian")

            @JvmField val NORWEGIAN = of("Norwegian")

            @JvmField val SLOVENIAN = of("Slovenian")

            @JvmField val CATALAN = of("Catalan")

            @JvmField val NYNORSK = of("Nynorsk")

            @JvmField val TAMIL = of("Tamil")

            @JvmField val AFRIKAANS = of("Afrikaans")

            @JvmStatic fun of(value: String) = LanguageBoost(JsonField.of(value))
        }

        /** An enum containing [LanguageBoost]'s known values. */
        enum class Known {
            AUTO,
            CHINESE,
            CHINESE_YUE,
        ...
        /**
         * An enum containing [LanguageBoost]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [LanguageBoost] can contain an unknown value in a couple of cases:
        ...
        enum class Value {
            ...
            AFRIKAANS,
            /**
             * An enum member indicating that [LanguageBoost] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                HEBREW -> Known.HEBREW
                MALAY -> Known.MALAY
                PERSIAN -> Known.PERSIAN
                SLOVAK -> Known.SLOVAK
                SWEDISH -> Known.SWEDISH
                CROATIAN -> Known.CROATIAN
                FILIPINO -> Known.FILIPINO
                HUNGARIAN -> Known.HUNGARIAN
                NORWEGIAN -> Known.NORWEGIAN
                SLOVENIAN -> Known.SLOVENIAN
                CATALAN -> Known.CATALAN
                NYNORSK -> Known.NYNORSK
                TAMIL -> Known.TAMIL
                AFRIKAANS -> Known.AFRIKAANS
                else -> throw TelnyxInvalidDataException("Unknown LanguageBoost: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): LanguageBoost = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is LanguageBoost && value == other.value
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InferenceEmbeddingVoiceSettings &&
            voice == other.voice &&
    ...
    override fun toString() =
        "InferenceEmbeddingVoiceSettings{voice=$voice, apiKeyRef=$apiKeyRef, backgroundAudio=$backgroundAudio, expressiveMode=$expressiveMode, languageBoost=$languageBoost, similarityBoost=$similarityBoost, speed=$speed, style=$style, temperature=$temperature, useSpeakerBoost=$useSpeakerBoost, voiceSpeed=$voiceSpeed, additionalProperties=$additionalProperties}"
}
