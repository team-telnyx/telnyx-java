...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(insightCreateParams: InsightCreateParams) = apply {
            idempotencyKey = insightCreateParams.idempotencyKey
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = jsonSchema.accept(new JsonSchema.Visitor<Optional<String>>() {
         *     @Override
    ...
    override fun toString() =
        "InsightCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
