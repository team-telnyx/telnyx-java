...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("commenter") @ExcludeMissing commenter: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(comment: Comment) = apply {
            ...
            commentRecordId = comment.commentRecordId
            commentRecordType = comment.commentRecordType
         ...
         * value.
         */
        fun commentBody(commentBody: JsonField<String>) = apply { this.commentBody = commentBody }
        ...
        fun commenterType(commenterType: CommenterType) = commenterType(JsonField.of(commenterType))
    ...
    override fun toString() =
        "Comment{id=$id, commentBody=$commentBody, commentRecordId=$commentRecordId, commentRecordType=$commentRecordType, commenter=$commenter, commenterType=$commenterType, createdAt=$createdAt, readAt=$readAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
