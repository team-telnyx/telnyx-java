...
class CallConversationInsightsGenerated
...
private constructor(
    ...
    /** A builder for [CallConversationInsightsGenerated]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callConversationInsightsGenerated: CallConversationInsightsGenerated) =
            apply {
                id = callConversationInsightsGenerated.id
                eventType = callConversationInsightsGenerated.eventType
                occurredAt = callConversationInsightsGenerated.occurredAt
                payload = callConversationInsightsGenerated.payload
                recordType = callConversationInsightsGenerated.recordType
                additionalProperties =
                    callConversationInsightsGenerated.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallConversationInsightsGenerated].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallConversationInsightsGenerated =
            CallConversationInsightsGenerated(
                id,
                eventType,
                occurredAt,
     ...
     *   expected type.
     */
    fun validate(): CallConversationInsightsGenerated = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CALL_CONVERSATION_INSIGHTS_GENERATED = of("call.conversation_insights.generated")
        ...
        fun value(): Value =
            when (this) {
                CALL_CONVERSATION_INSIGHTS_GENERATED -> Value.CALL_CONVERSATION_INSIGHTS_GENERATED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_CONVERSATION_INSIGHTS_GENERATED -> Known.CALL_CONVERSATION_INSIGHTS_GENERATED
    ...
    private constructor(
         ...
         *
         * Unlike [insightGroupId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("insight_group_id")
        @ExcludeMissing
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 *     @Override
                 *     public Optional<String> visitInsightObjectResult(InsightObjectResult insightObjectResult) {
                 *         return Optional.of(insightObjectResult.toString());
                 *     }
                 *
                 *     // ...
                 *
                        ...
                        val bestMatches =
                            sequenceOf(
                                    tryDeserialize(node, jacksonTypeRef<InsightObjectResult>())
                                        ?.let { Result(insightObjectResult = it, _json = json) },
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallConversationInsightsGenerated &&
            id == other.id &&
    ...
    override fun toString() =
        "CallConversationInsightsGenerated{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
