...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallInitiated]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallInitiated]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callInitiated: CallInitiated) = apply {
            id = callInitiated.id
            eventType = callInitiated.eventType
            occurredAt = callInitiated.occurredAt
            payload = callInitiated.payload
            recordType = callInitiated.recordType
            additionalProperties = callInitiated.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallInitiated].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallInitiated =
            CallInitiated(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallInitiated = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun connectionCodecs(): Optional<String> = connectionCodecs.getOptional("connection_codecs")
         ...
         *
         * Unlike [connectionCodecs], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("connection_codecs")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.connectionCodecs] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** The list of comma-separated codecs offered by caller. */
            fun offeredCodecs(offeredCodecs: String) = offeredCodecs(JsonField.of(offeredCodecs))
             ...
             *
             * You should usually call [Builder.shakenStirAttestation] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
    ...
    override fun toString() =
        "CallInitiated{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
