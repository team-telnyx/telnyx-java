...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DefaultGateway]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DefaultGateway]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(defaultGateway: DefaultGateway) = apply {
            id = defaultGateway.id
            createdAt = defaultGateway.createdAt
            recordType = defaultGateway.recordType
            updatedAt = defaultGateway.updatedAt
            networkId = defaultGateway.networkId
            status = defaultGateway.status
            wireguardPeerId = defaultGateway.wireguardPeerId
            additionalProperties = defaultGateway.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DefaultGateway].
         *
     ...
     *   expected type.
     */
    fun validate(): DefaultGateway = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DefaultGateway &&
            id == other.id &&
    ...
    override fun toString() =
        "DefaultGateway{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, networkId=$networkId, status=$status, wireguardPeerId=$wireguardPeerId, additionalProperties=$additionalProperties}"
}
