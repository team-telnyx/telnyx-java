...
private constructor(
    private val data: JsonField<CallConversationInsightsGenerated>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CallConversationInsightsGenerated> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallConversationInsightsGenerated> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<CallConversationInsightsGenerated> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallConversationInsightsGenerated> = JsonMissing.of()
        ...
        fun data(data: CallConversationInsightsGenerated) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * [CallConversationInsightsGenerated] value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<CallConversationInsightsGenerated>) = apply { this.data = data }
