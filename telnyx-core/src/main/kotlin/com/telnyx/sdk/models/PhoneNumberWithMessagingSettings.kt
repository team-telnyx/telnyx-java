...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(phoneNumberWithMessagingSettings: PhoneNumberWithMessagingSettings) =
            apply {
                ...
                organizationId = phoneNumberWithMessagingSettings.organizationId
                phoneNumber = phoneNumberWithMessagingSettings.phoneNumber
                recordType = phoneNumberWithMessagingSettings.recordType
                tags = phoneNumberWithMessagingSettings.tags.map { it.toMutableList() }
    ...
    override fun toString() =
        "PhoneNumberWithMessagingSettings{id=$id, countryCode=$countryCode, createdAt=$createdAt, eligibleMessagingProducts=$eligibleMessagingProducts, features=$features, health=$health, messagingProduct=$messagingProduct, messagingProfileId=$messagingProfileId, organizationId=$organizationId, phoneNumber=$phoneNumber, recordType=$recordType, tags=$tags, trafficType=$trafficType, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
