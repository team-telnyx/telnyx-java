...
/**
 * Removes one or more labels from a thread. Idempotent — removing a label the thread does not carry
 * is a no-op and still returns 200.
 */
class LabelDeleteAllParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LabelDeleteAllParams].
         *
    ...
    /** A builder for [LabelDeleteAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(labelDeleteAllParams: LabelDeleteAllParams) = apply {
            inboxId = labelDeleteAllParams.inboxId
            threadId = labelDeleteAllParams.threadId
            labelMutationRequest = labelDeleteAllParams.labelMutationRequest
            additionalHeaders = labelDeleteAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = labelDeleteAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LabelDeleteAllParams].
         *
         ...
         */
        fun build(): LabelDeleteAllParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LabelDeleteAllParams &&
    ...
    override fun toString() =
        "LabelDeleteAllParams{inboxId=$inboxId, threadId=$threadId, labelMutationRequest=$labelMutationRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
