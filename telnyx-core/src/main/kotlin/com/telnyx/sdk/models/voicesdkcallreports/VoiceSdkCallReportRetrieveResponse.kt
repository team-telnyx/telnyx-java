 ...
 */
class VoiceSdkCallReportRetrieveResponse
...
private constructor(
    ...
    /** A builder for [VoiceSdkCallReportRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceSdkCallReportRetrieveResponse: VoiceSdkCallReportRetrieveResponse) =
            apply {
                callId = voiceSdkCallReportRetrieveResponse.callId
                callReportId = voiceSdkCallReportRetrieveResponse.callReportId
                createdAt = voiceSdkCallReportRetrieveResponse.createdAt
                flushReason = voiceSdkCallReportRetrieveResponse.flushReason
                logs = voiceSdkCallReportRetrieveResponse.logs
                organizationId = voiceSdkCallReportRetrieveResponse.organizationId
                segment = voiceSdkCallReportRetrieveResponse.segment
                stats = voiceSdkCallReportRetrieveResponse.stats
                storedAt = voiceSdkCallReportRetrieveResponse.storedAt
                summary = voiceSdkCallReportRetrieveResponse.summary
                telnyxLegId = voiceSdkCallReportRetrieveResponse.telnyxLegId
                telnyxSessionId = voiceSdkCallReportRetrieveResponse.telnyxSessionId
                userAgent = voiceSdkCallReportRetrieveResponse.userAgent
                userId = voiceSdkCallReportRetrieveResponse.userId
                version = voiceSdkCallReportRetrieveResponse.version
                voiceSdkId = voiceSdkCallReportRetrieveResponse.voiceSdkId
                voiceSdkIdDecoded = voiceSdkCallReportRetrieveResponse.voiceSdkIdDecoded
                voiceSdkSessionId = voiceSdkCallReportRetrieveResponse.voiceSdkSessionId
                additionalProperties =
                    voiceSdkCallReportRetrieveResponse.additionalProperties.toMutableMap()
            }
         ...
         * `Stats.ofUnnamedSchemaWithArrayParent3s(unnamedSchemaWithArrayParent3s)`.
         */
        fun statsOfUnnamedSchemaWithArrayParent3s(
            unnamedSchemaWithArrayParent3s: List<Stats.UnnamedSchemaWithArrayParent3>
        ) = stats(Stats.ofUnnamedSchemaWithArrayParent3s(unnamedSchemaWithArrayParent3s))
        ...
        /**
         * Returns an immutable instance of [VoiceSdkCallReportRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceSdkCallReportRetrieveResponse =
            VoiceSdkCallReportRetrieveResponse(
                callId,
                callReportId,
                createdAt,
     ...
     *   expected type.
     */
    fun validate(): VoiceSdkCallReportRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitUnnamedSchemaWithArrayParent3s(List<UnnamedSchemaWithArrayParent3> unnamedSchemaWithArrayParent3s) {
         *         return Optional.of(unnamedSchemaWithArrayParent3s.toString());
         *     }
         *
         *     // ...
         *
        ...
        override fun hashCode(): Int = Objects.hash(unnamedSchemaWithArrayParent3s, unionMember1)

        override fun toString(): String =
            when {
                unnamedSchemaWithArrayParent3s != null ->
                    "Stats{unnamedSchemaWithArrayParent3s=$unnamedSchemaWithArrayParent3s}"
        ...
        companion object {
            ...
            fun ofUnnamedSchemaWithArrayParent3s(
                unnamedSchemaWithArrayParent3s: List<UnnamedSchemaWithArrayParent3>
            ) = Stats(unnamedSchemaWithArrayParent3s = unnamedSchemaWithArrayParent3s.toImmutable())
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(
                                ...
                                ?.let { Stats(unnamedSchemaWithArrayParent3s = it, _json = json) },
                        )
                        .filterNotNull()
                        .allMaxBy { it.validity() }
                        .toList()
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(unnamedSchemaWithArrayParent3: UnnamedSchemaWithArrayParent3) =
                    apply {
                        additionalProperties =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceSdkCallReportRetrieveResponse &&
            callId == other.callId &&
    ...
    override fun toString() =
        "VoiceSdkCallReportRetrieveResponse{callId=$callId, callReportId=$callReportId, createdAt=$createdAt, flushReason=$flushReason, logs=$logs, organizationId=$organizationId, segment=$segment, stats=$stats, storedAt=$storedAt, summary=$summary, telnyxLegId=$telnyxLegId, telnyxSessionId=$telnyxSessionId, userAgent=$userAgent, userId=$userId, version=$version, voiceSdkId=$voiceSdkId, voiceSdkIdDecoded=$voiceSdkIdDecoded, voiceSdkSessionId=$voiceSdkSessionId, additionalProperties=$additionalProperties}"
}
