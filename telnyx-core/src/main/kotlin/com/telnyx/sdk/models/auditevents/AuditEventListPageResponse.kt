...
class AuditEventListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AuditEventListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AuditEventListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<AuditEventListResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AuditEventListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AuditEventListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuditEventListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AuditEventListResponse>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(auditEventListPageResponse: AuditEventListPageResponse) = apply {
            data = auditEventListPageResponse.data.map { it.toMutableList() }
            meta = auditEventListPageResponse.meta
            additionalProperties = auditEventListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<AuditEventListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AuditEventListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<AuditEventListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AuditEventListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AuditEventListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AuditEventListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuditEventListPageResponse =
            AuditEventListPageResponse(
    ...
    fun validate(): AuditEventListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuditEventListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AuditEventListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
