 ...
 */
class TermsOfServiceRetrieveStatusParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TermsOfServiceRetrieveStatusParams = builder().build()
    ...
    /** A builder for [TermsOfServiceRetrieveStatusParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(termsOfServiceRetrieveStatusParams: TermsOfServiceRetrieveStatusParams) =
            apply {
                productType = termsOfServiceRetrieveStatusParams.productType
                additionalHeaders = termsOfServiceRetrieveStatusParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    termsOfServiceRetrieveStatusParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TermsOfServiceRetrieveStatusParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TermsOfServiceRetrieveStatusParams =
            TermsOfServiceRetrieveStatusParams(
                productType,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TermsOfServiceRetrieveStatusParams &&
    ...
    override fun toString() =
        "TermsOfServiceRetrieveStatusParams{productType=$productType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
