...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [QueueResource]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [QueueResource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(queueResource: QueueResource) = apply {
            accountSid = queueResource.accountSid
            averageWaitTime = queueResource.averageWaitTime
            currentSize = queueResource.currentSize
            dateCreated = queueResource.dateCreated
            dateUpdated = queueResource.dateUpdated
            maxSize = queueResource.maxSize
            sid = queueResource.sid
            subresourceUris = queueResource.subresourceUris
            uri = queueResource.uri
            additionalProperties = queueResource.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [QueueResource].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): QueueResource =
            QueueResource(
                accountSid,
                averageWaitTime,
                currentSize,
     ...
     *   expected type.
     */
    fun validate(): QueueResource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "QueueResource{accountSid=$accountSid, averageWaitTime=$averageWaitTime, currentSize=$currentSize, dateCreated=$dateCreated, dateUpdated=$dateUpdated, maxSize=$maxSize, sid=$sid, subresourceUris=$subresourceUris, uri=$uri, additionalProperties=$additionalProperties}"
}
