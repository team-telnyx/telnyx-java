...
private constructor(
    private val data: JsonField<List<Dir>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Dir>> = JsonMissing.of(),
        @JsonProperty("meta")
        @ExcludeMissing
     ...
     */
    fun data(): List<Dir> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Dir>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirList].
         *
    ...
    /** A builder for [DirList]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Dir>>? = null
        private var meta: JsonField<BrandedCallingPaginationMeta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(dirList: DirList) = apply {
            data = dirList.data.map { it.toMutableList() }
            meta = dirList.meta
            additionalProperties = dirList.additionalProperties.toMutableMap()
        }

        fun data(data: List<Dir>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Dir>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<Dir>>) = apply { this.data = data.map { it.toMutableList() } }

        /**
         * Adds a single [Dir] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Dir) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [DirList].
         *
    ...
    override fun toString() =
        "DirList{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
