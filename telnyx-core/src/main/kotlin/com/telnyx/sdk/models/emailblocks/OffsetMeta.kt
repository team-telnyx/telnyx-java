...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OffsetMeta].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(offsetMeta: OffsetMeta) = apply {
            pageNumber = offsetMeta.pageNumber
            pageSize = offsetMeta.pageSize
            totalPages = offsetMeta.totalPages
            totalResults = offsetMeta.totalResults
            additionalProperties = offsetMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OffsetMeta].
         *
    ...
    override fun toString() =
        "OffsetMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
