...
class ReportingPaginationMeta77109e5d17
...
private constructor(
    ...
    /** A builder for [ReportingPaginationMeta77109e5d17]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(reportingPaginationMeta77109e5d17: ReportingPaginationMeta77109e5d17) =
            apply {
                pageNumber = reportingPaginationMeta77109e5d17.pageNumber
                pageSize = reportingPaginationMeta77109e5d17.pageSize
                totalPages = reportingPaginationMeta77109e5d17.totalPages
                totalResults = reportingPaginationMeta77109e5d17.totalResults
                additionalProperties =
                    reportingPaginationMeta77109e5d17.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ReportingPaginationMeta77109e5d17].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ReportingPaginationMeta77109e5d17 =
            ReportingPaginationMeta77109e5d17(
                pageNumber,
                pageSize,
                totalPages,
     ...
     *   expected type.
     */
    fun validate(): ReportingPaginationMeta77109e5d17 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReportingPaginationMeta77109e5d17 &&
    ...
    override fun toString() =
        "ReportingPaginationMeta77109e5d17{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
