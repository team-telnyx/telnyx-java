 ...
 * `taskId`.
 */
class PhoneNumberAssignmentByProfileListPhoneNumberStatusParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PhoneNumberAssignmentByProfileListPhoneNumberStatusParams = builder().build()
    ...
    /** A builder for [PhoneNumberAssignmentByProfileListPhoneNumberStatusParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            taskId = phoneNumberAssignmentByProfileListPhoneNumberStatusParams.taskId
            page = phoneNumberAssignmentByProfileListPhoneNumberStatusParams.page
            recordsPerPage =
                phoneNumberAssignmentByProfileListPhoneNumberStatusParams.recordsPerPage
            additionalHeaders =
                phoneNumberAssignmentByProfileListPhoneNumberStatusParams.additionalHeaders
                    .toBuilder()
            additionalQueryParams =
                phoneNumberAssignmentByProfileListPhoneNumberStatusParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileListPhoneNumberStatusParams =
            PhoneNumberAssignmentByProfileListPhoneNumberStatusParams(
                taskId,
                page,
                recordsPerPage,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileListPhoneNumberStatusParams &&
            taskId == other.taskId &&
            page == other.page &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileListPhoneNumberStatusParams{taskId=$taskId, page=$page, recordsPerPage=$recordsPerPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
