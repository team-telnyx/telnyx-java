...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(wireguardInterfaceListPageResponse: WireguardInterfaceListPageResponse) =
            apply {
                data = wireguardInterfaceListPageResponse.data.map { it.toMutableList() }
                meta = wireguardInterfaceListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [WireguardInterfaceListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WireguardInterfaceListPageResponse =
            WireguardInterfaceListPageResponse(
    ...
    fun validate(): WireguardInterfaceListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WireguardInterfaceListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "WireguardInterfaceListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
