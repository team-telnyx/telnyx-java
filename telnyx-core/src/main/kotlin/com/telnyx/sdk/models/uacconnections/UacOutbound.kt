...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UacOutbound]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacOutbound]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uacOutbound: UacOutbound) = apply {
            aniOverride = uacOutbound.aniOverride
            aniOverrideType = uacOutbound.aniOverrideType
            callParkingEnabled = uacOutbound.callParkingEnabled
            channelLimit = uacOutbound.channelLimit
            generateRingbackTone = uacOutbound.generateRingbackTone
            instantRingbackEnabled = uacOutbound.instantRingbackEnabled
            localization = uacOutbound.localization
            outboundVoiceProfileId = uacOutbound.outboundVoiceProfileId
            t38ReinviteSource = uacOutbound.t38ReinviteSource
            additionalProperties = uacOutbound.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UacOutbound].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacOutbound =
            UacOutbound(
                aniOverride,
                aniOverrideType,
                callParkingEnabled,
     ...
     *   expected type.
     */
    fun validate(): UacOutbound = apply {
        if (validated) {
            return@apply
        }
