...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessagingPaginationMeta].
         *
    ...
    /** A builder for [MessagingPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingPaginationMeta: MessagingPaginationMeta) = apply {
            pageNumber = messagingPaginationMeta.pageNumber
            pageSize = messagingPaginationMeta.pageSize
            totalPages = messagingPaginationMeta.totalPages
            totalResults = messagingPaginationMeta.totalResults
            additionalProperties = messagingPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingPaginationMeta].
         *
         ...
         */
        fun build(): MessagingPaginationMeta =
    ...
    fun validate(): MessagingPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingPaginationMeta &&
    ...
    override fun toString() =
        "MessagingPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
