...
class PortingActionRequirement
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("action_url") @ExcludeMissing actionUrl: JsonField<String> = JsonMissing.of(),
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PortingActionRequirement]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingActionRequirement]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingActionRequirement: PortingActionRequirement) = apply {
            id = portingActionRequirement.id
            actionType = portingActionRequirement.actionType
            actionUrl = portingActionRequirement.actionUrl
            cancelReason = portingActionRequirement.cancelReason
            createdAt = portingActionRequirement.createdAt
            portingOrderId = portingActionRequirement.portingOrderId
            recordType = portingActionRequirement.recordType
            requirementTypeId = portingActionRequirement.requirementTypeId
            status = portingActionRequirement.status
            updatedAt = portingActionRequirement.updatedAt
            additionalProperties = portingActionRequirement.additionalProperties.toMutableMap()
        }
        ...
        /** Reason for cancellation if status is 'cancelled' */
        fun cancelReason(cancelReason: String?) = cancelReason(JsonField.ofNullable(cancelReason))

        /** Alias for calling [Builder.cancelReason] with `cancelReason.orElse(null)`. */
        fun cancelReason(cancelReason: Optional<String>) = cancelReason(cancelReason.getOrNull())

        /**
         * Sets [Builder.cancelReason] to an arbitrary JSON value.
         *
         * You should usually call [Builder.cancelReason] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [PortingActionRequirement].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingActionRequirement =
     ...
     *   expected type.
     */
    fun validate(): PortingActionRequirement = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingActionRequirement &&
            id == other.id &&
    ...
    override fun toString() =
        "PortingActionRequirement{id=$id, actionType=$actionType, actionUrl=$actionUrl, cancelReason=$cancelReason, createdAt=$createdAt, portingOrderId=$portingOrderId, recordType=$recordType, requirementTypeId=$requirementTypeId, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
