...
class PhoneNumberCreateVerificationParams
private constructor(
    ...
    /** A builder for [PhoneNumberCreateVerificationParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            phoneNumberCreateVerificationParams: PhoneNumberCreateVerificationParams
        ) = apply {
            id = phoneNumberCreateVerificationParams.id
            body = phoneNumberCreateVerificationParams.body.toBuilder()
            additionalHeaders = phoneNumberCreateVerificationParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                phoneNumberCreateVerificationParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberCreateVerificationParams].
         *
         ...
         */
        fun build(): PhoneNumberCreateVerificationParams =
            PhoneNumberCreateVerificationParams(
                id,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberCreateVerificationParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "PhoneNumberCreateVerificationParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
