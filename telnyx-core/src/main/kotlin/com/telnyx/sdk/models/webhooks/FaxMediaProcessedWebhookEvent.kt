...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): FaxMediaProcessedWebhookEvent =
            FaxMediaProcessedWebhookEvent(data, meta, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "FaxMediaProcessedWebhookEvent{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
