...
private constructor(
    ...
    /**
     * Consolidated filter parameter for OTA updates (deepObject style). Originally: filter[status],
     * filter[sim_card_id], filter[type]
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): OtaUpdateListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OtaUpdateListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OtaUpdateListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(otaUpdateListParams: OtaUpdateListParams) = apply {
            filter = otaUpdateListParams.filter
            pageNumber = otaUpdateListParams.pageNumber
            pageSize = otaUpdateListParams.pageSize
            additionalHeaders = otaUpdateListParams.additionalHeaders.toBuilder()
            additionalQueryParams = otaUpdateListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OtaUpdateListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OtaUpdateListParams =
            OtaUpdateListParams(
                filter,
                pageNumber,
                pageSize,
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Filter = Filter(simCardId, status, type, additionalProperties.build())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(simCardId, status, type, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{simCardId=$simCardId, status=$status, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OtaUpdateListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "OtaUpdateListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
