...
/**
 * A UAC (User Agent Client) Connection registers Telnyx to your PBX — the opposite of a standard
 * SIP trunk, where the PBX registers to Telnyx. Use UAC when your PBX doesn’t support outbound SIP
...
private constructor(
    ...
    private val inbound: JsonField<UacInbound>,
    ...
    private val noiseSuppression: JsonField<ConnectionNoiseSuppression>,
    ...
    private constructor(
        ...
        @JsonProperty("inbound") @ExcludeMissing inbound: JsonField<UacInbound> = JsonMissing.of(),
        ...
        @ExcludeMissing
        noiseSuppression: JsonField<ConnectionNoiseSuppression> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun authentication(): Optional<Authentication> = authentication.getOptional("authentication")
     ...
     *   server responded with an unexpected value).
     */
    fun inbound(): Optional<UacInbound> = inbound.getOptional("inbound")
     ...
     *   server responded with an unexpected value).
     */
    fun noiseSuppression(): Optional<ConnectionNoiseSuppression> =
     ...
     */
    @JsonProperty("inbound") @ExcludeMissing fun _inbound(): JsonField<UacInbound> = inbound
    ...
    @JsonProperty("noise_suppression")
    @ExcludeMissing
    fun _noiseSuppression(): JsonField<ConnectionNoiseSuppression> = noiseSuppression
     ...
     *
     * Unlike [registrationStatus], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("registration_status")
    @ExcludeMissing
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UacConnection]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacConnection]. */
    class Builder internal constructor() {
        ...
        private var inbound: JsonField<UacInbound> = JsonMissing.of()
        ...
        private var noiseSuppression: JsonField<ConnectionNoiseSuppression> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(uacConnection: UacConnection) = apply {
            id = uacConnection.id
            active = uacConnection.active
            anchorsiteOverride = uacConnection.anchorsiteOverride
            androidPushCredentialId = uacConnection.androidPushCredentialId
            authentication = uacConnection.authentication
            callCostInWebhooks = uacConnection.callCostInWebhooks
            connectionName = uacConnection.connectionName
            createdAt = uacConnection.createdAt
            defaultOnHoldComfortNoiseEnabled = uacConnection.defaultOnHoldComfortNoiseEnabled
            dtmfType = uacConnection.dtmfType
            encodeContactHeaderEnabled = uacConnection.encodeContactHeaderEnabled
            encryptedMedia = uacConnection.encryptedMedia
            externalUacSettings = uacConnection.externalUacSettings
            fqdn = uacConnection.fqdn
            fqdnOutboundAuthentication = uacConnection.fqdnOutboundAuthentication
            fqdns = uacConnection.fqdns.map { it.toMutableList() }
            inbound = uacConnection.inbound
            internalUacSettings = uacConnection.internalUacSettings
            iosPushCredentialId = uacConnection.iosPushCredentialId
            jitterBuffer = uacConnection.jitterBuffer
            noiseSuppression = uacConnection.noiseSuppression
            noiseSuppressionDetails = uacConnection.noiseSuppressionDetails
            onnetT38PassthroughEnabled = uacConnection.onnetT38PassthroughEnabled
            outbound = uacConnection.outbound
            password = uacConnection.password
            recordType = uacConnection.recordType
            registrationStatus = uacConnection.registrationStatus
            registrationStatusUpdatedAt = uacConnection.registrationStatusUpdatedAt
            rtcpSettings = uacConnection.rtcpSettings
            sipUriCallingPreference = uacConnection.sipUriCallingPreference
            tags = uacConnection.tags.map { it.toMutableList() }
            updatedAt = uacConnection.updatedAt
            userName = uacConnection.userName
            webhookApiVersion = uacConnection.webhookApiVersion
            webhookEventFailoverUrl = uacConnection.webhookEventFailoverUrl
            webhookEventUrl = uacConnection.webhookEventUrl
            webhookTimeoutSecs = uacConnection.webhookTimeoutSecs
            additionalProperties = uacConnection.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.authentication] with a well-typed [Authentication] value
        ...
        fun addFqdn(fqdn: Fqdn) = apply {
            fqdns =
                (fqdns ?: JsonField.of(mutableListOf())).also { checkKnown("fqdns", it).add(fqdn) }
        }

        fun inbound(inbound: UacInbound) = inbound(JsonField.of(inbound))

        /**
         * Sets [Builder.inbound] to an arbitrary JSON value.
         *
         * You should usually call [Builder.inbound] with a well-typed [UacInbound] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun inbound(inbound: JsonField<UacInbound>) = apply { this.inbound = inbound }
         ...
         */
        fun noiseSuppression(noiseSuppression: ConnectionNoiseSuppression) =
         ...
         * [ConnectionNoiseSuppression] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun noiseSuppression(noiseSuppression: JsonField<ConnectionNoiseSuppression>) = apply {
        ...
        /**
         * Alias for calling [Builder.registrationStatus] with `registrationStatus.orElse(null)`.
         */
         ...
         *
         * You should usually call [Builder.registrationStatusUpdatedAt] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun registrationStatusUpdatedAt(registrationStatusUpdatedAt: JsonField<String>) = apply {
        ...
        /**
         * Returns an immutable instance of [UacConnection].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacConnection =
            UacConnection(
                id,
                active,
                anchorsiteOverride,
     ...
     *   expected type.
     */
    fun validate(): UacConnection = apply {
        if (validated) {
            return@apply
        }
    ...
    /** The authentication strategy used by this connection. */
    class Authentication @JsonCreator private constructor(private val value: JsonField<String>) :
        Enum {
