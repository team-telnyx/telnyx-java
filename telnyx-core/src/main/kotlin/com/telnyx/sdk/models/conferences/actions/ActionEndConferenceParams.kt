...
private constructor(
     ...
     * `command_id` for the same conference.
     *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * same `command_id` for the same conference.
             */
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(commandId, additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (commandId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(commandId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{commandId=$commandId, additionalProperties=$additionalProperties}"
    }
