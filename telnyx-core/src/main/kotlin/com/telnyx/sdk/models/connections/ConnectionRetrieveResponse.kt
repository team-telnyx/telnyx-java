...
private constructor(
    private val data: JsonField<Connection>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<Connection> = JsonMissing.of()
     ...
     */
    fun data(): Optional<Connection> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Connection> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<Connection> = JsonMissing.of()
        ...
        fun data(data: Connection) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Connection] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Connection>) = apply { this.data = data }
