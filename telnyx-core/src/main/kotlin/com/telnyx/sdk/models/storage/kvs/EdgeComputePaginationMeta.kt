...
class EdgeComputePaginationMeta
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EdgeComputePaginationMeta].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EdgeComputePaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(edgeComputePaginationMeta: EdgeComputePaginationMeta) = apply {
            pageNumber = edgeComputePaginationMeta.pageNumber
            pageSize = edgeComputePaginationMeta.pageSize
            totalPages = edgeComputePaginationMeta.totalPages
            totalResults = edgeComputePaginationMeta.totalResults
            additionalProperties = edgeComputePaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EdgeComputePaginationMeta].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EdgeComputePaginationMeta =
     ...
     *   expected type.
     */
    fun validate(): EdgeComputePaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EdgeComputePaginationMeta &&
    ...
    override fun toString() =
        "EdgeComputePaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
