...
class FaxApplicationUpdateParams
private constructor(
    ...
    /**
     * Specifies an email address where faxes sent to this application will be forwarded to (as pdf
     * or tiff attachments)
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun faxEmailRecipient(): Optional<String> = body.faxEmailRecipient()
    ...
    /**
     * Returns the raw JSON value of [faxEmailRecipient].
     *
     * Unlike [faxEmailRecipient], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    fun _faxEmailRecipient(): JsonField<String> = body._faxEmailRecipient()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FaxApplicationUpdateParams].
         *
    ...
    /** A builder for [FaxApplicationUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxApplicationUpdateParams: FaxApplicationUpdateParams) = apply {
            id = faxApplicationUpdateParams.id
            body = faxApplicationUpdateParams.body.toBuilder()
            additionalHeaders = faxApplicationUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = faxApplicationUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Specifies an email address where faxes sent to this application will be forwarded to (as
         * pdf or tiff attachments)
         */
        fun faxEmailRecipient(faxEmailRecipient: String?) = apply {
            body.faxEmailRecipient(faxEmailRecipient)
        }

        /** Alias for calling [Builder.faxEmailRecipient] with `faxEmailRecipient.orElse(null)`. */
        fun faxEmailRecipient(faxEmailRecipient: Optional<String>) =
            faxEmailRecipient(faxEmailRecipient.getOrNull())

        /**
         * Sets [Builder.faxEmailRecipient] to an arbitrary JSON value.
         *
         * You should usually call [Builder.faxEmailRecipient] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun faxEmailRecipient(faxEmailRecipient: JsonField<String>) = apply {
            body.faxEmailRecipient(faxEmailRecipient)
        }
        ...
        /**
         * Returns an immutable instance of [FaxApplicationUpdateParams].
         *
         ...
         */
        fun build(): FaxApplicationUpdateParams =
    ...
    private constructor(
        ...
        private val faxEmailRecipient: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("fax_email_recipient")
            @ExcludeMissing
            faxEmailRecipient: JsonField<String> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun faxEmailRecipient(): Optional<String> =
            faxEmailRecipient.getOptional("fax_email_recipient")
        ...
        @JsonProperty("fax_email_recipient")
        @ExcludeMissing
        fun _faxEmailRecipient(): JsonField<String> = faxEmailRecipient
        ...
        class Builder internal constructor() {
            ...
            private var faxEmailRecipient: JsonField<String> = JsonMissing.of()
            ...
            internal fun from(body: Body) = apply {
                ...
                faxEmailRecipient = body.faxEmailRecipient
            ...
            /**
             * Specifies an email address where faxes sent to this application will be forwarded to
             * (as pdf or tiff attachments)
             */
            fun faxEmailRecipient(faxEmailRecipient: String?) =
                faxEmailRecipient(JsonField.ofNullable(faxEmailRecipient))
        ...
        internal fun validity(): Int =
            (if (applicationName.asKnown().isPresent) 1 else 0) +
                ...
                (if (faxEmailRecipient.asKnown().isPresent) 1 else 0) +
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Body &&
                ...
                faxEmailRecipient == other.faxEmailRecipient &&
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxApplicationUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "FaxApplicationUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
