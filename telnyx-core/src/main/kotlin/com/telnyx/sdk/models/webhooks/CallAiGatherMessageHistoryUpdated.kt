...
class CallAiGatherMessageHistoryUpdated
...
private constructor(
    ...
    /** A builder for [CallAiGatherMessageHistoryUpdated]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callAiGatherMessageHistoryUpdated: CallAiGatherMessageHistoryUpdated) =
            apply {
                id = callAiGatherMessageHistoryUpdated.id
                eventType = callAiGatherMessageHistoryUpdated.eventType
                occurredAt = callAiGatherMessageHistoryUpdated.occurredAt
                payload = callAiGatherMessageHistoryUpdated.payload
                recordType = callAiGatherMessageHistoryUpdated.recordType
                additionalProperties =
                    callAiGatherMessageHistoryUpdated.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallAiGatherMessageHistoryUpdated].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallAiGatherMessageHistoryUpdated =
            CallAiGatherMessageHistoryUpdated(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallAiGatherMessageHistoryUpdated = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallAiGatherMessageHistoryUpdated &&
            id == other.id &&
    ...
    override fun toString() =
        "CallAiGatherMessageHistoryUpdated{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
