...
class ConferenceParticipantSpeakEnded
...
private constructor(
    ...
    /** A builder for [ConferenceParticipantSpeakEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceParticipantSpeakEnded: ConferenceParticipantSpeakEnded) =
            apply {
                id = conferenceParticipantSpeakEnded.id
                eventType = conferenceParticipantSpeakEnded.eventType
                payload = conferenceParticipantSpeakEnded.payload
                recordType = conferenceParticipantSpeakEnded.recordType
                additionalProperties =
                    conferenceParticipantSpeakEnded.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ConferenceParticipantSpeakEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceParticipantSpeakEnded =
            ConferenceParticipantSpeakEnded(
                id,
                eventType,
                payload,
    ...
    fun validate(): ConferenceParticipantSpeakEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CONFERENCE_PARTICIPANT_SPEAK_ENDED = of("conference.participant.speak.ended")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PARTICIPANT_SPEAK_ENDED -> Value.CONFERENCE_PARTICIPANT_SPEAK_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PARTICIPANT_SPEAK_ENDED -> Known.CONFERENCE_PARTICIPANT_SPEAK_ENDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceParticipantSpeakEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceParticipantSpeakEnded{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
