...
class CallDeepfakeDetectionResultWebhookEvent
...
private constructor(
    ...
    /** A builder for [CallDeepfakeDetectionResultWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                callDeepfakeDetectionResultWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallDeepfakeDetectionResultWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallDeepfakeDetectionResultWebhookEvent =
            CallDeepfakeDetectionResultWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallDeepfakeDetectionResultWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_DEEPFAKE_DETECTION_RESULT = of("call.deepfake_detection.result")
            ...
            fun value(): Value =
                when (this) {
                    CALL_DEEPFAKE_DETECTION_RESULT -> Value.CALL_DEEPFAKE_DETECTION_RESULT
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_DEEPFAKE_DETECTION_RESULT -> Known.CALL_DEEPFAKE_DETECTION_RESULT
        ...
        private constructor(
            ...
            private val consistency: JsonField<Float>,
            ...
            private constructor(
                ...
                @ExcludeMissing
                consistency: JsonField<Float> = JsonMissing.of(),
                @JsonProperty("result")
                @ExcludeMissing
            ...
            /**
             * Percentage (0-100) indicating how consistently the model classified the audio across
             * frames. High consistency (>90%) means confident classification throughout; low
             * consistency suggests mixed signals. Null for silence_timeout.
             *
             * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if
             *   the server responded with an unexpected value).
             */
            fun consistency(): Optional<Float> = consistency.getOptional("consistency")
            ...
            /**
             * Probability that the audio is AI-generated, from 0.0 (likely real) to 1.0 (likely
             * deepfake). Based on the model's aggregated confidence across analyzed audio frames.
             * Null for silence_timeout.
             *
             * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if
             *   the server responded with an unexpected value).
             */
             ...
             *
             * Unlike [consistency], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("consistency")
            @ExcludeMissing
            fun _consistency(): JsonField<Float> = consistency
            ...
            class Builder internal constructor() {
                ...
                private var consistency: JsonField<Float> = JsonMissing.of()
                ...
                /** State received from a command. */
                fun clientState(clientState: String?) =
                    clientState(JsonField.ofNullable(clientState))

                /** Alias for calling [Builder.clientState] with `clientState.orElse(null)`. */
                fun clientState(clientState: Optional<String>) =
                    clientState(clientState.getOrNull())
                 ...
                 * across frames. High consistency (>90%) means confident classification throughout;
                 * low consistency suggests mixed signals. Null for silence_timeout.
                 */
                fun consistency(consistency: Float?) =
                    consistency(JsonField.ofNullable(consistency))

                /**
                 * Alias for [Builder.consistency].
                 *
                 * This unboxed primitive overload exists for backwards compatibility.
                 */
                fun consistency(consistency: Float) = consistency(consistency as Float?)

                /** Alias for calling [Builder.consistency] with `consistency.orElse(null)`. */
                fun consistency(consistency: Optional<Float>) = consistency(consistency.getOrNull())

                /**
                 * Sets [Builder.consistency] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.consistency] with a well-typed [Float] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun consistency(consistency: JsonField<Float>) = apply {
                ...
                /**
                 * Probability that the audio is AI-generated, from 0.0 (likely real) to 1.0 (likely
                 * deepfake). Based on the model's aggregated confidence across analyzed audio
                 * frames. Null for silence_timeout.
                 */
                fun score(score: Float?) = score(JsonField.ofNullable(score))
                 ...
                 * This unboxed primitive overload exists for backwards compatibility.
                 */
                fun score(score: Float) = score(score as Float?)

                /** Alias for calling [Builder.score] with `score.orElse(null)`. */
                fun score(score: Optional<Float>) = score(score.getOrNull())

                /**
                 * Sets [Builder.score] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.score] with a well-typed [Float] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
            ...
            internal fun validity(): Int =
                (if (callControlId.asKnown().isPresent) 1 else 0) +
                    ...
                    (if (consistency.asKnown().isPresent) 1 else 0) +
            ...
            class Result @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    @JvmField val FAKE = of("fake")

                    @JvmField val SILENCE_TIMEOUT = of("silence_timeout")
                ...
                fun value(): Value =
                    when (this) {
                        REAL -> Value.REAL
                        FAKE -> Value.FAKE
                        SILENCE_TIMEOUT -> Value.SILENCE_TIMEOUT
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        REAL -> Known.REAL
                        FAKE -> Known.FAKE
                        SILENCE_TIMEOUT -> Known.SILENCE_TIMEOUT
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, consistency=$consistency, result=$result, score=$score, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallDeepfakeDetectionResultWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallDeepfakeDetectionResultWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
