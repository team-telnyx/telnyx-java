...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListResponse: EventListResponse) = apply {
            ...
            portoutId = eventListResponse.portoutId
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(
                                ...
                                ?.let { Payload(webhookPortoutStatusChanged = it, _json = json) },
                            tryDeserialize(node, jacksonTypeRef<WebhookPortoutNewCommentPayload>())
                                ?.let { Payload(webhookPortoutNewComment = it, _json = json) },
                            tryDeserialize(
                                    node,
                                    jacksonTypeRef<WebhookPortoutFocDateChangedPayload>(),
                                )
                                ?.let { Payload(webhookPortoutFocDateChanged = it, _json = json) },
                        )
                        .filterNotNull()
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(
                    ...
                    phoneNumbers =
                        webhookPortoutStatusChangedPayload.phoneNumbers.map { it.toMutableList() }
    ...
    override fun toString() =
        "EventListResponse{id=$id, availableNotificationMethods=$availableNotificationMethods, createdAt=$createdAt, eventType=$eventType, payload=$payload, payloadStatus=$payloadStatus, portoutId=$portoutId, recordType=$recordType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
