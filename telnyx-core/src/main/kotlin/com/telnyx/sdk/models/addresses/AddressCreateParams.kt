...
private constructor(
    ...
    /**
     * The business name associated with the address. An address must have either a first last name
     * or a business name.
     *
    ...
    /**
     * The first name associated with the address. An address must have either a first last name or
     * a business name.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * The last name associated with the address. An address must have either a first last name or a
     * business name.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * Indicates whether or not the address should be considered part of your list of addresses that
     * appear for regular use.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun addressBook(): Optional<Boolean> = body.addressBook()
    ...
    /**
     * The borough of the address. This field is not used for addresses in the US but is used for
    ...
    /**
     * The neighborhood of the address. This field is not used for addresses in the US but is used
    ...
    /**
     * Indicates whether or not the address should be validated for emergency use upon creation or
     * not. This should be left with the default value of `true` unless you have used the
     * `/addresses/actions/validate` endpoint to validate the address separately prior to creation.
     * If an address is not validated for emergency use upon creation and it is not valid, it will
     * not be able to be used for emergency services.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun validateAddress(): Optional<Boolean> = body.validateAddress()
    ...
    /**
     * Returns the raw JSON value of [addressBook].
     *
     * Unlike [addressBook], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _addressBook(): JsonField<Boolean> = body._addressBook()
    ...
    /**
     * Returns the raw JSON value of [validateAddress].
     *
     * Unlike [validateAddress], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _validateAddress(): JsonField<Boolean> = body._validateAddress()
    ...
    class Builder internal constructor() {
        ...
        /**
         * The business name associated with the address. An address must have either a first last
        ...
        /**
         * The first name associated with the address. An address must have either a first last name
         * or a business name.
         */
        ...
        /**
         * The last name associated with the address. An address must have either a first last name
         * or a business name.
         */
        ...
        /**
         * Indicates whether or not the address should be considered part of your list of addresses
         * that appear for regular use.
         */
        fun addressBook(addressBook: Boolean) = apply { body.addressBook(addressBook) }

        /**
         * Sets [Builder.addressBook] to an arbitrary JSON value.
         *
         * You should usually call [Builder.addressBook] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun addressBook(addressBook: JsonField<Boolean>) = apply { body.addressBook(addressBook) }
        ...
        /**
         * The borough of the address. This field is not used for addresses in the US but is used
         * for some international addresses.
         */
        ...
        /**
         * The neighborhood of the address. This field is not used for addresses in the US but is
        ...
        /**
         * Indicates whether or not the address should be validated for emergency use upon creation
         * or not. This should be left with the default value of `true` unless you have used the
         * `/addresses/actions/validate` endpoint to validate the address separately prior to
         * creation. If an address is not validated for emergency use upon creation and it is not
         * valid, it will not be able to be used for emergency services.
         */
        fun validateAddress(validateAddress: Boolean) = apply {
            body.validateAddress(validateAddress)
        }

        /**
         * Sets [Builder.validateAddress] to an arbitrary JSON value.
         *
         * You should usually call [Builder.validateAddress] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun validateAddress(validateAddress: JsonField<Boolean>) = apply {
            body.validateAddress(validateAddress)
        }
    ...
    private constructor(
        ...
        private val addressBook: JsonField<Boolean>,
        ...
        private val validateAddress: JsonField<Boolean>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            addressBook: JsonField<Boolean> = JsonMissing.of(),
            ...
            @ExcludeMissing
            validateAddress: JsonField<Boolean> = JsonMissing.of(),
        ) : this(
            businessName,
            countryCode,
            firstName,
         ...
         *   server responded with an unexpected value).
         */
        fun addressBook(): Optional<Boolean> = addressBook.getOptional("address_book")
         ...
         *   server responded with an unexpected value).
         */
        fun validateAddress(): Optional<Boolean> = validateAddress.getOptional("validate_address")
        ...
        @JsonProperty("address_book")
        @ExcludeMissing
        fun _addressBook(): JsonField<Boolean> = addressBook
         ...
         * Returns the raw JSON value of [validateAddress].
         *
         * Unlike [validateAddress], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("validate_address")
        @ExcludeMissing
        fun _validateAddress(): JsonField<Boolean> = validateAddress
        ...
        class Builder internal constructor() {
            ...
            private var addressBook: JsonField<Boolean> = JsonMissing.of()
            ...
            private var validateAddress: JsonField<Boolean> = JsonMissing.of()
            ...
            internal fun from(body: Body) = apply {
                ...
                validateAddress = body.validateAddress
                additionalProperties = body.additionalProperties.toMutableMap()
            }

            /**
             * The business name associated with the address. An address must have either a first
            ...
            /**
             * The first name associated with the address. An address must have either a first last
             * name or a business name.
             */
            ...
            /**
             * The last name associated with the address. An address must have either a first last
             * name or a business name.
             */
             ...
             */
            fun addressBook(addressBook: Boolean) = addressBook(JsonField.of(addressBook))

            /**
             * Sets [Builder.addressBook] to an arbitrary JSON value.
             *
             * You should usually call [Builder.addressBook] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun addressBook(addressBook: JsonField<Boolean>) = apply {
            ...
            /**
             * The borough of the address. This field is not used for addresses in the US but is
             * used for some international addresses.
             */
            ...
            /**
             * The neighborhood of the address. This field is not used for addresses in the US but
             ...
             * creation or not. This should be left with the default value of `true` unless you have
             * used the `/addresses/actions/validate` endpoint to validate the address separately
             * prior to creation. If an address is not validated for emergency use upon creation and
             * it is not valid, it will not be able to be used for emergency services.
             */
            fun validateAddress(validateAddress: Boolean) =
                validateAddress(JsonField.of(validateAddress))
        ...
        internal fun validity(): Int =
            (if (businessName.asKnown().isPresent) 1 else 0) +
                ...
                (if (addressBook.asKnown().isPresent) 1 else 0) +
                ...
                (if (validateAddress.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() =
            "Body{businessName=$businessName, countryCode=$countryCode, firstName=$firstName, lastName=$lastName, locality=$locality, streetAddress=$streetAddress, addressBook=$addressBook, administrativeArea=$administrativeArea, borough=$borough, customerReference=$customerReference, extendedAddress=$extendedAddress, neighborhood=$neighborhood, phoneNumber=$phoneNumber, postalCode=$postalCode, validateAddress=$validateAddress, additionalProperties=$additionalProperties}"
    }
