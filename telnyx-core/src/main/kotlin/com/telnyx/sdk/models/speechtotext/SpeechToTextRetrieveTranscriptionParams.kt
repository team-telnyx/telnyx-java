...
private constructor(
    ...
    /**
     * Silence duration (in milliseconds) that triggers end-of-speech detection. When set, the
     * engine uses this value to determine when a speaker has stopped talking. Supported by `xAI`,
     * `Deepgram`, `Google`, `Speechmatics`, and `Soniox`. `Soniox` accepts values between 500
     * and 3000. Other engines may not support this parameter.
     */
    fun endpointing(): Optional<Long> = Optional.ofNullable(endpointing)

    /** Whether to receive interim transcription results. */
    fun interimResults(): Optional<Boolean> = Optional.ofNullable(interimResults)

    /**
     * A key term to boost in the transcription. The engine will be more likely to recognize this
     * term. Can be specified multiple times for multiple terms.
     */
    fun keyterm(): Optional<String> = Optional.ofNullable(keyterm)

    /**
     * Comma-separated list of keywords to boost in the transcription. The engine will prioritize
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            inputFormat = speechToTextRetrieveTranscriptionParams.inputFormat
            transcriptionEngine = speechToTextRetrieveTranscriptionParams.transcriptionEngine
            endpointing = speechToTextRetrieveTranscriptionParams.endpointing
            interimResults = speechToTextRetrieveTranscriptionParams.interimResults
            keyterm = speechToTextRetrieveTranscriptionParams.keyterm
            keywords = speechToTextRetrieveTranscriptionParams.keywords
            ...
            additionalQueryParams =
                speechToTextRetrieveTranscriptionParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Silence duration (in milliseconds) that triggers end-of-speech detection. When set, the
         * engine uses this value to determine when a speaker has stopped talking. Supported by
         * `xAI`, `Deepgram`, `Google`, `Speechmatics`, and `Soniox`. `Soniox` accepts values
         * between 500 and 3000. Other engines may not support this parameter.
         */
        fun endpointing(endpointing: Long?) = apply { this.endpointing = endpointing }

        /**
         * Alias for [Builder.endpointing].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun endpointing(endpointing: Long) = endpointing(endpointing as Long?)

        /** Alias for calling [Builder.endpointing] with `endpointing.orElse(null)`. */
        fun endpointing(endpointing: Optional<Long>) = endpointing(endpointing.getOrNull())
        ...
        /**
         * A key term to boost in the transcription. The engine will be more likely to recognize
         * this term. Can be specified multiple times for multiple terms.
         */
        fun keyterm(keyterm: String?) = apply { this.keyterm = keyterm }

        /** Alias for calling [Builder.keyterm] with `keyterm.orElse(null)`. */
        ...
        /**
         * Returns an immutable instance of [SpeechToTextRetrieveTranscriptionParams].
         *
         ...
         */
        fun build(): SpeechToTextRetrieveTranscriptionParams =
            SpeechToTextRetrieveTranscriptionParams(
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                endpointing?.let { put("endpointing", it.toString()) }
                interimResults?.let { put("interim_results", it.toString()) }
                keyterm?.let { put("keyterm", it) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpeechToTextRetrieveTranscriptionParams &&
