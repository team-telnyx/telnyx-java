...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MobileVoiceConnectionCreateParams = builder().build()
    ...
    /** A builder for [MobileVoiceConnectionCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mobileVoiceConnectionCreateParams: MobileVoiceConnectionCreateParams) =
            apply {
                body = mobileVoiceConnectionCreateParams.body.toBuilder()
                additionalHeaders = mobileVoiceConnectionCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    mobileVoiceConnectionCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MobileVoiceConnectionCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobileVoiceConnectionCreateParams =
            MobileVoiceConnectionCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobileVoiceConnectionCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MobileVoiceConnectionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
