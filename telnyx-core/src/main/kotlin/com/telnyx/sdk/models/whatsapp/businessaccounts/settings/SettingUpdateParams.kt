...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun webhookEnabled(): Optional<Boolean> = body.webhookEnabled()

    /**
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun webhookEvents(): Optional<List<String>> = body.webhookEvents()
     ...
     */
    fun _webhookEnabled(): JsonField<Boolean> = body._webhookEnabled()
     ...
     */
    fun _webhookEvents(): JsonField<List<String>> = body._webhookEvents()
    ...
    class Builder internal constructor() {
        ...
        /** Enable/disable receiving Whatsapp events */
        fun webhookEnabled(webhookEnabled: Boolean) = apply { body.webhookEnabled(webhookEnabled) }
        ...
        fun webhookEvents(webhookEvents: List<String>) = apply { body.webhookEvents(webhookEvents) }
         ...
         */
        fun addWebhookEvent(webhookEvent: String) = apply { body.addWebhookEvent(webhookEvent) }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{name=$name, timezone=$timezone, webhookEnabled=$webhookEnabled, webhookEvents=$webhookEvents, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "SettingUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
