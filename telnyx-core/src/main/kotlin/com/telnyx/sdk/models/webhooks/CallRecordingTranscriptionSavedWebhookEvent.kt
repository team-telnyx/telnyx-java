...
private constructor(
    private val data: JsonField<CallRecordingTranscriptionSaved>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CallRecordingTranscriptionSaved> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallRecordingTranscriptionSaved> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<CallRecordingTranscriptionSaved> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallRecordingTranscriptionSaved> = JsonMissing.of()
        ...
        fun data(data: CallRecordingTranscriptionSaved) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * [CallRecordingTranscriptionSaved] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<CallRecordingTranscriptionSaved>) = apply { this.data = data }
