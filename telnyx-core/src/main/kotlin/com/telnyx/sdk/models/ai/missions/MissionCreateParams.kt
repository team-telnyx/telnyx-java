...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissionCreateParams].
         *
    ...
    /** A builder for [MissionCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionCreateParams: MissionCreateParams) = apply {
            body = missionCreateParams.body.toBuilder()
            additionalHeaders = missionCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = missionCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MissionCreateParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, description, executionMode, instructions, metadata, model, mutableMapOf())
        ...
        override fun toString() =
            "Body{name=$name, description=$description, executionMode=$executionMode, instructions=$instructions, metadata=$metadata, model=$model, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MissionCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MissionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
