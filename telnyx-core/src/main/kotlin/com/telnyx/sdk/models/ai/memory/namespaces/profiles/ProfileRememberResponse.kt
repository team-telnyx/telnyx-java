...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfileRememberResponse].
         *
    ...
    /** A builder for [ProfileRememberResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(profileRememberResponse: ProfileRememberResponse) = apply {
            data = profileRememberResponse.data
            additionalProperties = profileRememberResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileRememberResponse].
         *
         ...
         */
        fun build(): ProfileRememberResponse =
     ...
     *   expected type.
     */
    fun validate(): ProfileRememberResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(operationId, profileId, sourceId, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(operationId, profileId, sourceId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{operationId=$operationId, profileId=$profileId, sourceId=$sourceId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileRememberResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ProfileRememberResponse{data=$data, additionalProperties=$additionalProperties}"
}
