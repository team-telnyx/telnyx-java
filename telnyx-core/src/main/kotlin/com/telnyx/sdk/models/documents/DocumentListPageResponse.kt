...
private constructor(
    private val data: JsonField<List<DocServiceDocument>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<DocServiceDocument>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<DocServiceDocument>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<DocServiceDocument>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<DocServiceDocument>>? = null
        ...
        internal fun from(documentListPageResponse: DocumentListPageResponse) = apply {
            ...
            meta = documentListPageResponse.meta
            additionalProperties = documentListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<DocServiceDocument>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<DocServiceDocument>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<DocServiceDocument>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [DocServiceDocument] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: DocServiceDocument) = apply {
            this.data =
    ...
    override fun toString() =
        "DocumentListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
