...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallReferStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallReferStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callReferStarted: CallReferStarted) = apply {
            id = callReferStarted.id
            eventType = callReferStarted.eventType
            occurredAt = callReferStarted.occurredAt
            payload = callReferStarted.payload
            recordType = callReferStarted.recordType
            additionalProperties = callReferStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallReferStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallReferStarted =
            CallReferStarted(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallReferStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_REFER_STARTED = of("call.refer.started")
        ...
        fun value(): Value =
            when (this) {
                CALL_REFER_STARTED -> Value.CALL_REFER_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_REFER_STARTED -> Known.CALL_REFER_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReferStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallReferStarted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
