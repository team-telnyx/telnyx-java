...
class AiListConversationHistoriesPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AiListConversationHistoriesResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AiListConversationHistoriesResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AiListConversationHistoriesResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AiListConversationHistoriesResponse>> = data
    ...
    companion object {
         ...
         * [AiListConversationHistoriesPageResponse].
         *
    ...
    /** A builder for [AiListConversationHistoriesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AiListConversationHistoriesResponse>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            aiListConversationHistoriesPageResponse: AiListConversationHistoriesPageResponse
        ) = apply {
            data = aiListConversationHistoriesPageResponse.data.map { it.toMutableList() }
            meta = aiListConversationHistoriesPageResponse.meta
            additionalProperties =
                aiListConversationHistoriesPageResponse.additionalProperties.toMutableMap()
        }

        /** Ranked list of matching text chunks, sorted by cosine similarity score descending. */
        fun data(data: List<AiListConversationHistoriesResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<AiListConversationHistoriesResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<AiListConversationHistoriesResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AiListConversationHistoriesResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AiListConversationHistoriesResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AiListConversationHistoriesPageResponse].
         *
         ...
         */
        fun build(): AiListConversationHistoriesPageResponse =
            AiListConversationHistoriesPageResponse(
     ...
     *   expected type.
     */
    fun validate(): AiListConversationHistoriesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AiListConversationHistoriesPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AiListConversationHistoriesPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
