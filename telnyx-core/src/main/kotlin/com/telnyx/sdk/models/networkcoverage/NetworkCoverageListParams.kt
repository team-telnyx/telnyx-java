...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(networkCoverageListParams: NetworkCoverageListParams) = apply {
            ...
            pageNumber = networkCoverageListParams.pageNumber
            pageSize = networkCoverageListParams.pageSize
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Contains
            private constructor(
                private val contains: AvailableService?,
                private val additionalProperties: QueryParams,
            ) {
    ...
    override fun toString() =
        "NetworkCoverageListParams{filter=$filter, filters=$filters, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
