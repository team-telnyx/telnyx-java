...
/**
 * Import job. Schema fields hidden: `account_id`, `csv_content`, `block_ttl_days`. Nullable fields
 * use the omit-nullable pattern.
 */
class EmailBlockImport
...
private constructor(
     ...
     *
     * Unlike [createdCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("created_count")
    @ExcludeMissing
     ...
     *
     * Unlike [existingCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("existing_count")
    @ExcludeMissing
     ...
     *
     * Unlike [skippedCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("skipped_count")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailBlockImport].
         *
    ...
    /** A builder for [EmailBlockImport]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailBlockImport: EmailBlockImport) = apply {
            id = emailBlockImport.id
            createdAt = emailBlockImport.createdAt
            recordType = emailBlockImport.recordType
            status = emailBlockImport.status
            total = emailBlockImport.total
            updatedAt = emailBlockImport.updatedAt
            completedAt = emailBlockImport.completedAt
            createdCount = emailBlockImport.createdCount
            errorCount = emailBlockImport.errorCount
            errors = emailBlockImport.errors
            existingCount = emailBlockImport.existingCount
            failureReason = emailBlockImport.failureReason
            processedRows = emailBlockImport.processedRows
            provider = emailBlockImport.provider
            skippedCount = emailBlockImport.skippedCount
            additionalProperties = emailBlockImport.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.createdCount] with a well-typed [Long] value instead.
         ...
         *
         * You should usually call [Builder.existingCount] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.skippedCount] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun skippedCount(skippedCount: JsonField<Long>) = apply { this.skippedCount = skippedCount }
        ...
        /**
         * Returns an immutable instance of [EmailBlockImport].
         *
     ...
     *   expected type.
     */
    fun validate(): EmailBlockImport = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailBlockImport &&
            id == other.id &&
