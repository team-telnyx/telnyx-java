...
private constructor(
    private val data: JsonField<List<NumberListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<NumberListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<NumberListResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<NumberListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<NumberListResponse>>? = null
        ...
        fun data(data: List<NumberListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<NumberListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<NumberListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [NumberListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: NumberListResponse) = apply {
            this.data =
