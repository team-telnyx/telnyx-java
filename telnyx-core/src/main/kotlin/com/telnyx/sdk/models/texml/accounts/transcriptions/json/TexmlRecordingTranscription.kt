...
class TexmlRecordingTranscription
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TexmlRecordingTranscription].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TexmlRecordingTranscription]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(texmlRecordingTranscription: TexmlRecordingTranscription) = apply {
            accountSid = texmlRecordingTranscription.accountSid
            apiVersion = texmlRecordingTranscription.apiVersion
            callSid = texmlRecordingTranscription.callSid
            dateCreated = texmlRecordingTranscription.dateCreated
            dateUpdated = texmlRecordingTranscription.dateUpdated
            duration = texmlRecordingTranscription.duration
            recordingSid = texmlRecordingTranscription.recordingSid
            sid = texmlRecordingTranscription.sid
            status = texmlRecordingTranscription.status
            transcriptionText = texmlRecordingTranscription.transcriptionText
            uri = texmlRecordingTranscription.uri
            additionalProperties = texmlRecordingTranscription.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TexmlRecordingTranscription].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlRecordingTranscription =
     ...
     *   expected type.
     */
    fun validate(): TexmlRecordingTranscription = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlRecordingTranscription &&
    ...
    override fun toString() =
        "TexmlRecordingTranscription{accountSid=$accountSid, apiVersion=$apiVersion, callSid=$callSid, dateCreated=$dateCreated, dateUpdated=$dateUpdated, duration=$duration, recordingSid=$recordingSid, sid=$sid, status=$status, transcriptionText=$transcriptionText, uri=$uri, additionalProperties=$additionalProperties}"
}
