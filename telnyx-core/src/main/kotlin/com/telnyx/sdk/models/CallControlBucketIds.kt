...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallControlBucketIds].
         *
    ...
    /** A builder for [CallControlBucketIds]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callControlBucketIds: CallControlBucketIds) = apply {
            bucketIds = callControlBucketIds.bucketIds.map { it.toMutableList() }
            maxNumResults = callControlBucketIds.maxNumResults
            additionalProperties = callControlBucketIds.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallControlBucketIds].
         *
         ...
         */
        fun build(): CallControlBucketIds =
    ...
    fun validate(): CallControlBucketIds = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallControlBucketIds &&
    ...
    override fun toString() =
        "CallControlBucketIds{bucketIds=$bucketIds, maxNumResults=$maxNumResults, additionalProperties=$additionalProperties}"
}
