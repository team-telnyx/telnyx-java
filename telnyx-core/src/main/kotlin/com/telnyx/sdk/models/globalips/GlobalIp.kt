...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(globalIp: GlobalIp) = apply {
            ...
            description = globalIp.description
            ipAddress = globalIp.ipAddress
            name = globalIp.name
            ports = globalIp.ports
    ...
    override fun toString() =
        "GlobalIp{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, description=$description, ipAddress=$ipAddress, name=$name, ports=$ports, additionalProperties=$additionalProperties}"
}
