...
class BrandRetrieveSmsOtpStatusResponse
...
private constructor(
    ...
    /** A builder for [BrandRetrieveSmsOtpStatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandRetrieveSmsOtpStatusResponse: BrandRetrieveSmsOtpStatusResponse) =
            apply {
                brandId = brandRetrieveSmsOtpStatusResponse.brandId
                deliveryStatus = brandRetrieveSmsOtpStatusResponse.deliveryStatus
                mobilePhone = brandRetrieveSmsOtpStatusResponse.mobilePhone
                referenceId = brandRetrieveSmsOtpStatusResponse.referenceId
                requestDate = brandRetrieveSmsOtpStatusResponse.requestDate
                deliveryStatusDate = brandRetrieveSmsOtpStatusResponse.deliveryStatusDate
                deliveryStatusDetails = brandRetrieveSmsOtpStatusResponse.deliveryStatusDetails
                verifyDate = brandRetrieveSmsOtpStatusResponse.verifyDate
                additionalProperties =
                    brandRetrieveSmsOtpStatusResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BrandRetrieveSmsOtpStatusResponse].
         *
         ...
         */
        fun build(): BrandRetrieveSmsOtpStatusResponse =
            BrandRetrieveSmsOtpStatusResponse(
    ...
    fun validate(): BrandRetrieveSmsOtpStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandRetrieveSmsOtpStatusResponse &&
    ...
    override fun toString() =
        "BrandRetrieveSmsOtpStatusResponse{brandId=$brandId, deliveryStatus=$deliveryStatus, mobilePhone=$mobilePhone, referenceId=$referenceId, requestDate=$requestDate, deliveryStatusDate=$deliveryStatusDate, deliveryStatusDetails=$deliveryStatusDetails, verifyDate=$verifyDate, additionalProperties=$additionalProperties}"
}
