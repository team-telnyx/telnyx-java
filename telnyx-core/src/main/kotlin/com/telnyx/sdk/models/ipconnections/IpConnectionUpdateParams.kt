...
class IpConnectionUpdateParams
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun inbound(): Optional<InboundIp> = body.inbound()
     ...
     */
    fun _inbound(): JsonField<InboundIp> = body._inbound()
    ...
    companion object {
        ...
        @JvmStatic fun none(): IpConnectionUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IpConnectionUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IpConnectionUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ipConnectionUpdateParams: IpConnectionUpdateParams) = apply {
            id = ipConnectionUpdateParams.id
            body = ipConnectionUpdateParams.body.toBuilder()
            additionalHeaders = ipConnectionUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = ipConnectionUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun inbound(inbound: InboundIp) = apply { body.inbound(inbound) }
         ...
         * value.
         */
        fun inbound(inbound: JsonField<InboundIp>) = apply { body.inbound(inbound) }
        ...
        /**
         * Returns an immutable instance of [IpConnectionUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IpConnectionUpdateParams =
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            inbound: JsonField<InboundIp> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.inbound] to an arbitrary JSON value.
             *
             * You should usually call [Builder.inbound] with a well-typed [InboundIp] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IpConnectionUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "IpConnectionUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
