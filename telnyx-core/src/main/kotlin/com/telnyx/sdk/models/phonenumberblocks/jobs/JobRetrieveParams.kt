...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): JobRetrieveParams =
            JobRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "JobRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
