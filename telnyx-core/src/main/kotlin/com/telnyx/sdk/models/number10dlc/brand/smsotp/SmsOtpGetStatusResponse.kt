...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SmsOtpGetStatusResponse].
         *
    ...
    /** A builder for [SmsOtpGetStatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(smsOtpGetStatusResponse: SmsOtpGetStatusResponse) = apply {
            brandId = smsOtpGetStatusResponse.brandId
            deliveryStatus = smsOtpGetStatusResponse.deliveryStatus
            mobilePhone = smsOtpGetStatusResponse.mobilePhone
            referenceId = smsOtpGetStatusResponse.referenceId
            requestDate = smsOtpGetStatusResponse.requestDate
            deliveryStatusDate = smsOtpGetStatusResponse.deliveryStatusDate
            deliveryStatusDetails = smsOtpGetStatusResponse.deliveryStatusDetails
            verifyDate = smsOtpGetStatusResponse.verifyDate
            additionalProperties = smsOtpGetStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SmsOtpGetStatusResponse].
         *
         ...
         */
        fun build(): SmsOtpGetStatusResponse =
    ...
    fun validate(): SmsOtpGetStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SmsOtpGetStatusResponse &&
    ...
    override fun toString() =
        "SmsOtpGetStatusResponse{brandId=$brandId, deliveryStatus=$deliveryStatus, mobilePhone=$mobilePhone, referenceId=$referenceId, requestDate=$requestDate, deliveryStatusDate=$deliveryStatusDate, deliveryStatusDetails=$deliveryStatusDetails, verifyDate=$verifyDate, additionalProperties=$additionalProperties}"
}
