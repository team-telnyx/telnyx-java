...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VoiceDesignSummaryData]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceDesignSummaryData]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceDesignSummaryData: VoiceDesignSummaryData) = apply {
            id = voiceDesignSummaryData.id
            createdAt = voiceDesignSummaryData.createdAt
            name = voiceDesignSummaryData.name
            provider = voiceDesignSummaryData.provider
            providerSupportedModels =
                voiceDesignSummaryData.providerSupportedModels.map { it.toMutableList() }
            recordType = voiceDesignSummaryData.recordType
            updatedAt = voiceDesignSummaryData.updatedAt
            additionalProperties = voiceDesignSummaryData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceDesignSummaryData].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceDesignSummaryData =
     ...
     *   expected type.
     */
    fun validate(): VoiceDesignSummaryData = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceDesignSummaryData &&
            id == other.id &&
    ...
    override fun toString() =
        "VoiceDesignSummaryData{id=$id, createdAt=$createdAt, name=$name, provider=$provider, providerSupportedModels=$providerSupportedModels, recordType=$recordType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
