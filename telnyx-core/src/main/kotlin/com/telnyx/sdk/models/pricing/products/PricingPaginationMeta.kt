...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PricingPaginationMeta].
         *
    ...
    /** A builder for [PricingPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pricingPaginationMeta: PricingPaginationMeta) = apply {
            pageNumber = pricingPaginationMeta.pageNumber
            pageSize = pricingPaginationMeta.pageSize
            totalPages = pricingPaginationMeta.totalPages
            totalResults = pricingPaginationMeta.totalResults
            additionalProperties = pricingPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PricingPaginationMeta].
         *
         ...
         */
        fun build(): PricingPaginationMeta =
     ...
     *   expected type.
     */
    fun validate(): PricingPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PricingPaginationMeta &&
    ...
    override fun toString() =
        "PricingPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
