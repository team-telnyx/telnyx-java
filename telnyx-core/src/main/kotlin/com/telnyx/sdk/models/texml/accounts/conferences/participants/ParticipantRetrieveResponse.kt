...
class ParticipantRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParticipantRetrieveResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ParticipantRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantRetrieveResponse: ParticipantRetrieveResponse) = apply {
            accountSid = participantRetrieveResponse.accountSid
            apiVersion = participantRetrieveResponse.apiVersion
            callSid = participantRetrieveResponse.callSid
            callSidLegacy = participantRetrieveResponse.callSidLegacy
            ...
            hold = participantRetrieveResponse.hold
            muted = participantRetrieveResponse.muted
            status = participantRetrieveResponse.status
            uri = participantRetrieveResponse.uri
            additionalProperties = participantRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ParticipantRetrieveResponse =
    ...
    fun validate(): ParticipantRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantRetrieveResponse &&
