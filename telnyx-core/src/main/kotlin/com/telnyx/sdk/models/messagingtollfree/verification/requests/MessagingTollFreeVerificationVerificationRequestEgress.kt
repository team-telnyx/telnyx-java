...
class MessagingTollFreeVerificationVerificationRequestEgress
...
private constructor(
    ...
    /** A builder for [MessagingTollFreeVerificationVerificationRequestEgress]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = messagingTollFreeVerificationVerificationRequestEgress.id
            additionalInformation =
                messagingTollFreeVerificationVerificationRequestEgress.additionalInformation
            businessAddr1 = messagingTollFreeVerificationVerificationRequestEgress.businessAddr1
            businessCity = messagingTollFreeVerificationVerificationRequestEgress.businessCity
            businessContactEmail =
                messagingTollFreeVerificationVerificationRequestEgress.businessContactEmail
            businessContactFirstName =
                messagingTollFreeVerificationVerificationRequestEgress.businessContactFirstName
            businessContactLastName =
                messagingTollFreeVerificationVerificationRequestEgress.businessContactLastName
            businessContactPhone =
                messagingTollFreeVerificationVerificationRequestEgress.businessContactPhone
            businessName = messagingTollFreeVerificationVerificationRequestEgress.businessName
            businessState = messagingTollFreeVerificationVerificationRequestEgress.businessState
            businessZip = messagingTollFreeVerificationVerificationRequestEgress.businessZip
            corporateWebsite =
                messagingTollFreeVerificationVerificationRequestEgress.corporateWebsite
            messageVolume = messagingTollFreeVerificationVerificationRequestEgress.messageVolume
            optInWorkflow = messagingTollFreeVerificationVerificationRequestEgress.optInWorkflow
            optInWorkflowImageUrls =
                messagingTollFreeVerificationVerificationRequestEgress.optInWorkflowImageUrls.map {
                    it.toMutableList()
                }
            phoneNumbers =
                messagingTollFreeVerificationVerificationRequestEgress.phoneNumbers.map {
                    it.toMutableList()
                }
            productionMessageContent =
                messagingTollFreeVerificationVerificationRequestEgress.productionMessageContent
            useCase = messagingTollFreeVerificationVerificationRequestEgress.useCase
            useCaseSummary = messagingTollFreeVerificationVerificationRequestEgress.useCaseSummary
            verificationRequestId =
                messagingTollFreeVerificationVerificationRequestEgress.verificationRequestId
            ageGatedContent = messagingTollFreeVerificationVerificationRequestEgress.ageGatedContent
            businessAddr2 = messagingTollFreeVerificationVerificationRequestEgress.businessAddr2
            businessRegistrationCountry =
            ...
            campaignVerifyAuthorizationToken =
                messagingTollFreeVerificationVerificationRequestEgress
                    .campaignVerifyAuthorizationToken
            doingBusinessAs = messagingTollFreeVerificationVerificationRequestEgress.doingBusinessAs
            entityType = messagingTollFreeVerificationVerificationRequestEgress.entityType
            helpMessageResponse =
                messagingTollFreeVerificationVerificationRequestEgress.helpMessageResponse
            isvReseller = messagingTollFreeVerificationVerificationRequestEgress.isvReseller
            optInConfirmationResponse =
                messagingTollFreeVerificationVerificationRequestEgress.optInConfirmationResponse
            optInKeywords = messagingTollFreeVerificationVerificationRequestEgress.optInKeywords
            privacyPolicyUrl =
                messagingTollFreeVerificationVerificationRequestEgress.privacyPolicyUrl
            termsAndConditionUrl =
                messagingTollFreeVerificationVerificationRequestEgress.termsAndConditionUrl
            verificationStatus =
                messagingTollFreeVerificationVerificationRequestEgress.verificationStatus
            webhookUrl = messagingTollFreeVerificationVerificationRequestEgress.webhookUrl
            additionalProperties =
                messagingTollFreeVerificationVerificationRequestEgress.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): MessagingTollFreeVerificationVerificationRequestEgress =
            MessagingTollFreeVerificationVerificationRequestEgress(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): MessagingTollFreeVerificationVerificationRequestEgress = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingTollFreeVerificationVerificationRequestEgress &&
            id == other.id &&
