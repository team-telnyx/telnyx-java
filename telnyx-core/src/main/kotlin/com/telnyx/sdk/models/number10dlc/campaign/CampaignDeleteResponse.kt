...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CampaignDeleteResponse].
         *
    ...
    /** A builder for [CampaignDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(campaignDeleteResponse: CampaignDeleteResponse) = apply {
            time = campaignDeleteResponse.time
            message = campaignDeleteResponse.message
            recordType = campaignDeleteResponse.recordType
            additionalProperties = campaignDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignDeleteResponse].
         *
         ...
         */
        fun build(): CampaignDeleteResponse =
    ...
    fun validate(): CampaignDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignDeleteResponse &&
            time == other.time &&
    ...
    override fun toString() =
        "CampaignDeleteResponse{time=$time, message=$message, recordType=$recordType, additionalProperties=$additionalProperties}"
}
