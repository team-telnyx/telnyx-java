...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("ref_type") @ExcludeMissing refType: JsonField<RefType> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reference: Reference) = apply {
            ...
            relationshipToRegistrant = reference.relationshipToRegistrant
         ...
         *
         * You should usually call [Builder.refType] with a well-typed [RefType] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    override fun toString() =
        "Reference{fullName=$fullName, phoneE164=$phoneE164, recordType=$recordType, refType=$refType, slot=$slot, timezone=$timezone, email=$email, jobTitle=$jobTitle, organization=$organization, relationshipToRegistrant=$relationshipToRegistrant, additionalProperties=$additionalProperties}"
}
