...
private constructor(
    ...
    ) : this(fieldType, fieldValue, recordType, requirementStatus, requirementType, mutableMapOf())
     ...
     *   server responded with an unexpected value).
     */
    fun requirementStatus(): Optional<String> = requirementStatus.getOptional("requirement_status")
     ...
     *
     * Unlike [requirementType], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("requirement_type")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            fieldType = portingOrderRetrieveRequirementsResponse.fieldType
            fieldValue = portingOrderRetrieveRequirementsResponse.fieldValue
            recordType = portingOrderRetrieveRequirementsResponse.recordType
            requirementStatus = portingOrderRetrieveRequirementsResponse.requirementStatus
            requirementType = portingOrderRetrieveRequirementsResponse.requirementType
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * [AcceptanceCriteria] value instead. This method is primarily for setting the field to
    ...
    override fun toString() =
        "PortingOrderRetrieveRequirementsResponse{fieldType=$fieldType, fieldValue=$fieldValue, recordType=$recordType, requirementStatus=$requirementStatus, requirementType=$requirementType, additionalProperties=$additionalProperties}"
}
