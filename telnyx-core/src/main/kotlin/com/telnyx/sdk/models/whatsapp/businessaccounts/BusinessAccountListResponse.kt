...
class BusinessAccountListResponse
...
private constructor(
     ...
     *
     * Unlike [accountReviewStatus], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("account_review_status")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BusinessAccountListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BusinessAccountListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(businessAccountListResponse: BusinessAccountListResponse) = apply {
            id = businessAccountListResponse.id
            accountReviewStatus = businessAccountListResponse.accountReviewStatus
            businessVerificationStatus = businessAccountListResponse.businessVerificationStatus
            country = businessAccountListResponse.country
            createdAt = businessAccountListResponse.createdAt
            name = businessAccountListResponse.name
            phoneNumbersCount = businessAccountListResponse.phoneNumbersCount
            recordType = businessAccountListResponse.recordType
            status = businessAccountListResponse.status
            wabaId = businessAccountListResponse.wabaId
            additionalProperties = businessAccountListResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.accountReviewStatus] with a well-typed [String] value
         ...
         *
         * You should usually call [Builder.businessVerificationStatus] with a well-typed [String]
        ...
        /**
         * Returns an immutable instance of [BusinessAccountListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BusinessAccountListResponse =
    ...
    fun validate(): BusinessAccountListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BusinessAccountListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "BusinessAccountListResponse{id=$id, accountReviewStatus=$accountReviewStatus, businessVerificationStatus=$businessVerificationStatus, country=$country, createdAt=$createdAt, name=$name, phoneNumbersCount=$phoneNumbersCount, recordType=$recordType, status=$status, wabaId=$wabaId, additionalProperties=$additionalProperties}"
}
