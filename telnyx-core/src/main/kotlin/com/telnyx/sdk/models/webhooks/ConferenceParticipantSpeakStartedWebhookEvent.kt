...
private constructor(
    private val data: JsonField<ConferenceParticipantSpeakStarted>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<ConferenceParticipantSpeakStarted> = JsonMissing.of()
     ...
     */
    fun data(): Optional<ConferenceParticipantSpeakStarted> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<ConferenceParticipantSpeakStarted> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<ConferenceParticipantSpeakStarted> = JsonMissing.of()
        ...
        fun data(data: ConferenceParticipantSpeakStarted) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * [ConferenceParticipantSpeakStarted] value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<ConferenceParticipantSpeakStarted>) = apply { this.data = data }
