...
class ProfileAssignmentPhoneNumbers
...
private constructor(
    ...
    /** A builder for [ProfileAssignmentPhoneNumbers]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(profileAssignmentPhoneNumbers: ProfileAssignmentPhoneNumbers) = apply {
            phoneNumber = profileAssignmentPhoneNumbers.phoneNumber
            status = profileAssignmentPhoneNumbers.status
            taskId = profileAssignmentPhoneNumbers.taskId
            additionalProperties = profileAssignmentPhoneNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileAssignmentPhoneNumbers].
         *
         ...
         */
        fun build(): ProfileAssignmentPhoneNumbers =
            ProfileAssignmentPhoneNumbers(
    ...
    fun validate(): ProfileAssignmentPhoneNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileAssignmentPhoneNumbers &&
    ...
    override fun toString() =
        "ProfileAssignmentPhoneNumbers{phoneNumber=$phoneNumber, status=$status, taskId=$taskId, additionalProperties=$additionalProperties}"
}
