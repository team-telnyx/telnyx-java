    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField
                val CALL_MACHINE_PREMIUM_DETECTION_ENDED =
                    of("call.machine.premium.detection.ended")
            ...
            fun value(): Value =
                when (this) {
                    CALL_MACHINE_PREMIUM_DETECTION_ENDED ->
                        Value.CALL_MACHINE_PREMIUM_DETECTION_ENDED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_MACHINE_PREMIUM_DETECTION_ENDED ->
                        Known.CALL_MACHINE_PREMIUM_DETECTION_ENDED
