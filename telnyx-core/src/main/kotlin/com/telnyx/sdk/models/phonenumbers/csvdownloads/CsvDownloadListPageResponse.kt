...
class CsvDownloadListPageResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CsvDownloadListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CsvDownloadListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(csvDownloadListPageResponse: CsvDownloadListPageResponse) = apply {
            data = csvDownloadListPageResponse.data.map { it.toMutableList() }
            meta = csvDownloadListPageResponse.meta
            additionalProperties = csvDownloadListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CsvDownloadListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CsvDownloadListPageResponse =
            CsvDownloadListPageResponse(
    ...
    fun validate(): CsvDownloadListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CsvDownloadListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "CsvDownloadListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
