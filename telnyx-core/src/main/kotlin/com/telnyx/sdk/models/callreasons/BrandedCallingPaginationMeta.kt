 ...
 * 1-based. `page_size` reports the number of items actually returned in `data` for this page; the
 * requested size is taken from the `page[size]` query parameter.
 */
class BrandedCallingPaginationMeta
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandedCallingPaginationMeta].
         *
    ...
    /** A builder for [BrandedCallingPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandedCallingPaginationMeta: BrandedCallingPaginationMeta) = apply {
            pageNumber = brandedCallingPaginationMeta.pageNumber
            pageSize = brandedCallingPaginationMeta.pageSize
            totalPages = brandedCallingPaginationMeta.totalPages
            totalResults = brandedCallingPaginationMeta.totalResults
            additionalProperties = brandedCallingPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandedCallingPaginationMeta].
         *
         ...
         */
        fun build(): BrandedCallingPaginationMeta =
     ...
     *   expected type.
     */
    fun validate(): BrandedCallingPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandedCallingPaginationMeta &&
    ...
    override fun toString() =
        "BrandedCallingPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
