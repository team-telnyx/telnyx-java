...
class NotificationEventConditionListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NotificationEventConditionListParams = builder().build()
    ...
    /** A builder for [NotificationEventConditionListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            pageNumber = notificationEventConditionListParams.pageNumber
            pageSize = notificationEventConditionListParams.pageSize
            additionalHeaders = notificationEventConditionListParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                notificationEventConditionListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NotificationEventConditionListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NotificationEventConditionListParams =
            NotificationEventConditionListParams(
                filter,
                pageNumber,
                pageSize,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NotificationEventConditionListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "NotificationEventConditionListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
