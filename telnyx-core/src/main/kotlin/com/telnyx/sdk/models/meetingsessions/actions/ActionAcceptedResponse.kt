...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ActionAcceptedResponse =
            ActionAcceptedResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Data =
                Data(checkRequired("accepted", accepted), additionalProperties.toMutableMap())
        }
         ...
         * Used for best match union deserialization.
         */
        @JvmSynthetic internal fun validity(): Int = (if (accepted.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(accepted, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{accepted=$accepted, additionalProperties=$additionalProperties}"
    }
