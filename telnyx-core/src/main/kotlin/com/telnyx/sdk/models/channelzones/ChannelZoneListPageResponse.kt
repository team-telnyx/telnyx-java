...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChannelZoneListPageResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(channelZoneListPageResponse: ChannelZoneListPageResponse) = apply {
            data = channelZoneListPageResponse.data.map { it.toMutableList() }
            meta = channelZoneListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [ChannelZoneListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ChannelZoneListPageResponse =
            ChannelZoneListPageResponse(
    ...
    fun validate(): ChannelZoneListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChannelZoneListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ChannelZoneListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
