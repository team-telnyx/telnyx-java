...
/**
 * The main text content of the message. Supports multiple variable parameters ({{1}}, {{2}}, etc.).
 * Variables cannot be at the start or end. Maximum 1024 characters.
 */
...
private constructor(
    ...
    /**
     * Body text content. Use {{1}}, {{2}}, etc. for variable placeholders. Required for MARKETING
     * and UTILITY templates. Optional for AUTHENTICATION templates where Meta provides the built-in
     * OTP body.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(whatsappTemplateBodyComponent: WhatsappTemplateBodyComponent) = apply {
            ...
            additionalProperties = whatsappTemplateBodyComponent.additionalProperties.toMutableMap()
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.bodyText] with a well-typed `List<List<String>>`
    ...
    private val hashCode: Int by lazy { Objects.hash(type, example, text, additionalProperties) }
