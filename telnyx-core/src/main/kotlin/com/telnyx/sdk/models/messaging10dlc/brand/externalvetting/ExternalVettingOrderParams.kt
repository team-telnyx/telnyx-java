...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalVettingOrderParams].
         *
    ...
    /** A builder for [ExternalVettingOrderParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVettingOrderParams: ExternalVettingOrderParams) = apply {
            brandId = externalVettingOrderParams.brandId
            body = externalVettingOrderParams.body.toBuilder()
            additionalHeaders = externalVettingOrderParams.additionalHeaders.toBuilder()
            additionalQueryParams = externalVettingOrderParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingOrderParams].
         *
         ...
         */
        fun build(): ExternalVettingOrderParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingOrderParams &&
    ...
    override fun toString() =
        "ExternalVettingOrderParams{brandId=$brandId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
