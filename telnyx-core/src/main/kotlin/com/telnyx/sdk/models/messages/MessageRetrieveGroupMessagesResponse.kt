...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = messageRetrieveGroupMessagesResponse.data.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [MessageRetrieveGroupMessagesResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessageRetrieveGroupMessagesResponse =
            MessageRetrieveGroupMessagesResponse(
    ...
    fun validate(): MessageRetrieveGroupMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageRetrieveGroupMessagesResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MessageRetrieveGroupMessagesResponse{data=$data, additionalProperties=$additionalProperties}"
}
