...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MobileVoiceConnection]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MobileVoiceConnection]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mobileVoiceConnection: MobileVoiceConnection) = apply {
            id = mobileVoiceConnection.id
            active = mobileVoiceConnection.active
            connectionName = mobileVoiceConnection.connectionName
            createdAt = mobileVoiceConnection.createdAt
            inbound = mobileVoiceConnection.inbound
            outbound = mobileVoiceConnection.outbound
            recordType = mobileVoiceConnection.recordType
            tags = mobileVoiceConnection.tags.map { it.toMutableList() }
            updatedAt = mobileVoiceConnection.updatedAt
            webhookApiVersion = mobileVoiceConnection.webhookApiVersion
            webhookEventFailoverUrl = mobileVoiceConnection.webhookEventFailoverUrl
            webhookEventUrl = mobileVoiceConnection.webhookEventUrl
            webhookTimeoutSecs = mobileVoiceConnection.webhookTimeoutSecs
            additionalProperties = mobileVoiceConnection.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MobileVoiceConnection].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobileVoiceConnection =
    ...
    fun validate(): MobileVoiceConnection = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobileVoiceConnection &&
            id == other.id &&
            active == other.active &&
