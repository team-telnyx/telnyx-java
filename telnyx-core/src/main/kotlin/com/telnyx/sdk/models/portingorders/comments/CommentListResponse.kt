...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commentListResponse: CommentListResponse) = apply {
            ...
            body = commentListResponse.body
            createdAt = commentListResponse.createdAt
            portingOrderId = commentListResponse.portingOrderId
            recordType = commentListResponse.recordType
            userType = commentListResponse.userType
    ...
    override fun toString() =
        "CommentListResponse{id=$id, body=$body, createdAt=$createdAt, portingOrderId=$portingOrderId, recordType=$recordType, userType=$userType, additionalProperties=$additionalProperties}"
}
