...
private constructor(
    private val uploadParams: JsonValue,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun uploadParams(): JsonValue = uploadParams
    ...
    class Builder internal constructor() {
        ...
        private var uploadParams: JsonValue? = null
        ...
        fun uploadParams(uploadParams: JsonValue) = apply { this.uploadParams = uploadParams }
    ...
    fun _body(): Map<String, MultipartField<*>> =
        mapOf("upload_params" to MultipartField.of(uploadParams)).toImmutable()
