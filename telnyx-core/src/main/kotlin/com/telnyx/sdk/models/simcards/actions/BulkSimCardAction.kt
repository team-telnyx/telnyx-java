...
/**
 * This object represents a bulk SIM card action. It groups SIM card actions created through a bulk
 * endpoint under a single resource for further lookup.
 */
class BulkSimCardAction
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BulkSimCardAction]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BulkSimCardAction]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkSimCardAction: BulkSimCardAction) = apply {
            id = bulkSimCardAction.id
            actionType = bulkSimCardAction.actionType
            createdAt = bulkSimCardAction.createdAt
            recordType = bulkSimCardAction.recordType
            settings = bulkSimCardAction.settings
            updatedAt = bulkSimCardAction.updatedAt
            additionalProperties = bulkSimCardAction.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BulkSimCardAction].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BulkSimCardAction =
            BulkSimCardAction(
                id,
                actionType,
                createdAt,
    ...
    fun validate(): BulkSimCardAction = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkSimCardAction &&
            id == other.id &&
    ...
    override fun toString() =
        "BulkSimCardAction{id=$id, actionType=$actionType, createdAt=$createdAt, recordType=$recordType, settings=$settings, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
