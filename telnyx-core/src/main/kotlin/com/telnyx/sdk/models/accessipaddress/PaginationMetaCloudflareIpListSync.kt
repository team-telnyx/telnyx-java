...
class PaginationMetaCloudflareIpListSync
...
private constructor(
    ...
    /** A builder for [PaginationMetaCloudflareIpListSync]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paginationMetaCloudflareIpListSync: PaginationMetaCloudflareIpListSync) =
            apply {
                pageNumber = paginationMetaCloudflareIpListSync.pageNumber
                pageSize = paginationMetaCloudflareIpListSync.pageSize
                totalPages = paginationMetaCloudflareIpListSync.totalPages
                totalResults = paginationMetaCloudflareIpListSync.totalResults
                additionalProperties =
                    paginationMetaCloudflareIpListSync.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PaginationMetaCloudflareIpListSync].
         *
         ...
         */
        fun build(): PaginationMetaCloudflareIpListSync =
            PaginationMetaCloudflareIpListSync(
    ...
    fun validate(): PaginationMetaCloudflareIpListSync = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaginationMetaCloudflareIpListSync &&
    ...
    override fun toString() =
        "PaginationMetaCloudflareIpListSync{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
