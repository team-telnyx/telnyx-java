...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AdvancedOrderRequest]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AdvancedOrderRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(advancedOrderRequest: AdvancedOrderRequest) = apply {
            areaCode = advancedOrderRequest.areaCode
            comments = advancedOrderRequest.comments
            countryCode = advancedOrderRequest.countryCode
            customerReference = advancedOrderRequest.customerReference
            features = advancedOrderRequest.features.map { it.toMutableList() }
            phoneNumberType = advancedOrderRequest.phoneNumberType
            quantity = advancedOrderRequest.quantity
            requirementGroupId = advancedOrderRequest.requirementGroupId
            additionalProperties = advancedOrderRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AdvancedOrderRequest].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AdvancedOrderRequest =
     ...
     *   expected type.
     */
    fun validate(): AdvancedOrderRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdvancedOrderRequest &&
    ...
    override fun toString() =
        "AdvancedOrderRequest{areaCode=$areaCode, comments=$comments, countryCode=$countryCode, customerReference=$customerReference, features=$features, phoneNumberType=$phoneNumberType, quantity=$quantity, requirementGroupId=$requirementGroupId, additionalProperties=$additionalProperties}"
}
