...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RegionIn]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RegionIn]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(regionIn: RegionIn) = apply {
            regionCode = regionIn.regionCode
            additionalProperties = regionIn.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RegionIn].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RegionIn = RegionIn(regionCode, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): RegionIn = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "RegionIn{regionCode=$regionCode, additionalProperties=$additionalProperties}"
}
