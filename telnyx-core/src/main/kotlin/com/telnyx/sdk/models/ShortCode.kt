...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShortCode].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(shortCode: ShortCode) = apply {
            messagingProfileId = shortCode.messagingProfileId
            id = shortCode.id
        ...
        /**
         * Returns an immutable instance of [ShortCode].
         *
    ...
    class RecordType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SHORT_CODE = of("short_code")
