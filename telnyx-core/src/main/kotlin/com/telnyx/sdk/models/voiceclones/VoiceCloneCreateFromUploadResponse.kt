...
private constructor(
    ...
    /** A builder for [VoiceCloneCreateFromUploadResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceCloneCreateFromUploadResponse: VoiceCloneCreateFromUploadResponse) =
            apply {
                data = voiceCloneCreateFromUploadResponse.data
                additionalProperties =
                    voiceCloneCreateFromUploadResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [VoiceCloneCreateFromUploadResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceCloneCreateFromUploadResponse =
            VoiceCloneCreateFromUploadResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): VoiceCloneCreateFromUploadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceCloneCreateFromUploadResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VoiceCloneCreateFromUploadResponse{data=$data, additionalProperties=$additionalProperties}"
}
