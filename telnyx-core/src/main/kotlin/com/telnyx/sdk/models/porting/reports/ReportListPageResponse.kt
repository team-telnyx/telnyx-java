...
private constructor(
    private val data: JsonField<List<PortingReport>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PortingReport>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<PortingReport>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PortingReport>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PortingReport>>? = null
        ...
        internal fun from(reportListPageResponse: ReportListPageResponse) = apply {
            data = reportListPageResponse.data.map { it.toMutableList() }
            meta = reportListPageResponse.meta
            additionalProperties = reportListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<PortingReport>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PortingReport>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<PortingReport>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PortingReport] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PortingReport) = apply {
            this.data =
    ...
    override fun toString() =
        "ReportListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
