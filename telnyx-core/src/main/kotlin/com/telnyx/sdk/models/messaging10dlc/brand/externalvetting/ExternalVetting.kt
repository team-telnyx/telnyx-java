...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ExternalVetting]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExternalVetting]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVetting: ExternalVetting) = apply {
            createDate = externalVetting.createDate
            evpId = externalVetting.evpId
            vettedDate = externalVetting.vettedDate
            vettingClass = externalVetting.vettingClass
            vettingId = externalVetting.vettingId
            vettingScore = externalVetting.vettingScore
            vettingToken = externalVetting.vettingToken
            additionalProperties = externalVetting.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVetting].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVetting =
            ExternalVetting(
                createDate,
                evpId,
                vettedDate,
     ...
     *   expected type.
     */
    fun validate(): ExternalVetting = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVetting &&
    ...
    override fun toString() =
        "ExternalVetting{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
