...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CampaignStatusUpdate]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CampaignStatusUpdate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(campaignStatusUpdate: CampaignStatusUpdate) = apply {
            brandId = campaignStatusUpdate.brandId
            campaignId = campaignStatusUpdate.campaignId
            createDate = campaignStatusUpdate.createDate
            cspId = campaignStatusUpdate.cspId
            description = campaignStatusUpdate.description
            isTMobileRegistered = campaignStatusUpdate.isTMobileRegistered
            status = campaignStatusUpdate.status
            type = campaignStatusUpdate.type
            additionalProperties = campaignStatusUpdate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignStatusUpdate].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CampaignStatusUpdate =
    ...
    fun validate(): CampaignStatusUpdate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignStatusUpdate &&
    ...
    override fun toString() =
        "CampaignStatusUpdate{brandId=$brandId, campaignId=$campaignId, createDate=$createDate, cspId=$cspId, description=$description, isTMobileRegistered=$isTMobileRegistered, status=$status, type=$type, additionalProperties=$additionalProperties}"
}
