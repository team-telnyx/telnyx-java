...
private constructor(
    private val data: JsonField<CallSpeakEnded>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CallSpeakEnded> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallSpeakEnded> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CallSpeakEnded> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallSpeakEnded> = JsonMissing.of()
        ...
        fun data(data: CallSpeakEnded) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CallSpeakEnded] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<CallSpeakEnded>) = apply { this.data = data }
