...
class AdditionalDocumentListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AdditionalDocumentListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AdditionalDocumentListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AdditionalDocumentListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(additionalDocumentListParams: AdditionalDocumentListParams) = apply {
            id = additionalDocumentListParams.id
            filter = additionalDocumentListParams.filter
            pageNumber = additionalDocumentListParams.pageNumber
            pageSize = additionalDocumentListParams.pageSize
            sort = additionalDocumentListParams.sort
            additionalHeaders = additionalDocumentListParams.additionalHeaders.toBuilder()
            additionalQueryParams = additionalDocumentListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AdditionalDocumentListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AdditionalDocumentListParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                filter?.let {
                    it.documentType().ifPresent {
                        put("filter[document_type]", it.joinToString(",") { it.toString() })
                    }
    ...
    class Filter
    private constructor(
        private val documentType: List<DocumentType>?,
        private val additionalProperties: QueryParams,
    ) {

        /** Filter additional documents by a list of document types */
        fun documentType(): Optional<List<DocumentType>> = Optional.ofNullable(documentType)
        ...
        class Builder internal constructor() {
            ...
            private var documentType: MutableList<DocumentType>? = null
            private var additionalProperties: QueryParams.Builder = QueryParams.builder()

            @JvmSynthetic
            internal fun from(filter: Filter) = apply {
                documentType = filter.documentType?.toMutableList()
                additionalProperties = filter.additionalProperties.toBuilder()
            }

            /** Filter additional documents by a list of document types */
            fun documentType(documentType: List<DocumentType>?) = apply {
                this.documentType = documentType?.toMutableList()
            }

            /** Alias for calling [Builder.documentType] with `documentType.orElse(null)`. */
            fun documentType(documentType: Optional<List<DocumentType>>) =
                documentType(documentType.getOrNull())

            /**
             * Adds a single [DocumentType] to [Builder.documentType].
             *
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addDocumentType(documentType: DocumentType) = apply {
                this.documentType =
                    (this.documentType ?: mutableListOf()).apply { add(documentType) }
            }
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Filter = Filter(documentType?.toImmutable(), additionalProperties.build())
        }
        ...
        override fun toString() =
            "Filter{documentType=$documentType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdditionalDocumentListParams &&
            id == other.id &&
            filter == other.filter &&
    ...
    override fun toString() =
        "AdditionalDocumentListParams{id=$id, filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
