...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(wireguardPeer: WireguardPeer) = apply {
            ...
            lastSeen = wireguardPeer.lastSeen
            privateKey = wireguardPeer.privateKey
            wireguardInterfaceId = wireguardPeer.wireguardInterfaceId
    ...
    override fun toString() =
        "WireguardPeer{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, lastSeen=$lastSeen, privateKey=$privateKey, wireguardInterfaceId=$wireguardInterfaceId, additionalProperties=$additionalProperties}"
}
