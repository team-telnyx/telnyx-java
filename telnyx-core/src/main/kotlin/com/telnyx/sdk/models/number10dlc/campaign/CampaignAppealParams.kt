...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CampaignAppealParams].
         *
    ...
    /** A builder for [CampaignAppealParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(campaignAppealParams: CampaignAppealParams) = apply {
            campaignId = campaignAppealParams.campaignId
            body = campaignAppealParams.body.toBuilder()
            additionalHeaders = campaignAppealParams.additionalHeaders.toBuilder()
            additionalQueryParams = campaignAppealParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignAppealParams].
         *
         ...
         */
        fun build(): CampaignAppealParams =
            CampaignAppealParams(
                campaignId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignAppealParams &&
    ...
    override fun toString() =
        "CampaignAppealParams{campaignId=$campaignId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
