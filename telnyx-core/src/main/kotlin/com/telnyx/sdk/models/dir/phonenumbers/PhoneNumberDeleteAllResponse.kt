 ...
 */
class PhoneNumberDeleteAllResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberDeleteAllResponse].
         *
    ...
    /** A builder for [PhoneNumberDeleteAllResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberDeleteAllResponse: PhoneNumberDeleteAllResponse) = apply {
            data = phoneNumberDeleteAllResponse.data.map { it.toMutableList() }
            meta = phoneNumberDeleteAllResponse.meta
            additionalProperties = phoneNumberDeleteAllResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberDeleteAllResponse].
         *
         ...
         */
        fun build(): PhoneNumberDeleteAllResponse =
            PhoneNumberDeleteAllResponse(
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberDeleteAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberDeleteAllResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PhoneNumberDeleteAllResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
