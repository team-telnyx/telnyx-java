...
class ExternalVettingExternalVettingParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun vettingClass(): String = body.vettingClass()
     ...
     */
    fun _vettingClass(): JsonField<String> = body._vettingClass()
    ...
    companion object {
         ...
         * [ExternalVettingExternalVettingParams].
         *
    ...
    /** A builder for [ExternalVettingExternalVettingParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            externalVettingExternalVettingParams: ExternalVettingExternalVettingParams
        ) = apply {
            brandId = externalVettingExternalVettingParams.brandId
            body = externalVettingExternalVettingParams.body.toBuilder()
            additionalHeaders = externalVettingExternalVettingParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                externalVettingExternalVettingParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Identifies the vetting classification. */
        fun vettingClass(vettingClass: String) = apply { body.vettingClass(vettingClass) }
        ...
        fun vettingClass(vettingClass: JsonField<String>) = apply {
            body.vettingClass(vettingClass)
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingExternalVettingParams].
         *
         ...
         */
        fun build(): ExternalVettingExternalVettingParams =
            ExternalVettingExternalVettingParams(
                brandId,
                body.build(),
    ...
    private constructor(
        ...
        ) : this(evpId, vettingClass, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun vettingClass(): String = vettingClass.getRequired("vettingClass")
         ...
         * Returns the raw JSON value of [vettingClass].
         *
         * Unlike [vettingClass], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("vettingClass")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var vettingClass: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(body: Body) = apply {
                evpId = body.evpId
                vettingClass = body.vettingClass
             ...
             * Sets [Builder.vettingClass] to an arbitrary JSON value.
             *
             * You should usually call [Builder.vettingClass] with a well-typed [String] value
            ...
            fun build(): Body =
                Body(
                    ...
                    checkRequired("vettingClass", vettingClass),
        ...
        private val hashCode: Int by lazy {
            Objects.hash(evpId, vettingClass, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{evpId=$evpId, vettingClass=$vettingClass, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingExternalVettingParams &&
    ...
    override fun toString() =
        "ExternalVettingExternalVettingParams{brandId=$brandId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
