...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SqldbListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SqldbListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SqldbListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sqldbListParams: SqldbListParams) = apply {
            filterName = sqldbListParams.filterName
            filterStatus = sqldbListParams.filterStatus
            pageNumber = sqldbListParams.pageNumber
            pageSize = sqldbListParams.pageSize
            sort = sqldbListParams.sort
            additionalHeaders = sqldbListParams.additionalHeaders.toBuilder()
            additionalQueryParams = sqldbListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SqldbListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SqldbListParams =
            SqldbListParams(
                filterName,
                filterStatus,
                pageNumber,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SqldbListParams &&
    ...
    override fun toString() =
        "SqldbListParams{filterName=$filterName, filterStatus=$filterStatus, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
