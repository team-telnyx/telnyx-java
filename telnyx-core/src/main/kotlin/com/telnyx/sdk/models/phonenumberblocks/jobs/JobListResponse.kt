...
private constructor(
    private val data: JsonField<List<Job>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Job>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<Job>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Job>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Job>>? = null
        ...
        fun data(data: List<Job>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Job>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<Job>>) = apply { this.data = data.map { it.toMutableList() } }

        /**
         * Adds a single [Job] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Job) = apply {
            this.data =
