...
class MessagingTollFreeVerificationEntityType
@JsonCreator
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(value: String) = MessagingTollFreeVerificationEntityType(JsonField.of(value))
    }

    /** An enum containing [MessagingTollFreeVerificationEntityType]'s known values. */
    enum class Known {
        SOLE_PROPRIETOR,
        PRIVATE_PROFIT,
        PUBLIC_PROFIT,
    ...
    /**
     * An enum containing [MessagingTollFreeVerificationEntityType]'s known values, as well as an
     * [_UNKNOWN] member.
     *
     * An instance of [MessagingTollFreeVerificationEntityType] can contain an unknown value in a
     * couple of cases:
    ...
    enum class Value {
        ...
        GOVERNMENT,
        /**
         * An enum member indicating that [MessagingTollFreeVerificationEntityType] was instantiated
        ...
        when (this) {
            ...
            GOVERNMENT -> Known.GOVERNMENT
                ...
                throw TelnyxInvalidDataException(
                    "Unknown MessagingTollFreeVerificationEntityType: $value"
                )
        }
     ...
     *   expected type.
     */
    fun validate(): MessagingTollFreeVerificationEntityType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingTollFreeVerificationEntityType && value == other.value
    }
