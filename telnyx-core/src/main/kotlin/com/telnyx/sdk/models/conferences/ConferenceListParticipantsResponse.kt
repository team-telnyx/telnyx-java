...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun endConferenceOnExit(): Boolean = endConferenceOnExit.getRequired("end_conference_on_exit")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(conferenceListParticipantsResponse: ConferenceListParticipantsResponse) =
            apply {
                id = conferenceListParticipantsResponse.id
                callControlId = conferenceListParticipantsResponse.callControlId
                callLegId = conferenceListParticipantsResponse.callLegId
                conference = conferenceListParticipantsResponse.conference
                createdAt = conferenceListParticipantsResponse.createdAt
                endConferenceOnExit = conferenceListParticipantsResponse.endConferenceOnExit
                muted = conferenceListParticipantsResponse.muted
                onHold = conferenceListParticipantsResponse.onHold
                recordType = conferenceListParticipantsResponse.recordType
                softEndConferenceOnExit = conferenceListParticipantsResponse.softEndConferenceOnExit
                status = conferenceListParticipantsResponse.status
                updatedAt = conferenceListParticipantsResponse.updatedAt
                whisperCallControlIds =
                    conferenceListParticipantsResponse.whisperCallControlIds.map {
                        it.toMutableList()
                    }
         ...
         * supported value.
         */
        fun conference(conference: JsonField<Conference>) = apply { this.conference = conference }
