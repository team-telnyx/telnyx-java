...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FaxMediaProcessed]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FaxMediaProcessed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxMediaProcessed: FaxMediaProcessed) = apply {
            data = faxMediaProcessed.data
            meta = faxMediaProcessed.meta
            additionalProperties = faxMediaProcessed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxMediaProcessed].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxMediaProcessed =
            FaxMediaProcessed(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FaxMediaProcessed = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxMediaProcessed &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FaxMediaProcessed{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
