...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberRemoveParams].
         *
    ...
    /** A builder for [PhoneNumberRemoveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberRemoveParams: PhoneNumberRemoveParams) = apply {
            dirId = phoneNumberRemoveParams.dirId
            body = phoneNumberRemoveParams.body.toBuilder()
            additionalHeaders = phoneNumberRemoveParams.additionalHeaders.toBuilder()
            additionalQueryParams = phoneNumberRemoveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberRemoveParams].
         *
         ...
         */
        fun build(): PhoneNumberRemoveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberRemoveParams &&
            dirId == other.dirId &&
            body == other.body &&
    ...
    override fun toString() =
        "PhoneNumberRemoveParams{dirId=$dirId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
