...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BucketIds].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bucketIds: BucketIds) = apply {
            this.bucketIds = bucketIds.bucketIds.map { it.toMutableList() }
            maxNumResults = bucketIds.maxNumResults
        ...
        /**
         * Returns an immutable instance of [BucketIds].
         *
    ...
    override fun toString() =
        "BucketIds{bucketIds=$bucketIds, maxNumResults=$maxNumResults, additionalProperties=$additionalProperties}"
}
