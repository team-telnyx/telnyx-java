...
class PrivateWirelessGatewayRetrieveResponse
...
private constructor(
    ...
    /** A builder for [PrivateWirelessGatewayRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = privateWirelessGatewayRetrieveResponse.data
            additionalProperties =
                privateWirelessGatewayRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PrivateWirelessGatewayRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PrivateWirelessGatewayRetrieveResponse =
            PrivateWirelessGatewayRetrieveResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PrivateWirelessGatewayRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateWirelessGatewayRetrieveResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PrivateWirelessGatewayRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
