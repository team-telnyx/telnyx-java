...
private constructor(
    private val data: JsonField<CivicAddress>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CivicAddress> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CivicAddress> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CivicAddress> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CivicAddress> = JsonMissing.of()
        ...
        fun data(data: CivicAddress) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CivicAddress] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<CivicAddress>) = apply { this.data = data }
