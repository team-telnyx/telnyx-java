...
class RemediationRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RemediationRetrieveResponse].
         *
    ...
    /** A builder for [RemediationRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(remediationRetrieveResponse: RemediationRetrieveResponse) = apply {
            data = remediationRetrieveResponse.data
            additionalProperties = remediationRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RemediationRetrieveResponse].
         *
         ...
         */
        fun build(): RemediationRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): RemediationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RemediationRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "RemediationRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
