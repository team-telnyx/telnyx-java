...
class TexmlApplicationListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<TexmlApplication>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<TexmlApplication>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<TexmlApplication>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<TexmlApplication>> = data
    ...
    companion object {
         ...
         * [TexmlApplicationListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TexmlApplicationListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<TexmlApplication>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(texmlApplicationListPageResponse: TexmlApplicationListPageResponse) =
            apply {
                data = texmlApplicationListPageResponse.data.map { it.toMutableList() }
                meta = texmlApplicationListPageResponse.meta
                additionalProperties =
                    texmlApplicationListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<TexmlApplication>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<TexmlApplication>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<TexmlApplication>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [TexmlApplication] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TexmlApplication) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [TexmlApplicationListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlApplicationListPageResponse =
            TexmlApplicationListPageResponse(
    ...
    fun validate(): TexmlApplicationListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlApplicationListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "TexmlApplicationListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
