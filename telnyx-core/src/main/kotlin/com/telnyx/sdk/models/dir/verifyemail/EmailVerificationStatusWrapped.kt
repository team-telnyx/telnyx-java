...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailVerificationStatusWrapped: EmailVerificationStatusWrapped) = apply {
            data = emailVerificationStatusWrapped.data
            additionalProperties =
                emailVerificationStatusWrapped.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailVerificationStatusWrapped].
         *
         ...
         */
        fun build(): EmailVerificationStatusWrapped =
            EmailVerificationStatusWrapped(
     ...
     *   expected type.
     */
    fun validate(): EmailVerificationStatusWrapped = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailVerificationStatusWrapped &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EmailVerificationStatusWrapped{data=$data, additionalProperties=$additionalProperties}"
}
