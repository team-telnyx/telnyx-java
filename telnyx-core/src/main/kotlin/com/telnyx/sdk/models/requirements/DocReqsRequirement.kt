...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DocReqsRequirement]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DocReqsRequirement]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(docReqsRequirement: DocReqsRequirement) = apply {
            id = docReqsRequirement.id
        ...
        /**
         * Returns an immutable instance of [DocReqsRequirement].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DocReqsRequirement =
            DocReqsRequirement(
                id,
                action,
                countryCode,
     ...
     *   expected type.
     */
    fun validate(): DocReqsRequirement = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DocReqsRequirement &&
            id == other.id &&
            action == other.action &&
