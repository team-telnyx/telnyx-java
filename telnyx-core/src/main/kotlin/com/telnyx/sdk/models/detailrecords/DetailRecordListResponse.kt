...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = detailRecordListResponse.accept(new DetailRecordListResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitMessageDetailRecord(MessageDetailRecord messageDetailRecord) {
     *         return Optional.of(messageDetailRecord.toString());
     *     }
     *
     *     // ...
     *
