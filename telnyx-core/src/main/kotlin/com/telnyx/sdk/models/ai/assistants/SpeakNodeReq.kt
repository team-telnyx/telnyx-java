 ...
 *
 * Unlike a prompt node, a speak node has no instructions or model — it isn't an LLM turn. Reaching
 * it delivers `message` to the user verbatim (with `{{variable}}` interpolation), then routes via
 * outgoing `llm` / `expression` edges.
 */
class SpeakNodeReq
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpeakNodeReq].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(speakNodeReq: SpeakNodeReq) = apply {
            id = speakNodeReq.id
            message = speakNodeReq.message
            name = speakNodeReq.name
            position = speakNodeReq.position
            type = speakNodeReq.type
            additionalProperties = speakNodeReq.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SpeakNodeReq].
         *
     ...
     *   expected type.
     */
    fun validate(): SpeakNodeReq = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SpeakNodeReq{id=$id, message=$message, name=$name, position=$position, type=$type, additionalProperties=$additionalProperties}"
}
