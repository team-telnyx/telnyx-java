...
class ConferenceParticipantPlaybackStarted
...
private constructor(
    ...
    /** A builder for [ConferenceParticipantPlaybackStarted]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = conferenceParticipantPlaybackStarted.id
            eventType = conferenceParticipantPlaybackStarted.eventType
            payload = conferenceParticipantPlaybackStarted.payload
            recordType = conferenceParticipantPlaybackStarted.recordType
            additionalProperties =
                conferenceParticipantPlaybackStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceParticipantPlaybackStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceParticipantPlaybackStarted =
            ConferenceParticipantPlaybackStarted(
                id,
                eventType,
                payload,
    ...
    fun validate(): ConferenceParticipantPlaybackStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CONFERENCE_PARTICIPANT_PLAYBACK_STARTED =
                of("conference.participant.playback.started")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PARTICIPANT_PLAYBACK_STARTED ->
                    Value.CONFERENCE_PARTICIPANT_PLAYBACK_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PARTICIPANT_PLAYBACK_STARTED ->
                    Known.CONFERENCE_PARTICIPANT_PLAYBACK_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceParticipantPlaybackStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceParticipantPlaybackStarted{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
