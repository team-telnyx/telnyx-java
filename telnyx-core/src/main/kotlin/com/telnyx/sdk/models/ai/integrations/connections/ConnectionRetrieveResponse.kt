...
private constructor(
    private val data: JsonField<IntegrationConnection>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<IntegrationConnection> = JsonMissing.of()
     ...
     */
    fun data(): IntegrationConnection = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<IntegrationConnection> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<IntegrationConnection>? = null
        ...
        fun data(data: IntegrationConnection) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [IntegrationConnection] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<IntegrationConnection>) = apply { this.data = data }
