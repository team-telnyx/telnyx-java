...
/**
 * Immediately refresh the stored reputation data for the listed numbers. This is in addition to the
 * periodic refresh determined by `check_frequency`. Up to 100 numbers per call. The response
 * carries the kicked-off jobs; the actual refresh runs asynchronously.
 *
...
private constructor(
    ...
    /**
     * Phone numbers to refresh reputation data for. 1–100 numbers per request, each in E.164
     * format. Reputation refreshes are subject to per-enterprise rate limits.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberRefreshParams].
         *
    ...
    /** A builder for [NumberRefreshParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberRefreshParams: NumberRefreshParams) = apply {
            enterpriseId = numberRefreshParams.enterpriseId
            body = numberRefreshParams.body.toBuilder()
            additionalHeaders = numberRefreshParams.additionalHeaders.toBuilder()
            additionalQueryParams = numberRefreshParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NumberRefreshParams].
         *
    ...
    private constructor(
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (phoneNumbers.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun toString() =
            "Body{phoneNumbers=$phoneNumbers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberRefreshParams &&
    ...
    override fun toString() =
        "NumberRefreshParams{enterpriseId=$enterpriseId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
