...
private constructor(
    ...
    /**
     * Business/industry segment of this campaign (Deprecated). Must be of defined valid types. Use
     * `/registry/enum/vertical` operation to retrieve verticals available for given brand, vertical
     * combination.
     *
     ...
     */
    @JsonProperty("billedDate") @ExcludeMissing fun _billedDate(): JsonField<String> = billedDate
     ...
     *
     * Unlike [isTMobileNumberPoolingEnabled], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("isTMobileNumberPoolingEnabled")
    @ExcludeMissing
     ...
     *
     * Unlike [isTMobileSuspended], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("isTMobileSuspended")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignListResponse: CampaignListResponse) = apply {
            ageGated = campaignListResponse.ageGated
            assignedPhoneNumbersCount = campaignListResponse.assignedPhoneNumbersCount
            autoRenewal = campaignListResponse.autoRenewal
            billedDate = campaignListResponse.billedDate
            brandDisplayName = campaignListResponse.brandDisplayName
            brandId = campaignListResponse.brandId
            campaignId = campaignListResponse.campaignId
            campaignStatus = campaignListResponse.campaignStatus
            createDate = campaignListResponse.createDate
            cspId = campaignListResponse.cspId
            description = campaignListResponse.description
            directLending = campaignListResponse.directLending
            embeddedLink = campaignListResponse.embeddedLink
            embeddedLinkSample = campaignListResponse.embeddedLinkSample
            embeddedPhone = campaignListResponse.embeddedPhone
            failureReasons = campaignListResponse.failureReasons
            helpKeywords = campaignListResponse.helpKeywords
            helpMessage = campaignListResponse.helpMessage
            isTMobileNumberPoolingEnabled = campaignListResponse.isTMobileNumberPoolingEnabled
            isTMobileRegistered = campaignListResponse.isTMobileRegistered
            isTMobileSuspended = campaignListResponse.isTMobileSuspended
            messageFlow = campaignListResponse.messageFlow
            mock = campaignListResponse.mock
            nextRenewalOrExpirationDate = campaignListResponse.nextRenewalOrExpirationDate
            numberPool = campaignListResponse.numberPool
            optinKeywords = campaignListResponse.optinKeywords
            optinMessage = campaignListResponse.optinMessage
            optoutKeywords = campaignListResponse.optoutKeywords
            optoutMessage = campaignListResponse.optoutMessage
            privacyPolicyLink = campaignListResponse.privacyPolicyLink
            referenceId = campaignListResponse.referenceId
            resellerId = campaignListResponse.resellerId
            sample1 = campaignListResponse.sample1
            sample2 = campaignListResponse.sample2
            sample3 = campaignListResponse.sample3
            sample4 = campaignListResponse.sample4
            sample5 = campaignListResponse.sample5
            status = campaignListResponse.status
            submissionStatus = campaignListResponse.submissionStatus
            subscriberHelp = campaignListResponse.subscriberHelp
            subscriberOptin = campaignListResponse.subscriberOptin
            subscriberOptout = campaignListResponse.subscriberOptout
            subUsecases = campaignListResponse.subUsecases.map { it.toMutableList() }
            tcrBrandId = campaignListResponse.tcrBrandId
            tcrCampaignId = campaignListResponse.tcrCampaignId
            termsAndConditions = campaignListResponse.termsAndConditions
            termsAndConditionsLink = campaignListResponse.termsAndConditionsLink
            usecase = campaignListResponse.usecase
            vertical = campaignListResponse.vertical
            webhookFailoverUrl = campaignListResponse.webhookFailoverUrl
            webhookUrl = campaignListResponse.webhookUrl
         ...
         * value.
         */
        fun autoRenewal(autoRenewal: JsonField<Boolean>) = apply { this.autoRenewal = autoRenewal }
         ...
         *
         * You should usually call [Builder.billedDate] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.isTMobileSuspended] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.nextRenewalOrExpirationDate] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun nextRenewalOrExpirationDate(nextRenewalOrExpirationDate: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.submissionStatus] with a well-typed [SubmissionStatus]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
    ...
    /** Campaign submission status */
    class SubmissionStatus @JsonCreator private constructor(private val value: JsonField<String>) :
        Enum {
        ...
        /**
         * An enum containing [SubmissionStatus]'s known values, as well as an [_UNKNOWN] member.
         *
        ...
        enum class Value {
            ...
            PENDING,
            /**
             * An enum member indicating that [SubmissionStatus] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
