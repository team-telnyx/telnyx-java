...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transcription: Transcription) = apply {
            ...
            occurredAt = transcription.occurredAt
            payload = transcription.payload
            recordType = transcription.recordType
    ...
    private constructor(
         ...
         *
         * Unlike [transcriptionData], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("transcription_data")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * [TranscriptionData] value instead. This method is primarily for setting the field to
        ...
        private constructor(
             ...
             *
             * Unlike [transcript], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("transcript")
            @ExcludeMissing
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [TranscriptionData].
                 */
                @JvmStatic fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun transcriptionTrack(transcriptionTrack: JsonField<TranscriptionTrack>) = apply {
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [TranscriptionTrack]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [TranscriptionTrack] can contain an unknown value in a couple of
                 * cases:
                ...
                enum class Value {
                    ...
                    OUTBOUND,
                    /**
                     * An enum member indicating that [TranscriptionTrack] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        OUTBOUND -> Known.OUTBOUND
                            ...
                            throw TelnyxInvalidDataException("Unknown TranscriptionTrack: $value")
                    }
    ...
    override fun toString() =
        "Transcription{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
