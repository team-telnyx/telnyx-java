...
/**
 * Asynchronously create a report containing Wireless Detail Records (WDRs) for the SIM cards that
 * consumed wireless data in the given time period.
 */
class DetailRecordsReportCreateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DetailRecordsReportCreateParams = builder().build()
    ...
    /** A builder for [DetailRecordsReportCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailRecordsReportCreateParams: DetailRecordsReportCreateParams) =
            apply {
                body = detailRecordsReportCreateParams.body.toBuilder()
                additionalHeaders = detailRecordsReportCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    detailRecordsReportCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DetailRecordsReportCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailRecordsReportCreateParams =
            DetailRecordsReportCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DetailRecordsReportCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "DetailRecordsReportCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
