...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): CallBridged = CallBridged(data, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() = "CallBridged{data=$data, additionalProperties=$additionalProperties}"
}
