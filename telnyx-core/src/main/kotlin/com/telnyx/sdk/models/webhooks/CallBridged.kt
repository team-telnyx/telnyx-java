...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallBridged]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallBridged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callBridged: CallBridged) = apply {
            id = callBridged.id
            eventType = callBridged.eventType
            occurredAt = callBridged.occurredAt
            payload = callBridged.payload
            recordType = callBridged.recordType
            additionalProperties = callBridged.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallBridged].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallBridged =
            CallBridged(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallBridged = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CallBridged{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
