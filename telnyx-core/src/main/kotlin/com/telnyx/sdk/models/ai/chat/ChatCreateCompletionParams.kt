...
private constructor(
    ...
    fun chatCompletionRequest(): ChatCompletionRequest = chatCompletionRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        chatCompletionRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(chatCreateCompletionParams: ChatCreateCompletionParams) = apply {
            chatCompletionRequest = chatCreateCompletionParams.chatCompletionRequest
        ...
        fun chatCompletionRequest(chatCompletionRequest: ChatCompletionRequest) = apply {
        ...
        fun build(): ChatCreateCompletionParams =
            ChatCreateCompletionParams(
                checkRequired("chatCompletionRequest", chatCompletionRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): ChatCompletionRequest = chatCompletionRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCreateCompletionParams &&
            chatCompletionRequest == other.chatCompletionRequest &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(chatCompletionRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ChatCreateCompletionParams{chatCompletionRequest=$chatCompletionRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
