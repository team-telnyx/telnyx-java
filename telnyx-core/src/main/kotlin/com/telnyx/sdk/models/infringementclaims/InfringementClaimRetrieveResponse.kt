...
class InfringementClaimRetrieveResponse
...
private constructor(
    ...
    /** A builder for [InfringementClaimRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(infringementClaimRetrieveResponse: InfringementClaimRetrieveResponse) =
            apply {
                data = infringementClaimRetrieveResponse.data
                additionalProperties =
                    infringementClaimRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InfringementClaimRetrieveResponse].
         *
         ...
         */
        fun build(): InfringementClaimRetrieveResponse =
            InfringementClaimRetrieveResponse(
     ...
     *   expected type.
     */
    fun validate(): InfringementClaimRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InfringementClaimRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "InfringementClaimRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
