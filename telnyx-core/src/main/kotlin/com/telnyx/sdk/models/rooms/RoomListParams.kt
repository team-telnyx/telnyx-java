...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(roomListParams: RoomListParams) = apply {
            ...
            pageNumber = roomListParams.pageNumber
            pageSize = roomListParams.pageSize
    ...
    override fun toString() =
        "RoomListParams{filter=$filter, includeSessions=$includeSessions, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
