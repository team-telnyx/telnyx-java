...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TextToSpeechGenerateSpeechParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(textToSpeechGenerateSpeechParams: TextToSpeechGenerateSpeechParams) =
            apply {
                audioFormat = textToSpeechGenerateSpeechParams.audioFormat
                disableCache = textToSpeechGenerateSpeechParams.disableCache
                modelId = textToSpeechGenerateSpeechParams.modelId
                provider = textToSpeechGenerateSpeechParams.provider
                socketId = textToSpeechGenerateSpeechParams.socketId
                voice = textToSpeechGenerateSpeechParams.voice
                voiceId = textToSpeechGenerateSpeechParams.voiceId
    ...
    override fun toString() =
        "TextToSpeechGenerateSpeechParams{audioFormat=$audioFormat, disableCache=$disableCache, modelId=$modelId, provider=$provider, socketId=$socketId, voice=$voice, voiceId=$voiceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
