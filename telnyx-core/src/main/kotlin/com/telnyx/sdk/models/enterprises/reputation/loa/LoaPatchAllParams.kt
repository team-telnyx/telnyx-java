...
/**
 * Point the enterprise's reputation settings at a new signed LOA document. This resets LOA approval
 * to `pending`; the new document must be approved before additional phone numbers can be added.
 */
class LoaPatchAllParams
private constructor(
    ...
    /**
     * Id of the new signed LOA document (from the Telnyx Documents API). Changing it resets LOA
     * approval; the new document must be approved before more numbers can be added.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LoaPatchAllParams].
         *
    ...
    /** A builder for [LoaPatchAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(loaPatchAllParams: LoaPatchAllParams) = apply {
            enterpriseId = loaPatchAllParams.enterpriseId
            body = loaPatchAllParams.body.toBuilder()
            additionalHeaders = loaPatchAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = loaPatchAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LoaPatchAllParams].
         *
    ...
    private constructor(
        ...
        ) : this(loaDocumentId, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /**
             * Id of the new signed LOA document (from the Telnyx Documents API). Changing it resets
             * LOA approval; the new document must be approved before more numbers can be added.
             */
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (loaDocumentId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(loaDocumentId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{loaDocumentId=$loaDocumentId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LoaPatchAllParams &&
    ...
    override fun toString() =
        "LoaPatchAllParams{enterpriseId=$enterpriseId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
