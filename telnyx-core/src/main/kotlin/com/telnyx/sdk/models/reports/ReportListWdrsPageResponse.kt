...
class ReportListWdrsPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<ReportListWdrsResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ReportListWdrsResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<ReportListWdrsResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<ReportListWdrsResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReportListWdrsPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ReportListWdrsPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<ReportListWdrsResponse>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(reportListWdrsPageResponse: ReportListWdrsPageResponse) = apply {
            data = reportListWdrsPageResponse.data.map { it.toMutableList() }
            meta = reportListWdrsPageResponse.meta
            additionalProperties = reportListWdrsPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<ReportListWdrsResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ReportListWdrsResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<ReportListWdrsResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ReportListWdrsResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ReportListWdrsResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ReportListWdrsPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ReportListWdrsPageResponse =
            ReportListWdrsPageResponse(
    ...
    fun validate(): ReportListWdrsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReportListWdrsPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ReportListWdrsPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
