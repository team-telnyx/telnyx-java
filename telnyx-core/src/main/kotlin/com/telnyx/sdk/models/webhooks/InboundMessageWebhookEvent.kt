...
private constructor(
    ...
    private constructor(
        ...
        private val payload: JsonField<InboundMessagePayload>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            payload: JsonField<InboundMessagePayload> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun payload(): Optional<InboundMessagePayload> = payload.getOptional("payload")
        ...
        @JsonProperty("payload")
        @ExcludeMissing
        fun _payload(): JsonField<InboundMessagePayload> = payload
        ...
        class Builder internal constructor() {
            ...
            private var payload: JsonField<InboundMessagePayload> = JsonMissing.of()
            ...
            fun payload(payload: InboundMessagePayload) = payload(JsonField.of(payload))

            /**
             * Sets [Builder.payload] to an arbitrary JSON value.
             *
             * You should usually call [Builder.payload] with a well-typed [InboundMessagePayload]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun payload(payload: JsonField<InboundMessagePayload>) = apply {
