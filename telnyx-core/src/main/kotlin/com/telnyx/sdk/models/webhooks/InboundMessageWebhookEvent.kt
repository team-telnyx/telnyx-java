...
class InboundMessageWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InboundMessageWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InboundMessageWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inboundMessageWebhookEvent: InboundMessageWebhookEvent) = apply {
            data = inboundMessageWebhookEvent.data
            additionalProperties = inboundMessageWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InboundMessageWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InboundMessageWebhookEvent =
            InboundMessageWebhookEvent(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): InboundMessageWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(payload: Payload) = apply {
                    id = payload.id
                    cc = payload.cc.map { it.toMutableList() }
                    ...
                    from = payload.from
                    media = payload.media.map { it.toMutableList() }
                    messagingProfileId = payload.messagingProfileId
                    numChars = payload.numChars
                    ...
                    tcrCampaignBillable = payload.tcrCampaignBillable
                    tcrCampaignId = payload.tcrCampaignId
                    tcrCampaignRegistered = payload.tcrCampaignRegistered
                    text = payload.text
                    to = payload.to.map { it.toMutableList() }
                    type = payload.type
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboundMessageWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "InboundMessageWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
