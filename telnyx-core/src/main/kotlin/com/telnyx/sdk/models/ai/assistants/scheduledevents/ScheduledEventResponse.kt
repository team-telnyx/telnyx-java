...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = scheduledEventResponse.accept(new ScheduledEventResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitPhoneCall(ScheduledPhoneCallEventResponse phoneCall) {
     *         return Optional.of(phoneCall.toString());
     *     }
     *
     *     // ...
     *
