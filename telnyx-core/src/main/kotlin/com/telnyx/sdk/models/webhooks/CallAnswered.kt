...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallAnswered]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallAnswered]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callAnswered: CallAnswered) = apply {
            id = callAnswered.id
            eventType = callAnswered.eventType
            occurredAt = callAnswered.occurredAt
            payload = callAnswered.payload
            recordType = callAnswered.recordType
            additionalProperties = callAnswered.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallAnswered].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallAnswered =
            CallAnswered(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallAnswered = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CallAnswered{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
