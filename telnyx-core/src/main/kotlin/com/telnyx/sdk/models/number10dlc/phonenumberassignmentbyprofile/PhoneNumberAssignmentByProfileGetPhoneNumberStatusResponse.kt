...
class PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse
...
private constructor(
    ...
    /** A builder for [PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            records =
                phoneNumberAssignmentByProfileGetPhoneNumberStatusResponse.records.map {
                    it.toMutableList()
                }
            additionalProperties =
                phoneNumberAssignmentByProfileGetPhoneNumberStatusResponse.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse =
            PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse(
    ...
    fun validate(): PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse{records=$records, additionalProperties=$additionalProperties}"
}
