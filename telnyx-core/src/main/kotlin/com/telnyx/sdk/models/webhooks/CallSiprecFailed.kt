...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallSiprecFailed]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallSiprecFailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callSiprecFailed: CallSiprecFailed) = apply {
            id = callSiprecFailed.id
            eventType = callSiprecFailed.eventType
            occurredAt = callSiprecFailed.occurredAt
            payload = callSiprecFailed.payload
            recordType = callSiprecFailed.recordType
            additionalProperties = callSiprecFailed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallSiprecFailed].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallSiprecFailed =
            CallSiprecFailed(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallSiprecFailed = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SIPREC_FAILED = of("siprec.failed")
        ...
        fun value(): Value =
            when (this) {
                SIPREC_FAILED -> Value.SIPREC_FAILED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SIPREC_FAILED -> Known.SIPREC_FAILED
    ...
    private constructor(
        ...
        private val failureCause: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            failureCause: JsonField<String> = JsonMissing.of(),
        ) : this(
            callControlId,
            callLegId,
            callSessionId,
         ...
         *   server responded with an unexpected value).
         */
        fun failureCause(): Optional<String> = failureCause.getOptional("failure_cause")
        ...
        /**
         * Returns the raw JSON value of [failureCause].
         *
         * Unlike [failureCause], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("failure_cause")
        @ExcludeMissing
        fun _failureCause(): JsonField<String> = failureCause
        ...
        class Builder internal constructor() {
            ...
            private var failureCause: JsonField<String> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            /** Q850 reason why siprec session failed. */
            fun failureCause(failureCause: String) = failureCause(JsonField.of(failureCause))

            /**
             * Sets [Builder.failureCause] to an arbitrary JSON value.
             *
             * You should usually call [Builder.failureCause] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun failureCause(failureCause: JsonField<String>) = apply {
        ...
        internal fun validity(): Int =
            (if (callControlId.asKnown().isPresent) 1 else 0) +
                ...
                (if (failureCause.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, failureCause=$failureCause, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallSiprecFailed &&
            id == other.id &&
    ...
    override fun toString() =
        "CallSiprecFailed{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
