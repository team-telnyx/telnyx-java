...
class ManagedAccountUpdateGlobalChannelLimitResponse
...
private constructor(
    ...
    /** A builder for [ManagedAccountUpdateGlobalChannelLimitResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                managedAccountUpdateGlobalChannelLimitResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ManagedAccountUpdateGlobalChannelLimitResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ManagedAccountUpdateGlobalChannelLimitResponse =
            ManagedAccountUpdateGlobalChannelLimitResponse(
                data,
    ...
    fun validate(): ManagedAccountUpdateGlobalChannelLimitResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(id, channelLimit, email, managerAccountId, recordType, mutableMapOf())
        ...
        /**
         * Integer value that indicates the number of allocatable global outbound channels that are
         * allocated to the managed account. If the value is 0 then the account will have no usable
         * channels and will not be able to perform outbound calling.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
         ...
         *   server responded with an unexpected value).
         */
        fun managerAccountId(): Optional<String> =
            managerAccountId.getOptional("manager_account_id")
        ...
        class Builder internal constructor() {
            ...
            private var managerAccountId: JsonField<String> = JsonMissing.of()
             ...
             * are allocated to the managed account. If the value is 0 then the account will have no
        ...
        override fun toString() =
            "Data{id=$id, channelLimit=$channelLimit, email=$email, managerAccountId=$managerAccountId, recordType=$recordType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ManagedAccountUpdateGlobalChannelLimitResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ManagedAccountUpdateGlobalChannelLimitResponse{data=$data, additionalProperties=$additionalProperties}"
}
