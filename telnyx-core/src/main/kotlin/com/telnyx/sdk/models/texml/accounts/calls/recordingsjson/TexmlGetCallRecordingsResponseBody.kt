...
class TexmlGetCallRecordingsResponseBody
...
private constructor(
    ...
    /** A builder for [TexmlGetCallRecordingsResponseBody]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(texmlGetCallRecordingsResponseBody: TexmlGetCallRecordingsResponseBody) =
            apply {
                end = texmlGetCallRecordingsResponseBody.end
                firstPageUri = texmlGetCallRecordingsResponseBody.firstPageUri
                nextPageUri = texmlGetCallRecordingsResponseBody.nextPageUri
                page = texmlGetCallRecordingsResponseBody.page
                pageSize = texmlGetCallRecordingsResponseBody.pageSize
                previousPageUri = texmlGetCallRecordingsResponseBody.previousPageUri
                recordings =
                    texmlGetCallRecordingsResponseBody.recordings.map { it.toMutableList() }
                start = texmlGetCallRecordingsResponseBody.start
                uri = texmlGetCallRecordingsResponseBody.uri
                additionalProperties =
                    texmlGetCallRecordingsResponseBody.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TexmlGetCallRecordingsResponseBody].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlGetCallRecordingsResponseBody =
            TexmlGetCallRecordingsResponseBody(
                end,
                firstPageUri,
                nextPageUri,
     ...
     *   expected type.
     */
    fun validate(): TexmlGetCallRecordingsResponseBody = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlGetCallRecordingsResponseBody &&
            end == other.end &&
    ...
    override fun toString() =
        "TexmlGetCallRecordingsResponseBody{end=$end, firstPageUri=$firstPageUri, nextPageUri=$nextPageUri, page=$page, pageSize=$pageSize, previousPageUri=$previousPageUri, recordings=$recordings, start=$start, uri=$uri, additionalProperties=$additionalProperties}"
}
