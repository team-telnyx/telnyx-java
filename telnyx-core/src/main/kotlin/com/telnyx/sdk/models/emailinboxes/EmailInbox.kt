...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailInbox].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailInbox: EmailInbox) = apply {
            id = emailInbox.id
            address = emailInbox.address
            createdAt = emailInbox.createdAt
            domain = emailInbox.domain
            domainId = emailInbox.domainId
            recordType = emailInbox.recordType
            settings = emailInbox.settings
            status = emailInbox.status
            updatedAt = emailInbox.updatedAt
            additionalProperties = emailInbox.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailInbox].
         *
    ...
    class RecordType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val EMAIL_INBOX = of("email_inbox")
    ...
    override fun toString() =
        "EmailInbox{id=$id, address=$address, createdAt=$createdAt, domain=$domain, domainId=$domainId, recordType=$recordType, settings=$settings, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
