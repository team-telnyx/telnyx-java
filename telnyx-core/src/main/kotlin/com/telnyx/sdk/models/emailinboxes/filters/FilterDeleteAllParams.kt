...
/**
 * Removes entries from either the allowlist or blocklist. The operation is idempotent: removing an
 * entry that is not present still returns the current filter lists.
 */
class FilterDeleteAllParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FilterDeleteAllParams].
         *
    ...
    /** A builder for [FilterDeleteAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(filterDeleteAllParams: FilterDeleteAllParams) = apply {
            inboxId = filterDeleteAllParams.inboxId
            mutateInboxFiltersRequest = filterDeleteAllParams.mutateInboxFiltersRequest
            additionalHeaders = filterDeleteAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = filterDeleteAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FilterDeleteAllParams].
         *
         ...
         */
        fun build(): FilterDeleteAllParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FilterDeleteAllParams &&
    ...
    override fun toString() =
        "FilterDeleteAllParams{inboxId=$inboxId, mutateInboxFiltersRequest=$mutateInboxFiltersRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
