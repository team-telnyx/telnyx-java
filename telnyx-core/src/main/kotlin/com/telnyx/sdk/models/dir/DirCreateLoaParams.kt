...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirCreateLoaParams].
         *
    ...
    /** A builder for [DirCreateLoaParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirCreateLoaParams: DirCreateLoaParams) = apply {
            dirId = dirCreateLoaParams.dirId
            body = dirCreateLoaParams.body.toBuilder()
            additionalHeaders = dirCreateLoaParams.additionalHeaders.toBuilder()
            additionalQueryParams = dirCreateLoaParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DirCreateLoaParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirCreateLoaParams &&
            dirId == other.dirId &&
            body == other.body &&
    ...
    override fun toString() =
        "DirCreateLoaParams{dirId=$dirId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
