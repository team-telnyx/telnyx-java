...
class MessagingOutboundMessagePayload
...
private constructor(
    ...
    /** A builder for [MessagingOutboundMessagePayload]. */
    class Builder internal constructor() {
        ...
        internal fun from(messagingOutboundMessagePayload: MessagingOutboundMessagePayload) =
            apply {
                ...
                costBreakdown = messagingOutboundMessagePayload.costBreakdown
                direction = messagingOutboundMessagePayload.direction
                encoding = messagingOutboundMessagePayload.encoding
                errors = messagingOutboundMessagePayload.errors.map { it.toMutableList() }
                from = messagingOutboundMessagePayload.from
                media = messagingOutboundMessagePayload.media.map { it.toMutableList() }
                messagingProfileId = messagingOutboundMessagePayload.messagingProfileId
                numChars = messagingOutboundMessagePayload.numChars
                organizationId = messagingOutboundMessagePayload.organizationId
                parts = messagingOutboundMessagePayload.parts
                receivedAt = messagingOutboundMessagePayload.receivedAt
                recordType = messagingOutboundMessagePayload.recordType
                sentAt = messagingOutboundMessagePayload.sentAt
                smartEncodingApplied = messagingOutboundMessagePayload.smartEncodingApplied
                subject = messagingOutboundMessagePayload.subject
                tags = messagingOutboundMessagePayload.tags.map { it.toMutableList() }
                tcrCampaignBillable = messagingOutboundMessagePayload.tcrCampaignBillable
                tcrCampaignId = messagingOutboundMessagePayload.tcrCampaignId
                tcrCampaignRegistered = messagingOutboundMessagePayload.tcrCampaignRegistered
                text = messagingOutboundMessagePayload.text
                to = messagingOutboundMessagePayload.to.map { it.toMutableList() }
                type = messagingOutboundMessagePayload.type
                validUntil = messagingOutboundMessagePayload.validUntil
                waitSeconds = messagingOutboundMessagePayload.waitSeconds
                webhookFailoverUrl = messagingOutboundMessagePayload.webhookFailoverUrl
                webhookUrl = messagingOutboundMessagePayload.webhookUrl
                additionalProperties =
                    messagingOutboundMessagePayload.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MessagingOutboundMessagePayload].
         *
     ...
     *   expected type.
     */
    fun validate(): MessagingOutboundMessagePayload = apply {
        if (validated) {
            return@apply
        }
