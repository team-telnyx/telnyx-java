...
class PronunciationDictListResponse
...
private constructor(
    ...
    /** A builder for [PronunciationDictListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pronunciationDictListResponse: PronunciationDictListResponse) = apply {
            id = pronunciationDictListResponse.id
            createdAt = pronunciationDictListResponse.createdAt
            items = pronunciationDictListResponse.items.map { it.toMutableList() }
            name = pronunciationDictListResponse.name
            recordType = pronunciationDictListResponse.recordType
            updatedAt = pronunciationDictListResponse.updatedAt
            version = pronunciationDictListResponse.version
            additionalProperties = pronunciationDictListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PronunciationDictListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PronunciationDictListResponse =
            PronunciationDictListResponse(
                id,
                createdAt,
    ...
    fun validate(): PronunciationDictListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PronunciationDictListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PronunciationDictListResponse{id=$id, createdAt=$createdAt, items=$items, name=$name, recordType=$recordType, updatedAt=$updatedAt, version=$version, additionalProperties=$additionalProperties}"
}
