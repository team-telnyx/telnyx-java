...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CollectionsSource]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CollectionsSource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectionsSource: CollectionsSource) = apply {
            id = collectionsSource.id
            bucketId = collectionsSource.bucketId
            collectionId = collectionsSource.collectionId
            recordType = collectionsSource.recordType
            sourceType = collectionsSource.sourceType
            status = collectionsSource.status
            additionalProperties = collectionsSource.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionsSource].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CollectionsSource =
            CollectionsSource(
                id,
                bucketId,
                collectionId,
     ...
     *   expected type.
     */
    fun validate(): CollectionsSource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionsSource &&
            id == other.id &&
    ...
    override fun toString() =
        "CollectionsSource{id=$id, bucketId=$bucketId, collectionId=$collectionId, recordType=$recordType, sourceType=$sourceType, status=$status, additionalProperties=$additionalProperties}"
}
