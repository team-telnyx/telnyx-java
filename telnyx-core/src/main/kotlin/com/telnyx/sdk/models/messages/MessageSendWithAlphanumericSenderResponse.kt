...
class MessageSendWithAlphanumericSenderResponse
...
private constructor(
    ...
    /** A builder for [MessageSendWithAlphanumericSenderResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = messageSendWithAlphanumericSenderResponse.data
            additionalProperties =
                messageSendWithAlphanumericSenderResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageSendWithAlphanumericSenderResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessageSendWithAlphanumericSenderResponse =
            MessageSendWithAlphanumericSenderResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): MessageSendWithAlphanumericSenderResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageSendWithAlphanumericSenderResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MessageSendWithAlphanumericSenderResponse{data=$data, additionalProperties=$additionalProperties}"
}
