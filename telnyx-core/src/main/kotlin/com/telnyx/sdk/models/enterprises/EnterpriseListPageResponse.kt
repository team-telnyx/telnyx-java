...
class EnterpriseListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<EnterpriseListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EnterpriseListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<EnterpriseListResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<EnterpriseListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EnterpriseListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EnterpriseListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<EnterpriseListResponse>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(enterpriseListPageResponse: EnterpriseListPageResponse) = apply {
            data = enterpriseListPageResponse.data.map { it.toMutableList() }
            meta = enterpriseListPageResponse.meta
            additionalProperties = enterpriseListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<EnterpriseListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EnterpriseListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EnterpriseListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EnterpriseListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EnterpriseListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [EnterpriseListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EnterpriseListPageResponse =
            EnterpriseListPageResponse(
    ...
    fun validate(): EnterpriseListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnterpriseListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EnterpriseListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
