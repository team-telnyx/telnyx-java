...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data =
                messagingProfileListAlphanumericSenderIdsPageResponse.data.map {
                    it.toMutableList()
                }
            meta = messagingProfileListAlphanumericSenderIdsPageResponse.meta
            additionalProperties =
                messagingProfileListAlphanumericSenderIdsPageResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingProfileListAlphanumericSenderIdsPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingProfileListAlphanumericSenderIdsPageResponse =
            MessagingProfileListAlphanumericSenderIdsPageResponse(
    ...
    fun validate(): MessagingProfileListAlphanumericSenderIdsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingProfileListAlphanumericSenderIdsPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "MessagingProfileListAlphanumericSenderIdsPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
