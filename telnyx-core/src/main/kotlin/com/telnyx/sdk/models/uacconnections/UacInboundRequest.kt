...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UacInboundRequest]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacInboundRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uacInboundRequest: UacInboundRequest) = apply {
            aniNumberFormat = uacInboundRequest.aniNumberFormat
            channelLimit = uacInboundRequest.channelLimit
            codecs = uacInboundRequest.codecs.map { it.toMutableList() }
            defaultRoutingMethod = uacInboundRequest.defaultRoutingMethod
            dnisNumberFormat = uacInboundRequest.dnisNumberFormat
            generateRingbackTone = uacInboundRequest.generateRingbackTone
            isupHeadersEnabled = uacInboundRequest.isupHeadersEnabled
            prackEnabled = uacInboundRequest.prackEnabled
        ...
        /**
         * Returns an immutable instance of [UacInboundRequest].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacInboundRequest =
            UacInboundRequest(
                aniNumberFormat,
                channelLimit,
     ...
     *   expected type.
     */
    fun validate(): UacInboundRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UacInboundRequest &&
