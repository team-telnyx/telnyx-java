...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ModelsResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(modelsResponse: ModelsResponse) = apply {
            data = modelsResponse.data.map { it.toMutableList() }
            modelObject = modelsResponse.modelObject
            additionalProperties = modelsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ModelsResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): ModelsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "ModelsResponse{data=$data, modelObject=$modelObject, additionalProperties=$additionalProperties}"
}
