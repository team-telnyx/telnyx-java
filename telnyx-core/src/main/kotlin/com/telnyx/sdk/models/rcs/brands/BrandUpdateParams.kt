...
/**
 * Updates one or more fields on a brand while its status is `CREATED`. Submitted brands cannot be
 * changed.
 */
...
private constructor(
     ...
     */
    fun addresses(): Optional<Addresses> = body.addresses()
     ...
     *   server responded with an unexpected value).
     */
    fun contacts(): Optional<Contacts> = body.contacts()
     ...
     *   server responded with an unexpected value).
     */
    fun identifiers(): Optional<Identifiers> = body.identifiers()

    /**
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun legalEntityType(): Optional<BrandLegalEntityType> = body.legalEntityType()
     ...
     *   server responded with an unexpected value).
     */
    fun organizationType(): Optional<BrandOrganizationType> = body.organizationType()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun addresses(): Optional<Addresses> = addresses.getOptional("addresses")
         ...
         *   server responded with an unexpected value).
         */
        fun contacts(): Optional<Contacts> = contacts.getOptional("contacts")
         ...
         *   server responded with an unexpected value).
         */
        fun identifiers(): Optional<Identifiers> = identifiers.getOptional("identifiers")

        /**
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun legalEntityType(): Optional<BrandLegalEntityType> =
         ...
         *   server responded with an unexpected value).
         */
        fun organizationType(): Optional<BrandOrganizationType> =
        ...
        class Builder internal constructor() {
            ...
            private var addresses: JsonField<Addresses> = JsonMissing.of()
            private var contacts: JsonField<Contacts> = JsonMissing.of()
            private var displayName: JsonField<String> = JsonMissing.of()
            private var identifiers: JsonField<Identifiers> = JsonMissing.of()
            private var legalEntityType: JsonField<BrandLegalEntityType> = JsonMissing.of()
            private var legalName: JsonField<String> = JsonMissing.of()
            private var organizationType: JsonField<BrandOrganizationType> = JsonMissing.of()
        ...
        fun validate(): Body = apply {
            ...
            addresses().ifPresent { it.validate() }
            contacts().ifPresent { it.validate() }
            displayName()
            identifiers().ifPresent { it.validate() }
        ...
        override fun toString() =
            "Body{addresses=$addresses, contacts=$contacts, displayName=$displayName, identifiers=$identifiers, legalEntityType=$legalEntityType, legalName=$legalName, organizationType=$organizationType, profileId=$profileId, websiteUrl=$websiteUrl, additionalProperties=$additionalProperties}"
    }
