...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RoomRecording]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RoomRecording]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roomRecording: RoomRecording) = apply {
            id = roomRecording.id
            codec = roomRecording.codec
            completedAt = roomRecording.completedAt
            createdAt = roomRecording.createdAt
            downloadUrl = roomRecording.downloadUrl
            durationSecs = roomRecording.durationSecs
            endedAt = roomRecording.endedAt
            participantId = roomRecording.participantId
            recordType = roomRecording.recordType
            roomId = roomRecording.roomId
            sessionId = roomRecording.sessionId
            sizeMb = roomRecording.sizeMb
            startedAt = roomRecording.startedAt
            status = roomRecording.status
            type = roomRecording.type
            updatedAt = roomRecording.updatedAt
            additionalProperties = roomRecording.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.codec] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        /**
         * Returns an immutable instance of [RoomRecording].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RoomRecording =
            RoomRecording(
                id,
                codec,
                completedAt,
     ...
     *   expected type.
     */
    fun validate(): RoomRecording = apply {
        if (validated) {
            return@apply
        }
