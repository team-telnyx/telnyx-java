...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = trafficPolicyProfileListPageResponse.data.map { it.toMutableList() }
            meta = trafficPolicyProfileListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [TrafficPolicyProfileListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrafficPolicyProfileListPageResponse =
            TrafficPolicyProfileListPageResponse(
    ...
    fun validate(): TrafficPolicyProfileListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrafficPolicyProfileListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "TrafficPolicyProfileListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
