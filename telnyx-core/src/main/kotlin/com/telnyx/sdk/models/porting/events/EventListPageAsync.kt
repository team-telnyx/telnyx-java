...
private constructor(
     ...
     */
    fun data(): List<PortingEvent> = response._data().getOptional("data").getOrNull() ?: emptyList()
    ...
    override fun items(): List<PortingEvent> = data()
    ...
    fun autoPager(): AutoPagerAsync<PortingEvent> = AutoPagerAsync.from(this, streamHandlerExecutor)
