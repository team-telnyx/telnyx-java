...
class CampaignRetrieveMnoMetadataResponse
...
private constructor(
    ...
    /** A builder for [CampaignRetrieveMnoMetadataResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            campaignRetrieveMnoMetadataResponse: CampaignRetrieveMnoMetadataResponse
        ) = apply {
            mno10999 = campaignRetrieveMnoMetadataResponse.mno10999
            additionalProperties =
                campaignRetrieveMnoMetadataResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignRetrieveMnoMetadataResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CampaignRetrieveMnoMetadataResponse =
            CampaignRetrieveMnoMetadataResponse(mno10999, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CampaignRetrieveMnoMetadataResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignRetrieveMnoMetadataResponse &&
    ...
    override fun toString() =
        "CampaignRetrieveMnoMetadataResponse{mno10999=$mno10999, additionalProperties=$additionalProperties}"
}
