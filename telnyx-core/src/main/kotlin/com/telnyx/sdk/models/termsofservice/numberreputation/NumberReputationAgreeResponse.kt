...
class NumberReputationAgreeResponse
...
private constructor(
    ...
    /** A builder for [NumberReputationAgreeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberReputationAgreeResponse: NumberReputationAgreeResponse) = apply {
            data = numberReputationAgreeResponse.data
            additionalProperties = numberReputationAgreeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberReputationAgreeResponse].
         *
         ...
         */
        fun build(): NumberReputationAgreeResponse =
            NumberReputationAgreeResponse(
     ...
     *   expected type.
     */
    fun validate(): NumberReputationAgreeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberReputationAgreeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "NumberReputationAgreeResponse{data=$data, additionalProperties=$additionalProperties}"
}
