...
class PortingAdditionalDocument
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortingAdditionalDocument].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingAdditionalDocument]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingAdditionalDocument: PortingAdditionalDocument) = apply {
            id = portingAdditionalDocument.id
            contentType = portingAdditionalDocument.contentType
            createdAt = portingAdditionalDocument.createdAt
            documentId = portingAdditionalDocument.documentId
            documentType = portingAdditionalDocument.documentType
            filename = portingAdditionalDocument.filename
            portingOrderId = portingAdditionalDocument.portingOrderId
            recordType = portingAdditionalDocument.recordType
            updatedAt = portingAdditionalDocument.updatedAt
            additionalProperties = portingAdditionalDocument.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortingAdditionalDocument].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingAdditionalDocument =
     ...
     *   expected type.
     */
    fun validate(): PortingAdditionalDocument = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingAdditionalDocument &&
            id == other.id &&
    ...
    override fun toString() =
        "PortingAdditionalDocument{id=$id, contentType=$contentType, createdAt=$createdAt, documentId=$documentId, documentType=$documentType, filename=$filename, portingOrderId=$portingOrderId, recordType=$recordType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
