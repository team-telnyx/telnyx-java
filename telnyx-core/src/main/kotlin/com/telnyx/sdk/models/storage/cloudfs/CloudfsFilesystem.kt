...
/**
 * A CloudFS filesystem, including its metadata credential. This shape is returned only by create
 * and rotate-meta-token.
 */
class CloudfsFilesystem
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val id: JsonField<String>,
    private val createdAt: JsonField<OffsetDateTime>,
    private val metaToken: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("meta_token") @ExcludeMissing metaToken: JsonField<String> = JsonMissing.of(),
    ...
    /**
     * Metadata access token, in cleartext. Returned only by create and rotate-meta-token and not
     * retrievable afterwards — store it securely.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun metaToken(): Optional<String> = metaToken.getOptional("meta_token")
     ...
     * (the example below is shown without the credential; the actual response includes it). Pass it
     * to `juicefs mount`: the storage configuration is baked in at provisioning, so the metadata
     * URL is all a client needs to mount the filesystem.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * Returns the raw JSON value of [metaToken].
     *
     * Unlike [metaToken], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("meta_token") @ExcludeMissing fun _metaToken(): JsonField<String> = metaToken
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CloudfsFilesystem]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CloudfsFilesystem]. */
    class Builder internal constructor() {

        private var id: JsonField<String> = JsonMissing.of()
        private var createdAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var metaToken: JsonField<String> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(cloudfsFilesystem: CloudfsFilesystem) = apply {
            id = cloudfsFilesystem.id
            createdAt = cloudfsFilesystem.createdAt
            metaToken = cloudfsFilesystem.metaToken
            metaUrl = cloudfsFilesystem.metaUrl
            name = cloudfsFilesystem.name
            recordType = cloudfsFilesystem.recordType
            region = cloudfsFilesystem.region
            s3Bucket = cloudfsFilesystem.s3Bucket
            s3Endpoint = cloudfsFilesystem.s3Endpoint
            status = cloudfsFilesystem.status
            updatedAt = cloudfsFilesystem.updatedAt
            additionalProperties = cloudfsFilesystem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Metadata access token, in cleartext. Returned only by create and rotate-meta-token and
         * not retrievable afterwards — store it securely.
         */
        fun metaToken(metaToken: String) = metaToken(JsonField.of(metaToken))

        /**
         * Sets [Builder.metaToken] to an arbitrary JSON value.
         *
         * You should usually call [Builder.metaToken] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun metaToken(metaToken: JsonField<String>) = apply { this.metaToken = metaToken }

        /**
         * PostgreSQL connection URL for the filesystem's metadata database. In create and
         * rotate-meta-token responses it embeds the metadata token as the password:
         * `postgres://<database>:<meta_token>@us-east-1.telnyxcloudfs.com:5432/<database>?sslmode=require`
         * (the example below is shown without the credential; the actual response includes it).
         * Pass it to `juicefs mount`: the storage configuration is baked in at provisioning, so the
         * metadata URL is all a client needs to mount the filesystem.
         */
         ...
         *
         * You should usually call [Builder.metaUrl] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        /**
         * Returns an immutable instance of [CloudfsFilesystem].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CloudfsFilesystem =
            CloudfsFilesystem(
                id,
                createdAt,
                metaToken,
     ...
     *   expected type.
     */
    fun validate(): CloudfsFilesystem = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (metaToken.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloudfsFilesystem &&
            id == other.id &&
            createdAt == other.createdAt &&
            metaToken == other.metaToken &&
    ...
    override fun toString() =
        "CloudfsFilesystem{id=$id, createdAt=$createdAt, metaToken=$metaToken, metaUrl=$metaUrl, name=$name, recordType=$recordType, region=$region, s3Bucket=$s3Bucket, s3Endpoint=$s3Endpoint, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
