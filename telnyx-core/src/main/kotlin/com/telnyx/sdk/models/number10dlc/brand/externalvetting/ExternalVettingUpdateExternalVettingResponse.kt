...
class ExternalVettingUpdateExternalVettingResponse
...
private constructor(
    ...
    /** A builder for [ExternalVettingUpdateExternalVettingResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            createDate = externalVettingUpdateExternalVettingResponse.createDate
            evpId = externalVettingUpdateExternalVettingResponse.evpId
            vettedDate = externalVettingUpdateExternalVettingResponse.vettedDate
            vettingClass = externalVettingUpdateExternalVettingResponse.vettingClass
            vettingId = externalVettingUpdateExternalVettingResponse.vettingId
            vettingScore = externalVettingUpdateExternalVettingResponse.vettingScore
            vettingToken = externalVettingUpdateExternalVettingResponse.vettingToken
            additionalProperties =
                externalVettingUpdateExternalVettingResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingUpdateExternalVettingResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVettingUpdateExternalVettingResponse =
            ExternalVettingUpdateExternalVettingResponse(
                createDate,
                evpId,
                vettedDate,
    ...
    fun validate(): ExternalVettingUpdateExternalVettingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingUpdateExternalVettingResponse &&
    ...
    override fun toString() =
        "ExternalVettingUpdateExternalVettingResponse{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
