...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InsightGroupUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [InsightGroupUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InsightGroupUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(insightGroupUpdateParams: InsightGroupUpdateParams) = apply {
            groupId = insightGroupUpdateParams.groupId
            body = insightGroupUpdateParams.body.toBuilder()
            additionalHeaders = insightGroupUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = insightGroupUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InsightGroupUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InsightGroupUpdateParams =
    ...
    private constructor(
        ...
        ) : this(description, name, webhook, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(description, name, webhook, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(description, name, webhook, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{description=$description, name=$name, webhook=$webhook, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InsightGroupUpdateParams &&
    ...
    override fun toString() =
        "InsightGroupUpdateParams{groupId=$groupId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
