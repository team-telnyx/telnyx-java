...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RuleInput].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ruleInput: RuleInput) = apply {
            serve = ruleInput.serve
            match = ruleInput.match.map { it.toMutableList() }
            additionalProperties = ruleInput.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RuleInput].
         *
    ...
    override fun toString() =
        "RuleInput{serve=$serve, match=$match, additionalProperties=$additionalProperties}"
}
