...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("order_type") @ExcludeMissing orderType: JsonField<String> = JsonMissing.of(),
    ...
    /**
     * Indicates the completion level of the sub number orders report. The report must have a status
     * of 'success' before it can be downloaded.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SubNumberOrdersReport]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SubNumberOrdersReport]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subNumberOrdersReport: SubNumberOrdersReport) = apply {
            id = subNumberOrdersReport.id
            createdAt = subNumberOrdersReport.createdAt
            filters = subNumberOrdersReport.filters
            orderType = subNumberOrdersReport.orderType
            status = subNumberOrdersReport.status
            updatedAt = subNumberOrdersReport.updatedAt
            userId = subNumberOrdersReport.userId
            additionalProperties = subNumberOrdersReport.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubNumberOrdersReport].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubNumberOrdersReport =
    ...
    fun validate(): SubNumberOrdersReport = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubNumberOrdersReport &&
            id == other.id &&
    ...
    override fun toString() =
        "SubNumberOrdersReport{id=$id, createdAt=$createdAt, filters=$filters, orderType=$orderType, status=$status, updatedAt=$updatedAt, userId=$userId, additionalProperties=$additionalProperties}"
}
