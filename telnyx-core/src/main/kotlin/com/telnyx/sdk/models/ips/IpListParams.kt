...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IpListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IpListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IpListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ipListParams: IpListParams) = apply {
            filter = ipListParams.filter
            pageNumber = ipListParams.pageNumber
            pageSize = ipListParams.pageSize
            additionalHeaders = ipListParams.additionalHeaders.toBuilder()
            additionalQueryParams = ipListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IpListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IpListParams =
            IpListParams(
                filter,
                pageNumber,
                pageSize,
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Filter =
                Filter(connectionId, ipAddress, port, additionalProperties.build())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(connectionId, ipAddress, port, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{connectionId=$connectionId, ipAddress=$ipAddress, port=$port, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "IpListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
