...
private constructor(
     ...
     * must be within the phone number range and should not overlap with other activation ranges.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * Specifies the country code for this porting phone number block. It is a two-letter ISO 3166-1
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PortingPhoneNumberBlock]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingPhoneNumberBlock]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingPhoneNumberBlock: PortingPhoneNumberBlock) = apply {
            id = portingPhoneNumberBlock.id
            activationRanges = portingPhoneNumberBlock.activationRanges.map { it.toMutableList() }
            countryCode = portingPhoneNumberBlock.countryCode
            createdAt = portingPhoneNumberBlock.createdAt
            phoneNumberRange = portingPhoneNumberBlock.phoneNumberRange
            phoneNumberType = portingPhoneNumberBlock.phoneNumberType
            recordType = portingPhoneNumberBlock.recordType
            updatedAt = portingPhoneNumberBlock.updatedAt
            additionalProperties = portingPhoneNumberBlock.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Specifies the activation ranges for this porting phone number block. The activation range
         * must be within the phone number range and should not overlap with other activation
         * ranges.
         */
        ...
        /**
         * Specifies the country code for this porting phone number block. It is a two-letter ISO
        ...
        /**
         * Returns an immutable instance of [PortingPhoneNumberBlock].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingPhoneNumberBlock =
    ...
    fun validate(): PortingPhoneNumberBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * Specifies the end of the activation range. It must be no more than the end of the phone
         * number range.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingPhoneNumberBlock &&
            id == other.id &&
    ...
    override fun toString() =
        "PortingPhoneNumberBlock{id=$id, activationRanges=$activationRanges, countryCode=$countryCode, createdAt=$createdAt, phoneNumberRange=$phoneNumberRange, phoneNumberType=$phoneNumberType, recordType=$recordType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
