...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [QueueUpdateParams].
         *
    ...
    /** A builder for [QueueUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(queueUpdateParams: QueueUpdateParams) = apply {
            accountSid = queueUpdateParams.accountSid
            queueSid = queueUpdateParams.queueSid
            body = queueUpdateParams.body.toBuilder()
            additionalHeaders = queueUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = queueUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [QueueUpdateParams].
         *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(maxSize, additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (maxSize.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(maxSize, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{maxSize=$maxSize, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QueueUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(accountSid, queueSid, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "QueueUpdateParams{accountSid=$accountSid, queueSid=$queueSid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
