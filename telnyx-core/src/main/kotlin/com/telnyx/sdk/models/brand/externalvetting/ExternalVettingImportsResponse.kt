...
class ExternalVettingImportsResponse
...
private constructor(
    ...
    /** A builder for [ExternalVettingImportsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVettingImportsResponse: ExternalVettingImportsResponse) = apply {
            createDate = externalVettingImportsResponse.createDate
            evpId = externalVettingImportsResponse.evpId
            vettedDate = externalVettingImportsResponse.vettedDate
            vettingClass = externalVettingImportsResponse.vettingClass
            vettingId = externalVettingImportsResponse.vettingId
            vettingScore = externalVettingImportsResponse.vettingScore
            vettingToken = externalVettingImportsResponse.vettingToken
            additionalProperties =
                externalVettingImportsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingImportsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVettingImportsResponse =
            ExternalVettingImportsResponse(
                createDate,
                evpId,
                vettedDate,
    ...
    fun validate(): ExternalVettingImportsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingImportsResponse &&
    ...
    override fun toString() =
        "ExternalVettingImportsResponse{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
