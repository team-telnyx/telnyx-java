...
class UacConnectionUpdateParams
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun inbound(): Optional<UacInboundRequest> = body.inbound()
     ...
     *   server responded with an unexpected value).
     */
    fun noiseSuppression(): Optional<ConnectionNoiseSuppression> = body.noiseSuppression()
     ...
     */
    fun _inbound(): JsonField<UacInboundRequest> = body._inbound()
     ...
     * type.
     */
    fun _noiseSuppression(): JsonField<ConnectionNoiseSuppression> = body._noiseSuppression()
    ...
    companion object {
        ...
        @JvmStatic fun none(): UacConnectionUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [UacConnectionUpdateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacConnectionUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uacConnectionUpdateParams: UacConnectionUpdateParams) = apply {
            id = uacConnectionUpdateParams.id
            body = uacConnectionUpdateParams.body.toBuilder()
            additionalHeaders = uacConnectionUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = uacConnectionUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         * accepted as request parameters.
         */
        fun inbound(inbound: UacInboundRequest) = apply { body.inbound(inbound) }

        /**
         * Sets [Builder.inbound] to an arbitrary JSON value.
         *
         * You should usually call [Builder.inbound] with a well-typed [UacInboundRequest] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun inbound(inbound: JsonField<UacInboundRequest>) = apply { body.inbound(inbound) }
         ...
         */
        fun noiseSuppression(noiseSuppression: ConnectionNoiseSuppression) = apply {
        ...
        /**
         * Returns an immutable instance of [UacConnectionUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacConnectionUpdateParams =
    ...
    /**
     * Parameters that can be updated in a UAC connection. A UAC (User Agent Client) Connection
     * registers Telnyx to your PBX — the opposite of a standard SIP trunk, where the PBX registers
     * to Telnyx. Use UAC when your PBX doesn’t support outbound SIP registration or you need Telnyx
    ...
    private constructor(
        ...
        private val inbound: JsonField<UacInboundRequest>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            inbound: JsonField<UacInboundRequest> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun inbound(): Optional<UacInboundRequest> = inbound.getOptional("inbound")
        ...
        @JsonProperty("inbound")
        @ExcludeMissing
        fun _inbound(): JsonField<UacInboundRequest> = inbound
        ...
        class Builder internal constructor() {
            ...
            private var inbound: JsonField<UacInboundRequest> = JsonMissing.of()
             ...
             */
            fun inbound(inbound: UacInboundRequest) = inbound(JsonField.of(inbound))
             ...
             * supported value.
             */
            fun inbound(inbound: JsonField<UacInboundRequest>) = apply { this.inbound = inbound }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UacConnectionUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "UacConnectionUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
