...
class ActionEnableVoiceResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionEnableVoiceResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionEnableVoiceResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionEnableVoiceResponse: ActionEnableVoiceResponse) = apply {
            data = actionEnableVoiceResponse.data
            additionalProperties = actionEnableVoiceResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionEnableVoiceResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionEnableVoiceResponse =
            ActionEnableVoiceResponse(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ActionEnableVoiceResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionEnableVoiceResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionEnableVoiceResponse{data=$data, additionalProperties=$additionalProperties}"
}
