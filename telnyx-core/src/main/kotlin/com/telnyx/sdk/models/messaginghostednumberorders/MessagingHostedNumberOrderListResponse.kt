...
class MessagingHostedNumberOrderListResponse
...
private constructor(
    ...
    /** A builder for [MessagingHostedNumberOrderListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            messagingHostedNumberOrderListResponse: MessagingHostedNumberOrderListResponse
        ) = apply {
            data = messagingHostedNumberOrderListResponse.data.map { it.toMutableList() }
            meta = messagingHostedNumberOrderListResponse.meta
            additionalProperties =
                messagingHostedNumberOrderListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingHostedNumberOrderListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingHostedNumberOrderListResponse =
            MessagingHostedNumberOrderListResponse(
    ...
    fun validate(): MessagingHostedNumberOrderListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingHostedNumberOrderListResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "MessagingHostedNumberOrderListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
