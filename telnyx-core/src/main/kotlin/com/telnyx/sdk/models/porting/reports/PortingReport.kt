...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun params(): Optional<ExportPortingOrdersCsvReport> = params.getOptional("params")
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PortingReport]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingReport]. */
    class Builder internal constructor() {

        private var id: JsonField<String> = JsonMissing.of()
        private var createdAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var documentId: JsonField<String> = JsonMissing.of()
        private var params: JsonField<ExportPortingOrdersCsvReport> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(portingReport: PortingReport) = apply {
            id = portingReport.id
            createdAt = portingReport.createdAt
            documentId = portingReport.documentId
            params = portingReport.params
            recordType = portingReport.recordType
            reportType = portingReport.reportType
            status = portingReport.status
            updatedAt = portingReport.updatedAt
            additionalProperties = portingReport.additionalProperties.toMutableMap()
        }
         ...
         * yet supported value.
         */
        fun params(params: JsonField<ExportPortingOrdersCsvReport>) = apply { this.params = params }
        ...
        /**
         * Returns an immutable instance of [PortingReport].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingReport =
            PortingReport(
                id,
                createdAt,
                documentId,
    ...
    fun validate(): PortingReport = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PortingReport{id=$id, createdAt=$createdAt, documentId=$documentId, params=$params, recordType=$recordType, reportType=$reportType, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
