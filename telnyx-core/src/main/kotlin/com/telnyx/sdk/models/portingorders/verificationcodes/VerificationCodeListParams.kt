...
class VerificationCodeListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VerificationCodeListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [VerificationCodeListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VerificationCodeListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verificationCodeListParams: VerificationCodeListParams) = apply {
            id = verificationCodeListParams.id
            filter = verificationCodeListParams.filter
            pageNumber = verificationCodeListParams.pageNumber
            pageSize = verificationCodeListParams.pageSize
            sort = verificationCodeListParams.sort
            additionalHeaders = verificationCodeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = verificationCodeListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VerificationCodeListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VerificationCodeListParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                filter?.let {
                    it.verified().ifPresent { put("filter[verified]", it.toString()) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Filter = Filter(verified, additionalProperties.build())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(verified, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{verified=$verified, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerificationCodeListParams &&
            id == other.id &&
            filter == other.filter &&
    ...
    override fun toString() =
        "VerificationCodeListParams{id=$id, filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
