...
class PhoneNumberConfigurationListResponse
...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun userBundleId(): Optional<String> = userBundleId.getOptional("user_bundle_id")
     ...
     *
     * Unlike [userBundleId], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("user_bundle_id")
    @ExcludeMissing
    ...
    /** A builder for [PhoneNumberConfigurationListResponse]. */
    class Builder internal constructor() {
        ...
        private var userBundleId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            phoneNumberConfigurationListResponse: PhoneNumberConfigurationListResponse
        ) = apply {
            id = phoneNumberConfigurationListResponse.id
            createdAt = phoneNumberConfigurationListResponse.createdAt
            portingPhoneNumberId = phoneNumberConfigurationListResponse.portingPhoneNumberId
            recordType = phoneNumberConfigurationListResponse.recordType
            updatedAt = phoneNumberConfigurationListResponse.updatedAt
            userBundleId = phoneNumberConfigurationListResponse.userBundleId
            additionalProperties =
                phoneNumberConfigurationListResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.userBundleId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [PhoneNumberConfigurationListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoneNumberConfigurationListResponse =
            PhoneNumberConfigurationListResponse(
                id,
                createdAt,
                portingPhoneNumberId,
    ...
    fun validate(): PhoneNumberConfigurationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberConfigurationListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PhoneNumberConfigurationListResponse{id=$id, createdAt=$createdAt, portingPhoneNumberId=$portingPhoneNumberId, recordType=$recordType, updatedAt=$updatedAt, userBundleId=$userBundleId, additionalProperties=$additionalProperties}"
}
