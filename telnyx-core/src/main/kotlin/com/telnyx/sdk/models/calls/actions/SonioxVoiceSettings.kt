...
private constructor(
    ...
    ) : this(type, reduceSilence, speed, mutableMapOf())
     ...
     *
     * Unlike [reduceSilence], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("reduce_silence")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SonioxVoiceSettings].
         *
    ...
    /** A builder for [SonioxVoiceSettings]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sonioxVoiceSettings: SonioxVoiceSettings) = apply {
            type = sonioxVoiceSettings.type
            reduceSilence = sonioxVoiceSettings.reduceSilence
            speed = sonioxVoiceSettings.speed
            additionalProperties = sonioxVoiceSettings.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SonioxVoiceSettings].
         *
     ...
     *   expected type.
     */
    fun validate(): SonioxVoiceSettings = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SonioxVoiceSettings &&
            type == other.type &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(type, reduceSilence, speed, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "SonioxVoiceSettings{type=$type, reduceSilence=$reduceSilence, speed=$speed, additionalProperties=$additionalProperties}"
}
