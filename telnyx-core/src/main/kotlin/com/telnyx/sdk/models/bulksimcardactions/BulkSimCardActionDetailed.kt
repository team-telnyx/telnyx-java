...
class BulkSimCardActionDetailed
...
private constructor(
     ...
     *
     * Unlike [simCardActionsSummary], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("sim_card_actions_summary")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BulkSimCardActionDetailed].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BulkSimCardActionDetailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkSimCardActionDetailed: BulkSimCardActionDetailed) = apply {
            id = bulkSimCardActionDetailed.id
            actionType = bulkSimCardActionDetailed.actionType
            createdAt = bulkSimCardActionDetailed.createdAt
            recordType = bulkSimCardActionDetailed.recordType
            settings = bulkSimCardActionDetailed.settings
            simCardActionsSummary =
                bulkSimCardActionDetailed.simCardActionsSummary.map { it.toMutableList() }
            updatedAt = bulkSimCardActionDetailed.updatedAt
            additionalProperties = bulkSimCardActionDetailed.additionalProperties.toMutableMap()
        }
         ...
         */
        fun simCardActionsSummary(simCardActionsSummary: JsonField<List<SimCardActionsSummary>>) =
            apply {
        ...
        /**
         * Returns an immutable instance of [BulkSimCardActionDetailed].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BulkSimCardActionDetailed =
     ...
     *   expected type.
     */
    fun validate(): BulkSimCardActionDetailed = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (simCardActionsSummary.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BulkSimCardActionDetailed &&
            id == other.id &&
    ...
    override fun toString() =
        "BulkSimCardActionDetailed{id=$id, actionType=$actionType, createdAt=$createdAt, recordType=$recordType, settings=$settings, simCardActionsSummary=$simCardActionsSummary, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
