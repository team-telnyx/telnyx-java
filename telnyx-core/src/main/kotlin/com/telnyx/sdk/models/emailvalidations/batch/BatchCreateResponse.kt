...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): BatchCreateResponse =
            BatchCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        private val duplicatesRemoved: JsonField<Long>,
        ...
        private constructor(
            ...
            @JsonProperty("duplicates_removed")
            @ExcludeMissing
            duplicatesRemoved: JsonField<Long> = JsonMissing.of(),
        ...
        ) : this(id, duplicatesRemoved, recordType, status, total, webhookUrl, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun duplicatesRemoved(): Long = duplicatesRemoved.getRequired("duplicates_removed")
        ...
        /**
         * Returns the raw JSON value of [duplicatesRemoved].
         *
         * Unlike [duplicatesRemoved], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("duplicates_removed")
        @ExcludeMissing
        fun _duplicatesRemoved(): JsonField<Long> = duplicatesRemoved
        ...
        class Builder internal constructor() {
            ...
            private var duplicatesRemoved: JsonField<Long>? = null
            ...
            fun duplicatesRemoved(duplicatesRemoved: Long) =
                duplicatesRemoved(JsonField.of(duplicatesRemoved))

            /**
             * Sets [Builder.duplicatesRemoved] to an arbitrary JSON value.
             *
             * You should usually call [Builder.duplicatesRemoved] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun duplicatesRemoved(duplicatesRemoved: JsonField<Long>) = apply {
            ...
            fun build(): Data =
                Data(
                    checkRequired("id", id),
                    checkRequired("duplicatesRemoved", duplicatesRemoved),
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                (if (duplicatesRemoved.asKnown().isPresent) 1 else 0) +
        ...
        override fun toString() =
            "Data{id=$id, duplicatesRemoved=$duplicatesRemoved, recordType=$recordType, status=$status, total=$total, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "BatchCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
