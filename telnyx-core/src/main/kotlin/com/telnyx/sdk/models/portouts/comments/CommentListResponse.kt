...
private constructor(
    private val data: JsonField<List<PortoutComment>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PortoutComment>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<PortoutComment>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PortoutComment>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PortoutComment>>? = null
        ...
        fun data(data: List<PortoutComment>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PortoutComment>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<PortoutComment>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PortoutComment] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PortoutComment) = apply {
            this.data =
