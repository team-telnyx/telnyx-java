...
class CloudfListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<CloudfListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CloudfListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<CloudfListResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CloudfListResponse>> = data
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CloudfListPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CloudfListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CloudfListResponse>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(cloudfListPageResponse: CloudfListPageResponse) = apply {
            data = cloudfListPageResponse.data.map { it.toMutableList() }
            meta = cloudfListPageResponse.meta
            additionalProperties = cloudfListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CloudfListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CloudfListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CloudfListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CloudfListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CloudfListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CloudfListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CloudfListPageResponse =
            CloudfListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): CloudfListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloudfListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CloudfListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
