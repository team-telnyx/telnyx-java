...
class PartnerCampaignGetSharedByMeResponse
...
private constructor(
    ...
    /** A builder for [PartnerCampaignGetSharedByMeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            partnerCampaignGetSharedByMeResponse: PartnerCampaignGetSharedByMeResponse
        ) = apply {
            page = partnerCampaignGetSharedByMeResponse.page
            records = partnerCampaignGetSharedByMeResponse.records.map { it.toMutableList() }
            totalRecords = partnerCampaignGetSharedByMeResponse.totalRecords
            additionalProperties =
                partnerCampaignGetSharedByMeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignGetSharedByMeResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignGetSharedByMeResponse =
            PartnerCampaignGetSharedByMeResponse(
                page,
    ...
    fun validate(): PartnerCampaignGetSharedByMeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignGetSharedByMeResponse &&
            page == other.page &&
    ...
    override fun toString() =
        "PartnerCampaignGetSharedByMeResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
