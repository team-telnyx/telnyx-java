...
private constructor(
    private val data: JsonField<List<X402TransactionRecord>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<X402TransactionRecord>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<X402TransactionRecord>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<X402TransactionRecord>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<X402TransactionRecord>>? = null
        ...
        internal fun from(paymentListPageResponse: PaymentListPageResponse) = apply {
            ...
            meta = paymentListPageResponse.meta
            additionalProperties = paymentListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<X402TransactionRecord>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<X402TransactionRecord>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<X402TransactionRecord>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [X402TransactionRecord] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: X402TransactionRecord) = apply {
            this.data =
    ...
    override fun toString() =
        "PaymentListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
