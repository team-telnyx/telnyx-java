...
class MobileVoiceConnectionListResponse
...
private constructor(
    ...
    /** A builder for [MobileVoiceConnectionListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mobileVoiceConnectionListResponse: MobileVoiceConnectionListResponse) =
            apply {
                data = mobileVoiceConnectionListResponse.data.map { it.toMutableList() }
                meta = mobileVoiceConnectionListResponse.meta
                additionalProperties =
                    mobileVoiceConnectionListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MobileVoiceConnectionListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobileVoiceConnectionListResponse =
            MobileVoiceConnectionListResponse(
    ...
    fun validate(): MobileVoiceConnectionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobileVoiceConnectionListResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "MobileVoiceConnectionListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
