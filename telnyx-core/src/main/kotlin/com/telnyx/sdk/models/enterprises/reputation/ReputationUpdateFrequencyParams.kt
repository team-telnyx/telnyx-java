...
private constructor(
    ...
    /** A builder for [ReputationUpdateFrequencyParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(reputationUpdateFrequencyParams: ReputationUpdateFrequencyParams) =
            apply {
                enterpriseId = reputationUpdateFrequencyParams.enterpriseId
                body = reputationUpdateFrequencyParams.body.toBuilder()
                additionalHeaders = reputationUpdateFrequencyParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    reputationUpdateFrequencyParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ReputationUpdateFrequencyParams].
         *
         ...
         */
        fun build(): ReputationUpdateFrequencyParams =
            ReputationUpdateFrequencyParams(
                enterpriseId,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                    checkRequired("checkFrequency", checkFrequency),
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (checkFrequency.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(checkFrequency, additionalProperties) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReputationUpdateFrequencyParams &&
    ...
    override fun toString() =
        "ReputationUpdateFrequencyParams{enterpriseId=$enterpriseId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
