...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun meta(): Optional<EdgeComputePaginationMeta> = meta.getOptional("meta")
     ...
     */
    @JsonProperty("meta") @ExcludeMissing fun _meta(): JsonField<EdgeComputePaginationMeta> = meta
    ...
    class Builder internal constructor() {
        ...
        fun meta(meta: EdgeComputePaginationMeta) = meta(JsonField.of(meta))

        /**
         * Sets [Builder.meta] to an arbitrary JSON value.
         *
         * You should usually call [Builder.meta] with a well-typed [EdgeComputePaginationMeta]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun meta(meta: JsonField<EdgeComputePaginationMeta>) = apply { this.meta = meta }
