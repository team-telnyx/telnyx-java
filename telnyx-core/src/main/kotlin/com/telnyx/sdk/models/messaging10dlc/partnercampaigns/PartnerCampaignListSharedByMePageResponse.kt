...
class PartnerCampaignListSharedByMePageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val page: JsonField<Long>,
    private val records: JsonField<List<PartnerCampaignListSharedByMeResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        records: JsonField<List<PartnerCampaignListSharedByMeResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun records(): Optional<List<PartnerCampaignListSharedByMeResponse>> =
        records.getOptional("records")
    ...
    @JsonProperty("records")
    @ExcludeMissing
    fun _records(): JsonField<List<PartnerCampaignListSharedByMeResponse>> = records
    ...
    /** A builder for [PartnerCampaignListSharedByMePageResponse]. */
    class Builder internal constructor() {

        private var page: JsonField<Long> = JsonMissing.of()
        private var records: JsonField<MutableList<PartnerCampaignListSharedByMeResponse>>? = null
        ...
        internal fun from(
            ...
            page = partnerCampaignListSharedByMePageResponse.page
            records = partnerCampaignListSharedByMePageResponse.records.map { it.toMutableList() }
            totalRecords = partnerCampaignListSharedByMePageResponse.totalRecords
            additionalProperties =
                partnerCampaignListSharedByMePageResponse.additionalProperties.toMutableMap()
        }
        ...
        fun records(records: List<PartnerCampaignListSharedByMeResponse>) =
            records(JsonField.of(records))

        /**
         * Sets [Builder.records] to an arbitrary JSON value.
         *
         * You should usually call [Builder.records] with a well-typed
         * `List<PartnerCampaignListSharedByMeResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun records(records: JsonField<List<PartnerCampaignListSharedByMeResponse>>) = apply {
            this.records = records.map { it.toMutableList() }
        }

        /**
         * Adds a single [PartnerCampaignListSharedByMeResponse] to [records].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRecord(record: PartnerCampaignListSharedByMeResponse) = apply {
            records =
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignListSharedByMePageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignListSharedByMePageResponse =
            PartnerCampaignListSharedByMePageResponse(
                page,
    ...
    fun validate(): PartnerCampaignListSharedByMePageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignListSharedByMePageResponse &&
            page == other.page &&
    ...
    override fun toString() =
        "PartnerCampaignListSharedByMePageResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
