...
class NumbersPhoneNumberDetailed
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumbersPhoneNumberDetailed].
         *
    ...
    /** A builder for [NumbersPhoneNumberDetailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numbersPhoneNumberDetailed: NumbersPhoneNumberDetailed) = apply {
            id = numbersPhoneNumberDetailed.id
            countryIsoAlpha2 = numbersPhoneNumberDetailed.countryIsoAlpha2
            createdAt = numbersPhoneNumberDetailed.createdAt
            deletionLockEnabled = numbersPhoneNumberDetailed.deletionLockEnabled
            externalPin = numbersPhoneNumberDetailed.externalPin
            phoneNumber = numbersPhoneNumberDetailed.phoneNumber
            phoneNumberType = numbersPhoneNumberDetailed.phoneNumberType
            purchasedAt = numbersPhoneNumberDetailed.purchasedAt
            recordType = numbersPhoneNumberDetailed.recordType
            status = numbersPhoneNumberDetailed.status
            tags = numbersPhoneNumberDetailed.tags.map { it.toMutableList() }
            activatedAt = numbersPhoneNumberDetailed.activatedAt
            billingGroupId = numbersPhoneNumberDetailed.billingGroupId
            callForwardingEnabled = numbersPhoneNumberDetailed.callForwardingEnabled
            callRecordingEnabled = numbersPhoneNumberDetailed.callRecordingEnabled
            callerIdNameEnabled = numbersPhoneNumberDetailed.callerIdNameEnabled
            cnamListingEnabled = numbersPhoneNumberDetailed.cnamListingEnabled
            connectionId = numbersPhoneNumberDetailed.connectionId
            connectionName = numbersPhoneNumberDetailed.connectionName
            customerReference = numbersPhoneNumberDetailed.customerReference
            emergencyAddressId = numbersPhoneNumberDetailed.emergencyAddressId
            emergencyEnabled = numbersPhoneNumberDetailed.emergencyEnabled
            ...
            t38FaxGatewayEnabled = numbersPhoneNumberDetailed.t38FaxGatewayEnabled
            updatedAt = numbersPhoneNumberDetailed.updatedAt
            additionalProperties = numbersPhoneNumberDetailed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumbersPhoneNumberDetailed].
         *
         ...
         */
        fun build(): NumbersPhoneNumberDetailed =
     ...
     *   expected type.
     */
    fun validate(): NumbersPhoneNumberDetailed = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumbersPhoneNumberDetailed &&
            id == other.id &&
