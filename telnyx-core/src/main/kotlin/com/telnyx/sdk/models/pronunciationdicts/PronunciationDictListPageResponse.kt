...
private constructor(
    private val data: JsonField<List<PronunciationDictData>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PronunciationDictData>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<PronunciationDictData>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PronunciationDictData>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PronunciationDictData>>? = null
        ...
        /** Array of pronunciation dictionary objects. */
        fun data(data: List<PronunciationDictData>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PronunciationDictData>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<PronunciationDictData>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PronunciationDictData] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PronunciationDictData) = apply {
            this.data =
