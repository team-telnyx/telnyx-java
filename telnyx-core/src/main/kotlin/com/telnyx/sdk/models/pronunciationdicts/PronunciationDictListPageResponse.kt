...
class PronunciationDictListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<PronunciationDictListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PronunciationDictListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<PronunciationDictListResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PronunciationDictListResponse>> = data
    ...
    /** A builder for [PronunciationDictListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<PronunciationDictListResponse>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(pronunciationDictListPageResponse: PronunciationDictListPageResponse) =
            apply {
                data = pronunciationDictListPageResponse.data.map { it.toMutableList() }
                meta = pronunciationDictListPageResponse.meta
                additionalProperties =
                    pronunciationDictListPageResponse.additionalProperties.toMutableMap()
            }

        /** Array of pronunciation dictionary objects. */
        fun data(data: List<PronunciationDictListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<PronunciationDictListResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<PronunciationDictListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PronunciationDictListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PronunciationDictListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PronunciationDictListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PronunciationDictListPageResponse =
            PronunciationDictListPageResponse(
    ...
    fun validate(): PronunciationDictListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PronunciationDictListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PronunciationDictListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
