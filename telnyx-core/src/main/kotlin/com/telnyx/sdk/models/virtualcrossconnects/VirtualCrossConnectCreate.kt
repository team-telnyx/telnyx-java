...
class VirtualCrossConnectCreate
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VirtualCrossConnectCreate].
         *
    ...
    /** A builder for [VirtualCrossConnectCreate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(virtualCrossConnectCreate: VirtualCrossConnectCreate) = apply {
            ...
            regionCode = virtualCrossConnectCreate.regionCode
            bandwidthMbps = virtualCrossConnectCreate.bandwidthMbps
            bgpAsn = virtualCrossConnectCreate.bgpAsn
            cloudProvider = virtualCrossConnectCreate.cloudProvider
            cloudProviderRegion = virtualCrossConnectCreate.cloudProviderRegion
            primaryBgpKey = virtualCrossConnectCreate.primaryBgpKey
            primaryCloudAccountId = virtualCrossConnectCreate.primaryCloudAccountId
            primaryCloudIp = virtualCrossConnectCreate.primaryCloudIp
            primaryEnabled = virtualCrossConnectCreate.primaryEnabled
            primaryTelnyxIp = virtualCrossConnectCreate.primaryTelnyxIp
            secondaryBgpKey = virtualCrossConnectCreate.secondaryBgpKey
            secondaryCloudAccountId = virtualCrossConnectCreate.secondaryCloudAccountId
            secondaryCloudIp = virtualCrossConnectCreate.secondaryCloudIp
            secondaryEnabled = virtualCrossConnectCreate.secondaryEnabled
            secondaryTelnyxIp = virtualCrossConnectCreate.secondaryTelnyxIp
            additionalProperties = virtualCrossConnectCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VirtualCrossConnectCreate].
         *
         ...
         */
        fun build(): VirtualCrossConnectCreate =
     ...
     *   expected type.
     */
    fun validate(): VirtualCrossConnectCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VirtualCrossConnectCreate &&
            id == other.id &&
