...
private constructor(
    ...
    private val regulatoryRequirements: JsonField<List<UserRequirement>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        regulatoryRequirements: JsonField<List<UserRequirement>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun regulatoryRequirements(): Optional<List<UserRequirement>> =
    ...
    @JsonProperty("regulatory_requirements")
    @ExcludeMissing
    fun _regulatoryRequirements(): JsonField<List<UserRequirement>> = regulatoryRequirements
    ...
    class Builder internal constructor() {
        ...
        private var regulatoryRequirements: JsonField<MutableList<UserRequirement>>? = null
        ...
        fun regulatoryRequirements(regulatoryRequirements: List<UserRequirement>) =
         ...
         * `List<UserRequirement>` value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
        fun regulatoryRequirements(regulatoryRequirements: JsonField<List<UserRequirement>>) =
            apply {
                this.regulatoryRequirements = regulatoryRequirements.map { it.toMutableList() }
            }

        /**
         * Adds a single [UserRequirement] to [regulatoryRequirements].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRegulatoryRequirement(regulatoryRequirement: UserRequirement) = apply {
            regulatoryRequirements =
