...
/**
 * Requests asynchronous generation of one `summary` or `action_items` artifact. Each type requires
 * its own request. Generation requires transcript content and configured inference and currently
 * reads at most the first 10,000 segments, so exceptionally long transcripts may produce incomplete
 * artifacts or fail model limits.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(artifactCreateParams: ArtifactCreateParams) = apply {
            ...
            body = artifactCreateParams.body.toBuilder()
