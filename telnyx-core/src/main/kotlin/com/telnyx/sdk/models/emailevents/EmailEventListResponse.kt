...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.emailId] with a well-typed [String] value instead.
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("from")
                @ExcludeMissing
                from: JsonField<EmailAddress> = JsonMissing.of(),
        ...
        override fun toString() =
            "Data{id=$id, emailId=$emailId, occurredAt=$occurredAt, recordType=$recordType, type=$type, email=$email, payload=$payload, additionalProperties=$additionalProperties}"
    }
