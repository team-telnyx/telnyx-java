...
class ConferenceRecordingSaved
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferenceRecordingSaved]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceRecordingSaved]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceRecordingSaved: ConferenceRecordingSaved) = apply {
            id = conferenceRecordingSaved.id
            eventType = conferenceRecordingSaved.eventType
            payload = conferenceRecordingSaved.payload
            recordType = conferenceRecordingSaved.recordType
            additionalProperties = conferenceRecordingSaved.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceRecordingSaved].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceRecordingSaved =
    ...
    fun validate(): ConferenceRecordingSaved = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_RECORDING_SAVED = of("conference.recording.saved")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_RECORDING_SAVED -> Value.CONFERENCE_RECORDING_SAVED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_RECORDING_SAVED -> Known.CONFERENCE_RECORDING_SAVED
    ...
    private constructor(
        ...
        /**
         * Recording URLs in requested format. The URL is valid for as long as the file exists. For
         * security purposes, this feature is activated on a per request basis. Please contact
         * customer support with your Account ID to request activation.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
         ...
         *   server responded with an unexpected value).
         */
        fun recordingUrls(): Optional<RecordingUrls> = recordingUrls.getOptional("recording_urls")
        ...
        class Builder internal constructor() {
             ...
             * [PublicRecordingUrls] value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun publicRecordingUrls(publicRecordingUrls: JsonField<PublicRecordingUrls>) = apply {
             ...
             *
             * You should usually call [Builder.recordingEndedAt] with a well-typed [OffsetDateTime]
        ...
        private constructor(
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PublicRecordingUrls].
                 */
                @JvmStatic fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(publicRecordingUrls: PublicRecordingUrls) = apply {
                    ...
                    additionalProperties = publicRecordingUrls.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.mp3] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.wav] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callSessionId=$callSessionId, channels=$channels, clientState=$clientState, conferenceId=$conferenceId, connectionId=$connectionId, format=$format, publicRecordingUrls=$publicRecordingUrls, recordingEndedAt=$recordingEndedAt, recordingId=$recordingId, recordingStartedAt=$recordingStartedAt, recordingUrls=$recordingUrls, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceRecordingSaved &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceRecordingSaved{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
