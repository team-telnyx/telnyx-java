...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(portingOrderListParams: PortingOrderListParams) = apply {
            ...
            pageNumber = portingOrderListParams.pageNumber
            pageSize = portingOrderListParams.pageSize
    ...
    override fun toString() =
        "PortingOrderListParams{filter=$filter, includePhoneNumbers=$includePhoneNumbers, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
