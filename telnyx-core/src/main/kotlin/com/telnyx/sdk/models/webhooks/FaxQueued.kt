...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FaxQueued]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FaxQueued]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxQueued: FaxQueued) = apply {
            data = faxQueued.data
            meta = faxQueued.meta
            additionalProperties = faxQueued.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxQueued].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxQueued = FaxQueued(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FaxQueued = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "FaxQueued{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
