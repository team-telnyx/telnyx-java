...
/**
 * Returns the full product catalog with pagination. Each entry contains a slug, display name, and
 * description. Use the slug to fetch per-product pricing via GET /pricing/products/{slug}.
 */
...
private constructor(
    ...
    override fun toString() =
        "ProductListParams{pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
