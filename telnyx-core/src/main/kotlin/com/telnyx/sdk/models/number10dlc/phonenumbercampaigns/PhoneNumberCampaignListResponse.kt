...
class PhoneNumberCampaignListResponse
...
private constructor(
    ...
    /** A builder for [PhoneNumberCampaignListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberCampaignListResponse: PhoneNumberCampaignListResponse) =
            apply {
                page = phoneNumberCampaignListResponse.page
                records = phoneNumberCampaignListResponse.records.map { it.toMutableList() }
                totalRecords = phoneNumberCampaignListResponse.totalRecords
                additionalProperties =
                    phoneNumberCampaignListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberCampaignListResponse].
         *
         ...
         */
        fun build(): PhoneNumberCampaignListResponse =
            PhoneNumberCampaignListResponse(
    ...
    fun validate(): PhoneNumberCampaignListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberCampaignListResponse &&
            page == other.page &&
    ...
    override fun toString() =
        "PhoneNumberCampaignListResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
