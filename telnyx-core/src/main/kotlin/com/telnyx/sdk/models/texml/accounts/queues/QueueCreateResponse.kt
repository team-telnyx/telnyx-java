...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [QueueCreateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [QueueCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(queueCreateResponse: QueueCreateResponse) = apply {
            accountSid = queueCreateResponse.accountSid
            averageWaitTime = queueCreateResponse.averageWaitTime
            currentSize = queueCreateResponse.currentSize
            dateCreated = queueCreateResponse.dateCreated
            dateUpdated = queueCreateResponse.dateUpdated
            maxSize = queueCreateResponse.maxSize
            sid = queueCreateResponse.sid
            subresourceUris = queueCreateResponse.subresourceUris
            uri = queueCreateResponse.uri
            additionalProperties = queueCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [QueueCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): QueueCreateResponse =
            QueueCreateResponse(
                accountSid,
                averageWaitTime,
                currentSize,
    ...
    fun validate(): QueueCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QueueCreateResponse &&
    ...
    override fun toString() =
        "QueueCreateResponse{accountSid=$accountSid, averageWaitTime=$averageWaitTime, currentSize=$currentSize, dateCreated=$dateCreated, dateUpdated=$dateUpdated, maxSize=$maxSize, sid=$sid, subresourceUris=$subresourceUris, uri=$uri, additionalProperties=$additionalProperties}"
}
