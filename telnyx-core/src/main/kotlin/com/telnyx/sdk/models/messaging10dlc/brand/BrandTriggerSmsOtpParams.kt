 ...
 */
class BrandTriggerSmsOtpParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandTriggerSmsOtpParams].
         *
    ...
    /** A builder for [BrandTriggerSmsOtpParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandTriggerSmsOtpParams: BrandTriggerSmsOtpParams) = apply {
            brandId = brandTriggerSmsOtpParams.brandId
            body = brandTriggerSmsOtpParams.body.toBuilder()
            additionalHeaders = brandTriggerSmsOtpParams.additionalHeaders.toBuilder()
            additionalQueryParams = brandTriggerSmsOtpParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BrandTriggerSmsOtpParams].
         *
         ...
         */
        fun build(): BrandTriggerSmsOtpParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandTriggerSmsOtpParams &&
    ...
    override fun toString() =
        "BrandTriggerSmsOtpParams{brandId=$brandId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
