...
class ConferenceParticipantJoined
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConferenceParticipantJoined].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceParticipantJoined]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceParticipantJoined: ConferenceParticipantJoined) = apply {
            id = conferenceParticipantJoined.id
            eventType = conferenceParticipantJoined.eventType
            occurredAt = conferenceParticipantJoined.occurredAt
            payload = conferenceParticipantJoined.payload
            recordType = conferenceParticipantJoined.recordType
            additionalProperties = conferenceParticipantJoined.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceParticipantJoined].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceParticipantJoined =
    ...
    fun validate(): ConferenceParticipantJoined = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_PARTICIPANT_JOINED = of("conference.participant.joined")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PARTICIPANT_JOINED -> Value.CONFERENCE_PARTICIPANT_JOINED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PARTICIPANT_JOINED -> Known.CONFERENCE_PARTICIPANT_JOINED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, conferenceId=$conferenceId, connectionId=$connectionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceParticipantJoined &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceParticipantJoined{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
