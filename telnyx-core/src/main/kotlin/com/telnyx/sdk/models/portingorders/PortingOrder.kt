...
private constructor(
    ...
    private val phoneNumbers: JsonField<List<PortingPhoneNumber>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        phoneNumbers: JsonField<List<PortingPhoneNumber>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun phoneNumbers(): Optional<List<PortingPhoneNumber>> =
    ...
    @JsonProperty("phone_numbers")
    @ExcludeMissing
    fun _phoneNumbers(): JsonField<List<PortingPhoneNumber>> = phoneNumbers
    ...
    class Builder internal constructor() {
        ...
        private var phoneNumbers: JsonField<MutableList<PortingPhoneNumber>>? = null
        ...
        internal fun from(portingOrder: PortingOrder) = apply {
            ...
            phoneNumbers = portingOrder.phoneNumbers.map { it.toMutableList() }
        ...
        /** List of phone numbers associated with this porting order */
        fun phoneNumbers(phoneNumbers: List<PortingPhoneNumber>) =
         ...
         * `List<PortingPhoneNumber>` value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun phoneNumbers(phoneNumbers: JsonField<List<PortingPhoneNumber>>) = apply {
            this.phoneNumbers = phoneNumbers.map { it.toMutableList() }
        }

        /**
         * Adds a single [PortingPhoneNumber] to [phoneNumbers].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPhoneNumber(phoneNumber: PortingPhoneNumber) = apply {
            phoneNumbers =
