 ...
 * from it. Send a transcript to `ingest` instead. Remembering the same text again writes the same
 * memory rather than a second copy of it, so a retry is safe. The write runs asynchronously -- poll
 * the returned operation.
 */
class ProfileRememberParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfileRememberParams].
         *
    ...
    /** A builder for [ProfileRememberParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(profileRememberParams: ProfileRememberParams) = apply {
            namespace = profileRememberParams.namespace
            profileId = profileRememberParams.profileId
            body = profileRememberParams.body.toBuilder()
            additionalHeaders = profileRememberParams.additionalHeaders.toBuilder()
            additionalQueryParams = profileRememberParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileRememberParams].
         *
         ...
         */
        fun build(): ProfileRememberParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileRememberParams &&
    ...
    override fun toString() =
        "ProfileRememberParams{namespace=$namespace, profileId=$profileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
