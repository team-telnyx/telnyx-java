...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("national") @ExcludeMissing national: JsonField<National> = JsonMissing.of(),
        ...
        @JsonProperty("quickship") @ExcludeMissing quickship: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("toll_free") @ExcludeMissing tollFree: JsonField<TollFree> = JsonMissing.of(),
    ) : this(
        code,
        features,
        internationalSms,
     ...
     *   server responded with an unexpected value).
     */
    fun internationalSms(): Optional<Boolean> = internationalSms.getOptional("international_sms")
     ...
     *   server responded with an unexpected value).
     */
    fun inventoryCoverage(): Optional<Boolean> = inventoryCoverage.getOptional("inventory_coverage")
     ...
     *   server responded with an unexpected value).
     */
    fun phoneNumberType(): Optional<List<String>> = phoneNumberType.getOptional("phone_number_type")
     ...
     */
    @JsonProperty("reservable") @ExcludeMissing fun _reservable(): JsonField<Boolean> = reservable
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CountryCoverage]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CountryCoverage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(countryCoverage: CountryCoverage) = apply {
            code = countryCoverage.code
            features = countryCoverage.features.map { it.toMutableList() }
            internationalSms = countryCoverage.internationalSms
            inventoryCoverage = countryCoverage.inventoryCoverage
            local = countryCoverage.local
            mobile = countryCoverage.mobile
            national = countryCoverage.national
            numbers = countryCoverage.numbers
            p2p = countryCoverage.p2p
            phoneNumberType = countryCoverage.phoneNumberType.map { it.toMutableList() }
            quickship = countryCoverage.quickship
            region = countryCoverage.region
            reservable = countryCoverage.reservable
            sharedCost = countryCoverage.sharedCost
            tollFree = countryCoverage.tollFree
            additionalProperties = countryCoverage.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.mobile] with a well-typed [Mobile] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.national] with a well-typed [National] value instead.
         ...
         *
         * You should usually call [Builder.numbers] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.phoneNumberType] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.quickship] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         *
         * You should usually call [Builder.reservable] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
         ...
         * supported value.
         */
        fun sharedCost(sharedCost: JsonField<SharedCost>) = apply { this.sharedCost = sharedCost }
         ...
         *
         * You should usually call [Builder.tollFree] with a well-typed [TollFree] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [CountryCoverage].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CountryCoverage =
            CountryCoverage(
                code,
    ...
    fun validate(): CountryCoverage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CountryCoverage &&
            code == other.code &&
            features == other.features &&
            internationalSms == other.internationalSms &&
