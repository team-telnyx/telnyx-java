...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventsListResponse].
         *
    ...
    /** A builder for [EventsListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventsListResponse: EventsListResponse) = apply {
            data = eventsListResponse.data.map { it.toMutableList() }
            meta = eventsListResponse.meta
            additionalProperties = eventsListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EventsListResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): EventsListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventsListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "EventsListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
