...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallLeftQueue]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallLeftQueue]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callLeftQueue: CallLeftQueue) = apply {
            id = callLeftQueue.id
            eventType = callLeftQueue.eventType
            occurredAt = callLeftQueue.occurredAt
            payload = callLeftQueue.payload
            recordType = callLeftQueue.recordType
            additionalProperties = callLeftQueue.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallLeftQueue].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallLeftQueue =
            CallLeftQueue(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallLeftQueue = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CallLeftQueue{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
