...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SimCardListPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SimCardListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(simCardListPageResponse: SimCardListPageResponse) = apply {
            data = simCardListPageResponse.data.map { it.toMutableList() }
            meta = simCardListPageResponse.meta
            additionalProperties = simCardListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SimCardListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SimCardListPageResponse =
            SimCardListPageResponse(
    ...
    fun validate(): SimCardListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimCardListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "SimCardListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
