...
/** Get Enum */
class Number10dlcGetEnumParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): Number10dlcGetEnumParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [Number10dlcGetEnumParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [Number10dlcGetEnumParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(number10dlcGetEnumParams: Number10dlcGetEnumParams) = apply {
            endpoint = number10dlcGetEnumParams.endpoint
            additionalHeaders = number10dlcGetEnumParams.additionalHeaders.toBuilder()
            additionalQueryParams = number10dlcGetEnumParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [Number10dlcGetEnumParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): Number10dlcGetEnumParams =
            Number10dlcGetEnumParams(
                endpoint,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Number10dlcGetEnumParams &&
    ...
    override fun toString() =
        "Number10dlcGetEnumParams{endpoint=$endpoint, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
