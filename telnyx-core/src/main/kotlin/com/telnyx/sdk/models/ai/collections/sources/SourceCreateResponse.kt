...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SourceCreateResponse]. */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceCreateResponse: SourceCreateResponse) = apply {
            data = sourceCreateResponse.data
        ...
        /**
         * Returns an immutable instance of [SourceCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SourceCreateResponse =
            SourceCreateResponse(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): SourceCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SourceCreateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SourceCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
