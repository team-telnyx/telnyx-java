...
private constructor(
    private val data: JsonField<CallRecordingSaved>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CallRecordingSaved> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallRecordingSaved> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CallRecordingSaved> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallRecordingSaved> = JsonMissing.of()
        ...
        fun data(data: CallRecordingSaved) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CallRecordingSaved] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CallRecordingSaved>) = apply { this.data = data }
