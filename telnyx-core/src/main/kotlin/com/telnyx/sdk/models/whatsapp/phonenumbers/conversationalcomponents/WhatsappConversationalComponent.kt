...
class WhatsappConversationalComponent
...
private constructor(
     ...
     */
    @JsonProperty("commands") @ExcludeMissing fun _commands(): JsonField<List<Command>> = commands
    ...
    /** A builder for [WhatsappConversationalComponent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(whatsappConversationalComponent: WhatsappConversationalComponent) =
            apply {
                commands = whatsappConversationalComponent.commands.map { it.toMutableList() }
                iceBreakers = whatsappConversationalComponent.iceBreakers.map { it.toMutableList() }
                phoneNumber = whatsappConversationalComponent.phoneNumber
                recordType = whatsappConversationalComponent.recordType
                additionalProperties =
                    whatsappConversationalComponent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [WhatsappConversationalComponent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WhatsappConversationalComponent =
            WhatsappConversationalComponent(
     ...
     *   expected type.
     */
    fun validate(): WhatsappConversationalComponent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappConversationalComponent &&
    ...
    override fun toString() =
        "WhatsappConversationalComponent{commands=$commands, iceBreakers=$iceBreakers, phoneNumber=$phoneNumber, recordType=$recordType, additionalProperties=$additionalProperties}"
}
