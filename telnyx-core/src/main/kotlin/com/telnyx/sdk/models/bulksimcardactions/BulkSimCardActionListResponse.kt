...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bulkSimCardActionListResponse: BulkSimCardActionListResponse) = apply {
            id = bulkSimCardActionListResponse.id
            actionType = bulkSimCardActionListResponse.actionType
            createdAt = bulkSimCardActionListResponse.createdAt
            recordType = bulkSimCardActionListResponse.recordType
            settings = bulkSimCardActionListResponse.settings
            simCardActionsSummary =
                bulkSimCardActionListResponse.simCardActionsSummary.map { it.toMutableList() }
            updatedAt = bulkSimCardActionListResponse.updatedAt
    ...
    override fun toString() =
        "BulkSimCardActionListResponse{id=$id, actionType=$actionType, createdAt=$createdAt, recordType=$recordType, settings=$settings, simCardActionsSummary=$simCardActionsSummary, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
