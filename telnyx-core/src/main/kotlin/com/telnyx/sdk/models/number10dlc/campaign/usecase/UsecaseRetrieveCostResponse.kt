...
class UsecaseRetrieveCostResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsecaseRetrieveCostResponse].
         *
    ...
    /** A builder for [UsecaseRetrieveCostResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usecaseRetrieveCostResponse: UsecaseRetrieveCostResponse) = apply {
            campaignUsecase = usecaseRetrieveCostResponse.campaignUsecase
            description = usecaseRetrieveCostResponse.description
            monthlyCost = usecaseRetrieveCostResponse.monthlyCost
            upFrontCost = usecaseRetrieveCostResponse.upFrontCost
            additionalProperties = usecaseRetrieveCostResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsecaseRetrieveCostResponse].
         *
         ...
         */
        fun build(): UsecaseRetrieveCostResponse =
    ...
    fun validate(): UsecaseRetrieveCostResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsecaseRetrieveCostResponse &&
    ...
    override fun toString() =
        "UsecaseRetrieveCostResponse{campaignUsecase=$campaignUsecase, description=$description, monthlyCost=$monthlyCost, upFrontCost=$upFrontCost, additionalProperties=$additionalProperties}"
}
