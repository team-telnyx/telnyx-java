...
class UserGetGroupsReportResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserGetGroupsReportResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserGetGroupsReportResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userGetGroupsReportResponse: UserGetGroupsReportResponse) = apply {
            data = userGetGroupsReportResponse.data.map { it.toMutableList() }
            additionalProperties = userGetGroupsReportResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserGetGroupsReportResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserGetGroupsReportResponse =
    ...
    fun validate(): UserGetGroupsReportResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun groups(): List<UserGroupReference> = groups.getRequired("groups")
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun userStatus(): UserStatus = userStatus.getRequired("user_status")
        ...
        class Builder internal constructor() {
            ...
            private var userStatus: JsonField<UserStatus>? = null
            ...
            fun build(): Data =
                Data(
                    ...
                    checkRequired("userStatus", userStatus),
                    lastSignInAt,
                    organizationUserBypassesSso,
                    additionalProperties.toMutableMap(),
                )
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, email=$email, groups=$groups, recordType=$recordType, userStatus=$userStatus, lastSignInAt=$lastSignInAt, organizationUserBypassesSso=$organizationUserBypassesSso, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserGetGroupsReportResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "UserGetGroupsReportResponse{data=$data, additionalProperties=$additionalProperties}"
}
