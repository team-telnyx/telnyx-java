...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortingEventWithoutWebhook].
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(portingEventWithoutWebhook: PortingEventWithoutWebhook) = apply {
            ...
            availableNotificationMethods =
                portingEventWithoutWebhook.availableNotificationMethods.map { it.toMutableList() }
            ...
            additionalProperties = portingEventWithoutWebhook.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.payload] with a well-typed [Void] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
