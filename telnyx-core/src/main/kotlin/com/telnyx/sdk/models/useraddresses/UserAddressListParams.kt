...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userAddressListParams: UserAddressListParams) = apply {
            ...
            pageNumber = userAddressListParams.pageNumber
            pageSize = userAddressListParams.pageSize
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun build(): CustomerReference =
                    CustomerReference(contains, eq, additionalProperties.build())
            }
            ...
            override fun toString() =
                "CustomerReference{contains=$contains, eq=$eq, additionalProperties=$additionalProperties}"
        }
    ...
    override fun toString() =
        "UserAddressListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
