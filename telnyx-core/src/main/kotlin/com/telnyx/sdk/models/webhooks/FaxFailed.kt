...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FaxFailed]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FaxFailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxFailed: FaxFailed) = apply {
            data = faxFailed.data
            meta = faxFailed.meta
            additionalProperties = faxFailed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxFailed].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxFailed = FaxFailed(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FaxFailed = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "FaxFailed{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
