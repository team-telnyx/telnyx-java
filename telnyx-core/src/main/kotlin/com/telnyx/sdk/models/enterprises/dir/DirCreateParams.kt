 ...
 *
 * **Field rules**
 * - `display_name`: 1–35 characters, no emoji or whitespace-only strings; this is the name shown to
 *   recipients.
 * - `call_reasons`: 1–10 strings, each ≤64 characters; describe why your business calls customers
 *   (e.g. 'Appointment reminders', 'Billing inquiries'). Validate the wording against `POST
 *   /call_reasons/validate`.
 * - `logo_url`: HTTPS URL (max 128 chars) to a 256×256 BMP (max 1 MB). The image is downloaded and
 *   hashed at submission time.
 * - `documents`: up to 20 entries; each `document_id` must be obtained by uploading the file via
 *   the Telnyx Documents API first. Within one DIR a `document_id` may only appear once.
...
private constructor(
    ...
    /**
     * Contact email of the authorizer. Telnyx may send verification or infringement-notice email
     * here; use a monitored mailbox.
     *
    ...
    /**
     * Name of the person at your enterprise who is authorizing this DIR registration. Must be a
     * real individual (used for audit and trademark-claim contests).
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirCreateParams: DirCreateParams) = apply {
            enterpriseId = dirCreateParams.enterpriseId
            body = dirCreateParams.body.toBuilder()
            additionalHeaders = dirCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = dirCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DirCreateParams].
         *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Name of the person at your enterprise who is authorizing this DIR registration. Must
             * be a real individual (used for audit and trademark-claim contests).
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirCreateParams &&
    ...
    override fun toString() =
        "DirCreateParams{enterpriseId=$enterpriseId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
