...
private constructor(
    private val data: JsonField<WebhookDelivery>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<WebhookDelivery> = JsonMissing.of()
     ...
     */
    fun data(): Optional<WebhookDelivery> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<WebhookDelivery> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<WebhookDelivery> = JsonMissing.of()
        ...
        /** Record of all attempts to deliver a webhook. */
        fun data(data: WebhookDelivery) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [WebhookDelivery] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<WebhookDelivery>) = apply { this.data = data }
