...
class CallDeepfakeDetectionErrorWebhookEvent
...
private constructor(
    ...
    /** A builder for [CallDeepfakeDetectionErrorWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                callDeepfakeDetectionErrorWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallDeepfakeDetectionErrorWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallDeepfakeDetectionErrorWebhookEvent =
            CallDeepfakeDetectionErrorWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallDeepfakeDetectionErrorWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_DEEPFAKE_DETECTION_ERROR = of("call.deepfake_detection.error")
            ...
            fun value(): Value =
                when (this) {
                    CALL_DEEPFAKE_DETECTION_ERROR -> Value.CALL_DEEPFAKE_DETECTION_ERROR
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_DEEPFAKE_DETECTION_ERROR -> Known.CALL_DEEPFAKE_DETECTION_ERROR
        ...
        private constructor(
            ...
            private val errorMessage: JsonField<ErrorMessage>,
            private val additionalProperties: MutableMap<String, JsonValue>,
        ) {
            ...
            private constructor(
                ...
                @ExcludeMissing
                errorMessage: JsonField<ErrorMessage> = JsonMissing.of(),
            ) : this(
                callControlId,
                callLegId,
                callSessionId,
             ...
             *   the server responded with an unexpected value).
             */
            fun errorMessage(): Optional<ErrorMessage> = errorMessage.getOptional("error_message")
            ...
            @JsonProperty("error_message")
            @ExcludeMissing
            fun _errorMessage(): JsonField<ErrorMessage> = errorMessage
            ...
            class Builder internal constructor() {
                ...
                private var errorMessage: JsonField<ErrorMessage> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                fun errorMessage(errorMessage: ErrorMessage) =
                    errorMessage(JsonField.of(errorMessage))

                /**
                 * Sets [Builder.errorMessage] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.errorMessage] with a well-typed [ErrorMessage]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun errorMessage(errorMessage: JsonField<ErrorMessage>) = apply {
            ...
            fun validate(): Payload = apply {
                ...
                clientState()
                connectionId()
                errorMessage().ifPresent { it.validate() }
                validated = true
            }
            ...
            internal fun validity(): Int =
                (if (callControlId.asKnown().isPresent) 1 else 0) +
                    ...
                    (errorMessage.asKnown().getOrNull()?.validity() ?: 0)
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val DETECTION_TIMEOUT = of("detection_timeout")

                    @JvmField val RTP_TIMEOUT = of("rtp_timeout")

                    @JvmField val DFD_CONNECTION_ERROR = of("dfd_connection_error")

                    @JvmField val DFD_STREAM_ERROR = of("dfd_stream_error")

                    @JvmStatic fun of(value: String) = ErrorMessage(JsonField.of(value))
                }

                /** An enum containing [ErrorMessage]'s known values. */
                enum class Known {
                    DETECTION_TIMEOUT,
                    RTP_TIMEOUT,
                ...
                /**
                 * An enum containing [ErrorMessage]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [ErrorMessage] can contain an unknown value in a couple of cases:
                ...
                enum class Value {
                    ...
                    DFD_STREAM_ERROR,
                    /**
                     * An enum member indicating that [ErrorMessage] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
                ...
                fun value(): Value =
                    when (this) {
                        DETECTION_TIMEOUT -> Value.DETECTION_TIMEOUT
                        RTP_TIMEOUT -> Value.RTP_TIMEOUT
                        DFD_CONNECTION_ERROR -> Value.DFD_CONNECTION_ERROR
                        DFD_STREAM_ERROR -> Value.DFD_STREAM_ERROR
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        DETECTION_TIMEOUT -> Known.DETECTION_TIMEOUT
                        RTP_TIMEOUT -> Known.RTP_TIMEOUT
                        DFD_CONNECTION_ERROR -> Known.DFD_CONNECTION_ERROR
                        DFD_STREAM_ERROR -> Known.DFD_STREAM_ERROR
                        else -> throw TelnyxInvalidDataException("Unknown ErrorMessage: $value")
                    }
                ...
                fun validate(): ErrorMessage = apply {
                    if (validated) {
                        return@apply
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is ErrorMessage && value == other.value
                }
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, errorMessage=$errorMessage, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallDeepfakeDetectionErrorWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallDeepfakeDetectionErrorWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
