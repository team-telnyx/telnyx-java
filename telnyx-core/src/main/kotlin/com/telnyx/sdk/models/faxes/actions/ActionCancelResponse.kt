...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ActionCancelResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionCancelResponse: ActionCancelResponse) = apply {
            result = actionCancelResponse.result
            additionalProperties = actionCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionCancelResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionCancelResponse =
            ActionCancelResponse(result, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionCancelResponse &&
            result == other.result &&
    ...
    override fun toString() =
        "ActionCancelResponse{result=$result, additionalProperties=$additionalProperties}"
}
