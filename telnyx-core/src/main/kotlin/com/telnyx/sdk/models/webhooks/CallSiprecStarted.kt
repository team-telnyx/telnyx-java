...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallSiprecStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallSiprecStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callSiprecStarted: CallSiprecStarted) = apply {
            id = callSiprecStarted.id
            eventType = callSiprecStarted.eventType
            occurredAt = callSiprecStarted.occurredAt
            payload = callSiprecStarted.payload
            recordType = callSiprecStarted.recordType
            additionalProperties = callSiprecStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallSiprecStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallSiprecStarted =
            CallSiprecStarted(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallSiprecStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SIPREC_STARTED = of("siprec.started")
        ...
        fun value(): Value =
            when (this) {
                SIPREC_STARTED -> Value.SIPREC_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SIPREC_STARTED -> Known.SIPREC_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallSiprecStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallSiprecStarted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
