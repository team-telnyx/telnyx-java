...
class McpServerRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [McpServerRetrieveResponse].
         *
    ...
    /** A builder for [McpServerRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mcpServerRetrieveResponse: McpServerRetrieveResponse) = apply {
            id = mcpServerRetrieveResponse.id
            createdAt = mcpServerRetrieveResponse.createdAt
            name = mcpServerRetrieveResponse.name
            type = mcpServerRetrieveResponse.type
            url = mcpServerRetrieveResponse.url
            allowedTools = mcpServerRetrieveResponse.allowedTools.map { it.toMutableList() }
            apiKeyRef = mcpServerRetrieveResponse.apiKeyRef
            additionalProperties = mcpServerRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [McpServerRetrieveResponse].
         *
         ...
         */
        fun build(): McpServerRetrieveResponse =
    ...
    fun validate(): McpServerRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is McpServerRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "McpServerRetrieveResponse{id=$id, createdAt=$createdAt, name=$name, type=$type, url=$url, allowedTools=$allowedTools, apiKeyRef=$apiKeyRef, additionalProperties=$additionalProperties}"
}
