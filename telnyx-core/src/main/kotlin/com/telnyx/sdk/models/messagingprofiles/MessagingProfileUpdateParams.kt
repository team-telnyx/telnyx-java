...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun v1Secret(): Optional<String> = body.v1Secret()
     ...
     */
    fun _v1Secret(): JsonField<String> = body._v1Secret()
    ...
    companion object {
        ...
        @JvmStatic fun none(): MessagingProfileUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [MessagingProfileUpdateParams].
         */
    ...
    class Builder internal constructor() {
        ...
        /** Identifies the type of the resource. */
        fun recordType(recordType: RecordType) = apply { body.recordType(recordType) }
        ...
        /** Secret used to authenticate with v1 endpoints. */
        fun v1Secret(v1Secret: String) = apply { body.v1Secret(v1Secret) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun v1Secret(v1Secret: JsonField<String>) = apply { body.v1Secret(v1Secret) }
        ...
        /**
         * Returns an immutable instance of [MessagingProfileUpdateParams].
         *
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("v1_secret")
            @ExcludeMissing
            v1Secret: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.v1Secret] to an arbitrary JSON value.
             *
             * You should usually call [Builder.v1Secret] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
