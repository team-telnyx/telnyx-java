...
private constructor(
    ...
    fun globalIp(): GlobalIp = globalIp

    fun _additionalBodyProperties(): Map<String, JsonValue> = globalIp._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        fun globalIp(globalIp: GlobalIp) = apply { this.globalIp = globalIp }
        ...
        fun build(): GlobalIpCreateParams =
            GlobalIpCreateParams(
                checkRequired("globalIp", globalIp),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): GlobalIp = globalIp
    ...
    override fun hashCode(): Int = Objects.hash(globalIp, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "GlobalIpCreateParams{globalIp=$globalIp, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
