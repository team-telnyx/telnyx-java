...
class PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse
...
private constructor(
    ...
    /** A builder for [PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            records =
                phoneNumberAssignmentByProfileListPhoneNumberStatusResponse.records.map {
                    it.toMutableList()
                }
            additionalProperties =
                phoneNumberAssignmentByProfileListPhoneNumberStatusResponse.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse =
            PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse(
    ...
    fun validate(): PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse{records=$records, additionalProperties=$additionalProperties}"
}
