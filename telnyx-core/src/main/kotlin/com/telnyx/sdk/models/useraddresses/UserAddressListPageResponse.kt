...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserAddressListPageResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userAddressListPageResponse: UserAddressListPageResponse) = apply {
            data = userAddressListPageResponse.data.map { it.toMutableList() }
            meta = userAddressListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [UserAddressListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserAddressListPageResponse =
            UserAddressListPageResponse(
    ...
    fun validate(): UserAddressListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserAddressListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "UserAddressListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
