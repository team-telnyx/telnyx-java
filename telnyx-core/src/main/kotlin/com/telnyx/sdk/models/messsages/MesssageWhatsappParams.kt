...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MesssageWhatsappParams].
         *
    ...
    /** A builder for [MesssageWhatsappParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messsageWhatsappParams: MesssageWhatsappParams) = apply {
            body = messsageWhatsappParams.body.toBuilder()
            additionalHeaders = messsageWhatsappParams.additionalHeaders.toBuilder()
            additionalQueryParams = messsageWhatsappParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MesssageWhatsappParams].
         *
         ...
         */
        fun build(): MesssageWhatsappParams =
    ...
    private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         * Sets [Builder.action] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.action] with a well-typed [InnerAction]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun action(action: JsonField<InnerAction>) = apply { this.action = action }
                    ...
                    private constructor(
                        ...
                        override fun toString() =
                            "Body{text=$text, additionalProperties=$additionalProperties}"
                    }
        ...
        private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("empji") @ExcludeMissing empji: JsonField<String> = JsonMissing.of(),
             ...
             *
             * Unlike [empji], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.empji] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MesssageWhatsappParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MesssageWhatsappParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
