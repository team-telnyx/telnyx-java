...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * DTMF only.
         */
        fun interruptible(interruptible: Interruptible) = interruptible(JsonField.of(interruptible))
         ...
         * [WelcomeGreetingInterruptible] value instead. This method is primarily for setting the
    ...
    private constructor(private val value: JsonField<String>) : Enum {
         ...
         * [_UNKNOWN] member.
         *
         * An instance of [WelcomeGreetingInterruptible] can contain an unknown value in a couple of
         * cases:
         * - It was deserialized from data that doesn't match any known member. For example, if the
         *   SDK is on an older version than the API, then the API may respond with new members that
         *   the SDK is unaware of.
        ...
        enum class Value {
            ...
            DTMF,
            /**
             * An enum member indicating that [WelcomeGreetingInterruptible] was instantiated with
             * an unknown value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                DTMF -> Known.DTMF
                    ...
                    throw TelnyxInvalidDataException("Unknown WelcomeGreetingInterruptible: $value")
            }
