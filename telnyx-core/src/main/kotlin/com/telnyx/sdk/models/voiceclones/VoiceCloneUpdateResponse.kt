...
class VoiceCloneUpdateResponse
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VoiceCloneUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceCloneUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceCloneUpdateResponse: VoiceCloneUpdateResponse) = apply {
            data = voiceCloneUpdateResponse.data
            additionalProperties = voiceCloneUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceCloneUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceCloneUpdateResponse =
            VoiceCloneUpdateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): VoiceCloneUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Provider-specific voice identifier used for TTS synthesis. For Telnyx clones this
             * equals the clone ID; for Minimax it is the Minimax-assigned voice ID.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceCloneUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VoiceCloneUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
