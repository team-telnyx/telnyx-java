...
class InexplicitNumberOrderListResponse
...
private constructor(
    ...
    /** A builder for [InexplicitNumberOrderListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inexplicitNumberOrderListResponse: InexplicitNumberOrderListResponse) =
            apply {
                data = inexplicitNumberOrderListResponse.data.map { it.toMutableList() }
                meta = inexplicitNumberOrderListResponse.meta
                additionalProperties =
                    inexplicitNumberOrderListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InexplicitNumberOrderListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InexplicitNumberOrderListResponse =
            InexplicitNumberOrderListResponse(
    ...
    fun validate(): InexplicitNumberOrderListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InexplicitNumberOrderListResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "InexplicitNumberOrderListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
