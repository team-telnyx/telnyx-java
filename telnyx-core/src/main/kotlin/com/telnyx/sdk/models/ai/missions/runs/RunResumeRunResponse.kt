...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{missionId=$missionId, runId=$runId, startedAt=$startedAt, status=$status, updatedAt=$updatedAt, error=$error, finishedAt=$finishedAt, input=$input, metadata=$metadata, resultPayload=$resultPayload, resultSummary=$resultSummary, additionalProperties=$additionalProperties}"
    }
