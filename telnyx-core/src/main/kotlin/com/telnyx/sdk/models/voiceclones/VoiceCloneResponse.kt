...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VoiceCloneResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceCloneResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceCloneResponse: VoiceCloneResponse) = apply {
            data = voiceCloneResponse.data
            additionalProperties = voiceCloneResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceCloneResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceCloneResponse =
            VoiceCloneResponse(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): VoiceCloneResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceCloneResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "VoiceCloneResponse{data=$data, additionalProperties=$additionalProperties}"
}
