...
private constructor(
    ...
    private val records: JsonField<List<BrandListResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        records: JsonField<List<BrandListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun records(): Optional<List<BrandListResponse>> = records.getOptional("records")
    ...
    @JsonProperty("records")
    @ExcludeMissing
    fun _records(): JsonField<List<BrandListResponse>> = records
    ...
    class Builder internal constructor() {
        ...
        private var records: JsonField<MutableList<BrandListResponse>>? = null
        ...
        internal fun from(brandListPageResponse: BrandListPageResponse) = apply {
            page = brandListPageResponse.page
            records = brandListPageResponse.records.map { it.toMutableList() }
            totalRecords = brandListPageResponse.totalRecords
        ...
        fun records(records: List<BrandListResponse>) = records(JsonField.of(records))

        /**
         * Sets [Builder.records] to an arbitrary JSON value.
         *
         * You should usually call [Builder.records] with a well-typed `List<BrandListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun records(records: JsonField<List<BrandListResponse>>) = apply {
            this.records = records.map { it.toMutableList() }
        }

        /**
         * Adds a single [BrandListResponse] to [records].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRecord(record: BrandListResponse) = apply {
            records =
    ...
    override fun toString() =
        "BrandListPageResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
