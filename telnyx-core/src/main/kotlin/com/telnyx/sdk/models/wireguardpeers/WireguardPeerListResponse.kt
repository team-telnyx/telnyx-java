...
class WireguardPeerListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WireguardPeerListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WireguardPeerListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(wireguardPeerListResponse: WireguardPeerListResponse) = apply {
            id = wireguardPeerListResponse.id
            createdAt = wireguardPeerListResponse.createdAt
            recordType = wireguardPeerListResponse.recordType
            updatedAt = wireguardPeerListResponse.updatedAt
            publicKey = wireguardPeerListResponse.publicKey
            lastSeen = wireguardPeerListResponse.lastSeen
            privateKey = wireguardPeerListResponse.privateKey
            wireguardInterfaceId = wireguardPeerListResponse.wireguardInterfaceId
            additionalProperties = wireguardPeerListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WireguardPeerListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WireguardPeerListResponse =
    ...
    fun validate(): WireguardPeerListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WireguardPeerListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "WireguardPeerListResponse{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, publicKey=$publicKey, lastSeen=$lastSeen, privateKey=$privateKey, wireguardInterfaceId=$wireguardInterfaceId, additionalProperties=$additionalProperties}"
}
