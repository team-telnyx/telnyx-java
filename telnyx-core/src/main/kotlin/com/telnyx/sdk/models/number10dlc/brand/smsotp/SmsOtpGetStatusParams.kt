...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SmsOtpGetStatusParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SmsOtpGetStatusParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SmsOtpGetStatusParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(smsOtpGetStatusParams: SmsOtpGetStatusParams) = apply {
            referenceId = smsOtpGetStatusParams.referenceId
            brandId = smsOtpGetStatusParams.brandId
            additionalHeaders = smsOtpGetStatusParams.additionalHeaders.toBuilder()
            additionalQueryParams = smsOtpGetStatusParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SmsOtpGetStatusParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SmsOtpGetStatusParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SmsOtpGetStatusParams &&
    ...
    override fun toString() =
        "SmsOtpGetStatusParams{referenceId=$referenceId, brandId=$brandId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
