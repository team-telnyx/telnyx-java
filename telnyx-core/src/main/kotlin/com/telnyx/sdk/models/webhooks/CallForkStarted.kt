...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallForkStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallForkStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callForkStarted: CallForkStarted) = apply {
            id = callForkStarted.id
            eventType = callForkStarted.eventType
            occurredAt = callForkStarted.occurredAt
            payload = callForkStarted.payload
            recordType = callForkStarted.recordType
            additionalProperties = callForkStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallForkStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallForkStarted =
            CallForkStarted(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallForkStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_FORK_STARTED = of("call.fork.started")
        ...
        fun value(): Value =
            when (this) {
                CALL_FORK_STARTED -> Value.CALL_FORK_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_FORK_STARTED -> Known.CALL_FORK_STARTED
    ...
    private constructor(
        ...
        /** Type of media streamed. It can be either 'raw' or 'decrypted'. */
        class StreamType @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, streamType=$streamType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallForkStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallForkStarted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
