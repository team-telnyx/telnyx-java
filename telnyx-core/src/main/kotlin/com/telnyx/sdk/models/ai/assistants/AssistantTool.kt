...
private constructor(
    ...
    fun clientSide(): Optional<ClientSideTool> = Optional.ofNullable(clientSide)
     ...
     * message text is generated by the assistant unless a message_template is provided for runtime
    ...
    fun validate(): AssistantTool = apply {
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitClientSide(clientSide: ClientSideTool) {
                    clientSide.validate()
                }
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                ...
                override fun visitClientSide(clientSide: ClientSideTool) = clientSide.validity()
    ...
    companion object {
        ...
        @JvmStatic
        fun ofClientSide(clientSide: ClientSideTool) = AssistantTool(clientSide = clientSide)
         ...
         * and the message text is generated by the assistant unless a message_template is provided
    ...
    internal class Deserializer : BaseDeserializer<AssistantTool>(AssistantTool::class) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): AssistantTool {
            ...
            when (type) {
                ...
                "client_side_tool" -> {
                    return tryDeserialize(node, jacksonTypeRef<ClientSideTool>())?.let {
                        AssistantTool(clientSide = it, _json = json)
                    } ?: AssistantTool(_json = json)
                }
                "retrieval" -> {
    ...
    private constructor(
         ...
         */
        fun clientSideTool(): InnerClientSideTool = clientSideTool.getRequired("client_side_tool")

        /**
         * Expected to always return the following:
         * ```java
         * JsonValue.from("client_side_tool")
         * ```
         *
        ...
        class Builder internal constructor() {
            ...
            fun clientSideTool(clientSideTool: InnerClientSideTool) =
                clientSideTool(JsonField.of(clientSideTool))

            /**
             * Sets [Builder.clientSideTool] to an arbitrary JSON value.
             *
             * You should usually call [Builder.clientSideTool] with a well-typed
             * [InnerClientSideTool] value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun clientSideTool(clientSideTool: JsonField<InnerClientSideTool>) = apply {
        ...
        fun validate(): ClientSideTool = apply {
            ...
            clientSideTool().validate()
            _type().let {
                if (it != JsonValue.from("client_side_tool")) {
        ...
        private constructor(
            ...
            ) : this(description, name, parameters, mutableMapOf())
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [InnerClientSideTool].
                 *
                 * The following fields are required:
                 * ```java
                 * .description()
            ...
            /** A builder for [InnerClientSideTool]. */
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(innerClientSideTool: InnerClientSideTool) = apply {
                    description = innerClientSideTool.description
                    name = innerClientSideTool.name
                    parameters = innerClientSideTool.parameters
                    additionalProperties = innerClientSideTool.additionalProperties.toMutableMap()
                }
                ...
                /**
                 * Returns an immutable instance of [InnerClientSideTool].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
             ...
             *   expected type.
             */
            fun validate(): InnerClientSideTool = apply {
                if (validated) {
                    return@apply
                }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(parameters: Parameters) = apply {
                        ...
                        required = parameters.required.map { it.toMutableList() }
                ...
                override fun toString() =
                    "Parameters{properties=$properties, required=$required, type=$type, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is InnerClientSideTool &&
            ...
            private val hashCode: Int by lazy {
                Objects.hash(description, name, parameters, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "InnerClientSideTool{description=$description, name=$name, parameters=$parameters, additionalProperties=$additionalProperties}"
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.targets] with a well-typed [Targets] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                ...
                companion object {
                     ...
                     * the dynamic variables webhook and resolves to an array of target objects at
                     * runtime.
                     */
                ...
                interface Visitor<out T> {
                     ...
                     *
                     * An instance of [Targets] can contain an unknown variant if it was
    ...
    private constructor(
        ...
        private constructor(
             ...
             * one of the targets to invite to the call. This can also be a dynamic variable string
             * like `{{ targets }}` where `targets` is returned by the dynamic variables webhook and
             * resolves to an array of target objects at runtime. If omitted or null, the invite
             * tool can still be configured and targets may be supplied dynamically at runtime.
             *
             * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if
             *   the server responded with an unexpected value).
             */
            fun targets(): Optional<Targets> = targets.getOptional("targets")
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun targets(targets: Targets?) = targets(JsonField.ofNullable(targets))

                /** Alias for calling [Builder.targets] with `targets.orElse(null)`. */
                fun targets(targets: Optional<Targets>) = targets(targets.getOrNull())
    ...
    private constructor(
        ...
        private constructor(
            ...
            ) : this(messageTemplate, mutableMapOf())

            /**
             * Optional message template with dynamic variable support using mustache syntax (e.g.,
             * {{variable_name}}). When set, the assistant will use this template for the SMS body
             * instead of generating one. Dynamic variables like {{telnyx_end_user_target}},
             * {{telnyx_agent_target}}, and custom webhook-provided variables will be resolved at
             * runtime.
             *
             * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if
             *   the server responded with an unexpected value).
             */
            fun messageTemplate(): Optional<String> =
                messageTemplate.getOptional("message_template")

            /**
             * Returns the raw JSON value of [messageTemplate].
             *
             * Unlike [messageTemplate], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("message_template")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(sendMessageConfig: SendMessageConfig) = apply {
                    messageTemplate = sendMessageConfig.messageTemplate
                 ...
                 * (e.g., {{variable_name}}). When set, the assistant will use this template for the
                 * SMS body instead of generating one. Dynamic variables like
                ...
                fun messageTemplate(messageTemplate: String?) =
                    messageTemplate(JsonField.ofNullable(messageTemplate))

                /**
                 * Alias for calling [Builder.messageTemplate] with `messageTemplate.orElse(null)`.
                 */
                fun messageTemplate(messageTemplate: Optional<String>) =
                    messageTemplate(messageTemplate.getOrNull())

                /**
                 * Sets [Builder.messageTemplate] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.messageTemplate] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                fun build(): SendMessageConfig =
                    SendMessageConfig(messageTemplate, additionalProperties.toMutableMap())
            }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (messageTemplate.asKnown().isPresent) 1 else 0)
            ...
            private val hashCode: Int by lazy {
                Objects.hash(messageTemplate, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "SendMessageConfig{messageTemplate=$messageTemplate, additionalProperties=$additionalProperties}"
        }
