...
private constructor(
    private val data: JsonField<List<InvoiceListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InvoiceListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<InvoiceListResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<InvoiceListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<InvoiceListResponse>>? = null
        ...
        internal fun from(invoiceListPageResponse: InvoiceListPageResponse) = apply {
            ...
            meta = invoiceListPageResponse.meta
            additionalProperties = invoiceListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<InvoiceListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<InvoiceListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<InvoiceListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [InvoiceListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: InvoiceListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "InvoiceListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
