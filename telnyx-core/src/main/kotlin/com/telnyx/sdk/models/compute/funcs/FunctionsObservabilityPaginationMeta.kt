...
class FunctionsObservabilityPaginationMeta
...
private constructor(
    ...
    /** A builder for [FunctionsObservabilityPaginationMeta]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            pageNumber = functionsObservabilityPaginationMeta.pageNumber
            pageSize = functionsObservabilityPaginationMeta.pageSize
            totalPages = functionsObservabilityPaginationMeta.totalPages
            totalResults = functionsObservabilityPaginationMeta.totalResults
            additionalProperties =
                functionsObservabilityPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FunctionsObservabilityPaginationMeta].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FunctionsObservabilityPaginationMeta =
            FunctionsObservabilityPaginationMeta(
                pageNumber,
                pageSize,
                totalPages,
     ...
     *   expected type.
     */
    fun validate(): FunctionsObservabilityPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FunctionsObservabilityPaginationMeta &&
    ...
    override fun toString() =
        "FunctionsObservabilityPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
