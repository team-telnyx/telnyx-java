...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Webhook{description=$description, name=$name, url=$url, bodyParameters=$bodyParameters, headers=$headers, method=$method, pathParameters=$pathParameters, queryParameters=$queryParameters, additionalProperties=$additionalProperties}"
    }
