...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallHangup]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallHangup]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callHangup: CallHangup) = apply {
            id = callHangup.id
            eventType = callHangup.eventType
            occurredAt = callHangup.occurredAt
            payload = callHangup.payload
            recordType = callHangup.recordType
            additionalProperties = callHangup.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallHangup].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallHangup =
            CallHangup(
                id,
                eventType,
                occurredAt,
    ...
    private constructor(
        ...
        /**
         * Call quality statistics aggregated from the CHANNEL_HANGUP_COMPLETE event. Only includes
         * metrics that are available (filters out nil values). Returns nil if no metrics are
         * available.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
        ...
        /**
         * The reason the call was ended (SIP response code). If the SIP response is unavailable (in
         * inbound calls for example) this is set to `unspecified`.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
         ...
         *
         * Unlike [callQualityStats], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("call_quality_stats")
        @ExcludeMissing
         ...
         *
         * Unlike [hangupCause], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("hangup_cause")
        @ExcludeMissing
         ...
         *
         * Unlike [sipHangupCause], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("sip_hangup_cause")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [Builder.callQualityStats] with `callQualityStats.orElse(null)`.
             */
             ...
             * [CallQualityStats] value instead. This method is primarily for setting the field to
             ...
             *
             * You should usually call [Builder.hangupCause] with a well-typed [HangupCause] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** The party who ended the call (`callee`, `caller`, `unknown`). */
            fun hangupSource(hangupSource: HangupSource) = hangupSource(JsonField.of(hangupSource))

            /**
             * Sets [Builder.hangupSource] to an arbitrary JSON value.
             *
             * You should usually call [Builder.hangupSource] with a well-typed [HangupSource] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("mos") @ExcludeMissing mos: JsonField<String> = JsonMissing.of(),
                 ...
                 *
                 * Unlike [jitterMaxVariance], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("jitter_max_variance")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [jitterPacketCount], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("jitter_packet_count")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [mos], this method doesn't throw if the JSON field has an unexpected type.
                 */
                ...
                class Builder internal constructor() {
                    ...
                    /** Total number of inbound audio packets. */
                    fun packetCount(packetCount: String) = packetCount(JsonField.of(packetCount))
                     ...
                     *
                     * You should usually call [Builder.skipPacketCount] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     */
                    fun build(): Outbound =
                        Outbound(packetCount, skipPacketCount, additionalProperties.toMutableMap())
                }
         ...
         * `timeout`, `time_limit`, `user_busy`, `not_found`, `no_answer` or `unspecified`).
         */
        class HangupCause @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
        ...
        /** The party who ended the call (`callee`, `caller`, `unknown`). */
        class HangupSource @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            /**
             * An enum containing [HangupSource]'s known values, as well as an [_UNKNOWN] member.
             *
            ...
            enum class Value {
                ...
                UNKNOWN,
                /**
                 * An enum member indicating that [HangupSource] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
    ...
    override fun toString() =
        "CallHangup{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
