...
private constructor(
    private val data: JsonField<ReputationPhoneNumberWithReputationData>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<ReputationPhoneNumberWithReputationData> = JsonMissing.of()
     ...
     */
    fun data(): Optional<ReputationPhoneNumberWithReputationData> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<ReputationPhoneNumberWithReputationData> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<ReputationPhoneNumberWithReputationData> = JsonMissing.of()
        ...
        fun data(data: ReputationPhoneNumberWithReputationData) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * [ReputationPhoneNumberWithReputationData] value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<ReputationPhoneNumberWithReputationData>) = apply {
            this.data = data
        }
