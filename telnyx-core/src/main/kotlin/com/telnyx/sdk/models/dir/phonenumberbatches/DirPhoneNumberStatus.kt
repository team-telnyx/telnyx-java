 ...
 */
class DirPhoneNumberStatus @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = DirPhoneNumberStatus(JsonField.of(value))
    }

    /** An enum containing [DirPhoneNumberStatus]'s known values. */
    enum class Known {
        SUBMITTED,
        IN_REVIEW,
        VERIFIED,
    ...
    /**
     * An enum containing [DirPhoneNumberStatus]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [DirPhoneNumberStatus] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        PERMANENTLY_REJECTED,
        /**
         * An enum member indicating that [DirPhoneNumberStatus] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw TelnyxInvalidDataException("Unknown DirPhoneNumberStatus: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): DirPhoneNumberStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirPhoneNumberStatus && value == other.value
    }
