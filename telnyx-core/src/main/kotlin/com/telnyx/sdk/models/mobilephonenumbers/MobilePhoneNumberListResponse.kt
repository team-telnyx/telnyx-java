...
class MobilePhoneNumberListResponse
...
private constructor(
    ...
    /** A builder for [MobilePhoneNumberListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mobilePhoneNumberListResponse: MobilePhoneNumberListResponse) = apply {
            data = mobilePhoneNumberListResponse.data.map { it.toMutableList() }
            meta = mobilePhoneNumberListResponse.meta
            additionalProperties = mobilePhoneNumberListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MobilePhoneNumberListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobilePhoneNumberListResponse =
            MobilePhoneNumberListResponse(
    ...
    fun validate(): MobilePhoneNumberListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobilePhoneNumberListResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "MobilePhoneNumberListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
