...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(notificationChannelListParams: NotificationChannelListParams) = apply {
            ...
            pageNumber = notificationChannelListParams.pageNumber
            pageSize = notificationChannelListParams.pageSize
    ...
    override fun toString() =
        "NotificationChannelListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
