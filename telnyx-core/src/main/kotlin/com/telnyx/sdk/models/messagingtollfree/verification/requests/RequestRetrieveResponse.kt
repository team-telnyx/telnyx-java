...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RequestRetrieveResponse].
         *
    ...
    /** A builder for [RequestRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(requestRetrieveResponse: RequestRetrieveResponse) = apply {
            id = requestRetrieveResponse.id
            additionalInformation = requestRetrieveResponse.additionalInformation
            businessAddr1 = requestRetrieveResponse.businessAddr1
            businessCity = requestRetrieveResponse.businessCity
            businessContactEmail = requestRetrieveResponse.businessContactEmail
            businessContactFirstName = requestRetrieveResponse.businessContactFirstName
            businessContactLastName = requestRetrieveResponse.businessContactLastName
            businessContactPhone = requestRetrieveResponse.businessContactPhone
            businessName = requestRetrieveResponse.businessName
            businessState = requestRetrieveResponse.businessState
            businessZip = requestRetrieveResponse.businessZip
            corporateWebsite = requestRetrieveResponse.corporateWebsite
            messageVolume = requestRetrieveResponse.messageVolume
            optInWorkflow = requestRetrieveResponse.optInWorkflow
            optInWorkflowImageUrls =
                requestRetrieveResponse.optInWorkflowImageUrls.map { it.toMutableList() }
            phoneNumbers = requestRetrieveResponse.phoneNumbers.map { it.toMutableList() }
            productionMessageContent = requestRetrieveResponse.productionMessageContent
            useCase = requestRetrieveResponse.useCase
            useCaseSummary = requestRetrieveResponse.useCaseSummary
            verificationStatus = requestRetrieveResponse.verificationStatus
            ageGatedContent = requestRetrieveResponse.ageGatedContent
            businessAddr2 = requestRetrieveResponse.businessAddr2
            businessRegistrationCountry = requestRetrieveResponse.businessRegistrationCountry
            businessRegistrationNumber = requestRetrieveResponse.businessRegistrationNumber
            businessRegistrationType = requestRetrieveResponse.businessRegistrationType
            campaignVerifyAuthorizationToken =
                requestRetrieveResponse.campaignVerifyAuthorizationToken
            createdAt = requestRetrieveResponse.createdAt
            doingBusinessAs = requestRetrieveResponse.doingBusinessAs
            entityType = requestRetrieveResponse.entityType
            helpMessageResponse = requestRetrieveResponse.helpMessageResponse
            isvReseller = requestRetrieveResponse.isvReseller
            optInConfirmationResponse = requestRetrieveResponse.optInConfirmationResponse
            optInKeywords = requestRetrieveResponse.optInKeywords
            privacyPolicyUrl = requestRetrieveResponse.privacyPolicyUrl
            reason = requestRetrieveResponse.reason
            termsAndConditionUrl = requestRetrieveResponse.termsAndConditionUrl
            updatedAt = requestRetrieveResponse.updatedAt
            webhookUrl = requestRetrieveResponse.webhookUrl
            additionalProperties = requestRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RequestRetrieveResponse].
         *
         ...
         */
        fun build(): RequestRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): RequestRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RequestRetrieveResponse &&
            id == other.id &&
