...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DirComment]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DirComment]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirComment: DirComment) = apply {
            id = dirComment.id
            authorName = dirComment.authorName
            authorRole = dirComment.authorRole
            commentType = dirComment.commentType
            content = dirComment.content
            createdAt = dirComment.createdAt
            entityType = dirComment.entityType
            visibility = dirComment.visibility
            additionalProperties = dirComment.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirComment].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DirComment =
            DirComment(
                id,
                authorName,
                authorRole,
    ...
    override fun toString() =
        "DirComment{id=$id, authorName=$authorName, authorRole=$authorRole, commentType=$commentType, content=$content, createdAt=$createdAt, entityType=$entityType, visibility=$visibility, additionalProperties=$additionalProperties}"
}
