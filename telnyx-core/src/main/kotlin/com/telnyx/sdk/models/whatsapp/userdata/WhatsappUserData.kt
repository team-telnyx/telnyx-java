...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WhatsappUserData]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WhatsappUserData]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(whatsappUserData: WhatsappUserData) = apply {
            createdAt = whatsappUserData.createdAt
            recordType = whatsappUserData.recordType
            updatedAt = whatsappUserData.updatedAt
            webhookFailoverUrl = whatsappUserData.webhookFailoverUrl
            webhookUrl = whatsappUserData.webhookUrl
            additionalProperties = whatsappUserData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WhatsappUserData].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WhatsappUserData =
            WhatsappUserData(
                createdAt,
                recordType,
                updatedAt,
     ...
     *   expected type.
     */
    fun validate(): WhatsappUserData = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappUserData &&
    ...
    override fun toString() =
        "WhatsappUserData{createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
}
