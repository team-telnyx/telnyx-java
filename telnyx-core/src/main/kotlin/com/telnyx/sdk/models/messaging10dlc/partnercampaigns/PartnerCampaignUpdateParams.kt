...
class PartnerCampaignUpdateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PartnerCampaignUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PartnerCampaignUpdateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PartnerCampaignUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(partnerCampaignUpdateParams: PartnerCampaignUpdateParams) = apply {
            campaignId = partnerCampaignUpdateParams.campaignId
            body = partnerCampaignUpdateParams.body.toBuilder()
            additionalHeaders = partnerCampaignUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = partnerCampaignUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignUpdateParams =
    ...
    private constructor(
        ...
        ) : this(webhookFailoverUrl, webhookUrl, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(webhookFailoverUrl, webhookUrl, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(webhookFailoverUrl, webhookUrl, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignUpdateParams &&
    ...
    override fun toString() =
        "PartnerCampaignUpdateParams{campaignId=$campaignId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
