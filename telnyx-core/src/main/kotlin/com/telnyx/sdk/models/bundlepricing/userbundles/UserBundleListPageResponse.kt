...
class UserBundleListPageResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserBundleListPageResponse].
         *
    ...
    /** A builder for [UserBundleListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userBundleListPageResponse: UserBundleListPageResponse) = apply {
            data = userBundleListPageResponse.data.map { it.toMutableList() }
            meta = userBundleListPageResponse.meta
            additionalProperties = userBundleListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserBundleListPageResponse].
         *
         ...
         */
        fun build(): UserBundleListPageResponse =
            UserBundleListPageResponse(
    ...
    fun validate(): UserBundleListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserBundleListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "UserBundleListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
