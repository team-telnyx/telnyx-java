...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): FaxSendingStartedWebhookEvent =
            FaxSendingStartedWebhookEvent(data, meta, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "FaxSendingStartedWebhookEvent{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
