...
private constructor(
    private val data: JsonField<List<Comment>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Comment>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<Comment>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Comment>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Comment>>? = null
        ...
        fun data(data: List<Comment>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Comment>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Comment>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Comment] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Comment) = apply {
            this.data =
