...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun data(inbound: Data.Inbound) = data(Data.ofInbound(inbound))
    ...
    private constructor(
        ...
        fun inbound(): Optional<Inbound> = Optional.ofNullable(inbound)
        ...
        fun asInbound(): Inbound = inbound.getOrThrow("inbound")
        ...
        fun validate(): Data = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitInbound(inbound: Inbound) {
                        inbound.validate()
                    }
                }
            )
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitInbound(inbound: Inbound) = inbound.validity()
        ...
        companion object {
            ...
            @JvmStatic fun ofInbound(inbound: Inbound) = Data(inbound = inbound)
        }
        ...
        interface Visitor<out T> {
            ...
            fun visitInbound(inbound: Inbound): T
        ...
        internal class Deserializer : BaseDeserializer<Data>(Data::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Data {
                ...
                when (direction) {
                    ...
                    "inbound" -> {
                        return tryDeserialize(node, jacksonTypeRef<Inbound>())?.let {
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                numChars: JsonField<Long> = JsonMissing.of(),
             ...
             *
             * Unlike [numChars], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            ...
            class Builder internal constructor() {
                ...
                internal fun from(inbound: Inbound) = apply {
                    id = inbound.id
                    cc = inbound.cc.map { it.toMutableList() }
                    completedAt = inbound.completedAt
                    cost = inbound.cost
                    costBreakdown = inbound.costBreakdown
                    direction = inbound.direction
                    encoding = inbound.encoding
                    errors = inbound.errors.map { it.toMutableList() }
                    from = inbound.from
                    media = inbound.media.map { it.toMutableList() }
                    messagingProfileId = inbound.messagingProfileId
                    numChars = inbound.numChars
                    ...
                    tags = inbound.tags.map { it.toMutableList() }
                    tcrCampaignBillable = inbound.tcrCampaignBillable
                    tcrCampaignId = inbound.tcrCampaignId
                    tcrCampaignRegistered = inbound.tcrCampaignRegistered
                    text = inbound.text
                    to = inbound.to.map { it.toMutableList() }
                    type = inbound.type
                    validUntil = inbound.validUntil
                    webhookFailoverUrl = inbound.webhookFailoverUrl
                    webhookUrl = inbound.webhookUrl
                 ...
                 *
                 * You should usually call [Builder.numChars] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
