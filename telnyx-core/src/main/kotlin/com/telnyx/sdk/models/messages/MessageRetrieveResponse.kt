...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [data] with `Data.ofOutboundMessagePayload(outboundMessagePayload)`.
         */
        fun data(outboundMessagePayload: OutboundMessagePayload) =
            data(Data.ofOutboundMessagePayload(outboundMessagePayload))

        /** Alias for calling [data] with `Data.ofInboundMessagePayload(inboundMessagePayload)`. */
        fun data(inboundMessagePayload: Data.InboundMessagePayload) =
            data(Data.ofInboundMessagePayload(inboundMessagePayload))
    ...
    class Data
    private constructor(
        private val outboundMessagePayload: OutboundMessagePayload? = null,
        private val inboundMessagePayload: InboundMessagePayload? = null,
        private val _json: JsonValue? = null,
    ) {

        fun outboundMessagePayload(): Optional<OutboundMessagePayload> =
            Optional.ofNullable(outboundMessagePayload)

        fun inboundMessagePayload(): Optional<InboundMessagePayload> =
            Optional.ofNullable(inboundMessagePayload)

        fun isOutboundMessagePayload(): Boolean = outboundMessagePayload != null

        fun isInboundMessagePayload(): Boolean = inboundMessagePayload != null

        fun asOutboundMessagePayload(): OutboundMessagePayload =
            outboundMessagePayload.getOrThrow("outboundMessagePayload")

        fun asInboundMessagePayload(): InboundMessagePayload =
            inboundMessagePayload.getOrThrow("inboundMessagePayload")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                outboundMessagePayload != null ->
                    visitor.visitOutboundMessagePayload(outboundMessagePayload)
                inboundMessagePayload != null ->
                    visitor.visitInboundMessagePayload(inboundMessagePayload)
        ...
        fun validate(): Data = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitOutboundMessagePayload(
                        outboundMessagePayload: OutboundMessagePayload
                    ) {
                        outboundMessagePayload.validate()
                    }

                    override fun visitInboundMessagePayload(
                        inboundMessagePayload: InboundMessagePayload
                    ) {
                        inboundMessagePayload.validate()
                    }
                }
            )
            validated = true
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitOutboundMessagePayload(
                        outboundMessagePayload: OutboundMessagePayload
                    ) = outboundMessagePayload.validity()

                    override fun visitInboundMessagePayload(
                        inboundMessagePayload: InboundMessagePayload
                    ) = inboundMessagePayload.validity()
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Data &&
                outboundMessagePayload == other.outboundMessagePayload &&
                inboundMessagePayload == other.inboundMessagePayload
        }

        override fun hashCode(): Int = Objects.hash(outboundMessagePayload, inboundMessagePayload)
        ...
        override fun toString(): String =
            when {
                ...
                inboundMessagePayload != null ->
                    "Data{inboundMessagePayload=$inboundMessagePayload}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofOutboundMessagePayload(outboundMessagePayload: OutboundMessagePayload) =
                Data(outboundMessagePayload = outboundMessagePayload)

            @JvmStatic
            fun ofInboundMessagePayload(inboundMessagePayload: InboundMessagePayload) =
                Data(inboundMessagePayload = inboundMessagePayload)
        }
        ...
        interface Visitor<out T> {
            ...
            fun visitOutboundMessagePayload(outboundMessagePayload: OutboundMessagePayload): T

            fun visitInboundMessagePayload(inboundMessagePayload: InboundMessagePayload): T
        ...
        internal class Deserializer : BaseDeserializer<Data>(Data::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Data {
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<OutboundMessagePayload>())?.let {
                                Data(outboundMessagePayload = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<InboundMessagePayload>())?.let {
                                Data(inboundMessagePayload = it, _json = json)
                            },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Data>(Data::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.outboundMessagePayload != null ->
                        generator.writeObject(value.outboundMessagePayload)
                    value.inboundMessagePayload != null ->
                        generator.writeObject(value.inboundMessagePayload)
        ...
        private constructor(
            ...
            fun costBreakdown(): Optional<CostBreakdown> =
                costBreakdown.getOptional("cost_breakdown")
            ...
            @JsonProperty("errors")
            @ExcludeMissing
            fun _errors(): JsonField<List<MessagingError>> = errors
             ...
             *
             * Unlike [tcrCampaignBillable], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("tcr_campaign_billable")
            @ExcludeMissing
             ...
             *
             * Unlike [tcrCampaignRegistered], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("tcr_campaign_registered")
            @ExcludeMissing
            ...
            /** A builder for [InboundMessagePayload]. */
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(inboundMessagePayload: InboundMessagePayload) = apply {
                    id = inboundMessagePayload.id
                    cc = inboundMessagePayload.cc.map { it.toMutableList() }
                    completedAt = inboundMessagePayload.completedAt
                    cost = inboundMessagePayload.cost
                    costBreakdown = inboundMessagePayload.costBreakdown
                    direction = inboundMessagePayload.direction
                    encoding = inboundMessagePayload.encoding
                    errors = inboundMessagePayload.errors.map { it.toMutableList() }
                    ...
                    tcrCampaignRegistered = inboundMessagePayload.tcrCampaignRegistered
                    text = inboundMessagePayload.text
                    to = inboundMessagePayload.to.map { it.toMutableList() }
                    type = inboundMessagePayload.type
                    validUntil = inboundMessagePayload.validUntil
                    webhookFailoverUrl = inboundMessagePayload.webhookFailoverUrl
                    webhookUrl = inboundMessagePayload.webhookUrl
                    additionalProperties = inboundMessagePayload.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.cc] with a well-typed `List<Cc>` value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                fun addCc(cc: Cc) = apply {
                    this.cc =
                        (this.cc ?: JsonField.of(mutableListOf())).also {
                            checkKnown("cc", it).add(cc)
                        }
                }
                 ...
                 *
                 * You should usually call [Builder.errors] with a well-typed `List<MessagingError>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.tcrCampaignBillable] with a well-typed [Boolean]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.tcrCampaignRegistered] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.to] with a well-typed `List<To>` value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                ...
                fun addTo(to: To) = apply {
                    this.to =
                        (this.to ?: JsonField.of(mutableListOf())).also {
                            checkKnown("to", it).add(to)
                        }
                }
                ...
                fun validUntil(validUntil: OffsetDateTime?) =
                    validUntil(JsonField.ofNullable(validUntil))

                /** Alias for calling [Builder.validUntil] with `validUntil.orElse(null)`. */
                fun validUntil(validUntil: Optional<OffsetDateTime>) =
                    validUntil(validUntil.getOrNull())
                ...
                /**
                 * Returns an immutable instance of [InboundMessagePayload].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): InboundMessagePayload =
                    InboundMessagePayload(
                        id,
            ...
            fun validate(): InboundMessagePayload = apply {
                if (validated) {
                    return@apply
                }
            ...
            private constructor(
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    /**
                     * An enum containing [LineType]'s known values, as well as an [_UNKNOWN]
                     * member.
                     *
                    ...
                    enum class Value {
                        ...
                        EMPTY,
                        /**
                         * An enum member indicating that [LineType] was instantiated with an
                         * unknown value.
                         */
                        _UNKNOWN,
                    }
            ...
            private constructor(
                 ...
                 *
                 * Unlike [carrierFee], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("carrier_fee")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.carrierFee] with a well-typed [CarrierFee]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.rate] with a well-typed [Rate] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         */
                        fun build(): Rate =
                            Rate(amount, currency, additionalProperties.toMutableMap())
                    }
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(carrierFee, rate, additionalProperties)
                }
            ...
            private constructor(
                 ...
                 *
                 * Unlike [hashSha256], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("hash_sha256")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     * not yet supported value.
                     */
                    fun hashSha256(hashSha256: JsonField<String>) = apply {
                     ...
                     *
                     * You should usually call [Builder.size] with a well-typed [Long] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is InboundMessagePayload &&
                    id == other.id &&
                    cc == other.cc &&
