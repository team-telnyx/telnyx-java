...
@JsonDeserialize(using = Number10dlcRetrieveResponse.Deserializer::class)
@JsonSerialize(using = Number10dlcRetrieveResponse.Serializer::class)
class Number10dlcRetrieveResponse
private constructor(
    ...
    fun validate(): Number10dlcRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Number10dlcRetrieveResponse &&
    ...
    override fun toString(): String =
        when {
            enumStringList != null -> "Number10dlcRetrieveResponse{enumStringList=$enumStringList}"
            enumObjectList != null -> "Number10dlcRetrieveResponse{enumObjectList=$enumObjectList}"
            enumObjectToString != null ->
                "Number10dlcRetrieveResponse{enumObjectToString=$enumObjectToString}"
            enumObjecToObjectt != null ->
                "Number10dlcRetrieveResponse{enumObjecToObjectt=$enumObjecToObjectt}"
            enumPaginated != null -> "Number10dlcRetrieveResponse{enumPaginated=$enumPaginated}"
            _json != null -> "Number10dlcRetrieveResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid Number10dlcRetrieveResponse")
        }
    ...
    companion object {
        ...
        fun ofEnumStringList(enumStringList: List<String>) =
            Number10dlcRetrieveResponse(enumStringList = enumStringList.toImmutable())

        @JvmStatic
        fun ofEnumObjectList(enumObjectList: List<UnnamedSchemaWithArrayParent0>) =
            Number10dlcRetrieveResponse(enumObjectList = enumObjectList.toImmutable())
        ...
        fun ofEnumPaginated(enumPaginated: EnumPaginatedResponse) =
            Number10dlcRetrieveResponse(enumPaginated = enumPaginated)
    }

    /**
     * An interface that defines how to map each variant of [Number10dlcRetrieveResponse] to a value
     * of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [Number10dlcRetrieveResponse] to a value of type [T].
         *
         * An instance of [Number10dlcRetrieveResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw TelnyxInvalidDataException("Unknown Number10dlcRetrieveResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<Number10dlcRetrieveResponse>(Number10dlcRetrieveResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): Number10dlcRetrieveResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<EnumObjectToStringResponse>())?.let {
                            Number10dlcRetrieveResponse(enumObjectToString = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<EnumObjecToObjecttResponse>())?.let {
                            Number10dlcRetrieveResponse(enumObjecToObjectt = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<EnumPaginatedResponse>())?.let {
                            Number10dlcRetrieveResponse(enumPaginated = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<String>>())?.let {
                            Number10dlcRetrieveResponse(enumStringList = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent0>>())
                            ?.let { Number10dlcRetrieveResponse(enumObjectList = it, _json = json) },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> Number10dlcRetrieveResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<Number10dlcRetrieveResponse>(Number10dlcRetrieveResponse::class) {

        override fun serialize(
            value: Number10dlcRetrieveResponse,
