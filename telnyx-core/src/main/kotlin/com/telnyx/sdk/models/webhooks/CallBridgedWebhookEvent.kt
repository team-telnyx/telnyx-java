    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_BRIDGED = of("call.bridged")
            ...
            fun value(): Value =
                when (this) {
                    CALL_BRIDGED -> Value.CALL_BRIDGED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_BRIDGED -> Known.CALL_BRIDGED
        ...
        private constructor(
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, from=$from, to=$to, additionalProperties=$additionalProperties}"
        }
