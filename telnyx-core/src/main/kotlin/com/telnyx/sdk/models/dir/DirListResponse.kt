...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DirListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DirListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirListResponse: DirListResponse) = apply {
            id = dirListResponse.id
            authorizerEmail = dirListResponse.authorizerEmail
            authorizerName = dirListResponse.authorizerName
            callReasons = dirListResponse.callReasons.map { it.toMutableList() }
            certifyBrandIsAccurate = dirListResponse.certifyBrandIsAccurate
            certifyIpOwnership = dirListResponse.certifyIpOwnership
            certifyNoShaftContent = dirListResponse.certifyNoShaftContent
            createdAt = dirListResponse.createdAt
            displayName = dirListResponse.displayName
            documents = dirListResponse.documents.map { it.toMutableList() }
            enterpriseId = dirListResponse.enterpriseId
            expiringAt = dirListResponse.expiringAt
            logoUrl = dirListResponse.logoUrl
            rejectedAt = dirListResponse.rejectedAt
            rejectionReasons = dirListResponse.rejectionReasons.map { it.toMutableList() }
            reselling = dirListResponse.reselling
            status = dirListResponse.status
            submittedAt = dirListResponse.submittedAt
            updatedAt = dirListResponse.updatedAt
            verifiedAt = dirListResponse.verifiedAt
            additionalProperties = dirListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DirListResponse =
            DirListResponse(
                id,
                authorizerEmail,
                authorizerName,
     ...
     *   expected type.
     */
    fun validate(): DirListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirListResponse &&
            id == other.id &&
