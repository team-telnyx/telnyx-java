...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(networkCoverageListResponse: NetworkCoverageListResponse) = apply {
            data = networkCoverageListResponse.data.map { it.toMutableList() }
            meta = networkCoverageListResponse.meta
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                availableServices = data.availableServices.map { it.toMutableList() }
             ...
             * `List<AvailableService>` value instead. This method is primarily for setting the
        ...
        override fun toString() =
            "Data{availableServices=$availableServices, location=$location, recordType=$recordType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "NetworkCoverageListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
