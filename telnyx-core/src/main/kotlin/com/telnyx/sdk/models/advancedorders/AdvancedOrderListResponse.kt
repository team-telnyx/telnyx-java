...
class AdvancedOrderListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AdvancedOrderListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AdvancedOrderListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(advancedOrderListResponse: AdvancedOrderListResponse) = apply {
            data = advancedOrderListResponse.data.map { it.toMutableList() }
            additionalProperties = advancedOrderListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AdvancedOrderListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AdvancedOrderListResponse =
    ...
    fun validate(): AdvancedOrderListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("orders")
            @ExcludeMissing
            orders: JsonField<List<String>> = JsonMissing.of(),
            ...
            @JsonProperty("status")
            @ExcludeMissing
            status: JsonField<List<Status>> = JsonMissing.of(),
        ) : this(
            id,
            areaCode,
            comments,
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                status = data.status.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.orders] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * `List<PhoneNumberType>` value instead. This method is primarily for setting the field
             ...
             *
             * You should usually call [Builder.status] with a well-typed `List<Status>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Data{id=$id, areaCode=$areaCode, comments=$comments, countryCode=$countryCode, customerReference=$customerReference, features=$features, orders=$orders, phoneNumberType=$phoneNumberType, quantity=$quantity, requirementGroupId=$requirementGroupId, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdvancedOrderListResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AdvancedOrderListResponse{data=$data, additionalProperties=$additionalProperties}"
}
