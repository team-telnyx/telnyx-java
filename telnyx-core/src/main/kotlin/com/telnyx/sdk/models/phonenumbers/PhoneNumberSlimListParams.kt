 ...
 */
class PhoneNumberSlimListParams
private constructor(
    private val filter: Filter?,
    private val includeConnection: Boolean?,
    ...
    fun includeConnection(): Optional<Boolean> = Optional.ofNullable(includeConnection)

    /** Include the tags associated with the phone number. */
    fun includeTags(): Optional<Boolean> = Optional.ofNullable(includeTags)
    ...
    companion object {
        ...
        @JvmStatic fun none(): PhoneNumberSlimListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberSlimListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PhoneNumberSlimListParams]. */
    class Builder internal constructor() {

        private var filter: Filter? = null
        private var includeConnection: Boolean? = null
        private var includeTags: Boolean? = null
        ...
        @JvmSynthetic
        internal fun from(phoneNumberSlimListParams: PhoneNumberSlimListParams) = apply {
            filter = phoneNumberSlimListParams.filter
            includeConnection = phoneNumberSlimListParams.includeConnection
            includeTags = phoneNumberSlimListParams.includeTags
            pageNumber = phoneNumberSlimListParams.pageNumber
            pageSize = phoneNumberSlimListParams.pageSize
            sort = phoneNumberSlimListParams.sort
            additionalHeaders = phoneNumberSlimListParams.additionalHeaders.toBuilder()
            additionalQueryParams = phoneNumberSlimListParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Include the connection associated with the phone number. */
        fun includeConnection(includeConnection: Boolean?) = apply {
            this.includeConnection = includeConnection
        }

        /**
         * Alias for [Builder.includeConnection].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun includeConnection(includeConnection: Boolean) =
            includeConnection(includeConnection as Boolean?)

        /** Alias for calling [Builder.includeConnection] with `includeConnection.orElse(null)`. */
        fun includeConnection(includeConnection: Optional<Boolean>) =
            includeConnection(includeConnection.getOrNull())

        /** Include the tags associated with the phone number. */
        fun includeTags(includeTags: Boolean?) = apply { this.includeTags = includeTags }

        /**
         * Alias for [Builder.includeTags].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun includeTags(includeTags: Boolean) = includeTags(includeTags as Boolean?)

        /** Alias for calling [Builder.includeTags] with `includeTags.orElse(null)`. */
        fun includeTags(includeTags: Optional<Boolean>) = includeTags(includeTags.getOrNull())
        ...
        /**
         * Returns an immutable instance of [PhoneNumberSlimListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoneNumberSlimListParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                includeConnection?.let { put("include_connection", it.toString()) }
                includeTags?.let { put("include_tags", it.toString()) }
    ...
    private constructor(
        ...
        class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val PORT_PENDING = of("port_pending")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberSlimListParams &&
            filter == other.filter &&
            includeConnection == other.includeConnection &&
    ...
    override fun toString() =
        "PhoneNumberSlimListParams{filter=$filter, includeConnection=$includeConnection, includeTags=$includeTags, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
