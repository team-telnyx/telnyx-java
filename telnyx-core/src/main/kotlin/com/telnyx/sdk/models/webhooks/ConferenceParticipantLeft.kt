...
class ConferenceParticipantLeft
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConferenceParticipantLeft].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceParticipantLeft]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceParticipantLeft: ConferenceParticipantLeft) = apply {
            id = conferenceParticipantLeft.id
            eventType = conferenceParticipantLeft.eventType
            occurredAt = conferenceParticipantLeft.occurredAt
            payload = conferenceParticipantLeft.payload
            recordType = conferenceParticipantLeft.recordType
            additionalProperties = conferenceParticipantLeft.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceParticipantLeft].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceParticipantLeft =
    ...
    fun validate(): ConferenceParticipantLeft = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_PARTICIPANT_LEFT = of("conference.participant.left")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PARTICIPANT_LEFT -> Value.CONFERENCE_PARTICIPANT_LEFT
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PARTICIPANT_LEFT -> Known.CONFERENCE_PARTICIPANT_LEFT
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceParticipantLeft &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceParticipantLeft{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
