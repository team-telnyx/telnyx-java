...
class ConferencePlaybackStarted
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConferencePlaybackStarted].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferencePlaybackStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferencePlaybackStarted: ConferencePlaybackStarted) = apply {
            id = conferencePlaybackStarted.id
            eventType = conferencePlaybackStarted.eventType
            payload = conferencePlaybackStarted.payload
            recordType = conferencePlaybackStarted.recordType
            additionalProperties = conferencePlaybackStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferencePlaybackStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferencePlaybackStarted =
    ...
    fun validate(): ConferencePlaybackStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_PLAYBACK_STARTED = of("conference.playback.started")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PLAYBACK_STARTED -> Value.CONFERENCE_PLAYBACK_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PLAYBACK_STARTED -> Known.CONFERENCE_PLAYBACK_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferencePlaybackStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferencePlaybackStarted{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
