...
class MobilePhoneNumberWithMessagingSettings
...
private constructor(
    ...
    /** A builder for [MobilePhoneNumberWithMessagingSettings]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = mobilePhoneNumberWithMessagingSettings.id
            countryCode = mobilePhoneNumberWithMessagingSettings.countryCode
            createdAt = mobilePhoneNumberWithMessagingSettings.createdAt
            features = mobilePhoneNumberWithMessagingSettings.features
            messagingProduct = mobilePhoneNumberWithMessagingSettings.messagingProduct
            messagingProfileId = mobilePhoneNumberWithMessagingSettings.messagingProfileId
            organizationId = mobilePhoneNumberWithMessagingSettings.organizationId
            phoneNumber = mobilePhoneNumberWithMessagingSettings.phoneNumber
            recordType = mobilePhoneNumberWithMessagingSettings.recordType
            tags = mobilePhoneNumberWithMessagingSettings.tags.map { it.toMutableList() }
            trafficType = mobilePhoneNumberWithMessagingSettings.trafficType
            type = mobilePhoneNumberWithMessagingSettings.type
            updatedAt = mobilePhoneNumberWithMessagingSettings.updatedAt
            additionalProperties =
                mobilePhoneNumberWithMessagingSettings.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MobilePhoneNumberWithMessagingSettings].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobilePhoneNumberWithMessagingSettings =
            MobilePhoneNumberWithMessagingSettings(
                id,
                countryCode,
                createdAt,
     ...
     *   expected type.
     */
    fun validate(): MobilePhoneNumberWithMessagingSettings = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * Used for best match union deserialization.
         */
        @JvmSynthetic internal fun validity(): Int = (sms.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun toString() = "Features{sms=$sms, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobilePhoneNumberWithMessagingSettings &&
            id == other.id &&
