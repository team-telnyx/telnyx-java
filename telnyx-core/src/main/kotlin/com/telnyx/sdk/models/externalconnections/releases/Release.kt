...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [Release]. */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(release: Release) = apply {
            createdAt = release.createdAt
            errorMessage = release.errorMessage
            status = release.status
            telephoneNumbers = release.telephoneNumbers.map { it.toMutableList() }
            tenantId = release.tenantId
            ticketId = release.ticketId
            additionalProperties = release.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Release].
         *
    ...
    override fun toString() =
        "Release{createdAt=$createdAt, errorMessage=$errorMessage, status=$status, telephoneNumbers=$telephoneNumbers, tenantId=$tenantId, ticketId=$ticketId, additionalProperties=$additionalProperties}"
}
