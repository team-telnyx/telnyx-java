...
private constructor(
    ...
    private constructor(
        ...
        ) : this(name, networkId, regionCode, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, networkId, regionCode, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, networkId=$networkId, regionCode=$regionCode, additionalProperties=$additionalProperties}"
    }
