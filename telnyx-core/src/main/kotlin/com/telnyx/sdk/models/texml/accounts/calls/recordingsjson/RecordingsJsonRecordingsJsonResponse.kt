...
class RecordingsJsonRecordingsJsonResponse
...
private constructor(
    ...
    /** A builder for [RecordingsJsonRecordingsJsonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            recordingsJsonRecordingsJsonResponse: RecordingsJsonRecordingsJsonResponse
        ) = apply {
            accountSid = recordingsJsonRecordingsJsonResponse.accountSid
            callSid = recordingsJsonRecordingsJsonResponse.callSid
            channels = recordingsJsonRecordingsJsonResponse.channels
            conferenceSid = recordingsJsonRecordingsJsonResponse.conferenceSid
            dateCreated = recordingsJsonRecordingsJsonResponse.dateCreated
            dateUpdated = recordingsJsonRecordingsJsonResponse.dateUpdated
            duration = recordingsJsonRecordingsJsonResponse.duration
            errorCode = recordingsJsonRecordingsJsonResponse.errorCode
            price = recordingsJsonRecordingsJsonResponse.price
            priceUnit = recordingsJsonRecordingsJsonResponse.priceUnit
            sid = recordingsJsonRecordingsJsonResponse.sid
            source = recordingsJsonRecordingsJsonResponse.source
            startTime = recordingsJsonRecordingsJsonResponse.startTime
            track = recordingsJsonRecordingsJsonResponse.track
            uri = recordingsJsonRecordingsJsonResponse.uri
            additionalProperties =
                recordingsJsonRecordingsJsonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RecordingsJsonRecordingsJsonResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RecordingsJsonRecordingsJsonResponse =
            RecordingsJsonRecordingsJsonResponse(
                accountSid,
                callSid,
                channels,
    ...
    fun validate(): RecordingsJsonRecordingsJsonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecordingsJsonRecordingsJsonResponse &&
