...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InboundSipHeader].
         *
    ...
    /** A builder for [InboundSipHeader]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inboundSipHeader: InboundSipHeader) = apply {
            name = inboundSipHeader.name
            value = inboundSipHeader.value
            additionalProperties = inboundSipHeader.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InboundSipHeader].
         *
     ...
     *   expected type.
     */
    fun validate(): InboundSipHeader = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (name.asKnown().getOrNull()?.validity() ?: 0) + (if (value.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboundSipHeader &&
            name == other.name &&
            value == other.value &&
    ...
    override fun toString() =
        "InboundSipHeader{name=$name, value=$value, additionalProperties=$additionalProperties}"
}
