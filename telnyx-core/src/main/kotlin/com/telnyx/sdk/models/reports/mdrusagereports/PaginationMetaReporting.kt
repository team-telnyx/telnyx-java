...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaginationMetaReporting].
         *
    ...
    /** A builder for [PaginationMetaReporting]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paginationMetaReporting: PaginationMetaReporting) = apply {
            pageNumber = paginationMetaReporting.pageNumber
            totalPages = paginationMetaReporting.totalPages
            pageSize = paginationMetaReporting.pageSize
            totalResults = paginationMetaReporting.totalResults
            additionalProperties = paginationMetaReporting.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaginationMetaReporting].
         *
         ...
         */
        fun build(): PaginationMetaReporting =
    ...
    fun validate(): PaginationMetaReporting = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaginationMetaReporting &&
    ...
    override fun toString() =
        "PaginationMetaReporting{pageNumber=$pageNumber, totalPages=$totalPages, pageSize=$pageSize, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
