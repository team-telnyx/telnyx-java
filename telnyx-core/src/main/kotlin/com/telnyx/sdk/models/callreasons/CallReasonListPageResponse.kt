...
class CallReasonListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<CallReasonListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CallReasonListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CallReasonListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CallReasonListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallReasonListPageResponse].
         *
    ...
    /** A builder for [CallReasonListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CallReasonListResponse>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(callReasonListPageResponse: CallReasonListPageResponse) = apply {
            data = callReasonListPageResponse.data.map { it.toMutableList() }
            meta = callReasonListPageResponse.meta
            additionalProperties = callReasonListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CallReasonListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CallReasonListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<CallReasonListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CallReasonListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CallReasonListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CallReasonListPageResponse].
         *
         ...
         */
        fun build(): CallReasonListPageResponse =
            CallReasonListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): CallReasonListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReasonListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallReasonListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
