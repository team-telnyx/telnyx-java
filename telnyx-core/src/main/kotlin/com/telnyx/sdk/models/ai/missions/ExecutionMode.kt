...
class ExecutionMode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    enum class Value {
        ...
        MANAGED,
        /**
         * An enum member indicating that [ExecutionMode] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
