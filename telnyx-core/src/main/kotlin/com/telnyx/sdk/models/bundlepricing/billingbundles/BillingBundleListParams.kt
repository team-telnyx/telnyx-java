...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BillingBundleListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BillingBundleListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BillingBundleListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingBundleListParams: BillingBundleListParams) = apply {
            filter = billingBundleListParams.filter
            pageNumber = billingBundleListParams.pageNumber
            pageSize = billingBundleListParams.pageSize
            authorizationBearer = billingBundleListParams.authorizationBearer
            additionalHeaders = billingBundleListParams.additionalHeaders.toBuilder()
            additionalQueryParams = billingBundleListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BillingBundleListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BillingBundleListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BillingBundleListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "BillingBundleListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, authorizationBearer=$authorizationBearer, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
