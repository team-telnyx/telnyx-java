 ...
 */
class TextToSpeechRetrieveSpeechParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TextToSpeechRetrieveSpeechParams = builder().build()
    ...
    /** A builder for [TextToSpeechRetrieveSpeechParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(textToSpeechRetrieveSpeechParams: TextToSpeechRetrieveSpeechParams) =
            apply {
                audioFormat = textToSpeechRetrieveSpeechParams.audioFormat
                disableCache = textToSpeechRetrieveSpeechParams.disableCache
                modelId = textToSpeechRetrieveSpeechParams.modelId
                provider = textToSpeechRetrieveSpeechParams.provider
                socketId = textToSpeechRetrieveSpeechParams.socketId
                voice = textToSpeechRetrieveSpeechParams.voice
                voiceId = textToSpeechRetrieveSpeechParams.voiceId
                additionalHeaders = textToSpeechRetrieveSpeechParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    textToSpeechRetrieveSpeechParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TextToSpeechRetrieveSpeechParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TextToSpeechRetrieveSpeechParams =
            TextToSpeechRetrieveSpeechParams(
                audioFormat,
                disableCache,
                modelId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TextToSpeechRetrieveSpeechParams &&
    ...
    override fun toString() =
        "TextToSpeechRetrieveSpeechParams{audioFormat=$audioFormat, disableCache=$disableCache, modelId=$modelId, provider=$provider, socketId=$socketId, voice=$voice, voiceId=$voiceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
