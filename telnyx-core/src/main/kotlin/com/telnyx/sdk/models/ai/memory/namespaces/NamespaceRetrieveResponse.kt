...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NamespaceRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NamespaceRetrieveResponse].
         *
    ...
    private constructor(
        ...
        ) : this(operationId, status, completedAt, createdAt, mutableMapOf())
        ...
        /**
         * Where the write is. `completed`, `failed` and `cancelled` are terminal: stop polling at
         * any of them, and treat `failed` and `cancelled` as writes that did not happen.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
         ...
         */
        fun completedAt(): Optional<String> = completedAt.getOptional("completed_at")
        ...
        class Builder internal constructor() {
            ...
            fun completedAt(completedAt: String?) = completedAt(JsonField.ofNullable(completedAt))

            /** Alias for calling [Builder.completedAt] with `completedAt.orElse(null)`. */
            fun completedAt(completedAt: Optional<String>) = completedAt(completedAt.getOrNull())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(operationId, status, completedAt, createdAt, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{operationId=$operationId, status=$status, completedAt=$completedAt, createdAt=$createdAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NamespaceRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "NamespaceRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
