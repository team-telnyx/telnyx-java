...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PhoneNumberResendVerificationParams = builder().build()
    ...
    /** A builder for [PhoneNumberResendVerificationParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            phoneNumber = phoneNumberResendVerificationParams.phoneNumber
            body = phoneNumberResendVerificationParams.body.toBuilder()
            additionalHeaders = phoneNumberResendVerificationParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                phoneNumberResendVerificationParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberResendVerificationParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoneNumberResendVerificationParams =
            PhoneNumberResendVerificationParams(
                phoneNumber,
                body.build(),
    ...
    private constructor(
        ...
        ) : this(verificationMethod, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(verificationMethod, additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (verificationMethod.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(verificationMethod, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{verificationMethod=$verificationMethod, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberResendVerificationParams &&
    ...
    override fun toString() =
        "PhoneNumberResendVerificationParams{phoneNumber=$phoneNumber, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
