...
class MessagingMessagingProfile
...
private constructor(
    ...
    /**
     * Indicates whether message content redaction is enabled for this profile. When enabled,
     * message text, MMS media, and the counterparty phone number are redacted in message records
     * and reporting. Requires organization activation — contact support to enable. The field is
     * only present in responses for organizations with redaction access.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * Determines how much information is redacted for privacy or compliance purposes. Level 1:
     * message records and reporting are redacted, but inbound webhook payloads are not. Level 2
     * (default): message records, reporting, and inbound webhook payloads are all redacted.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessagingMessagingProfile].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessagingMessagingProfile]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingMessagingProfile: MessagingMessagingProfile) = apply {
            id = messagingMessagingProfile.id
            aiAssistantId = messagingMessagingProfile.aiAssistantId
            alphaSender = messagingMessagingProfile.alphaSender
            createdAt = messagingMessagingProfile.createdAt
            dailySpendLimit = messagingMessagingProfile.dailySpendLimit
            dailySpendLimitEnabled = messagingMessagingProfile.dailySpendLimitEnabled
            enabled = messagingMessagingProfile.enabled
            features = messagingMessagingProfile.features
            healthWebhookUrl = messagingMessagingProfile.healthWebhookUrl
            mmsFallBackToSms = messagingMessagingProfile.mmsFallBackToSms
            mmsTranscoding = messagingMessagingProfile.mmsTranscoding
            mobileOnly = messagingMessagingProfile.mobileOnly
            name = messagingMessagingProfile.name
            numberPoolSettings = messagingMessagingProfile.numberPoolSettings
            organizationId = messagingMessagingProfile.organizationId
            recordType = messagingMessagingProfile.recordType
            redactionEnabled = messagingMessagingProfile.redactionEnabled
            redactionLevel = messagingMessagingProfile.redactionLevel
            resourceGroupId = messagingMessagingProfile.resourceGroupId
            smartEncoding = messagingMessagingProfile.smartEncoding
            updatedAt = messagingMessagingProfile.updatedAt
            urlShortenerSettings = messagingMessagingProfile.urlShortenerSettings
            v1Secret = messagingMessagingProfile.v1Secret
            webhookApiVersion = messagingMessagingProfile.webhookApiVersion
            webhookFailoverUrl = messagingMessagingProfile.webhookFailoverUrl
            webhookUrl = messagingMessagingProfile.webhookUrl
            whitelistedDestinations =
                messagingMessagingProfile.whitelistedDestinations.map { it.toMutableList() }
            additionalProperties = messagingMessagingProfile.additionalProperties.toMutableMap()
        }
         ...
         * compatibility with rolling deployments.
         */
        fun features(features: MessagingProfileFeatures?) = features(JsonField.ofNullable(features))
        ...
        /**
         * Indicates whether message content redaction is enabled for this profile. When enabled,
         * message text, MMS media, and the counterparty phone number are redacted in message
         * records and reporting. Requires organization activation — contact support to enable. The
         * field is only present in responses for organizations with redaction access.
         */
        ...
        /**
         * Returns an immutable instance of [MessagingMessagingProfile].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingMessagingProfile =
     ...
     *   expected type.
     */
    fun validate(): MessagingMessagingProfile = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingMessagingProfile &&
            id == other.id &&
