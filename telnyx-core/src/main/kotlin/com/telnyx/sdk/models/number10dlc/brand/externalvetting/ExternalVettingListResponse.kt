...
class ExternalVettingListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalVettingListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExternalVettingListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVettingListResponse: ExternalVettingListResponse) = apply {
            createDate = externalVettingListResponse.createDate
            evpId = externalVettingListResponse.evpId
            vettedDate = externalVettingListResponse.vettedDate
            vettingClass = externalVettingListResponse.vettingClass
            vettingId = externalVettingListResponse.vettingId
            vettingScore = externalVettingListResponse.vettingScore
            vettingToken = externalVettingListResponse.vettingToken
            additionalProperties = externalVettingListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVettingListResponse =
    ...
    fun validate(): ExternalVettingListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingListResponse &&
    ...
    override fun toString() =
        "ExternalVettingListResponse{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
