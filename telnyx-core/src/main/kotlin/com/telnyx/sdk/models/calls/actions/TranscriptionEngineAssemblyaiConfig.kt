...
class TranscriptionEngineAssemblyaiConfig
...
private constructor(
    ...
    /** A builder for [TranscriptionEngineAssemblyaiConfig]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            interimResults = transcriptionEngineAssemblyaiConfig.interimResults
            transcriptionEngine = transcriptionEngineAssemblyaiConfig.transcriptionEngine
            transcriptionModel = transcriptionEngineAssemblyaiConfig.transcriptionModel
            additionalProperties =
                transcriptionEngineAssemblyaiConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TranscriptionEngineAssemblyaiConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TranscriptionEngineAssemblyaiConfig =
            TranscriptionEngineAssemblyaiConfig(
                interimResults,
                transcriptionEngine,
                transcriptionModel,
     ...
     *   expected type.
     */
    fun validate(): TranscriptionEngineAssemblyaiConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranscriptionEngineAssemblyaiConfig &&
    ...
    override fun toString() =
        "TranscriptionEngineAssemblyaiConfig{interimResults=$interimResults, transcriptionEngine=$transcriptionEngine, transcriptionModel=$transcriptionModel, additionalProperties=$additionalProperties}"
}
