...
private constructor(
    ...
    private constructor(
         ...
         *
         * Unlike [availableTools], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("available_tools")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                id = data.id
                availableTools = data.availableTools.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.availableTools] with a well-typed `List<String>`
        ...
        override fun toString() =
            "Data{id=$id, availableTools=$availableTools, description=$description, displayName=$displayName, logoUrl=$logoUrl, name=$name, status=$status, additionalProperties=$additionalProperties}"
    }
