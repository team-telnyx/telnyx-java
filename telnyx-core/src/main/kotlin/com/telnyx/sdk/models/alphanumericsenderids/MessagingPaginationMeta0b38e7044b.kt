...
class MessagingPaginationMeta0b38e7044b
...
private constructor(
    ...
    /** A builder for [MessagingPaginationMeta0b38e7044b]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingPaginationMeta0b38e7044b: MessagingPaginationMeta0b38e7044b) =
            apply {
                pageNumber = messagingPaginationMeta0b38e7044b.pageNumber
                pageSize = messagingPaginationMeta0b38e7044b.pageSize
                totalPages = messagingPaginationMeta0b38e7044b.totalPages
                totalResults = messagingPaginationMeta0b38e7044b.totalResults
                additionalProperties =
                    messagingPaginationMeta0b38e7044b.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [MessagingPaginationMeta0b38e7044b].
         *
         ...
         */
        fun build(): MessagingPaginationMeta0b38e7044b =
            MessagingPaginationMeta0b38e7044b(
     ...
     *   expected type.
     */
    fun validate(): MessagingPaginationMeta0b38e7044b = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingPaginationMeta0b38e7044b &&
    ...
    override fun toString() =
        "MessagingPaginationMeta0b38e7044b{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
