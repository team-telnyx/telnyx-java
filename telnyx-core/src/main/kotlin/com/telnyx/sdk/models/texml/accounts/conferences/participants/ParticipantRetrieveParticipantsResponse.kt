...
private constructor(
    ...
    private val participants: JsonField<List<ParticipantResource>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        participants: JsonField<List<ParticipantResource>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun participants(): Optional<List<ParticipantResource>> =
    ...
    @JsonProperty("participants")
    @ExcludeMissing
    fun _participants(): JsonField<List<ParticipantResource>> = participants
    ...
    class Builder internal constructor() {
        ...
        private var participants: JsonField<MutableList<ParticipantResource>>? = null
        ...
        fun participants(participants: List<ParticipantResource>) =
         ...
         * `List<ParticipantResource>` value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun participants(participants: JsonField<List<ParticipantResource>>) = apply {
            this.participants = participants.map { it.toMutableList() }
        }

        /**
         * Adds a single [ParticipantResource] to [participants].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addParticipant(participant: ParticipantResource) = apply {
            participants =
