...
/**
 * Returns a list of all associated phone numbers for a porting order. Associated phone numbers are
 * used for partial porting in GB to specify which phone numbers should be kept or disconnected.
 */
class AssociatedPhoneNumberListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AssociatedPhoneNumberListParams = builder().build()
    ...
    /** A builder for [AssociatedPhoneNumberListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(associatedPhoneNumberListParams: AssociatedPhoneNumberListParams) =
            apply {
                portingOrderId = associatedPhoneNumberListParams.portingOrderId
                filter = associatedPhoneNumberListParams.filter
                pageNumber = associatedPhoneNumberListParams.pageNumber
                pageSize = associatedPhoneNumberListParams.pageSize
                sort = associatedPhoneNumberListParams.sort
                additionalHeaders = associatedPhoneNumberListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    associatedPhoneNumberListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AssociatedPhoneNumberListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AssociatedPhoneNumberListParams =
            AssociatedPhoneNumberListParams(
                portingOrderId,
                filter,
                pageNumber,
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Filter = Filter(action, phoneNumber, additionalProperties.build())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(action, phoneNumber, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{action=$action, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociatedPhoneNumberListParams &&
    ...
    override fun toString() =
        "AssociatedPhoneNumberListParams{portingOrderId=$portingOrderId, filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
