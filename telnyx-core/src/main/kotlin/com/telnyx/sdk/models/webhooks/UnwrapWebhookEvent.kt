...
private constructor(
    ...
    override fun toString(): String =
        when {
            ...
            callHold != null -> "UnwrapWebhookEvent{callHold=$callHold}"
            ...
            callPaymentCompleted != null ->
                "UnwrapWebhookEvent{callPaymentCompleted=$callPaymentCompleted}"
            callPaymentProgress != null ->
                "UnwrapWebhookEvent{callPaymentProgress=$callPaymentProgress}"
            ...
            callUnhold != null -> "UnwrapWebhookEvent{callUnhold=$callUnhold}"
    ...
    companion object {
        ...
        @JvmStatic
        fun ofCallHold(callHold: CallHoldWebhookEvent) = UnwrapWebhookEvent(callHold = callHold)
        ...
        fun ofCallUnhold(callUnhold: CallUnholdWebhookEvent) =
            UnwrapWebhookEvent(callUnhold = callUnhold)
            ...
            val bestMatches =
                sequenceOf(
                        ...
                        tryDeserialize(node, jacksonTypeRef<CallHoldWebhookEvent>())?.let {
                            UnwrapWebhookEvent(callHold = it, _json = json)
                        },
                        ...
                        tryDeserialize(node, jacksonTypeRef<CallPaymentCompletedWebhookEvent>())
                            ?.let { UnwrapWebhookEvent(callPaymentCompleted = it, _json = json) },
                        tryDeserialize(node, jacksonTypeRef<CallPaymentProgressWebhookEvent>())
                            ?.let { UnwrapWebhookEvent(callPaymentProgress = it, _json = json) },
                        ...
                        tryDeserialize(node, jacksonTypeRef<CallUnholdWebhookEvent>())?.let {
                            UnwrapWebhookEvent(callUnhold = it, _json = json)
                        },
