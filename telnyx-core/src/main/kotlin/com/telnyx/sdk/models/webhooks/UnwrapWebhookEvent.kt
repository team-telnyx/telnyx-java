...
private constructor(
    ...
    private val campaignStatusUpdate: CampaignStatusUpdateEvent? = null,
    private val campaignSuspended: CampaignSuspendedEvent? = null,
    ...
    fun campaignStatusUpdate(): Optional<CampaignStatusUpdateEvent> =
        Optional.ofNullable(campaignStatusUpdate)

    fun campaignSuspended(): Optional<CampaignSuspendedEvent> =
        Optional.ofNullable(campaignSuspended)
    ...
    fun isCampaignSuspended(): Boolean = campaignSuspended != null
    ...
    fun asCampaignStatusUpdate(): CampaignStatusUpdateEvent =
        campaignStatusUpdate.getOrThrow("campaignStatusUpdate")

    fun asCampaignSuspended(): CampaignSuspendedEvent =
        campaignSuspended.getOrThrow("campaignSuspended")
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            ...
            campaignSuspended != null -> visitor.visitCampaignSuspended(campaignSuspended)
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitCampaignStatusUpdate(
                    campaignStatusUpdate: CampaignStatusUpdateEvent
                ) {
                    campaignStatusUpdate.validate()
                }

                override fun visitCampaignSuspended(campaignSuspended: CampaignSuspendedEvent) {
                    campaignSuspended.validate()
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UnwrapWebhookEvent &&
            ...
            campaignSuspended == other.campaignSuspended &&
    ...
    override fun toString(): String =
        when {
            ...
            campaignSuspended != null -> "UnwrapWebhookEvent{campaignSuspended=$campaignSuspended}"
    ...
    companion object {
        ...
        @JvmStatic
        fun ofCampaignStatusUpdate(campaignStatusUpdate: CampaignStatusUpdateEvent) =
            UnwrapWebhookEvent(campaignStatusUpdate = campaignStatusUpdate)

        @JvmStatic
        fun ofCampaignSuspended(campaignSuspended: CampaignSuspendedEvent) =
            UnwrapWebhookEvent(campaignSuspended = campaignSuspended)
        ...
        fun ofFaxFailed(faxFailed: FaxFailedWebhookEvent) =
            UnwrapWebhookEvent(faxFailed = faxFailed)
        ...
        fun ofFaxQueued(faxQueued: FaxQueuedWebhookEvent) =
            UnwrapWebhookEvent(faxQueued = faxQueued)
    ...
    interface Visitor<out T> {
        ...
        fun visitCampaignStatusUpdate(campaignStatusUpdate: CampaignStatusUpdateEvent): T

        fun visitCampaignSuspended(campaignSuspended: CampaignSuspendedEvent): T
            ...
            val bestMatches =
                sequenceOf(
                        ...
                        tryDeserialize(node, jacksonTypeRef<CampaignSuspendedEvent>())?.let {
                            UnwrapWebhookEvent(campaignSuspended = it, _json = json)
                        },
                        ...
                        tryDeserialize(node, jacksonTypeRef<ConferenceFloorChangedWebhookEvent>())
                            ?.let { UnwrapWebhookEvent(conferenceFloorChanged = it, _json = json) },
                        tryDeserialize(
                                node,
    ...
    internal class Serializer : BaseSerializer<UnwrapWebhookEvent>(UnwrapWebhookEvent::class) {
        ...
        override fun serialize(
            ...
            when {
                ...
                value.campaignSuspended != null -> generator.writeObject(value.campaignSuspended)
