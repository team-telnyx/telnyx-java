...
class VoiceDesignCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VoiceDesignCreateResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceDesignCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceDesignCreateResponse: VoiceDesignCreateResponse) = apply {
            data = voiceDesignCreateResponse.data
            additionalProperties = voiceDesignCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceDesignCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceDesignCreateResponse =
            VoiceDesignCreateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): VoiceDesignCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [providerVoiceId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("provider_voice_id")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                providerSupportedModels = data.providerSupportedModels.map { it.toMutableList() }
            ...
            /**
             * Provider-specific voice identifier. For Telnyx designs this is the design version ID;
             * for Minimax it is the Minimax-assigned voice ID.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceDesignCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VoiceDesignCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
