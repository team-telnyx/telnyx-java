...
private constructor(
    private val data: JsonField<List<UserListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<UserListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<UserListResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<UserListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<UserListResponse>>? = null
        ...
        internal fun from(userListPageResponse: UserListPageResponse) = apply {
            ...
            meta = userListPageResponse.meta
            additionalProperties = userListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<UserListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<UserListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<UserListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [UserListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: UserListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "UserListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
