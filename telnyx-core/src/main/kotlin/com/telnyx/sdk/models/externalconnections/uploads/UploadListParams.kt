...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UploadListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UploadListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UploadListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uploadListParams: UploadListParams) = apply {
            id = uploadListParams.id
            filter = uploadListParams.filter
            pageNumber = uploadListParams.pageNumber
            pageSize = uploadListParams.pageSize
            additionalHeaders = uploadListParams.additionalHeaders.toBuilder()
            additionalQueryParams = uploadListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UploadListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UploadListParams =
            UploadListParams(
                id,
                filter,
                pageNumber,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UploadListParams &&
            id == other.id &&
            filter == other.filter &&
    ...
    override fun toString() =
        "UploadListParams{id=$id, filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
