...
class CallMachinePremiumGreetingEnded
...
private constructor(
    ...
    /** A builder for [CallMachinePremiumGreetingEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callMachinePremiumGreetingEnded: CallMachinePremiumGreetingEnded) =
            apply {
                id = callMachinePremiumGreetingEnded.id
                eventType = callMachinePremiumGreetingEnded.eventType
                occurredAt = callMachinePremiumGreetingEnded.occurredAt
                payload = callMachinePremiumGreetingEnded.payload
                recordType = callMachinePremiumGreetingEnded.recordType
                additionalProperties =
                    callMachinePremiumGreetingEnded.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallMachinePremiumGreetingEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallMachinePremiumGreetingEnded =
            CallMachinePremiumGreetingEnded(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallMachinePremiumGreetingEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CALL_MACHINE_PREMIUM_GREETING_ENDED = of("call.machine.premium.greeting.ended")
        ...
        fun value(): Value =
            when (this) {
                CALL_MACHINE_PREMIUM_GREETING_ENDED -> Value.CALL_MACHINE_PREMIUM_GREETING_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_MACHINE_PREMIUM_GREETING_ENDED -> Known.CALL_MACHINE_PREMIUM_GREETING_ENDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallMachinePremiumGreetingEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallMachinePremiumGreetingEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
