...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WirelessErrorC5290d5308].
         *
    ...
    /** A builder for [WirelessErrorC5290d5308]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(wirelessErrorC5290d5308: WirelessErrorC5290d5308) = apply {
            code = wirelessErrorC5290d5308.code
            title = wirelessErrorC5290d5308.title
            detail = wirelessErrorC5290d5308.detail
            meta = wirelessErrorC5290d5308.meta
            source = wirelessErrorC5290d5308.source
            additionalProperties = wirelessErrorC5290d5308.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WirelessErrorC5290d5308].
         *
         ...
         */
        fun build(): WirelessErrorC5290d5308 =
            WirelessErrorC5290d5308(
     ...
     *   expected type.
     */
    fun validate(): WirelessErrorC5290d5308 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WirelessErrorC5290d5308 &&
            code == other.code &&
            title == other.title &&
            detail == other.detail &&
            meta == other.meta &&
    ...
    override fun toString() =
        "WirelessErrorC5290d5308{code=$code, title=$title, detail=$detail, meta=$meta, source=$source, additionalProperties=$additionalProperties}"
}
