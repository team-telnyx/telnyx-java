...
/**
 * Lists conferences. Conferences are created on demand, and will expire after all participants have
 * left the conference or after 4 hours regardless of the number of active participants. Conferences
 * are listed in descending order by `expires_at`.
 */
class ConferenceListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ConferenceListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ConferenceListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(conferenceListParams: ConferenceListParams) = apply {
            ...
            pageNumber = conferenceListParams.pageNumber
            pageSize = conferenceListParams.pageSize
        ...
        /**
         * Returns an immutable instance of [ConferenceListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceListParams =
    ...
    override fun hashCode(): Int =
        Objects.hash(filter, pageNumber, pageSize, region, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ConferenceListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, region=$region, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
