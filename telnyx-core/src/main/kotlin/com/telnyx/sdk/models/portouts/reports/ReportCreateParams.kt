...
private constructor(
     ...
     */
    fun params(): ExportPortoutsCsvReport = body.params()
     ...
     */
    fun _params(): JsonField<ExportPortoutsCsvReport> = body._params()
    ...
    class Builder internal constructor() {
        ...
        /** The parameters for generating a port-outs CSV report. */
        fun params(params: ExportPortoutsCsvReport) = apply { body.params(params) }
         ...
         * yet supported value.
         */
        fun params(params: JsonField<ExportPortoutsCsvReport>) = apply { body.params(params) }
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun params(): ExportPortoutsCsvReport = params.getRequired("params")
        ...
        class Builder internal constructor() {
            ...
            private var params: JsonField<ExportPortoutsCsvReport>? = null
