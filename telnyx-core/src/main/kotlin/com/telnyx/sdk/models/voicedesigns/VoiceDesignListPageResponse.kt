...
private constructor(
    private val data: JsonField<List<VoiceDesignListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<VoiceDesignListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<VoiceDesignListResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<VoiceDesignListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<VoiceDesignListResponse>>? = null
        ...
        /** Array of voice design summary objects. */
        fun data(data: List<VoiceDesignListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<VoiceDesignListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<VoiceDesignListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [VoiceDesignListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: VoiceDesignListResponse) = apply {
            this.data =
