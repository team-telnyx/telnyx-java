...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = createMobilePushCredentialRequest.accept(new CreateMobilePushCredentialRequest.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitIos(Ios ios) {
         *         return Optional.of(ios.toString());
         *     }
         *
         *     // ...
         *
