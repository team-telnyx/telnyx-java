...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callUpdateParams: CallUpdateParams) = apply {
            queueName = callUpdateParams.queueName
            callControlId = callUpdateParams.callControlId
            body = callUpdateParams.body.toBuilder()
    ...
    private constructor(
        ...
        ) : this(keepAfterHangup, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(keepAfterHangup, additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (keepAfterHangup.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(keepAfterHangup, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{keepAfterHangup=$keepAfterHangup, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(queueName, callControlId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CallUpdateParams{queueName=$queueName, callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
