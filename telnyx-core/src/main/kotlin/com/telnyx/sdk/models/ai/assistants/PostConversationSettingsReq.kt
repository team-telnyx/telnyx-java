...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostConversationSettingsReq].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostConversationSettingsReq]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postConversationSettingsReq: PostConversationSettingsReq) = apply {
            enabled = postConversationSettingsReq.enabled
            additionalProperties = postConversationSettingsReq.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PostConversationSettingsReq].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostConversationSettingsReq =
            PostConversationSettingsReq(enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): PostConversationSettingsReq = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostConversationSettingsReq &&
    ...
    override fun toString() =
        "PostConversationSettingsReq{enabled=$enabled, additionalProperties=$additionalProperties}"
}
