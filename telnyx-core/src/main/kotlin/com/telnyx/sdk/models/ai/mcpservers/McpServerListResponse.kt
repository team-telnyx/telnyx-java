...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [McpServerListResponse].
         *
    ...
    /** A builder for [McpServerListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mcpServerListResponse: McpServerListResponse) = apply {
            id = mcpServerListResponse.id
            createdAt = mcpServerListResponse.createdAt
            name = mcpServerListResponse.name
            type = mcpServerListResponse.type
            url = mcpServerListResponse.url
            allowedTools = mcpServerListResponse.allowedTools.map { it.toMutableList() }
            apiKeyRef = mcpServerListResponse.apiKeyRef
            additionalProperties = mcpServerListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [McpServerListResponse].
         *
         ...
         */
        fun build(): McpServerListResponse =
    ...
    fun validate(): McpServerListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is McpServerListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "McpServerListResponse{id=$id, createdAt=$createdAt, name=$name, type=$type, url=$url, allowedTools=$allowedTools, apiKeyRef=$apiKeyRef, additionalProperties=$additionalProperties}"
}
