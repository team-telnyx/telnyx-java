...
class CallControlApplicationListResponse
...
private constructor(
    ...
    /** A builder for [CallControlApplicationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callControlApplicationListResponse: CallControlApplicationListResponse) =
            apply {
                data = callControlApplicationListResponse.data.map { it.toMutableList() }
                meta = callControlApplicationListResponse.meta
                additionalProperties =
                    callControlApplicationListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallControlApplicationListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallControlApplicationListResponse =
            CallControlApplicationListResponse(
    ...
    fun validate(): CallControlApplicationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallControlApplicationListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "CallControlApplicationListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
