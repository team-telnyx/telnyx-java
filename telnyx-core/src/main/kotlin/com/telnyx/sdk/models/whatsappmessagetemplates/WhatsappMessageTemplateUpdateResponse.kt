...
class WhatsappMessageTemplateUpdateResponse
...
private constructor(
    ...
    /** A builder for [WhatsappMessageTemplateUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                whatsappMessageTemplateUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WhatsappMessageTemplateUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WhatsappMessageTemplateUpdateResponse =
            WhatsappMessageTemplateUpdateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): WhatsappMessageTemplateUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                whatsappBusinessAccount = data.whatsappBusinessAccount
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(whatsappBusinessAccount: WhatsappBusinessAccount) = apply {
                    ...
                    additionalProperties =
                        whatsappBusinessAccount.additionalProperties.toMutableMap()
                }
        ...
        override fun toString() =
            "Data{id=$id, category=$category, components=$components, createdAt=$createdAt, language=$language, name=$name, recordType=$recordType, rejectionReason=$rejectionReason, status=$status, templateId=$templateId, updatedAt=$updatedAt, whatsappBusinessAccount=$whatsappBusinessAccount, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappMessageTemplateUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "WhatsappMessageTemplateUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
