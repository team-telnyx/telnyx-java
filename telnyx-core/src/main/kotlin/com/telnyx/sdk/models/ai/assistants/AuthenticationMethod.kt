...
class AuthenticationMethod @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    /**
     * An enum containing [AuthenticationMethod]'s known values, as well as an [_UNKNOWN] member.
     *
    ...
    enum class Value {
        ...
        CERTIFICATE,
        /**
         * An enum member indicating that [AuthenticationMethod] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
