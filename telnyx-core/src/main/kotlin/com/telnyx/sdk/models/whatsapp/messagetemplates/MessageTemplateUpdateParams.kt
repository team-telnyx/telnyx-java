...
class MessageTemplateUpdateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MessageTemplateUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [MessageTemplateUpdateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageTemplateUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageTemplateUpdateParams: MessageTemplateUpdateParams) = apply {
            id = messageTemplateUpdateParams.id
            body = messageTemplateUpdateParams.body.toBuilder()
            additionalHeaders = messageTemplateUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageTemplateUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessageTemplateUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessageTemplateUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageTemplateUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "MessageTemplateUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
