...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EnterpriseListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EnterpriseListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(enterpriseListResponse: EnterpriseListResponse) = apply {
            id = enterpriseListResponse.id
            billingAddress = enterpriseListResponse.billingAddress
            billingContact = enterpriseListResponse.billingContact
            corporateRegistrationNumber = enterpriseListResponse.corporateRegistrationNumber
            countryCode = enterpriseListResponse.countryCode
            createdAt = enterpriseListResponse.createdAt
            customerReference = enterpriseListResponse.customerReference
            doingBusinessAs = enterpriseListResponse.doingBusinessAs
            dunBradstreetNumber = enterpriseListResponse.dunBradstreetNumber
            fein = enterpriseListResponse.fein
            industry = enterpriseListResponse.industry
            legalName = enterpriseListResponse.legalName
            numberOfEmployees = enterpriseListResponse.numberOfEmployees
            organizationContact = enterpriseListResponse.organizationContact
            organizationLegalType = enterpriseListResponse.organizationLegalType
            organizationPhysicalAddress = enterpriseListResponse.organizationPhysicalAddress
            organizationType = enterpriseListResponse.organizationType
            primaryBusinessDomainSicCode = enterpriseListResponse.primaryBusinessDomainSicCode
            professionalLicenseNumber = enterpriseListResponse.professionalLicenseNumber
            roleType = enterpriseListResponse.roleType
            updatedAt = enterpriseListResponse.updatedAt
            website = enterpriseListResponse.website
            additionalProperties = enterpriseListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EnterpriseListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EnterpriseListResponse =
    ...
    fun validate(): EnterpriseListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnterpriseListResponse &&
            id == other.id &&
