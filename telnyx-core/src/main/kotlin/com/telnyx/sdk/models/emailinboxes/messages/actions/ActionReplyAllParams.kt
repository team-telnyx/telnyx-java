...
/**
 * Sends from the inbox address through the standard email send pipeline. The To list starts with
 * the original `Reply-To` (or `From`) and includes original To recipients; the Cc list includes
 * original Cc recipients. The inbox address is excluded, and recipients are de-duplicated
 * case-insensitively across To and Cc. Bcc is always empty. The subject is prefixed with `Re:`
 * unless it already has that prefix.
 *
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionReplyAllParams].
         *
    ...
    /** A builder for [ActionReplyAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionReplyAllParams: ActionReplyAllParams) = apply {
            inboxId = actionReplyAllParams.inboxId
            messageId = actionReplyAllParams.messageId
            replyEmailInboxMessageRequest = actionReplyAllParams.replyEmailInboxMessageRequest
            additionalHeaders = actionReplyAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionReplyAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionReplyAllParams].
         *
         ...
         */
        fun build(): ActionReplyAllParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionReplyAllParams &&
    ...
    override fun toString() =
        "ActionReplyAllParams{inboxId=$inboxId, messageId=$messageId, replyEmailInboxMessageRequest=$replyEmailInboxMessageRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
