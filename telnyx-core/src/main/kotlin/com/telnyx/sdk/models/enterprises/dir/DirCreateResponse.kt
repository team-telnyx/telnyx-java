...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirCreateResponse].
         *
    ...
    /** A builder for [DirCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirCreateResponse: DirCreateResponse) = apply {
            data = dirCreateResponse.data
            additionalProperties = dirCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirCreateResponse].
         *
         ...
         */
        fun build(): DirCreateResponse =
            DirCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): DirCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DirCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
