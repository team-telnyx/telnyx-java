...
class TexmlApplicationUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TexmlApplicationUpdateParams].
         *
    ...
    /** A builder for [TexmlApplicationUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(texmlApplicationUpdateParams: TexmlApplicationUpdateParams) = apply {
            id = texmlApplicationUpdateParams.id
            body = texmlApplicationUpdateParams.body.toBuilder()
            additionalHeaders = texmlApplicationUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = texmlApplicationUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TexmlApplicationUpdateParams].
         *
         ...
         */
        fun build(): TexmlApplicationUpdateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{friendlyName=$friendlyName, voiceUrl=$voiceUrl, active=$active, anchorsiteOverride=$anchorsiteOverride, callCostInWebhooks=$callCostInWebhooks, dtmfType=$dtmfType, firstCommandTimeout=$firstCommandTimeout, firstCommandTimeoutSecs=$firstCommandTimeoutSecs, inbound=$inbound, outbound=$outbound, statusCallback=$statusCallback, statusCallbackMethod=$statusCallbackMethod, tags=$tags, voiceFallbackUrl=$voiceFallbackUrl, voiceMethod=$voiceMethod, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlApplicationUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "TexmlApplicationUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
