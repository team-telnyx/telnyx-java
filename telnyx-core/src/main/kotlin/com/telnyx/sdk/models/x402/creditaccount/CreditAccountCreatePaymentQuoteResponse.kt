...
class CreditAccountCreatePaymentQuoteResponse
...
private constructor(
    ...
    /** A builder for [CreditAccountCreatePaymentQuoteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            creditAccountCreatePaymentQuoteResponse: CreditAccountCreatePaymentQuoteResponse
        ) = apply {
            data = creditAccountCreatePaymentQuoteResponse.data
            additionalProperties =
                creditAccountCreatePaymentQuoteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreditAccountCreatePaymentQuoteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CreditAccountCreatePaymentQuoteResponse =
            CreditAccountCreatePaymentQuoteResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CreditAccountCreatePaymentQuoteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditAccountCreatePaymentQuoteResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CreditAccountCreatePaymentQuoteResponse{data=$data, additionalProperties=$additionalProperties}"
}
