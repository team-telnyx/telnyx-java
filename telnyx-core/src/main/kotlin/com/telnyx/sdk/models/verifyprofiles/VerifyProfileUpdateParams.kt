...
private constructor(
    ...
    fun verifyProfileId(): Optional<String> = Optional.ofNullable(verifyProfileId)
     ...
     *   server responded with an unexpected value).
     */
    fun dailySpendLimit(): Optional<Double> = body.dailySpendLimit()
     ...
     */
    fun _dailySpendLimit(): JsonField<Double> = body._dailySpendLimit()
    ...
    companion object {
        ...
        @JvmStatic fun none(): VerifyProfileUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [VerifyProfileUpdateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VerifyProfileUpdateParams]. */
    class Builder internal constructor() {

        private var verifyProfileId: String? = null
        private var body: Body.Builder = Body.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(verifyProfileUpdateParams: VerifyProfileUpdateParams) = apply {
            verifyProfileId = verifyProfileUpdateParams.verifyProfileId
            body = verifyProfileUpdateParams.body.toBuilder()
            additionalHeaders = verifyProfileUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = verifyProfileUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Alias for calling [Builder.verifyProfileId] with `verifyProfileId.orElse(null)`. */
        fun verifyProfileId(verifyProfileId: Optional<String>) =
            verifyProfileId(verifyProfileId.getOrNull())
        ...
        /** The maximum daily spend allowed on this verify profile, in USD. */
        fun dailySpendLimit(dailySpendLimit: Double) = apply {
        ...
        /**
         * Returns an immutable instance of [VerifyProfileUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VerifyProfileUpdateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{call=$call, dailySpendLimit=$dailySpendLimit, dailySpendLimitEnabled=$dailySpendLimitEnabled, language=$language, name=$name, sms=$sms, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, whatsapp=$whatsapp, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifyProfileUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(verifyProfileId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "VerifyProfileUpdateParams{verifyProfileId=$verifyProfileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
