...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UserDataUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UserDataUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserDataUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userDataUpdateParams: UserDataUpdateParams) = apply {
            body = userDataUpdateParams.body.toBuilder()
            additionalHeaders = userDataUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = userDataUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserDataUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserDataUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserDataUpdateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "UserDataUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
