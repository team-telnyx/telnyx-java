...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(settingsRequest: SettingsRequest) = apply {
            retrieval = settingsRequest.retrieval
        ...
        fun build(): SettingsRequest =
            SettingsRequest(retrieval, additionalProperties.toMutableMap())
    }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (retrieval.asKnown().getOrNull()?.validity() ?: 0)
    ...
    private val hashCode: Int by lazy { Objects.hash(retrieval, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "SettingsRequest{retrieval=$retrieval, additionalProperties=$additionalProperties}"
}
