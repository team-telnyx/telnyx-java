...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirNewLoaParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirNewLoaParams: DirNewLoaParams) = apply {
            dirId = dirNewLoaParams.dirId
            body = dirNewLoaParams.body.toBuilder()
            additionalHeaders = dirNewLoaParams.additionalHeaders.toBuilder()
            additionalQueryParams = dirNewLoaParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DirNewLoaParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirNewLoaParams &&
            dirId == other.dirId &&
            body == other.body &&
    ...
    override fun toString() =
        "DirNewLoaParams{dirId=$dirId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
