...
private constructor(
    ...
    /**
     * `sent` after a code is emailed; `verified` after a successful confirm; `unverified` when no
     ...
     *
     * Unlike [sendsRemainingToday], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("sends_remaining_today")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailVerificationStatus].
         *
    ...
    /** A builder for [EmailVerificationStatus]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailVerificationStatus: EmailVerificationStatus) = apply {
            emailVerified = emailVerificationStatus.emailVerified
            recordType = emailVerificationStatus.recordType
            status = emailVerificationStatus.status
            expiresAt = emailVerificationStatus.expiresAt
            sendsRemainingToday = emailVerificationStatus.sendsRemainingToday
            additionalProperties = emailVerificationStatus.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Alias for calling [Builder.sendsRemainingToday] with `sendsRemainingToday.orElse(null)`.
         */
        ...
        /**
         * Returns an immutable instance of [EmailVerificationStatus].
         *
         ...
         */
        fun build(): EmailVerificationStatus =
     ...
     *   expected type.
     */
    fun validate(): EmailVerificationStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "EmailVerificationStatus{emailVerified=$emailVerified, recordType=$recordType, status=$status, expiresAt=$expiresAt, sendsRemainingToday=$sendsRemainingToday, additionalProperties=$additionalProperties}"
}
