...
private constructor(
     ...
     */
    fun callControlIds(): List<String> = body.callControlIds()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionUnholdParams].
         *
    ...
    /** A builder for [ActionUnholdParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionUnholdParams: ActionUnholdParams) = apply {
            id = actionUnholdParams.id
            body = actionUnholdParams.body.toBuilder()
            additionalHeaders = actionUnholdParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionUnholdParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionUnholdParams].
         *
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun callControlIds(): List<String> = callControlIds.getRequired("call_control_ids")
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                    checkRequired("callControlIds", callControlIds).map { it.toImmutable() },
                    region,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionUnholdParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ActionUnholdParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
