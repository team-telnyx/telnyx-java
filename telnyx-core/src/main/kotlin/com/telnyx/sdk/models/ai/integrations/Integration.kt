...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(integration: Integration) = apply {
            id = integration.id
            availableTools = integration.availableTools.map { it.toMutableList() }
    ...
    override fun toString() =
        "Integration{id=$id, availableTools=$availableTools, description=$description, displayName=$displayName, logoUrl=$logoUrl, name=$name, status=$status, additionalProperties=$additionalProperties}"
}
