...
private constructor(
    ...
    private val queues: JsonField<List<Queue>>,
    ...
    private constructor(
        ...
        @JsonProperty("queues") @ExcludeMissing queues: JsonField<List<Queue>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun queues(): Optional<List<Queue>> = queues.getOptional("queues")
     ...
     */
    @JsonProperty("queues") @ExcludeMissing fun _queues(): JsonField<List<Queue>> = queues
    ...
    class Builder internal constructor() {
        ...
        private var queues: JsonField<MutableList<Queue>>? = null
        ...
        internal fun from(queueListResponse: QueueListResponse) = apply {
            end = queueListResponse.end
            firstPageUri = queueListResponse.firstPageUri
            nextPageUri = queueListResponse.nextPageUri
            page = queueListResponse.page
            pageSize = queueListResponse.pageSize
            queues = queueListResponse.queues.map { it.toMutableList() }
            start = queueListResponse.start
            uri = queueListResponse.uri
        ...
        fun queues(queues: List<Queue>) = queues(JsonField.of(queues))

        /**
         * Sets [Builder.queues] to an arbitrary JSON value.
         *
         * You should usually call [Builder.queues] with a well-typed `List<Queue>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun queues(queues: JsonField<List<Queue>>) = apply {
            this.queues = queues.map { it.toMutableList() }
        }

        /**
         * Adds a single [Queue] to [queues].
         *
    ...
    private constructor(
         ...
         *
         * Unlike [averageWaitTime], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("average_wait_time")
        @ExcludeMissing
        ...
        @JsonProperty("current_size")
        @ExcludeMissing
        fun _currentSize(): JsonField<Long> = currentSize
        ...
        class Builder internal constructor() {
            ...
            internal fun from(queue: Queue) = apply {
                ...
                sid = queue.sid
                subresourceUris = queue.subresourceUris
                uri = queue.uri
            ...
            /** The average wait time in seconds for members in the queue. */
            fun averageWaitTime(averageWaitTime: Long) =
                averageWaitTime(JsonField.of(averageWaitTime))

            /**
             * Sets [Builder.averageWaitTime] to an arbitrary JSON value.
             *
             * You should usually call [Builder.averageWaitTime] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Queue{accountSid=$accountSid, averageWaitTime=$averageWaitTime, currentSize=$currentSize, dateCreated=$dateCreated, dateUpdated=$dateUpdated, maxSize=$maxSize, sid=$sid, subresourceUris=$subresourceUris, uri=$uri, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "QueueListResponse{end=$end, firstPageUri=$firstPageUri, nextPageUri=$nextPageUri, page=$page, pageSize=$pageSize, queues=$queues, start=$start, uri=$uri, additionalProperties=$additionalProperties}"
}
