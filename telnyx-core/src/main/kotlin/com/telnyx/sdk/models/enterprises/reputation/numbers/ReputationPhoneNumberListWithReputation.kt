...
class ReputationPhoneNumberListWithReputation
...
private constructor(
    ...
    /** A builder for [ReputationPhoneNumberListWithReputation]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = reputationPhoneNumberListWithReputation.data.map { it.toMutableList() }
            meta = reputationPhoneNumberListWithReputation.meta
            additionalProperties =
                reputationPhoneNumberListWithReputation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ReputationPhoneNumberListWithReputation].
         *
         ...
         */
        fun build(): ReputationPhoneNumberListWithReputation =
            ReputationPhoneNumberListWithReputation(
     ...
     *   expected type.
     */
    fun validate(): ReputationPhoneNumberListWithReputation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReputationPhoneNumberListWithReputation &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ReputationPhoneNumberListWithReputation{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
