...
private constructor(
    ...
    /**
     * URL for batch completion webhook. Empty string is treated as omitted. SSRF-protected;
     * private/reserved IPs and internal hostnames are rejected.
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchCreateParams: BatchCreateParams) = apply {
            idempotencyKey = batchCreateParams.idempotencyKey
    ...
    private constructor(
        ...
        ) : this(emails, webhookUrl, mutableMapOf())
        ...
        private val hashCode: Int by lazy { Objects.hash(emails, webhookUrl, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{emails=$emails, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "BatchCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
