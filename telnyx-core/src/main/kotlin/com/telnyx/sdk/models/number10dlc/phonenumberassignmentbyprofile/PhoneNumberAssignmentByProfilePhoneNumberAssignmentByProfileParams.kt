 ...
 */
class PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams
private constructor(
    ...
    companion object {
         ...
         * [PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams].
         *
    ...
    /** A builder for [PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body =
                phoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams.body.toBuilder()
            additionalHeaders =
                phoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams.additionalHeaders
                    .toBuilder()
         ...
         */
        fun build(): PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams =
            PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
