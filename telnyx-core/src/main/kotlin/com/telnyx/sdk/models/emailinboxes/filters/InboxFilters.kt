...
private constructor(
     ...
     */
    @JsonProperty("allowlist") @ExcludeMissing fun _allowlist(): JsonField<List<String>> = allowlist
     ...
     */
    @JsonProperty("blocklist") @ExcludeMissing fun _blocklist(): JsonField<List<String>> = blocklist
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InboxFilters].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inboxFilters: InboxFilters) = apply {
            allowlist = inboxFilters.allowlist.map { it.toMutableList() }
            blocklist = inboxFilters.blocklist.map { it.toMutableList() }
            recordType = inboxFilters.recordType
            additionalProperties = inboxFilters.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InboxFilters].
         *
     ...
     *   expected type.
     */
    fun validate(): InboxFilters = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "InboxFilters{allowlist=$allowlist, blocklist=$blocklist, recordType=$recordType, additionalProperties=$additionalProperties}"
}
