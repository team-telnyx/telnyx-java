...
class CallMachinePremiumDetectionEnded
...
private constructor(
    ...
    /** A builder for [CallMachinePremiumDetectionEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callMachinePremiumDetectionEnded: CallMachinePremiumDetectionEnded) =
            apply {
                id = callMachinePremiumDetectionEnded.id
                eventType = callMachinePremiumDetectionEnded.eventType
                occurredAt = callMachinePremiumDetectionEnded.occurredAt
                payload = callMachinePremiumDetectionEnded.payload
                recordType = callMachinePremiumDetectionEnded.recordType
                additionalProperties =
                    callMachinePremiumDetectionEnded.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallMachinePremiumDetectionEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallMachinePremiumDetectionEnded =
            CallMachinePremiumDetectionEnded(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallMachinePremiumDetectionEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CALL_MACHINE_PREMIUM_DETECTION_ENDED = of("call.machine.premium.detection.ended")
        ...
        fun value(): Value =
            when (this) {
                CALL_MACHINE_PREMIUM_DETECTION_ENDED -> Value.CALL_MACHINE_PREMIUM_DETECTION_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_MACHINE_PREMIUM_DETECTION_ENDED -> Known.CALL_MACHINE_PREMIUM_DETECTION_ENDED
    ...
    private constructor(
        ...
        class Result @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val HUMAN_RESIDENCE = of("human_residence")

                @JvmField val HUMAN_BUSINESS = of("human_business")

                @JvmField val MACHINE = of("machine")

                @JvmField val SILENCE = of("silence")

                @JvmField val FAX_DETECTED = of("fax_detected")
            ...
            fun value(): Value =
                when (this) {
                    HUMAN_RESIDENCE -> Value.HUMAN_RESIDENCE
                    HUMAN_BUSINESS -> Value.HUMAN_BUSINESS
                    MACHINE -> Value.MACHINE
                    SILENCE -> Value.SILENCE
                    FAX_DETECTED -> Value.FAX_DETECTED
            ...
            fun known(): Known =
                when (this) {
                    HUMAN_RESIDENCE -> Known.HUMAN_RESIDENCE
                    HUMAN_BUSINESS -> Known.HUMAN_BUSINESS
                    MACHINE -> Known.MACHINE
                    SILENCE -> Known.SILENCE
                    FAX_DETECTED -> Known.FAX_DETECTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallMachinePremiumDetectionEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallMachinePremiumDetectionEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
