...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(connection: Connection) = apply {
            ...
            anchorsiteOverride = connection.anchorsiteOverride
            connectionName = connection.connectionName
            createdAt = connection.createdAt
            outboundVoiceProfileId = connection.outboundVoiceProfileId
            recordType = connection.recordType
            tags = connection.tags.map { it.toMutableList() }
            updatedAt = connection.updatedAt
            webhookApiVersion = connection.webhookApiVersion
            webhookEventFailoverUrl = connection.webhookEventFailoverUrl
            webhookEventUrl = connection.webhookEventUrl
