...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingEventStatusChangedEvent: PortingEventStatusChangedEvent) = apply {
    ...
    private constructor(
        ...
        ) : this(id, customerReference, status, supportKey, updatedAt, webhookUrl, mutableMapOf())
