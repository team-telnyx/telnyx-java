...
private constructor(
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun executionMode(): ExecutionMode = executionMode.getRequired("execution_mode")
        ...
        class Builder internal constructor() {
            ...
            private var executionMode: JsonField<ExecutionMode>? = null
        ...
        override fun toString() =
            "Data{createdAt=$createdAt, executionMode=$executionMode, missionId=$missionId, name=$name, updatedAt=$updatedAt, description=$description, instructions=$instructions, metadata=$metadata, model=$model, additionalProperties=$additionalProperties}"
    }
