...
class NetappsLocation17904fcfbc
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NetappsLocation17904fcfbc].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NetappsLocation17904fcfbc]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(netappsLocation17904fcfbc: NetappsLocation17904fcfbc) = apply {
            code = netappsLocation17904fcfbc.code
            name = netappsLocation17904fcfbc.name
            pop = netappsLocation17904fcfbc.pop
            region = netappsLocation17904fcfbc.region
            site = netappsLocation17904fcfbc.site
            additionalProperties = netappsLocation17904fcfbc.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NetappsLocation17904fcfbc].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NetappsLocation17904fcfbc =
     ...
     *   expected type.
     */
    fun validate(): NetappsLocation17904fcfbc = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NetappsLocation17904fcfbc &&
            code == other.code &&
            name == other.name &&
            pop == other.pop &&
            region == other.region &&
    ...
    override fun toString() =
        "NetappsLocation17904fcfbc{code=$code, name=$name, pop=$pop, region=$region, site=$site, additionalProperties=$additionalProperties}"
}
