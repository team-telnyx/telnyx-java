...
class CampaignRetrieveSharingResponse
...
private constructor(
    ...
    /** A builder for [CampaignRetrieveSharingResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(campaignRetrieveSharingResponse: CampaignRetrieveSharingResponse) =
            apply {
                sharedByMe = campaignRetrieveSharingResponse.sharedByMe
                sharedWithMe = campaignRetrieveSharingResponse.sharedWithMe
                additionalProperties =
                    campaignRetrieveSharingResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CampaignRetrieveSharingResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CampaignRetrieveSharingResponse =
            CampaignRetrieveSharingResponse(
                sharedByMe,
                sharedWithMe,
    ...
    fun validate(): CampaignRetrieveSharingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignRetrieveSharingResponse &&
    ...
    override fun toString() =
        "CampaignRetrieveSharingResponse{sharedByMe=$sharedByMe, sharedWithMe=$sharedWithMe, additionalProperties=$additionalProperties}"
}
