...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingProfileListPageResponse: MessagingProfileListPageResponse) =
            apply {
                data = messagingProfileListPageResponse.data.map { it.toMutableList() }
                meta = messagingProfileListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [MessagingProfileListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingProfileListPageResponse =
            MessagingProfileListPageResponse(
    ...
    fun validate(): MessagingProfileListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingProfileListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "MessagingProfileListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
