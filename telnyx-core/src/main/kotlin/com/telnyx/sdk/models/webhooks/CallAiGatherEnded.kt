...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallAiGatherEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallAiGatherEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callAiGatherEnded: CallAiGatherEnded) = apply {
            id = callAiGatherEnded.id
            eventType = callAiGatherEnded.eventType
            occurredAt = callAiGatherEnded.occurredAt
            payload = callAiGatherEnded.payload
            recordType = callAiGatherEnded.recordType
            additionalProperties = callAiGatherEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallAiGatherEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallAiGatherEnded =
            CallAiGatherEnded(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallAiGatherEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_AI_GATHER_ENDED = of("call.ai_gather.ended")
        ...
        fun value(): Value =
            when (this) {
                CALL_AI_GATHER_ENDED -> Value.CALL_AI_GATHER_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_AI_GATHER_ENDED -> Known.CALL_AI_GATHER_ENDED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, from=$from, messageHistory=$messageHistory, result=$result, status=$status, to=$to, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallAiGatherEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallAiGatherEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
