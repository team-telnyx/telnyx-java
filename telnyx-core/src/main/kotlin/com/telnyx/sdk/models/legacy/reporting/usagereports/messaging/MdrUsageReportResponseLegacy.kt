...
class MdrUsageReportResponseLegacy
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MdrUsageReportResponseLegacy].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MdrUsageReportResponseLegacy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mdrUsageReportResponseLegacy: MdrUsageReportResponseLegacy) = apply {
            id = mdrUsageReportResponseLegacy.id
            aggregationType = mdrUsageReportResponseLegacy.aggregationType
            connections = mdrUsageReportResponseLegacy.connections.map { it.toMutableList() }
            createdAt = mdrUsageReportResponseLegacy.createdAt
            endTime = mdrUsageReportResponseLegacy.endTime
            profiles = mdrUsageReportResponseLegacy.profiles.map { it.toMutableList() }
            recordType = mdrUsageReportResponseLegacy.recordType
            reportUrl = mdrUsageReportResponseLegacy.reportUrl
            result = mdrUsageReportResponseLegacy.result
            startTime = mdrUsageReportResponseLegacy.startTime
            status = mdrUsageReportResponseLegacy.status
            updatedAt = mdrUsageReportResponseLegacy.updatedAt
            additionalProperties = mdrUsageReportResponseLegacy.additionalProperties.toMutableMap()
        }
        ...
        /** Aggregation type: No aggregation = 0, By Messaging Profile = 1, By Tags = 2 */
        fun aggregationType(aggregationType: Int) = aggregationType(JsonField.of(aggregationType))
        ...
        /**
         * Returns an immutable instance of [MdrUsageReportResponseLegacy].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MdrUsageReportResponseLegacy =
    ...
    fun validate(): MdrUsageReportResponseLegacy = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MdrUsageReportResponseLegacy &&
            id == other.id &&
    ...
    override fun toString() =
        "MdrUsageReportResponseLegacy{id=$id, aggregationType=$aggregationType, connections=$connections, createdAt=$createdAt, endTime=$endTime, profiles=$profiles, recordType=$recordType, reportUrl=$reportUrl, result=$result, startTime=$startTime, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
