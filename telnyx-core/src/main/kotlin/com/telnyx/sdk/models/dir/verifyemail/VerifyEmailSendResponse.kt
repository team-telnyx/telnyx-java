...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VerifyEmailSendResponse].
         *
    ...
    /** A builder for [VerifyEmailSendResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verifyEmailSendResponse: VerifyEmailSendResponse) = apply {
            data = verifyEmailSendResponse.data
            additionalProperties = verifyEmailSendResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VerifyEmailSendResponse].
         *
         ...
         */
        fun build(): VerifyEmailSendResponse =
     ...
     *   expected type.
     */
    fun validate(): VerifyEmailSendResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifyEmailSendResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VerifyEmailSendResponse{data=$data, additionalProperties=$additionalProperties}"
}
