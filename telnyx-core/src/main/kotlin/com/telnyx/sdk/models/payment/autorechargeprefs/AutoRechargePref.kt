...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AutoRechargePref]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AutoRechargePref]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(autoRechargePref: AutoRechargePref) = apply {
            id = autoRechargePref.id
            enabled = autoRechargePref.enabled
            invoiceEnabled = autoRechargePref.invoiceEnabled
            preference = autoRechargePref.preference
            rechargeAmount = autoRechargePref.rechargeAmount
            recordType = autoRechargePref.recordType
            thresholdAmount = autoRechargePref.thresholdAmount
            additionalProperties = autoRechargePref.additionalProperties.toMutableMap()
        }
        ...
        fun invoiceEnabled(invoiceEnabled: Boolean) = invoiceEnabled(JsonField.of(invoiceEnabled))
         ...
         * supported value.
         */
        fun preference(preference: JsonField<Preference>) = apply { this.preference = preference }
         ...
         */
        fun rechargeAmount(rechargeAmount: String) = rechargeAmount(JsonField.of(rechargeAmount))
        ...
        /**
         * Returns an immutable instance of [AutoRechargePref].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AutoRechargePref =
            AutoRechargePref(
                id,
                enabled,
                invoiceEnabled,
    ...
    fun validate(): AutoRechargePref = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutoRechargePref &&
            id == other.id &&
    ...
    override fun toString() =
        "AutoRechargePref{id=$id, enabled=$enabled, invoiceEnabled=$invoiceEnabled, preference=$preference, rechargeAmount=$rechargeAmount, recordType=$recordType, thresholdAmount=$thresholdAmount, additionalProperties=$additionalProperties}"
}
