...
class MessagingTollFreeVerificationTfVerificationRequest
...
private constructor(
    ...
    private val entityType: JsonField<MessagingTollFreeVerificationEntityType>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        entityType: JsonField<MessagingTollFreeVerificationEntityType> = JsonMissing.of(),
    ...
    /**
     * Indicates if messaging content requires age gating (e.g., 18+). Defaults to false if not
     * provided.
     *
    ...
    /**
     * ISO 3166-1 alpha-2 country code of the issuing business authority. Must be exactly 2 letters.
     * Automatically converted to uppercase. Required from January 2026.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * Official business registration number (e.g., Employer Identification Number (EIN) in the
     * U.S.). Required from January 2026.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
     ...
     * February 17, 2026. This token is validated by Zipwhip and must be provided for all Political
     * use case verifications after the deadline.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
     ...
     *   server responded with an unexpected value).
     */
    fun entityType(): Optional<MessagingTollFreeVerificationEntityType> =
    ...
    @JsonProperty("entityType")
    @ExcludeMissing
    fun _entityType(): JsonField<MessagingTollFreeVerificationEntityType> = entityType
    ...
    /** A builder for [MessagingTollFreeVerificationTfVerificationRequest]. */
    class Builder internal constructor() {
        ...
        private var entityType: JsonField<MessagingTollFreeVerificationEntityType> =
            JsonMissing.of()
        ...
        internal fun from(
            ...
            additionalInformation =
                messagingTollFreeVerificationTfVerificationRequest.additionalInformation
            businessAddr1 = messagingTollFreeVerificationTfVerificationRequest.businessAddr1
            businessCity = messagingTollFreeVerificationTfVerificationRequest.businessCity
            businessContactEmail =
                messagingTollFreeVerificationTfVerificationRequest.businessContactEmail
            businessContactFirstName =
                messagingTollFreeVerificationTfVerificationRequest.businessContactFirstName
            businessContactLastName =
                messagingTollFreeVerificationTfVerificationRequest.businessContactLastName
            businessContactPhone =
                messagingTollFreeVerificationTfVerificationRequest.businessContactPhone
            businessName = messagingTollFreeVerificationTfVerificationRequest.businessName
            businessState = messagingTollFreeVerificationTfVerificationRequest.businessState
            businessZip = messagingTollFreeVerificationTfVerificationRequest.businessZip
            corporateWebsite = messagingTollFreeVerificationTfVerificationRequest.corporateWebsite
            messageVolume = messagingTollFreeVerificationTfVerificationRequest.messageVolume
            optInWorkflow = messagingTollFreeVerificationTfVerificationRequest.optInWorkflow
            optInWorkflowImageUrls =
                messagingTollFreeVerificationTfVerificationRequest.optInWorkflowImageUrls.map {
                    it.toMutableList()
                }
            phoneNumbers =
                messagingTollFreeVerificationTfVerificationRequest.phoneNumbers.map {
                    it.toMutableList()
                }
            productionMessageContent =
                messagingTollFreeVerificationTfVerificationRequest.productionMessageContent
            useCase = messagingTollFreeVerificationTfVerificationRequest.useCase
            useCaseSummary = messagingTollFreeVerificationTfVerificationRequest.useCaseSummary
            ageGatedContent = messagingTollFreeVerificationTfVerificationRequest.ageGatedContent
            businessAddr2 = messagingTollFreeVerificationTfVerificationRequest.businessAddr2
            businessRegistrationCountry =
                messagingTollFreeVerificationTfVerificationRequest.businessRegistrationCountry
            businessRegistrationNumber =
                messagingTollFreeVerificationTfVerificationRequest.businessRegistrationNumber
            businessRegistrationType =
                messagingTollFreeVerificationTfVerificationRequest.businessRegistrationType
            campaignVerifyAuthorizationToken =
                messagingTollFreeVerificationTfVerificationRequest.campaignVerifyAuthorizationToken
            doingBusinessAs = messagingTollFreeVerificationTfVerificationRequest.doingBusinessAs
            entityType = messagingTollFreeVerificationTfVerificationRequest.entityType
            helpMessageResponse =
                messagingTollFreeVerificationTfVerificationRequest.helpMessageResponse
            isvReseller = messagingTollFreeVerificationTfVerificationRequest.isvReseller
            optInConfirmationResponse =
                messagingTollFreeVerificationTfVerificationRequest.optInConfirmationResponse
            optInKeywords = messagingTollFreeVerificationTfVerificationRequest.optInKeywords
            privacyPolicyUrl = messagingTollFreeVerificationTfVerificationRequest.privacyPolicyUrl
            termsAndConditionUrl =
                messagingTollFreeVerificationTfVerificationRequest.termsAndConditionUrl
            webhookUrl = messagingTollFreeVerificationTfVerificationRequest.webhookUrl
            additionalProperties =
                messagingTollFreeVerificationTfVerificationRequest.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * ISO 3166-1 alpha-2 country code of the issuing business authority. Must be exactly 2
         * letters. Automatically converted to uppercase. Required from January 2026.
         */
        fun businessRegistrationCountry(businessRegistrationCountry: String?) =
            businessRegistrationCountry(JsonField.ofNullable(businessRegistrationCountry))

        /**
         * Alias for calling [Builder.businessRegistrationCountry] with
         * `businessRegistrationCountry.orElse(null)`.
         */
        fun businessRegistrationCountry(businessRegistrationCountry: Optional<String>) =
            businessRegistrationCountry(businessRegistrationCountry.getOrNull())
        ...
        fun businessRegistrationNumber(businessRegistrationNumber: String?) =
            businessRegistrationNumber(JsonField.ofNullable(businessRegistrationNumber))

        /**
         * Alias for calling [Builder.businessRegistrationNumber] with
         * `businessRegistrationNumber.orElse(null)`.
         */
        fun businessRegistrationNumber(businessRegistrationNumber: Optional<String>) =
            businessRegistrationNumber(businessRegistrationNumber.getOrNull())
        ...
        fun businessRegistrationType(businessRegistrationType: String?) =
            businessRegistrationType(JsonField.ofNullable(businessRegistrationType))

        /**
         * Alias for calling [Builder.businessRegistrationType] with
         * `businessRegistrationType.orElse(null)`.
         */
        fun businessRegistrationType(businessRegistrationType: Optional<String>) =
            businessRegistrationType(businessRegistrationType.getOrNull())
        ...
        /**
         * Campaign Verify Authorization Token required for Political use case submissions starting
         * February 17, 2026. This token is validated by Zipwhip and must be provided for all
         * Political use case verifications after the deadline.
         */
        ...
        /** Business entity classification */
        fun entityType(entityType: MessagingTollFreeVerificationEntityType?) =
            entityType(JsonField.ofNullable(entityType))

        /** Alias for calling [Builder.entityType] with `entityType.orElse(null)`. */
        fun entityType(entityType: Optional<MessagingTollFreeVerificationEntityType>) =
         ...
         * [MessagingTollFreeVerificationEntityType] value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun entityType(entityType: JsonField<MessagingTollFreeVerificationEntityType>) = apply {
            this.entityType = entityType
        }

        /** The message returned when users text 'HELP' */
        fun helpMessageResponse(helpMessageResponse: String?) =
            helpMessageResponse(JsonField.ofNullable(helpMessageResponse))

        /**
         * Alias for calling [Builder.helpMessageResponse] with `helpMessageResponse.orElse(null)`.
         */
        fun helpMessageResponse(helpMessageResponse: Optional<String>) =
            helpMessageResponse(helpMessageResponse.getOrNull())
        ...
        /**
         * Alias for calling [Builder.optInConfirmationResponse] with
         * `optInConfirmationResponse.orElse(null)`.
         */
        fun optInConfirmationResponse(optInConfirmationResponse: Optional<String>) =
            optInConfirmationResponse(optInConfirmationResponse.getOrNull())
        ...
        fun privacyPolicyUrl(privacyPolicyUrl: String?) =
            privacyPolicyUrl(JsonField.ofNullable(privacyPolicyUrl))

        /** Alias for calling [Builder.privacyPolicyUrl] with `privacyPolicyUrl.orElse(null)`. */
        fun privacyPolicyUrl(privacyPolicyUrl: Optional<String>) =
            privacyPolicyUrl(privacyPolicyUrl.getOrNull())
        ...
        fun termsAndConditionUrl(termsAndConditionUrl: String?) =
            termsAndConditionUrl(JsonField.ofNullable(termsAndConditionUrl))

        /**
         * Alias for calling [Builder.termsAndConditionUrl] with
         * `termsAndConditionUrl.orElse(null)`.
         */
        fun termsAndConditionUrl(termsAndConditionUrl: Optional<String>) =
            termsAndConditionUrl(termsAndConditionUrl.getOrNull())
        ...
        /**
         * Returns an immutable instance of [MessagingTollFreeVerificationTfVerificationRequest].
         *
         ...
         */
        fun build(): MessagingTollFreeVerificationTfVerificationRequest =
            MessagingTollFreeVerificationTfVerificationRequest(
     ...
     *   expected type.
     */
    fun validate(): MessagingTollFreeVerificationTfVerificationRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingTollFreeVerificationTfVerificationRequest &&
