...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TelephonyCredentialUpdateParams = builder().build()
    ...
    /** A builder for [TelephonyCredentialUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(telephonyCredentialUpdateParams: TelephonyCredentialUpdateParams) =
            apply {
                id = telephonyCredentialUpdateParams.id
                body = telephonyCredentialUpdateParams.body.toBuilder()
                additionalHeaders = telephonyCredentialUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    telephonyCredentialUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TelephonyCredentialUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TelephonyCredentialUpdateParams =
            TelephonyCredentialUpdateParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(connectionId, expiresAt, name, tag, additionalProperties.toMutableMap())
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TelephonyCredentialUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "TelephonyCredentialUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
