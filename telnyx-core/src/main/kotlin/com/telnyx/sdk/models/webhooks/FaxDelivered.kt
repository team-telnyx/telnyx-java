...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FaxDelivered]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FaxDelivered]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxDelivered: FaxDelivered) = apply {
            data = faxDelivered.data
            meta = faxDelivered.meta
            additionalProperties = faxDelivered.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxDelivered].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxDelivered = FaxDelivered(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): FaxDelivered = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "FaxDelivered{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
