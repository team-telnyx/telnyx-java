...
private constructor(
    ...
    /**
     * Consolidated filter parameter (deepObject style). Originally: filter[report_type],
     * filter[status]
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reportListParams: ReportListParams) = apply {
            ...
            pageNumber = reportListParams.pageNumber
            pageSize = reportListParams.pageSize
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                filter?.let {
                    it.reportType().ifPresent { put("filter[report_type]", it.toString()) }
    ...
    private constructor(
        ...
        fun reportType(): Optional<ReportType> = Optional.ofNullable(reportType)
        ...
        class Builder internal constructor() {
            ...
            /** Filter reports of a specific type */
            fun reportType(reportType: ReportType?) = apply { this.reportType = reportType }

            /** Alias for calling [Builder.reportType] with `reportType.orElse(null)`. */
            fun reportType(reportType: Optional<ReportType>) = reportType(reportType.getOrNull())
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Filter = Filter(reportType, status, additionalProperties.build())
        }

        /** Filter reports of a specific type */
        class ReportType @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            enum class Value {
                EXPORT_PORTING_ORDERS_CSV,
                /**
                 * An enum member indicating that [ReportType] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
        ...
        private val hashCode: Int by lazy { Objects.hash(reportType, status, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{reportType=$reportType, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ReportListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
