...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OffsetPaginationMeta].
         *
    ...
    /** A builder for [OffsetPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(offsetPaginationMeta: OffsetPaginationMeta) = apply {
            pageNumber = offsetPaginationMeta.pageNumber
            pageSize = offsetPaginationMeta.pageSize
            totalPages = offsetPaginationMeta.totalPages
            totalResults = offsetPaginationMeta.totalResults
            additionalProperties = offsetPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OffsetPaginationMeta].
         *
         ...
         */
        fun build(): OffsetPaginationMeta =
     ...
     *   expected type.
     */
    fun validate(): OffsetPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OffsetPaginationMeta &&
    ...
    override fun toString() =
        "OffsetPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
