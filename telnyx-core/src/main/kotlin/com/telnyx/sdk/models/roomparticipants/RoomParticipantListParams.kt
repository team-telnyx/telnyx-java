...
/**
 * Returns a paginated list of room participants across sessions. Filter participants by session,
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(roomParticipantListParams: RoomParticipantListParams) = apply {
            ...
            pageNumber = roomParticipantListParams.pageNumber
            pageSize = roomParticipantListParams.pageSize
    ...
    override fun toString() =
        "RoomParticipantListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
