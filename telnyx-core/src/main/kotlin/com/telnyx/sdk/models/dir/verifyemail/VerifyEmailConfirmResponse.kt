...
class VerifyEmailConfirmResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VerifyEmailConfirmResponse].
         *
    ...
    /** A builder for [VerifyEmailConfirmResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verifyEmailConfirmResponse: VerifyEmailConfirmResponse) = apply {
            data = verifyEmailConfirmResponse.data
            additionalProperties = verifyEmailConfirmResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VerifyEmailConfirmResponse].
         *
         ...
         */
        fun build(): VerifyEmailConfirmResponse =
     ...
     *   expected type.
     */
    fun validate(): VerifyEmailConfirmResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifyEmailConfirmResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VerifyEmailConfirmResponse{data=$data, additionalProperties=$additionalProperties}"
}
