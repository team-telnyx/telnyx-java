...
private constructor(
    ...
    private val records: JsonField<List<CampaignListResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        records: JsonField<List<CampaignListResponse>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun records(): Optional<List<CampaignListResponse>> = records.getOptional("records")
    ...
    @JsonProperty("records")
    @ExcludeMissing
    fun _records(): JsonField<List<CampaignListResponse>> = records
    ...
    class Builder internal constructor() {
        ...
        private var records: JsonField<MutableList<CampaignListResponse>>? = null
        ...
        internal fun from(campaignListPageResponse: CampaignListPageResponse) = apply {
            page = campaignListPageResponse.page
            records = campaignListPageResponse.records.map { it.toMutableList() }
            totalRecords = campaignListPageResponse.totalRecords
        ...
        fun records(records: List<CampaignListResponse>) = records(JsonField.of(records))

        /**
         * Sets [Builder.records] to an arbitrary JSON value.
         *
         * You should usually call [Builder.records] with a well-typed `List<CampaignListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun records(records: JsonField<List<CampaignListResponse>>) = apply {
            this.records = records.map { it.toMutableList() }
        }

        /**
         * Adds a single [CampaignListResponse] to [records].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRecord(record: CampaignListResponse) = apply {
            records =
    ...
    override fun toString() =
        "CampaignListPageResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
