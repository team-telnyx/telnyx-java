...
private constructor(
     ...
     *
     * Unlike [simCardCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("sim_card_count")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(simCardGroupListResponse: SimCardGroupListResponse) = apply {
            id = simCardGroupListResponse.id
            consumedData = simCardGroupListResponse.consumedData
            createdAt = simCardGroupListResponse.createdAt
            dataLimit = simCardGroupListResponse.dataLimit
            isDefault = simCardGroupListResponse.isDefault
            name = simCardGroupListResponse.name
            privateWirelessGatewayId = simCardGroupListResponse.privateWirelessGatewayId
            recordType = simCardGroupListResponse.recordType
            simCardCount = simCardGroupListResponse.simCardCount
            updatedAt = simCardGroupListResponse.updatedAt
            wirelessBlocklistId = simCardGroupListResponse.wirelessBlocklistId
         ...
         *
         * You should usually call [Builder.simCardCount] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun simCardCount(simCardCount: JsonField<Long>) = apply { this.simCardCount = simCardCount }
    ...
    override fun toString() =
        "SimCardGroupListResponse{id=$id, consumedData=$consumedData, createdAt=$createdAt, dataLimit=$dataLimit, isDefault=$isDefault, name=$name, privateWirelessGatewayId=$privateWirelessGatewayId, recordType=$recordType, simCardCount=$simCardCount, updatedAt=$updatedAt, wirelessBlocklistId=$wirelessBlocklistId, additionalProperties=$additionalProperties}"
}
