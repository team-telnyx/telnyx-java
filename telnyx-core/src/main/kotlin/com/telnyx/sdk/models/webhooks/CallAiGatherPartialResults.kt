...
class CallAiGatherPartialResults
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallAiGatherPartialResults].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallAiGatherPartialResults]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callAiGatherPartialResults: CallAiGatherPartialResults) = apply {
            id = callAiGatherPartialResults.id
            eventType = callAiGatherPartialResults.eventType
            occurredAt = callAiGatherPartialResults.occurredAt
            payload = callAiGatherPartialResults.payload
            recordType = callAiGatherPartialResults.recordType
            additionalProperties = callAiGatherPartialResults.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallAiGatherPartialResults].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallAiGatherPartialResults =
    ...
    fun validate(): CallAiGatherPartialResults = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_AI_GATHER_PARTIAL_RESULTS = of("call.ai_gather.partial_results")
        ...
        fun value(): Value =
            when (this) {
                CALL_AI_GATHER_PARTIAL_RESULTS -> Value.CALL_AI_GATHER_PARTIAL_RESULTS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_AI_GATHER_PARTIAL_RESULTS -> Known.CALL_AI_GATHER_PARTIAL_RESULTS
    ...
    private constructor(
        ...
        /**
         * The partial result of the AI gather, its type depends of the `parameters` provided in the
         * command
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         ...
         *
         * Unlike [partialResults], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("partial_results")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.partialResults] with a well-typed [PartialResults]
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is PartialResults && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PartialResults{additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, from=$from, messageHistory=$messageHistory, partialResults=$partialResults, to=$to, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallAiGatherPartialResults &&
            id == other.id &&
    ...
    override fun toString() =
        "CallAiGatherPartialResults{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
