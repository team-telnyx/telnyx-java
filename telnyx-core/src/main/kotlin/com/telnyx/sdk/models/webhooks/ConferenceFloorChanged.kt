...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferenceFloorChanged]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceFloorChanged]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceFloorChanged: ConferenceFloorChanged) = apply {
            id = conferenceFloorChanged.id
            eventType = conferenceFloorChanged.eventType
            payload = conferenceFloorChanged.payload
            recordType = conferenceFloorChanged.recordType
            additionalProperties = conferenceFloorChanged.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceFloorChanged].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceFloorChanged =
    ...
    fun validate(): ConferenceFloorChanged = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceFloorChanged &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceFloorChanged{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
