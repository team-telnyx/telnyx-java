...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SettingUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SettingUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(settingUpdateResponse: SettingUpdateResponse) = apply {
            data = settingUpdateResponse.data
            additionalProperties = settingUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SettingUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SettingUpdateResponse =
            SettingUpdateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): SettingUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [webhookEnabled], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("webhook_enabled")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                webhookEvents = data.webhookEvents.map { it.toMutableList() }
                webhookFailoverUrl = data.webhookFailoverUrl
            ...
            /** Enable/disable receiving Whatsapp events */
            fun webhookEnabled(webhookEnabled: Boolean) =
                webhookEnabled(JsonField.of(webhookEnabled))
        ...
        override fun toString() =
            "Data{id=$id, name=$name, recordType=$recordType, timezone=$timezone, updatedAt=$updatedAt, webhookEnabled=$webhookEnabled, webhookEvents=$webhookEvents, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SettingUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SettingUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
