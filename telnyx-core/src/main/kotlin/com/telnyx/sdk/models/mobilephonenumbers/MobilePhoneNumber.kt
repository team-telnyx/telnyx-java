...
private constructor(
     ...
     *
     * Unlike [mobileVoiceEnabled], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("mobile_voice_enabled")
    @ExcludeMissing
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MobilePhoneNumber]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MobilePhoneNumber]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mobilePhoneNumber: MobilePhoneNumber) = apply {
            id = mobilePhoneNumber.id
            callForwarding = mobilePhoneNumber.callForwarding
            callRecording = mobilePhoneNumber.callRecording
            callerIdNameEnabled = mobilePhoneNumber.callerIdNameEnabled
            cnamListing = mobilePhoneNumber.cnamListing
            connectionId = mobilePhoneNumber.connectionId
            connectionName = mobilePhoneNumber.connectionName
            connectionType = mobilePhoneNumber.connectionType
            countryIsoAlpha2 = mobilePhoneNumber.countryIsoAlpha2
            createdAt = mobilePhoneNumber.createdAt
            customerReference = mobilePhoneNumber.customerReference
            inbound = mobilePhoneNumber.inbound
            inboundCallScreening = mobilePhoneNumber.inboundCallScreening
            mobileVoiceEnabled = mobilePhoneNumber.mobileVoiceEnabled
            noiseSuppression = mobilePhoneNumber.noiseSuppression
            outbound = mobilePhoneNumber.outbound
            phoneNumber = mobilePhoneNumber.phoneNumber
            recordType = mobilePhoneNumber.recordType
            simCardId = mobilePhoneNumber.simCardId
            status = mobilePhoneNumber.status
            tags = mobilePhoneNumber.tags.map { it.toMutableList() }
            updatedAt = mobilePhoneNumber.updatedAt
            additionalProperties = mobilePhoneNumber.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.mobileVoiceEnabled] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [MobilePhoneNumber].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobilePhoneNumber =
            MobilePhoneNumber(
                id,
                callForwarding,
                callRecording,
    ...
    fun validate(): MobilePhoneNumber = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Inbound =
                Inbound(interceptionAppId, interceptionAppName, additionalProperties.toMutableMap())
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobilePhoneNumber &&
            id == other.id &&
