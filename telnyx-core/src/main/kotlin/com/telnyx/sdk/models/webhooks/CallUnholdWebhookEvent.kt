...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallUnholdWebhookEvent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallUnholdWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callUnholdWebhookEvent: CallUnholdWebhookEvent) = apply {
            data = callUnholdWebhookEvent.data
            additionalProperties = callUnholdWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallUnholdWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallUnholdWebhookEvent =
            CallUnholdWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallUnholdWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_UNHOLD = of("call.unhold")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallUnholdWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallUnholdWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
