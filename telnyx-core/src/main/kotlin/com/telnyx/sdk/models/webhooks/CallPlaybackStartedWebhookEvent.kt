...
class CallPlaybackStartedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CallPlaybackStartedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callPlaybackStartedWebhookEvent: CallPlaybackStartedWebhookEvent) =
            apply {
                data = callPlaybackStartedWebhookEvent.data
                additionalProperties =
                    callPlaybackStartedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallPlaybackStartedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallPlaybackStartedWebhookEvent =
            CallPlaybackStartedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallPlaybackStartedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallPlaybackStartedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallPlaybackStartedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
