...
/**
 * Create verification codes to validate numbers of the hosted order. The verification codes will be
 * sent to the numbers of the hosted order.
 */
class MessagingHostedNumberOrderCreateVerificationCodesParams
private constructor(
    ...
    /** A builder for [MessagingHostedNumberOrderCreateVerificationCodesParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = messagingHostedNumberOrderCreateVerificationCodesParams.id
            body = messagingHostedNumberOrderCreateVerificationCodesParams.body.toBuilder()
            additionalHeaders =
                messagingHostedNumberOrderCreateVerificationCodesParams.additionalHeaders
                    .toBuilder()
            additionalQueryParams =
                messagingHostedNumberOrderCreateVerificationCodesParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): MessagingHostedNumberOrderCreateVerificationCodesParams =
            MessagingHostedNumberOrderCreateVerificationCodesParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        ) : this(phoneNumbers, verificationMethod, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(phoneNumbers, verificationMethod, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{phoneNumbers=$phoneNumbers, verificationMethod=$verificationMethod, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingHostedNumberOrderCreateVerificationCodesParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "MessagingHostedNumberOrderCreateVerificationCodesParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
