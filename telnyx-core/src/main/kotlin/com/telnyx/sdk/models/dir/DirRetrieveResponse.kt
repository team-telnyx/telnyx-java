...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirRetrieveResponse].
         *
    ...
    /** A builder for [DirRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirRetrieveResponse: DirRetrieveResponse) = apply {
            data = dirRetrieveResponse.data
            additionalProperties = dirRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirRetrieveResponse].
         *
         ...
         */
        fun build(): DirRetrieveResponse =
            DirRetrieveResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): DirRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DirRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
