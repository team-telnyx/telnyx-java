...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebhookPortoutStatusChanged].
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookPortoutStatusChanged: WebhookPortoutStatusChanged) = apply {
            ...
            availableNotificationMethods =
                webhookPortoutStatusChanged.availableNotificationMethods.map { it.toMutableList() }
            ...
            additionalProperties = webhookPortoutStatusChanged.additionalProperties.toMutableMap()
        }
    ...
    private constructor(
         ...
         *
         * Unlike [subscriberName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("subscriber_name")
        @ExcludeMissing
