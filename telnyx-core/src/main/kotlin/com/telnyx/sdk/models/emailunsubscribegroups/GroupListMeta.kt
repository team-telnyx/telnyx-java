...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GroupListMeta].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(groupListMeta: GroupListMeta) = apply {
            pageNumber = groupListMeta.pageNumber
            pageSize = groupListMeta.pageSize
            totalPages = groupListMeta.totalPages
            totalResults = groupListMeta.totalResults
            additionalProperties = groupListMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GroupListMeta].
         *
     ...
     *   expected type.
     */
    fun validate(): GroupListMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "GroupListMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
