...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FuncRetrieveLogsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FuncRetrieveLogsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FuncRetrieveLogsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(funcRetrieveLogsParams: FuncRetrieveLogsParams) = apply {
            id = funcRetrieveLogsParams.id
            endTime = funcRetrieveLogsParams.endTime
            limit = funcRetrieveLogsParams.limit
            startTime = funcRetrieveLogsParams.startTime
            type = funcRetrieveLogsParams.type
            additionalHeaders = funcRetrieveLogsParams.additionalHeaders.toBuilder()
            additionalQueryParams = funcRetrieveLogsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FuncRetrieveLogsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FuncRetrieveLogsParams =
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val RUNTIME = of("runtime")

            @JvmField val INVOCATIONS = of("invocations")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FuncRetrieveLogsParams &&
            id == other.id &&
    ...
    override fun hashCode(): Int =
        Objects.hash(id, endTime, limit, startTime, type, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "FuncRetrieveLogsParams{id=$id, endTime=$endTime, limit=$limit, startTime=$startTime, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
