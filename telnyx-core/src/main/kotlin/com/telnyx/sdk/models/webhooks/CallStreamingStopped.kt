...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallStreamingStopped]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallStreamingStopped]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callStreamingStopped: CallStreamingStopped) = apply {
            id = callStreamingStopped.id
            eventType = callStreamingStopped.eventType
            occurredAt = callStreamingStopped.occurredAt
            payload = callStreamingStopped.payload
            recordType = callStreamingStopped.recordType
            additionalProperties = callStreamingStopped.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallStreamingStopped].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallStreamingStopped =
    ...
    fun validate(): CallStreamingStopped = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val STREAMING_STOPPED = of("streaming.stopped")
        ...
        fun value(): Value =
            when (this) {
                STREAMING_STOPPED -> Value.STREAMING_STOPPED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                STREAMING_STOPPED -> Known.STREAMING_STOPPED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallStreamingStopped &&
            id == other.id &&
    ...
    override fun toString() =
        "CallStreamingStopped{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
