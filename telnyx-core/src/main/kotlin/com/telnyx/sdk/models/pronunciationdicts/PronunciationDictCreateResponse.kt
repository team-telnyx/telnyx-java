...
class PronunciationDictCreateResponse
...
private constructor(
    ...
    /** A builder for [PronunciationDictCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pronunciationDictCreateResponse: PronunciationDictCreateResponse) =
            apply {
                data = pronunciationDictCreateResponse.data
                additionalProperties =
                    pronunciationDictCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PronunciationDictCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PronunciationDictCreateResponse =
            PronunciationDictCreateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PronunciationDictCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PronunciationDictCreateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PronunciationDictCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
