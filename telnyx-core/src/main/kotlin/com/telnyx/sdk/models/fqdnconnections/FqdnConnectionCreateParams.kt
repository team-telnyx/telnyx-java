...
private constructor(
    ...
    /**
     * When enabled, the connection will be created for Microsoft Teams Direct Routing. A
     * *.mstsbc.telnyx.tech FQDN will be created for the connection automatically.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun microsoftTeamsSbc(): Optional<Boolean> = body.microsoftTeamsSbc()
     ...
     * type.
     */
    fun _microsoftTeamsSbc(): JsonField<Boolean> = body._microsoftTeamsSbc()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FqdnConnectionCreateParams].
         *
    ...
    /** A builder for [FqdnConnectionCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fqdnConnectionCreateParams: FqdnConnectionCreateParams) = apply {
            body = fqdnConnectionCreateParams.body.toBuilder()
            additionalHeaders = fqdnConnectionCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = fqdnConnectionCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * *.mstsbc.telnyx.tech FQDN will be created for the connection automatically.
         */
        fun microsoftTeamsSbc(microsoftTeamsSbc: Boolean) = apply {
            body.microsoftTeamsSbc(microsoftTeamsSbc)
        }
        ...
        /**
         * Returns an immutable instance of [FqdnConnectionCreateParams].
         *
         ...
         */
        fun build(): FqdnConnectionCreateParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                microsoftTeamsSbc = body.microsoftTeamsSbc
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FqdnConnectionCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FqdnConnectionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
