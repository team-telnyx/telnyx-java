...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolCreateResponse: ToolCreateResponse) = apply {
            id = toolCreateResponse.id
            toolDefinition = toolCreateResponse.toolDefinition
            type = toolCreateResponse.type
            createdAt = toolCreateResponse.createdAt
            displayName = toolCreateResponse.displayName
            timeoutMs = toolCreateResponse.timeoutMs
    ...
    override fun toString() =
        "ToolCreateResponse{id=$id, toolDefinition=$toolDefinition, type=$type, createdAt=$createdAt, displayName=$displayName, timeoutMs=$timeoutMs, additionalProperties=$additionalProperties}"
}
