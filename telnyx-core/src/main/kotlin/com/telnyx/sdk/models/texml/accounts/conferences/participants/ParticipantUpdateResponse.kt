...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParticipantUpdateResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ParticipantUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(participantUpdateResponse: ParticipantUpdateResponse) = apply {
            accountSid = participantUpdateResponse.accountSid
            apiVersion = participantUpdateResponse.apiVersion
            callSid = participantUpdateResponse.callSid
            callSidLegacy = participantUpdateResponse.callSidLegacy
            coaching = participantUpdateResponse.coaching
            coachingCallSid = participantUpdateResponse.coachingCallSid
            coachingCallSidLegacy = participantUpdateResponse.coachingCallSidLegacy
            conferenceSid = participantUpdateResponse.conferenceSid
            dateCreated = participantUpdateResponse.dateCreated
            dateUpdated = participantUpdateResponse.dateUpdated
            endConferenceOnExit = participantUpdateResponse.endConferenceOnExit
            hold = participantUpdateResponse.hold
            muted = participantUpdateResponse.muted
            status = participantUpdateResponse.status
            uri = participantUpdateResponse.uri
            additionalProperties = participantUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipantUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ParticipantUpdateResponse =
    ...
    fun validate(): ParticipantUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipantUpdateResponse &&
