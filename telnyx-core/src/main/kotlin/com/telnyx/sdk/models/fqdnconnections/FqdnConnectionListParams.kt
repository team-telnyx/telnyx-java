...
class FqdnConnectionListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FqdnConnectionListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FqdnConnectionListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FqdnConnectionListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fqdnConnectionListParams: FqdnConnectionListParams) = apply {
            filter = fqdnConnectionListParams.filter
            pageNumber = fqdnConnectionListParams.pageNumber
            pageSize = fqdnConnectionListParams.pageSize
            sort = fqdnConnectionListParams.sort
            additionalHeaders = fqdnConnectionListParams.additionalHeaders.toBuilder()
            additionalQueryParams = fqdnConnectionListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FqdnConnectionListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FqdnConnectionListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FqdnConnectionListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "FqdnConnectionListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
