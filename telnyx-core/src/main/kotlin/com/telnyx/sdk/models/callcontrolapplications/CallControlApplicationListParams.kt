...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callControlApplicationListParams: CallControlApplicationListParams) =
            apply {
                ...
                pageNumber = callControlApplicationListParams.pageNumber
                pageSize = callControlApplicationListParams.pageSize
    ...
    override fun toString() =
        "CallControlApplicationListParams{filter=$filter, page=$page, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
