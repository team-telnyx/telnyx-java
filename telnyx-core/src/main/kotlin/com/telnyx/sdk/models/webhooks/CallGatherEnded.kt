...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallGatherEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallGatherEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callGatherEnded: CallGatherEnded) = apply {
            id = callGatherEnded.id
            eventType = callGatherEnded.eventType
            occurredAt = callGatherEnded.occurredAt
            payload = callGatherEnded.payload
            recordType = callGatherEnded.recordType
            additionalProperties = callGatherEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallGatherEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallGatherEnded =
            CallGatherEnded(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallGatherEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallGatherEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallGatherEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
