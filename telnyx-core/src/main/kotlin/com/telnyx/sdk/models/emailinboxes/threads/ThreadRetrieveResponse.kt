...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(threadRetrieveResponse: ThreadRetrieveResponse) = apply {
            data = threadRetrieveResponse.data
            meta = threadRetrieveResponse.meta
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadRetrieveResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ThreadRetrieveResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
