...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallReferCompleted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallReferCompleted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callReferCompleted: CallReferCompleted) = apply {
            id = callReferCompleted.id
            eventType = callReferCompleted.eventType
            occurredAt = callReferCompleted.occurredAt
            payload = callReferCompleted.payload
            recordType = callReferCompleted.recordType
            additionalProperties = callReferCompleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallReferCompleted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallReferCompleted =
            CallReferCompleted(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallReferCompleted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_REFER_COMPLETED = of("call.refer.completed")
        ...
        fun value(): Value =
            when (this) {
                CALL_REFER_COMPLETED -> Value.CALL_REFER_COMPLETED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_REFER_COMPLETED -> Known.CALL_REFER_COMPLETED
    ...
    private constructor(
        ...
        private val sipNotifyResponse: JsonField<Long>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            sipNotifyResponse: JsonField<Long> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun sipNotifyResponse(): Optional<Long> =
            sipNotifyResponse.getOptional("sip_notify_response")
        ...
        /**
         * Returns the raw JSON value of [sipNotifyResponse].
         *
         * Unlike [sipNotifyResponse], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("sip_notify_response")
        @ExcludeMissing
        fun _sipNotifyResponse(): JsonField<Long> = sipNotifyResponse
        ...
        class Builder internal constructor() {
            ...
            private var sipNotifyResponse: JsonField<Long> = JsonMissing.of()
            ...
            internal fun from(payload: Payload) = apply {
                ...
                from = payload.from
                sipNotifyResponse = payload.sipNotifyResponse
                to = payload.to
            ...
            /** SIP NOTIFY event status for tracking the REFER attempt. */
            fun sipNotifyResponse(sipNotifyResponse: Long) =
                sipNotifyResponse(JsonField.of(sipNotifyResponse))

            /**
             * Sets [Builder.sipNotifyResponse] to an arbitrary JSON value.
             *
             * You should usually call [Builder.sipNotifyResponse] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sipNotifyResponse(sipNotifyResponse: JsonField<Long>) = apply {
        ...
        internal fun validity(): Int =
            (if (callControlId.asKnown().isPresent) 1 else 0) +
                ...
                (if (sipNotifyResponse.asKnown().isPresent) 1 else 0) +
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Payload &&
                ...
                from == other.from &&
                sipNotifyResponse == other.sipNotifyResponse &&
                to == other.to &&
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, from=$from, sipNotifyResponse=$sipNotifyResponse, to=$to, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReferCompleted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallReferCompleted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
