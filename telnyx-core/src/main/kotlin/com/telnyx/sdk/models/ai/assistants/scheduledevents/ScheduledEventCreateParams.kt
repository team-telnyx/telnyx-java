...
private constructor(
     ...
     */
    fun callSettings(): Optional<ScheduledCallSettings> = body.callSettings()
     ...
     */
    fun _callSettings(): JsonField<ScheduledCallSettings> = body._callSettings()
    ...
    class Builder internal constructor() {
         ...
         */
        fun callSettings(callSettings: ScheduledCallSettings) = apply {
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun callSettings(): Optional<ScheduledCallSettings> =
            callSettings.getOptional("call_settings")
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.callSettings] to an arbitrary JSON value.
             *
             * You should usually call [Builder.callSettings] with a well-typed
             * [ScheduledCallSettings] value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun callSettings(callSettings: JsonField<ScheduledCallSettings>) = apply {
