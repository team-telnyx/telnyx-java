...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WirelessError].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(wirelessError: WirelessError) = apply {
            code = wirelessError.code
            title = wirelessError.title
            detail = wirelessError.detail
            meta = wirelessError.meta
            source = wirelessError.source
            additionalProperties = wirelessError.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WirelessError].
         *
    ...
    fun validate(): WirelessError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "WirelessError{code=$code, title=$title, detail=$detail, meta=$meta, source=$source, additionalProperties=$additionalProperties}"
}
