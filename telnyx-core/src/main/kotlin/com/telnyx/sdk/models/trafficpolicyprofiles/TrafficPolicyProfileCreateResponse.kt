...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("limit_bw_kbps")
        @ExcludeMissing
        fun _limitBwKbps(): JsonField<Long> = limitBwKbps
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                domains = data.domains.map { it.toMutableList() }
                ipRanges = data.ipRanges.map { it.toMutableList() }
                limitBwKbps = data.limitBwKbps
                recordType = data.recordType
                services = data.services.map { it.toMutableList() }
                type = data.type
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, domains=$domains, ipRanges=$ipRanges, limitBwKbps=$limitBwKbps, recordType=$recordType, services=$services, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
