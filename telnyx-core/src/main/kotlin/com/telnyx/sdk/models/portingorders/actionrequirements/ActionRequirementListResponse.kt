...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(actionRequirementListResponse: ActionRequirementListResponse) = apply {
            id = actionRequirementListResponse.id
            actionType = actionRequirementListResponse.actionType
            actionUrl = actionRequirementListResponse.actionUrl
            cancelReason = actionRequirementListResponse.cancelReason
            createdAt = actionRequirementListResponse.createdAt
            portingOrderId = actionRequirementListResponse.portingOrderId
            recordType = actionRequirementListResponse.recordType
            requirementTypeId = actionRequirementListResponse.requirementTypeId
            status = actionRequirementListResponse.status
            updatedAt = actionRequirementListResponse.updatedAt
    ...
    override fun toString() =
        "ActionRequirementListResponse{id=$id, actionType=$actionType, actionUrl=$actionUrl, cancelReason=$cancelReason, createdAt=$createdAt, portingOrderId=$portingOrderId, recordType=$recordType, requirementTypeId=$requirementTypeId, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
