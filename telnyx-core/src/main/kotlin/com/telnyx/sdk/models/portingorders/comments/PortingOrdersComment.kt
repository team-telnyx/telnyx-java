...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PortingOrdersComment]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingOrdersComment]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingOrdersComment: PortingOrdersComment) = apply {
            id = portingOrdersComment.id
            body = portingOrdersComment.body
            createdAt = portingOrdersComment.createdAt
            portingOrderId = portingOrdersComment.portingOrderId
            recordType = portingOrdersComment.recordType
            userType = portingOrdersComment.userType
            additionalProperties = portingOrdersComment.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortingOrdersComment].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingOrdersComment =
     ...
     *   expected type.
     */
    fun validate(): PortingOrdersComment = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingOrdersComment &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "PortingOrdersComment{id=$id, body=$body, createdAt=$createdAt, portingOrderId=$portingOrderId, recordType=$recordType, userType=$userType, additionalProperties=$additionalProperties}"
}
