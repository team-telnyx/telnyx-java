...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallStreamingStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallStreamingStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callStreamingStarted: CallStreamingStarted) = apply {
            id = callStreamingStarted.id
            eventType = callStreamingStarted.eventType
            occurredAt = callStreamingStarted.occurredAt
            payload = callStreamingStarted.payload
            recordType = callStreamingStarted.recordType
            additionalProperties = callStreamingStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallStreamingStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallStreamingStarted =
    ...
    fun validate(): CallStreamingStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val STREAMING_STARTED = of("streaming.started")
        ...
        fun value(): Value =
            when (this) {
                STREAMING_STARTED -> Value.STREAMING_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                STREAMING_STARTED -> Known.STREAMING_STARTED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, streamUrl=$streamUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallStreamingStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallStreamingStarted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
