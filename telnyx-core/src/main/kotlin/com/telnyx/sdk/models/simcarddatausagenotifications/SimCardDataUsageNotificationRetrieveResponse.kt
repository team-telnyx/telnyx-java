...
class SimCardDataUsageNotificationRetrieveResponse
...
private constructor(
    ...
    /** A builder for [SimCardDataUsageNotificationRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = simCardDataUsageNotificationRetrieveResponse.data
            additionalProperties =
                simCardDataUsageNotificationRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SimCardDataUsageNotificationRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SimCardDataUsageNotificationRetrieveResponse =
            SimCardDataUsageNotificationRetrieveResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): SimCardDataUsageNotificationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimCardDataUsageNotificationRetrieveResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SimCardDataUsageNotificationRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
