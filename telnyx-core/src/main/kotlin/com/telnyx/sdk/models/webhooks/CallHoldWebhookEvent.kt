...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallHoldWebhookEvent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallHoldWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callHoldWebhookEvent: CallHoldWebhookEvent) = apply {
            data = callHoldWebhookEvent.data
            additionalProperties = callHoldWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallHoldWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallHoldWebhookEvent =
            CallHoldWebhookEvent(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): CallHoldWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_HOLD = of("call.hold")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallHoldWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallHoldWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
