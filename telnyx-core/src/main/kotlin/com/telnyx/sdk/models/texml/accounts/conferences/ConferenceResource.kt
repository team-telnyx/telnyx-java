...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferenceResource]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceResource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceResource: ConferenceResource) = apply {
            accountSid = conferenceResource.accountSid
            apiVersion = conferenceResource.apiVersion
            callSidEndingConference = conferenceResource.callSidEndingConference
            dateCreated = conferenceResource.dateCreated
            dateUpdated = conferenceResource.dateUpdated
            friendlyName = conferenceResource.friendlyName
            reasonConferenceEnded = conferenceResource.reasonConferenceEnded
            region = conferenceResource.region
            sid = conferenceResource.sid
            status = conferenceResource.status
            subresourceUris = conferenceResource.subresourceUris
            uri = conferenceResource.uri
            additionalProperties = conferenceResource.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceResource].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceResource =
            ConferenceResource(
                accountSid,
                apiVersion,
                callSidEndingConference,
     ...
     *   expected type.
     */
    fun validate(): ConferenceResource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceResource &&
