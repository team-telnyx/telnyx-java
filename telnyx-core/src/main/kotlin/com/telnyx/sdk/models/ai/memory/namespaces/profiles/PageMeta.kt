...
private constructor(
    ...
    /**
     * Pages that can be requested; 0 when nothing matched. Page until `page_number` reaches it
     * rather than until a page comes back short: a page can hold fewer than `page_size` results
     * without being the last. Capped at the deepest page served, so on a very large listing it
     * covers fewer results than `total_results`.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PageMeta].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageMeta: PageMeta) = apply {
            pageNumber = pageMeta.pageNumber
            pageSize = pageMeta.pageSize
            totalPages = pageMeta.totalPages
            totalResults = pageMeta.totalResults
            additionalProperties = pageMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PageMeta].
         *
    ...
    override fun toString() =
        "PageMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
