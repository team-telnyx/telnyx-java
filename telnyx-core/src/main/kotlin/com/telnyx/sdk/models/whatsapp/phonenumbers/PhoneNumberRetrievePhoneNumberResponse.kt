...
class PhoneNumberRetrievePhoneNumberResponse
...
private constructor(
    ...
    /** A builder for [PhoneNumberRetrievePhoneNumberResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                phoneNumberRetrievePhoneNumberResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberRetrievePhoneNumberResponse].
         *
         ...
         */
        fun build(): PhoneNumberRetrievePhoneNumberResponse =
            PhoneNumberRetrievePhoneNumberResponse(
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberRetrievePhoneNumberResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberRetrievePhoneNumberResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PhoneNumberRetrievePhoneNumberResponse{data=$data, additionalProperties=$additionalProperties}"
}
