 ...
 * endpoint.
 */
class PartnerCampaignGetSharedByMeParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PartnerCampaignGetSharedByMeParams = builder().build()
    ...
    /** A builder for [PartnerCampaignGetSharedByMeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(partnerCampaignGetSharedByMeParams: PartnerCampaignGetSharedByMeParams) =
            apply {
                page = partnerCampaignGetSharedByMeParams.page
                recordsPerPage = partnerCampaignGetSharedByMeParams.recordsPerPage
                additionalHeaders = partnerCampaignGetSharedByMeParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    partnerCampaignGetSharedByMeParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignGetSharedByMeParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignGetSharedByMeParams =
            PartnerCampaignGetSharedByMeParams(
                page,
                recordsPerPage,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignGetSharedByMeParams &&
            page == other.page &&
    ...
    override fun toString() =
        "PartnerCampaignGetSharedByMeParams{page=$page, recordsPerPage=$recordsPerPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
