...
class VoiceDesignsPaginationMeta
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VoiceDesignsPaginationMeta].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceDesignsPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceDesignsPaginationMeta: VoiceDesignsPaginationMeta) = apply {
            pageNumber = voiceDesignsPaginationMeta.pageNumber
            pageSize = voiceDesignsPaginationMeta.pageSize
            totalPages = voiceDesignsPaginationMeta.totalPages
            totalResults = voiceDesignsPaginationMeta.totalResults
            additionalProperties = voiceDesignsPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceDesignsPaginationMeta].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceDesignsPaginationMeta =
     ...
     *   expected type.
     */
    fun validate(): VoiceDesignsPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceDesignsPaginationMeta &&
    ...
    override fun toString() =
        "VoiceDesignsPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
