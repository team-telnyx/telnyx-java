...
class GlobalIpHealthCheckListResponse
...
private constructor(
    ...
    /** A builder for [GlobalIpHealthCheckListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalIpHealthCheckListResponse: GlobalIpHealthCheckListResponse) =
            apply {
                id = globalIpHealthCheckListResponse.id
                createdAt = globalIpHealthCheckListResponse.createdAt
                recordType = globalIpHealthCheckListResponse.recordType
                updatedAt = globalIpHealthCheckListResponse.updatedAt
                globalIpId = globalIpHealthCheckListResponse.globalIpId
                healthCheckParams = globalIpHealthCheckListResponse.healthCheckParams
                healthCheckType = globalIpHealthCheckListResponse.healthCheckType
                additionalProperties =
                    globalIpHealthCheckListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [GlobalIpHealthCheckListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GlobalIpHealthCheckListResponse =
            GlobalIpHealthCheckListResponse(
                id,
                createdAt,
                recordType,
    ...
    fun validate(): GlobalIpHealthCheckListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalIpHealthCheckListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "GlobalIpHealthCheckListResponse{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, globalIpId=$globalIpId, healthCheckParams=$healthCheckParams, healthCheckType=$healthCheckType, additionalProperties=$additionalProperties}"
}
