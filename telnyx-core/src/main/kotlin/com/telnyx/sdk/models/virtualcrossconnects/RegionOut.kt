...
private constructor(
    ...
    ) : this(region, regionCode, mutableMapOf())
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RegionOut]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RegionOut]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(regionOut: RegionOut) = apply {
            region = regionOut.region
            regionCode = regionOut.regionCode
            additionalProperties = regionOut.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RegionOut].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RegionOut = RegionOut(region, regionCode, additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RegionOut &&
            region == other.region &&
            regionCode == other.regionCode &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(region, regionCode, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "RegionOut{region=$region, regionCode=$regionCode, additionalProperties=$additionalProperties}"
}
