 ...
 * `taskId`.
 */
class PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            taskId = phoneNumberAssignmentByProfileRetrievePhoneNumbersParams.taskId
            page = phoneNumberAssignmentByProfileRetrievePhoneNumbersParams.page
            recordsPerPage = phoneNumberAssignmentByProfileRetrievePhoneNumbersParams.recordsPerPage
            additionalHeaders =
                phoneNumberAssignmentByProfileRetrievePhoneNumbersParams.additionalHeaders
                    .toBuilder()
            additionalQueryParams =
                phoneNumberAssignmentByProfileRetrievePhoneNumbersParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams =
            PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams(
                taskId,
                page,
                recordsPerPage,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams &&
            taskId == other.taskId &&
            page == other.page &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams{taskId=$taskId, page=$page, recordsPerPage=$recordsPerPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
