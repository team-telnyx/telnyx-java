...
class OAuthOAuthPaginationMeta
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OAuthOAuthPaginationMeta]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OAuthOAuthPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(oauthOAuthPaginationMeta: OAuthOAuthPaginationMeta) = apply {
            pageNumber = oauthOAuthPaginationMeta.pageNumber
            pageSize = oauthOAuthPaginationMeta.pageSize
            totalPages = oauthOAuthPaginationMeta.totalPages
            totalResults = oauthOAuthPaginationMeta.totalResults
            additionalProperties = oauthOAuthPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OAuthOAuthPaginationMeta].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OAuthOAuthPaginationMeta =
     ...
     *   expected type.
     */
    fun validate(): OAuthOAuthPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OAuthOAuthPaginationMeta &&
    ...
    override fun toString() =
        "OAuthOAuthPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
