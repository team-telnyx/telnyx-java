...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferenceCreated]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceCreated]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceCreated: ConferenceCreated) = apply {
            id = conferenceCreated.id
            eventType = conferenceCreated.eventType
            payload = conferenceCreated.payload
            recordType = conferenceCreated.recordType
            additionalProperties = conferenceCreated.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceCreated].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceCreated =
            ConferenceCreated(
                id,
                eventType,
                payload,
    ...
    fun validate(): ConferenceCreated = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_CREATED = of("conference.created")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_CREATED -> Value.CONFERENCE_CREATED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_CREATED -> Known.CONFERENCE_CREATED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceCreated &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceCreated{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
