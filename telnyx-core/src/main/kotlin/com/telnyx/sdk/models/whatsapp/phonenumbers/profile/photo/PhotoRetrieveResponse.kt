...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PhotoRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PhotoRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(photoRetrieveResponse: PhotoRetrieveResponse) = apply {
            data = photoRetrieveResponse.data
            additionalProperties = photoRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhotoRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhotoRetrieveResponse =
            PhotoRetrieveResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PhotoRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(phoneNumberId, profilePhotoUrl, recordType, mutableMapOf())
        ...
        /**
         * URL of the business profile photo (served by Meta's CDN). May be empty if no photo is
         * set.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         ...
         *
         * Unlike [profilePhotoUrl], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("profile_photo_url")
        @ExcludeMissing
        ...
        private val hashCode: Int by lazy {
            Objects.hash(phoneNumberId, profilePhotoUrl, recordType, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{phoneNumberId=$phoneNumberId, profilePhotoUrl=$profilePhotoUrl, recordType=$recordType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhotoRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PhotoRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
