...
class ExternalVettingRetrieveExternalVettingResponse
...
private constructor(
    ...
    /** A builder for [ExternalVettingRetrieveExternalVettingResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            createDate = externalVettingRetrieveExternalVettingResponse.createDate
            evpId = externalVettingRetrieveExternalVettingResponse.evpId
            vettedDate = externalVettingRetrieveExternalVettingResponse.vettedDate
            vettingClass = externalVettingRetrieveExternalVettingResponse.vettingClass
            vettingId = externalVettingRetrieveExternalVettingResponse.vettingId
            vettingScore = externalVettingRetrieveExternalVettingResponse.vettingScore
            vettingToken = externalVettingRetrieveExternalVettingResponse.vettingToken
            additionalProperties =
                externalVettingRetrieveExternalVettingResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingRetrieveExternalVettingResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalVettingRetrieveExternalVettingResponse =
            ExternalVettingRetrieveExternalVettingResponse(
                createDate,
                evpId,
                vettedDate,
    ...
    fun validate(): ExternalVettingRetrieveExternalVettingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingRetrieveExternalVettingResponse &&
    ...
    override fun toString() =
        "ExternalVettingRetrieveExternalVettingResponse{createDate=$createDate, evpId=$evpId, vettedDate=$vettedDate, vettingClass=$vettingClass, vettingId=$vettingId, vettingScore=$vettingScore, vettingToken=$vettingToken, additionalProperties=$additionalProperties}"
}
