...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(embeddingCreateResponse: EmbeddingCreateResponse) = apply {
            data = embeddingCreateResponse.data.map { it.toMutableList() }
            model = embeddingCreateResponse.model
            object_ = embeddingCreateResponse.object_
    ...
    override fun toString() =
        "EmbeddingCreateResponse{data=$data, model=$model, object_=$object_, usage=$usage, additionalProperties=$additionalProperties}"
}
