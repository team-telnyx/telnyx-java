...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FilterReplaceResponse].
         *
    ...
    /** A builder for [FilterReplaceResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(filterReplaceResponse: FilterReplaceResponse) = apply {
            data = filterReplaceResponse.data
            additionalProperties = filterReplaceResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FilterReplaceResponse].
         *
         ...
         */
        fun build(): FilterReplaceResponse =
            FilterReplaceResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): FilterReplaceResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(allowlist, blocklist, recordType, mutableMapOf())

        /**
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun allowlist(): List<String> = allowlist.getRequired("allowlist")

        /**
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun blocklist(): List<String> = blocklist.getRequired("blocklist")
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                allowlist = data.allowlist.map { it.toMutableList() }
                blocklist = data.blocklist.map { it.toMutableList() }
            ...
            fun build(): Data =
                Data(
                    checkRequired("allowlist", allowlist).map { it.toImmutable() },
                    checkRequired("blocklist", blocklist).map { it.toImmutable() },
        ...
        class RecordType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val EMAIL_INBOX_FILTERS = of("email_inbox_filters")
            ...
            fun value(): Value =
                when (this) {
                    EMAIL_INBOX_FILTERS -> Value.EMAIL_INBOX_FILTERS
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    EMAIL_INBOX_FILTERS -> Known.EMAIL_INBOX_FILTERS
        ...
        private val hashCode: Int by lazy {
            Objects.hash(allowlist, blocklist, recordType, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{allowlist=$allowlist, blocklist=$blocklist, recordType=$recordType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FilterReplaceResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FilterReplaceResponse{data=$data, additionalProperties=$additionalProperties}"
}
