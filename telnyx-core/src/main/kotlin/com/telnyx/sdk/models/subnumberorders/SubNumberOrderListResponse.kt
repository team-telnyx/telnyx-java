...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubNumberOrderListResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subNumberOrderListResponse: SubNumberOrderListResponse) = apply {
            data = subNumberOrderListResponse.data.map { it.toMutableList() }
            meta = subNumberOrderListResponse.meta
        ...
        /**
         * Returns an immutable instance of [SubNumberOrderListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubNumberOrderListResponse =
    ...
    fun validate(): SubNumberOrderListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubNumberOrderListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "SubNumberOrderListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
