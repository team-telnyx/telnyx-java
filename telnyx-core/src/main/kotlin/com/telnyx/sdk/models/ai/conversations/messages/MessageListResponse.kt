...
private constructor(
    ...
    /**
     * The datetime the message was created on the conversation. This does not necesarily correspond
     * to the time the message was sent. The best field to use to determine the time the end user
     * experienced the message is `sent_at`.
     *
