...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PhoneNumberGetResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PhoneNumberGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberGetResponse: PhoneNumberGetResponse) = apply {
            data = phoneNumberGetResponse.data.map { it.toMutableList() }
            meta = phoneNumberGetResponse.meta
            additionalProperties = phoneNumberGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberGetResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoneNumberGetResponse =
     ...
     *   expected type.
     */
    fun validate(): PhoneNumberGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [callingEnabled], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("calling_enabled")
        @ExcludeMissing
         ...
         *
         * Unlike [qualityRating], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("quality_rating")
        @ExcludeMissing
         ...
         *
         * Unlike [syncDeadline], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("sync_deadline")
        @ExcludeMissing
         ...
         *
         * Unlike [syncProgress], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("sync_progress")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                callingEnabled = data.callingEnabled
                coexistenceState = data.coexistenceState
                createdAt = data.createdAt
                displayName = data.displayName
                enabled = data.enabled
                isOnBizApp = data.isOnBizApp
                phoneNumber = data.phoneNumber
                phoneNumberId = data.phoneNumberId
                qualityRating = data.qualityRating
                recordType = data.recordType
                status = data.status
                syncDeadline = data.syncDeadline
            ...
            fun callingEnabled(callingEnabled: Boolean) =
                callingEnabled(JsonField.of(callingEnabled))
            ...
            /**
             * Current lifecycle state for a coexistence number. This is null for a standard Cloud
             * API number.
             */
             ...
             *
             * You should usually call [Builder.coexistenceState] with a well-typed
             * [CoexistenceState] value instead. This method is primarily for setting the field to
            ...
            /**
             * Indicates whether the number is connected to both the WhatsApp Business app and Cloud
             * API through WhatsApp Coexistence.
             */
             ...
             *
             * You should usually call [Builder.isOnBizApp] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.qualityRating] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Deadline for initiating the current coexistence synchronization cycle. This is null
             ...
             *
             * You should usually call [Builder.syncDeadline] with a well-typed [OffsetDateTime]
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            /**
             * An enum containing [CoexistenceState]'s known values, as well as an [_UNKNOWN]
             * member.
             *
            ...
            enum class Value {
                ...
                DISCONNECTED,
                /**
                 * An enum member indicating that [CoexistenceState] was instantiated with an
                 * unknown value.
                 */
                _UNKNOWN,
            }
        ...
        private constructor(
             ...
             *
             * Unlike [contactsStatus], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("contacts_status")
            @ExcludeMissing
             ...
             *
             * Unlike [historyChunkOrder], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("history_chunk_order")
            @ExcludeMissing
             ...
             *
             * Unlike [historyProgress], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("history_progress")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Alias for calling [Builder.historyChunkOrder] with
                 * `historyChunkOrder.orElse(null)`.
                 */
                 ...
                 *
                 * You should usually call [Builder.historyChunkOrder] with a well-typed [Long]
                ...
                fun historyPhase(historyPhase: Long?) =
                    historyPhase(JsonField.ofNullable(historyPhase))
                ...
                fun historyPhase(historyPhase: Optional<Long>) =
                    historyPhase(historyPhase.getOrNull())
                 ...
                 */
                fun historyProgress(historyProgress: Long) =
                    historyProgress(historyProgress as Long?)
                ...
                fun historyStatus(historyStatus: String) =
                    historyStatus(JsonField.of(historyStatus))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberGetResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PhoneNumberGetResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
