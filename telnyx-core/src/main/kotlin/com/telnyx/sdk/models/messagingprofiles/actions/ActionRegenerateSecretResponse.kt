...
class ActionRegenerateSecretResponse
...
private constructor(
    ...
    /** A builder for [ActionRegenerateSecretResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionRegenerateSecretResponse: ActionRegenerateSecretResponse) = apply {
            data = actionRegenerateSecretResponse.data
            additionalProperties =
                actionRegenerateSecretResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRegenerateSecretResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionRegenerateSecretResponse =
            ActionRegenerateSecretResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionRegenerateSecretResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRegenerateSecretResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionRegenerateSecretResponse{data=$data, additionalProperties=$additionalProperties}"
}
