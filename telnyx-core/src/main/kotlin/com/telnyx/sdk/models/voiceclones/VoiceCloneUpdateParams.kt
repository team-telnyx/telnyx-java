...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VoiceCloneUpdateParams].
         *
    ...
    /** A builder for [VoiceCloneUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceCloneUpdateParams: VoiceCloneUpdateParams) = apply {
            id = voiceCloneUpdateParams.id
            body = voiceCloneUpdateParams.body.toBuilder()
            additionalHeaders = voiceCloneUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = voiceCloneUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceCloneUpdateParams].
         *
         ...
         */
        fun build(): VoiceCloneUpdateParams =
    ...
    private constructor(
        ...
        ) : this(name, gender, language, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, gender, language, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, gender=$gender, language=$language, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceCloneUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "VoiceCloneUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
