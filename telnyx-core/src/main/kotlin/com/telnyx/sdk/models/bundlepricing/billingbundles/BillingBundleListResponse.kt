...
class BillingBundleListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillingBundleListResponse].
         *
    ...
    /** A builder for [BillingBundleListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingBundleListResponse: BillingBundleListResponse) = apply {
            data = billingBundleListResponse.data.map { it.toMutableList() }
            meta = billingBundleListResponse.meta
            additionalProperties = billingBundleListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BillingBundleListResponse].
         *
         ...
         */
        fun build(): BillingBundleListResponse =
    ...
    fun validate(): BillingBundleListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BillingBundleListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "BillingBundleListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
