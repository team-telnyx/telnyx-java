...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(releaseListResponse: ReleaseListResponse) = apply {
            createdAt = releaseListResponse.createdAt
            errorMessage = releaseListResponse.errorMessage
            status = releaseListResponse.status
            telephoneNumbers = releaseListResponse.telephoneNumbers.map { it.toMutableList() }
            tenantId = releaseListResponse.tenantId
            ticketId = releaseListResponse.ticketId
    ...
    override fun toString() =
        "ReleaseListResponse{createdAt=$createdAt, errorMessage=$errorMessage, status=$status, telephoneNumbers=$telephoneNumbers, tenantId=$tenantId, ticketId=$ticketId, additionalProperties=$additionalProperties}"
}
