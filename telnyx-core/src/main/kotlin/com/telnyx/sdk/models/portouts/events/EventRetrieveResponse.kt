...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun data(webhookPortoutStatusChanged: Data.WebhookPortoutStatusChanged) =
         ...
         */
        fun data(webhookPortoutNewComment: Data.WebhookPortoutNewComment) =
         ...
         */
        fun data(webhookPortoutFocDateChanged: Data.WebhookPortoutFocDateChanged) =
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(webhookPortoutStatusChanged: WebhookPortoutStatusChanged) =
                    apply {
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(webhookPortoutNewComment: WebhookPortoutNewComment) = apply {
                    ...
                    availableNotificationMethods =
                        webhookPortoutNewComment.availableNotificationMethods.map {
                            it.toMutableList()
                        }
                    ...
                    additionalProperties =
                        webhookPortoutNewComment.additionalProperties.toMutableMap()
                }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(webhookPortoutFocDateChanged: WebhookPortoutFocDateChanged) =
                    apply {
