...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callEventListResponse: CallEventListResponse) = apply {
            callLegId = callEventListResponse.callLegId
            callSessionId = callEventListResponse.callSessionId
            eventTimestamp = callEventListResponse.eventTimestamp
            metadata = callEventListResponse.metadata
            name = callEventListResponse.name
            recordType = callEventListResponse.recordType
            type = callEventListResponse.type
        ...
        /** Event timestamp */
        fun eventTimestamp(eventTimestamp: String) = eventTimestamp(JsonField.of(eventTimestamp))
    ...
    override fun toString() =
        "CallEventListResponse{callLegId=$callLegId, callSessionId=$callSessionId, eventTimestamp=$eventTimestamp, metadata=$metadata, name=$name, recordType=$recordType, type=$type, additionalProperties=$additionalProperties}"
}
