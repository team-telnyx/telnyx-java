...
class MessagingMetricsTimeFrame
@JsonCreator
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = MessagingMetricsTimeFrame(JsonField.of(value))
    }

    /** An enum containing [MessagingMetricsTimeFrame]'s known values. */
    enum class Known {
        TIME_FRAME_1_H,
        TIME_FRAME_3_H,
        TIME_FRAME_24_H,
    ...
    /**
     * An enum containing [MessagingMetricsTimeFrame]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [MessagingMetricsTimeFrame] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        TIME_FRAME_30_D,
        /**
         * An enum member indicating that [MessagingMetricsTimeFrame] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw TelnyxInvalidDataException("Unknown MessagingMetricsTimeFrame: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): MessagingMetricsTimeFrame = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingMetricsTimeFrame && value == other.value
    }
