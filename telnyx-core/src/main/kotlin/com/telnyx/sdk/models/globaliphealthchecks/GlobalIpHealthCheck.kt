...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [GlobalIpHealthCheck]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GlobalIpHealthCheck]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalIpHealthCheck: GlobalIpHealthCheck) = apply {
            ...
            globalIpId = globalIpHealthCheck.globalIpId
            healthCheckParams = globalIpHealthCheck.healthCheckParams
            healthCheckType = globalIpHealthCheck.healthCheckType
            additionalProperties = globalIpHealthCheck.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GlobalIpHealthCheck].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GlobalIpHealthCheck =
            GlobalIpHealthCheck(
                id,
                createdAt,
                recordType,
     ...
     *   expected type.
     */
    fun validate(): GlobalIpHealthCheck = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalIpHealthCheck &&
            id == other.id &&
    ...
    override fun toString() =
        "GlobalIpHealthCheck{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, globalIpId=$globalIpId, healthCheckParams=$healthCheckParams, healthCheckType=$healthCheckType, additionalProperties=$additionalProperties}"
}
