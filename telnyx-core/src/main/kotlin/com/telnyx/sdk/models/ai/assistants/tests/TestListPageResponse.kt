...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TestListPageResponse].
         *
    ...
    /** A builder for [TestListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(testListPageResponse: TestListPageResponse) = apply {
            data = testListPageResponse.data.map { it.toMutableList() }
            meta = testListPageResponse.meta
            additionalProperties = testListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TestListPageResponse].
         *
         ...
         */
        fun build(): TestListPageResponse =
    ...
    fun validate(): TestListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TestListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "TestListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
