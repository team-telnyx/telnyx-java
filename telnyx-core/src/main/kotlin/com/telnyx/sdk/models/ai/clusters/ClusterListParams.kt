...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ClusterListParams =
            ClusterListParams(page, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ClusterListParams{page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
