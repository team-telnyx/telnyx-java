...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ClusterListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(clusterListParams: ClusterListParams) = apply {
            pageNumber = clusterListParams.pageNumber
            pageSize = clusterListParams.pageSize
    ...
    override fun toString() =
        "ClusterListParams{pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
