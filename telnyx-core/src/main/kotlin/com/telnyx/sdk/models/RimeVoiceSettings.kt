...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RimeVoiceSettings].
         *
    ...
    /** A builder for [RimeVoiceSettings]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [RimeVoiceSettings].
         *
    ...
    fun validate(): RimeVoiceSettings = apply {
        if (validated) {
            return@apply
        }
