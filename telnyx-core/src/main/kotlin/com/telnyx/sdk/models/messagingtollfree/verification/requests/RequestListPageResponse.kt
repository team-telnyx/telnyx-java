...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RequestListPageResponse].
         *
    ...
    /** A builder for [RequestListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(requestListPageResponse: RequestListPageResponse) = apply {
            records = requestListPageResponse.records.map { it.toMutableList() }
            totalRecords = requestListPageResponse.totalRecords
            additionalProperties = requestListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RequestListPageResponse].
         *
         ...
         */
        fun build(): RequestListPageResponse =
    ...
    fun validate(): RequestListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RequestListPageResponse &&
    ...
    override fun toString() =
        "RequestListPageResponse{records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
