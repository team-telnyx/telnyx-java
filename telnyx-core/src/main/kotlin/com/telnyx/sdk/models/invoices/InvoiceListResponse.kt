...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceListResponse: InvoiceListResponse) = apply {
            fileId = invoiceListResponse.fileId
            invoiceId = invoiceListResponse.invoiceId
            paid = invoiceListResponse.paid
            periodEnd = invoiceListResponse.periodEnd
            periodStart = invoiceListResponse.periodStart
            url = invoiceListResponse.url
         ...
         *
         * You should usually call [Builder.paid] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    override fun toString() =
        "InvoiceListResponse{fileId=$fileId, invoiceId=$invoiceId, paid=$paid, periodEnd=$periodEnd, periodStart=$periodStart, url=$url, additionalProperties=$additionalProperties}"
}
