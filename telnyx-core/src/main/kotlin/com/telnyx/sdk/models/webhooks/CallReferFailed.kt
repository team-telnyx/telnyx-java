...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallReferFailed]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallReferFailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callReferFailed: CallReferFailed) = apply {
            id = callReferFailed.id
            eventType = callReferFailed.eventType
            occurredAt = callReferFailed.occurredAt
            payload = callReferFailed.payload
            recordType = callReferFailed.recordType
            additionalProperties = callReferFailed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallReferFailed].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallReferFailed =
            CallReferFailed(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallReferFailed = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_REFER_FAILED = of("call.refer.failed")
        ...
        fun value(): Value =
            when (this) {
                CALL_REFER_FAILED -> Value.CALL_REFER_FAILED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_REFER_FAILED -> Known.CALL_REFER_FAILED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReferFailed &&
            id == other.id &&
    ...
    override fun toString() =
        "CallReferFailed{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
