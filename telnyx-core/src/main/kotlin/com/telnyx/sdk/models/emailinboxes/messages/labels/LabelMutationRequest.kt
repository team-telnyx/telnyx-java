...
private constructor(
    ...
    ) : this(labels, mutableMapOf())

    /**
     * One or more labels. Each label is a freeform, case-sensitive string of at most 255
     * characters; a message or thread may carry at most 50 labels. The `telnyx:` prefix is a
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LabelMutationRequest].
         *
    ...
    /** A builder for [LabelMutationRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(labelMutationRequest: LabelMutationRequest) = apply {
            labels = labelMutationRequest.labels.map { it.toMutableList() }
            additionalProperties = labelMutationRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LabelMutationRequest].
         *
         ...
         */
        fun build(): LabelMutationRequest =
     ...
     *   expected type.
     */
    fun validate(): LabelMutationRequest = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (labels.asKnown().getOrNull()?.size ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LabelMutationRequest &&
            labels == other.labels &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(labels, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "LabelMutationRequest{labels=$labels, additionalProperties=$additionalProperties}"
}
