...
private constructor(
     ...
     * country.<br/><br/> This code is commonly seen joined with a Mobile Network Code (MNC) in a
     * tuple that allows identifying a carrier known as PLMN (Public Land Mobile Network) code.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
     ...
     * network.<br/><br/> This code is commonly seen joined with a Mobile Country Code (MCC) in a
     * tuple that allows identifying a carrier known as PLMN (Public Land Mobile Network) code.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mobileNetworkOperatorListResponse: MobileNetworkOperatorListResponse) =
            apply {
                id = mobileNetworkOperatorListResponse.id
                countryCode = mobileNetworkOperatorListResponse.countryCode
                mcc = mobileNetworkOperatorListResponse.mcc
                mnc = mobileNetworkOperatorListResponse.mnc
                name = mobileNetworkOperatorListResponse.name
                networkPreferencesEnabled =
                    mobileNetworkOperatorListResponse.networkPreferencesEnabled
                recordType = mobileNetworkOperatorListResponse.recordType
                tadig = mobileNetworkOperatorListResponse.tadig
         ...
         *
         * You should usually call [Builder.networkPreferencesEnabled] with a well-typed [Boolean]
         ...
         *
         * You should usually call [Builder.tadig] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    override fun toString() =
        "MobileNetworkOperatorListResponse{id=$id, countryCode=$countryCode, mcc=$mcc, mnc=$mnc, name=$name, networkPreferencesEnabled=$networkPreferencesEnabled, recordType=$recordType, tadig=$tadig, additionalProperties=$additionalProperties}"
}
