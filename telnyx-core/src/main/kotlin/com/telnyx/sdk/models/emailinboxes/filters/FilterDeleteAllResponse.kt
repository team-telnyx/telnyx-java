...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FilterDeleteAllResponse].
         *
    ...
    /** A builder for [FilterDeleteAllResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(filterDeleteAllResponse: FilterDeleteAllResponse) = apply {
            data = filterDeleteAllResponse.data
            additionalProperties = filterDeleteAllResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FilterDeleteAllResponse].
         *
         ...
         */
        fun build(): FilterDeleteAllResponse =
     ...
     *   expected type.
     */
    fun validate(): FilterDeleteAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FilterDeleteAllResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FilterDeleteAllResponse{data=$data, additionalProperties=$additionalProperties}"
}
