...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VoiceSdkCallReport]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceSdkCallReport]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceSdkCallReport: VoiceSdkCallReport) = apply {
            callId = voiceSdkCallReport.callId
            callReportId = voiceSdkCallReport.callReportId
            createdAt = voiceSdkCallReport.createdAt
            flushReason = voiceSdkCallReport.flushReason
            logs = voiceSdkCallReport.logs
            organizationId = voiceSdkCallReport.organizationId
            segment = voiceSdkCallReport.segment
            stats = voiceSdkCallReport.stats
            storedAt = voiceSdkCallReport.storedAt
            summary = voiceSdkCallReport.summary
            telnyxLegId = voiceSdkCallReport.telnyxLegId
            telnyxSessionId = voiceSdkCallReport.telnyxSessionId
            userAgent = voiceSdkCallReport.userAgent
            userId = voiceSdkCallReport.userId
            version = voiceSdkCallReport.version
            voiceSdkId = voiceSdkCallReport.voiceSdkId
            voiceSdkIdDecoded = voiceSdkCallReport.voiceSdkIdDecoded
            voiceSdkSessionId = voiceSdkCallReport.voiceSdkSessionId
            additionalProperties = voiceSdkCallReport.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceSdkCallReport].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceSdkCallReport =
            VoiceSdkCallReport(
                callId,
                callReportId,
                createdAt,
     ...
     *   expected type.
     */
    fun validate(): VoiceSdkCallReport = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceSdkCallReport &&
            callId == other.callId &&
    ...
    override fun toString() =
        "VoiceSdkCallReport{callId=$callId, callReportId=$callReportId, createdAt=$createdAt, flushReason=$flushReason, logs=$logs, organizationId=$organizationId, segment=$segment, stats=$stats, storedAt=$storedAt, summary=$summary, telnyxLegId=$telnyxLegId, telnyxSessionId=$telnyxSessionId, userAgent=$userAgent, userId=$userId, version=$version, voiceSdkId=$voiceSdkId, voiceSdkIdDecoded=$voiceSdkIdDecoded, voiceSdkSessionId=$voiceSdkSessionId, additionalProperties=$additionalProperties}"
}
