...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FilterListResponse].
         *
    ...
    /** A builder for [FilterListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(filterListResponse: FilterListResponse) = apply {
            data = filterListResponse.data
            additionalProperties = filterListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FilterListResponse].
         *
         ...
         */
        fun build(): FilterListResponse =
            FilterListResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): FilterListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FilterListResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FilterListResponse{data=$data, additionalProperties=$additionalProperties}"
}
