...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun interruptible(): Optional<ConversationRelayInterruptible> = body.interruptible()
     ...
     */
    fun _interruptible(): JsonField<ConversationRelayInterruptible> = body._interruptible()
     ...
     * type.
     */
    fun _interruptibleGreeting(): JsonField<ConversationRelayInterruptible> =
        body._interruptibleGreeting()
    ...
    class Builder internal constructor() {
         ...
         * DTMF only.
         */
        fun interruptible(interruptible: ConversationRelayInterruptible) = apply {
         ...
         * DTMF only.
         */
        fun interruptibleGreeting(interruptibleGreeting: ConversationRelayInterruptible) = apply {
        ...
        ) = apply { body.interruptibleGreeting(interruptibleGreeting) }
        ...
        fun voiceSettings(soniox: SonioxVoiceSettings) = apply { body.voiceSettings(soniox) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.interruptible] with a well-typed
             * [ConversationRelayInterruptible] value instead. This method is primarily for setting
             ...
             *   [Voices API](https://developers.telnyx.com/api-reference/text-to-speech-commands/list-available-voices).
             *   Every voice speaks all supported languages; set `language` to the two-letter ISO
             *   639-1 code of the text, for example `it`. SSML is not supported. Use
