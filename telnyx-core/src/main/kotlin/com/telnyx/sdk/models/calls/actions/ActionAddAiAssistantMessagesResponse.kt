...
class ActionAddAiAssistantMessagesResponse
...
private constructor(
    ...
    /** A builder for [ActionAddAiAssistantMessagesResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = actionAddAiAssistantMessagesResponse.data
            additionalProperties =
                actionAddAiAssistantMessagesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionAddAiAssistantMessagesResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionAddAiAssistantMessagesResponse =
            ActionAddAiAssistantMessagesResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionAddAiAssistantMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionAddAiAssistantMessagesResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionAddAiAssistantMessagesResponse{data=$data, additionalProperties=$additionalProperties}"
}
