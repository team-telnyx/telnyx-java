...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiprecConnectorResponse].
         *
    ...
    /** A builder for [SiprecConnectorResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siprecConnectorResponse: SiprecConnectorResponse) = apply {
            data = siprecConnectorResponse.data
            additionalProperties = siprecConnectorResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SiprecConnectorResponse].
         *
         ...
         */
        fun build(): SiprecConnectorResponse =
     ...
     *   expected type.
     */
    fun validate(): SiprecConnectorResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiprecConnectorResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SiprecConnectorResponse{data=$data, additionalProperties=$additionalProperties}"
}
