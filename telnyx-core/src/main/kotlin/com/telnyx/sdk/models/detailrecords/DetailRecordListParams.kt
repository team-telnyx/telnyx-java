...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(detailRecordListParams: DetailRecordListParams) = apply {
            ...
            pageNumber = detailRecordListParams.pageNumber
            pageSize = detailRecordListParams.pageSize
    ...
    override fun toString() =
        "DetailRecordListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
