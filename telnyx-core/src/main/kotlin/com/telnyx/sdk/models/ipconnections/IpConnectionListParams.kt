...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IpConnectionListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IpConnectionListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IpConnectionListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ipConnectionListParams: IpConnectionListParams) = apply {
            filter = ipConnectionListParams.filter
            pageNumber = ipConnectionListParams.pageNumber
            pageSize = ipConnectionListParams.pageSize
            sort = ipConnectionListParams.sort
            additionalHeaders = ipConnectionListParams.additionalHeaders.toBuilder()
            additionalQueryParams = ipConnectionListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IpConnectionListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IpConnectionListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IpConnectionListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "IpConnectionListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
