...
class CustomerServiceRecordStatusChangedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CustomerServiceRecordStatusChangedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                customerServiceRecordStatusChangedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerServiceRecordStatusChangedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CustomerServiceRecordStatusChangedWebhookEvent =
            CustomerServiceRecordStatusChangedWebhookEvent(
                data,
                meta,
    ...
    fun validate(): CustomerServiceRecordStatusChangedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField
                val CUSTOMER_SERVICE_RECORD_STATUS_CHANGED =
                    of("customer_service_record.status_changed")
            ...
            fun value(): Value =
                when (this) {
                    CUSTOMER_SERVICE_RECORD_STATUS_CHANGED ->
                        Value.CUSTOMER_SERVICE_RECORD_STATUS_CHANGED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CUSTOMER_SERVICE_RECORD_STATUS_CHANGED ->
                        Known.CUSTOMER_SERVICE_RECORD_STATUS_CHANGED
        ...
        private constructor(
            ...
            ) : this(id, phoneNumber, status, updatedAt, mutableMapOf())
            ...
            class Builder internal constructor() {
                 ...
                 */
                fun build(): Payload =
                    Payload(id, phoneNumber, status, updatedAt, additionalProperties.toMutableMap())
            }
            ...
            private val hashCode: Int by lazy {
                Objects.hash(id, phoneNumber, status, updatedAt, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "Payload{id=$id, phoneNumber=$phoneNumber, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerServiceRecordStatusChangedWebhookEvent &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomerServiceRecordStatusChangedWebhookEvent{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
