...
class DialogflowConnectionResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DialogflowConnectionResponse].
         *
    ...
    /** A builder for [DialogflowConnectionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dialogflowConnectionResponse: DialogflowConnectionResponse) = apply {
            data = dialogflowConnectionResponse.data
            additionalProperties = dialogflowConnectionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DialogflowConnectionResponse].
         *
         ...
         */
        fun build(): DialogflowConnectionResponse =
     ...
     *   expected type.
     */
    fun validate(): DialogflowConnectionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DialogflowConnectionResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DialogflowConnectionResponse{data=$data, additionalProperties=$additionalProperties}"
}
