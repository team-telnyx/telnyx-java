...
class TranscriptionEngineCohereConfig
...
private constructor(
    ...
    /**
     * The language of the audio to be transcribed. Unlike other self-hosted models, Cohere does not
     * auto-detect the language; `auto` is not supported.
     *
    ...
    /** A builder for [TranscriptionEngineCohereConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transcriptionEngineCohereConfig: TranscriptionEngineCohereConfig) =
            apply {
                language = transcriptionEngineCohereConfig.language
                transcriptionEngine = transcriptionEngineCohereConfig.transcriptionEngine
                transcriptionModel = transcriptionEngineCohereConfig.transcriptionModel
                additionalProperties =
                    transcriptionEngineCohereConfig.additionalProperties.toMutableMap()
            }

        /**
         * The language of the audio to be transcribed. Unlike other self-hosted models, Cohere does
         * not auto-detect the language; `auto` is not supported.
         */
        ...
        /**
         * Returns an immutable instance of [TranscriptionEngineCohereConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TranscriptionEngineCohereConfig =
            TranscriptionEngineCohereConfig(
                language,
                transcriptionEngine,
                transcriptionModel,
     ...
     *   expected type.
     */
    fun validate(): TranscriptionEngineCohereConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranscriptionEngineCohereConfig &&
    ...
    override fun toString() =
        "TranscriptionEngineCohereConfig{language=$language, transcriptionEngine=$transcriptionEngine, transcriptionModel=$transcriptionModel, additionalProperties=$additionalProperties}"
}
