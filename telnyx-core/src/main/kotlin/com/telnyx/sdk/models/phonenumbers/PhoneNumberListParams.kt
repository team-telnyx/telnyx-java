...
private constructor(
    ...
    override fun toString() =
        "PhoneNumberListParams{filter=$filter, handleMessagingProfileError=$handleMessagingProfileError, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
