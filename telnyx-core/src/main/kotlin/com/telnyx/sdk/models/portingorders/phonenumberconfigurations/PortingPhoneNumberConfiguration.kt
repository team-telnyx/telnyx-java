...
class PortingPhoneNumberConfiguration
...
private constructor(
    ...
    /** A builder for [PortingPhoneNumberConfiguration]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingPhoneNumberConfiguration: PortingPhoneNumberConfiguration) =
            apply {
                id = portingPhoneNumberConfiguration.id
                createdAt = portingPhoneNumberConfiguration.createdAt
                portingPhoneNumberId = portingPhoneNumberConfiguration.portingPhoneNumberId
                recordType = portingPhoneNumberConfiguration.recordType
                updatedAt = portingPhoneNumberConfiguration.updatedAt
                userBundleId = portingPhoneNumberConfiguration.userBundleId
                additionalProperties =
                    portingPhoneNumberConfiguration.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PortingPhoneNumberConfiguration].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingPhoneNumberConfiguration =
            PortingPhoneNumberConfiguration(
                id,
                createdAt,
                portingPhoneNumberId,
     ...
     *   expected type.
     */
    fun validate(): PortingPhoneNumberConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingPhoneNumberConfiguration &&
            id == other.id &&
    ...
    override fun toString() =
        "PortingPhoneNumberConfiguration{id=$id, createdAt=$createdAt, portingPhoneNumberId=$portingPhoneNumberId, recordType=$recordType, updatedAt=$updatedAt, userBundleId=$userBundleId, additionalProperties=$additionalProperties}"
}
