...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferencePlaybackEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferencePlaybackEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferencePlaybackEnded: ConferencePlaybackEnded) = apply {
            id = conferencePlaybackEnded.id
            eventType = conferencePlaybackEnded.eventType
            payload = conferencePlaybackEnded.payload
            recordType = conferencePlaybackEnded.recordType
            additionalProperties = conferencePlaybackEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferencePlaybackEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferencePlaybackEnded =
    ...
    fun validate(): ConferencePlaybackEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferencePlaybackEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferencePlaybackEnded{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
