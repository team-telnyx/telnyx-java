...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(queueUpdateParams: QueueUpdateParams) = apply {
            queueName = queueUpdateParams.queueName
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("maxSize", maxSize), additionalProperties.toMutableMap())
        }
    ...
    override fun toString() =
        "QueueUpdateParams{queueName=$queueName, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
