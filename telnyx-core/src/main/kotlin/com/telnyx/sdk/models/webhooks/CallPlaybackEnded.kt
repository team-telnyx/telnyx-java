...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallPlaybackEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallPlaybackEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callPlaybackEnded: CallPlaybackEnded) = apply {
            id = callPlaybackEnded.id
            eventType = callPlaybackEnded.eventType
            occurredAt = callPlaybackEnded.occurredAt
            payload = callPlaybackEnded.payload
            recordType = callPlaybackEnded.recordType
            additionalProperties = callPlaybackEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallPlaybackEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallPlaybackEnded =
            CallPlaybackEnded(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallPlaybackEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallPlaybackEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallPlaybackEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
