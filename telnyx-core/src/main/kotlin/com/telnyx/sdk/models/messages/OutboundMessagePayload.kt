...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OutboundMessagePayload]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OutboundMessagePayload]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(outboundMessagePayload: OutboundMessagePayload) = apply {
            id = outboundMessagePayload.id
            body = outboundMessagePayload.body
            cc = outboundMessagePayload.cc.map { it.toMutableList() }
            completedAt = outboundMessagePayload.completedAt
            cost = outboundMessagePayload.cost
            costBreakdown = outboundMessagePayload.costBreakdown
            direction = outboundMessagePayload.direction
            encoding = outboundMessagePayload.encoding
            errors = outboundMessagePayload.errors.map { it.toMutableList() }
            from = outboundMessagePayload.from
            media = outboundMessagePayload.media.map { it.toMutableList() }
            messagingProfileId = outboundMessagePayload.messagingProfileId
            numChars = outboundMessagePayload.numChars
            organizationId = outboundMessagePayload.organizationId
            parts = outboundMessagePayload.parts
            receivedAt = outboundMessagePayload.receivedAt
            recordType = outboundMessagePayload.recordType
            sentAt = outboundMessagePayload.sentAt
            smartEncodingApplied = outboundMessagePayload.smartEncodingApplied
            subject = outboundMessagePayload.subject
            tags = outboundMessagePayload.tags.map { it.toMutableList() }
            tcrCampaignBillable = outboundMessagePayload.tcrCampaignBillable
            tcrCampaignId = outboundMessagePayload.tcrCampaignId
            tcrCampaignRegistered = outboundMessagePayload.tcrCampaignRegistered
            text = outboundMessagePayload.text
        ...
        /**
         * Returns an immutable instance of [OutboundMessagePayload].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OutboundMessagePayload =
     ...
     *   expected type.
     */
    fun validate(): OutboundMessagePayload = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OutboundMessagePayload &&
            id == other.id &&
            body == other.body &&
            cc == other.cc &&
