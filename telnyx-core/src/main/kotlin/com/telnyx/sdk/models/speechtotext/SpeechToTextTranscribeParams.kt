...
private constructor(
     ...
     * engine uses this value to determine when a speaker has stopped talking. Not all engines
    ...
    class Builder internal constructor() {
        ...
        internal fun from(speechToTextTranscribeParams: SpeechToTextTranscribeParams) = apply {
            ...
            endpointing = speechToTextTranscribeParams.endpointing
            interimResults = speechToTextTranscribeParams.interimResults
            keyterm = speechToTextTranscribeParams.keyterm
            keywords = speechToTextTranscribeParams.keywords
            language = speechToTextTranscribeParams.language
            model = speechToTextTranscribeParams.model
            redact = speechToTextTranscribeParams.redact
