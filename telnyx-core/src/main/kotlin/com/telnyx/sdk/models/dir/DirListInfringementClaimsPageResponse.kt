...
class DirListInfringementClaimsPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<DirListInfringementClaimsResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<DirListInfringementClaimsResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<DirListInfringementClaimsResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<DirListInfringementClaimsResponse>> = data
    ...
    /** A builder for [DirListInfringementClaimsPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<DirListInfringementClaimsResponse>>? = null
        ...
        internal fun from(
            ...
            data = dirListInfringementClaimsPageResponse.data.map { it.toMutableList() }
            meta = dirListInfringementClaimsPageResponse.meta
            additionalProperties =
                dirListInfringementClaimsPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<DirListInfringementClaimsResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<DirListInfringementClaimsResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<DirListInfringementClaimsResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [DirListInfringementClaimsResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: DirListInfringementClaimsResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [DirListInfringementClaimsPageResponse].
         *
         ...
         */
        fun build(): DirListInfringementClaimsPageResponse =
            DirListInfringementClaimsPageResponse(
     ...
     *   expected type.
     */
    fun validate(): DirListInfringementClaimsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirListInfringementClaimsPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DirListInfringementClaimsPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
