...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(brandListResponse: BrandListResponse) = apply {
            assignedCampaingsCount = brandListResponse.assignedCampaingsCount
            brandId = brandListResponse.brandId
            companyName = brandListResponse.companyName
            createdAt = brandListResponse.createdAt
            displayName = brandListResponse.displayName
            email = brandListResponse.email
            entityType = brandListResponse.entityType
            failureReasons = brandListResponse.failureReasons
            identityStatus = brandListResponse.identityStatus
            status = brandListResponse.status
            tcrBrandId = brandListResponse.tcrBrandId
            updatedAt = brandListResponse.updatedAt
            website = brandListResponse.website
         ...
         *
         * You should usually call [Builder.assignedCampaingsCount] with a well-typed [Long] value
