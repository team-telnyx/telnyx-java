...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(phoneNumberListResponse: PhoneNumberListResponse) = apply {
            id = phoneNumberListResponse.id
            batchId = phoneNumberListResponse.batchId
            createdAt = phoneNumberListResponse.createdAt
            dirId = phoneNumberListResponse.dirId
            enterpriseId = phoneNumberListResponse.enterpriseId
            loaDocumentId = phoneNumberListResponse.loaDocumentId
            phoneNumber = phoneNumberListResponse.phoneNumber
            rejectionReason = phoneNumberListResponse.rejectionReason
            status = phoneNumberListResponse.status
            updatedAt = phoneNumberListResponse.updatedAt
            verifiedAt = phoneNumberListResponse.verifiedAt
    ...
    override fun toString() =
        "PhoneNumberListResponse{id=$id, batchId=$batchId, createdAt=$createdAt, dirId=$dirId, enterpriseId=$enterpriseId, loaDocumentId=$loaDocumentId, phoneNumber=$phoneNumber, rejectionReason=$rejectionReason, status=$status, updatedAt=$updatedAt, verifiedAt=$verifiedAt, additionalProperties=$additionalProperties}"
}
