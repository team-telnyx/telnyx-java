...
class DirListInfringementClaimsResponse
...
private constructor(
    ...
    /** A builder for [DirListInfringementClaimsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirListInfringementClaimsResponse: DirListInfringementClaimsResponse) =
            apply {
                id = dirListInfringementClaimsResponse.id
                claimDate = dirListInfringementClaimsResponse.claimDate
                claimDescription = dirListInfringementClaimsResponse.claimDescription
                claimType = dirListInfringementClaimsResponse.claimType
                claimantContact = dirListInfringementClaimsResponse.claimantContact
                claimantName = dirListInfringementClaimsResponse.claimantName
                contestDocuments =
                    dirListInfringementClaimsResponse.contestDocuments.map { it.toMutableList() }
                contestHistory =
                    dirListInfringementClaimsResponse.contestHistory.map { it.toMutableList() }
                createdAt = dirListInfringementClaimsResponse.createdAt
                dir = dirListInfringementClaimsResponse.dir
                dirId = dirListInfringementClaimsResponse.dirId
                enterpriseId = dirListInfringementClaimsResponse.enterpriseId
                resolution = dirListInfringementClaimsResponse.resolution
                resolutionDate = dirListInfringementClaimsResponse.resolutionDate
                resolutionNotes = dirListInfringementClaimsResponse.resolutionNotes
                status = dirListInfringementClaimsResponse.status
                updatedAt = dirListInfringementClaimsResponse.updatedAt
                additionalProperties =
                    dirListInfringementClaimsResponse.additionalProperties.toMutableMap()
            }
         ...
         * `List<ContestDocument>` value instead. This method is primarily for setting the field to
        ...
        /**
         * Returns an immutable instance of [DirListInfringementClaimsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DirListInfringementClaimsResponse =
            DirListInfringementClaimsResponse(
                id,
                claimDate,
                claimDescription,
     ...
     *   expected type.
     */
    fun validate(): DirListInfringementClaimsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirListInfringementClaimsResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "DirListInfringementClaimsResponse{id=$id, claimDate=$claimDate, claimDescription=$claimDescription, claimType=$claimType, claimantContact=$claimantContact, claimantName=$claimantName, contestDocuments=$contestDocuments, contestHistory=$contestHistory, createdAt=$createdAt, dir=$dir, dirId=$dirId, enterpriseId=$enterpriseId, resolution=$resolution, resolutionDate=$resolutionDate, resolutionNotes=$resolutionNotes, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
