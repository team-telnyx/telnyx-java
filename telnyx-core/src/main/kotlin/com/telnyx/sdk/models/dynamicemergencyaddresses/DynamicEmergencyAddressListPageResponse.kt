...
class DynamicEmergencyAddressListPageResponse
...
private constructor(
    ...
    /** A builder for [DynamicEmergencyAddressListPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = dynamicEmergencyAddressListPageResponse.data.map { it.toMutableList() }
            meta = dynamicEmergencyAddressListPageResponse.meta
            additionalProperties =
                dynamicEmergencyAddressListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DynamicEmergencyAddressListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DynamicEmergencyAddressListPageResponse =
            DynamicEmergencyAddressListPageResponse(
    ...
    fun validate(): DynamicEmergencyAddressListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DynamicEmergencyAddressListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "DynamicEmergencyAddressListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
