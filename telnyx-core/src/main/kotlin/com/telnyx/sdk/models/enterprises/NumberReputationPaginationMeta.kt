 ...
 */
class NumberReputationPaginationMeta
...
private constructor(
    ...
    /** A builder for [NumberReputationPaginationMeta]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberReputationPaginationMeta: NumberReputationPaginationMeta) = apply {
            pageNumber = numberReputationPaginationMeta.pageNumber
            pageSize = numberReputationPaginationMeta.pageSize
            totalPages = numberReputationPaginationMeta.totalPages
            totalResults = numberReputationPaginationMeta.totalResults
            additionalProperties =
                numberReputationPaginationMeta.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberReputationPaginationMeta].
         *
         ...
         */
        fun build(): NumberReputationPaginationMeta =
            NumberReputationPaginationMeta(
     ...
     *   expected type.
     */
    fun validate(): NumberReputationPaginationMeta = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberReputationPaginationMeta &&
    ...
    override fun toString() =
        "NumberReputationPaginationMeta{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
