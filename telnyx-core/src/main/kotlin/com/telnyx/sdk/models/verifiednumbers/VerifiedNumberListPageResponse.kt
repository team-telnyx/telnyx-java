...
class VerifiedNumberListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<VerifiedNumber>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<VerifiedNumber>> = JsonMissing.of(),
     ...
     */
    fun data(): List<VerifiedNumber> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<VerifiedNumber>> = data
    ...
    companion object {
         ...
         * [VerifiedNumberListPageResponse].
         *
    ...
    /** A builder for [VerifiedNumberListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<VerifiedNumber>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(verifiedNumberListPageResponse: VerifiedNumberListPageResponse) = apply {
            data = verifiedNumberListPageResponse.data.map { it.toMutableList() }
            meta = verifiedNumberListPageResponse.meta
            additionalProperties =
                verifiedNumberListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<VerifiedNumber>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<VerifiedNumber>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<VerifiedNumber>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [VerifiedNumber] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: VerifiedNumber) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [VerifiedNumberListPageResponse].
         *
         ...
         */
        fun build(): VerifiedNumberListPageResponse =
            VerifiedNumberListPageResponse(
    ...
    fun validate(): VerifiedNumberListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifiedNumberListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VerifiedNumberListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
