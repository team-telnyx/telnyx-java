...
@JsonDeserialize(using = Messaging10dlcGetEnumResponse.Deserializer::class)
@JsonSerialize(using = Messaging10dlcGetEnumResponse.Serializer::class)
class Messaging10dlcGetEnumResponse
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = messaging10dlcGetEnumResponse.accept(new Messaging10dlcGetEnumResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitEnumStringList(List<String> enumStringList) {
     *         return Optional.of(enumStringList.toString());
     *     }
     *
     *     // ...
     *
     ...
     *   expected type.
     */
    fun validate(): Messaging10dlcGetEnumResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Messaging10dlcGetEnumResponse &&
    ...
    override fun toString(): String =
        when {
            enumStringList != null ->
                "Messaging10dlcGetEnumResponse{enumStringList=$enumStringList}"
            enumObjectList != null ->
                "Messaging10dlcGetEnumResponse{enumObjectList=$enumObjectList}"
            enumObjectToString != null ->
                "Messaging10dlcGetEnumResponse{enumObjectToString=$enumObjectToString}"
            enumObjecToObjectt != null ->
                "Messaging10dlcGetEnumResponse{enumObjecToObjectt=$enumObjecToObjectt}"
            enumPaginated != null -> "Messaging10dlcGetEnumResponse{enumPaginated=$enumPaginated}"
            _json != null -> "Messaging10dlcGetEnumResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid Messaging10dlcGetEnumResponse")
        }
    ...
    companion object {
        ...
        fun ofEnumStringList(enumStringList: List<String>) =
            Messaging10dlcGetEnumResponse(enumStringList = enumStringList.toImmutable())

        @JvmStatic
        fun ofEnumObjectList(enumObjectList: List<EnumObject>) =
            Messaging10dlcGetEnumResponse(enumObjectList = enumObjectList.toImmutable())
        ...
        fun ofEnumPaginated(enumPaginated: EnumPaginatedResponse) =
            Messaging10dlcGetEnumResponse(enumPaginated = enumPaginated)
    }

    /**
     * An interface that defines how to map each variant of [Messaging10dlcGetEnumResponse] to a
     * value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [Messaging10dlcGetEnumResponse] to a value of type [T].
         *
         * An instance of [Messaging10dlcGetEnumResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw TelnyxInvalidDataException("Unknown Messaging10dlcGetEnumResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<Messaging10dlcGetEnumResponse>(Messaging10dlcGetEnumResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): Messaging10dlcGetEnumResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<EnumObjectToStringResponse>())?.let {
                            Messaging10dlcGetEnumResponse(enumObjectToString = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<EnumObjecToObjecttResponse>())?.let {
                            Messaging10dlcGetEnumResponse(enumObjecToObjectt = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<EnumPaginatedResponse>())?.let {
                            Messaging10dlcGetEnumResponse(enumPaginated = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<String>>())?.let {
                            Messaging10dlcGetEnumResponse(enumStringList = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<EnumObject>>())?.let {
                            Messaging10dlcGetEnumResponse(enumObjectList = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> Messaging10dlcGetEnumResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<Messaging10dlcGetEnumResponse>(Messaging10dlcGetEnumResponse::class) {

        override fun serialize(
            value: Messaging10dlcGetEnumResponse,
