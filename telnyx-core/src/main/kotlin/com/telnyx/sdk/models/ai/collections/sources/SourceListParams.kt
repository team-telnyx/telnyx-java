...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SourceListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): SourceListParams =
            SourceListParams(uuid, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "SourceListParams{uuid=$uuid, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
