...
private constructor(
    private val data: JsonField<QueueCall>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<QueueCall> = JsonMissing.of()
     ...
     */
    fun data(): Optional<QueueCall> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<QueueCall> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<QueueCall> = JsonMissing.of()
        ...
        fun data(data: QueueCall) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [QueueCall] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<QueueCall>) = apply { this.data = data }
