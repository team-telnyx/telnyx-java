...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListResponse: EventListResponse) = apply {
            ...
            availableNotificationMethods =
                eventListResponse.availableNotificationMethods.map { it.toMutableList() }
            createdAt = eventListResponse.createdAt
            eventType = eventListResponse.eventType
            payload = eventListResponse.payload
            payloadStatus = eventListResponse.payloadStatus
            portingOrderId = eventListResponse.portingOrderId
            recordType = eventListResponse.recordType
            updatedAt = eventListResponse.updatedAt
         ...
         */
        fun payload(
            webhookPortingOrderMessagingChanged: Payload.WebhookPortingOrderMessagingChangedPayload
        ) =
            payload(
                Payload.ofWebhookPortingOrderMessagingChanged(webhookPortingOrderMessagingChanged)
            )
        ...
        ) = payload(Payload.ofWebhookPortingOrderStatusChanged(webhookPortingOrderStatusChanged))

        /**
         * Alias for calling [payload] with
         * `Payload.ofWebhookPortingOrderNewComment(webhookPortingOrderNewComment)`.
         */
        fun payload(webhookPortingOrderNewComment: Payload.WebhookPortingOrderNewCommentPayload) =
    ...
    private constructor(
        ...
        fun webhookPortingOrderStatusChanged(): Optional<WebhookPortingOrderStatusChangedPayload> =
        ...
        fun isWebhookPortingOrderStatusChanged(): Boolean = webhookPortingOrderStatusChanged != null
        ...
        /** The webhook payload for the porting_order.messaging_changed event */
        fun asWebhookPortingOrderMessagingChanged(): WebhookPortingOrderMessagingChangedPayload =
            webhookPortingOrderMessagingChanged.getOrThrow("webhookPortingOrderMessagingChanged")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                webhookPortingOrderStatusChanged != null ->
                    visitor.visitWebhookPortingOrderStatusChanged(webhookPortingOrderStatusChanged)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Payload &&
                ...
                webhookPortingOrderMessagingChanged == other.webhookPortingOrderMessagingChanged &&
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(
                                ...
                                ?.let { Payload(webhookPortingOrderDeleted = it, _json = json) },
                            tryDeserialize(
                                    node,
                                    jacksonTypeRef<WebhookPortingOrderMessagingChangedPayload>(),
                                )
                                ?.let {
                                    Payload(webhookPortingOrderMessagingChanged = it, _json = json)
                                },
                            tryDeserialize(
                                    node,
                            ...
                            tryDeserialize(
                                ...
                                ?.let { Payload(webhookPortingOrderNewComment = it, _json = json) },
                            tryDeserialize(node, jacksonTypeRef<WebhookPortingOrderSplitPayload>())
        ...
        private constructor(
             ...
             *
             * Unlike [supportKey], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("support_key")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(
                    ...
                    customerReference = webhookPortingOrderMessagingChangedPayload.customerReference
                ...
                /**
                 * Returns an immutable instance of [WebhookPortingOrderMessagingChangedPayload].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
            ...
            private constructor(
                 ...
                 *
                 * Unlike [messagingPortCompleted], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("messaging_port_completed")
                @ExcludeMissing
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                     ...
                     * [_UNKNOWN] member.
                     *
                     * An instance of [MessagingPortStatus] can contain an unknown value in a couple
                     * of cases:
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(
                    ...
                    customerReference = webhookPortingOrderStatusChangedPayload.customerReference
                    ...
                    additionalProperties =
                        webhookPortingOrderStatusChangedPayload.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.status] with a well-typed [PortingOrderStatus]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * `List<PortingPhoneNumber>` value instead. This method is primarily for setting
                 * the field to an undocumented or not yet supported value.
                 */
    ...
    override fun toString() =
        "EventListResponse{id=$id, availableNotificationMethods=$availableNotificationMethods, createdAt=$createdAt, eventType=$eventType, payload=$payload, payloadStatus=$payloadStatus, portingOrderId=$portingOrderId, recordType=$recordType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
