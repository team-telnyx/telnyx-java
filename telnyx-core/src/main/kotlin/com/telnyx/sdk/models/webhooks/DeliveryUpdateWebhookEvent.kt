...
class DeliveryUpdateWebhookEvent
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<OutboundMessage>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<OutboundMessage> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<OutboundMessage> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<OutboundMessage> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeliveryUpdateWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DeliveryUpdateWebhookEvent]. */
    class Builder internal constructor() {

        private var data: JsonField<OutboundMessage> = JsonMissing.of()
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(deliveryUpdateWebhookEvent: DeliveryUpdateWebhookEvent) = apply {
            data = deliveryUpdateWebhookEvent.data
            meta = deliveryUpdateWebhookEvent.meta
            additionalProperties = deliveryUpdateWebhookEvent.additionalProperties.toMutableMap()
        }

        fun data(data: OutboundMessage) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [OutboundMessage] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<OutboundMessage>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [DeliveryUpdateWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DeliveryUpdateWebhookEvent =
            DeliveryUpdateWebhookEvent(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): DeliveryUpdateWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeliveryUpdateWebhookEvent &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DeliveryUpdateWebhookEvent{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
