...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MessageWhatsappResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageWhatsappResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageWhatsappResponse: MessageWhatsappResponse) = apply {
            data = messageWhatsappResponse.data
            additionalProperties = messageWhatsappResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageWhatsappResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessageWhatsappResponse =
            MessageWhatsappResponse(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): MessageWhatsappResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageWhatsappResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "MessageWhatsappResponse{data=$data, additionalProperties=$additionalProperties}"
}
