...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(logMessageListResponse: LogMessageListResponse) = apply {
            logMessages = logMessageListResponse.logMessages.map { it.toMutableList() }
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [LogMessage].
             *
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(logMessage: LogMessage) = apply {
                code = logMessage.code
                title = logMessage.title
                detail = logMessage.detail
                meta = logMessage.meta
                source = logMessage.source
                additionalProperties = logMessage.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [LogMessage].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun telephoneNumber(): Optional<String> =
                telephoneNumber.getOptional("telephone_number")
             ...
             *
             * Unlike [telephoneNumber], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("telephone_number")
            @ExcludeMissing
             ...
             *
             * Unlike [ticketId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.telephoneNumber] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.ticketId] with a well-typed [String] value
        ...
        override fun toString() =
            "LogMessage{code=$code, title=$title, detail=$detail, meta=$meta, source=$source, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "LogMessageListResponse{logMessages=$logMessages, meta=$meta, additionalProperties=$additionalProperties}"
}
