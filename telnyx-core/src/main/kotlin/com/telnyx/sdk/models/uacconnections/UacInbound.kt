...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UacInbound]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacInbound]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uacInbound: UacInbound) = apply {
            aniNumberFormat = uacInbound.aniNumberFormat
            channelLimit = uacInbound.channelLimit
            codecs = uacInbound.codecs.map { it.toMutableList() }
            defaultRoutingMethod = uacInbound.defaultRoutingMethod
            dnisNumberFormat = uacInbound.dnisNumberFormat
            generateRingbackTone = uacInbound.generateRingbackTone
            isupHeadersEnabled = uacInbound.isupHeadersEnabled
            prackEnabled = uacInbound.prackEnabled
            shakenStirEnabled = uacInbound.shakenStirEnabled
            simultaneousRinging = uacInbound.simultaneousRinging
            sipCompactHeadersEnabled = uacInbound.sipCompactHeadersEnabled
            sipRegion = uacInbound.sipRegion
            sipSubdomain = uacInbound.sipSubdomain
            sipSubdomainReceiveSettings = uacInbound.sipSubdomainReceiveSettings
            timeout1xxSecs = uacInbound.timeout1xxSecs
            timeout2xxSecs = uacInbound.timeout2xxSecs
            additionalProperties = uacInbound.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UacInbound].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacInbound =
            UacInbound(
                aniNumberFormat,
                channelLimit,
