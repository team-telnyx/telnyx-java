...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallSpeakEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallSpeakEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callSpeakEnded: CallSpeakEnded) = apply {
            id = callSpeakEnded.id
            eventType = callSpeakEnded.eventType
            occurredAt = callSpeakEnded.occurredAt
            payload = callSpeakEnded.payload
            recordType = callSpeakEnded.recordType
            additionalProperties = callSpeakEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallSpeakEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallSpeakEnded =
            CallSpeakEnded(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallSpeakEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallSpeakEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallSpeakEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
