...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageSendGroupMmsResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageSendGroupMmsResponse: MessageSendGroupMmsResponse) = apply {
            data = messageSendGroupMmsResponse.data
        ...
        /**
         * Returns an immutable instance of [MessageSendGroupMmsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessageSendGroupMmsResponse =
            MessageSendGroupMmsResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): MessageSendGroupMmsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageSendGroupMmsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MessageSendGroupMmsResponse{data=$data, additionalProperties=$additionalProperties}"
}
