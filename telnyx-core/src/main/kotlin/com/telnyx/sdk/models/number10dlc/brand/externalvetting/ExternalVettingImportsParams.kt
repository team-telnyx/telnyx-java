 ...
 */
class ExternalVettingImportsParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalVettingImportsParams].
         *
    ...
    /** A builder for [ExternalVettingImportsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVettingImportsParams: ExternalVettingImportsParams) = apply {
            brandId = externalVettingImportsParams.brandId
            body = externalVettingImportsParams.body.toBuilder()
            additionalHeaders = externalVettingImportsParams.additionalHeaders.toBuilder()
            additionalQueryParams = externalVettingImportsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingImportsParams].
         *
         ...
         */
        fun build(): ExternalVettingImportsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingImportsParams &&
    ...
    override fun toString() =
        "ExternalVettingImportsParams{brandId=$brandId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
