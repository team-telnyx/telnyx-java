...
/**
 * Validate the verification codes sent to the numbers of the hosted order. The verification codes
 * must be created in the verification codes endpoint.
 */
class MessagingHostedNumberOrderValidateCodesParams
private constructor(
     ...
     */
    fun verificationCodes(): List<VerificationCode> = body.verificationCodes()
    ...
    /** A builder for [MessagingHostedNumberOrderValidateCodesParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = messagingHostedNumberOrderValidateCodesParams.id
            body = messagingHostedNumberOrderValidateCodesParams.body.toBuilder()
            additionalHeaders =
                messagingHostedNumberOrderValidateCodesParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                messagingHostedNumberOrderValidateCodesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingHostedNumberOrderValidateCodesParams].
         *
         ...
         */
        fun build(): MessagingHostedNumberOrderValidateCodesParams =
            MessagingHostedNumberOrderValidateCodesParams(
                id,
                body.build(),
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun verificationCodes(): List<VerificationCode> =
            verificationCodes.getRequired("verification_codes")
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                    checkRequired("verificationCodes", verificationCodes).map { it.toImmutable() },
        ...
        fun validate(): Body = apply {
            ...
            verificationCodes().forEach { it.validate() }
            validated = true
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingHostedNumberOrderValidateCodesParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "MessagingHostedNumberOrderValidateCodesParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
