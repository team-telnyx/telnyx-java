...
class CallRecordingTranscriptionSaved
...
private constructor(
    ...
    /** A builder for [CallRecordingTranscriptionSaved]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callRecordingTranscriptionSaved: CallRecordingTranscriptionSaved) =
            apply {
                id = callRecordingTranscriptionSaved.id
                eventType = callRecordingTranscriptionSaved.eventType
                occurredAt = callRecordingTranscriptionSaved.occurredAt
                payload = callRecordingTranscriptionSaved.payload
                recordType = callRecordingTranscriptionSaved.recordType
                additionalProperties =
                    callRecordingTranscriptionSaved.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallRecordingTranscriptionSaved].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallRecordingTranscriptionSaved =
            CallRecordingTranscriptionSaved(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallRecordingTranscriptionSaved = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.recordingTranscriptionId] with a well-typed [String]
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallRecordingTranscriptionSaved &&
            id == other.id &&
    ...
    override fun toString() =
        "CallRecordingTranscriptionSaved{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
