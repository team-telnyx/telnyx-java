...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): CommentCreateResponse =
            CommentCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * supported value.
             */
            fun authorRole(authorRole: JsonField<AuthorRole>) = apply {
        ...
        /** Who wrote the comment. `admin` covers the Telnyx vetting team. */
        class AuthorRole @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            enum class Value {
                ...
                ADMIN,
                /**
                 * An enum member indicating that [AuthorRole] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
        ...
        class CommentType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            enum class Value {
                ...
                ADMIN_RESPONSE,
                /**
                 * An enum member indicating that [CommentType] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
        ...
        class Visibility @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            enum class Value {
                CUSTOMER,
                /**
                 * An enum member indicating that [Visibility] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
        ...
        override fun toString() =
            "Data{id=$id, authorName=$authorName, authorRole=$authorRole, commentType=$commentType, content=$content, createdAt=$createdAt, entityType=$entityType, visibility=$visibility, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommentCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CommentCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
