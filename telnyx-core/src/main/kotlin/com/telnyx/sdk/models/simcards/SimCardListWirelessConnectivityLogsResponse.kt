...
/**
 * This object represents a wireless connectivity session log that happened through a SIM card. It
 * aids in finding out potential problems when the SIM is not able to attach properly.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("last_seen") @ExcludeMissing lastSeen: JsonField<String> = JsonMissing.of(),
        @JsonProperty("log_type") @ExcludeMissing logType: JsonField<LogType> = JsonMissing.of(),
        ...
        @JsonProperty("stop_time") @ExcludeMissing stopTime: JsonField<String> = JsonMissing.of(),
    ) : this(
        id,
        apn,
        cellId,
    ...
    /**
     * The Access Point Name (APN) identifies the packet data network that a mobile data user wants
     * to communicate with.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    /**
     * The type of the session, 'registration' being the initial authentication session and 'data'
     * the actual data transfer sessions.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * It's a three decimal digit that identifies a country.<br/><br/> This code is commonly seen
     * joined with a Mobile Network Code (MNC) in a tuple that allows identifying a carrier known as
     * PLMN (Public Land Mobile Network) code.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun mobileCountryCode(): Optional<String> = mobileCountryCode.getOptional("mobile_country_code")

    /**
     * It's a two to three decimal digits that identify a network.<br/><br/> This code is commonly
     * seen joined with a Mobile Country Code (MCC) in a tuple that allows identifying a carrier
     * known as PLMN (Public Land Mobile Network) code.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun mobileNetworkCode(): Optional<String> = mobileNetworkCode.getOptional("mobile_network_code")
     ...
     *
     * Unlike [radioAccessTechnology], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("radio_access_technology")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = simCardListWirelessConnectivityLogsResponse.id
            apn = simCardListWirelessConnectivityLogsResponse.apn
            cellId = simCardListWirelessConnectivityLogsResponse.cellId
            createdAt = simCardListWirelessConnectivityLogsResponse.createdAt
            imei = simCardListWirelessConnectivityLogsResponse.imei
            imsi = simCardListWirelessConnectivityLogsResponse.imsi
            ipv4 = simCardListWirelessConnectivityLogsResponse.ipv4
            ipv6 = simCardListWirelessConnectivityLogsResponse.ipv6
            lastSeen = simCardListWirelessConnectivityLogsResponse.lastSeen
            logType = simCardListWirelessConnectivityLogsResponse.logType
            mobileCountryCode = simCardListWirelessConnectivityLogsResponse.mobileCountryCode
            mobileNetworkCode = simCardListWirelessConnectivityLogsResponse.mobileNetworkCode
            radioAccessTechnology =
                simCardListWirelessConnectivityLogsResponse.radioAccessTechnology
            recordType = simCardListWirelessConnectivityLogsResponse.recordType
            simCardId = simCardListWirelessConnectivityLogsResponse.simCardId
            startTime = simCardListWirelessConnectivityLogsResponse.startTime
            state = simCardListWirelessConnectivityLogsResponse.state
            stopTime = simCardListWirelessConnectivityLogsResponse.stopTime
         ...
         *
         * You should usually call [Builder.logType] with a well-typed [LogType] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.radioAccessTechnology] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.stopTime] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
