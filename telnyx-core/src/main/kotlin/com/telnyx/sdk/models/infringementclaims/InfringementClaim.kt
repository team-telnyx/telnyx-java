...
private constructor(
    ...
    private val contestDocuments: JsonField<List<Document>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        contestDocuments: JsonField<List<Document>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun contestDocuments(): Optional<List<Document>> =
    ...
    /**
     * Lifecycle status. `pending` - newly filed; the DIR is auto-suspended. `contested` - you have
     ...
     */
    @JsonProperty("claim_type") @ExcludeMissing fun _claimType(): JsonField<ClaimType> = claimType

    /**
     * Returns the raw JSON value of [claimantContact].
     *
     * Unlike [claimantContact], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("claimant_contact")
    @ExcludeMissing
     ...
     *
     * Unlike [claimantName], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("claimant_name")
    @ExcludeMissing
    ...
    @JsonProperty("contest_documents")
    @ExcludeMissing
    fun _contestDocuments(): JsonField<List<Document>> = contestDocuments

    /**
     * Returns the raw JSON value of [contestHistory].
     *
     * Unlike [contestHistory], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("contest_history")
    @ExcludeMissing
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [InfringementClaim]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InfringementClaim]. */
    class Builder internal constructor() {
        ...
        private var contestDocuments: JsonField<MutableList<Document>>? = null
        ...
        @JvmSynthetic
        internal fun from(infringementClaim: InfringementClaim) = apply {
            id = infringementClaim.id
            claimDate = infringementClaim.claimDate
            claimDescription = infringementClaim.claimDescription
            claimType = infringementClaim.claimType
            claimantContact = infringementClaim.claimantContact
            claimantName = infringementClaim.claimantName
            contestDocuments = infringementClaim.contestDocuments.map { it.toMutableList() }
            contestHistory = infringementClaim.contestHistory.map { it.toMutableList() }
            createdAt = infringementClaim.createdAt
            dir = infringementClaim.dir
            dirId = infringementClaim.dirId
            enterpriseId = infringementClaim.enterpriseId
            resolution = infringementClaim.resolution
            resolutionDate = infringementClaim.resolutionDate
            resolutionNotes = infringementClaim.resolutionNotes
            status = infringementClaim.status
            updatedAt = infringementClaim.updatedAt
            additionalProperties = infringementClaim.additionalProperties.toMutableMap()
        }
         ...
         * supported value.
         */
        fun claimDate(claimDate: JsonField<OffsetDateTime>) = apply { this.claimDate = claimDate }
         ...
         *
         * You should usually call [Builder.claimType] with a well-typed [ClaimType] value instead.
         ...
         *
         * You should usually call [Builder.claimantName] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /** Aggregated across all customer contest submissions on this claim. */
        fun contestDocuments(contestDocuments: List<Document>) =
            contestDocuments(JsonField.of(contestDocuments))

        /**
         * Sets [Builder.contestDocuments] to an arbitrary JSON value.
         *
         * You should usually call [Builder.contestDocuments] with a well-typed `List<Document>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun contestDocuments(contestDocuments: JsonField<List<Document>>) = apply {
            this.contestDocuments = contestDocuments.map { it.toMutableList() }
        }

        /**
         * Adds a single [Document] to [contestDocuments].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addContestDocument(contestDocument: Document) = apply {
            contestDocuments =
         ...
         *
         * You should usually call [Builder.contestHistory] with a well-typed `List<ContestHistory>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
         ...
         *
         * You should usually call [Builder.dir] with a well-typed [Dir] value instead. This method
        ...
        /**
         * Returns an immutable instance of [InfringementClaim].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InfringementClaim =
            InfringementClaim(
                id,
                claimDate,
                claimDescription,
     ...
     *   expected type.
     */
    fun validate(): InfringementClaim = apply {
        if (validated) {
            return@apply
        }
    ...
    /** Category of infringement being claimed. */
    class ClaimType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        enum class Value {
            ...
            COPYRIGHT,
            /**
             * An enum member indicating that [ClaimType] was instantiated with an unknown value.
             */
            _UNKNOWN,
        }
     ...
     * across rounds live on the parent claim's `contest_documents`; this submission record carries
     * only the per-round notes and document count.
     */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InfringementClaim &&
            id == other.id &&
