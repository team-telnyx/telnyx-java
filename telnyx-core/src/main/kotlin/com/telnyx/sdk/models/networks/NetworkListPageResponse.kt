...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [NetworkListPageResponse]. */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(networkListPageResponse: NetworkListPageResponse) = apply {
            data = networkListPageResponse.data.map { it.toMutableList() }
            meta = networkListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [NetworkListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NetworkListPageResponse =
            NetworkListPageResponse(
    ...
    fun validate(): NetworkListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NetworkListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "NetworkListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
