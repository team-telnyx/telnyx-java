...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): Messaging10dlcGetEnumParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [Messaging10dlcGetEnumParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [Messaging10dlcGetEnumParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messaging10dlcGetEnumParams: Messaging10dlcGetEnumParams) = apply {
            endpoint = messaging10dlcGetEnumParams.endpoint
            additionalHeaders = messaging10dlcGetEnumParams.additionalHeaders.toBuilder()
            additionalQueryParams = messaging10dlcGetEnumParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [Messaging10dlcGetEnumParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): Messaging10dlcGetEnumParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Messaging10dlcGetEnumParams &&
    ...
    override fun toString() =
        "Messaging10dlcGetEnumParams{endpoint=$endpoint, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
