...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntegrationConnection].
         *
    ...
    /** A builder for [IntegrationConnection]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(integrationConnection: IntegrationConnection) = apply {
            id = integrationConnection.id
            allowedTools = integrationConnection.allowedTools.map { it.toMutableList() }
            integrationId = integrationConnection.integrationId
            additionalProperties = integrationConnection.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegrationConnection].
         *
         ...
         */
        fun build(): IntegrationConnection =
    ...
    fun validate(): IntegrationConnection = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationConnection &&
            id == other.id &&
    ...
    override fun toString() =
        "IntegrationConnection{id=$id, allowedTools=$allowedTools, integrationId=$integrationId, additionalProperties=$additionalProperties}"
}
