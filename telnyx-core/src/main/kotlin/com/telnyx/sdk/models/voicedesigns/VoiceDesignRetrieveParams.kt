 ...
 */
class VoiceDesignRetrieveParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VoiceDesignRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceDesignRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceDesignRetrieveParams: VoiceDesignRetrieveParams) = apply {
            id = voiceDesignRetrieveParams.id
            version = voiceDesignRetrieveParams.version
            additionalHeaders = voiceDesignRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = voiceDesignRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceDesignRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceDesignRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceDesignRetrieveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "VoiceDesignRetrieveParams{id=$id, version=$version, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
