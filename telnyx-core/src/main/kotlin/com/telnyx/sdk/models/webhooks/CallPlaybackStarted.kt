...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallPlaybackStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallPlaybackStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callPlaybackStarted: CallPlaybackStarted) = apply {
            id = callPlaybackStarted.id
            eventType = callPlaybackStarted.eventType
            occurredAt = callPlaybackStarted.occurredAt
            payload = callPlaybackStarted.payload
            recordType = callPlaybackStarted.recordType
            additionalProperties = callPlaybackStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallPlaybackStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallPlaybackStarted =
            CallPlaybackStarted(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallPlaybackStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_PLAYBACK_STARTED = of("call.playback.started")
        ...
        fun value(): Value =
            when (this) {
                CALL_PLAYBACK_STARTED -> Value.CALL_PLAYBACK_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_PLAYBACK_STARTED -> Known.CALL_PLAYBACK_STARTED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, mediaName=$mediaName, mediaUrl=$mediaUrl, overlay=$overlay, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallPlaybackStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallPlaybackStarted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
