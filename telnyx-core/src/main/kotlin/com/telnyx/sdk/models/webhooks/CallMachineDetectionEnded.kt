...
class CallMachineDetectionEnded
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallMachineDetectionEnded].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallMachineDetectionEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callMachineDetectionEnded: CallMachineDetectionEnded) = apply {
            id = callMachineDetectionEnded.id
            eventType = callMachineDetectionEnded.eventType
            occurredAt = callMachineDetectionEnded.occurredAt
            payload = callMachineDetectionEnded.payload
            recordType = callMachineDetectionEnded.recordType
            additionalProperties = callMachineDetectionEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallMachineDetectionEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallMachineDetectionEnded =
    ...
    fun validate(): CallMachineDetectionEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_MACHINE_DETECTION_ENDED = of("call.machine.detection.ended")
        ...
        fun value(): Value =
            when (this) {
                CALL_MACHINE_DETECTION_ENDED -> Value.CALL_MACHINE_DETECTION_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_MACHINE_DETECTION_ENDED -> Known.CALL_MACHINE_DETECTION_ENDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallMachineDetectionEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "CallMachineDetectionEnded{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
