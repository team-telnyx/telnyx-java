...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SmsOtpTriggerResponse].
         *
    ...
    /** A builder for [SmsOtpTriggerResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(smsOtpTriggerResponse: SmsOtpTriggerResponse) = apply {
            brandId = smsOtpTriggerResponse.brandId
            referenceId = smsOtpTriggerResponse.referenceId
            additionalProperties = smsOtpTriggerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SmsOtpTriggerResponse].
         *
         ...
         */
        fun build(): SmsOtpTriggerResponse =
    ...
    fun validate(): SmsOtpTriggerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SmsOtpTriggerResponse &&
    ...
    override fun toString() =
        "SmsOtpTriggerResponse{brandId=$brandId, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}
