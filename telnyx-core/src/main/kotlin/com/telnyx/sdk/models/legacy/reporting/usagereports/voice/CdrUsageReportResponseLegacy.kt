...
class CdrUsageReportResponseLegacy
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CdrUsageReportResponseLegacy].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CdrUsageReportResponseLegacy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cdrUsageReportResponseLegacy: CdrUsageReportResponseLegacy) = apply {
            id = cdrUsageReportResponseLegacy.id
            aggregationType = cdrUsageReportResponseLegacy.aggregationType
            connections = cdrUsageReportResponseLegacy.connections.map { it.toMutableList() }
            createdAt = cdrUsageReportResponseLegacy.createdAt
            endTime = cdrUsageReportResponseLegacy.endTime
            productBreakdown = cdrUsageReportResponseLegacy.productBreakdown
            recordType = cdrUsageReportResponseLegacy.recordType
            reportUrl = cdrUsageReportResponseLegacy.reportUrl
            result = cdrUsageReportResponseLegacy.result
            startTime = cdrUsageReportResponseLegacy.startTime
            status = cdrUsageReportResponseLegacy.status
            updatedAt = cdrUsageReportResponseLegacy.updatedAt
            additionalProperties = cdrUsageReportResponseLegacy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CdrUsageReportResponseLegacy].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CdrUsageReportResponseLegacy =
    ...
    fun validate(): CdrUsageReportResponseLegacy = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CdrUsageReportResponseLegacy &&
            id == other.id &&
    ...
    override fun toString() =
        "CdrUsageReportResponseLegacy{id=$id, aggregationType=$aggregationType, connections=$connections, createdAt=$createdAt, endTime=$endTime, productBreakdown=$productBreakdown, recordType=$recordType, reportUrl=$reportUrl, result=$result, startTime=$startTime, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
