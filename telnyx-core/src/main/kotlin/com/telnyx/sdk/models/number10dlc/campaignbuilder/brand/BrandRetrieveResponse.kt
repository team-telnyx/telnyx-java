...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(brandRetrieveResponse: BrandRetrieveResponse) = apply {
            annualFee = brandRetrieveResponse.annualFee
            maxSubUsecases = brandRetrieveResponse.maxSubUsecases
            minSubUsecases = brandRetrieveResponse.minSubUsecases
            mnoMetadata = brandRetrieveResponse.mnoMetadata
            monthlyFee = brandRetrieveResponse.monthlyFee
            quarterlyFee = brandRetrieveResponse.quarterlyFee
            usecase = brandRetrieveResponse.usecase
    ...
    override fun toString() =
        "BrandRetrieveResponse{annualFee=$annualFee, maxSubUsecases=$maxSubUsecases, minSubUsecases=$minSubUsecases, mnoMetadata=$mnoMetadata, monthlyFee=$monthlyFee, quarterlyFee=$quarterlyFee, usecase=$usecase, additionalProperties=$additionalProperties}"
}
