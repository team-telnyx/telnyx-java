...
class NumberReservationListParams
private constructor(
     ...
     * filter[created_at], filter[phone_numbers.phone_number], filter[customer_reference]
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): NumberReservationListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [NumberReservationListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NumberReservationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberReservationListParams: NumberReservationListParams) = apply {
            filter = numberReservationListParams.filter
            pageNumber = numberReservationListParams.pageNumber
            pageSize = numberReservationListParams.pageSize
            additionalHeaders = numberReservationListParams.additionalHeaders.toBuilder()
            additionalQueryParams = numberReservationListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NumberReservationListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NumberReservationListParams =
        ...
        QueryParams.builder()
            .apply {
                filter?.let {
                    ...
                    it.phoneNumbersPhoneNumber().ifPresent {
                        put("filter[phone_numbers.phone_number]", it)
                    }
    ...
    private constructor(
        ...
        private val phoneNumbersPhoneNumber: String?,
        ...
        fun phoneNumbersPhoneNumber(): Optional<String> =
            Optional.ofNullable(phoneNumbersPhoneNumber)
        ...
        class Builder internal constructor() {
            ...
            private var phoneNumbersPhoneNumber: String? = null
            ...
            internal fun from(filter: Filter) = apply {
                ...
                phoneNumbersPhoneNumber = filter.phoneNumbersPhoneNumber
            ...
            /** Filter number reservations having these phone numbers. */
            fun phoneNumbersPhoneNumber(phoneNumbersPhoneNumber: String?) = apply {
                this.phoneNumbersPhoneNumber = phoneNumbersPhoneNumber
            }

            /**
             * Alias for calling [Builder.phoneNumbersPhoneNumber] with
             * `phoneNumbersPhoneNumber.orElse(null)`.
             */
            fun phoneNumbersPhoneNumber(phoneNumbersPhoneNumber: Optional<String>) =
                phoneNumbersPhoneNumber(phoneNumbersPhoneNumber.getOrNull())
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Filter &&
                ...
                phoneNumbersPhoneNumber == other.phoneNumbersPhoneNumber &&
                status == other.status &&
                additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() =
            "Filter{createdAt=$createdAt, customerReference=$customerReference, phoneNumbersPhoneNumber=$phoneNumbersPhoneNumber, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberReservationListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "NumberReservationListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
