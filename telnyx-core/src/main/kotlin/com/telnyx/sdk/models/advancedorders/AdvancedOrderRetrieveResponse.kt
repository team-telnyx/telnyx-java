...
class AdvancedOrderRetrieveResponse
...
private constructor(
    ...
    /** A builder for [AdvancedOrderRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(advancedOrderRetrieveResponse: AdvancedOrderRetrieveResponse) = apply {
            id = advancedOrderRetrieveResponse.id
            areaCode = advancedOrderRetrieveResponse.areaCode
            comments = advancedOrderRetrieveResponse.comments
            countryCode = advancedOrderRetrieveResponse.countryCode
            customerReference = advancedOrderRetrieveResponse.customerReference
            features = advancedOrderRetrieveResponse.features.map { it.toMutableList() }
            orders = advancedOrderRetrieveResponse.orders.map { it.toMutableList() }
            phoneNumberType =
                advancedOrderRetrieveResponse.phoneNumberType.map { it.toMutableList() }
            quantity = advancedOrderRetrieveResponse.quantity
            requirementGroupId = advancedOrderRetrieveResponse.requirementGroupId
            status = advancedOrderRetrieveResponse.status.map { it.toMutableList() }
            additionalProperties = advancedOrderRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AdvancedOrderRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AdvancedOrderRetrieveResponse =
            AdvancedOrderRetrieveResponse(
                id,
                areaCode,
                comments,
    ...
    fun validate(): AdvancedOrderRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdvancedOrderRetrieveResponse &&
            id == other.id &&
