...
class UsageReportListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<UsageReportListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<UsageReportListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<UsageReportListResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<UsageReportListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageReportListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UsageReportListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<UsageReportListResponse>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(usageReportListPageResponse: UsageReportListPageResponse) = apply {
            data = usageReportListPageResponse.data.map { it.toMutableList() }
            meta = usageReportListPageResponse.meta
            additionalProperties = usageReportListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<UsageReportListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<UsageReportListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<UsageReportListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [UsageReportListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: UsageReportListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [UsageReportListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UsageReportListPageResponse =
            UsageReportListPageResponse(
    ...
    fun validate(): UsageReportListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Meta{pageNumber=$pageNumber, totalPages=$totalPages, pageSize=$pageSize, totalResults=$totalResults, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageReportListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "UsageReportListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
