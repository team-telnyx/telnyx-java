...
private constructor(
    ...
    /** A builder for [CallControlApplicationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callControlApplicationCreateParams: CallControlApplicationCreateParams) =
            apply {
                body = callControlApplicationCreateParams.body.toBuilder()
                additionalHeaders = callControlApplicationCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    callControlApplicationCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CallControlApplicationCreateParams].
         *
         ...
         */
        fun build(): CallControlApplicationCreateParams =
            CallControlApplicationCreateParams(
                body.build(),
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{applicationName=$applicationName, webhookEventUrl=$webhookEventUrl, active=$active, anchorsiteOverride=$anchorsiteOverride, callCostInWebhooks=$callCostInWebhooks, dtmfType=$dtmfType, firstCommandTimeout=$firstCommandTimeout, firstCommandTimeoutSecs=$firstCommandTimeoutSecs, inbound=$inbound, outbound=$outbound, redactDtmfDebugLogging=$redactDtmfDebugLogging, webhookApiVersion=$webhookApiVersion, webhookEventFailoverUrl=$webhookEventFailoverUrl, webhookTimeoutSecs=$webhookTimeoutSecs, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallControlApplicationCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CallControlApplicationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
