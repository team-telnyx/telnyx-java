...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SourceListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SourceListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceListResponse: SourceListResponse) = apply {
            data = sourceListResponse.data.map { it.toMutableList() }
            additionalProperties = sourceListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SourceListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SourceListResponse =
            SourceListResponse(
     ...
     *   expected type.
     */
    fun validate(): SourceListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SourceListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SourceListResponse{data=$data, additionalProperties=$additionalProperties}"
}
