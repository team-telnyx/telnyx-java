...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(assistantImportsParams: AssistantImportsParams) = apply {
            idempotencyKey = assistantImportsParams.idempotencyKey
    ...
    override fun toString() =
        "AssistantImportsParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
