...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PortingVerificationCode]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingVerificationCode]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingVerificationCode: PortingVerificationCode) = apply {
            id = portingVerificationCode.id
            createdAt = portingVerificationCode.createdAt
            phoneNumber = portingVerificationCode.phoneNumber
            portingOrderId = portingVerificationCode.portingOrderId
            recordType = portingVerificationCode.recordType
            updatedAt = portingVerificationCode.updatedAt
            verified = portingVerificationCode.verified
            additionalProperties = portingVerificationCode.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortingVerificationCode].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingVerificationCode =
     ...
     *   expected type.
     */
    fun validate(): PortingVerificationCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingVerificationCode &&
            id == other.id &&
    ...
    override fun toString() =
        "PortingVerificationCode{id=$id, createdAt=$createdAt, phoneNumber=$phoneNumber, portingOrderId=$portingOrderId, recordType=$recordType, updatedAt=$updatedAt, verified=$verified, additionalProperties=$additionalProperties}"
}
