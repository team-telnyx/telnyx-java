...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallStreamingFailed]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallStreamingFailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callStreamingFailed: CallStreamingFailed) = apply {
            id = callStreamingFailed.id
            eventType = callStreamingFailed.eventType
            occurredAt = callStreamingFailed.occurredAt
            payload = callStreamingFailed.payload
            recordType = callStreamingFailed.recordType
            additionalProperties = callStreamingFailed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallStreamingFailed].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallStreamingFailed =
            CallStreamingFailed(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallStreamingFailed = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Streaming parameters as they were originally given to the Call Control API. */
            fun streamParams(streamParams: StreamParams) = streamParams(JsonField.of(streamParams))

            /**
             * Sets [Builder.streamParams] to an arbitrary JSON value.
             *
             * You should usually call [Builder.streamParams] with a well-typed [StreamParams] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.track] with a well-typed [Track] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallStreamingFailed &&
            id == other.id &&
    ...
    override fun toString() =
        "CallStreamingFailed{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
