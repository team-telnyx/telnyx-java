...
class SessionStatusChangedWebhookEvent
...
private constructor(
    ...
    /** A builder for [SessionStatusChangedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionStatusChangedWebhookEvent: SessionStatusChangedWebhookEvent) =
            apply {
                id = sessionStatusChangedWebhookEvent.id
                data = sessionStatusChangedWebhookEvent.data
                event = sessionStatusChangedWebhookEvent.event
                occurredAt = sessionStatusChangedWebhookEvent.occurredAt
                version = sessionStatusChangedWebhookEvent.version
                additionalProperties =
                    sessionStatusChangedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SessionStatusChangedWebhookEvent].
         *
         ...
         */
        fun build(): SessionStatusChangedWebhookEvent =
            SessionStatusChangedWebhookEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): SessionStatusChangedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            recording: JsonField<Boolean> = JsonMissing.of(),
        ...
        ) : this(recording, sessionId, status, statusDetail, mutableMapOf())
        ...
        /**
         * Additional detail about the status (for example `timeout_exceeded_everyone_left` or
         * `cancelled`), or null.
         *
         ...
         *
         * Unlike [statusDetail], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("status_detail")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.recording] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * `cancelled`), or null.
             */
            fun statusDetail(statusDetail: String?) =
                statusDetail(JsonField.ofNullable(statusDetail))

            /** Alias for calling [Builder.statusDetail] with `statusDetail.orElse(null)`. */
            fun statusDetail(statusDetail: Optional<String>) =
                statusDetail(statusDetail.getOrNull())

            /**
             * Sets [Builder.statusDetail] to an arbitrary JSON value.
             *
             * You should usually call [Builder.statusDetail] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(recording, sessionId, status, statusDetail, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{recording=$recording, sessionId=$sessionId, status=$status, statusDetail=$statusDetail, additionalProperties=$additionalProperties}"
    }
    ...
    class Event @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SESSION_STATUS_CHANGED = of("session.status_changed")
        ...
        fun value(): Value =
            when (this) {
                SESSION_STATUS_CHANGED -> Value.SESSION_STATUS_CHANGED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SESSION_STATUS_CHANGED -> Known.SESSION_STATUS_CHANGED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionStatusChangedWebhookEvent &&
            id == other.id &&
            data == other.data &&
            event == other.event &&
    ...
    override fun toString() =
        "SessionStatusChangedWebhookEvent{id=$id, data=$data, event=$event, occurredAt=$occurredAt, version=$version, additionalProperties=$additionalProperties}"
}
