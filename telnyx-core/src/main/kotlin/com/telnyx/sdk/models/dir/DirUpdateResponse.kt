...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirUpdateResponse].
         *
    ...
    /** A builder for [DirUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirUpdateResponse: DirUpdateResponse) = apply {
            data = dirUpdateResponse.data
            additionalProperties = dirUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirUpdateResponse].
         *
         ...
         */
        fun build(): DirUpdateResponse =
            DirUpdateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): DirUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DirUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
