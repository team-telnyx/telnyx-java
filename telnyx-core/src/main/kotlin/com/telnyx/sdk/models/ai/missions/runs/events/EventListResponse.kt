...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListResponse: EventListResponse) = apply {
            eventId = eventListResponse.eventId
            runId = eventListResponse.runId
            summary = eventListResponse.summary
            timestamp = eventListResponse.timestamp
            type = eventListResponse.type
            agentId = eventListResponse.agentId
            idempotencyKey = eventListResponse.idempotencyKey
            payload = eventListResponse.payload
            stepId = eventListResponse.stepId
    ...
    override fun toString() =
        "EventListResponse{eventId=$eventId, runId=$runId, summary=$summary, timestamp=$timestamp, type=$type, agentId=$agentId, idempotencyKey=$idempotencyKey, payload=$payload, stepId=$stepId, additionalProperties=$additionalProperties}"
}
