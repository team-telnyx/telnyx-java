...
private constructor(
    private val data: JsonField<CallHangup>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CallHangup> = JsonMissing.of()
     ...
     */
    fun data(): Optional<CallHangup> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CallHangup> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<CallHangup> = JsonMissing.of()
        ...
        fun data(data: CallHangup) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CallHangup] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<CallHangup>) = apply { this.data = data }
