...
class PartnerCampaignListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PartnerCampaignListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PartnerCampaignListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(partnerCampaignListResponse: PartnerCampaignListResponse) = apply {
            page = partnerCampaignListResponse.page
            records = partnerCampaignListResponse.records.map { it.toMutableList() }
            totalRecords = partnerCampaignListResponse.totalRecords
            additionalProperties = partnerCampaignListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignListResponse =
    ...
    fun validate(): PartnerCampaignListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignListResponse &&
            page == other.page &&
    ...
    override fun toString() =
        "PartnerCampaignListResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
