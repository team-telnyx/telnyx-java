...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageSendLongCodeParams].
         *
    ...
    /** A builder for [MessageSendLongCodeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageSendLongCodeParams: MessageSendLongCodeParams) = apply {
            body = messageSendLongCodeParams.body.toBuilder()
            additionalHeaders = messageSendLongCodeParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageSendLongCodeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessageSendLongCodeParams].
         *
         ...
         */
        fun build(): MessageSendLongCodeParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{from=$from, to=$to, autoDetect=$autoDetect, encoding=$encoding, mediaUrls=$mediaUrls, subject=$subject, text=$text, type=$type, useProfileWebhooks=$useProfileWebhooks, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageSendLongCodeParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MessageSendLongCodeParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
