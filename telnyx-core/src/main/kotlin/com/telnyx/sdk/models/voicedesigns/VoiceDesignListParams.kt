...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VoiceDesignListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoiceDesignListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(voiceDesignListParams: VoiceDesignListParams) = apply {
            filterName = voiceDesignListParams.filterName
            pageNumber = voiceDesignListParams.pageNumber
            pageSize = voiceDesignListParams.pageSize
            sort = voiceDesignListParams.sort
            additionalHeaders = voiceDesignListParams.additionalHeaders.toBuilder()
            additionalQueryParams = voiceDesignListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VoiceDesignListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VoiceDesignListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VoiceDesignListParams &&
    ...
    override fun toString() =
        "VoiceDesignListParams{filterName=$filterName, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
