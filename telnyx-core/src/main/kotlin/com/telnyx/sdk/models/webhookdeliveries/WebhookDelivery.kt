...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WebhookDelivery]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebhookDelivery]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookDelivery: WebhookDelivery) = apply {
            id = webhookDelivery.id
            attempts = webhookDelivery.attempts.map { it.toMutableList() }
            finishedAt = webhookDelivery.finishedAt
            recordType = webhookDelivery.recordType
            startedAt = webhookDelivery.startedAt
            status = webhookDelivery.status
            userId = webhookDelivery.userId
            webhook = webhookDelivery.webhook
            additionalProperties = webhookDelivery.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookDelivery].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookDelivery =
            WebhookDelivery(
                id,
     ...
     *   expected type.
     */
    fun validate(): WebhookDelivery = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookDelivery &&
            id == other.id &&
    ...
    override fun toString() =
        "WebhookDelivery{id=$id, attempts=$attempts, finishedAt=$finishedAt, recordType=$recordType, startedAt=$startedAt, status=$status, userId=$userId, webhook=$webhook, additionalProperties=$additionalProperties}"
}
