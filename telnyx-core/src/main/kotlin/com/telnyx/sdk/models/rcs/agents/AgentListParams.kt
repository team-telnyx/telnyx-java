...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentListParams: AgentListParams) = apply {
            brandId = agentListParams.brandId
        ...
        fun build(): AgentListParams =
            AgentListParams(brandId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AgentListParams{brandId=$brandId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
