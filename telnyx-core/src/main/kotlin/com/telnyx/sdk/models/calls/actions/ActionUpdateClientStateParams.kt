...
private constructor(
     ...
     */
    fun clientState(): String = body.clientState()
    ...
    /** A builder for [ActionUpdateClientStateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionUpdateClientStateParams: ActionUpdateClientStateParams) = apply {
            callControlId = actionUpdateClientStateParams.callControlId
            body = actionUpdateClientStateParams.body.toBuilder()
            additionalHeaders = actionUpdateClientStateParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionUpdateClientStateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionUpdateClientStateParams].
         *
         ...
         */
        fun build(): ActionUpdateClientStateParams =
            ActionUpdateClientStateParams(
                callControlId,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("clientState", clientState), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (clientState.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(clientState, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{clientState=$clientState, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionUpdateClientStateParams &&
    ...
    override fun toString() =
        "ActionUpdateClientStateParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
