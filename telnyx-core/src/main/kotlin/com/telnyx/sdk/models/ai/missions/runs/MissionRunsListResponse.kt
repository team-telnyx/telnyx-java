...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MissionRunsListResponse].
         *
    ...
    /** A builder for [MissionRunsListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionRunsListResponse: MissionRunsListResponse) = apply {
            data = missionRunsListResponse.data.map { it.toMutableList() }
            meta = missionRunsListResponse.meta
            additionalProperties = missionRunsListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MissionRunsListResponse].
         *
         ...
         */
        fun build(): MissionRunsListResponse =
     ...
     *   expected type.
     */
    fun validate(): MissionRunsListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MissionRunsListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "MissionRunsListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
