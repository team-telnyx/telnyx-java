...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunListRunsPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runListRunsPageResponse: RunListRunsPageResponse) = apply {
            data = runListRunsPageResponse.data.map { it.toMutableList() }
            meta = runListRunsPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [RunListRunsPageResponse].
         *
         ...
         */
        fun build(): RunListRunsPageResponse =
            RunListRunsPageResponse(
    ...
    fun validate(): RunListRunsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunListRunsPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "RunListRunsPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
