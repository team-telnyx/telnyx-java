...
class PhoneNumberAssignmentByProfileGetTaskStatusResponse
...
private constructor(
    ...
    /** A builder for [PhoneNumberAssignmentByProfileGetTaskStatusResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            status = phoneNumberAssignmentByProfileGetTaskStatusResponse.status
            taskId = phoneNumberAssignmentByProfileGetTaskStatusResponse.taskId
            createdAt = phoneNumberAssignmentByProfileGetTaskStatusResponse.createdAt
            updatedAt = phoneNumberAssignmentByProfileGetTaskStatusResponse.updatedAt
            additionalProperties =
                phoneNumberAssignmentByProfileGetTaskStatusResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberAssignmentByProfileGetTaskStatusResponse].
         *
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileGetTaskStatusResponse =
            PhoneNumberAssignmentByProfileGetTaskStatusResponse(
    ...
    fun validate(): PhoneNumberAssignmentByProfileGetTaskStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileGetTaskStatusResponse &&
            status == other.status &&
            taskId == other.taskId &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileGetTaskStatusResponse{status=$status, taskId=$taskId, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
