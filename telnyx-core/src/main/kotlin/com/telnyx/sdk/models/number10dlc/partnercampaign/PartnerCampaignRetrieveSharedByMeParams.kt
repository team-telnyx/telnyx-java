 ...
 * endpoint.
 */
class PartnerCampaignRetrieveSharedByMeParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PartnerCampaignRetrieveSharedByMeParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [PartnerCampaignRetrieveSharedByMeParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PartnerCampaignRetrieveSharedByMeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            partnerCampaignRetrieveSharedByMeParams: PartnerCampaignRetrieveSharedByMeParams
        ) = apply {
            page = partnerCampaignRetrieveSharedByMeParams.page
            recordsPerPage = partnerCampaignRetrieveSharedByMeParams.recordsPerPage
            additionalHeaders =
                partnerCampaignRetrieveSharedByMeParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                partnerCampaignRetrieveSharedByMeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignRetrieveSharedByMeParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignRetrieveSharedByMeParams =
            PartnerCampaignRetrieveSharedByMeParams(
                page,
                recordsPerPage,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignRetrieveSharedByMeParams &&
            page == other.page &&
    ...
    override fun toString() =
        "PartnerCampaignRetrieveSharedByMeParams{page=$page, recordsPerPage=$recordsPerPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
