...
class AdvancedOrderCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AdvancedOrderCreateResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AdvancedOrderCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(advancedOrderCreateResponse: AdvancedOrderCreateResponse) = apply {
            id = advancedOrderCreateResponse.id
            areaCode = advancedOrderCreateResponse.areaCode
            comments = advancedOrderCreateResponse.comments
            countryCode = advancedOrderCreateResponse.countryCode
            customerReference = advancedOrderCreateResponse.customerReference
            features = advancedOrderCreateResponse.features.map { it.toMutableList() }
            orders = advancedOrderCreateResponse.orders.map { it.toMutableList() }
            phoneNumberType = advancedOrderCreateResponse.phoneNumberType.map { it.toMutableList() }
            quantity = advancedOrderCreateResponse.quantity
            requirementGroupId = advancedOrderCreateResponse.requirementGroupId
            status = advancedOrderCreateResponse.status.map { it.toMutableList() }
            additionalProperties = advancedOrderCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AdvancedOrderCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AdvancedOrderCreateResponse =
    ...
    fun validate(): AdvancedOrderCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdvancedOrderCreateResponse &&
            id == other.id &&
