...
class DirUpdateInfringementResponse
...
private constructor(
    ...
    /** A builder for [DirUpdateInfringementResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dirUpdateInfringementResponse: DirUpdateInfringementResponse) = apply {
            data = dirUpdateInfringementResponse.data
            additionalProperties = dirUpdateInfringementResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DirUpdateInfringementResponse].
         *
         ...
         */
        fun build(): DirUpdateInfringementResponse =
            DirUpdateInfringementResponse(
     ...
     *   expected type.
     */
    fun validate(): DirUpdateInfringementResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DirUpdateInfringementResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DirUpdateInfringementResponse{data=$data, additionalProperties=$additionalProperties}"
}
