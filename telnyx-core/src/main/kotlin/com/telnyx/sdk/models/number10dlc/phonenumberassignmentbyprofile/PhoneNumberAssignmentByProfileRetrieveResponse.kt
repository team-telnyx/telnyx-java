...
class PhoneNumberAssignmentByProfileRetrieveResponse
...
private constructor(
    ...
    /** A builder for [PhoneNumberAssignmentByProfileRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            status = phoneNumberAssignmentByProfileRetrieveResponse.status
            taskId = phoneNumberAssignmentByProfileRetrieveResponse.taskId
            createdAt = phoneNumberAssignmentByProfileRetrieveResponse.createdAt
            updatedAt = phoneNumberAssignmentByProfileRetrieveResponse.updatedAt
            additionalProperties =
                phoneNumberAssignmentByProfileRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberAssignmentByProfileRetrieveResponse].
         *
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileRetrieveResponse =
            PhoneNumberAssignmentByProfileRetrieveResponse(
    ...
    fun validate(): PhoneNumberAssignmentByProfileRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileRetrieveResponse &&
            status == other.status &&
            taskId == other.taskId &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileRetrieveResponse{status=$status, taskId=$taskId, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
