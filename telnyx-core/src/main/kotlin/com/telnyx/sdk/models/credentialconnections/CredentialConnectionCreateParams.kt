...
private constructor(
    ...
    /** A builder for [CredentialConnectionCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(credentialConnectionCreateParams: CredentialConnectionCreateParams) =
            apply {
                body = credentialConnectionCreateParams.body.toBuilder()
                additionalHeaders = credentialConnectionCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    credentialConnectionCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CredentialConnectionCreateParams].
         *
         ...
         */
        fun build(): CredentialConnectionCreateParams =
            CredentialConnectionCreateParams(
                body.build(),
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun userName(): String = userName.getRequired("user_name")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CredentialConnectionCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "CredentialConnectionCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
