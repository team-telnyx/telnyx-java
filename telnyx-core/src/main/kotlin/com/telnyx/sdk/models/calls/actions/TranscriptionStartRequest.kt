...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun transcriptionEngineConfig(deepgram: TranscriptionEngineDeepgramConfig) =
        ...
        fun deepgramTranscriptionEngineConfig(
            ...
            transcriptionEngineConfig(
                TranscriptionEngineDeepgramConfig.builder()
                    .transcriptionEngine(
                        TranscriptionEngineDeepgramConfig.TranscriptionEngine.DEEPGRAM
                    )
                    .transcriptionModel(transcriptionModel)
                    .build()
            )
    ...
    private constructor(
        ...
        private val deepgram: TranscriptionEngineDeepgramConfig? = null,
        ...
        fun deepgram(): Optional<TranscriptionEngineDeepgramConfig> = Optional.ofNullable(deepgram)
        ...
        fun asDeepgram(): TranscriptionEngineDeepgramConfig = deepgram.getOrThrow("deepgram")
        ...
        fun validate(): TranscriptionEngineConfig = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitDeepgram(deepgram: TranscriptionEngineDeepgramConfig) {
                        deepgram.validate()
                    }
        ...
        companion object {
            ...
            @JvmStatic
            fun ofDeepgram(deepgram: TranscriptionEngineDeepgramConfig) =
                TranscriptionEngineConfig(deepgram = deepgram)
        ...
        interface Visitor<out T> {
            ...
            fun visitDeepgram(deepgram: TranscriptionEngineDeepgramConfig): T
                ...
                when (transcriptionEngine) {
                    ...
                    "Deepgram" -> {
                        return tryDeserialize(
                            ...
                            ?.let { TranscriptionEngineConfig(deepgram = it, _json = json) }
                            ?: TranscriptionEngineConfig(_json = json)
                    }
                    "Azure" -> {
                        return tryDeserialize(
