...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun transcriptionEngineConfig(parakeet: TranscriptionEngineConfig.Parakeet) =
    ...
    private constructor(
        ...
        private val parakeet: Parakeet? = null,
        ...
        fun parakeet(): Optional<Parakeet> = Optional.ofNullable(parakeet)
        ...
        fun asParakeet(): Parakeet = parakeet.getOrThrow("parakeet")
        ...
        fun validate(): TranscriptionEngineConfig = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitParakeet(parakeet: Parakeet) {
                        parakeet.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitParakeet(parakeet: Parakeet) = parakeet.validity()
        ...
        companion object {
            ...
            @JvmStatic
            fun ofParakeet(parakeet: Parakeet) = TranscriptionEngineConfig(parakeet = parakeet)
        ...
        interface Visitor<out T> {
            ...
            fun visitParakeet(parakeet: Parakeet): T
        ...
        internal class Deserializer :
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): TranscriptionEngineConfig {
                ...
                when (transcriptionEngine) {
                    ...
                    "Parakeet" -> {
                        return tryDeserialize(node, jacksonTypeRef<Parakeet>())?.let {
                            TranscriptionEngineConfig(parakeet = it, _json = json)
                        } ?: TranscriptionEngineConfig(_json = json)
                    }
                    "A" -> {
        ...
        private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [Parakeet]. */
                @JvmStatic fun builder() = Builder()
            }

            /** A builder for [Parakeet]. */
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(parakeet: Parakeet) = apply {
                    interimResults = parakeet.interimResults
                    transcriptionEngine = parakeet.transcriptionEngine
                    transcriptionModel = parakeet.transcriptionModel
                    additionalProperties = parakeet.additionalProperties.toMutableMap()
                }
                ...
                /**
                 * Returns an immutable instance of [Parakeet].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): Parakeet =
            ...
            override fun toString() =
                "Parakeet{interimResults=$interimResults, transcriptionEngine=$transcriptionEngine, transcriptionModel=$transcriptionModel, additionalProperties=$additionalProperties}"
        }
    }
