...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [utteranceEndMs], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("utterance_end_ms")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * to 5000 ms.
                 */
                fun utteranceEndMs(utteranceEndMs: Long) =
                    utteranceEndMs(JsonField.of(utteranceEndMs))
