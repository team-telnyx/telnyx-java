...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun transcriptionEngineConfig(humain: TranscriptionEngineHumainConfig) =
    ...
    private constructor(
        ...
        fun humain(): Optional<TranscriptionEngineHumainConfig> = Optional.ofNullable(humain)
        ...
        fun validate(): TranscriptionEngineConfig = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitHumain(humain: TranscriptionEngineHumainConfig) {
                        humain.validate()
                    }
        ...
        companion object {
            ...
            @JvmStatic
            fun ofHumain(humain: TranscriptionEngineHumainConfig) =
                TranscriptionEngineConfig(humain = humain)
                ...
                when (transcriptionEngine) {
                    ...
                    "Humain" -> {
                        return tryDeserialize(
                            ...
                            ?.let { TranscriptionEngineConfig(humain = it, _json = json) }
                            ?: TranscriptionEngineConfig(_json = json)
                    }
                    "Reson8" -> {
