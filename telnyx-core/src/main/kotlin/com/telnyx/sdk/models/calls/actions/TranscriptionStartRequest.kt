...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun transcriptionEngineConfig(azure: TranscriptionEngineConfig.Azure) =
            transcriptionEngineConfig(TranscriptionEngineConfig.ofAzure(azure))

        /**
         * Alias for calling [transcriptionEngineConfig] with the following:
         * ```java
         * TranscriptionEngineConfig.Azure.builder()
         *     .region(region)
         *     .build()
         * ```
         */
        fun azureTranscriptionEngineConfig(region: TranscriptionEngineConfig.Azure.Region) =
            transcriptionEngineConfig(
                TranscriptionEngineConfig.Azure.builder().region(region).build()
            )
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                private var transcriptionEngine: JsonValue = JsonValue.from("Azure")
                ...
                internal fun from(azure: Azure) = apply {
                    region = azure.region
                    transcriptionEngine = azure.transcriptionEngine
            ...
            internal fun validity(): Int =
                (region.asKnown().getOrNull()?.validity() ?: 0) +
                    transcriptionEngine.let { if (it == JsonValue.from("Azure")) 1 else 0 } +
            ...
            override fun toString() =
                "Azure{region=$region, transcriptionEngine=$transcriptionEngine, apiKeyRef=$apiKeyRef, language=$language, additionalProperties=$additionalProperties}"
        }
    }
