...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun transcriptionEngineConfig(soniox: TranscriptionEngineSonioxConfig) =
        ...
        /**
         * Alias for calling [transcriptionEngineConfig] with
         * `TranscriptionEngineConfig.ofHumain(humain)`.
         */
        fun transcriptionEngineConfig(humain: TranscriptionEngineConfig.Humain) =
            transcriptionEngineConfig(TranscriptionEngineConfig.ofHumain(humain))

        /**
         * Alias for calling [transcriptionEngineConfig] with
         * `TranscriptionEngineConfig.ofReson8(reson8)`.
         */
        fun transcriptionEngineConfig(reson8: TranscriptionEngineConfig.Reson8) =
    ...
    private constructor(
        ...
        private val humain: Humain? = null,
        private val reson8: Reson8? = null,
        ...
        fun humain(): Optional<Humain> = Optional.ofNullable(humain)

        fun reson8(): Optional<Reson8> = Optional.ofNullable(reson8)
        ...
        fun asHumain(): Humain = humain.getOrThrow("humain")

        fun asReson8(): Reson8 = reson8.getOrThrow("reson8")
        ...
        fun validate(): TranscriptionEngineConfig = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitHumain(humain: Humain) {
                        humain.validate()
                    }

                    override fun visitReson8(reson8: Reson8) {
                        reson8.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitHumain(humain: Humain) = humain.validity()

                    override fun visitReson8(reson8: Reson8) = reson8.validity()
        ...
        companion object {
            ...
            @JvmStatic fun ofHumain(humain: Humain) = TranscriptionEngineConfig(humain = humain)

            @JvmStatic fun ofReson8(reson8: Reson8) = TranscriptionEngineConfig(reson8 = reson8)
        ...
        interface Visitor<out T> {
            ...
            fun visitHumain(humain: Humain): T

            fun visitReson8(reson8: Reson8): T
        ...
        internal class Deserializer :
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): TranscriptionEngineConfig {
                ...
                when (transcriptionEngine) {
                    ...
                    "Humain" -> {
                        return tryDeserialize(node, jacksonTypeRef<Humain>())?.let {
                            TranscriptionEngineConfig(humain = it, _json = json)
                        } ?: TranscriptionEngineConfig(_json = json)
                    }
                    "Reson8" -> {
                        return tryDeserialize(node, jacksonTypeRef<Reson8>())?.let {
                            TranscriptionEngineConfig(reson8 = it, _json = json)
                        } ?: TranscriptionEngineConfig(_json = json)
                    }
                    "A" -> {
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(humain: Humain) = apply {
                    language = humain.language
                    transcriptionEngine = humain.transcriptionEngine
                    transcriptionModel = humain.transcriptionModel
            ...
            class Language @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    @JvmField val CODESWITCH = of("codeswitch")
            ...
            override fun toString() =
                "Humain{language=$language, transcriptionEngine=$transcriptionEngine, transcriptionModel=$transcriptionModel, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [Reson8]. */
                @JvmStatic fun builder() = Builder()
            }

            /** A builder for [Reson8]. */
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(reson8: Reson8) = apply {
                    language = reson8.language
                    transcriptionEngine = reson8.transcriptionEngine
                    transcriptionModel = reson8.transcriptionModel
                    additionalProperties = reson8.additionalProperties.toMutableMap()
                }
                ...
                /**
                 * Returns an immutable instance of [Reson8].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): Reson8 =
            ...
            override fun toString() =
                "Reson8{language=$language, transcriptionEngine=$transcriptionEngine, transcriptionModel=$transcriptionModel, additionalProperties=$additionalProperties}"
        }
    }
