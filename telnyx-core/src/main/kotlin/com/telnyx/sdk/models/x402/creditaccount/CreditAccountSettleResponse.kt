...
class CreditAccountSettleResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditAccountSettleResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CreditAccountSettleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditAccountSettleResponse: CreditAccountSettleResponse) = apply {
            data = creditAccountSettleResponse.data
            additionalProperties = creditAccountSettleResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreditAccountSettleResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CreditAccountSettleResponse =
            CreditAccountSettleResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CreditAccountSettleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.txHash] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Data{id=$id, amount=$amount, createdAt=$createdAt, currency=$currency, quoteId=$quoteId, recordType=$recordType, status=$status, txHash=$txHash, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditAccountSettleResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CreditAccountSettleResponse{data=$data, additionalProperties=$additionalProperties}"
}
