...
class TranscriptionEngineHumainConfig
...
private constructor(
    ...
    /** A builder for [TranscriptionEngineHumainConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transcriptionEngineHumainConfig: TranscriptionEngineHumainConfig) =
            apply {
                language = transcriptionEngineHumainConfig.language
                transcriptionEngine = transcriptionEngineHumainConfig.transcriptionEngine
                transcriptionModel = transcriptionEngineHumainConfig.transcriptionModel
                additionalProperties =
                    transcriptionEngineHumainConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TranscriptionEngineHumainConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TranscriptionEngineHumainConfig =
            TranscriptionEngineHumainConfig(
                language,
                transcriptionEngine,
                transcriptionModel,
     ...
     *   expected type.
     */
    fun validate(): TranscriptionEngineHumainConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranscriptionEngineHumainConfig &&
    ...
    override fun toString() =
        "TranscriptionEngineHumainConfig{language=$language, transcriptionEngine=$transcriptionEngine, transcriptionModel=$transcriptionModel, additionalProperties=$additionalProperties}"
}
