...
class MobilePhoneNumberListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<MobilePhoneNumber>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<MobilePhoneNumber>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<MobilePhoneNumber>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<MobilePhoneNumber>> = data
    ...
    companion object {
         ...
         * [MobilePhoneNumberListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MobilePhoneNumberListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<MobilePhoneNumber>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(mobilePhoneNumberListPageResponse: MobilePhoneNumberListPageResponse) =
            apply {
                data = mobilePhoneNumberListPageResponse.data.map { it.toMutableList() }
                meta = mobilePhoneNumberListPageResponse.meta
                additionalProperties =
                    mobilePhoneNumberListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<MobilePhoneNumber>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<MobilePhoneNumber>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<MobilePhoneNumber>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [MobilePhoneNumber] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: MobilePhoneNumber) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [MobilePhoneNumberListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MobilePhoneNumberListPageResponse =
            MobilePhoneNumberListPageResponse(
    ...
    fun validate(): MobilePhoneNumberListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobilePhoneNumberListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "MobilePhoneNumberListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
