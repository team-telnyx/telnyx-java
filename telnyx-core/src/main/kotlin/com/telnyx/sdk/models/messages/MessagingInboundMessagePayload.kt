...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messagingInboundMessagePayload: MessagingInboundMessagePayload) = apply {
            ...
            to = messagingInboundMessagePayload.to.map { it.toMutableList() }
