...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PublicInternetGateway]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PublicInternetGateway]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicInternetGateway: PublicInternetGateway) = apply {
            ...
            publicIp = publicInternetGateway.publicIp
            regionCode = publicInternetGateway.regionCode
            additionalProperties = publicInternetGateway.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicInternetGateway].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PublicInternetGateway =
     ...
     *   expected type.
     */
    fun validate(): PublicInternetGateway = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicInternetGateway &&
            id == other.id &&
    ...
    override fun toString() =
        "PublicInternetGateway{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, name=$name, networkId=$networkId, status=$status, publicIp=$publicIp, regionCode=$regionCode, additionalProperties=$additionalProperties}"
}
