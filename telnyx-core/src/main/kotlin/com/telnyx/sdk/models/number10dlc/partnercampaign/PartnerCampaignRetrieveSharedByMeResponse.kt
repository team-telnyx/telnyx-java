...
class PartnerCampaignRetrieveSharedByMeResponse
...
private constructor(
    ...
    /** A builder for [PartnerCampaignRetrieveSharedByMeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            partnerCampaignRetrieveSharedByMeResponse: PartnerCampaignRetrieveSharedByMeResponse
        ) = apply {
            page = partnerCampaignRetrieveSharedByMeResponse.page
            records = partnerCampaignRetrieveSharedByMeResponse.records.map { it.toMutableList() }
            totalRecords = partnerCampaignRetrieveSharedByMeResponse.totalRecords
            additionalProperties =
                partnerCampaignRetrieveSharedByMeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PartnerCampaignRetrieveSharedByMeResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerCampaignRetrieveSharedByMeResponse =
            PartnerCampaignRetrieveSharedByMeResponse(
                page,
    ...
    fun validate(): PartnerCampaignRetrieveSharedByMeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerCampaignRetrieveSharedByMeResponse &&
            page == other.page &&
    ...
    override fun toString() =
        "PartnerCampaignRetrieveSharedByMeResponse{page=$page, records=$records, totalRecords=$totalRecords, additionalProperties=$additionalProperties}"
}
