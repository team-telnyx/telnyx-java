...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(managedAccountListParams: ManagedAccountListParams) = apply {
            ...
            pageNumber = managedAccountListParams.pageNumber
            pageSize = managedAccountListParams.pageSize
    ...
    override fun toString() =
        "ManagedAccountListParams{filter=$filter, includeCancelledAccounts=$includeCancelledAccounts, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
