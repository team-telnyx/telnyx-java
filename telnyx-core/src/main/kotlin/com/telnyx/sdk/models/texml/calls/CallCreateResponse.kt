...
private constructor(
     ...
     */
    fun callSid(): String = callSid.getRequired("call_sid")
    ...
    class Builder internal constructor() {
        ...
        private var callSid: JsonField<String>? = null
        ...
        internal fun from(callCreateResponse: CallCreateResponse) = apply {
            callSid = callCreateResponse.callSid
            from = callCreateResponse.from
            status = callCreateResponse.status
            to = callCreateResponse.to
    ...
    override fun toString() =
        "CallCreateResponse{callSid=$callSid, from=$from, status=$status, to=$to, additionalProperties=$additionalProperties}"
}
