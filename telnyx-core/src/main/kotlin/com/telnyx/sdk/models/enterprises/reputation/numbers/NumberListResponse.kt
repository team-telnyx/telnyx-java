...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(numberListResponse: NumberListResponse) = apply {
            id = numberListResponse.id
            createdAt = numberListResponse.createdAt
            enterpriseId = numberListResponse.enterpriseId
            phoneNumber = numberListResponse.phoneNumber
            reputationData = numberListResponse.reputationData
            updatedAt = numberListResponse.updatedAt
    ...
    private constructor(
        ...
        /** Reputation metrics */
        fun reputationData(): Optional<InnerReputationData> = Optional.ofNullable(reputationData)
        ...
        /** Reputation metrics */
        fun asReputationData(): InnerReputationData = reputationData.getOrThrow("reputationData")
        ...
        companion object {
            ...
            @JvmStatic fun ofJsonValue(jsonValue: JsonValue) = ReputationData(jsonValue = jsonValue)
        }
        ...
        private constructor(
             ...
             *
             * Unlike [maturityScore], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("maturity_score")
            @ExcludeMissing
             ...
             *
             * Unlike [spamCategory], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("spam_category")
            @ExcludeMissing
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [InnerReputationData].
                 */
                @JvmStatic fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                internal fun from(innerReputationData: InnerReputationData) = apply {
                    ...
                    additionalProperties = innerReputationData.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.connectionScore] with a well-typed [Long] value
                 ...
                 *
                 * You should usually call [Builder.engagementScore] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.maturityScore] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.sentimentScore] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.spamCategory] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            /** Overall spam risk level */
            class SpamRisk @JsonCreator private constructor(private val value: JsonField<String>) :
                Enum {
                ...
                enum class Value {
                    ...
                    HIGH,
                    /**
                     * An enum member indicating that [SpamRisk] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
    ...
    override fun toString() =
        "NumberListResponse{id=$id, createdAt=$createdAt, enterpriseId=$enterpriseId, phoneNumber=$phoneNumber, reputationData=$reputationData, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
