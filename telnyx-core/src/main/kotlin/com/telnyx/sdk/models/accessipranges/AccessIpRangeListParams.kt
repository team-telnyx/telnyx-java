...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accessIpRangeListParams: AccessIpRangeListParams) = apply {
            ...
            pageNumber = accessIpRangeListParams.pageNumber
            pageSize = accessIpRangeListParams.pageSize
    ...
    override fun toString() =
        "AccessIpRangeListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
