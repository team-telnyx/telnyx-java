...
class CloudfsFilesystemResponseWrapper
...
private constructor(
    ...
    /**
     * A CloudFS filesystem, including its metadata credential. This shape is returned only by
     * create and rotate-meta-token.
     *
    ...
    /** A builder for [CloudfsFilesystemResponseWrapper]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cloudfsFilesystemResponseWrapper: CloudfsFilesystemResponseWrapper) =
            apply {
                data = cloudfsFilesystemResponseWrapper.data
                additionalProperties =
                    cloudfsFilesystemResponseWrapper.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CloudfsFilesystemResponseWrapper].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CloudfsFilesystemResponseWrapper =
            CloudfsFilesystemResponseWrapper(data, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): CloudfsFilesystemResponseWrapper = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("meta_token")
            @ExcludeMissing
            metaToken: JsonField<String> = JsonMissing.of(),
        ...
        /**
         * PostgreSQL connection URL for the filesystem's metadata database, including the metadata
         * token as the password. Pass it to `juicefs mount`: the storage configuration is baked in
         * at provisioning, so the metadata URL is all a client needs to mount the filesystem.
         *
         * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        ...
        class Builder internal constructor() {
             ...
             * metadata token as the password. Pass it to `juicefs mount`: the storage configuration
             * is baked in at provisioning, so the metadata URL is all a client needs to mount the
             * filesystem.
             */
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, metaToken=$metaToken, metaUrl=$metaUrl, name=$name, recordType=$recordType, region=$region, s3Bucket=$s3Bucket, s3Endpoint=$s3Endpoint, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CloudfsFilesystemResponseWrapper &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CloudfsFilesystemResponseWrapper{data=$data, additionalProperties=$additionalProperties}"
}
