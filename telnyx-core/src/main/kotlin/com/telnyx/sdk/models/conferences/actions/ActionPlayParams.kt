...
private constructor(
    ...
    private constructor(
        ...
        ) : this(audioUrl, callControlIds, loop, mediaName, region, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(audioUrl, callControlIds, loop, mediaName, region, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{audioUrl=$audioUrl, callControlIds=$callControlIds, loop=$loop, mediaName=$mediaName, region=$region, additionalProperties=$additionalProperties}"
    }
