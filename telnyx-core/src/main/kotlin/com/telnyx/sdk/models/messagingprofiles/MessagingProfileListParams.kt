...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MessagingProfileListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [MessagingProfileListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessagingProfileListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(messagingProfileListParams: MessagingProfileListParams) = apply {
            ...
            additionalQueryParams = messagingProfileListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingProfileListParams].
         *
    ...
    override fun toString() =
        "MessagingProfileListParams{filter=$filter, page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
