...
class PortOutSupportingDocument
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("portout_id") @ExcludeMissing portoutId: JsonField<String> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortOutSupportingDocument].
         *
    ...
    /** A builder for [PortOutSupportingDocument]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portOutSupportingDocument: PortOutSupportingDocument) = apply {
            id = portOutSupportingDocument.id
            createdAt = portOutSupportingDocument.createdAt
            documentId = portOutSupportingDocument.documentId
            portoutId = portOutSupportingDocument.portoutId
            recordType = portOutSupportingDocument.recordType
            type = portOutSupportingDocument.type
            updatedAt = portOutSupportingDocument.updatedAt
            additionalProperties = portOutSupportingDocument.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortOutSupportingDocument].
         *
         ...
         */
        fun build(): PortOutSupportingDocument =
    ...
    fun validate(): PortOutSupportingDocument = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortOutSupportingDocument &&
            id == other.id &&
    ...
    override fun toString() =
        "PortOutSupportingDocument{id=$id, createdAt=$createdAt, documentId=$documentId, portoutId=$portoutId, recordType=$recordType, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
