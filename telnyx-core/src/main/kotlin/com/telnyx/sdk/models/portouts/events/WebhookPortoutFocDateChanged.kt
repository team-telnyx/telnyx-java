...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebhookPortoutFocDateChanged].
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookPortoutFocDateChanged: WebhookPortoutFocDateChanged) = apply {
            ...
            availableNotificationMethods =
                webhookPortoutFocDateChanged.availableNotificationMethods.map { it.toMutableList() }
            ...
            additionalProperties = webhookPortoutFocDateChanged.additionalProperties.toMutableMap()
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.focDate] with a well-typed [OffsetDateTime] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Payload = Payload(id, focDate, userId, additionalProperties.toMutableMap())
        }
