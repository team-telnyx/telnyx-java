...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SharedToolResponse].
         *
    ...
    /** A builder for [SharedToolResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sharedToolResponse: SharedToolResponse) = apply {
            id = sharedToolResponse.id
            toolDefinition = sharedToolResponse.toolDefinition
            type = sharedToolResponse.type
            createdAt = sharedToolResponse.createdAt
            displayName = sharedToolResponse.displayName
            timeoutMs = sharedToolResponse.timeoutMs
            additionalProperties = sharedToolResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SharedToolResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): SharedToolResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SharedToolResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SharedToolResponse{id=$id, toolDefinition=$toolDefinition, type=$type, createdAt=$createdAt, displayName=$displayName, timeoutMs=$timeoutMs, additionalProperties=$additionalProperties}"
}
