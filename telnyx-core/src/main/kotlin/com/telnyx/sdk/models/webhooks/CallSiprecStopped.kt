...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallSiprecStopped]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallSiprecStopped]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callSiprecStopped: CallSiprecStopped) = apply {
            id = callSiprecStopped.id
            eventType = callSiprecStopped.eventType
            occurredAt = callSiprecStopped.occurredAt
            payload = callSiprecStopped.payload
            recordType = callSiprecStopped.recordType
            additionalProperties = callSiprecStopped.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallSiprecStopped].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallSiprecStopped =
            CallSiprecStopped(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallSiprecStopped = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SIPREC_STOPPED = of("siprec.stopped")
        ...
        fun value(): Value =
            when (this) {
                SIPREC_STOPPED -> Value.SIPREC_STOPPED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SIPREC_STOPPED -> Known.SIPREC_STOPPED
    ...
    private constructor(
        ...
        private val hangupCause: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            hangupCause: JsonField<String> = JsonMissing.of(),
        ) : this(
            callControlId,
            callLegId,
            callSessionId,
         ...
         *   server responded with an unexpected value).
         */
        fun hangupCause(): Optional<String> = hangupCause.getOptional("hangup_cause")
        ...
        @JsonProperty("hangup_cause")
        @ExcludeMissing
        fun _hangupCause(): JsonField<String> = hangupCause
        ...
        class Builder internal constructor() {
            ...
            private var hangupCause: JsonField<String> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            /** Q850 reason why the SIPREC session was stopped. */
            fun hangupCause(hangupCause: String) = hangupCause(JsonField.of(hangupCause))

            /**
             * Sets [Builder.hangupCause] to an arbitrary JSON value.
             *
             * You should usually call [Builder.hangupCause] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun hangupCause(hangupCause: JsonField<String>) = apply {
        ...
        internal fun validity(): Int =
            (if (callControlId.asKnown().isPresent) 1 else 0) +
                ...
                (if (hangupCause.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, hangupCause=$hangupCause, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallSiprecStopped &&
            id == other.id &&
    ...
    override fun toString() =
        "CallSiprecStopped{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
