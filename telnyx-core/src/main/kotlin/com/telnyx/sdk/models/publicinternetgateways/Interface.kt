...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [Interface]. */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(interface_: Interface) = apply {
            name = interface_.name
            networkId = interface_.networkId
            status = interface_.status
            additionalProperties = interface_.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Interface].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): Interface =
            Interface(name, networkId, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): Interface = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "Interface{name=$name, networkId=$networkId, status=$status, additionalProperties=$additionalProperties}"
}
