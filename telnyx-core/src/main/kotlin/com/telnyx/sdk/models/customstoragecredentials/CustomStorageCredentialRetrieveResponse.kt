...
class CustomStorageCredentialRetrieveResponse
...
private constructor(
    ...
    /** A builder for [CustomStorageCredentialRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            customStorageCredentialRetrieveResponse: CustomStorageCredentialRetrieveResponse
        ) = apply {
            connectionId = customStorageCredentialRetrieveResponse.connectionId
            data = customStorageCredentialRetrieveResponse.data
            recordType = customStorageCredentialRetrieveResponse.recordType
            additionalProperties =
                customStorageCredentialRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomStorageCredentialRetrieveResponse].
         *
         ...
         */
        fun build(): CustomStorageCredentialRetrieveResponse =
            CustomStorageCredentialRetrieveResponse(
    ...
    fun validate(): CustomStorageCredentialRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomStorageCredentialRetrieveResponse &&
    ...
    override fun toString() =
        "CustomStorageCredentialRetrieveResponse{connectionId=$connectionId, data=$data, recordType=$recordType, additionalProperties=$additionalProperties}"
}
