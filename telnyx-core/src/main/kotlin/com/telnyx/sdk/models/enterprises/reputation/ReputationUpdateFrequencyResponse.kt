...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(reputationUpdateFrequencyResponse: ReputationUpdateFrequencyResponse) =
            apply {
                data = reputationUpdateFrequencyResponse.data
                additionalProperties =
                    reputationUpdateFrequencyResponse.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): ReputationUpdateFrequencyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReputationUpdateFrequencyResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ReputationUpdateFrequencyResponse{data=$data, additionalProperties=$additionalProperties}"
}
