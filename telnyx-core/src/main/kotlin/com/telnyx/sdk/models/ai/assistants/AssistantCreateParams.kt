...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(assistantCreateParams: AssistantCreateParams) = apply {
            idempotencyKey = assistantCreateParams.idempotencyKey
         ...
         */
        fun conversationFlow(conversationFlow: ConversationFlowReq) = apply {
         ...
         * [ConversationFlowReq] value instead. This method is primarily for setting the field to an
         ...
         */
        fun addTool(updateDynamicVariables: AssistantTool.UpdateDynamicVariables) = apply {
            body.addTool(updateDynamicVariables)
        }
        ...
        ) = apply { body.addUpdateDynamicVariablesTool(updateDynamicVariables) }
        ...
        fun voiceSettings(voiceSettings: InferenceEmbeddingVoiceSettings) = apply {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun conversationFlow(conversationFlow: ConversationFlowReq) =
             ...
             *
             * You should usually call [Builder.conversationFlow] with a well-typed
             * [ConversationFlowReq] value instead. This method is primarily for setting the field
             ...
             *
             * You should usually call [Builder.voiceSettings] with a well-typed
             * [InferenceEmbeddingVoiceSettings] value instead. This method is primarily for setting
    ...
    override fun toString() =
        "AssistantCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
