...
private constructor(
     ...
     */
    fun conversationFlow(): Optional<ConversationFlow> = body.conversationFlow()
     ...
     *   server responded with an unexpected value).
     */
    fun externalLlm(): Optional<ExternalLlm> = body.externalLlm()
     ...
     * type.
     */
    fun _conversationFlow(): JsonField<ConversationFlow> = body._conversationFlow()
     ...
     */
    fun _externalLlm(): JsonField<ExternalLlm> = body._externalLlm()
     ...
     * unexpected type.
     */
    fun _postConversationSettings(): JsonField<PostConversationSettings> =
    ...
    class Builder internal constructor() {
         ...
         */
        fun conversationFlow(conversationFlow: ConversationFlow) = apply {
        ...
        fun externalLlm(externalLlm: ExternalLlm) = apply { body.externalLlm(externalLlm) }
         ...
         * unavailable post-conversation. Beta feature.
         */
        fun postConversationSettings(postConversationSettings: PostConversationSettings) = apply {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * [ConversationFlow] value instead. This method is primarily for setting the field to
             * an undocumented or not yet supported value.
             */
            fun conversationFlow(conversationFlow: JsonField<ConversationFlow>) = apply {
             ...
             *
             * You should usually call [Builder.postConversationSettings] with a well-typed
             * [PostConversationSettings] value instead. This method is primarily for setting the
