...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(missionListEventsPageResponse: MissionListEventsPageResponse) = apply {
            data = missionListEventsPageResponse.data.map { it.toMutableList() }
            meta = missionListEventsPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [MissionListEventsPageResponse].
         *
         ...
         */
        fun build(): MissionListEventsPageResponse =
            MissionListEventsPageResponse(
    ...
    fun validate(): MissionListEventsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MissionListEventsPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "MissionListEventsPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
