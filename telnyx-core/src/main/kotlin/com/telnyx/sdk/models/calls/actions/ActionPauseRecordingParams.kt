 ...
 */
class ActionPauseRecordingParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionPauseRecordingParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ActionPauseRecordingParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionPauseRecordingParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionPauseRecordingParams: ActionPauseRecordingParams) = apply {
            callControlId = actionPauseRecordingParams.callControlId
            body = actionPauseRecordingParams.body.toBuilder()
            additionalHeaders = actionPauseRecordingParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionPauseRecordingParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionPauseRecordingParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionPauseRecordingParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionPauseRecordingParams &&
    ...
    override fun toString() =
        "ActionPauseRecordingParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
