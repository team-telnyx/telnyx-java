    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                usLongCodeFallback = data.usLongCodeFallback
        ...
        override fun toString() =
            "Data{id=$id, alphanumericSenderId=$alphanumericSenderId, messagingProfileId=$messagingProfileId, organizationId=$organizationId, recordType=$recordType, usLongCodeFallback=$usLongCodeFallback, additionalProperties=$additionalProperties}"
    }
