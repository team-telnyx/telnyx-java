...
class CollectionListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<Collection>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Collection>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<Collection>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Collection>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectionListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CollectionListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Collection>>? = null
        private var meta: JsonField<Meta> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(collectionListPageResponse: CollectionListPageResponse) = apply {
            data = collectionListPageResponse.data.map { it.toMutableList() }
            meta = collectionListPageResponse.meta
            additionalProperties = collectionListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<Collection>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Collection>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Collection>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Collection] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Collection) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CollectionListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CollectionListPageResponse =
            CollectionListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): CollectionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CollectionListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
