...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(queueListPageResponse: QueueListPageResponse) = apply {
            data = queueListPageResponse.data.map { it.toMutableList() }
            meta = queueListPageResponse.meta
    ...
    override fun toString() =
        "QueueListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
