 ...
 * `taskId`.
 */
class PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams =
            builder().build()
    ...
    /** A builder for [PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            taskId = phoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams.taskId
            page = phoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams.page
            recordsPerPage =
                phoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams.recordsPerPage
            additionalHeaders =
                phoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams.additionalHeaders
                    .toBuilder()
            additionalQueryParams =
                phoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams =
            PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams(
                taskId,
                page,
                recordsPerPage,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams &&
            taskId == other.taskId &&
            page == other.page &&
    ...
    override fun toString() =
        "PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusParams{taskId=$taskId, page=$page, recordsPerPage=$recordsPerPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
