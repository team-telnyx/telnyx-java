...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailBlockRetrieveEventsResponse: EmailBlockRetrieveEventsResponse) =
            apply {
                data = emailBlockRetrieveEventsResponse.data.map { it.toMutableList() }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, actor=$actor, eventType=$eventType, occurredAt=$occurredAt, reason=$reason, recordType=$recordType, source=$source, meta=$meta, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailBlockRetrieveEventsResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
