...
/**
 * Embed website content from a specified URL, including child pages up to 5 levels deep within the
 * same domain. The process crawls and loads content from the main URL and its linked pages into a
 * Telnyx Cloud Storage bucket. As soon as each webpage is added to the bucket, its content is
 * immediately processed for embeddings, that can be used for
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmbeddingUrlParams].
         *
    ...
    /** A builder for [EmbeddingUrlParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(embeddingUrlParams: EmbeddingUrlParams) = apply {
            idempotencyKey = embeddingUrlParams.idempotencyKey
            body = embeddingUrlParams.body.toBuilder()
            additionalHeaders = embeddingUrlParams.additionalHeaders.toBuilder()
            additionalQueryParams = embeddingUrlParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmbeddingUrlParams].
         *
    ...
    private constructor(
        ...
        ) : this(bucketName, url, mutableMapOf())
        ...
        internal fun validity(): Int =
            (if (bucketName.asKnown().isPresent) 1 else 0) + (if (url.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(bucketName, url, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{bucketName=$bucketName, url=$url, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmbeddingUrlParams &&
    ...
    override fun toString() =
        "EmbeddingUrlParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
