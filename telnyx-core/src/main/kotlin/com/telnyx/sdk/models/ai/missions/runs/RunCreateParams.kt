...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runCreateParams: RunCreateParams) = apply {
            missionId = runCreateParams.missionId
    ...
    private constructor(
        ...
        ) : this(input, metadata, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(input, metadata, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(input, metadata, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{input=$input, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "RunCreateParams{missionId=$missionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
