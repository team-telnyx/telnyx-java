...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(connectionListParams: ConnectionListParams) = apply {
            ...
            pageNumber = connectionListParams.pageNumber
            pageSize = connectionListParams.pageSize
            sort = connectionListParams.sort
    ...
    override fun toString() =
        "ConnectionListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
