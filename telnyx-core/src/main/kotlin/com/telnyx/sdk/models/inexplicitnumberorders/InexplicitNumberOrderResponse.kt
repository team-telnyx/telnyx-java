...
class InexplicitNumberOrderResponse
...
private constructor(
    ...
    /** A builder for [InexplicitNumberOrderResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inexplicitNumberOrderResponse: InexplicitNumberOrderResponse) = apply {
            id = inexplicitNumberOrderResponse.id
            billingGroupId = inexplicitNumberOrderResponse.billingGroupId
            connectionId = inexplicitNumberOrderResponse.connectionId
            createdAt = inexplicitNumberOrderResponse.createdAt
            customerReference = inexplicitNumberOrderResponse.customerReference
            messagingProfileId = inexplicitNumberOrderResponse.messagingProfileId
            orderingGroups = inexplicitNumberOrderResponse.orderingGroups.map { it.toMutableList() }
            updatedAt = inexplicitNumberOrderResponse.updatedAt
            additionalProperties = inexplicitNumberOrderResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InexplicitNumberOrderResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InexplicitNumberOrderResponse =
            InexplicitNumberOrderResponse(
                id,
                billingGroupId,
                connectionId,
    ...
    fun validate(): InexplicitNumberOrderResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [countAllocated], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("count_allocated")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            /** Quantity of phone numbers allocated */
            fun countAllocated(countAllocated: Long) = countAllocated(JsonField.of(countAllocated))
            ...
            /** Quantity of phone numbers requested */
            fun countRequested(countRequested: Long) = countRequested(JsonField.of(countRequested))
             ...
             *
             * You should usually call [Builder.phoneNumberStartsWith] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        private constructor(
             ...
             *
             * Unlike [numberOrderId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("number_order_id")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.numberOrderId] with a well-typed [String] value
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InexplicitNumberOrderResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "InexplicitNumberOrderResponse{id=$id, billingGroupId=$billingGroupId, connectionId=$connectionId, createdAt=$createdAt, customerReference=$customerReference, messagingProfileId=$messagingProfileId, orderingGroups=$orderingGroups, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
