...
/** Get Enum */
class EnumerationRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EnumerationRetrieveParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [EnumerationRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EnumerationRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(enumerationRetrieveParams: EnumerationRetrieveParams) = apply {
            endpoint = enumerationRetrieveParams.endpoint
            additionalHeaders = enumerationRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = enumerationRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EnumerationRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EnumerationRetrieveParams =
            EnumerationRetrieveParams(
                endpoint,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnumerationRetrieveParams &&
    ...
    override fun toString() =
        "EnumerationRetrieveParams{endpoint=$endpoint, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
