...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AgreementListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AgreementListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(agreementListResponse: AgreementListResponse) = apply {
            id = agreementListResponse.id
            agreedAt = agreementListResponse.agreedAt
            createdAt = agreementListResponse.createdAt
            productType = agreementListResponse.productType
            termsVersion = agreementListResponse.termsVersion
            version = agreementListResponse.version
            additionalProperties = agreementListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgreementListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AgreementListResponse =
     ...
     *   expected type.
     */
    fun validate(): AgreementListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgreementListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "AgreementListResponse{id=$id, agreedAt=$agreedAt, createdAt=$createdAt, productType=$productType, termsVersion=$termsVersion, version=$version, additionalProperties=$additionalProperties}"
}
