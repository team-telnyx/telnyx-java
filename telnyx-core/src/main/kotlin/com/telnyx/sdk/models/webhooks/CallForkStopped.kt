...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallForkStopped]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallForkStopped]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callForkStopped: CallForkStopped) = apply {
            id = callForkStopped.id
            eventType = callForkStopped.eventType
            occurredAt = callForkStopped.occurredAt
            payload = callForkStopped.payload
            recordType = callForkStopped.recordType
            additionalProperties = callForkStopped.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallForkStopped].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallForkStopped =
            CallForkStopped(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallForkStopped = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_FORK_STOPPED = of("call.fork.stopped")
        ...
        fun value(): Value =
            when (this) {
                CALL_FORK_STOPPED -> Value.CALL_FORK_STOPPED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_FORK_STOPPED -> Known.CALL_FORK_STOPPED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallForkStopped &&
            id == other.id &&
    ...
    override fun toString() =
        "CallForkStopped{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
