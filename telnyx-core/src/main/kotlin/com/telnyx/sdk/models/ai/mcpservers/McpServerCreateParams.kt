...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mcpServerCreateParams: McpServerCreateParams) = apply {
            idempotencyKey = mcpServerCreateParams.idempotencyKey
    ...
    override fun toString() =
        "McpServerCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
