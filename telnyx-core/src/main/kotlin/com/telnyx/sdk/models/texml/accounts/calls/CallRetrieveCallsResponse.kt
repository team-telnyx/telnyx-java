...
private constructor(
    private val calls: JsonField<List<CallResource>>,
    ...
    private constructor(
        @JsonProperty("calls")
        @ExcludeMissing
        calls: JsonField<List<CallResource>> = JsonMissing.of(),
     ...
     */
    fun calls(): Optional<List<CallResource>> = calls.getOptional("calls")
     ...
     */
    @JsonProperty("calls") @ExcludeMissing fun _calls(): JsonField<List<CallResource>> = calls
    ...
    class Builder internal constructor() {
        ...
        private var calls: JsonField<MutableList<CallResource>>? = null
        ...
        fun calls(calls: List<CallResource>) = calls(JsonField.of(calls))

        /**
         * Sets [Builder.calls] to an arbitrary JSON value.
         *
         * You should usually call [Builder.calls] with a well-typed `List<CallResource>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun calls(calls: JsonField<List<CallResource>>) = apply {
            this.calls = calls.map { it.toMutableList() }
        }

        /**
         * Adds a single [CallResource] to [calls].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCall(call: CallResource) = apply {
            calls =
