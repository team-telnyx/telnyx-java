...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TrafficPolicyProfileUpdateParams = builder().build()
    ...
    /** A builder for [TrafficPolicyProfileUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(trafficPolicyProfileUpdateParams: TrafficPolicyProfileUpdateParams) =
            apply {
                id = trafficPolicyProfileUpdateParams.id
                body = trafficPolicyProfileUpdateParams.body.toBuilder()
                additionalHeaders = trafficPolicyProfileUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    trafficPolicyProfileUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        fun limitBwKbps(limitBwKbps: Optional<LimitBwKbps>) = limitBwKbps(limitBwKbps.getOrNull())
        ...
        /**
         * Returns an immutable instance of [TrafficPolicyProfileUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TrafficPolicyProfileUpdateParams =
            TrafficPolicyProfileUpdateParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        ) : this(domains, ipRanges, limitBwKbps, services, type, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /** Bandwidth limit in kbps. Must be 512 or 1024, or null to remove. */
            fun limitBwKbps(limitBwKbps: LimitBwKbps?) =
                limitBwKbps(JsonField.ofNullable(limitBwKbps))

            /** Alias for calling [Builder.limitBwKbps] with `limitBwKbps.orElse(null)`. */
            fun limitBwKbps(limitBwKbps: Optional<LimitBwKbps>) =
                limitBwKbps(limitBwKbps.getOrNull())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(domains, ipRanges, limitBwKbps, services, type, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{domains=$domains, ipRanges=$ipRanges, limitBwKbps=$limitBwKbps, services=$services, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrafficPolicyProfileUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "TrafficPolicyProfileUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
