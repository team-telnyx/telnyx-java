...
class MessageTemplateUpdateResponse
...
private constructor(
    ...
    /** A builder for [MessageTemplateUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageTemplateUpdateResponse: MessageTemplateUpdateResponse) = apply {
            data = messageTemplateUpdateResponse.data
            additionalProperties = messageTemplateUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageTemplateUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessageTemplateUpdateResponse =
            MessageTemplateUpdateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): MessageTemplateUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageTemplateUpdateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MessageTemplateUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
