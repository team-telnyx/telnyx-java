...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roomRecordingListPageResponse: RoomRecordingListPageResponse) = apply {
            data = roomRecordingListPageResponse.data.map { it.toMutableList() }
            meta = roomRecordingListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [RoomRecordingListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RoomRecordingListPageResponse =
            RoomRecordingListPageResponse(
    ...
    fun validate(): RoomRecordingListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoomRecordingListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "RoomRecordingListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
