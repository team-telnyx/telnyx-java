...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(connectionListResponse: ConnectionListResponse) = apply {
            id = connectionListResponse.id
            active = connectionListResponse.active
            anchorsiteOverride = connectionListResponse.anchorsiteOverride
            connectionName = connectionListResponse.connectionName
            createdAt = connectionListResponse.createdAt
            outboundVoiceProfileId = connectionListResponse.outboundVoiceProfileId
            recordType = connectionListResponse.recordType
            tags = connectionListResponse.tags.map { it.toMutableList() }
            updatedAt = connectionListResponse.updatedAt
            webhookApiVersion = connectionListResponse.webhookApiVersion
            webhookEventFailoverUrl = connectionListResponse.webhookEventFailoverUrl
            webhookEventUrl = connectionListResponse.webhookEventUrl
