...
class IntegrationSecretListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<IntegrationSecret>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<IntegrationSecret>> = JsonMissing.of(),
     ...
     */
    fun data(): List<IntegrationSecret> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<IntegrationSecret>> = data
    ...
    /** A builder for [IntegrationSecretListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<IntegrationSecret>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(integrationSecretListPageResponse: IntegrationSecretListPageResponse) =
            apply {
                data = integrationSecretListPageResponse.data.map { it.toMutableList() }
                meta = integrationSecretListPageResponse.meta
                additionalProperties =
                    integrationSecretListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<IntegrationSecret>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<IntegrationSecret>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<IntegrationSecret>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [IntegrationSecret] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: IntegrationSecret) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [IntegrationSecretListPageResponse].
         *
         ...
         */
        fun build(): IntegrationSecretListPageResponse =
            IntegrationSecretListPageResponse(
    ...
    fun validate(): IntegrationSecretListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationSecretListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "IntegrationSecretListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
