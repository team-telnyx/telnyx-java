...
private constructor(
     ...
     *
     * Unlike [portingOrderStatus], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("porting_order_status")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(portingPhoneNumberListResponse: PortingPhoneNumberListResponse) = apply {
            activationStatus = portingPhoneNumberListResponse.activationStatus
            phoneNumber = portingPhoneNumberListResponse.phoneNumber
            phoneNumberType = portingPhoneNumberListResponse.phoneNumberType
            portabilityStatus = portingPhoneNumberListResponse.portabilityStatus
            portingOrderId = portingPhoneNumberListResponse.portingOrderId
            portingOrderStatus = portingPhoneNumberListResponse.portingOrderStatus
            recordType = portingPhoneNumberListResponse.recordType
            requirementsStatus = portingPhoneNumberListResponse.requirementsStatus
            supportKey = portingPhoneNumberListResponse.supportKey
         ...
         *
         * You should usually call [Builder.portabilityStatus] with a well-typed [PortabilityStatus]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
         ...
         * [PortingOrderStatus] value instead. This method is primarily for setting the field to an
     ...
     * Canada. International phone numbers are provisional by default.
     */
    class PortabilityStatus @JsonCreator private constructor(private val value: JsonField<String>) :
        Enum {
        ...
        /**
         * An enum containing [PortabilityStatus]'s known values, as well as an [_UNKNOWN] member.
         *
        ...
        enum class Value {
            ...
            PROVISIONAL,
            /**
             * An enum member indicating that [PortabilityStatus] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        /**
         * An enum containing [PortingOrderStatus]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [PortingOrderStatus] can contain an unknown value in a couple of cases:
         * - It was deserialized from data that doesn't match any known member. For example, if the
         *   SDK is on an older version than the API, then the API may respond with new members that
         *   the SDK is unaware of.
         * - It was constructed with an arbitrary value using the [of] method.
        ...
        enum class Value {
            ...
            CANCELLED,
            /**
             * An enum member indicating that [PortingOrderStatus] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
