...
class TollFreeVerificationEntityType
@JsonCreator
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = TollFreeVerificationEntityType(JsonField.of(value))
    }

    /** An enum containing [TollFreeVerificationEntityType]'s known values. */
    enum class Known {
        SOLE_PROPRIETOR,
        PRIVATE_PROFIT,
        PUBLIC_PROFIT,
    ...
    /**
     * An enum containing [TollFreeVerificationEntityType]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [TollFreeVerificationEntityType] can contain an unknown value in a couple of
     * cases:
    ...
    enum class Value {
        ...
        GOVERNMENT,
        /**
         * An enum member indicating that [TollFreeVerificationEntityType] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            GOVERNMENT -> Known.GOVERNMENT
                ...
                throw TelnyxInvalidDataException("Unknown TollFreeVerificationEntityType: $value")
        }
    ...
    fun validate(): TollFreeVerificationEntityType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TollFreeVerificationEntityType && value == other.value
    }
