...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ConferenceSpeakEnded]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceSpeakEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceSpeakEnded: ConferenceSpeakEnded) = apply {
            id = conferenceSpeakEnded.id
            eventType = conferenceSpeakEnded.eventType
            payload = conferenceSpeakEnded.payload
            recordType = conferenceSpeakEnded.recordType
            additionalProperties = conferenceSpeakEnded.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceSpeakEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceSpeakEnded =
    ...
    fun validate(): ConferenceSpeakEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_SPEAK_ENDED = of("conference.speak.ended")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_SPEAK_ENDED -> Value.CONFERENCE_SPEAK_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_SPEAK_ENDED -> Known.CONFERENCE_SPEAK_ENDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceSpeakEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceSpeakEnded{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
