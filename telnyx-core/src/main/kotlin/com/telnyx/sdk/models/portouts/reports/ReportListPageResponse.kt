...
private constructor(
    private val data: JsonField<List<PortoutReport>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PortoutReport>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<PortoutReport>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PortoutReport>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PortoutReport>>? = null
        ...
        fun data(data: List<PortoutReport>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PortoutReport>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<PortoutReport>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PortoutReport] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PortoutReport) = apply {
            this.data =
