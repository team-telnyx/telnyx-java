...
private constructor(
    ...
    ) : this(email, kind, name, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailWebhookRecipient].
         *
    ...
    /** A builder for [EmailWebhookRecipient]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailWebhookRecipient: EmailWebhookRecipient) = apply {
            email = emailWebhookRecipient.email
            kind = emailWebhookRecipient.kind
            name = emailWebhookRecipient.name
            additionalProperties = emailWebhookRecipient.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailWebhookRecipient].
         *
         ...
         */
        fun build(): EmailWebhookRecipient =
     ...
     *   expected type.
     */
    fun validate(): EmailWebhookRecipient = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailWebhookRecipient &&
            email == other.email &&
            kind == other.kind &&
            name == other.name &&
    ...
    private val hashCode: Int by lazy { Objects.hash(email, kind, name, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EmailWebhookRecipient{email=$email, kind=$kind, name=$name, additionalProperties=$additionalProperties}"
}
