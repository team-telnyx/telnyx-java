...
private constructor(
    private val data: JsonField<List<PhoneNumberBatchListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PhoneNumberBatchListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PhoneNumberBatchListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PhoneNumberBatchListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PhoneNumberBatchListResponse>>? = null
        ...
        fun data(data: List<PhoneNumberBatchListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<PhoneNumberBatchListResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<PhoneNumberBatchListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PhoneNumberBatchListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PhoneNumberBatchListResponse) = apply {
            this.data =
