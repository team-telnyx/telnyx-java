...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallResource]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallResource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callResource: CallResource) = apply {
            ...
            additionalProperties = callResource.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallResource].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallResource =
            CallResource(
                accountSid,
                answeredBy,
                callerName,
     ...
     *   expected type.
     */
    fun validate(): CallResource = apply {
        if (validated) {
            return@apply
        }
