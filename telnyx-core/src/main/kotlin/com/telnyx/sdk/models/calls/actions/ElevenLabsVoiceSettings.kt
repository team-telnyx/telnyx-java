...
private constructor(
    ...
    ) : this(type, apiKeyRef, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(elevenLabsVoiceSettings: ElevenLabsVoiceSettings) = apply {
            type = elevenLabsVoiceSettings.type
    ...
    private val hashCode: Int by lazy { Objects.hash(type, apiKeyRef, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ElevenLabsVoiceSettings{type=$type, apiKeyRef=$apiKeyRef, additionalProperties=$additionalProperties}"
}
