...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolUpdateResponse: ToolUpdateResponse) = apply {
            id = toolUpdateResponse.id
            toolDefinition = toolUpdateResponse.toolDefinition
            type = toolUpdateResponse.type
            createdAt = toolUpdateResponse.createdAt
            displayName = toolUpdateResponse.displayName
            timeoutMs = toolUpdateResponse.timeoutMs
    ...
    override fun toString() =
        "ToolUpdateResponse{id=$id, toolDefinition=$toolDefinition, type=$type, createdAt=$createdAt, displayName=$displayName, timeoutMs=$timeoutMs, additionalProperties=$additionalProperties}"
}
