...
class AiAssistantJoinParticipant
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("on_hangup") @ExcludeMissing onHangup: JsonField<OnHangup> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AiAssistantJoinParticipant].
         *
    ...
    /** A builder for [AiAssistantJoinParticipant]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(aiAssistantJoinParticipant: AiAssistantJoinParticipant) = apply {
            id = aiAssistantJoinParticipant.id
            role = aiAssistantJoinParticipant.role
            name = aiAssistantJoinParticipant.name
            onHangup = aiAssistantJoinParticipant.onHangup
            additionalProperties = aiAssistantJoinParticipant.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.onHangup] with a well-typed [OnHangup] value instead.
        ...
        /**
         * Returns an immutable instance of [AiAssistantJoinParticipant].
         *
         ...
         */
        fun build(): AiAssistantJoinParticipant =
     ...
     *   expected type.
     */
    fun validate(): AiAssistantJoinParticipant = apply {
        if (validated) {
            return@apply
        }
    ...
    /** Determines what happens to the conversation when this participant hangs up. */
    class OnHangup @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AiAssistantJoinParticipant &&
            id == other.id &&
            role == other.role &&
            name == other.name &&
    ...
    override fun toString() =
        "AiAssistantJoinParticipant{id=$id, role=$role, name=$name, onHangup=$onHangup, additionalProperties=$additionalProperties}"
}
