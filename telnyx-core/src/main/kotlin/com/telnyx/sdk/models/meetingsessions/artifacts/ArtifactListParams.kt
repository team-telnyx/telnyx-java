...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ArtifactListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): ArtifactListParams =
            ArtifactListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ArtifactListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
