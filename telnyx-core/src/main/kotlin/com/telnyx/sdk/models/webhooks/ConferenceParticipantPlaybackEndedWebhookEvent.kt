    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField
                val CONFERENCE_PARTICIPANT_PLAYBACK_ENDED =
                    of("conference.participant.playback.ended")
            ...
            fun value(): Value =
                when (this) {
                    CONFERENCE_PARTICIPANT_PLAYBACK_ENDED ->
                        Value.CONFERENCE_PARTICIPANT_PLAYBACK_ENDED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CONFERENCE_PARTICIPANT_PLAYBACK_ENDED ->
                        Known.CONFERENCE_PARTICIPANT_PLAYBACK_ENDED
