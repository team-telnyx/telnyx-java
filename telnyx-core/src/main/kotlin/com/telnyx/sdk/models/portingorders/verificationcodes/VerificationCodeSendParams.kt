...
class VerificationCodeSendParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VerificationCodeSendParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [VerificationCodeSendParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VerificationCodeSendParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verificationCodeSendParams: VerificationCodeSendParams) = apply {
            id = verificationCodeSendParams.id
            body = verificationCodeSendParams.body.toBuilder()
            additionalHeaders = verificationCodeSendParams.additionalHeaders.toBuilder()
            additionalQueryParams = verificationCodeSendParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VerificationCodeSendParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): VerificationCodeSendParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerificationCodeSendParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "VerificationCodeSendParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
