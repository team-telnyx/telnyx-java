...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun cspId(): String = cspId.getRequired("cspId")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun mock(): Boolean = mock.getRequired("mock")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun subUsecases(): List<String> = subUsecases.getRequired("subUsecases")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun termsAndConditions(): Boolean = termsAndConditions.getRequired("termsAndConditions")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TelnyxCampaignCsp].
         *
    ...
    /** A builder for [TelnyxCampaignCsp]. */
    class Builder internal constructor() {

        private var brandId: JsonField<String>? = null
        private var campaignId: JsonField<String>? = null
        private var cspId: JsonField<String>? = null
        private var description: JsonField<String>? = null
        private var mock: JsonField<Boolean>? = null
        private var subUsecases: JsonField<MutableList<String>>? = null
        private var termsAndConditions: JsonField<Boolean>? = null
        ...
        @JvmSynthetic
        internal fun from(telnyxCampaignCsp: TelnyxCampaignCsp) = apply {
            brandId = telnyxCampaignCsp.brandId
            campaignId = telnyxCampaignCsp.campaignId
            cspId = telnyxCampaignCsp.cspId
            description = telnyxCampaignCsp.description
            mock = telnyxCampaignCsp.mock
            subUsecases = telnyxCampaignCsp.subUsecases.map { it.toMutableList() }
            termsAndConditions = telnyxCampaignCsp.termsAndConditions
            usecase = telnyxCampaignCsp.usecase
            ageGated = telnyxCampaignCsp.ageGated
            autoRenewal = telnyxCampaignCsp.autoRenewal
            billedDate = telnyxCampaignCsp.billedDate
            brandDisplayName = telnyxCampaignCsp.brandDisplayName
            campaignStatus = telnyxCampaignCsp.campaignStatus
            createDate = telnyxCampaignCsp.createDate
            directLending = telnyxCampaignCsp.directLending
            embeddedLink = telnyxCampaignCsp.embeddedLink
            embeddedLinkSample = telnyxCampaignCsp.embeddedLinkSample
            embeddedPhone = telnyxCampaignCsp.embeddedPhone
            failureReasons = telnyxCampaignCsp.failureReasons
            helpKeywords = telnyxCampaignCsp.helpKeywords
            helpMessage = telnyxCampaignCsp.helpMessage
            isTMobileNumberPoolingEnabled = telnyxCampaignCsp.isTMobileNumberPoolingEnabled
            isTMobileRegistered = telnyxCampaignCsp.isTMobileRegistered
            isTMobileSuspended = telnyxCampaignCsp.isTMobileSuspended
            messageFlow = telnyxCampaignCsp.messageFlow
            nextRenewalOrExpirationDate = telnyxCampaignCsp.nextRenewalOrExpirationDate
            numberPool = telnyxCampaignCsp.numberPool
            optinKeywords = telnyxCampaignCsp.optinKeywords
            optinMessage = telnyxCampaignCsp.optinMessage
            optoutKeywords = telnyxCampaignCsp.optoutKeywords
            optoutMessage = telnyxCampaignCsp.optoutMessage
            privacyPolicyLink = telnyxCampaignCsp.privacyPolicyLink
            referenceId = telnyxCampaignCsp.referenceId
            resellerId = telnyxCampaignCsp.resellerId
            sample1 = telnyxCampaignCsp.sample1
            sample2 = telnyxCampaignCsp.sample2
            sample3 = telnyxCampaignCsp.sample3
            sample4 = telnyxCampaignCsp.sample4
            sample5 = telnyxCampaignCsp.sample5
            status = telnyxCampaignCsp.status
            submissionStatus = telnyxCampaignCsp.submissionStatus
            subscriberHelp = telnyxCampaignCsp.subscriberHelp
            subscriberOptin = telnyxCampaignCsp.subscriberOptin
            subscriberOptout = telnyxCampaignCsp.subscriberOptout
            tcrBrandId = telnyxCampaignCsp.tcrBrandId
            tcrCampaignId = telnyxCampaignCsp.tcrCampaignId
            termsAndConditionsLink = telnyxCampaignCsp.termsAndConditionsLink
            vertical = telnyxCampaignCsp.vertical
            webhookFailoverUrl = telnyxCampaignCsp.webhookFailoverUrl
            webhookUrl = telnyxCampaignCsp.webhookUrl
            additionalProperties = telnyxCampaignCsp.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TelnyxCampaignCsp].
         *
         ...
         */
        fun build(): TelnyxCampaignCsp =
            TelnyxCampaignCsp(
                checkRequired("brandId", brandId),
                checkRequired("campaignId", campaignId),
                checkRequired("cspId", cspId),
                checkRequired("description", description),
                checkRequired("mock", mock),
                checkRequired("subUsecases", subUsecases).map { it.toImmutable() },
                checkRequired("termsAndConditions", termsAndConditions),
    ...
    fun validate(): TelnyxCampaignCsp = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TelnyxCampaignCsp &&
    ...
    override fun toString() =
        "TelnyxCampaignCsp{brandId=$brandId, campaignId=$campaignId, cspId=$cspId, description=$description, mock=$mock, subUsecases=$subUsecases, termsAndConditions=$termsAndConditions, usecase=$usecase, ageGated=$ageGated, autoRenewal=$autoRenewal, billedDate=$billedDate, brandDisplayName=$brandDisplayName, campaignStatus=$campaignStatus, createDate=$createDate, directLending=$directLending, embeddedLink=$embeddedLink, embeddedLinkSample=$embeddedLinkSample, embeddedPhone=$embeddedPhone, failureReasons=$failureReasons, helpKeywords=$helpKeywords, helpMessage=$helpMessage, isTMobileNumberPoolingEnabled=$isTMobileNumberPoolingEnabled, isTMobileRegistered=$isTMobileRegistered, isTMobileSuspended=$isTMobileSuspended, messageFlow=$messageFlow, nextRenewalOrExpirationDate=$nextRenewalOrExpirationDate, numberPool=$numberPool, optinKeywords=$optinKeywords, optinMessage=$optinMessage, optoutKeywords=$optoutKeywords, optoutMessage=$optoutMessage, privacyPolicyLink=$privacyPolicyLink, referenceId=$referenceId, resellerId=$resellerId, sample1=$sample1, sample2=$sample2, sample3=$sample3, sample4=$sample4, sample5=$sample5, status=$status, submissionStatus=$submissionStatus, subscriberHelp=$subscriberHelp, subscriberOptin=$subscriberOptin, subscriberOptout=$subscriberOptout, tcrBrandId=$tcrBrandId, tcrCampaignId=$tcrCampaignId, termsAndConditionsLink=$termsAndConditionsLink, vertical=$vertical, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
}
