...
class ConferenceParticipantSpeakStarted
...
private constructor(
    ...
    /** A builder for [ConferenceParticipantSpeakStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceParticipantSpeakStarted: ConferenceParticipantSpeakStarted) =
            apply {
                id = conferenceParticipantSpeakStarted.id
                eventType = conferenceParticipantSpeakStarted.eventType
                payload = conferenceParticipantSpeakStarted.payload
                recordType = conferenceParticipantSpeakStarted.recordType
                additionalProperties =
                    conferenceParticipantSpeakStarted.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ConferenceParticipantSpeakStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceParticipantSpeakStarted =
            ConferenceParticipantSpeakStarted(
                id,
                eventType,
                payload,
    ...
    fun validate(): ConferenceParticipantSpeakStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CONFERENCE_PARTICIPANT_SPEAK_STARTED = of("conference.participant.speak.started")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PARTICIPANT_SPEAK_STARTED -> Value.CONFERENCE_PARTICIPANT_SPEAK_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PARTICIPANT_SPEAK_STARTED -> Known.CONFERENCE_PARTICIPANT_SPEAK_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceParticipantSpeakStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceParticipantSpeakStarted{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
