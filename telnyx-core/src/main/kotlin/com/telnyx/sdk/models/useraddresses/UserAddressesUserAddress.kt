...
class UserAddressesUserAddress
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UserAddressesUserAddress]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserAddressesUserAddress]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userAddressesUserAddress: UserAddressesUserAddress) = apply {
            id = userAddressesUserAddress.id
            administrativeArea = userAddressesUserAddress.administrativeArea
            borough = userAddressesUserAddress.borough
            businessName = userAddressesUserAddress.businessName
            countryCode = userAddressesUserAddress.countryCode
            createdAt = userAddressesUserAddress.createdAt
            customerReference = userAddressesUserAddress.customerReference
            extendedAddress = userAddressesUserAddress.extendedAddress
            firstName = userAddressesUserAddress.firstName
            lastName = userAddressesUserAddress.lastName
            locality = userAddressesUserAddress.locality
            neighborhood = userAddressesUserAddress.neighborhood
            phoneNumber = userAddressesUserAddress.phoneNumber
            postalCode = userAddressesUserAddress.postalCode
            recordType = userAddressesUserAddress.recordType
            streetAddress = userAddressesUserAddress.streetAddress
            updatedAt = userAddressesUserAddress.updatedAt
            additionalProperties = userAddressesUserAddress.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserAddressesUserAddress].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserAddressesUserAddress =
     ...
     *   expected type.
     */
    fun validate(): UserAddressesUserAddress = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserAddressesUserAddress &&
            id == other.id &&
