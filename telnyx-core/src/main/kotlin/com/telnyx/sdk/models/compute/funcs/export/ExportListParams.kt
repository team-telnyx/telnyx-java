 ...
 * Headers are never returned. Returns 404 (error code 10005) when no destination is configured for
 * the function.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ExportListParams =
            ExportListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ExportListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
