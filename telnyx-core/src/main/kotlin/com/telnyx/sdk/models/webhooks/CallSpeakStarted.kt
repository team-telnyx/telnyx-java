...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallSpeakStarted]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallSpeakStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callSpeakStarted: CallSpeakStarted) = apply {
            id = callSpeakStarted.id
            eventType = callSpeakStarted.eventType
            occurredAt = callSpeakStarted.occurredAt
            payload = callSpeakStarted.payload
            recordType = callSpeakStarted.recordType
            additionalProperties = callSpeakStarted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallSpeakStarted].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallSpeakStarted =
            CallSpeakStarted(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallSpeakStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CALL_SPEAK_STARTED = of("call.speak.started")
        ...
        fun value(): Value =
            when (this) {
                CALL_SPEAK_STARTED -> Value.CALL_SPEAK_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CALL_SPEAK_STARTED -> Known.CALL_SPEAK_STARTED
    ...
    private constructor(
        ...
        ) : this(callControlId, callLegId, callSessionId, clientState, connectionId, mutableMapOf())
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallSpeakStarted &&
            id == other.id &&
    ...
    override fun toString() =
        "CallSpeakStarted{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
