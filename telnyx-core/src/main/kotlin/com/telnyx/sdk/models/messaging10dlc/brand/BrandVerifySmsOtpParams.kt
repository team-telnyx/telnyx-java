...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandVerifySmsOtpParams].
         *
    ...
    /** A builder for [BrandVerifySmsOtpParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandVerifySmsOtpParams: BrandVerifySmsOtpParams) = apply {
            brandId = brandVerifySmsOtpParams.brandId
            body = brandVerifySmsOtpParams.body.toBuilder()
            additionalHeaders = brandVerifySmsOtpParams.additionalHeaders.toBuilder()
            additionalQueryParams = brandVerifySmsOtpParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BrandVerifySmsOtpParams].
         *
         ...
         */
        fun build(): BrandVerifySmsOtpParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandVerifySmsOtpParams &&
    ...
    override fun toString() =
        "BrandVerifySmsOtpParams{brandId=$brandId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
