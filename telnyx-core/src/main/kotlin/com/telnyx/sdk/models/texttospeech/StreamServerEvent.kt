...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = streamServerEvent.accept(new StreamServerEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitAudioChunk(AudioChunk audioChunk) {
     *         return Optional.of(audioChunk.toString());
     *     }
     *
     *     // ...
     *
