...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallEnqueued]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallEnqueued]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callEnqueued: CallEnqueued) = apply {
            id = callEnqueued.id
            eventType = callEnqueued.eventType
            occurredAt = callEnqueued.occurredAt
            payload = callEnqueued.payload
            recordType = callEnqueued.recordType
            additionalProperties = callEnqueued.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallEnqueued].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallEnqueued =
            CallEnqueued(
                id,
                eventType,
                occurredAt,
    ...
    fun validate(): CallEnqueued = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [currentPosition], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("current_position")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.queueAvgWaitTimeSecs] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun toString() =
        "CallEnqueued{id=$id, eventType=$eventType, occurredAt=$occurredAt, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
