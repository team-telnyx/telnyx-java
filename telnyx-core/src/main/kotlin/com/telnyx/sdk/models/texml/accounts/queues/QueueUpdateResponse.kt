...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [QueueUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [QueueUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(queueUpdateResponse: QueueUpdateResponse) = apply {
            accountSid = queueUpdateResponse.accountSid
            averageWaitTime = queueUpdateResponse.averageWaitTime
            currentSize = queueUpdateResponse.currentSize
            dateCreated = queueUpdateResponse.dateCreated
            dateUpdated = queueUpdateResponse.dateUpdated
            maxSize = queueUpdateResponse.maxSize
            sid = queueUpdateResponse.sid
            subresourceUris = queueUpdateResponse.subresourceUris
            uri = queueUpdateResponse.uri
            additionalProperties = queueUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [QueueUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): QueueUpdateResponse =
            QueueUpdateResponse(
                accountSid,
                averageWaitTime,
                currentSize,
    ...
    fun validate(): QueueUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QueueUpdateResponse &&
    ...
    override fun toString() =
        "QueueUpdateResponse{accountSid=$accountSid, averageWaitTime=$averageWaitTime, currentSize=$currentSize, dateCreated=$dateCreated, dateUpdated=$dateUpdated, maxSize=$maxSize, sid=$sid, subresourceUris=$subresourceUris, uri=$uri, additionalProperties=$additionalProperties}"
}
