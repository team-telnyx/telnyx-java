...
class ConferenceParticipantPlaybackEnded
...
private constructor(
    ...
    /** A builder for [ConferenceParticipantPlaybackEnded]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceParticipantPlaybackEnded: ConferenceParticipantPlaybackEnded) =
            apply {
                id = conferenceParticipantPlaybackEnded.id
                eventType = conferenceParticipantPlaybackEnded.eventType
                payload = conferenceParticipantPlaybackEnded.payload
                recordType = conferenceParticipantPlaybackEnded.recordType
                additionalProperties =
                    conferenceParticipantPlaybackEnded.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ConferenceParticipantPlaybackEnded].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceParticipantPlaybackEnded =
            ConferenceParticipantPlaybackEnded(
                id,
                eventType,
                payload,
    ...
    fun validate(): ConferenceParticipantPlaybackEnded = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val CONFERENCE_PARTICIPANT_PLAYBACK_ENDED = of("conference.participant.playback.ended")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_PARTICIPANT_PLAYBACK_ENDED -> Value.CONFERENCE_PARTICIPANT_PLAYBACK_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_PARTICIPANT_PLAYBACK_ENDED -> Known.CONFERENCE_PARTICIPANT_PLAYBACK_ENDED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, conferenceId=$conferenceId, connectionId=$connectionId, creatorCallSessionId=$creatorCallSessionId, mediaName=$mediaName, mediaUrl=$mediaUrl, occurredAt=$occurredAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceParticipantPlaybackEnded &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceParticipantPlaybackEnded{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
