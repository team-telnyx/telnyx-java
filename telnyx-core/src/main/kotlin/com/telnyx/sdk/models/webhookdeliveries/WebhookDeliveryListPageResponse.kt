...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookDeliveryListPageResponse: WebhookDeliveryListPageResponse) =
            apply {
                data = webhookDeliveryListPageResponse.data.map { it.toMutableList() }
                meta = webhookDeliveryListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [WebhookDeliveryListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookDeliveryListPageResponse =
            WebhookDeliveryListPageResponse(
    ...
    fun validate(): WebhookDeliveryListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookDeliveryListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "WebhookDeliveryListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
