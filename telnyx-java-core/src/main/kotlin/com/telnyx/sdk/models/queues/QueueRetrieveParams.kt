...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): QueueRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(queueRetrieveParams: QueueRetrieveParams) = apply {
            queueName = queueRetrieveParams.queueName
        ...
        fun build(): QueueRetrieveParams =
            QueueRetrieveParams(queueName, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun hashCode(): Int = Objects.hash(queueName, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "QueueRetrieveParams{queueName=$queueName, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
