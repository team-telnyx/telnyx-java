...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun dnsRecordType(): String = body.dnsRecordType()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FqdnCreateParams].
         *
    ...
    /** A builder for [FqdnCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fqdnCreateParams: FqdnCreateParams) = apply {
            body = fqdnCreateParams.body.toBuilder()
            additionalHeaders = fqdnCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = fqdnCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FqdnCreateParams].
         *
         ...
         */
        fun build(): FqdnCreateParams =
            FqdnCreateParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun dnsRecordType(): String = dnsRecordType.getRequired("dns_record_type")
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun fqdn(): String = fqdn.getRequired("fqdn")
        ...
        class Builder internal constructor() {
            ...
            private var dnsRecordType: JsonField<String>? = null
            private var fqdn: JsonField<String>? = null
            ...
            fun build(): Body =
                Body(
                    ...
                    checkRequired("dnsRecordType", dnsRecordType),
                    checkRequired("fqdn", fqdn),
                    port,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FqdnCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FqdnCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
