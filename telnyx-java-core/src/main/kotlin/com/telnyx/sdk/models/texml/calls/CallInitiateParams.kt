...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallInitiateParams].
         *
    ...
    /** A builder for [CallInitiateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callInitiateParams: CallInitiateParams) = apply {
            applicationId = callInitiateParams.applicationId
            body = callInitiateParams.body.toBuilder()
            additionalHeaders = callInitiateParams.additionalHeaders.toBuilder()
            additionalQueryParams = callInitiateParams.additionalQueryParams.toBuilder()
        }

        fun applicationId(applicationId: String?) = apply { this.applicationId = applicationId }

        /** Alias for calling [Builder.applicationId] with `applicationId.orElse(null)`. */
        fun applicationId(applicationId: Optional<String>) =
            applicationId(applicationId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [CallInitiateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallInitiateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(applicationId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CallInitiateParams{applicationId=$applicationId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
