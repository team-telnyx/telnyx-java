...
class MessagingProfileListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessagingProfileListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessagingProfileListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagingProfileListResponse: MessagingProfileListResponse) = apply {
            data = messagingProfileListResponse.data.map { it.toMutableList() }
            meta = messagingProfileListResponse.meta
            additionalProperties = messagingProfileListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessagingProfileListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingProfileListResponse =
    ...
    fun validate(): MessagingProfileListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessagingProfileListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "MessagingProfileListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
