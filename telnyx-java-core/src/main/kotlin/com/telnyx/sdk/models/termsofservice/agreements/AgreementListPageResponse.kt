...
class AgreementListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AgreementListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AgreementListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AgreementListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AgreementListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgreementListPageResponse].
         *
    ...
    /** A builder for [AgreementListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AgreementListResponse>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agreementListPageResponse: AgreementListPageResponse) = apply {
            data = agreementListPageResponse.data.map { it.toMutableList() }
            meta = agreementListPageResponse.meta
            additionalProperties = agreementListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<AgreementListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AgreementListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<AgreementListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgreementListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AgreementListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AgreementListPageResponse].
         *
         ...
         */
        fun build(): AgreementListPageResponse =
            AgreementListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): AgreementListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgreementListPageResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AgreementListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
