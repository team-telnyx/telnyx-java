...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OAuthGrant].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(oauthGrant: OAuthGrant) = apply {
            id = oauthGrant.id
            clientId = oauthGrant.clientId
            createdAt = oauthGrant.createdAt
            recordType = oauthGrant.recordType
            scopes = oauthGrant.scopes.map { it.toMutableList() }
            lastUsedAt = oauthGrant.lastUsedAt
            additionalProperties = oauthGrant.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OAuthGrant].
         *
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, clientId, createdAt, recordType, scopes, lastUsedAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "OAuthGrant{id=$id, clientId=$clientId, createdAt=$createdAt, recordType=$recordType, scopes=$scopes, lastUsedAt=$lastUsedAt, additionalProperties=$additionalProperties}"
}
