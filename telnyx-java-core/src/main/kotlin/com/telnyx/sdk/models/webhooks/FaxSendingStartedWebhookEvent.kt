...
class FaxSendingStartedWebhookEvent
...
private constructor(
    ...
    /** A builder for [FaxSendingStartedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxSendingStartedWebhookEvent: FaxSendingStartedWebhookEvent) = apply {
            id = faxSendingStartedWebhookEvent.id
            eventType = faxSendingStartedWebhookEvent.eventType
            payload = faxSendingStartedWebhookEvent.payload
            recordType = faxSendingStartedWebhookEvent.recordType
            additionalProperties = faxSendingStartedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxSendingStartedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxSendingStartedWebhookEvent =
            FaxSendingStartedWebhookEvent(
                id,
                eventType,
                payload,
    ...
    fun validate(): FaxSendingStartedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FAX_SENDING_STARTED = of("fax.sending.started")
        ...
        fun value(): Value =
            when (this) {
                FAX_SENDING_STARTED -> Value.FAX_SENDING_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FAX_SENDING_STARTED -> Known.FAX_SENDING_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxSendingStartedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "FaxSendingStartedWebhookEvent{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
