...
class VerifyEmailStatusResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VerifyEmailStatusResponse].
         *
    ...
    /** A builder for [VerifyEmailStatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verifyEmailStatusResponse: VerifyEmailStatusResponse) = apply {
            data = verifyEmailStatusResponse.data
            additionalProperties = verifyEmailStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VerifyEmailStatusResponse].
         *
         ...
         */
        fun build(): VerifyEmailStatusResponse =
     ...
     *   expected type.
     */
    fun validate(): VerifyEmailStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifyEmailStatusResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VerifyEmailStatusResponse{data=$data, additionalProperties=$additionalProperties}"
}
