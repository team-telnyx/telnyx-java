...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GlobalIpLatencyRetrieveParams = builder().build()
    ...
    /** A builder for [GlobalIpLatencyRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalIpLatencyRetrieveParams: GlobalIpLatencyRetrieveParams) = apply {
            filter = globalIpLatencyRetrieveParams.filter
            additionalHeaders = globalIpLatencyRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = globalIpLatencyRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GlobalIpLatencyRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GlobalIpLatencyRetrieveParams =
            GlobalIpLatencyRetrieveParams(
                filter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalIpLatencyRetrieveParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "GlobalIpLatencyRetrieveParams{filter=$filter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
