...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.sendAt] with `sendAt.orElse(null)`. */
        fun sendAt(sendAt: Optional<OffsetDateTime>) = sendAt(sendAt.getOrNull())
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * minute.
             */
            fun sendAt(sendAt: OffsetDateTime?) = sendAt(JsonField.ofNullable(sendAt))
    ...
    override fun toString() =
        "MessageSendParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
