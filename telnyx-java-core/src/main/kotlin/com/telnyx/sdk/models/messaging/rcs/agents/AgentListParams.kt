...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): AgentListParams =
            AgentListParams(page, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AgentListParams{page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
