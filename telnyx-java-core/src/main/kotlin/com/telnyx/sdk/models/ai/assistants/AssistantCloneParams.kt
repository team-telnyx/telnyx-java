...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AssistantCloneParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AssistantCloneParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AssistantCloneParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AssistantCloneParams].
         *
