...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OAuthClient].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(oauthClient: OAuthClient) = apply {
            clientId = oauthClient.clientId
            clientType = oauthClient.clientType
            createdAt = oauthClient.createdAt
            name = oauthClient.name
            orgId = oauthClient.orgId
            recordType = oauthClient.recordType
            requirePkce = oauthClient.requirePkce
            updatedAt = oauthClient.updatedAt
            userId = oauthClient.userId
            allowedGrantTypes = oauthClient.allowedGrantTypes.map { it.toMutableList() }
            allowedScopes = oauthClient.allowedScopes.map { it.toMutableList() }
            clientSecret = oauthClient.clientSecret
            logoUri = oauthClient.logoUri
            policyUri = oauthClient.policyUri
            redirectUris = oauthClient.redirectUris.map { it.toMutableList() }
            tosUri = oauthClient.tosUri
            additionalProperties = oauthClient.additionalProperties.toMutableMap()
        }
         ...
         * value.
         */
        fun requirePkce(requirePkce: JsonField<Boolean>) = apply { this.requirePkce = requirePkce }
        ...
        /** List of allowed OAuth scopes */
        fun allowedScopes(allowedScopes: List<String>) = allowedScopes(JsonField.of(allowedScopes))
        ...
        /**
         * Returns an immutable instance of [OAuthClient].
         *
    ...
    fun validate(): OAuthClient = apply {
        if (validated) {
            return@apply
        }
