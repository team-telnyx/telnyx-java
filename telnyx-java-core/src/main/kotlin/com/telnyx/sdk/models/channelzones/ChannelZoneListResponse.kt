...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(channelZoneListResponse: ChannelZoneListResponse) = apply {
            data = channelZoneListResponse.data.map { it.toMutableList() }
            meta = channelZoneListResponse.meta
    ...
    private constructor(
        ...
        @JsonProperty("countries")
        @ExcludeMissing
        fun _countries(): JsonField<List<String>> = countries
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                countries = data.countries.map { it.toMutableList() }
                name = data.name
        ...
        override fun toString() =
            "Data{id=$id, channels=$channels, countries=$countries, name=$name, recordType=$recordType, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ChannelZoneListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
