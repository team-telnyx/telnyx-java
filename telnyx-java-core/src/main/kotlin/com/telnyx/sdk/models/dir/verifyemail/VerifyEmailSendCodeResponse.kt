...
class VerifyEmailSendCodeResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VerifyEmailSendCodeResponse].
         *
    ...
    /** A builder for [VerifyEmailSendCodeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verifyEmailSendCodeResponse: VerifyEmailSendCodeResponse) = apply {
            data = verifyEmailSendCodeResponse.data
            additionalProperties = verifyEmailSendCodeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VerifyEmailSendCodeResponse].
         *
         ...
         */
        fun build(): VerifyEmailSendCodeResponse =
     ...
     *   expected type.
     */
    fun validate(): VerifyEmailSendCodeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifyEmailSendCodeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VerifyEmailSendCodeResponse{data=$data, additionalProperties=$additionalProperties}"
}
