...
class SiprecConnectorCreateResponse
...
private constructor(
    ...
    /** A builder for [SiprecConnectorCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siprecConnectorCreateResponse: SiprecConnectorCreateResponse) = apply {
            data = siprecConnectorCreateResponse.data
            additionalProperties = siprecConnectorCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SiprecConnectorCreateResponse].
         *
         ...
         */
        fun build(): SiprecConnectorCreateResponse =
            SiprecConnectorCreateResponse(
    ...
    fun validate(): SiprecConnectorCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiprecConnectorCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SiprecConnectorCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
