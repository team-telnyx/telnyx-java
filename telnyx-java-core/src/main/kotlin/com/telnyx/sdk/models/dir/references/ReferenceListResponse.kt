...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReferenceListResponse].
         *
    ...
    /** A builder for [ReferenceListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(referenceListResponse: ReferenceListResponse) = apply {
            data = referenceListResponse.data.map { it.toMutableList() }
            additionalProperties = referenceListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ReferenceListResponse].
         *
         ...
         */
        fun build(): ReferenceListResponse =
     ...
     *   expected type.
     */
    fun validate(): ReferenceListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReferenceListResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ReferenceListResponse{data=$data, additionalProperties=$additionalProperties}"
}
