...
class CallReferFailedWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallReferFailedWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallReferFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callReferFailedWebhookEvent: CallReferFailedWebhookEvent) = apply {
            data = callReferFailedWebhookEvent.data
            additionalProperties = callReferFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallReferFailedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallReferFailedWebhookEvent =
            CallReferFailedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallReferFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReferFailedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallReferFailedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
