...
class TexmlApplicationListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TexmlApplicationListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TexmlApplicationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(texmlApplicationListResponse: TexmlApplicationListResponse) = apply {
            data = texmlApplicationListResponse.data.map { it.toMutableList() }
            meta = texmlApplicationListResponse.meta
            additionalProperties = texmlApplicationListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TexmlApplicationListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlApplicationListResponse =
    ...
    fun validate(): TexmlApplicationListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlApplicationListResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "TexmlApplicationListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
