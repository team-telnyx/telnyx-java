...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RoomUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RoomUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RoomUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roomUpdateParams: RoomUpdateParams) = apply {
            roomId = roomUpdateParams.roomId
            body = roomUpdateParams.body.toBuilder()
            additionalHeaders = roomUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = roomUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RoomUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RoomUpdateParams =
            RoomUpdateParams(
                roomId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoomUpdateParams &&
            roomId == other.roomId &&
            body == other.body &&
    ...
    override fun toString() =
        "RoomUpdateParams{roomId=$roomId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
