...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionStopSiprecParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ActionStopSiprecParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionStopSiprecParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionStopSiprecParams: ActionStopSiprecParams) = apply {
            callControlId = actionStopSiprecParams.callControlId
            body = actionStopSiprecParams.body.toBuilder()
            additionalHeaders = actionStopSiprecParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionStopSiprecParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionStopSiprecParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStopSiprecParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStopSiprecParams &&
    ...
    override fun toString() =
        "ActionStopSiprecParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
