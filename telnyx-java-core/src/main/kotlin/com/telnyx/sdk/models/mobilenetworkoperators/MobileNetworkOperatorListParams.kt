...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mobileNetworkOperatorListParams: MobileNetworkOperatorListParams) =
            apply {
                ...
                pageNumber = mobileNetworkOperatorListParams.pageNumber
                pageSize = mobileNetworkOperatorListParams.pageSize
    ...
    override fun toString() =
        "MobileNetworkOperatorListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
