...
class TranscriptionWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TranscriptionWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TranscriptionWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transcriptionWebhookEvent: TranscriptionWebhookEvent) = apply {
            data = transcriptionWebhookEvent.data
            additionalProperties = transcriptionWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TranscriptionWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TranscriptionWebhookEvent =
            TranscriptionWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): TranscriptionWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_TRANSCRIPTION = of("call.transcription")
            ...
            fun value(): Value =
                when (this) {
                    CALL_TRANSCRIPTION -> Value.CALL_TRANSCRIPTION
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_TRANSCRIPTION -> Known.CALL_TRANSCRIPTION
        ...
        private constructor(
            ...
            private val transcriptionData: JsonField<TranscriptionData>,
            private val additionalProperties: MutableMap<String, JsonValue>,
        ) {
            ...
            private constructor(
                ...
                @ExcludeMissing
                transcriptionData: JsonField<TranscriptionData> = JsonMissing.of(),
            ) : this(
                callControlId,
                callLegId,
                callSessionId,
             ...
             *   the server responded with an unexpected value).
             */
            fun transcriptionData(): Optional<TranscriptionData> =
                transcriptionData.getOptional("transcription_data")
            ...
            /**
             * Returns the raw JSON value of [transcriptionData].
             *
             * Unlike [transcriptionData], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("transcription_data")
            @ExcludeMissing
            fun _transcriptionData(): JsonField<TranscriptionData> = transcriptionData
            ...
            class Builder internal constructor() {
                ...
                private var transcriptionData: JsonField<TranscriptionData> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                fun transcriptionData(transcriptionData: TranscriptionData) =
                    transcriptionData(JsonField.of(transcriptionData))

                /**
                 * Sets [Builder.transcriptionData] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.transcriptionData] with a well-typed
                 * [TranscriptionData] value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
                fun transcriptionData(transcriptionData: JsonField<TranscriptionData>) = apply {
            ...
            fun validate(): Payload = apply {
                ...
                clientState()
                connectionId()
                transcriptionData().ifPresent { it.validate() }
                validated = true
            }
            ...
            internal fun validity(): Int =
                (if (callControlId.asKnown().isPresent) 1 else 0) +
                    ...
                    (transcriptionData.asKnown().getOrNull()?.validity() ?: 0)
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("transcription_track")
                    @ExcludeMissing
                    transcriptionTrack: JsonField<TranscriptionTrack> = JsonMissing.of(),
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun transcriptionTrack(): Optional<TranscriptionTrack> =
                    transcriptionTrack.getOptional("transcription_track")

                /**
                 * Returns the raw JSON value of [confidence].
                 *
                 * Unlike [confidence], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("confidence")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [isFinal], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("is_final")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [transcript], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("transcript")
                @ExcludeMissing
                ...
                /**
                 * Returns the raw JSON value of [transcriptionTrack].
                 *
                 * Unlike [transcriptionTrack], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("transcription_track")
                @ExcludeMissing
                fun _transcriptionTrack(): JsonField<TranscriptionTrack> = transcriptionTrack
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(transcriptionData: TranscriptionData) = apply {
                        confidence = transcriptionData.confidence
                        isFinal = transcriptionData.isFinal
                        transcript = transcriptionData.transcript
                        transcriptionTrack = transcriptionData.transcriptionTrack
                     ...
                     *
                     * You should usually call [Builder.isFinal] with a well-typed [Boolean] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     */
                    fun transcriptionTrack(transcriptionTrack: TranscriptionTrack) =
                        transcriptionTrack(JsonField.of(transcriptionTrack))

                    /**
                     * Sets [Builder.transcriptionTrack] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.transcriptionTrack] with a well-typed
                     * [TranscriptionTrack] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                    fun transcriptionTrack(transcriptionTrack: JsonField<TranscriptionTrack>) =
                        apply {
                    ...
                    /**
                     * Returns an immutable instance of [TranscriptionData].
                     *
                     * Further updates to this [Builder] will not mutate the returned instance.
                     */
                    fun build(): TranscriptionData =
                        TranscriptionData(
                            confidence,
                            isFinal,
                            transcript,
                ...
                fun validate(): TranscriptionData = apply {
                    if (validated) {
                        return@apply
                    }
                    ...
                    isFinal()
                    transcript()
                    transcriptionTrack().ifPresent { it.validate() }
                    validated = true
                }
                ...
                internal fun validity(): Int =
                    (if (confidence.asKnown().isPresent) 1 else 0) +
                        ...
                        (transcriptionTrack.asKnown().getOrNull()?.validity() ?: 0)
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmStatic fun of(value: String) = TranscriptionTrack(JsonField.of(value))
                    }

                    /** An enum containing [TranscriptionTrack]'s known values. */
                    enum class Known {
                        INBOUND,
                        OUTBOUND,
                    }
                    ...
                    /**
                     * An enum containing [TranscriptionTrack]'s known values, as well as an
                     * [_UNKNOWN] member.
                     *
                     * An instance of [TranscriptionTrack] can contain an unknown value in a couple
                     * of cases:
                    ...
                    enum class Value {
                        ...
                        OUTBOUND,
                        /**
                         * An enum member indicating that [TranscriptionTrack] was instantiated with
                         * an unknown value.
                         */
                        _UNKNOWN,
                    }
                        ...
                        when (this) {
                            ...
                            OUTBOUND -> Known.OUTBOUND
                                ...
                                throw TelnyxInvalidDataException(
                                    "Unknown TranscriptionTrack: $value"
                                )
                        }
                    ...
                    fun validate(): TranscriptionTrack = apply {
                        if (validated) {
                            return@apply
                        }
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return other is TranscriptionTrack && value == other.value
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is TranscriptionData &&
                        confidence == other.confidence &&
                        isFinal == other.isFinal &&
                        transcript == other.transcript &&
                        transcriptionTrack == other.transcriptionTrack &&
                ...
                override fun toString() =
                    "TranscriptionData{confidence=$confidence, isFinal=$isFinal, transcript=$transcript, transcriptionTrack=$transcriptionTrack, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is Payload &&
                    ...
                    transcriptionData == other.transcriptionData &&
                    additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, transcriptionData=$transcriptionData, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranscriptionWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "TranscriptionWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
