...
class CallConversationEndedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CallConversationEndedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callConversationEndedWebhookEvent: CallConversationEndedWebhookEvent) =
            apply {
                data = callConversationEndedWebhookEvent.data
                additionalProperties =
                    callConversationEndedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CallConversationEndedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallConversationEndedWebhookEvent =
            CallConversationEndedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallConversationEndedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [durationSec], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("duration_sec")
            @ExcludeMissing
             ...
             *
             * Unlike [llmModel], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [sttModel], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [ttsModelId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("tts_model_id")
            @ExcludeMissing
             ...
             *
             * Unlike [ttsVoiceId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("tts_voice_id")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.durationSec] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun durationSec(durationSec: JsonField<Long>) = apply {
                 ...
                 *
                 * You should usually call [Builder.llmModel] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.sttModel] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * yet supported value.
                 */
                fun ttsModelId(ttsModelId: JsonField<String>) = apply {
                 ...
                 * yet supported value.
                 */
                fun ttsVoiceId(ttsVoiceId: JsonField<String>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallConversationEndedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallConversationEndedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
