...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ActionKickResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionKickResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionKickResponse: ActionKickResponse) = apply {
            data = actionKickResponse.data
            additionalProperties = actionKickResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionKickResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionKickResponse =
            ActionKickResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionKickResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionKickResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ActionKickResponse{data=$data, additionalProperties=$additionalProperties}"
}
