...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MessagingUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messagingUpdateParams: MessagingUpdateParams) = apply {
            ...
            body = messagingUpdateParams.body.toBuilder()
    ...
    private constructor(
        ...
        ) : this(messagingProduct, messagingProfileId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(messagingProduct, messagingProfileId, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(messagingProduct, messagingProfileId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{messagingProduct=$messagingProduct, messagingProfileId=$messagingProfileId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "MessagingUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
