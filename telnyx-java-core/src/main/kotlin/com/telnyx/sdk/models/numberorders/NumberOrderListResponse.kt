...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(numberOrderListResponse: NumberOrderListResponse) = apply {
            data = numberOrderListResponse.data.map { it.toMutableList() }
            meta = numberOrderListResponse.meta
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                status = data.status
                subNumberOrdersIds = data.subNumberOrdersIds.map { it.toMutableList() }
        ...
        private constructor(
            ...
            private val hashCode: Int by lazy {
                Objects.hash(id, phoneNumber, additionalProperties)
            }
    ...
    override fun toString() =
        "NumberOrderListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
