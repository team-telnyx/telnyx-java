...
private constructor(
     ...
     */
    fun data(): Optional<List<CdrDetailedReqResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CdrDetailedReqResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        fun data(data: List<CdrDetailedReqResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CdrDetailedReqResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<CdrDetailedReqResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CdrDetailedReqResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CdrDetailedReqResponse) = apply {
            this.data =
