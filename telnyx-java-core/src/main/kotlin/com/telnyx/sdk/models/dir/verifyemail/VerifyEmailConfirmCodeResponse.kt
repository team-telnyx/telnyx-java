...
class VerifyEmailConfirmCodeResponse
...
private constructor(
    ...
    /** A builder for [VerifyEmailConfirmCodeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verifyEmailConfirmCodeResponse: VerifyEmailConfirmCodeResponse) = apply {
            data = verifyEmailConfirmCodeResponse.data
            additionalProperties =
                verifyEmailConfirmCodeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VerifyEmailConfirmCodeResponse].
         *
         ...
         */
        fun build(): VerifyEmailConfirmCodeResponse =
            VerifyEmailConfirmCodeResponse(
     ...
     *   expected type.
     */
    fun validate(): VerifyEmailConfirmCodeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerifyEmailConfirmCodeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "VerifyEmailConfirmCodeResponse{data=$data, additionalProperties=$additionalProperties}"
}
