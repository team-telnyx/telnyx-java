...
class ActionRemoveWirelessBlocklistResponse
...
private constructor(
    ...
    /** A builder for [ActionRemoveWirelessBlocklistResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = actionRemoveWirelessBlocklistResponse.data
            additionalProperties =
                actionRemoveWirelessBlocklistResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRemoveWirelessBlocklistResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionRemoveWirelessBlocklistResponse =
            ActionRemoveWirelessBlocklistResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionRemoveWirelessBlocklistResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRemoveWirelessBlocklistResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionRemoveWirelessBlocklistResponse{data=$data, additionalProperties=$additionalProperties}"
}
