...
class RequirementRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RequirementRetrieveResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RequirementRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(requirementRetrieveResponse: RequirementRetrieveResponse) = apply {
            data = requirementRetrieveResponse.data
            additionalProperties = requirementRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RequirementRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RequirementRetrieveResponse =
            RequirementRetrieveResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): RequirementRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                requirementsTypes = data.requirementsTypes.map { it.toMutableList() }
            ...
            /**
             * Indicates whether this requirement applies to branded_calling, ordering, porting, or
             * both ordering and porting
             */
             ...
             * `List<DocReqsRequirementType>` value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
            fun requirementsTypes(requirementsTypes: JsonField<List<DocReqsRequirementType>>) =
                apply {
        ...
        override fun toString() =
            "Data{id=$id, action=$action, countryCode=$countryCode, createdAt=$createdAt, locality=$locality, phoneNumberType=$phoneNumberType, recordType=$recordType, requirementsTypes=$requirementsTypes, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RequirementRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "RequirementRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
