...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(notificationEventListResponse: NotificationEventListResponse) = apply {
            data = notificationEventListResponse.data.map { it.toMutableList() }
            meta = notificationEventListResponse.meta
    ...
    private constructor(
         ...
         *
         * Unlike [notificationCategory], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("notification_category")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.notificationCategory] with a well-typed [String]
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, enabled=$enabled, name=$name, notificationCategory=$notificationCategory, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "NotificationEventListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
