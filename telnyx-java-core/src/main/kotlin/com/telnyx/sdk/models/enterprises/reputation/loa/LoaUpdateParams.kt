...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LoaUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(loaUpdateParams: LoaUpdateParams) = apply {
            enterpriseId = loaUpdateParams.enterpriseId
            body = loaUpdateParams.body.toBuilder()
            additionalHeaders = loaUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = loaUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LoaUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LoaUpdateParams &&
    ...
    override fun toString() =
        "LoaUpdateParams{enterpriseId=$enterpriseId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
