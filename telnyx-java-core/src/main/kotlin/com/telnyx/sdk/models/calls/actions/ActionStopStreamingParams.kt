 ...
 * - `streaming.stopped`
 */
class ActionStopStreamingParams
private constructor(
    ...
    /**
     * Identifies the stream. If the `stream_id` is not provided the command stops all streams
     * associated with a given `call_control_id`.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun streamId(): Optional<String> = body.streamId()
     ...
     */
    fun _streamId(): JsonField<String> = body._streamId()
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionStopStreamingParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ActionStopStreamingParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionStopStreamingParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionStopStreamingParams: ActionStopStreamingParams) = apply {
            callControlId = actionStopStreamingParams.callControlId
            body = actionStopStreamingParams.body.toBuilder()
            additionalHeaders = actionStopStreamingParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionStopStreamingParams.additionalQueryParams.toBuilder()
        }
         ...
         * associated with a given `call_control_id`.
         */
        fun streamId(streamId: String) = apply { body.streamId(streamId) }
         ...
         */
        fun streamId(streamId: JsonField<String>) = apply { body.streamId(streamId) }
        ...
        /**
         * Returns an immutable instance of [ActionStopStreamingParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStopStreamingParams =
    ...
    private constructor(
        ...
        ) : this(clientState, commandId, streamId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(clientState, commandId, streamId, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(clientState, commandId, streamId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{clientState=$clientState, commandId=$commandId, streamId=$streamId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStopStreamingParams &&
    ...
    override fun toString() =
        "ActionStopStreamingParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
