...
class ActionSetPrivateWirelessGatewayResponse
...
private constructor(
    ...
    /** A builder for [ActionSetPrivateWirelessGatewayResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = actionSetPrivateWirelessGatewayResponse.data
            additionalProperties =
                actionSetPrivateWirelessGatewayResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionSetPrivateWirelessGatewayResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionSetPrivateWirelessGatewayResponse =
            ActionSetPrivateWirelessGatewayResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionSetPrivateWirelessGatewayResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionSetPrivateWirelessGatewayResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionSetPrivateWirelessGatewayResponse{data=$data, additionalProperties=$additionalProperties}"
}
