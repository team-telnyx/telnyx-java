...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ConferenceRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(conferenceRetrieveParams: ConferenceRetrieveParams) = apply {
            id = conferenceRetrieveParams.id
            region = conferenceRetrieveParams.region
    ...
    override fun hashCode(): Int =
        Objects.hash(id, region, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ConferenceRetrieveParams{id=$id, region=$region, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
