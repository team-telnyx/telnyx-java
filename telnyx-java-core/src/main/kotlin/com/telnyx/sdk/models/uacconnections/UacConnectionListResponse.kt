 ...
 */
class UacConnectionListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UacConnectionListResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacConnectionListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uacConnectionListResponse: UacConnectionListResponse) = apply {
            id = uacConnectionListResponse.id
            active = uacConnectionListResponse.active
            anchorsiteOverride = uacConnectionListResponse.anchorsiteOverride
            androidPushCredentialId = uacConnectionListResponse.androidPushCredentialId
            authentication = uacConnectionListResponse.authentication
            callCostInWebhooks = uacConnectionListResponse.callCostInWebhooks
            connectionName = uacConnectionListResponse.connectionName
            createdAt = uacConnectionListResponse.createdAt
            defaultOnHoldComfortNoiseEnabled =
                uacConnectionListResponse.defaultOnHoldComfortNoiseEnabled
            dtmfType = uacConnectionListResponse.dtmfType
            encodeContactHeaderEnabled = uacConnectionListResponse.encodeContactHeaderEnabled
            encryptedMedia = uacConnectionListResponse.encryptedMedia
            externalUacSettings = uacConnectionListResponse.externalUacSettings
            fqdn = uacConnectionListResponse.fqdn
            fqdnOutboundAuthentication = uacConnectionListResponse.fqdnOutboundAuthentication
            fqdns = uacConnectionListResponse.fqdns.map { it.toMutableList() }
            inbound = uacConnectionListResponse.inbound
            internalUacSettings = uacConnectionListResponse.internalUacSettings
            iosPushCredentialId = uacConnectionListResponse.iosPushCredentialId
            jitterBuffer = uacConnectionListResponse.jitterBuffer
            noiseSuppression = uacConnectionListResponse.noiseSuppression
            noiseSuppressionDetails = uacConnectionListResponse.noiseSuppressionDetails
            onnetT38PassthroughEnabled = uacConnectionListResponse.onnetT38PassthroughEnabled
            outbound = uacConnectionListResponse.outbound
            password = uacConnectionListResponse.password
            recordType = uacConnectionListResponse.recordType
            registrationStatus = uacConnectionListResponse.registrationStatus
            registrationStatusUpdatedAt = uacConnectionListResponse.registrationStatusUpdatedAt
            rtcpSettings = uacConnectionListResponse.rtcpSettings
            sipUriCallingPreference = uacConnectionListResponse.sipUriCallingPreference
            tags = uacConnectionListResponse.tags.map { it.toMutableList() }
            updatedAt = uacConnectionListResponse.updatedAt
            userName = uacConnectionListResponse.userName
            webhookApiVersion = uacConnectionListResponse.webhookApiVersion
            webhookEventFailoverUrl = uacConnectionListResponse.webhookEventFailoverUrl
            webhookEventUrl = uacConnectionListResponse.webhookEventUrl
            webhookTimeoutSecs = uacConnectionListResponse.webhookTimeoutSecs
            additionalProperties = uacConnectionListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UacConnectionListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacConnectionListResponse =
     ...
     *   expected type.
     */
    fun validate(): UacConnectionListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UacConnectionListResponse &&
            id == other.id &&
            active == other.active &&
