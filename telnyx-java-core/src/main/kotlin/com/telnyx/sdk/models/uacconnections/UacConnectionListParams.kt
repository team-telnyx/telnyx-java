...
/**
 * Returns a list of your UAC connections. A UAC (User Agent Client) Connection registers Telnyx to
 * your PBX — the opposite of a standard SIP trunk, where the PBX registers to Telnyx. Use UAC when
 * your PBX doesn’t support outbound SIP registration or you need Telnyx to maintain the
 * registration.
 */
class UacConnectionListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UacConnectionListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UacConnectionListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UacConnectionListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uacConnectionListParams: UacConnectionListParams) = apply {
            filter = uacConnectionListParams.filter
            pageNumber = uacConnectionListParams.pageNumber
            pageSize = uacConnectionListParams.pageSize
            sort = uacConnectionListParams.sort
            additionalHeaders = uacConnectionListParams.additionalHeaders.toBuilder()
            additionalQueryParams = uacConnectionListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UacConnectionListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UacConnectionListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UacConnectionListParams &&
            filter == other.filter &&
    ...
    override fun toString() =
        "UacConnectionListParams{filter=$filter, pageNumber=$pageNumber, pageSize=$pageSize, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
