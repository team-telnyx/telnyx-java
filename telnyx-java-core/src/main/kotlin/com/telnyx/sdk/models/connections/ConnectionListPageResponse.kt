...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConnectionListPageResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(connectionListPageResponse: ConnectionListPageResponse) = apply {
            data = connectionListPageResponse.data.map { it.toMutableList() }
            meta = connectionListPageResponse.meta
        ...
        /**
         * Returns an immutable instance of [ConnectionListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConnectionListPageResponse =
            ConnectionListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ConnectionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConnectionListPageResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "ConnectionListPageResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
