...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = privateWirelessGatewayCreateResponse.data
        ...
        /**
         * Returns an immutable instance of [PrivateWirelessGatewayCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PrivateWirelessGatewayCreateResponse =
            PrivateWirelessGatewayCreateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PrivateWirelessGatewayCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateWirelessGatewayCreateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PrivateWirelessGatewayCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
