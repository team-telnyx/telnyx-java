...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(wireguardInterfaceListResponse: WireguardInterfaceListResponse) = apply {
            data = wireguardInterfaceListResponse.data.map { it.toMutableList() }
            meta = wireguardInterfaceListResponse.meta
    ...
    override fun toString() =
        "WireguardInterfaceListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
