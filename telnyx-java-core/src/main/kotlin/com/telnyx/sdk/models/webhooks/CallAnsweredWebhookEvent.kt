    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_ANSWERED = of("call.answered")
        ...
        private constructor(
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, customHeaders=$customHeaders, from=$from, sipHeaders=$sipHeaders, startTime=$startTime, state=$state, tags=$tags, to=$to, additionalProperties=$additionalProperties}"
        }
