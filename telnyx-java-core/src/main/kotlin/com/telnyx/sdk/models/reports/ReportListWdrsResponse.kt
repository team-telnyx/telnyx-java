...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reportListWdrsResponse: ReportListWdrsResponse) = apply {
            data = reportListWdrsResponse.data.map { it.toMutableList() }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                downlinkData = data.downlinkData
                ...
                simGroupId = data.simGroupId
                simGroupName = data.simGroupName
                uplinkData = data.uplinkData
             ...
             * supported value.
             */
            fun uplinkData(uplinkData: JsonField<UplinkData>) = apply {
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): UplinkData =
                    UplinkData(amount, unit, additionalProperties.toMutableMap())
            }
    ...
    override fun toString() =
        "ReportListWdrsResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
