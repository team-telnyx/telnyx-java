...
/**
 * Verifies ownership of the provided phone numbers and returns a mapping of numbers to their IDs,
 * plus a list of numbers not found in the account.
 */
class ActionVerifyOwnershipParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionVerifyOwnershipParams].
         *
    ...
    /** A builder for [ActionVerifyOwnershipParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionVerifyOwnershipParams: ActionVerifyOwnershipParams) = apply {
            body = actionVerifyOwnershipParams.body.toBuilder()
            additionalHeaders = actionVerifyOwnershipParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionVerifyOwnershipParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionVerifyOwnershipParams].
         *
         ...
         */
        fun build(): ActionVerifyOwnershipParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionVerifyOwnershipParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ActionVerifyOwnershipParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
