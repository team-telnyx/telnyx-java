...
class CsvDownloadCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CsvDownloadCreateResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CsvDownloadCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(csvDownloadCreateResponse: CsvDownloadCreateResponse) = apply {
            data = csvDownloadCreateResponse.data.map { it.toMutableList() }
            additionalProperties = csvDownloadCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CsvDownloadCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CsvDownloadCreateResponse =
    ...
    fun validate(): CsvDownloadCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CsvDownloadCreateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CsvDownloadCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
