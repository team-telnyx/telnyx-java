...
class CallReferCompletedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CallReferCompletedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callReferCompletedWebhookEvent: CallReferCompletedWebhookEvent) = apply {
            data = callReferCompletedWebhookEvent.data
            additionalProperties =
                callReferCompletedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallReferCompletedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallReferCompletedWebhookEvent =
            CallReferCompletedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallReferCompletedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallReferCompletedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallReferCompletedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
