...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [InsightGroupInsightGroupsParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, description, webhook, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, description, webhook, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, description=$description, webhook=$webhook, additionalProperties=$additionalProperties}"
    }
