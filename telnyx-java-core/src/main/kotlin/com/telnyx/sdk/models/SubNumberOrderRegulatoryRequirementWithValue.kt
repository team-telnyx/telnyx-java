...
class SubNumberOrderRegulatoryRequirementWithValue
...
private constructor(
    ...
    /** A builder for [SubNumberOrderRegulatoryRequirementWithValue]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            fieldType = subNumberOrderRegulatoryRequirementWithValue.fieldType
            fieldValue = subNumberOrderRegulatoryRequirementWithValue.fieldValue
            recordType = subNumberOrderRegulatoryRequirementWithValue.recordType
            requirementId = subNumberOrderRegulatoryRequirementWithValue.requirementId
            additionalProperties =
                subNumberOrderRegulatoryRequirementWithValue.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubNumberOrderRegulatoryRequirementWithValue].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubNumberOrderRegulatoryRequirementWithValue =
            SubNumberOrderRegulatoryRequirementWithValue(
                fieldType,
                fieldValue,
                recordType,
    ...
    fun validate(): SubNumberOrderRegulatoryRequirementWithValue = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubNumberOrderRegulatoryRequirementWithValue &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(fieldType, fieldValue, recordType, requirementId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "SubNumberOrderRegulatoryRequirementWithValue{fieldType=$fieldType, fieldValue=$fieldValue, recordType=$recordType, requirementId=$requirementId, additionalProperties=$additionalProperties}"
}
