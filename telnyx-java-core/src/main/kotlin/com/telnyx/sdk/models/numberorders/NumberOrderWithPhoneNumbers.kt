...
class NumberOrderWithPhoneNumbers
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberOrderWithPhoneNumbers].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NumberOrderWithPhoneNumbers]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberOrderWithPhoneNumbers: NumberOrderWithPhoneNumbers) = apply {
            id = numberOrderWithPhoneNumbers.id
            billingGroupId = numberOrderWithPhoneNumbers.billingGroupId
            connectionId = numberOrderWithPhoneNumbers.connectionId
            createdAt = numberOrderWithPhoneNumbers.createdAt
            customerReference = numberOrderWithPhoneNumbers.customerReference
            messagingProfileId = numberOrderWithPhoneNumbers.messagingProfileId
            phoneNumbers = numberOrderWithPhoneNumbers.phoneNumbers.map { it.toMutableList() }
            phoneNumbersCount = numberOrderWithPhoneNumbers.phoneNumbersCount
            recordType = numberOrderWithPhoneNumbers.recordType
            requirementsMet = numberOrderWithPhoneNumbers.requirementsMet
            status = numberOrderWithPhoneNumbers.status
            subNumberOrdersIds =
                numberOrderWithPhoneNumbers.subNumberOrdersIds.map { it.toMutableList() }
            updatedAt = numberOrderWithPhoneNumbers.updatedAt
            additionalProperties = numberOrderWithPhoneNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberOrderWithPhoneNumbers].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NumberOrderWithPhoneNumbers =
    ...
    fun validate(): NumberOrderWithPhoneNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberOrderWithPhoneNumbers &&
            id == other.id &&
