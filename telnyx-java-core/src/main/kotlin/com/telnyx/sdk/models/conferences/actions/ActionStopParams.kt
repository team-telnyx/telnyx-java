...
private constructor(
    ...
    /**
     * List of call control ids identifying participants the audio file should stop be played to. If
     * not given, the audio will be stoped to the entire conference.
     *
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionStopParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ActionStopParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionStopParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionStopParams: ActionStopParams) = apply {
            id = actionStopParams.id
            body = actionStopParams.body.toBuilder()
            additionalHeaders = actionStopParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionStopParams.additionalQueryParams.toBuilder()
        }
         ...
         * to. If not given, the audio will be stoped to the entire conference.
         */
        ...
        /**
         * Returns an immutable instance of [ActionStopParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStopParams =
            ActionStopParams(
                id,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStopParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ActionStopParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
