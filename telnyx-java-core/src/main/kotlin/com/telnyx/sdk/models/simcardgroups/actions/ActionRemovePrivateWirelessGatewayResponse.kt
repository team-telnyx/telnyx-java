...
class ActionRemovePrivateWirelessGatewayResponse
...
private constructor(
    ...
    /** A builder for [ActionRemovePrivateWirelessGatewayResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = actionRemovePrivateWirelessGatewayResponse.data
            additionalProperties =
                actionRemovePrivateWirelessGatewayResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRemovePrivateWirelessGatewayResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionRemovePrivateWirelessGatewayResponse =
            ActionRemovePrivateWirelessGatewayResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionRemovePrivateWirelessGatewayResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRemovePrivateWirelessGatewayResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionRemovePrivateWirelessGatewayResponse{data=$data, additionalProperties=$additionalProperties}"
}
