...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ListRetrieveAllResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ListRetrieveAllResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listRetrieveAllResponse: ListRetrieveAllResponse) = apply {
            data = listRetrieveAllResponse.data.map { it.toMutableList() }
            meta = listRetrieveAllResponse.meta
            additionalProperties = listRetrieveAllResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ListRetrieveAllResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ListRetrieveAllResponse =
    ...
    fun validate(): ListRetrieveAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListRetrieveAllResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ListRetrieveAllResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
