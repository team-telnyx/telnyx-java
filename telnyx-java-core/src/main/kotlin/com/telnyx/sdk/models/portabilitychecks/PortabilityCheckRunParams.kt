...
class PortabilityCheckRunParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PortabilityCheckRunParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PortabilityCheckRunParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortabilityCheckRunParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portabilityCheckRunParams: PortabilityCheckRunParams) = apply {
            body = portabilityCheckRunParams.body.toBuilder()
            additionalHeaders = portabilityCheckRunParams.additionalHeaders.toBuilder()
            additionalQueryParams = portabilityCheckRunParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PortabilityCheckRunParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortabilityCheckRunParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortabilityCheckRunParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PortabilityCheckRunParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
