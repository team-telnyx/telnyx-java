...
class SiprecConnectorRetrieveResponse
...
private constructor(
    ...
    /** A builder for [SiprecConnectorRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siprecConnectorRetrieveResponse: SiprecConnectorRetrieveResponse) =
            apply {
                data = siprecConnectorRetrieveResponse.data
                additionalProperties =
                    siprecConnectorRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SiprecConnectorRetrieveResponse].
         *
         ...
         */
        fun build(): SiprecConnectorRetrieveResponse =
            SiprecConnectorRetrieveResponse(
    ...
    fun validate(): SiprecConnectorRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiprecConnectorRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SiprecConnectorRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
