...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FaxFailedWebhookEvent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FaxFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxFailedWebhookEvent: FaxFailedWebhookEvent) = apply {
            id = faxFailedWebhookEvent.id
            eventType = faxFailedWebhookEvent.eventType
            payload = faxFailedWebhookEvent.payload
            recordType = faxFailedWebhookEvent.recordType
            additionalProperties = faxFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxFailedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxFailedWebhookEvent =
    ...
    fun validate(): FaxFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FAX_FAILED = of("fax.failed")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxFailedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "FaxFailedWebhookEvent{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
