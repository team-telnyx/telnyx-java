...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [VoicemailPrefResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [VoicemailPrefResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [VoicemailPrefResponse].
         *
    ...
    fun validate(): VoicemailPrefResponse = apply {
        if (validated) {
            return@apply
        }
