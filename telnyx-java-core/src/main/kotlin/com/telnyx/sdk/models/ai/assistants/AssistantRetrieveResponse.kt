...
class AssistantRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssistantRetrieveResponse].
         *
    ...
    /** A builder for [AssistantRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(assistantRetrieveResponse: AssistantRetrieveResponse) = apply {
            id = assistantRetrieveResponse.id
            createdAt = assistantRetrieveResponse.createdAt
            instructions = assistantRetrieveResponse.instructions
            model = assistantRetrieveResponse.model
            name = assistantRetrieveResponse.name
            description = assistantRetrieveResponse.description
            dynamicVariables = assistantRetrieveResponse.dynamicVariables
            dynamicVariablesWebhookUrl = assistantRetrieveResponse.dynamicVariablesWebhookUrl
            enabledFeatures = assistantRetrieveResponse.enabledFeatures.map { it.toMutableList() }
            greeting = assistantRetrieveResponse.greeting
            importMetadata = assistantRetrieveResponse.importMetadata
            insightSettings = assistantRetrieveResponse.insightSettings
            llmApiKeyRef = assistantRetrieveResponse.llmApiKeyRef
            messagingSettings = assistantRetrieveResponse.messagingSettings
            privacySettings = assistantRetrieveResponse.privacySettings
            telephonySettings = assistantRetrieveResponse.telephonySettings
            tools = assistantRetrieveResponse.tools.map { it.toMutableList() }
            transcription = assistantRetrieveResponse.transcription
            voiceSettings = assistantRetrieveResponse.voiceSettings
            additionalProperties = assistantRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssistantRetrieveResponse].
         *
         ...
         */
        fun build(): AssistantRetrieveResponse =
    ...
    fun validate(): AssistantRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssistantRetrieveResponse &&
            id == other.id &&
