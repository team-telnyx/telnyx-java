...
class OutboundVoiceProfileUpdateParams
private constructor(
    ...
    /** A builder for [OutboundVoiceProfileUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(outboundVoiceProfileUpdateParams: OutboundVoiceProfileUpdateParams) =
            apply {
                id = outboundVoiceProfileUpdateParams.id
                body = outboundVoiceProfileUpdateParams.body.toBuilder()
                additionalHeaders = outboundVoiceProfileUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    outboundVoiceProfileUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [OutboundVoiceProfileUpdateParams].
         *
         ...
         */
        fun build(): OutboundVoiceProfileUpdateParams =
            OutboundVoiceProfileUpdateParams(
                id,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OutboundVoiceProfileUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "OutboundVoiceProfileUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
