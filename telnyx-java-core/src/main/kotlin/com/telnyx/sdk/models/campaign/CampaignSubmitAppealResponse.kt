...
class CampaignSubmitAppealResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CampaignSubmitAppealResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CampaignSubmitAppealResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(campaignSubmitAppealResponse: CampaignSubmitAppealResponse) = apply {
            appealedAt = campaignSubmitAppealResponse.appealedAt
            additionalProperties = campaignSubmitAppealResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CampaignSubmitAppealResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CampaignSubmitAppealResponse =
            CampaignSubmitAppealResponse(appealedAt, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CampaignSubmitAppealResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CampaignSubmitAppealResponse &&
    ...
    override fun toString() =
        "CampaignSubmitAppealResponse{appealedAt=$appealedAt, additionalProperties=$additionalProperties}"
}
