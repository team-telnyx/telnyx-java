...
class DialogflowConnectionCreateResponse
...
private constructor(
    ...
    /** A builder for [DialogflowConnectionCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dialogflowConnectionCreateResponse: DialogflowConnectionCreateResponse) =
            apply {
                data = dialogflowConnectionCreateResponse.data
                additionalProperties =
                    dialogflowConnectionCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DialogflowConnectionCreateResponse].
         *
         ...
         */
        fun build(): DialogflowConnectionCreateResponse =
            DialogflowConnectionCreateResponse(
    ...
    fun validate(): DialogflowConnectionCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DialogflowConnectionCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DialogflowConnectionCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
