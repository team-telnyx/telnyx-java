...
class WirelessBlocklistCreateParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun values(): List<String> = body.values()
    ...
    /** A builder for [WirelessBlocklistCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(wirelessBlocklistCreateParams: WirelessBlocklistCreateParams) = apply {
            body = wirelessBlocklistCreateParams.body.toBuilder()
            additionalHeaders = wirelessBlocklistCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = wirelessBlocklistCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WirelessBlocklistCreateParams].
         *
         ...
         */
        fun build(): WirelessBlocklistCreateParams =
            WirelessBlocklistCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WirelessBlocklistCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "WirelessBlocklistCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
