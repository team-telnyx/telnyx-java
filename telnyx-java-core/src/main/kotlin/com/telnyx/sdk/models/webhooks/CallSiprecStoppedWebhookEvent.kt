...
class CallSiprecStoppedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CallSiprecStoppedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callSiprecStoppedWebhookEvent: CallSiprecStoppedWebhookEvent) = apply {
            data = callSiprecStoppedWebhookEvent.data
            additionalProperties = callSiprecStoppedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallSiprecStoppedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallSiprecStoppedWebhookEvent =
            CallSiprecStoppedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallSiprecStoppedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallSiprecStoppedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallSiprecStoppedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
