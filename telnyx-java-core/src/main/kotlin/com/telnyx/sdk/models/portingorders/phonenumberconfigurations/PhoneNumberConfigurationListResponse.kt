...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = phoneNumberConfigurationListResponse.data.map { it.toMutableList() }
            meta = phoneNumberConfigurationListResponse.meta
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                portingPhoneNumberId = data.portingPhoneNumberId
                recordType = data.recordType
                updatedAt = data.updatedAt
                userBundleId = data.userBundleId
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, portingPhoneNumberId=$portingPhoneNumberId, recordType=$recordType, updatedAt=$updatedAt, userBundleId=$userBundleId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "PhoneNumberConfigurationListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
