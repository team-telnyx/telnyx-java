...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccessIpAddressCreateParams].
         *
    ...
    /** A builder for [AccessIpAddressCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accessIpAddressCreateParams: AccessIpAddressCreateParams) = apply {
            body = accessIpAddressCreateParams.body.toBuilder()
            additionalHeaders = accessIpAddressCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = accessIpAddressCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AccessIpAddressCreateParams].
         *
         ...
         */
        fun build(): AccessIpAddressCreateParams =
    ...
    private constructor(
        ...
        ) : this(ipAddress, description, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(ipAddress, description, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{ipAddress=$ipAddress, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccessIpAddressCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "AccessIpAddressCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
