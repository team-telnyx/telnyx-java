...
private constructor(
     ...
     */
    fun _cause(): JsonField<Cause> = body._cause()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(actionRejectParams: ActionRejectParams) = apply {
            callControlId = actionRejectParams.callControlId
         ...
         */
        fun cause(cause: JsonField<Cause>) = apply { body.cause(cause) }
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun cause(): Cause = cause.getRequired("cause")
        ...
        class Builder internal constructor() {
            ...
            private var cause: JsonField<Cause>? = null
        ...
        private val hashCode: Int by lazy {
            Objects.hash(cause, clientState, commandId, additionalProperties)
        }
    ...
    class Cause @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Cause && value == other.value
        }
    ...
    override fun toString() =
        "ActionRejectParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
