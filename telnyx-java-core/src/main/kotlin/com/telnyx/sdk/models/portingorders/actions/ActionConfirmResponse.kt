...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ActionConfirmResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionConfirmResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionConfirmResponse: ActionConfirmResponse) = apply {
            data = actionConfirmResponse.data
            meta = actionConfirmResponse.meta
            additionalProperties = actionConfirmResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionConfirmResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionConfirmResponse =
            ActionConfirmResponse(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionConfirmResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionConfirmResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ActionConfirmResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
