...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(globalIpHealthCheckListResponse: GlobalIpHealthCheckListResponse) =
            apply {
                data = globalIpHealthCheckListResponse.data.map { it.toMutableList() }
                meta = globalIpHealthCheckListResponse.meta
    ...
    override fun toString() =
        "GlobalIpHealthCheckListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
