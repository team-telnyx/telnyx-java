...
class SiprecConnectorUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiprecConnectorUpdateParams].
         *
    ...
    /** A builder for [SiprecConnectorUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siprecConnectorUpdateParams: SiprecConnectorUpdateParams) = apply {
            connectorName = siprecConnectorUpdateParams.connectorName
            body = siprecConnectorUpdateParams.body.toBuilder()
            additionalHeaders = siprecConnectorUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = siprecConnectorUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SiprecConnectorUpdateParams].
         *
         ...
         */
        fun build(): SiprecConnectorUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiprecConnectorUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(connectorName, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SiprecConnectorUpdateParams{connectorName=$connectorName, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
