...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UserBundleRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UserBundleRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserBundleRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userBundleRetrieveParams: UserBundleRetrieveParams) = apply {
            userBundleId = userBundleRetrieveParams.userBundleId
            authorizationBearer = userBundleRetrieveParams.authorizationBearer
            additionalHeaders = userBundleRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = userBundleRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserBundleRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserBundleRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserBundleRetrieveParams &&
    ...
    override fun toString() =
        "UserBundleRetrieveParams{userBundleId=$userBundleId, authorizationBearer=$authorizationBearer, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
