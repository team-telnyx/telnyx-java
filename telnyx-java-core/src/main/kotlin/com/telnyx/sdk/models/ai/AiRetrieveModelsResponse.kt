...
private constructor(
     ...
     * (and the deprecated `GET /v2/ai/models`). Open-source models live under their Hugging Face
    ...
    private constructor(
         ...
         *
         * Unlike [contextLength], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("context_length")
        @ExcludeMissing
         ...
         *
         * Unlike [isFineTunable], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("is_fine_tunable")
        @ExcludeMissing
         ...
         *
         * Unlike [parametersStr], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("parameters_str")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                isFineTunable = data.isFineTunable
                isVisionSupported = data.isVisionSupported
                maxCompletionTokens = data.maxCompletionTokens
                modelObject = data.modelObject
                parametersStr = data.parametersStr
                pricing = data.pricing
                recommendedForAssistants = data.recommendedForAssistants
                regions = data.regions.map { it.toMutableList() }
                task = data.task
             ...
             *
             * You should usually call [Builder.contextLength] with a well-typed [Long] value
             ...
             *
             * You should usually call [Builder.parameters] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * Billing tier the model belongs to. Used together with `pricing` to determine cost per
             * 1M tokens.
             */
             ...
             *
             * You should usually call [Builder.parametersStr] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Mapping of token kind to price, as strings to preserve precision. Typical keys are
             * `prompt`, `cached_prompt`, and `completion`. When pricing is available the block also
             * includes `currency` (ISO 4217 code matching the account's configured billing
             * currency) and `unit` (the denomination the prices are quoted in, currently always
             ...
             *
             * You should usually call [Builder.recommendedForAssistants] with a well-typed
             ...
             *
             * You should usually call [Builder.regions] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
