 ...
 */
class ActionResumeRecordingParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionResumeRecordingParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ActionResumeRecordingParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionResumeRecordingParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionResumeRecordingParams: ActionResumeRecordingParams) = apply {
            callControlId = actionResumeRecordingParams.callControlId
            body = actionResumeRecordingParams.body.toBuilder()
            additionalHeaders = actionResumeRecordingParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionResumeRecordingParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionResumeRecordingParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionResumeRecordingParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(clientState, commandId, recordingId, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{clientState=$clientState, commandId=$commandId, recordingId=$recordingId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionResumeRecordingParams &&
    ...
    override fun toString() =
        "ActionResumeRecordingParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
