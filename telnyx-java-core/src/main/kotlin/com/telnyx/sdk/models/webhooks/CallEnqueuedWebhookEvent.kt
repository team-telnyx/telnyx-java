...
class CallEnqueuedWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallEnqueuedWebhookEvent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallEnqueuedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callEnqueuedWebhookEvent: CallEnqueuedWebhookEvent) = apply {
            data = callEnqueuedWebhookEvent.data
            additionalProperties = callEnqueuedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallEnqueuedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallEnqueuedWebhookEvent =
            CallEnqueuedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallEnqueuedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_ENQUEUED = of("call.enqueued")
            ...
            fun value(): Value =
                when (this) {
                    CALL_ENQUEUED -> Value.CALL_ENQUEUED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_ENQUEUED -> Known.CALL_ENQUEUED
        ...
        private constructor(
            ...
            private val currentPosition: JsonField<Long>,
            private val queue: JsonField<String>,
            private val queueAvgWaitTimeSecs: JsonField<Long>,
            private val additionalProperties: MutableMap<String, JsonValue>,
        ) {
            ...
            private constructor(
                ...
                @ExcludeMissing
                currentPosition: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("queue") @ExcludeMissing queue: JsonField<String> = JsonMissing.of(),
                @JsonProperty("queue_avg_wait_time_secs")
                @ExcludeMissing
                queueAvgWaitTimeSecs: JsonField<Long> = JsonMissing.of(),
            ) : this(
                callControlId,
                callLegId,
                callSessionId,
             ...
             *   the server responded with an unexpected value).
             */
            fun currentPosition(): Optional<Long> = currentPosition.getOptional("current_position")
             ...
             *   the server responded with an unexpected value).
             */
            fun queueAvgWaitTimeSecs(): Optional<Long> =
                queueAvgWaitTimeSecs.getOptional("queue_avg_wait_time_secs")
            ...
            /**
             * Returns the raw JSON value of [currentPosition].
             *
             * Unlike [currentPosition], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("current_position")
            @ExcludeMissing
            fun _currentPosition(): JsonField<Long> = currentPosition
            ...
            /**
             * Returns the raw JSON value of [queueAvgWaitTimeSecs].
             *
             * Unlike [queueAvgWaitTimeSecs], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("queue_avg_wait_time_secs")
            @ExcludeMissing
            fun _queueAvgWaitTimeSecs(): JsonField<Long> = queueAvgWaitTimeSecs
            ...
            class Builder internal constructor() {
                ...
                private var currentPosition: JsonField<Long> = JsonMissing.of()
                private var queue: JsonField<String> = JsonMissing.of()
                private var queueAvgWaitTimeSecs: JsonField<Long> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                internal fun from(payload: Payload) = apply {
                    ...
                    queue = payload.queue
                    queueAvgWaitTimeSecs = payload.queueAvgWaitTimeSecs
                ...
                fun currentPosition(currentPosition: Long) =
                    currentPosition(JsonField.of(currentPosition))

                /**
                 * Sets [Builder.currentPosition] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.currentPosition] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun currentPosition(currentPosition: JsonField<Long>) = apply {
                ...
                /** Average time call spends in the queue in seconds. */
                fun queueAvgWaitTimeSecs(queueAvgWaitTimeSecs: Long) =
                    queueAvgWaitTimeSecs(JsonField.of(queueAvgWaitTimeSecs))

                /**
                 * Sets [Builder.queueAvgWaitTimeSecs] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.queueAvgWaitTimeSecs] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun queueAvgWaitTimeSecs(queueAvgWaitTimeSecs: JsonField<Long>) = apply {
            ...
            internal fun validity(): Int =
                (if (callControlId.asKnown().isPresent) 1 else 0) +
                    ...
                    (if (currentPosition.asKnown().isPresent) 1 else 0) +
                    (if (queue.asKnown().isPresent) 1 else 0) +
                    (if (queueAvgWaitTimeSecs.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is Payload &&
                    ...
                    queue == other.queue &&
                    queueAvgWaitTimeSecs == other.queueAvgWaitTimeSecs &&
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, currentPosition=$currentPosition, queue=$queue, queueAvgWaitTimeSecs=$queueAvgWaitTimeSecs, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallEnqueuedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallEnqueuedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
