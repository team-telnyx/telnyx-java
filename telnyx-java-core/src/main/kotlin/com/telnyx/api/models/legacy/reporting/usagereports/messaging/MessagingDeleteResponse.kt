...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, aggregationType=$aggregationType, connections=$connections, createdAt=$createdAt, endTime=$endTime, profiles=$profiles, recordType=$recordType, reportUrl=$reportUrl, result=$result, startTime=$startTime, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
