...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ActionListParams =
            ActionListParams(filter, page, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ActionListParams{filter=$filter, page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
