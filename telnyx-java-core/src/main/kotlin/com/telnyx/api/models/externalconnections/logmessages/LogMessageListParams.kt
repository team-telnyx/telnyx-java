...
private constructor(
    ...
    private constructor(
        ...
        private constructor(private val contains: String?, private val eq: String?) {
            ...
            class Builder internal constructor() {
                 ...
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): TelephoneNumber = TelephoneNumber(contains, eq)
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is TelephoneNumber && contains == other.contains && eq == other.eq
            }
            ...
            override fun toString() = "TelephoneNumber{contains=$contains, eq=$eq}"
        }
    ...
    override fun toString() =
        "LogMessageListParams{filter=$filter, page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
