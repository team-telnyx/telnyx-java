...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TexmlSecretsResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TexmlSecretsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(texmlSecretsResponse: TexmlSecretsResponse) = apply {
            data = texmlSecretsResponse.data
            additionalProperties = texmlSecretsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TexmlSecretsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlSecretsResponse =
            TexmlSecretsResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): TexmlSecretsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Data = Data(name, value, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Data{name=$name, value=$value, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlSecretsResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "TexmlSecretsResponse{data=$data, additionalProperties=$additionalProperties}"
}
