...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionRemovePublicIpResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionRemovePublicIpResponse: ActionRemovePublicIpResponse) = apply {
            data = actionRemovePublicIpResponse.data
            additionalProperties = actionRemovePublicIpResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionRemovePublicIpResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionRemovePublicIpResponse =
            ActionRemovePublicIpResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionRemovePublicIpResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionRemovePublicIpResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionRemovePublicIpResponse{data=$data, additionalProperties=$additionalProperties}"
}
