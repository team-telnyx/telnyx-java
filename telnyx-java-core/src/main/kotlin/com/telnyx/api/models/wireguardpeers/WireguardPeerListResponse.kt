...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(wireguardPeerListResponse: WireguardPeerListResponse) = apply {
            data = wireguardPeerListResponse.data.map { it.toMutableList() }
            meta = wireguardPeerListResponse.meta
    ...
    override fun toString() =
        "WireguardPeerListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
