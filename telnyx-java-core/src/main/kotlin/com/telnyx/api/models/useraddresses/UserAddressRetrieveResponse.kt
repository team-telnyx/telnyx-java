...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserAddressRetrieveResponse].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userAddressRetrieveResponse: UserAddressRetrieveResponse) = apply {
            data = userAddressRetrieveResponse.data
        ...
        /**
         * Returns an immutable instance of [UserAddressRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserAddressRetrieveResponse =
            UserAddressRetrieveResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): UserAddressRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserAddressRetrieveResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UserAddressRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
