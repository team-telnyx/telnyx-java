...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            @JsonProperty("failed")
            @ExcludeMissing
            failed: JsonField<List<String>> = JsonMissing.of(),
            ...
            @ExcludeMissing
            success: JsonField<List<String>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                failed = data.failed.map { it.toMutableList() }
                orderId = data.orderId
                pending = data.pending.map { it.toMutableList() }
                recordType = data.recordType
                success = data.success.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.failed] with a well-typed `List<String>` value
             ...
             *
             * You should usually call [Builder.pending] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.success] with a well-typed `List<String>` value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Data{failed=$failed, orderId=$orderId, pending=$pending, recordType=$recordType, success=$success, additionalProperties=$additionalProperties}"
    }
