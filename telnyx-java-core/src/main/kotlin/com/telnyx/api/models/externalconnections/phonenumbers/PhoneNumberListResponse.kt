...
private constructor(
    private val data: JsonField<List<ExternalConnectionPhoneNumber>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ExternalConnectionPhoneNumber>> = JsonMissing.of(),
        @JsonProperty("meta")
        @ExcludeMissing
     ...
     */
    fun data(): Optional<List<ExternalConnectionPhoneNumber>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<ExternalConnectionPhoneNumber>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ExternalConnectionPhoneNumber>>? = null
        ...
        internal fun from(phoneNumberListResponse: PhoneNumberListResponse) = apply {
            data = phoneNumberListResponse.data.map { it.toMutableList() }
            meta = phoneNumberListResponse.meta
            additionalProperties = phoneNumberListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<ExternalConnectionPhoneNumber>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<ExternalConnectionPhoneNumber>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<ExternalConnectionPhoneNumber>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ExternalConnectionPhoneNumber] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ExternalConnectionPhoneNumber) = apply {
            this.data =
    ...
    override fun toString() =
        "PhoneNumberListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
