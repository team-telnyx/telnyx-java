...
private constructor(
    ...
    /** A builder for [SubNumberOrderUpdateRequirementGroupParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            subNumberOrderUpdateRequirementGroupParams: SubNumberOrderUpdateRequirementGroupParams
        ) = apply {
            id = subNumberOrderUpdateRequirementGroupParams.id
            body = subNumberOrderUpdateRequirementGroupParams.body.toBuilder()
            additionalHeaders =
                subNumberOrderUpdateRequirementGroupParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                subNumberOrderUpdateRequirementGroupParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubNumberOrderUpdateRequirementGroupParams].
         *
         ...
         */
        fun build(): SubNumberOrderUpdateRequirementGroupParams =
            SubNumberOrderUpdateRequirementGroupParams(
                id,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubNumberOrderUpdateRequirementGroupParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "SubNumberOrderUpdateRequirementGroupParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
