...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionStopNoiseSuppressionParams = builder().build()
    ...
    /** A builder for [ActionStopNoiseSuppressionParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionStopNoiseSuppressionParams: ActionStopNoiseSuppressionParams) =
            apply {
                callControlId = actionStopNoiseSuppressionParams.callControlId
                body = actionStopNoiseSuppressionParams.body.toBuilder()
                additionalHeaders = actionStopNoiseSuppressionParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    actionStopNoiseSuppressionParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ActionStopNoiseSuppressionParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStopNoiseSuppressionParams =
            ActionStopNoiseSuppressionParams(
                callControlId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStopNoiseSuppressionParams &&
    ...
    override fun toString() =
        "ActionStopNoiseSuppressionParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
