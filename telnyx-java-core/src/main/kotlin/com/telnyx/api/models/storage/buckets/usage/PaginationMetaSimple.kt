...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PaginationMetaSimple]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PaginationMetaSimple]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paginationMetaSimple: PaginationMetaSimple) = apply {
            pageNumber = paginationMetaSimple.pageNumber
            pageSize = paginationMetaSimple.pageSize
            totalPages = paginationMetaSimple.totalPages
            totalResults = paginationMetaSimple.totalResults
            additionalProperties = paginationMetaSimple.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaginationMetaSimple].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PaginationMetaSimple =
    ...
    fun validate(): PaginationMetaSimple = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaginationMetaSimple &&
    ...
    override fun toString() =
        "PaginationMetaSimple{pageNumber=$pageNumber, pageSize=$pageSize, totalPages=$totalPages, totalResults=$totalResults, additionalProperties=$additionalProperties}"
}
