...
class PhoneNumberDeleteResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberDeleteResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PhoneNumberDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberDeleteResponse: PhoneNumberDeleteResponse) = apply {
            data = phoneNumberDeleteResponse.data
            additionalProperties = phoneNumberDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberDeleteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PhoneNumberDeleteResponse =
            PhoneNumberDeleteResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PhoneNumberDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [messagingProfileName], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("messaging_profile_name")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                deletionLockEnabled = data.deletionLockEnabled
             ...
             *
             * You should usually call [Builder.messagingProfileName] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberDeleteResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PhoneNumberDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
