...
class FaxMediaProcessedWebhookEvent
...
private constructor(
    ...
    /** A builder for [FaxMediaProcessedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxMediaProcessedWebhookEvent: FaxMediaProcessedWebhookEvent) = apply {
            id = faxMediaProcessedWebhookEvent.id
            eventType = faxMediaProcessedWebhookEvent.eventType
            payload = faxMediaProcessedWebhookEvent.payload
            recordType = faxMediaProcessedWebhookEvent.recordType
            additionalProperties = faxMediaProcessedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FaxMediaProcessedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FaxMediaProcessedWebhookEvent =
            FaxMediaProcessedWebhookEvent(
                id,
                eventType,
                payload,
    ...
    fun validate(): FaxMediaProcessedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FAX_MEDIA_PROCESSED = of("fax.media.processed")
        ...
        fun value(): Value =
            when (this) {
                FAX_MEDIA_PROCESSED -> Value.FAX_MEDIA_PROCESSED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FAX_MEDIA_PROCESSED -> Known.FAX_MEDIA_PROCESSED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxMediaProcessedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "FaxMediaProcessedWebhookEvent{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
