...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(requirementListResponse: RequirementListResponse) = apply {
            data = requirementListResponse.data.map { it.toMutableList() }
            meta = requirementListResponse.meta
    ...
    override fun toString() =
        "RequirementListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
