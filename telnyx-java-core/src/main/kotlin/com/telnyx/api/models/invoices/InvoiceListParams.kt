...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): InvoiceListParams =
            InvoiceListParams(page, sort, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    class Sort @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PERIOD_START = of("period_start")

            @JvmField val PERIOD_START_DESC = of("-period_start")
        ...
        fun value(): Value =
            when (this) {
                ...
                PERIOD_START_DESC -> Value.PERIOD_START_DESC
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ...
                PERIOD_START_DESC -> Known.PERIOD_START_DESC
    ...
    override fun hashCode(): Int =
        Objects.hash(page, sort, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "InvoiceListParams{page=$page, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
