...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionListParams: VersionListParams) = apply {
            assistantId = versionListParams.assistantId
        ...
        fun build(): VersionListParams =
            VersionListParams(assistantId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "VersionListParams{assistantId=$assistantId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
