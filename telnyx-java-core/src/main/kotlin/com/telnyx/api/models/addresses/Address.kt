...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(address: Address) = apply {
            ...
            customerReference = address.customerReference
         ...
         * value.
         */
        fun addressBook(addressBook: JsonField<Boolean>) = apply { this.addressBook = addressBook }
    ...
    override fun toString() =
        "Address{id=$id, addressBook=$addressBook, administrativeArea=$administrativeArea, borough=$borough, businessName=$businessName, countryCode=$countryCode, createdAt=$createdAt, customerReference=$customerReference, extendedAddress=$extendedAddress, firstName=$firstName, lastName=$lastName, locality=$locality, neighborhood=$neighborhood, phoneNumber=$phoneNumber, postalCode=$postalCode, recordType=$recordType, streetAddress=$streetAddress, updatedAt=$updatedAt, validateAddress=$validateAddress, additionalProperties=$additionalProperties}"
}
