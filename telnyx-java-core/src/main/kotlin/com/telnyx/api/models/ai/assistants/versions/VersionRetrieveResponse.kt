...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionRetrieveResponse: VersionRetrieveResponse) = apply {
            ...
            instructions = versionRetrieveResponse.instructions
            model = versionRetrieveResponse.model
            name = versionRetrieveResponse.name
            description = versionRetrieveResponse.description
            dynamicVariables = versionRetrieveResponse.dynamicVariables
            dynamicVariablesWebhookUrl = versionRetrieveResponse.dynamicVariablesWebhookUrl
            enabledFeatures = versionRetrieveResponse.enabledFeatures.map { it.toMutableList() }
            greeting = versionRetrieveResponse.greeting
            importMetadata = versionRetrieveResponse.importMetadata
            insightSettings = versionRetrieveResponse.insightSettings
            llmApiKeyRef = versionRetrieveResponse.llmApiKeyRef
            messagingSettings = versionRetrieveResponse.messagingSettings
            privacySettings = versionRetrieveResponse.privacySettings
            telephonySettings = versionRetrieveResponse.telephonySettings
            tools = versionRetrieveResponse.tools.map { it.toMutableList() }
            transcription = versionRetrieveResponse.transcription
            voiceSettings = versionRetrieveResponse.voiceSettings
