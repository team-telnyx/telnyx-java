...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceRetrieveParams: InvoiceRetrieveParams) = apply {
            ...
            action = invoiceRetrieveParams.action
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                action?.let { put("action", it.toString()) }
    ...
    override fun hashCode(): Int =
        Objects.hash(id, action, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "InvoiceRetrieveParams{id=$id, action=$action, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
