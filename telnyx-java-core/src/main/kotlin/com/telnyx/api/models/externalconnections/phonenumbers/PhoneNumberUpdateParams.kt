...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(locationId, additionalProperties.toMutableMap())
        }
    ...
    override fun hashCode(): Int =
        Objects.hash(id, phoneNumberId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "PhoneNumberUpdateParams{id=$id, phoneNumberId=$phoneNumberId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
