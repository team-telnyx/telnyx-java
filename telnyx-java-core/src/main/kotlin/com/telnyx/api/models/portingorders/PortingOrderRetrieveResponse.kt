...
class PortingOrderRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortingOrderRetrieveResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PortingOrderRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portingOrderRetrieveResponse: PortingOrderRetrieveResponse) = apply {
            data = portingOrderRetrieveResponse.data
            meta = portingOrderRetrieveResponse.meta
            additionalProperties = portingOrderRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortingOrderRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PortingOrderRetrieveResponse =
            PortingOrderRetrieveResponse(data, meta, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PortingOrderRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortingOrderRetrieveResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PortingOrderRetrieveResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
