...
class DialogflowConnectionCreateParams
private constructor(
    ...
    /** A builder for [DialogflowConnectionCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dialogflowConnectionCreateParams: DialogflowConnectionCreateParams) =
            apply {
                connectionId = dialogflowConnectionCreateParams.connectionId
                body = dialogflowConnectionCreateParams.body.toBuilder()
                additionalHeaders = dialogflowConnectionCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    dialogflowConnectionCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DialogflowConnectionCreateParams].
         *
         ...
         */
        fun build(): DialogflowConnectionCreateParams =
            DialogflowConnectionCreateParams(
                connectionId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DialogflowConnectionCreateParams &&
    ...
    override fun toString() =
        "DialogflowConnectionCreateParams{connectionId=$connectionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
