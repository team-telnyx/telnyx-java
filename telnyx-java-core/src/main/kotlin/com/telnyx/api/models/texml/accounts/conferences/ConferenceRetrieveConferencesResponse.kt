...
private constructor(
    private val conferences: JsonField<List<Conference>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        conferences: JsonField<List<Conference>> = JsonMissing.of(),
     ...
     */
    fun conferences(): Optional<List<Conference>> = conferences.getOptional("conferences")
    ...
    @JsonProperty("conferences")
    @ExcludeMissing
    fun _conferences(): JsonField<List<Conference>> = conferences
    ...
    class Builder internal constructor() {
        ...
        private var conferences: JsonField<MutableList<Conference>>? = null
        ...
        fun conferences(conferences: List<Conference>) = conferences(JsonField.of(conferences))

        /**
         * Sets [Builder.conferences] to an arbitrary JSON value.
         *
         * You should usually call [Builder.conferences] with a well-typed `List<Conference>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun conferences(conferences: JsonField<List<Conference>>) = apply {
            this.conferences = conferences.map { it.toMutableList() }
        }

        /**
         * Adds a single [Conference] to [conferences].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConference(conference: Conference) = apply {
            conferences =
    ...
    private constructor(
         ...
         *
         * Unlike [reasonConferenceEnded], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("reason_conference_ended")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(conference: Conference) = apply {
                ...
                apiVersion = conference.apiVersion
                ...
                subresourceUris = conference.subresourceUris
                uri = conference.uri
             ...
             * [ReasonConferenceEnded] value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun reasonConferenceEnded(reasonConferenceEnded: JsonField<ReasonConferenceEnded>) =
                apply {
        ...
        private constructor(private val value: JsonField<String>) : Enum {
             ...
             * member.
             *
             * An instance of [ReasonConferenceEnded] can contain an unknown value in a couple of
             * cases:
            ...
            fun known(): Known =
                when (this) {
                    ...
                    TIME_EXCEEDED -> Known.TIME_EXCEEDED
                        ...
                        throw TelnyxInvalidDataException("Unknown ReasonConferenceEnded: $value")
                }
