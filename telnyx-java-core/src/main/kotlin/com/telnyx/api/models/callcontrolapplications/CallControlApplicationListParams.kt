...
class CallControlApplicationListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CallControlApplicationListParams = builder().build()
    ...
    /** A builder for [CallControlApplicationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callControlApplicationListParams: CallControlApplicationListParams) =
            apply {
                filter = callControlApplicationListParams.filter
                page = callControlApplicationListParams.page
                sort = callControlApplicationListParams.sort
                additionalHeaders = callControlApplicationListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    callControlApplicationListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CallControlApplicationListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallControlApplicationListParams =
            CallControlApplicationListParams(
                filter,
                page,
                sort,
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): OccurredAt = OccurredAt(eq, gt, gte, lt, lte)
            }
            ...
            private val hashCode: Int by lazy { Objects.hash(eq, gt, gte, lt, lte) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "OccurredAt{eq=$eq, gt=$gt, gte=$gte, lt=$lt, lte=$lte}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallControlApplicationListParams &&
            filter == other.filter &&
            page == other.page &&
            sort == other.sort &&
    ...
    override fun toString() =
        "CallControlApplicationListParams{filter=$filter, page=$page, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
