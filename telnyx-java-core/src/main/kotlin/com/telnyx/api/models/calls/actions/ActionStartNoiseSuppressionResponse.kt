...
class ActionStartNoiseSuppressionResponse
...
private constructor(
    ...
    /** A builder for [ActionStartNoiseSuppressionResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = actionStartNoiseSuppressionResponse.data
            additionalProperties =
                actionStartNoiseSuppressionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionStartNoiseSuppressionResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStartNoiseSuppressionResponse =
            ActionStartNoiseSuppressionResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionStartNoiseSuppressionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStartNoiseSuppressionResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionStartNoiseSuppressionResponse{data=$data, additionalProperties=$additionalProperties}"
}
