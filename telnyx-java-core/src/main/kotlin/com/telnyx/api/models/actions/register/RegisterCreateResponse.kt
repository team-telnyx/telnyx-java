...
import com.telnyx.api.models.SimpleSimCard
import java.util.Collections
import java.util.Objects
import java.util.Optional
import kotlin.jvm.optionals.getOrNull

class RegisterCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RegisterCreateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RegisterCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(registerCreateResponse: RegisterCreateResponse) = apply {
            data = registerCreateResponse.data.map { it.toMutableList() }
            errors = registerCreateResponse.errors.map { it.toMutableList() }
            additionalProperties = registerCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RegisterCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RegisterCreateResponse =
    ...
    fun validate(): RegisterCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RegisterCreateResponse &&
            data == other.data &&
            errors == other.errors &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "RegisterCreateResponse{data=$data, errors=$errors, additionalProperties=$additionalProperties}"
}
