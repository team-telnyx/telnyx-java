...
private constructor(
    ...
    /**
     * The URL we should call to announce something into the conference. The URL may return an MP3
    ...
    /**
     * The new status of the resource. Specifying `completed` will end the conference and hang up
     * all participants.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConferenceUpdateParams].
         *
    ...
    /** A builder for [ConferenceUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceUpdateParams: ConferenceUpdateParams) = apply {
            accountSid = conferenceUpdateParams.accountSid
            conferenceSid = conferenceUpdateParams.conferenceSid
            body = conferenceUpdateParams.body.toBuilder()
            additionalHeaders = conferenceUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = conferenceUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * The URL we should call to announce something into the conference. The URL may return an
         * MP3 file, a WAV file, or a TwiML document that contains `<Play>`, `<Say>`, `<Pause>`, or
         * `<Redirect>` verbs.
         */
        ...
        /**
         * The new status of the resource. Specifying `completed` will end the conference and hang
         * up all participants.
         */
        ...
        /**
         * Returns an immutable instance of [ConferenceUpdateParams].
         *
         ...
         */
        fun build(): ConferenceUpdateParams =
    ...
    private constructor(
        ...
        ) : this(announceMethod, announceUrl, status, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /**
             * The URL we should call to announce something into the conference. The URL may return
            ...
            /**
             * The new status of the resource. Specifying `completed` will end the conference and
             ...
             */
            fun build(): Body =
                Body(announceMethod, announceUrl, status, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(announceMethod, announceUrl, status, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{announceMethod=$announceMethod, announceUrl=$announceUrl, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceUpdateParams &&
    ...
    override fun toString() =
        "ConferenceUpdateParams{accountSid=$accountSid, conferenceSid=$conferenceSid, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
