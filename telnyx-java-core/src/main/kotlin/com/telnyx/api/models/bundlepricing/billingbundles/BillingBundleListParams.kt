...
private constructor(
    ...
    override fun toString() =
        "BillingBundleListParams{filter=$filter, page=$page, authorizationBearer=$authorizationBearer, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
