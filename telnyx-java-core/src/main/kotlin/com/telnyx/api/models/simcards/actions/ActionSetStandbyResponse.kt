...
class ActionSetStandbyResponse
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ActionSetStandbyResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionSetStandbyResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionSetStandbyResponse: ActionSetStandbyResponse) = apply {
            data = actionSetStandbyResponse.data
            additionalProperties = actionSetStandbyResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionSetStandbyResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionSetStandbyResponse =
            ActionSetStandbyResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ActionSetStandbyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionSetStandbyResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ActionSetStandbyResponse{data=$data, additionalProperties=$additionalProperties}"
}
