 ...
 */
class ExternalVettingImportParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalVettingImportParams].
         *
    ...
    /** A builder for [ExternalVettingImportParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalVettingImportParams: ExternalVettingImportParams) = apply {
            brandId = externalVettingImportParams.brandId
            body = externalVettingImportParams.body.toBuilder()
            additionalHeaders = externalVettingImportParams.additionalHeaders.toBuilder()
            additionalQueryParams = externalVettingImportParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalVettingImportParams].
         *
         ...
         */
        fun build(): ExternalVettingImportParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalVettingImportParams &&
    ...
    override fun toString() =
        "ExternalVettingImportParams{brandId=$brandId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
