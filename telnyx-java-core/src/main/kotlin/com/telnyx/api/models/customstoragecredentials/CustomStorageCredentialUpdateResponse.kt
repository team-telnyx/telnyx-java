...
class CustomStorageCredentialUpdateResponse
...
private constructor(
    ...
    /** A builder for [CustomStorageCredentialUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            customStorageCredentialUpdateResponse: CustomStorageCredentialUpdateResponse
        ) = apply {
            connectionId = customStorageCredentialUpdateResponse.connectionId
            data = customStorageCredentialUpdateResponse.data
            recordType = customStorageCredentialUpdateResponse.recordType
            additionalProperties =
                customStorageCredentialUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomStorageCredentialUpdateResponse].
         *
         ...
         */
        fun build(): CustomStorageCredentialUpdateResponse =
            CustomStorageCredentialUpdateResponse(
    ...
    fun validate(): CustomStorageCredentialUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomStorageCredentialUpdateResponse &&
    ...
    override fun toString() =
        "CustomStorageCredentialUpdateResponse{connectionId=$connectionId, data=$data, recordType=$recordType, additionalProperties=$additionalProperties}"
}
