...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [JobDeleteBatchParams].
         *
    ...
    /** A builder for [JobDeleteBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(jobDeleteBatchParams: JobDeleteBatchParams) = apply {
            body = jobDeleteBatchParams.body.toBuilder()
            additionalHeaders = jobDeleteBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = jobDeleteBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [JobDeleteBatchParams].
         *
         ...
         */
        fun build(): JobDeleteBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JobDeleteBatchParams &&
            body == other.body &&
    ...
    override fun toString() =
        "JobDeleteBatchParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
