...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SubNumberOrderUpdateParams = builder().build()
    ...
    override fun hashCode(): Int =
        Objects.hash(subNumberOrderId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SubNumberOrderUpdateParams{subNumberOrderId=$subNumberOrderId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
