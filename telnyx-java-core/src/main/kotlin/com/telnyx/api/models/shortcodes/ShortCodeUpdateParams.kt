...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ShortCodeUpdateParams].
         *
    ...
    /** A builder for [ShortCodeUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(shortCodeUpdateParams: ShortCodeUpdateParams) = apply {
            id = shortCodeUpdateParams.id
            body = shortCodeUpdateParams.body.toBuilder()
            additionalHeaders = shortCodeUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = shortCodeUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ShortCodeUpdateParams].
         *
         ...
         */
        fun build(): ShortCodeUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShortCodeUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ShortCodeUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
