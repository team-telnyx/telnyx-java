...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sessionRetrieveParams: SessionRetrieveParams) = apply {
            roomSessionId = sessionRetrieveParams.roomSessionId
            includeParticipants = sessionRetrieveParams.includeParticipants
    ...
    override fun hashCode(): Int =
        Objects.hash(roomSessionId, includeParticipants, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SessionRetrieveParams{roomSessionId=$roomSessionId, includeParticipants=$includeParticipants, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
