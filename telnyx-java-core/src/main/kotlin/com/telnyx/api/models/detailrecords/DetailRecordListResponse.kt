...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DetailRecordListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DetailRecordListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(detailRecordListResponse: DetailRecordListResponse) = apply {
            data = detailRecordListResponse.data.map { it.toMutableList() }
            meta = detailRecordListResponse.meta
            additionalProperties = detailRecordListResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Alias for calling [addData] with `Data.ofMessageDetailRecord(messageDetailRecord)`. */
        fun addData(messageDetailRecord: Data.MessageDetailRecord) =
            addData(Data.ofMessageDetailRecord(messageDetailRecord))

        /**
         * Alias for calling [addData] with `Data.ofConferenceDetailRecord(conferenceDetailRecord)`.
         */
        fun addData(conferenceDetailRecord: Data.ConferenceDetailRecord) =
            addData(Data.ofConferenceDetailRecord(conferenceDetailRecord))

        /**
         * Alias for calling [addData] with
         * `Data.ofConferenceParticipantDetailRecord(conferenceParticipantDetailRecord)`.
         */
        fun addData(conferenceParticipantDetailRecord: Data.ConferenceParticipantDetailRecord) =
            addData(Data.ofConferenceParticipantDetailRecord(conferenceParticipantDetailRecord))

        /** Alias for calling [addData] with `Data.ofAmdDetailRecord(amdDetailRecord)`. */
        fun addData(amdDetailRecord: Data.AmdDetailRecord) =
            addData(Data.ofAmdDetailRecord(amdDetailRecord))

        /** Alias for calling [addData] with `Data.ofVerifyDetailRecord(verifyDetailRecord)`. */
        fun addData(verifyDetailRecord: Data.VerifyDetailRecord) =
            addData(Data.ofVerifyDetailRecord(verifyDetailRecord))

        /**
         * Alias for calling [addData] with
         * `Data.ofSimCardUsageDetailRecord(simCardUsageDetailRecord)`.
         */
        fun addData(simCardUsageDetailRecord: Data.SimCardUsageDetailRecord) =
            addData(Data.ofSimCardUsageDetailRecord(simCardUsageDetailRecord))

        /**
         * Alias for calling [addData] with
         * `Data.ofMediaStorageDetailRecord(mediaStorageDetailRecord)`.
         */
        fun addData(mediaStorageDetailRecord: Data.MediaStorageDetailRecord) =
            addData(Data.ofMediaStorageDetailRecord(mediaStorageDetailRecord))
        ...
        /**
         * Returns an immutable instance of [DetailRecordListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DetailRecordListResponse =
    ...
    private constructor(
        ...
        fun verifyDetailRecord(): Optional<VerifyDetailRecord> =
            Optional.ofNullable(verifyDetailRecord)
        ...
        fun isConferenceParticipantDetailRecord(): Boolean =
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                conferenceParticipantDetailRecord != null ->
                    visitor.visitConferenceParticipantDetailRecord(
        ...
        fun validate(): Data = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitMessageDetailRecord(
        ...
        override fun toString(): String =
            when {
                messageDetailRecord != null -> "Data{messageDetailRecord=$messageDetailRecord}"
                conferenceDetailRecord != null ->
                    "Data{conferenceDetailRecord=$conferenceDetailRecord}"
                conferenceParticipantDetailRecord != null ->
                    "Data{conferenceParticipantDetailRecord=$conferenceParticipantDetailRecord}"
                amdDetailRecord != null -> "Data{amdDetailRecord=$amdDetailRecord}"
                verifyDetailRecord != null -> "Data{verifyDetailRecord=$verifyDetailRecord}"
                simCardUsageDetailRecord != null ->
                    "Data{simCardUsageDetailRecord=$simCardUsageDetailRecord}"
                mediaStorageDetailRecord != null ->
                    "Data{mediaStorageDetailRecord=$mediaStorageDetailRecord}"
        ...
        companion object {
            ...
            fun ofMessageDetailRecord(messageDetailRecord: MessageDetailRecord) =
                Data(messageDetailRecord = messageDetailRecord)
            ...
            fun ofAmdDetailRecord(amdDetailRecord: AmdDetailRecord) =
                Data(amdDetailRecord = amdDetailRecord)

            @JvmStatic
            fun ofVerifyDetailRecord(verifyDetailRecord: VerifyDetailRecord) =
                Data(verifyDetailRecord = verifyDetailRecord)
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<MessageDetailRecord>())?.let {
                                Data(messageDetailRecord = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<ConferenceDetailRecord>())?.let {
                                Data(conferenceDetailRecord = it, _json = json)
                            },
                            tryDeserialize(
                                    node,
                                    jacksonTypeRef<ConferenceParticipantDetailRecord>(),
                                )
                                ?.let {
                                    Data(conferenceParticipantDetailRecord = it, _json = json)
                                },
                            tryDeserialize(node, jacksonTypeRef<AmdDetailRecord>())?.let {
                                Data(amdDetailRecord = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<VerifyDetailRecord>())?.let {
                                Data(verifyDetailRecord = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<SimCardUsageDetailRecord>())?.let {
                                Data(simCardUsageDetailRecord = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<MediaStorageDetailRecord>())?.let {
                                Data(mediaStorageDetailRecord = it, _json = json)
                            },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Data>(Data::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.verifyDetailRecord != null ->
                        generator.writeObject(value.verifyDetailRecord)
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("on_net")
                @ExcludeMissing
                onNet: JsonField<Boolean> = JsonMissing.of(),
             ...
             *
             * Unlike [carrierFee], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("carrier_fee")
            @ExcludeMissing
             ...
             *
             * Unlike [deliveryStatusFailoverUrl], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("delivery_status_failover_url")
            @ExcludeMissing
             ...
             *
             * Unlike [messageType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("message_type")
            @ExcludeMissing
             ...
             *
             * Unlike [profileName], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("profile_name")
            @ExcludeMissing
             ...
             *
             * Unlike [sourceCountryCode], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("source_country_code")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * yet supported value.
                 */
                fun carrierFee(carrierFee: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.cost] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 */
                fun deliveryStatusFailoverUrl(deliveryStatusFailoverUrl: JsonField<String>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.deliveryStatusWebhookUrl] with a well-typed
                 * [String] value instead. This method is primarily for setting the field to an
                 * undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.messageType] with a well-typed [MessageType]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.mnc] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.onNet] with a well-typed [Boolean] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.parts] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.sourceCountryCode] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.tags] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("call_sec")
                @ExcludeMissing
                callSec: JsonField<Long> = JsonMissing.of(),
             ...
             *   the server responded with an unexpected value).
             */
            fun participantCount(): Optional<Long> =
                participantCount.getOptional("participant_count")
             ...
             *
             * Unlike [isTelnyxBillable], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("is_telnyx_billable")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(conferenceDetailRecord: ConferenceDetailRecord) = apply {
                    ...
                    additionalProperties =
                        conferenceDetailRecord.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.isTelnyxBillable] with a well-typed [Boolean]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.participantCallSec] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
        ...
        private constructor(
             ...
             *
             * Unlike [billedSec], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("billed_sec")
            @ExcludeMissing
            fun _billedSec(): JsonField<Long> = billedSec
             ...
             *
             * Unlike [destinationNumber], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("destination_number")
            @ExcludeMissing
             ...
             *
             * Unlike [joinedAt], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("joined_at")
            @ExcludeMissing
            ...
            @JsonProperty("left_at")
            @ExcludeMissing
            fun _leftAt(): JsonField<OffsetDateTime> = leftAt

            /**
             * Returns the raw JSON value of [originatingNumber].
             *
             * Unlike [originatingNumber], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("originating_number")
            @ExcludeMissing
             ...
             *
             * Unlike [rateMeasuredIn], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("rate_measured_in")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.billedSec] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.destinationNumber] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.joinedAt] with a well-typed [OffsetDateTime]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun joinedAt(joinedAt: JsonField<OffsetDateTime>) = apply {
                 ...
                 *
                 * You should usually call [Builder.originatingNumber] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
        ...
        private constructor(
             ...
             *
             * Unlike [billingGroupName], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("billing_group_name")
            @ExcludeMissing
             ...
             *
             * Unlike [connectionName], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("connection_name")
            @ExcludeMissing
             ...
             *
             * Unlike [invokedAt], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("invoked_at")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.billingGroupName] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.invokedAt] with a well-typed [OffsetDateTime]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            class Feature @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                enum class Value {
                    PREMIUM,
                    /**
                     * An enum member indicating that [Feature] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun verifyChannelId(): Optional<String> =
                verifyChannelId.getOptional("verify_channel_id")
             ...
             *   the server responded with an unexpected value).
             */
            fun verifyProfileId(): Optional<String> =
                verifyProfileId.getOptional("verify_profile_id")
             ...
             *
             * Unlike [verifyChannelId], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("verify_channel_id")
            @ExcludeMissing
             ...
             *
             * Unlike [verifyChannelType], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("verify_channel_type")
            @ExcludeMissing
             ...
             *
             * Unlike [verifyProfileId], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("verify_profile_id")
            @ExcludeMissing
             ...
             *
             * Unlike [verifyUsageFee], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("verify_usage_fee")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.destinationPhoneNumber] with a well-typed
                 * [String] value instead. This method is primarily for setting the field to an
                 * undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.verificationStatus] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.verifyChannelId] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 * [VerifyChannelType] value instead. This method is primarily for setting the field
                 ...
                 *
                 * You should usually call [Builder.verifyProfileId] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                 ...
                 * member.
                 *
                 * An instance of [VerifyChannelType] can contain an unknown value in a couple of
                 * cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        FLASHCALL -> Known.FLASHCALL
                            ...
                            throw TelnyxInvalidDataException("Unknown VerifyChannelType: $value")
                    }
        ...
        private constructor(
             ...
             *
             * Unlike [closedAt], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("closed_at")
            @ExcludeMissing
             ...
             *
             * Unlike [dataCost], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [dataRate], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [dataUnit], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [simCardId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sim_card_id")
            @ExcludeMissing
            fun _simCardId(): JsonField<String> = simCardId

            /**
             * Returns the raw JSON value of [simCardTags].
             *
             * Unlike [simCardTags], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sim_card_tags")
            @ExcludeMissing
             ...
             *
             * Unlike [simGroupId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("sim_group_id")
            @ExcludeMissing
             ...
             *
             * Unlike [uplinkData], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("uplink_data")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(simCardUsageDetailRecord: SimCardUsageDetailRecord) = apply {
                    ...
                    additionalProperties =
                        simCardUsageDetailRecord.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.closedAt] with a well-typed [OffsetDateTime]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.dataCost] with a well-typed [Double] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.dataRate] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.dataUnit] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.imsi] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.simCardId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * yet supported value.
                 */
                fun simGroupId(simGroupId: JsonField<String>) = apply {
                 ...
                 * yet supported value.
                 */
                fun uplinkData(uplinkData: JsonField<Double>) = apply {
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun linkChannelType(): Optional<String> =
                linkChannelType.getOptional("link_channel_type")
             ...
             *
             * Unlike [linkChannelType], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("link_channel_type")
            @ExcludeMissing
             ...
             *
             * Unlike [webhookId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("webhook_id")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(mediaStorageDetailRecord: MediaStorageDetailRecord) = apply {
                    ...
                    additionalProperties =
                        mediaStorageDetailRecord.additionalProperties.toMutableMap()
                }
                ...
                /** Link channel id */
                fun linkChannelId(linkChannelId: String) =
                    linkChannelId(JsonField.of(linkChannelId))
                 ...
                 *
                 * You should usually call [Builder.linkChannelType] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.webhookId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
    ...
    override fun toString() =
        "DetailRecordListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
