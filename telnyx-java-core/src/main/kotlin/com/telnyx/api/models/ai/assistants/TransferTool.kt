...
private constructor(
    private val transfer: JsonField<InferenceEmbeddingTransferToolParams>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        transfer: JsonField<InferenceEmbeddingTransferToolParams> = JsonMissing.of(),
     ...
     */
    fun transfer(): InferenceEmbeddingTransferToolParams = transfer.getRequired("transfer")
    ...
    @JsonProperty("transfer")
    @ExcludeMissing
    fun _transfer(): JsonField<InferenceEmbeddingTransferToolParams> = transfer
    ...
    class Builder internal constructor() {
        ...
        private var transfer: JsonField<InferenceEmbeddingTransferToolParams>? = null
        ...
        fun transfer(transfer: InferenceEmbeddingTransferToolParams) =
            transfer(JsonField.of(transfer))

        /**
         * Sets [Builder.transfer] to an arbitrary JSON value.
         *
         * You should usually call [Builder.transfer] with a well-typed
         * [InferenceEmbeddingTransferToolParams] value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun transfer(transfer: JsonField<InferenceEmbeddingTransferToolParams>) = apply {
