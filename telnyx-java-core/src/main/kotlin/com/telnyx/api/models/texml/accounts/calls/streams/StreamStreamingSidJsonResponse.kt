...
class StreamStreamingSidJsonResponse
...
private constructor(
    ...
    ) : this(accountSid, callSid, dateUpdated, sid, status, uri, mutableMapOf())
    ...
    /** A builder for [StreamStreamingSidJsonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(streamStreamingSidJsonResponse: StreamStreamingSidJsonResponse) = apply {
            accountSid = streamStreamingSidJsonResponse.accountSid
            callSid = streamStreamingSidJsonResponse.callSid
            dateUpdated = streamStreamingSidJsonResponse.dateUpdated
            sid = streamStreamingSidJsonResponse.sid
            status = streamStreamingSidJsonResponse.status
            uri = streamStreamingSidJsonResponse.uri
            additionalProperties =
                streamStreamingSidJsonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StreamStreamingSidJsonResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StreamStreamingSidJsonResponse =
            StreamStreamingSidJsonResponse(
                accountSid,
                callSid,
                dateUpdated,
    ...
    fun validate(): StreamStreamingSidJsonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StreamStreamingSidJsonResponse &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(accountSid, callSid, dateUpdated, sid, status, uri, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "StreamStreamingSidJsonResponse{accountSid=$accountSid, callSid=$callSid, dateUpdated=$dateUpdated, sid=$sid, status=$status, uri=$uri, additionalProperties=$additionalProperties}"
}
