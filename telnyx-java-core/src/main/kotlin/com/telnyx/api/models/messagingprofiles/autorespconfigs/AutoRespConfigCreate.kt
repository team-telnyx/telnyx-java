...
private constructor(
    ...
    ) : this(countryCode, keywords, op, respText, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutoRespConfigCreate].
         *
    ...
    /** A builder for [AutoRespConfigCreate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(autoRespConfigCreate: AutoRespConfigCreate) = apply {
            countryCode = autoRespConfigCreate.countryCode
            keywords = autoRespConfigCreate.keywords.map { it.toMutableList() }
            op = autoRespConfigCreate.op
            respText = autoRespConfigCreate.respText
            additionalProperties = autoRespConfigCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutoRespConfigCreate].
         *
         ...
         */
        fun build(): AutoRespConfigCreate =
    ...
    fun validate(): AutoRespConfigCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutoRespConfigCreate &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(countryCode, keywords, op, respText, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AutoRespConfigCreate{countryCode=$countryCode, keywords=$keywords, op=$op, respText=$respText, additionalProperties=$additionalProperties}"
}
