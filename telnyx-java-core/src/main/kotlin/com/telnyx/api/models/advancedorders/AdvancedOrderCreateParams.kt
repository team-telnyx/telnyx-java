...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AdvancedOrderCreateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(advancedOrderCreateParams: AdvancedOrderCreateParams) = apply {
            body = advancedOrderCreateParams.body.toBuilder()
    ...
    override fun toString() =
        "AdvancedOrderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
