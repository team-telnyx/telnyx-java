...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun sendAt(): Optional<OffsetDateTime> = body.sendAt()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageScheduleParams].
         *
    ...
    /** A builder for [MessageScheduleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageScheduleParams: MessageScheduleParams) = apply {
            body = messageScheduleParams.body.toBuilder()
            additionalHeaders = messageScheduleParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageScheduleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessageScheduleParams].
         *
         ...
         */
        fun build(): MessageScheduleParams =
    ...
    private constructor(
         ...
         * Unlike [sendAt], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("send_at") @ExcludeMissing fun _sendAt(): JsonField<OffsetDateTime> = sendAt
        ...
        override fun toString() =
            "Body{to=$to, autoDetect=$autoDetect, from=$from, mediaUrls=$mediaUrls, messagingProfileId=$messagingProfileId, sendAt=$sendAt, subject=$subject, text=$text, type=$type, useProfileWebhooks=$useProfileWebhooks, webhookFailoverUrl=$webhookFailoverUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageScheduleParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MessageScheduleParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
