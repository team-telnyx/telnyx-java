...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LoaConfigurationUpdateParams].
         *
    ...
    /** A builder for [LoaConfigurationUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(loaConfigurationUpdateParams: LoaConfigurationUpdateParams) = apply {
            id = loaConfigurationUpdateParams.id
            body = loaConfigurationUpdateParams.body.toBuilder()
            additionalHeaders = loaConfigurationUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = loaConfigurationUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LoaConfigurationUpdateParams].
         *
         ...
         */
        fun build(): LoaConfigurationUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LoaConfigurationUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "LoaConfigurationUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
