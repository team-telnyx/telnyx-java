...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MesssageRcsResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MesssageRcsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messsageRcsResponse: MesssageRcsResponse) = apply {
            data = messsageRcsResponse.data
            additionalProperties = messsageRcsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MesssageRcsResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MesssageRcsResponse =
            MesssageRcsResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): MesssageRcsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MesssageRcsResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "MesssageRcsResponse{data=$data, additionalProperties=$additionalProperties}"
}
