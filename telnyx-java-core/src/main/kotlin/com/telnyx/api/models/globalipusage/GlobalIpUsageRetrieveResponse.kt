...
class GlobalIpUsageRetrieveResponse
...
private constructor(
    ...
    /** A builder for [GlobalIpUsageRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(globalIpUsageRetrieveResponse: GlobalIpUsageRetrieveResponse) = apply {
            data = globalIpUsageRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties = globalIpUsageRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GlobalIpUsageRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GlobalIpUsageRetrieveResponse =
            GlobalIpUsageRetrieveResponse(
    ...
    fun validate(): GlobalIpUsageRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(globalIp, received, timestamp, transmitted, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(globalIp, received, timestamp, transmitted, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{globalIp=$globalIp, received=$received, timestamp=$timestamp, transmitted=$transmitted, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GlobalIpUsageRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "GlobalIpUsageRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
