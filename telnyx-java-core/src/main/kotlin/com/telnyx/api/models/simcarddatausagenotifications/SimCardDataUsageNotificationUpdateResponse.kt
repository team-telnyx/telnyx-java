...
class SimCardDataUsageNotificationUpdateResponse
...
private constructor(
    ...
    /** A builder for [SimCardDataUsageNotificationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = simCardDataUsageNotificationUpdateResponse.data
            additionalProperties =
                simCardDataUsageNotificationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SimCardDataUsageNotificationUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SimCardDataUsageNotificationUpdateResponse =
            SimCardDataUsageNotificationUpdateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): SimCardDataUsageNotificationUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimCardDataUsageNotificationUpdateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SimCardDataUsageNotificationUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
