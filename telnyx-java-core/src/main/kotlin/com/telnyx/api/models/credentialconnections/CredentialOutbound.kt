...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CredentialOutbound]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CredentialOutbound]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(credentialOutbound: CredentialOutbound) = apply {
            aniOverride = credentialOutbound.aniOverride
            aniOverrideType = credentialOutbound.aniOverrideType
            callParkingEnabled = credentialOutbound.callParkingEnabled
            channelLimit = credentialOutbound.channelLimit
            generateRingbackTone = credentialOutbound.generateRingbackTone
            instantRingbackEnabled = credentialOutbound.instantRingbackEnabled
            localization = credentialOutbound.localization
            outboundVoiceProfileId = credentialOutbound.outboundVoiceProfileId
            t38ReinviteSource = credentialOutbound.t38ReinviteSource
            additionalProperties = credentialOutbound.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CredentialOutbound].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CredentialOutbound =
            CredentialOutbound(
                aniOverride,
                aniOverrideType,
                callParkingEnabled,
    ...
    fun validate(): CredentialOutbound = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CredentialOutbound &&
