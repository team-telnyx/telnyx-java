...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionStopTranscriptionParams = builder().build()
    ...
    /** A builder for [ActionStopTranscriptionParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionStopTranscriptionParams: ActionStopTranscriptionParams) = apply {
            callControlId = actionStopTranscriptionParams.callControlId
            body = actionStopTranscriptionParams.body.toBuilder()
            additionalHeaders = actionStopTranscriptionParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionStopTranscriptionParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionStopTranscriptionParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStopTranscriptionParams =
            ActionStopTranscriptionParams(
                callControlId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStopTranscriptionParams &&
    ...
    override fun toString() =
        "ActionStopTranscriptionParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
