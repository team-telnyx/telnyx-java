...
class NumberReservationCreateParams
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun phoneNumbers(): Optional<List<ReservedPhoneNumber>> = body.phoneNumbers()
     ...
     */
    fun _phoneNumbers(): JsonField<List<ReservedPhoneNumber>> = body._phoneNumbers()
    ...
    companion object {
        ...
        @JvmStatic fun none(): NumberReservationCreateParams = builder().build()
    ...
    /** A builder for [NumberReservationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberReservationCreateParams: NumberReservationCreateParams) = apply {
            body = numberReservationCreateParams.body.toBuilder()
            additionalHeaders = numberReservationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = numberReservationCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun phoneNumbers(phoneNumbers: List<ReservedPhoneNumber>) = apply {
        ...
        /**
         * Returns an immutable instance of [NumberReservationCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NumberReservationCreateParams =
            NumberReservationCreateParams(
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.phoneNumbers] with a well-typed
             * `List<ReservedPhoneNumber>` value instead. This method is primarily for setting the
        ...
        override fun toString() =
            "Body{id=$id, createdAt=$createdAt, customerReference=$customerReference, phoneNumbers=$phoneNumbers, recordType=$recordType, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberReservationCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "NumberReservationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
