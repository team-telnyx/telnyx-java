...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SimCardListResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SimCardListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(simCardListResponse: SimCardListResponse) = apply {
            data = simCardListResponse.data.map { it.toMutableList() }
            meta = simCardListResponse.meta
            additionalProperties = simCardListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SimCardListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SimCardListResponse =
            SimCardListResponse(
    ...
    fun validate(): SimCardListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimCardListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "SimCardListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
