...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(virtualCrossConnectListResponse: VirtualCrossConnectListResponse) =
            apply {
                data = virtualCrossConnectListResponse.data.map { it.toMutableList() }
                meta = virtualCrossConnectListResponse.meta
    ...
    override fun toString() =
        "VirtualCrossConnectListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
