...
class SimCardDataUsageNotificationCreateResponse
...
private constructor(
    ...
    /** A builder for [SimCardDataUsageNotificationCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = simCardDataUsageNotificationCreateResponse.data
            additionalProperties =
                simCardDataUsageNotificationCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SimCardDataUsageNotificationCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SimCardDataUsageNotificationCreateResponse =
            SimCardDataUsageNotificationCreateResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): SimCardDataUsageNotificationCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimCardDataUsageNotificationCreateResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SimCardDataUsageNotificationCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
