...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callUpdateResponse: CallUpdateResponse) = apply {
            accountSid = callUpdateResponse.accountSid
            answeredBy = callUpdateResponse.answeredBy
            callerName = callUpdateResponse.callerName
            dateCreated = callUpdateResponse.dateCreated
            dateUpdated = callUpdateResponse.dateUpdated
            direction = callUpdateResponse.direction
            duration = callUpdateResponse.duration
            endTime = callUpdateResponse.endTime
            from = callUpdateResponse.from
            fromFormatted = callUpdateResponse.fromFormatted
            price = callUpdateResponse.price
            priceUnit = callUpdateResponse.priceUnit
            sid = callUpdateResponse.sid
            startTime = callUpdateResponse.startTime
            status = callUpdateResponse.status
            to = callUpdateResponse.to
            toFormatted = callUpdateResponse.toFormatted
            uri = callUpdateResponse.uri
