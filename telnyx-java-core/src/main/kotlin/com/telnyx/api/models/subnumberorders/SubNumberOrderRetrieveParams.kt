...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SubNumberOrderRetrieveParams = builder().build()
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Filter = Filter(includePhoneNumbers, additionalProperties.build())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(includePhoneNumbers, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Filter{includePhoneNumbers=$includePhoneNumbers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(subNumberOrderId, filter, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SubNumberOrderRetrieveParams{subNumberOrderId=$subNumberOrderId, filter=$filter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
