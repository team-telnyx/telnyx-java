...
class ConferenceFloorChangedWebhookEvent
...
private constructor(
    ...
    /** A builder for [ConferenceFloorChangedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceFloorChangedWebhookEvent: ConferenceFloorChangedWebhookEvent) =
            apply {
                id = conferenceFloorChangedWebhookEvent.id
                eventType = conferenceFloorChangedWebhookEvent.eventType
                payload = conferenceFloorChangedWebhookEvent.payload
                recordType = conferenceFloorChangedWebhookEvent.recordType
                additionalProperties =
                    conferenceFloorChangedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ConferenceFloorChangedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceFloorChangedWebhookEvent =
            ConferenceFloorChangedWebhookEvent(
                id,
                eventType,
                payload,
    ...
    fun validate(): ConferenceFloorChangedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONFERENCE_FLOOR_CHANGED = of("conference.floor.changed")
        ...
        fun value(): Value =
            when (this) {
                CONFERENCE_FLOOR_CHANGED -> Value.CONFERENCE_FLOOR_CHANGED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONFERENCE_FLOOR_CHANGED -> Known.CONFERENCE_FLOOR_CHANGED
    ...
    private constructor(
        ...
        override fun toString() =
            "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, conferenceId=$conferenceId, connectionId=$connectionId, occurredAt=$occurredAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceFloorChangedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "ConferenceFloorChangedWebhookEvent{id=$id, eventType=$eventType, payload=$payload, recordType=$recordType, additionalProperties=$additionalProperties}"
}
