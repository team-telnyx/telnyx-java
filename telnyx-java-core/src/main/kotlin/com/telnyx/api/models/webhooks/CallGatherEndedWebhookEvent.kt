...
class CallGatherEndedWebhookEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallGatherEndedWebhookEvent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallGatherEndedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callGatherEndedWebhookEvent: CallGatherEndedWebhookEvent) = apply {
            data = callGatherEndedWebhookEvent.data
            additionalProperties = callGatherEndedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallGatherEndedWebhookEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallGatherEndedWebhookEvent =
            CallGatherEndedWebhookEvent(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallGatherEndedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class EventType @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                @JvmField val CALL_GATHER_ENDED = of("call.gather.ended")
            ...
            fun value(): Value =
                when (this) {
                    CALL_GATHER_ENDED -> Value.CALL_GATHER_ENDED
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    CALL_GATHER_ENDED -> Known.CALL_GATHER_ENDED
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("digits")
                @ExcludeMissing
                digits: JsonField<String> = JsonMissing.of(),
             ...
             *   the server responded with an unexpected value).
             */
            fun digits(): Optional<String> = digits.getOptional("digits")
            ...
            class Builder internal constructor() {
                ...
                private var digits: JsonField<String> = JsonMissing.of()
                 ...
                 *
                 * You should usually call [Builder.digits] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            override fun toString() =
                "Payload{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, clientState=$clientState, connectionId=$connectionId, digits=$digits, from=$from, status=$status, to=$to, additionalProperties=$additionalProperties}"
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallGatherEndedWebhookEvent &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallGatherEndedWebhookEvent{data=$data, additionalProperties=$additionalProperties}"
}
