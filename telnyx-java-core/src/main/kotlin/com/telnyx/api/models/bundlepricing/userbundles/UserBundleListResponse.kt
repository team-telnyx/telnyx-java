...
import com.telnyx.api.models.bundlepricing.billingbundles.PaginationResponse
import java.util.Collections
import java.util.Objects
import kotlin.jvm.optionals.getOrNull

class UserBundleListResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserBundleListResponse].
         *
    ...
    /** A builder for [UserBundleListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userBundleListResponse: UserBundleListResponse) = apply {
            data = userBundleListResponse.data.map { it.toMutableList() }
            meta = userBundleListResponse.meta
            additionalProperties = userBundleListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserBundleListResponse].
         *
         ...
         */
        fun build(): UserBundleListResponse =
    ...
    fun validate(): UserBundleListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserBundleListResponse &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "UserBundleListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
