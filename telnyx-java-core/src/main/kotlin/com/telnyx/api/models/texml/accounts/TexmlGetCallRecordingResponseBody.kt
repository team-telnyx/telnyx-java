...
class TexmlGetCallRecordingResponseBody
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("subresources_uris")
        @ExcludeMissing
        subresourcesUris: JsonField<TexmlRecordingSubresourcesUris> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun subresourcesUris(): Optional<TexmlRecordingSubresourcesUris> =
        subresourcesUris.getOptional("subresources_uris")
    ...
    /**
     * Returns the raw JSON value of [subresourcesUris].
     *
     * Unlike [subresourcesUris], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("subresources_uris")
    @ExcludeMissing
    fun _subresourcesUris(): JsonField<TexmlRecordingSubresourcesUris> = subresourcesUris
    ...
    /** A builder for [TexmlGetCallRecordingResponseBody]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(texmlGetCallRecordingResponseBody: TexmlGetCallRecordingResponseBody) =
            apply {
                accountSid = texmlGetCallRecordingResponseBody.accountSid
                callSid = texmlGetCallRecordingResponseBody.callSid
                channels = texmlGetCallRecordingResponseBody.channels
                conferenceSid = texmlGetCallRecordingResponseBody.conferenceSid
                dateCreated = texmlGetCallRecordingResponseBody.dateCreated
                dateUpdated = texmlGetCallRecordingResponseBody.dateUpdated
                duration = texmlGetCallRecordingResponseBody.duration
                errorCode = texmlGetCallRecordingResponseBody.errorCode
                mediaUrl = texmlGetCallRecordingResponseBody.mediaUrl
                sid = texmlGetCallRecordingResponseBody.sid
                source = texmlGetCallRecordingResponseBody.source
                startTime = texmlGetCallRecordingResponseBody.startTime
                status = texmlGetCallRecordingResponseBody.status
                subresourcesUris = texmlGetCallRecordingResponseBody.subresourcesUris
                uri = texmlGetCallRecordingResponseBody.uri
                additionalProperties =
                    texmlGetCallRecordingResponseBody.additionalProperties.toMutableMap()
            }
        ...
        /** Subresources details for a recording if available. */
        fun subresourcesUris(subresourcesUris: TexmlRecordingSubresourcesUris) =
            subresourcesUris(JsonField.of(subresourcesUris))

        /**
         * Sets [Builder.subresourcesUris] to an arbitrary JSON value.
         *
         * You should usually call [Builder.subresourcesUris] with a well-typed
         * [TexmlRecordingSubresourcesUris] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun subresourcesUris(subresourcesUris: JsonField<TexmlRecordingSubresourcesUris>) = apply {
        ...
        /**
         * Returns an immutable instance of [TexmlGetCallRecordingResponseBody].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TexmlGetCallRecordingResponseBody =
            TexmlGetCallRecordingResponseBody(
                accountSid,
                callSid,
                channels,
    ...
    fun validate(): TexmlGetCallRecordingResponseBody = apply {
        if (validated) {
            return@apply
        }
        ...
        subresourcesUris().ifPresent { it.validate() }
        uri()
        validated = true
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TexmlGetCallRecordingResponseBody &&
            ...
            status == other.status &&
            subresourcesUris == other.subresourcesUris &&
            uri == other.uri &&
    ...
    override fun toString() =
        "TexmlGetCallRecordingResponseBody{accountSid=$accountSid, callSid=$callSid, channels=$channels, conferenceSid=$conferenceSid, dateCreated=$dateCreated, dateUpdated=$dateUpdated, duration=$duration, errorCode=$errorCode, mediaUrl=$mediaUrl, sid=$sid, source=$source, startTime=$startTime, status=$status, subresourcesUris=$subresourcesUris, uri=$uri, additionalProperties=$additionalProperties}"
}
