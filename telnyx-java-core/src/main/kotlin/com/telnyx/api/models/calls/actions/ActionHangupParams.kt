...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionHangupParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ActionHangupParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionHangupParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionHangupParams: ActionHangupParams) = apply {
            callControlId = actionHangupParams.callControlId
            body = actionHangupParams.body.toBuilder()
            additionalHeaders = actionHangupParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionHangupParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionHangupParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionHangupParams =
            ActionHangupParams(
                callControlId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionHangupParams &&
    ...
    override fun toString() =
        "ActionHangupParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
