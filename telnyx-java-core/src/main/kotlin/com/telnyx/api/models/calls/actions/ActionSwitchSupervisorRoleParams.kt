...
/**
 * Switch the supervisor role for a bridged call. This allows switching between different supervisor
 * modes during an active call
 */
class ActionSwitchSupervisorRoleParams
private constructor(
    ...
    /**
     * The supervisor role to switch to. 'barge' allows speaking to both parties, 'whisper' allows
     * speaking to caller only, 'monitor' allows listening only.
     *
    ...
    /** A builder for [ActionSwitchSupervisorRoleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionSwitchSupervisorRoleParams: ActionSwitchSupervisorRoleParams) =
            apply {
                callControlId = actionSwitchSupervisorRoleParams.callControlId
                body = actionSwitchSupervisorRoleParams.body.toBuilder()
                additionalHeaders = actionSwitchSupervisorRoleParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    actionSwitchSupervisorRoleParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ActionSwitchSupervisorRoleParams].
         *
         ...
         */
        fun build(): ActionSwitchSupervisorRoleParams =
            ActionSwitchSupervisorRoleParams(
                callControlId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionSwitchSupervisorRoleParams &&
    ...
    override fun toString() =
        "ActionSwitchSupervisorRoleParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
