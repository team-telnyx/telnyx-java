...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(networkListResponse: NetworkListResponse) = apply {
            data = networkListResponse.data.map { it.toMutableList() }
            meta = networkListResponse.meta
    ...
    override fun toString() =
        "NetworkListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
