...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mediaDownloadParams: MediaDownloadParams) = apply {
            mediaName = mediaDownloadParams.mediaName
        ...
        fun build(): MediaDownloadParams =
            MediaDownloadParams(mediaName, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "MediaDownloadParams{mediaName=$mediaName, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
