...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InsightDeleteParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(insightDeleteParams: InsightDeleteParams) = apply {
            insightId = insightDeleteParams.insightId
    ...
    override fun hashCode(): Int =
        Objects.hash(insightId, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() =
        "InsightDeleteParams{insightId=$insightId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
