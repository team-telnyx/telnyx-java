...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ActionStopGatherParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ActionStopGatherParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ActionStopGatherParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionStopGatherParams: ActionStopGatherParams) = apply {
            callControlId = actionStopGatherParams.callControlId
            body = actionStopGatherParams.body.toBuilder()
            additionalHeaders = actionStopGatherParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionStopGatherParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionStopGatherParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ActionStopGatherParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionStopGatherParams &&
    ...
    override fun toString() =
        "ActionStopGatherParams{callControlId=$callControlId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
