...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssistantCloneResponse].
         *
    ...
    /** A builder for [AssistantCloneResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(assistantCloneResponse: AssistantCloneResponse) = apply {
            id = assistantCloneResponse.id
            createdAt = assistantCloneResponse.createdAt
            instructions = assistantCloneResponse.instructions
            model = assistantCloneResponse.model
            name = assistantCloneResponse.name
            description = assistantCloneResponse.description
            dynamicVariables = assistantCloneResponse.dynamicVariables
            dynamicVariablesWebhookUrl = assistantCloneResponse.dynamicVariablesWebhookUrl
            enabledFeatures = assistantCloneResponse.enabledFeatures.map { it.toMutableList() }
            greeting = assistantCloneResponse.greeting
            importMetadata = assistantCloneResponse.importMetadata
            insightSettings = assistantCloneResponse.insightSettings
            llmApiKeyRef = assistantCloneResponse.llmApiKeyRef
            messagingSettings = assistantCloneResponse.messagingSettings
            privacySettings = assistantCloneResponse.privacySettings
            telephonySettings = assistantCloneResponse.telephonySettings
            tools = assistantCloneResponse.tools.map { it.toMutableList() }
            transcription = assistantCloneResponse.transcription
            voiceSettings = assistantCloneResponse.voiceSettings
            additionalProperties = assistantCloneResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssistantCloneResponse].
         *
         ...
         */
        fun build(): AssistantCloneResponse =
    ...
    fun validate(): AssistantCloneResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssistantCloneResponse &&
            id == other.id &&
