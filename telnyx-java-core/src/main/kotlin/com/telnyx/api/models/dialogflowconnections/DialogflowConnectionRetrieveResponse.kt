...
class DialogflowConnectionRetrieveResponse
...
private constructor(
    ...
    /** A builder for [DialogflowConnectionRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            dialogflowConnectionRetrieveResponse: DialogflowConnectionRetrieveResponse
        ) = apply {
            data = dialogflowConnectionRetrieveResponse.data
            additionalProperties =
                dialogflowConnectionRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DialogflowConnectionRetrieveResponse].
         *
         ...
         */
        fun build(): DialogflowConnectionRetrieveResponse =
            DialogflowConnectionRetrieveResponse(
    ...
    fun validate(): DialogflowConnectionRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DialogflowConnectionRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DialogflowConnectionRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
