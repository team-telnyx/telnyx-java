...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CallDialResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallDialResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callDialResponse: CallDialResponse) = apply {
            data = callDialResponse.data
            additionalProperties = callDialResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CallDialResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallDialResponse = CallDialResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CallDialResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{callControlId=$callControlId, callLegId=$callLegId, callSessionId=$callSessionId, isAlive=$isAlive, recordType=$recordType, callDuration=$callDuration, clientState=$clientState, endTime=$endTime, recordingId=$recordingId, startTime=$startTime, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallDialResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CallDialResponse{data=$data, additionalProperties=$additionalProperties}"
}
