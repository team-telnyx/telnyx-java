...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(assistantCreateResponse: AssistantCreateResponse) = apply {
            id = assistantCreateResponse.id
            createdAt = assistantCreateResponse.createdAt
            instructions = assistantCreateResponse.instructions
            model = assistantCreateResponse.model
            name = assistantCreateResponse.name
            description = assistantCreateResponse.description
            dynamicVariables = assistantCreateResponse.dynamicVariables
            dynamicVariablesWebhookUrl = assistantCreateResponse.dynamicVariablesWebhookUrl
            enabledFeatures = assistantCreateResponse.enabledFeatures.map { it.toMutableList() }
            greeting = assistantCreateResponse.greeting
            importMetadata = assistantCreateResponse.importMetadata
            insightSettings = assistantCreateResponse.insightSettings
            llmApiKeyRef = assistantCreateResponse.llmApiKeyRef
            messagingSettings = assistantCreateResponse.messagingSettings
            privacySettings = assistantCreateResponse.privacySettings
            telephonySettings = assistantCreateResponse.telephonySettings
            tools = assistantCreateResponse.tools.map { it.toMutableList() }
            transcription = assistantCreateResponse.transcription
            voiceSettings = assistantCreateResponse.voiceSettings
