...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): JobRetrieveParams =
            JobRetrieveParams(jobId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "JobRetrieveParams{jobId=$jobId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
