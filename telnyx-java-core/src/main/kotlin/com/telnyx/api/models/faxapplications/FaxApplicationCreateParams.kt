...
/**
 * Creates a new Fax Application based on the parameters sent in the request. The application name
 * and webhook URL are required. Once created, you can assign phone numbers to your application
 * using the `/phone_numbers` endpoint.
 */
class FaxApplicationCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FaxApplicationCreateParams].
         *
    ...
    /** A builder for [FaxApplicationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(faxApplicationCreateParams: FaxApplicationCreateParams) = apply {
            body = faxApplicationCreateParams.body.toBuilder()
            additionalHeaders = faxApplicationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = faxApplicationCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FaxApplicationCreateParams].
         *
         ...
         */
        fun build(): FaxApplicationCreateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{applicationName=$applicationName, webhookEventUrl=$webhookEventUrl, active=$active, anchorsiteOverride=$anchorsiteOverride, inbound=$inbound, outbound=$outbound, tags=$tags, webhookEventFailoverUrl=$webhookEventFailoverUrl, webhookTimeoutSecs=$webhookTimeoutSecs, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FaxApplicationCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FaxApplicationCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
