...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(voiceListParams: VoiceListParams) = apply {
            ...
            perPage = voiceListParams.perPage
        ...
        fun build(): VoiceListParams =
            VoiceListParams(page, perPage, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "VoiceListParams{page=$page, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
