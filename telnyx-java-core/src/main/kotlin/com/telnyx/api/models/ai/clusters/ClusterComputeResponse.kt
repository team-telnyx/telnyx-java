...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ClusterComputeResponse].
         *
    ...
    /** A builder for [ClusterComputeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(clusterComputeResponse: ClusterComputeResponse) = apply {
            data = clusterComputeResponse.data
            additionalProperties = clusterComputeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClusterComputeResponse].
         *
         ...
         */
        fun build(): ClusterComputeResponse =
            ClusterComputeResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ClusterComputeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Data =
                Data(checkRequired("taskId", taskId), additionalProperties.toMutableMap())
        }
        ...
        override fun toString() = "Data{taskId=$taskId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClusterComputeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ClusterComputeResponse{data=$data, additionalProperties=$additionalProperties}"
}
