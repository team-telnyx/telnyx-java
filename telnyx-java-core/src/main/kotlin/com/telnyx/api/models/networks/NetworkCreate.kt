...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(networkCreate: NetworkCreate) = apply {
            id = networkCreate.id
            ...
            additionalProperties = networkCreate.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): NetworkCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "NetworkCreate{id=$id, createdAt=$createdAt, recordType=$recordType, updatedAt=$updatedAt, name=$name, additionalProperties=$additionalProperties}"
}
