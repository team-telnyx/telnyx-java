...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(verificationTriggerSmsParams: VerificationTriggerSmsParams) = apply {
            body = verificationTriggerSmsParams.body.toBuilder()
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{phoneNumber=$phoneNumber, verifyProfileId=$verifyProfileId, customCode=$customCode, timeoutSecs=$timeoutSecs, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "VerificationTriggerSmsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
