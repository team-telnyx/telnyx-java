...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MesssageRcsParams].
         *
    ...
    /** A builder for [MesssageRcsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messsageRcsParams: MesssageRcsParams) = apply {
            body = messsageRcsParams.body.toBuilder()
            additionalHeaders = messsageRcsParams.additionalHeaders.toBuilder()
            additionalQueryParams = messsageRcsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MesssageRcsParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MesssageRcsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MesssageRcsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
