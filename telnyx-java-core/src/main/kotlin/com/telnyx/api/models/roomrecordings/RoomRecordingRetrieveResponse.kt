...
class RoomRecordingRetrieveResponse
...
private constructor(
    ...
    /** A builder for [RoomRecordingRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roomRecordingRetrieveResponse: RoomRecordingRetrieveResponse) = apply {
            data = roomRecordingRetrieveResponse.data
            additionalProperties = roomRecordingRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RoomRecordingRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RoomRecordingRetrieveResponse =
            RoomRecordingRetrieveResponse(data, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): RoomRecordingRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoomRecordingRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "RoomRecordingRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
