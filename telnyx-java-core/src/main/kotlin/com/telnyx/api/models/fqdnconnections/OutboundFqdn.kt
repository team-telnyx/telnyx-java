...
private constructor(
    ...
    /**
     * Specifies when we should apply your ani_override setting. Only applies when ani_override is
     * not blank.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     ...
     * dictates whether or not Telnyx sends a t.38 reinvite. By default, Telnyx will send the
     * re-invite. If set to `customer`, the caller is expected to send the t.38 reinvite.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [OutboundFqdn]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OutboundFqdn]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(outboundFqdn: OutboundFqdn) = apply {
            aniOverride = outboundFqdn.aniOverride
            aniOverrideType = outboundFqdn.aniOverrideType
            callParkingEnabled = outboundFqdn.callParkingEnabled
            channelLimit = outboundFqdn.channelLimit
            encryptedMedia = outboundFqdn.encryptedMedia
            generateRingbackTone = outboundFqdn.generateRingbackTone
            instantRingbackEnabled = outboundFqdn.instantRingbackEnabled
            ipAuthenticationMethod = outboundFqdn.ipAuthenticationMethod
            ipAuthenticationToken = outboundFqdn.ipAuthenticationToken
            localization = outboundFqdn.localization
            outboundVoiceProfileId = outboundFqdn.outboundVoiceProfileId
            t38ReinviteSource = outboundFqdn.t38ReinviteSource
            techPrefix = outboundFqdn.techPrefix
            timeout1xxSecs = outboundFqdn.timeout1xxSecs
            timeout2xxSecs = outboundFqdn.timeout2xxSecs
            additionalProperties = outboundFqdn.additionalProperties.toMutableMap()
        }
         ...
         * \"bridged\" to the destination specified on the URI. Parked calls will return ringback to
         * the caller and will await for a Call Control command to define which action will be taken
         * next.
         */
        ...
        /**
         * Returns an immutable instance of [OutboundFqdn].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OutboundFqdn =
            OutboundFqdn(
                aniOverride,
                aniOverrideType,
                callParkingEnabled,
    ...
    fun validate(): OutboundFqdn = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "OutboundFqdn{aniOverride=$aniOverride, aniOverrideType=$aniOverrideType, callParkingEnabled=$callParkingEnabled, channelLimit=$channelLimit, encryptedMedia=$encryptedMedia, generateRingbackTone=$generateRingbackTone, instantRingbackEnabled=$instantRingbackEnabled, ipAuthenticationMethod=$ipAuthenticationMethod, ipAuthenticationToken=$ipAuthenticationToken, localization=$localization, outboundVoiceProfileId=$outboundVoiceProfileId, t38ReinviteSource=$t38ReinviteSource, techPrefix=$techPrefix, timeout1xxSecs=$timeout1xxSecs, timeout2xxSecs=$timeout2xxSecs, additionalProperties=$additionalProperties}"
}
