...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SimCardGroupCreateParams].
         *
    ...
    /** A builder for [SimCardGroupCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(simCardGroupCreateParams: SimCardGroupCreateParams) = apply {
            body = simCardGroupCreateParams.body.toBuilder()
            additionalHeaders = simCardGroupCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = simCardGroupCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SimCardGroupCreateParams].
         *
         ...
         */
        fun build(): SimCardGroupCreateParams =
    ...
    private constructor(
        ...
        ) : this(name, dataLimit, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("name", name), dataLimit, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(name, dataLimit, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, dataLimit=$dataLimit, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimCardGroupCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "SimCardGroupCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
