...
import com.telnyx.api.models.ai.assistants.HangupTool
...
import com.telnyx.api.models.ai.assistants.RetrievalTool
...
import com.telnyx.api.models.ai.assistants.TransferTool
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VersionUpdateResponse].
         *
    ...
    /** A builder for [VersionUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(versionUpdateResponse: VersionUpdateResponse) = apply {
            id = versionUpdateResponse.id
            createdAt = versionUpdateResponse.createdAt
            instructions = versionUpdateResponse.instructions
            model = versionUpdateResponse.model
            name = versionUpdateResponse.name
            description = versionUpdateResponse.description
            dynamicVariables = versionUpdateResponse.dynamicVariables
            dynamicVariablesWebhookUrl = versionUpdateResponse.dynamicVariablesWebhookUrl
            enabledFeatures = versionUpdateResponse.enabledFeatures.map { it.toMutableList() }
            greeting = versionUpdateResponse.greeting
            importMetadata = versionUpdateResponse.importMetadata
            insightSettings = versionUpdateResponse.insightSettings
            llmApiKeyRef = versionUpdateResponse.llmApiKeyRef
            messagingSettings = versionUpdateResponse.messagingSettings
            privacySettings = versionUpdateResponse.privacySettings
            telephonySettings = versionUpdateResponse.telephonySettings
            tools = versionUpdateResponse.tools.map { it.toMutableList() }
            transcription = versionUpdateResponse.transcription
            voiceSettings = versionUpdateResponse.voiceSettings
            additionalProperties = versionUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VersionUpdateResponse].
         *
         ...
         */
        fun build(): VersionUpdateResponse =
    ...
    fun validate(): VersionUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VersionUpdateResponse &&
            id == other.id &&
