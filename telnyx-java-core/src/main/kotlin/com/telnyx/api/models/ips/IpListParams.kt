...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): IpListParams =
            IpListParams(filter, page, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "IpListParams{filter=$filter, page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
