...
package com.telnyx.api.models.notificationeventconditions
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = notificationEventConditionListResponse.data.map { it.toMutableList() }
            meta = notificationEventConditionListResponse.meta
    ...
    private constructor(
         ...
         *
         * Unlike [allowMultipleChannels], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("allow_multiple_channels")
        @ExcludeMissing
         ...
         *
         * Unlike [associatedRecordType], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("associated_record_type")
        @ExcludeMissing
         ...
         *
         * Unlike [asynchronous], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("asynchronous")
        @ExcludeMissing
         ...
         *
         * Unlike [notificationEventId], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("notification_event_id")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                id = data.id
                allowMultipleChannels = data.allowMultipleChannels
                associatedRecordType = data.associatedRecordType
                ...
                parameters = data.parameters.map { it.toMutableList() }
                supportedChannels = data.supportedChannels.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.allowMultipleChannels] with a well-typed [Boolean]
             ...
             * [AssociatedRecordType] value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun associatedRecordType(associatedRecordType: JsonField<AssociatedRecordType>) =
                apply {
             ...
             *
             * You should usually call [Builder.asynchronous] with a well-typed [Boolean] value
             ...
             *
             * You should usually call [Builder.notificationEventId] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        private constructor(private val value: JsonField<String>) : Enum {
             ...
             * member.
             *
             * An instance of [AssociatedRecordType] can contain an unknown value in a couple of
             * cases:
        ...
        private constructor(
             ...
             *
             * Unlike [dataType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.dataType] with a well-typed [String] value
    ...
    override fun toString() =
        "NotificationEventConditionListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
