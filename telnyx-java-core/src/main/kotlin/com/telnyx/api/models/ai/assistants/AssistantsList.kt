...
private constructor(
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun importMetadata(): Optional<ImportMetadata> =
            importMetadata.getOptional("import_metadata")
         ...
         *
         * Unlike [importMetadata], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("import_metadata")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                dynamicVariablesWebhookUrl = data.dynamicVariablesWebhookUrl
                enabledFeatures = data.enabledFeatures.map { it.toMutableList() }
                greeting = data.greeting
                importMetadata = data.importMetadata
                insightSettings = data.insightSettings
                llmApiKeyRef = data.llmApiKeyRef
                messagingSettings = data.messagingSettings
                privacySettings = data.privacySettings
                telephonySettings = data.telephonySettings
                tools = data.tools.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.importMetadata] with a well-typed [ImportMetadata]
