...
private constructor(
    ...
    override fun hashCode(): Int =
        Objects.hash(filter, includeParticipants, page, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SessionList0Params{filter=$filter, includeParticipants=$includeParticipants, page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
