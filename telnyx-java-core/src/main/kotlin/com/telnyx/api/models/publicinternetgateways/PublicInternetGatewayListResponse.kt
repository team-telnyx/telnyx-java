...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(publicInternetGatewayListResponse: PublicInternetGatewayListResponse) =
            apply {
                data = publicInternetGatewayListResponse.data.map { it.toMutableList() }
                meta = publicInternetGatewayListResponse.meta
    ...
    override fun toString() =
        "PublicInternetGatewayListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
