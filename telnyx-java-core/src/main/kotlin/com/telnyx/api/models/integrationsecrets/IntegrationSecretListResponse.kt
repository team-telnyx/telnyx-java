...
class IntegrationSecretListResponse
...
private constructor(
    ...
    /** A builder for [IntegrationSecretListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(integrationSecretListResponse: IntegrationSecretListResponse) = apply {
            data = integrationSecretListResponse.data.map { it.toMutableList() }
            meta = integrationSecretListResponse.meta
            additionalProperties = integrationSecretListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegrationSecretListResponse].
         *
         ...
         */
        fun build(): IntegrationSecretListResponse =
            IntegrationSecretListResponse(
    ...
    fun validate(): IntegrationSecretListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationSecretListResponse &&
            data == other.data &&
            meta == other.meta &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "IntegrationSecretListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
