...
class ConferenceRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConferenceRetrieveResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ConferenceRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conferenceRetrieveResponse: ConferenceRetrieveResponse) = apply {
            accountSid = conferenceRetrieveResponse.accountSid
            apiVersion = conferenceRetrieveResponse.apiVersion
            callSidEndingConference = conferenceRetrieveResponse.callSidEndingConference
            dateCreated = conferenceRetrieveResponse.dateCreated
            dateUpdated = conferenceRetrieveResponse.dateUpdated
            friendlyName = conferenceRetrieveResponse.friendlyName
            reasonConferenceEnded = conferenceRetrieveResponse.reasonConferenceEnded
            region = conferenceRetrieveResponse.region
            sid = conferenceRetrieveResponse.sid
            status = conferenceRetrieveResponse.status
            subresourceUris = conferenceRetrieveResponse.subresourceUris
            uri = conferenceRetrieveResponse.uri
            additionalProperties = conferenceRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConferenceRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ConferenceRetrieveResponse =
    ...
    fun validate(): ConferenceRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConferenceRetrieveResponse &&
