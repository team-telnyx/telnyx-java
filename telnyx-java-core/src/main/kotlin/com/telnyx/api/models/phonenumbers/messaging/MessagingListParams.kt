...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MessagingListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MessagingListParams]. */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MessagingListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MessagingListParams =
            MessagingListParams(page, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "MessagingListParams{page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
