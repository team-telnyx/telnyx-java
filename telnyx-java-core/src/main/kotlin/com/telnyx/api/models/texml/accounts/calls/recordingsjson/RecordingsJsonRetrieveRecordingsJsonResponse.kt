...
class RecordingsJsonRetrieveRecordingsJsonResponse
...
private constructor(
    ...
    /** A builder for [RecordingsJsonRetrieveRecordingsJsonResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            end = recordingsJsonRetrieveRecordingsJsonResponse.end
            firstPageUri = recordingsJsonRetrieveRecordingsJsonResponse.firstPageUri
            nextPageUri = recordingsJsonRetrieveRecordingsJsonResponse.nextPageUri
            page = recordingsJsonRetrieveRecordingsJsonResponse.page
            pageSize = recordingsJsonRetrieveRecordingsJsonResponse.pageSize
            previousPageUri = recordingsJsonRetrieveRecordingsJsonResponse.previousPageUri
            recordings =
                recordingsJsonRetrieveRecordingsJsonResponse.recordings.map { it.toMutableList() }
            start = recordingsJsonRetrieveRecordingsJsonResponse.start
            uri = recordingsJsonRetrieveRecordingsJsonResponse.uri
            additionalProperties =
                recordingsJsonRetrieveRecordingsJsonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RecordingsJsonRetrieveRecordingsJsonResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RecordingsJsonRetrieveRecordingsJsonResponse =
            RecordingsJsonRetrieveRecordingsJsonResponse(
                end,
                firstPageUri,
                nextPageUri,
    ...
    fun validate(): RecordingsJsonRetrieveRecordingsJsonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecordingsJsonRetrieveRecordingsJsonResponse &&
            end == other.end &&
    ...
    override fun toString() =
        "RecordingsJsonRetrieveRecordingsJsonResponse{end=$end, firstPageUri=$firstPageUri, nextPageUri=$nextPageUri, page=$page, pageSize=$pageSize, previousPageUri=$previousPageUri, recordings=$recordings, start=$start, uri=$uri, additionalProperties=$additionalProperties}"
}
