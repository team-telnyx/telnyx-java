 ...
 */
class JobUpdateEmergencySettingsBatchParams
private constructor(
    ...
    /**
     * Identifies the address to be used with emergency services. Required if emergency_enabled is
     * true, must be null or omitted if emergency_enabled is false.
     *
     * @throws TelnyxInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun emergencyAddressId(): Optional<String> = body.emergencyAddressId()
    ...
    /** A builder for [JobUpdateEmergencySettingsBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            jobUpdateEmergencySettingsBatchParams: JobUpdateEmergencySettingsBatchParams
        ) = apply {
            body = jobUpdateEmergencySettingsBatchParams.body.toBuilder()
            additionalHeaders = jobUpdateEmergencySettingsBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                jobUpdateEmergencySettingsBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Identifies the address to be used with emergency services. Required if emergency_enabled
         * is true, must be null or omitted if emergency_enabled is false.
         */
        ...
        /**
         * Returns an immutable instance of [JobUpdateEmergencySettingsBatchParams].
         *
         ...
         */
        fun build(): JobUpdateEmergencySettingsBatchParams =
            JobUpdateEmergencySettingsBatchParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(emergencyEnabled, phoneNumbers, emergencyAddressId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * emergency_enabled is true, must be null or omitted if emergency_enabled is false.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(emergencyEnabled, phoneNumbers, emergencyAddressId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{emergencyEnabled=$emergencyEnabled, phoneNumbers=$phoneNumbers, emergencyAddressId=$emergencyAddressId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JobUpdateEmergencySettingsBatchParams &&
            body == other.body &&
    ...
    override fun toString() =
        "JobUpdateEmergencySettingsBatchParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
