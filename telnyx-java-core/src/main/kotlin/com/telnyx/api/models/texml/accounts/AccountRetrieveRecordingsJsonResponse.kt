...
class AccountRetrieveRecordingsJsonResponse
...
private constructor(
    ...
    /** A builder for [AccountRetrieveRecordingsJsonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            accountRetrieveRecordingsJsonResponse: AccountRetrieveRecordingsJsonResponse
        ) = apply {
            end = accountRetrieveRecordingsJsonResponse.end
            firstPageUri = accountRetrieveRecordingsJsonResponse.firstPageUri
            nextPageUri = accountRetrieveRecordingsJsonResponse.nextPageUri
            page = accountRetrieveRecordingsJsonResponse.page
            pageSize = accountRetrieveRecordingsJsonResponse.pageSize
            previousPageUri = accountRetrieveRecordingsJsonResponse.previousPageUri
            recordings = accountRetrieveRecordingsJsonResponse.recordings.map { it.toMutableList() }
            start = accountRetrieveRecordingsJsonResponse.start
            uri = accountRetrieveRecordingsJsonResponse.uri
            additionalProperties =
                accountRetrieveRecordingsJsonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountRetrieveRecordingsJsonResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AccountRetrieveRecordingsJsonResponse =
            AccountRetrieveRecordingsJsonResponse(
                end,
                firstPageUri,
                nextPageUri,
    ...
    fun validate(): AccountRetrieveRecordingsJsonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountRetrieveRecordingsJsonResponse &&
            end == other.end &&
    ...
    override fun toString() =
        "AccountRetrieveRecordingsJsonResponse{end=$end, firstPageUri=$firstPageUri, nextPageUri=$nextPageUri, page=$page, pageSize=$pageSize, previousPageUri=$previousPageUri, recordings=$recordings, start=$start, uri=$uri, additionalProperties=$additionalProperties}"
}
