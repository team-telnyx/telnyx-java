...
class RoomParticipantListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RoomParticipantListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [RoomParticipantListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RoomParticipantListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roomParticipantListParams: RoomParticipantListParams) = apply {
            filter = roomParticipantListParams.filter
            page = roomParticipantListParams.page
            additionalHeaders = roomParticipantListParams.additionalHeaders.toBuilder()
            additionalQueryParams = roomParticipantListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RoomParticipantListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RoomParticipantListParams =
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): DateJoinedAt = DateJoinedAt(eq, gte, lte)
            }
            ...
            override fun toString() = "DateJoinedAt{eq=$eq, gte=$gte, lte=$lte}"
        }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): DateLeftAt = DateLeftAt(eq, gte, lte)
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is DateLeftAt && eq == other.eq && gte == other.gte && lte == other.lte
            }
            ...
            override fun toString() = "DateLeftAt{eq=$eq, gte=$gte, lte=$lte}"
        }
        ...
        override fun toString() =
            "Filter{context=$context, dateJoinedAt=$dateJoinedAt, dateLeftAt=$dateLeftAt, dateUpdatedAt=$dateUpdatedAt, sessionId=$sessionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoomParticipantListParams &&
            filter == other.filter &&
            page == other.page &&
    ...
    override fun toString() =
        "RoomParticipantListParams{filter=$filter, page=$page, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
