...
package com.telnyx.api.services.blocking.operatorconnect
...
import com.telnyx.api.models.operatorconnect.actions.ActionRefreshParams
import com.telnyx.api.models.operatorconnect.actions.ActionRefreshResponse
        ...
        override fun refresh(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("operator_connect", "actions", "refresh")
