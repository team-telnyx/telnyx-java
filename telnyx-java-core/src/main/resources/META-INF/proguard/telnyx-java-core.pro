...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.telnyx.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.telnyx.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.telnyx.api.** {
    <init>(...);
