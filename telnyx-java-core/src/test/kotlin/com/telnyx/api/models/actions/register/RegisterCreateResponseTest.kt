...
internal class RegisterCreateResponseTest {

    @Test
    fun create() {
        val registerCreateResponse =
            RegisterCreateResponse.builder()
                .addData(
                ...
                .addError(
                    RegisterCreateResponse.Error.builder()
                        .code("code")
                        .title("title")
                        .detail("detail")
                        .meta(
                            RegisterCreateResponse.Error.Meta.builder()
                                .putAdditionalProperty("foo", JsonValue.from("bar"))
                                .build()
                        )
                        .source(
                            RegisterCreateResponse.Error.Source.builder()
                                .parameter("parameter")
                                .pointer("pointer")
                                .build()
                        )
        ...
        assertThat(registerCreateResponse.data().getOrNull())
            .containsExactly(
                SimpleSimCard.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .actionsInProgress(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedRegisterCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(registerCreateResponse),
                jacksonTypeRef<RegisterCreateResponse>(),
            )

        assertThat(roundtrippedRegisterCreateResponse).isEqualTo(registerCreateResponse)
    }
}
