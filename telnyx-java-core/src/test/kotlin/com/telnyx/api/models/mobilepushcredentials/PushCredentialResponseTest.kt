...
internal class PushCredentialResponseTest {

    @Test
    fun create() {
        val pushCredentialResponse =
            PushCredentialResponse.builder()
                .data(
        ...
        assertThat(pushCredentialResponse.data())
            .contains(
                PushCredential.builder()
                    .id("0ccc7b54-4df3-4bcb-a65a-3da1ecc997d7")
                    .alias("LucyCredential")
    ...
    fun roundtrip() {
        ...
        val roundtrippedPushCredentialResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(pushCredentialResponse),
                jacksonTypeRef<PushCredentialResponse>(),
            )

        assertThat(roundtrippedPushCredentialResponse).isEqualTo(pushCredentialResponse)
    }
}
