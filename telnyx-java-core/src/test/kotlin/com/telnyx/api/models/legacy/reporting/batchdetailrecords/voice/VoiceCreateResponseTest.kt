            ...
            VoiceCreateResponse.builder()
                .data(
                    VoiceCreateResponse.Data.builder()
                        ...
                        .addFilter(
                            VoiceCreateResponse.Data.Filter.builder()
                                .billingGroup("adfaa016-f921-4b6c-97bb-e4c1dad231c5")
                                .cld("+13129457420")
                                .cldFilter(VoiceCreateResponse.Data.Filter.CldFilter.CONTAINS)
                                .cli("+13129457420")
                                .cliFilter(VoiceCreateResponse.Data.Filter.CliFilter.CONTAINS)
                                .filterType(VoiceCreateResponse.Data.Filter.FilterType.AND)
                                .tagsList("tag1")
                                .build()
                        )
