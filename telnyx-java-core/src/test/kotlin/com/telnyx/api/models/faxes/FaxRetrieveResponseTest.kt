...
internal class FaxRetrieveResponseTest {

    @Test
    fun create() {
        val faxRetrieveResponse =
            FaxRetrieveResponse.builder()
                .data(
                    Fax.builder()
        ...
        assertThat(faxRetrieveResponse.data())
            .contains(
                Fax.builder()
                    .id("0ccc7b54-4df3-4bca-a65a-3da1ecc777f0")
                    .clientState("aGF2ZSBhIG5pY2UgZGF5ID1d")
    ...
    fun roundtrip() {
        ...
        val roundtrippedFaxRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(faxRetrieveResponse),
                jacksonTypeRef<FaxRetrieveResponse>(),
            )

        assertThat(roundtrippedFaxRetrieveResponse).isEqualTo(faxRetrieveResponse)
    }
}
