...
internal class AuthenticationProviderDeleteResponseTest {

    @Test
    fun create() {
        val authenticationProviderDeleteResponse =
            AuthenticationProviderDeleteResponse.builder()
                .data(
        ...
        assertThat(authenticationProviderDeleteResponse.data())
            .contains(
                AuthenticationProvider.builder()
                    .id("35146afd-df93-4963-b1e9-1a085e2ae874")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAuthenticationProviderDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(authenticationProviderDeleteResponse),
                jacksonTypeRef<AuthenticationProviderDeleteResponse>(),
            )

        assertThat(roundtrippedAuthenticationProviderDeleteResponse)
            .isEqualTo(authenticationProviderDeleteResponse)
    }
}
