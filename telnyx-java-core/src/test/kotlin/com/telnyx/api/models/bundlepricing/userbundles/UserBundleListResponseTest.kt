...
internal class UserBundleListResponseTest {

    @Test
    fun create() {
        val userBundleListResponse =
            UserBundleListResponse.builder()
                .addData(
                    UserBundle.builder()
        ...
        assertThat(userBundleListResponse.data())
            .containsExactly(
                UserBundle.builder()
                    .id("ca1d2263-d1f1-43ac-ba53-248e7a4bb26a")
                    .active(true)
        ...
        assertThat(userBundleListResponse.meta())
            .isEqualTo(
                PaginationResponse.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserBundleListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userBundleListResponse),
                jacksonTypeRef<UserBundleListResponse>(),
            )

        assertThat(roundtrippedUserBundleListResponse).isEqualTo(userBundleListResponse)
    }
}
