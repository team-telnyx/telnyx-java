...
internal class RoomRetrieveResponseTest {

    @Test
    fun create() {
        val roomRetrieveResponse =
            RoomRetrieveResponse.builder()
                .data(
                    Room.builder()
        ...
        assertThat(roomRetrieveResponse.data())
            .contains(
                Room.builder()
                    .id("7b61621f-62e0-4aad-ab11-9fd19e272e73")
                    .activeSessionId("7b61621f-62e0-4aad-ab11-9fd19e272e74")
    ...
    fun roundtrip() {
        ...
        val roundtrippedRoomRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(roomRetrieveResponse),
                jacksonTypeRef<RoomRetrieveResponse>(),
            )

        assertThat(roundtrippedRoomRetrieveResponse).isEqualTo(roomRetrieveResponse)
    }
}
