...
internal class MessagingHostedNumberOrderRetrieveResponseTest {

    @Test
    fun create() {
        val messagingHostedNumberOrderRetrieveResponse =
            MessagingHostedNumberOrderRetrieveResponse.builder()
                .data(
        ...
        assertThat(messagingHostedNumberOrderRetrieveResponse.data())
            .contains(
                MessagingHostedNumberOrder.builder()
                    .id("86f58db9-0fe3-4adc-9d1f-46e66e6e9323")
                    .messagingProfileId("dc8f39ac-953d-4520-b93b-786ae87db0da")
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingHostedNumberOrderRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingHostedNumberOrderRetrieveResponse),
                jacksonTypeRef<MessagingHostedNumberOrderRetrieveResponse>(),
            )

        assertThat(roundtrippedMessagingHostedNumberOrderRetrieveResponse)
            .isEqualTo(messagingHostedNumberOrderRetrieveResponse)
    }
}
