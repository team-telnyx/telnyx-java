...
internal class AssistantRetrieveResponseTest {

    @Test
    fun create() {
        val assistantRetrieveResponse =
            AssistantRetrieveResponse.builder()
                .id("id")
                ...
                .dynamicVariables(
                    AssistantRetrieveResponse.DynamicVariables.builder()
        ...
        assertThat(assistantRetrieveResponse.id()).isEqualTo("id")
        assertThat(assistantRetrieveResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(assistantRetrieveResponse.instructions()).isEqualTo("instructions")
        assertThat(assistantRetrieveResponse.model()).isEqualTo("model")
        assertThat(assistantRetrieveResponse.name()).isEqualTo("name")
        assertThat(assistantRetrieveResponse.description()).contains("description")
        assertThat(assistantRetrieveResponse.dynamicVariables())
            .contains(
                AssistantRetrieveResponse.DynamicVariables.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
            )
        assertThat(assistantRetrieveResponse.dynamicVariablesWebhookUrl())
            .contains("dynamic_variables_webhook_url")
        assertThat(assistantRetrieveResponse.enabledFeatures().getOrNull())
            .containsExactly(EnabledFeatures.TELEPHONY)
        assertThat(assistantRetrieveResponse.greeting()).contains("greeting")
        assertThat(assistantRetrieveResponse.importMetadata())
            .contains(
                ImportMetadata.builder()
                    .importId("import_id")
                    .importProvider(ImportMetadata.ImportProvider.ELEVENLABS)
        ...
        assertThat(assistantRetrieveResponse.insightSettings())
            .contains(InsightSettings.builder().insightGroupId("insight_group_id").build())
        assertThat(assistantRetrieveResponse.llmApiKeyRef()).contains("llm_api_key_ref")
        assertThat(assistantRetrieveResponse.messagingSettings())
            .contains(
                MessagingSettings.builder()
                    .defaultMessagingProfileId("default_messaging_profile_id")
                    .deliveryStatusWebhookUrl("delivery_status_webhook_url")
        ...
        assertThat(assistantRetrieveResponse.privacySettings())
            .contains(PrivacySettings.builder().dataRetention(true).build())
        assertThat(assistantRetrieveResponse.telephonySettings())
            .contains(
                TelephonySettings.builder()
                    .defaultTexmlAppId("default_texml_app_id")
                    .supportsUnauthenticatedWebCalls(true)
        ...
        assertThat(assistantRetrieveResponse.tools().getOrNull())
            .containsExactly(
        ...
        assertThat(assistantRetrieveResponse.transcription())
            .contains(TranscriptionSettings.builder().language("language").model("model").build())
        assertThat(assistantRetrieveResponse.voiceSettings())
            .contains(
                VoiceSettings.builder()
                    .voice("voice")
                    .apiKeyRef("api_key_ref")
    ...
    fun roundtrip() {
        ...
        val roundtrippedAssistantRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(assistantRetrieveResponse),
                jacksonTypeRef<AssistantRetrieveResponse>(),
            )

        assertThat(roundtrippedAssistantRetrieveResponse).isEqualTo(assistantRetrieveResponse)
    }
}
