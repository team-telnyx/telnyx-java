            ...
            MessagingListResponse.builder()
                .addData(
                    MessagingListResponse.Data.builder()
                        ...
                        .addDirection(MessagingListResponse.Data.Direction.INBOUND)
                        .endDate(OffsetDateTime.parse("2020-07-01T00:00:00-06:00"))
                        .addFilter(
                            MessagingListResponse.Data.Filter.builder()
                                .billingGroup("adfaa016-f921-4b6c-97bb-e4c1dad231c5")
                                .cld("+13129457420")
                                .cldFilter(MessagingListResponse.Data.Filter.CldFilter.CONTAINS)
                                .cli("+13129457420")
                                .cliFilter(MessagingListResponse.Data.Filter.CliFilter.CONTAINS)
                                .filterType(MessagingListResponse.Data.Filter.FilterType.AND)
                                .tagsList("tag1")
                                .build()
                        )
                        ...
                        .addRecordType(MessagingListResponse.Data.RecordType.INCOMPLETE)
                        ...
                        .status(MessagingListResponse.Data.Status.PENDING)
