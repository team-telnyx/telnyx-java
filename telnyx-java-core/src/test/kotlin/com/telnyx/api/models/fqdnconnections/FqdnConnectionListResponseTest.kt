...
internal class FqdnConnectionListResponseTest {

    @Test
    fun create() {
        val fqdnConnectionListResponse =
            FqdnConnectionListResponse.builder()
                .addData(
        ...
        assertThat(fqdnConnectionListResponse.data().getOrNull())
            .containsExactly(
                FqdnConnection.builder()
                    .connectionName("string")
                    .id("id")
        ...
        assertThat(fqdnConnectionListResponse.meta())
            .contains(
                ConnectionsPaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedFqdnConnectionListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fqdnConnectionListResponse),
                jacksonTypeRef<FqdnConnectionListResponse>(),
            )

        assertThat(roundtrippedFqdnConnectionListResponse).isEqualTo(fqdnConnectionListResponse)
    }
}
