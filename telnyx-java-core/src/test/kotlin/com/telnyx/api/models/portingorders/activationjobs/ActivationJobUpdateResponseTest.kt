...
internal class ActivationJobUpdateResponseTest {

    @Test
    fun create() {
        val activationJobUpdateResponse =
            ActivationJobUpdateResponse.builder()
                .data(
        ...
        assertThat(activationJobUpdateResponse.data())
            .contains(
                PortingOrdersActivationJob.builder()
                    .id("f1486bae-f067-460c-ad43-73a92848f902")
                    .activateAt(OffsetDateTime.parse("2021-03-19T10:07:15.527Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedActivationJobUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(activationJobUpdateResponse),
                jacksonTypeRef<ActivationJobUpdateResponse>(),
            )

        assertThat(roundtrippedActivationJobUpdateResponse).isEqualTo(activationJobUpdateResponse)
    }
}
