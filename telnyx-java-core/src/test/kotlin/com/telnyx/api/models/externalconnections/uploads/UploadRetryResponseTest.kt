...
internal class UploadRetryResponseTest {

    @Test
    fun create() {
        val uploadRetryResponse =
            UploadRetryResponse.builder()
                .data(
                    Upload.builder()
        ...
        assertThat(uploadRetryResponse.data())
            .contains(
                Upload.builder()
                    .addAvailableUsage(Upload.AvailableUsage.CALLING_USER_ASSIGNMENT)
                    .errorCode("error_code")
    ...
    fun roundtrip() {
        ...
        val roundtrippedUploadRetryResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(uploadRetryResponse),
                jacksonTypeRef<UploadRetryResponse>(),
            )

        assertThat(roundtrippedUploadRetryResponse).isEqualTo(uploadRetryResponse)
    }
}
