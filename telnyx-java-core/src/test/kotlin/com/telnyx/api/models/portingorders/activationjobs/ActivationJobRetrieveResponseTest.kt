...
internal class ActivationJobRetrieveResponseTest {

    @Test
    fun create() {
        val activationJobRetrieveResponse =
            ActivationJobRetrieveResponse.builder()
                .data(
        ...
        assertThat(activationJobRetrieveResponse.data())
            .contains(
                PortingOrdersActivationJob.builder()
                    .id("f1486bae-f067-460c-ad43-73a92848f902")
                    .activateAt(OffsetDateTime.parse("2021-03-19T10:07:15.527Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedActivationJobRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(activationJobRetrieveResponse),
                jacksonTypeRef<ActivationJobRetrieveResponse>(),
            )

        assertThat(roundtrippedActivationJobRetrieveResponse)
            .isEqualTo(activationJobRetrieveResponse)
    }
}
