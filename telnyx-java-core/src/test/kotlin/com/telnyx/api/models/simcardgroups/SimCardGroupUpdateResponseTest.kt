...
internal class SimCardGroupUpdateResponseTest {

    @Test
    fun create() {
        val simCardGroupUpdateResponse =
            SimCardGroupUpdateResponse.builder()
                .data(
        ...
        assertThat(simCardGroupUpdateResponse.data())
            .contains(
                SimCardGroup.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .consumedData(ConsumedData.builder().amount("2048.1").unit("MB").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedSimCardGroupUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(simCardGroupUpdateResponse),
                jacksonTypeRef<SimCardGroupUpdateResponse>(),
            )

        assertThat(roundtrippedSimCardGroupUpdateResponse).isEqualTo(simCardGroupUpdateResponse)
    }
}
