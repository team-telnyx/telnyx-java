...
internal class SessionList1ResponseTest {

    @Test
    fun create() {
        val sessionList1Response =
            SessionList1Response.builder()
                .addData(
                    RoomSession.builder()
        ...
        assertThat(sessionList1Response.data().getOrNull())
            .containsExactly(
                RoomSession.builder()
                    .id("7b61621f-62e0-4aad-ab11-9fd19e272e73")
                    .active(false)
        ...
        assertThat(sessionList1Response.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSessionList1Response =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(sessionList1Response),
                jacksonTypeRef<SessionList1Response>(),
            )

        assertThat(roundtrippedSessionList1Response).isEqualTo(sessionList1Response)
    }
}
