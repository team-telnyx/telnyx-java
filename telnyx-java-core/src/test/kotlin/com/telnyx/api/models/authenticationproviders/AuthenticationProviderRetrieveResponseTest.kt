...
internal class AuthenticationProviderRetrieveResponseTest {

    @Test
    fun create() {
        val authenticationProviderRetrieveResponse =
            AuthenticationProviderRetrieveResponse.builder()
                .data(
        ...
        assertThat(authenticationProviderRetrieveResponse.data())
            .contains(
                AuthenticationProvider.builder()
                    .id("35146afd-df93-4963-b1e9-1a085e2ae874")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAuthenticationProviderRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(authenticationProviderRetrieveResponse),
                jacksonTypeRef<AuthenticationProviderRetrieveResponse>(),
            )

        assertThat(roundtrippedAuthenticationProviderRetrieveResponse)
            .isEqualTo(authenticationProviderRetrieveResponse)
    }
}
