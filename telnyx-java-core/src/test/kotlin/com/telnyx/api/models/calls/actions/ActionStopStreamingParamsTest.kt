...
internal class ActionStopStreamingParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = ActionStopStreamingParams.builder().callControlId("call_control_id").build()
    ...
    fun body() {
        ...
        assertThat(body.streamId()).contains("1edb94f9-7ef0-4150-b502-e0ebadfd9491")
    }
