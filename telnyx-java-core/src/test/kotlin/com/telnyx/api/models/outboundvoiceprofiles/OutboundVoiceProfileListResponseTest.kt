...
internal class OutboundVoiceProfileListResponseTest {

    @Test
    fun create() {
        val outboundVoiceProfileListResponse =
            OutboundVoiceProfileListResponse.builder()
                .addData(
        ...
        assertThat(outboundVoiceProfileListResponse.data().getOrNull())
            .containsExactly(
                OutboundVoiceProfile.builder()
                    .name("office")
                    .id("1293384261075731499")
        ...
        assertThat(outboundVoiceProfileListResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedOutboundVoiceProfileListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(outboundVoiceProfileListResponse),
                jacksonTypeRef<OutboundVoiceProfileListResponse>(),
            )

        assertThat(roundtrippedOutboundVoiceProfileListResponse)
            .isEqualTo(outboundVoiceProfileListResponse)
    }
}
