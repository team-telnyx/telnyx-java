...
internal class PortoutReportTest {
    ...
    fun create() {
        ...
        assertThat(portoutReport.id()).contains("eef3340b-8903-4466-b445-89b697315a3a")
        assertThat(portoutReport.createdAt())
            .contains(OffsetDateTime.parse("2021-03-19T10:07:15.527000Z"))
        assertThat(portoutReport.documentId()).contains("f1486bae-f067-460c-ad43-73a92848f902")
        assertThat(portoutReport.params())
            .contains(
                ExportPortoutsCsvReport.builder()
                    .filters(
                        ExportPortoutsCsvReport.Filters.builder()
        ...
        assertThat(portoutReport.recordType()).contains("portout_report")
        assertThat(portoutReport.reportType())
            .contains(PortoutReport.ReportType.EXPORT_PORTOUTS_CSV)
        assertThat(portoutReport.status()).contains(PortoutReport.Status.COMPLETED)
        assertThat(portoutReport.updatedAt())
            .contains(OffsetDateTime.parse("2021-03-19T10:07:15.527000Z"))
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPortoutReport =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(portoutReport),
                jacksonTypeRef<PortoutReport>(),
            )

        assertThat(roundtrippedPortoutReport).isEqualTo(portoutReport)
    }
}
