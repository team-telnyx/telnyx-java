...
internal class NumberOrderCreateResponseTest {

    @Test
    fun create() {
        val numberOrderCreateResponse =
            NumberOrderCreateResponse.builder()
                .data(
        ...
        assertThat(numberOrderCreateResponse.data())
            .contains(
                NumberOrderWithPhoneNumbers.builder()
                    .id("12ade33a-21c0-473b-b055-b3c836e1c292")
                    .billingGroupId("abc85f64-5717-4562-b3fc-2c9600")
    ...
    fun roundtrip() {
        ...
        val roundtrippedNumberOrderCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(numberOrderCreateResponse),
                jacksonTypeRef<NumberOrderCreateResponse>(),
            )

        assertThat(roundtrippedNumberOrderCreateResponse).isEqualTo(numberOrderCreateResponse)
    }
}
