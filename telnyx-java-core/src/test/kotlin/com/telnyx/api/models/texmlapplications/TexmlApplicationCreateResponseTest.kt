...
internal class TexmlApplicationCreateResponseTest {

    @Test
    fun create() {
        val texmlApplicationCreateResponse =
            TexmlApplicationCreateResponse.builder()
                .data(
        ...
        assertThat(texmlApplicationCreateResponse.data())
            .contains(
                TexmlApplication.builder()
                    .id("1293384261075731499")
                    .active(false)
    ...
    fun roundtrip() {
        ...
        val roundtrippedTexmlApplicationCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(texmlApplicationCreateResponse),
                jacksonTypeRef<TexmlApplicationCreateResponse>(),
            )

        assertThat(roundtrippedTexmlApplicationCreateResponse)
            .isEqualTo(texmlApplicationCreateResponse)
    }
}
