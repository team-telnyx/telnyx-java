...
internal class FaxListResponseTest {

    @Test
    fun create() {
        val faxListResponse =
            FaxListResponse.builder()
                .addData(
                    Fax.builder()
        ...
        assertThat(faxListResponse.data().getOrNull())
            .containsExactly(
                Fax.builder()
                    .id("0ccc7b54-4df3-4bca-a65a-3da1ecc777f0")
                    .clientState("aGF2ZSBhIG5pY2UgZGF5ID1d")
        ...
        assertThat(faxListResponse._meta())
            .isEqualTo(
                JsonValue.from(
                    mapOf(
                        "page_number" to 2,
    ...
    fun roundtrip() {
        ...
        val roundtrippedFaxListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(faxListResponse),
                jacksonTypeRef<FaxListResponse>(),
            )

        assertThat(roundtrippedFaxListResponse).isEqualTo(faxListResponse)
    }
}
