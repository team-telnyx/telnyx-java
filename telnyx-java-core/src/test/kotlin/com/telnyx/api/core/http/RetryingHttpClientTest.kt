package com.telnyx.api.core.http

import com.github.tomakehurst.wiremock.client.WireMock.*
import com.github.tomakehurst.wiremock.junit5.WireMockRuntimeInfo
import com.github.tomakehurst.wiremock.junit5.WireMockTest
import com.github.tomakehurst.wiremock.stubbing.Scenario
import com.telnyx.api.client.okhttp.OkHttpClient
import com.telnyx.api.core.RequestOptions
import com.telnyx.api.core.Sleeper
import com.telnyx.api.errors.TelnyxRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw TelnyxRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            TelnyxRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
