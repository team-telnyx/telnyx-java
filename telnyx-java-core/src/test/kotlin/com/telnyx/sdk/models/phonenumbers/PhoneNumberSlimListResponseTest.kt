    ...
    fun create() {
        val phoneNumberSlimListResponse =
            PhoneNumberSlimListResponse.builder()
                .addData(
                    PhoneNumberSlimListResponse.Data.builder()
                        ...
                        .emergencyStatus(PhoneNumberSlimListResponse.Data.EmergencyStatus.ACTIVE)
                        .externalPin("1234")
                        .inboundCallScreening(
                            PhoneNumberSlimListResponse.Data.InboundCallScreening.DISABLED
                        )
                        .phoneNumber("+19705555098")
                        .phoneNumberType(PhoneNumberSlimListResponse.Data.PhoneNumberType.LOCAL)
                        .purchasedAt("2019-10-23T18:10:00.000Z")
                        .recordType("phone_number")
                        .status(PhoneNumberSlimListResponse.Data.Status.ACTIVE)
        ...
        assertThat(phoneNumberSlimListResponse.data().getOrNull())
            .containsExactly(
                PhoneNumberSlimListResponse.Data.builder()
                    .id("1293384261075731499")
                    .billingGroupId("86f58db9-0fe3-4adc-9d1f-46e66e6e9323")
        ...
        assertThat(phoneNumberSlimListResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
