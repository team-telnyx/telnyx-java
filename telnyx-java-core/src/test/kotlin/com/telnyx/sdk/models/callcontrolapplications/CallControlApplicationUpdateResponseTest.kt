...
internal class CallControlApplicationUpdateResponseTest {

    @Test
    fun create() {
        val callControlApplicationUpdateResponse =
            CallControlApplicationUpdateResponse.builder()
                .data(
        ...
        assertThat(callControlApplicationUpdateResponse.data())
            .contains(
                CallControlApplication.builder()
                    .id("id")
                    .active(false)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCallControlApplicationUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(callControlApplicationUpdateResponse),
                jacksonTypeRef<CallControlApplicationUpdateResponse>(),
            )

        assertThat(roundtrippedCallControlApplicationUpdateResponse)
            .isEqualTo(callControlApplicationUpdateResponse)
    }
}
