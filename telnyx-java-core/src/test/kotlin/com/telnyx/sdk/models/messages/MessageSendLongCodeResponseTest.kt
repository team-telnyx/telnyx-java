...
internal class MessageSendLongCodeResponseTest {

    @Test
    fun create() {
        val messageSendLongCodeResponse =
            MessageSendLongCodeResponse.builder()
                .data(
        ...
        assertThat(messageSendLongCodeResponse.data())
            .contains(
                OutboundMessagePayload.builder()
                    .id("40385f64-5717-4562-b3fc-2c963f66afa6")
                    .completedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessageSendLongCodeResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messageSendLongCodeResponse),
                jacksonTypeRef<MessageSendLongCodeResponse>(),
            )

        assertThat(roundtrippedMessageSendLongCodeResponse).isEqualTo(messageSendLongCodeResponse)
    }
}
