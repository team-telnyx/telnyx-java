...
internal class AuthenticationProviderCreateResponseTest {

    @Test
    fun create() {
        val authenticationProviderCreateResponse =
            AuthenticationProviderCreateResponse.builder()
                .data(
        ...
        assertThat(authenticationProviderCreateResponse.data())
            .contains(
                AuthenticationProvider.builder()
                    .id("35146afd-df93-4963-b1e9-1a085e2ae874")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAuthenticationProviderCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(authenticationProviderCreateResponse),
                jacksonTypeRef<AuthenticationProviderCreateResponse>(),
            )

        assertThat(roundtrippedAuthenticationProviderCreateResponse)
            .isEqualTo(authenticationProviderCreateResponse)
    }
}
