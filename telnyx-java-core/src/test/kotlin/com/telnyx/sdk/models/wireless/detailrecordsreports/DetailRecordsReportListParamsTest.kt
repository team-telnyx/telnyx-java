...
internal class DetailRecordsReportListParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = DetailRecordsReportListParams.builder().pageNumber(1L).pageSize(1L).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = DetailRecordsReportListParams.builder().build()
