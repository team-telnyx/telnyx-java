...
internal class DirSubmitResponseTest {

    @Test
    fun create() {
        val dirSubmitResponse =
            DirSubmitResponse.builder()
                .data(
                    DirSubmitResponse.Data.builder()
                        .id("16635d38-75a6-4481-82e8-69af60e05011")
                        .authorizerEmail("sam@acmeplumbing.example.com")
                        .authorizerName("Sam Owner")
                        .addCallReason(
                            DirSubmitResponse.Data.CallReason.builder()
                        ...
                        .addDocument(
                            DirSubmitResponse.Data.Document.builder()
                                .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                                .documentType(
                                    DirSubmitResponse.Data.Document.DocumentType
                        ...
                        .addRejectionReason(
                            DirSubmitResponse.Data.RejectionReason.builder()
                        ...
                        .reselling(false)
                        .status(DirSubmitResponse.Data.Status.DRAFT)
        ...
        assertThat(dirSubmitResponse.data())
            .isEqualTo(
                DirSubmitResponse.Data.builder()
                    .id("16635d38-75a6-4481-82e8-69af60e05011")
                    .authorizerEmail("sam@acmeplumbing.example.com")
                    ...
                    .addDocument(
                        DirSubmitResponse.Data.Document.builder()
                            .documentId("2a7e8337-e803-4057-a4ae-26c40eb0bc6c")
                            .documentType(
                                DirSubmitResponse.Data.Document.DocumentType.BUSINESS_REGISTRATION
                            )
                            .description("Certificate of incorporation.")
                            .build()
                    )
    ...
    fun roundtrip() {
        ...
        val roundtrippedDirSubmitResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(dirSubmitResponse),
                jacksonTypeRef<DirSubmitResponse>(),
            )

        assertThat(roundtrippedDirSubmitResponse).isEqualTo(dirSubmitResponse)
    }
}
