...
internal class CredentialConnectionListResponseTest {

    @Test
    fun create() {
        val credentialConnectionListResponse =
            CredentialConnectionListResponse.builder()
                .addData(
        ...
        assertThat(credentialConnectionListResponse.data().getOrNull())
            .containsExactly(
                CredentialConnection.builder()
                    .id("id")
                    .active(true)
        ...
        assertThat(credentialConnectionListResponse.meta())
            .contains(
                ConnectionsPaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedCredentialConnectionListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(credentialConnectionListResponse),
                jacksonTypeRef<CredentialConnectionListResponse>(),
            )

        assertThat(roundtrippedCredentialConnectionListResponse)
            .isEqualTo(credentialConnectionListResponse)
    }
}
