...
internal class SimCardDeleteResponseTest {

    @Test
    fun create() {
        val simCardDeleteResponse =
            SimCardDeleteResponse.builder()
                .data(
                    SimCard.builder()
        ...
        assertThat(simCardDeleteResponse.data())
            .contains(
                SimCard.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .actionsInProgress(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSimCardDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(simCardDeleteResponse),
                jacksonTypeRef<SimCardDeleteResponse>(),
            )

        assertThat(roundtrippedSimCardDeleteResponse).isEqualTo(simCardDeleteResponse)
    }
}
