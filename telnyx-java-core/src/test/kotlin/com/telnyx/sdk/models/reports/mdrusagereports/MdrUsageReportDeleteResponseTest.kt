...
internal class MdrUsageReportDeleteResponseTest {

    @Test
    fun create() {
        val mdrUsageReportDeleteResponse =
            MdrUsageReportDeleteResponse.builder()
                .data(
        ...
        assertThat(mdrUsageReportDeleteResponse.data())
            .contains(
                MdrUsageReport.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .aggregationType(MdrUsageReport.AggregationType.NO_AGGREGATION)
    ...
    fun roundtrip() {
        ...
        val roundtrippedMdrUsageReportDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(mdrUsageReportDeleteResponse),
                jacksonTypeRef<MdrUsageReportDeleteResponse>(),
            )

        assertThat(roundtrippedMdrUsageReportDeleteResponse).isEqualTo(mdrUsageReportDeleteResponse)
    }
}
