...
internal class NotificationSettingDeleteResponseTest {

    @Test
    fun create() {
        val notificationSettingDeleteResponse =
            NotificationSettingDeleteResponse.builder()
                .data(
        ...
        assertThat(notificationSettingDeleteResponse.data())
            .contains(
                NotificationSetting.builder()
                    .id("8eb5b5f9-5893-423c-9f15-b487713d44d4")
                    .associatedRecordType("phone_number")
    ...
    fun roundtrip() {
        ...
        val roundtrippedNotificationSettingDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(notificationSettingDeleteResponse),
                jacksonTypeRef<NotificationSettingDeleteResponse>(),
            )

        assertThat(roundtrippedNotificationSettingDeleteResponse)
            .isEqualTo(notificationSettingDeleteResponse)
    }
}
