...
internal class MessagingHostedNumberListPageResponseTest {

    @Test
    fun create() {
        val messagingHostedNumberListPageResponse =
            MessagingHostedNumberListPageResponse.builder()
                .addData(
        ...
        assertThat(messagingHostedNumberListPageResponse.data().getOrNull())
            .containsExactly(
                PhoneNumberWithMessagingSettings.builder()
                    .id("1293384261075731499")
                    .countryCode("US")
        ...
        assertThat(messagingHostedNumberListPageResponse.meta())
            .contains(
                MessagingPaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessagingHostedNumberListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messagingHostedNumberListPageResponse),
                jacksonTypeRef<MessagingHostedNumberListPageResponse>(),
            )

        assertThat(roundtrippedMessagingHostedNumberListPageResponse)
            .isEqualTo(messagingHostedNumberListPageResponse)
    }
}
