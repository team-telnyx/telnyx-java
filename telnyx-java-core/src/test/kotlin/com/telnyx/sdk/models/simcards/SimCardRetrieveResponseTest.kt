...
internal class SimCardRetrieveResponseTest {

    @Test
    fun create() {
        val simCardRetrieveResponse =
            SimCardRetrieveResponse.builder()
                .data(
                    SimCard.builder()
        ...
        assertThat(simCardRetrieveResponse.data())
            .contains(
                SimCard.builder()
                    .id("6a09cdc3-8948-47f0-aa62-74ac943d6c58")
                    .actionsInProgress(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedSimCardRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(simCardRetrieveResponse),
                jacksonTypeRef<SimCardRetrieveResponse>(),
            )

        assertThat(roundtrippedSimCardRetrieveResponse).isEqualTo(simCardRetrieveResponse)
    }
}
