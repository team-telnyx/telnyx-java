...
internal class JobDeleteBatchResponseTest {

    @Test
    fun create() {
        val jobDeleteBatchResponse =
            JobDeleteBatchResponse.builder()
                .data(
        ...
        assertThat(jobDeleteBatchResponse.data())
            .contains(
                PhoneNumbersJob.builder()
                    .id("42587e44-3a3e-46de-9255-0c9a7a1d1ec7")
                    .createdAt("2020-10-23T18:10:00.000Z")
    ...
    fun roundtrip() {
        ...
        val roundtrippedJobDeleteBatchResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(jobDeleteBatchResponse),
                jacksonTypeRef<JobDeleteBatchResponse>(),
            )

        assertThat(roundtrippedJobDeleteBatchResponse).isEqualTo(jobDeleteBatchResponse)
    }
}
