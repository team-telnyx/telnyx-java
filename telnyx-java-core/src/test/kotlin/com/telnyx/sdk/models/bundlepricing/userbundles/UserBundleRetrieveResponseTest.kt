...
internal class UserBundleRetrieveResponseTest {

    @Test
    fun create() {
        val userBundleRetrieveResponse =
            UserBundleRetrieveResponse.builder()
                .data(
                    UserBundle.builder()
        ...
        assertThat(userBundleRetrieveResponse.data())
            .isEqualTo(
                UserBundle.builder()
                    .id("ca1d2263-d1f1-43ac-ba53-248e7a4bb26a")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserBundleRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userBundleRetrieveResponse),
                jacksonTypeRef<UserBundleRetrieveResponse>(),
            )

        assertThat(roundtrippedUserBundleRetrieveResponse).isEqualTo(userBundleRetrieveResponse)
    }
}
