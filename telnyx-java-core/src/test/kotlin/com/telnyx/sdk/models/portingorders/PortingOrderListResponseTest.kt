...
internal class PortingOrderListResponseTest {

    @Test
    fun create() {
        val portingOrderListResponse =
            PortingOrderListResponse.builder()
                .addData(
        ...
        assertThat(portingOrderListResponse.data().getOrNull())
            .containsExactly(
                PortingOrder.builder()
                    .id("f1486bae-f067-460c-ad43-73a92848f902")
                    .activationSettings(
        ...
        assertThat(portingOrderListResponse.meta())
            .contains(
                PaginationMeta.builder()
                    .pageNumber(2L)
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPortingOrderListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(portingOrderListResponse),
                jacksonTypeRef<PortingOrderListResponse>(),
            )

        assertThat(roundtrippedPortingOrderListResponse).isEqualTo(portingOrderListResponse)
    }
}
