...
internal class VerifyEmailSendCodeParamsTest {

    @Test
    fun create() {
        VerifyEmailSendCodeParams.builder().dirId("16635d38-75a6-4481-82e8-69af60e05011").build()
    }

    @Test
    fun pathParams() {
        val params =
            VerifyEmailSendCodeParams.builder()
