...
internal class PhoneNumberBlockDeleteResponseTest {

    @Test
    fun create() {
        val phoneNumberBlockDeleteResponse =
            PhoneNumberBlockDeleteResponse.builder()
                .data(
        ...
        assertThat(phoneNumberBlockDeleteResponse.data())
            .contains(
                PortingPhoneNumberBlock.builder()
                    .id("f24151b6-3389-41d3-8747-7dd8c681e5e2")
                    .addActivationRange(
    ...
    fun roundtrip() {
        ...
        val roundtrippedPhoneNumberBlockDeleteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(phoneNumberBlockDeleteResponse),
                jacksonTypeRef<PhoneNumberBlockDeleteResponse>(),
            )

        assertThat(roundtrippedPhoneNumberBlockDeleteResponse)
            .isEqualTo(phoneNumberBlockDeleteResponse)
    }
}
