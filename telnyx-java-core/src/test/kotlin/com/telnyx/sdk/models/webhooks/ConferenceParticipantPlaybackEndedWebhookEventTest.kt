...
internal class ConferenceParticipantPlaybackEndedWebhookEventTest {

    @Test
    fun create() {
        val conferenceParticipantPlaybackEndedWebhookEvent =
        ...
        assertThat(conferenceParticipantPlaybackEndedWebhookEvent.data())
            .contains(
                ConferenceParticipantPlaybackEndedWebhookEvent.Data.builder()
                    .id("0ccc7b54-4df3-4bca-a65a-3da1ecc777f0")
                    .eventType(
    ...
    fun roundtrip() {
        ...
        val roundtrippedConferenceParticipantPlaybackEndedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(conferenceParticipantPlaybackEndedWebhookEvent),
                jacksonTypeRef<ConferenceParticipantPlaybackEndedWebhookEvent>(),
            )

        assertThat(roundtrippedConferenceParticipantPlaybackEndedWebhookEvent)
            .isEqualTo(conferenceParticipantPlaybackEndedWebhookEvent)
    }
}
