...
internal class LoaConfigurationRetrieveResponseTest {

    @Test
    fun create() {
        val loaConfigurationRetrieveResponse =
            LoaConfigurationRetrieveResponse.builder()
                .data(
        ...
        assertThat(loaConfigurationRetrieveResponse.data())
            .contains(
                PortingLoaConfiguration.builder()
                    .id("eef3340b-8903-4466-b445-89b697315a3a")
                    .address(
    ...
    fun roundtrip() {
        ...
        val roundtrippedLoaConfigurationRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(loaConfigurationRetrieveResponse),
                jacksonTypeRef<LoaConfigurationRetrieveResponse>(),
            )

        assertThat(roundtrippedLoaConfigurationRetrieveResponse)
            .isEqualTo(loaConfigurationRetrieveResponse)
    }
}
