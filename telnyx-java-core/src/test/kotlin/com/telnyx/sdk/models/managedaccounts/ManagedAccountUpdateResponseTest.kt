...
internal class ManagedAccountUpdateResponseTest {

    @Test
    fun create() {
        val managedAccountUpdateResponse =
            ManagedAccountUpdateResponse.builder()
                .data(
        ...
        assertThat(managedAccountUpdateResponse.data())
            .contains(
                ManagedAccount.builder()
                    .id("f65ceda4-6522-4ad6-aede-98de83385123")
                    .apiKey("KEY01236170692E74656C6E79782E636F6D_YmlnIGlyb24gaXMgZGVhZA")
    ...
    fun roundtrip() {
        ...
        val roundtrippedManagedAccountUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(managedAccountUpdateResponse),
                jacksonTypeRef<ManagedAccountUpdateResponse>(),
            )

        assertThat(roundtrippedManagedAccountUpdateResponse).isEqualTo(managedAccountUpdateResponse)
    }
}
