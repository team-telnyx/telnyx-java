...
internal class UserBundleCreateResponseTest {

    @Test
    fun create() {
        val userBundleCreateResponse =
            UserBundleCreateResponse.builder()
                .addData(
                    UserBundle.builder()
        ...
        assertThat(userBundleCreateResponse.data())
            .containsExactly(
                UserBundle.builder()
                    .id("ca1d2263-d1f1-43ac-ba53-248e7a4bb26a")
                    .active(true)
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserBundleCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userBundleCreateResponse),
                jacksonTypeRef<UserBundleCreateResponse>(),
            )

        assertThat(roundtrippedUserBundleCreateResponse).isEqualTo(userBundleCreateResponse)
    }
}
