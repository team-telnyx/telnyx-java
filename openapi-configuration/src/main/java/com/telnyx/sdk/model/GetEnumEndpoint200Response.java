...
public class GetEnumEndpoint200Response extends AbstractOpenApiSchema {
    ...
    public static class GetEnumEndpoint200ResponseDeserializer extends StdDeserializer<GetEnumEndpoint200Response> {
        ...
        public GetEnumEndpoint200Response deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (List<EnumListResponseInner>.class.equals(Integer.class) || List<EnumListResponseInner>.class.equals(Long.class) || List<EnumListResponseInner>.class.equals(Float.class) || List<EnumListResponseInner>.class.equals(Double.class) || List<EnumListResponseInner>.class.equals(Boolean.class) || List<EnumListResponseInner>.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((List<EnumListResponseInner>.class.equals(Integer.class) || List<EnumListResponseInner>.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((List<EnumListResponseInner>.class.equals(Float.class) || List<EnumListResponseInner>.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (List<EnumListResponseInner>.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (List<EnumListResponseInner>.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(List<EnumListResponseInner>.class);
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(List<EnumListResponseInner>.class, instance, new HashSet<Class<?>>())) {
     ...
     */
    public List<EnumListResponseInner> getList<EnumListResponseInner>() throws ClassCastException {
