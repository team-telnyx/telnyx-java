 ...
 */
@ApiModel(description = "Compose and send a message to a destination predefined by chatbot.")
@JsonPropertyOrder({
...
public class RCSComposeAction {
  ...
  public static final String JSON_PROPERTY_COMPOSE_RECORDING_MESSAGE = "compose_recording_message";
  private RCSComposeRecordingMessage composeRecordingMessage;

  public RCSComposeAction() { 
  }

  public RCSComposeAction composeTextMessage(RCSComposeTextMessage composeTextMessage) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_COMPOSE_TEXT_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComposeTextMessage(RCSComposeTextMessage composeTextMessage) {
    this.composeTextMessage = composeTextMessage;
  }


  public RCSComposeAction composeRecordingMessage(RCSComposeRecordingMessage composeRecordingMessage) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_COMPOSE_RECORDING_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComposeRecordingMessage(RCSComposeRecordingMessage composeRecordingMessage) {
    this.composeRecordingMessage = composeRecordingMessage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.composeTextMessage, rcSComposeAction.composeTextMessage) &&
        Objects.equals(this.composeRecordingMessage, rcSComposeAction.composeRecordingMessage);
  }
