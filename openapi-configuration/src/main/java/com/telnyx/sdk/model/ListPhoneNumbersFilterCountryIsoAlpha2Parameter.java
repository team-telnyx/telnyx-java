...
public class ListPhoneNumbersFilterCountryIsoAlpha2Parameter extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ListPhoneNumbersFilterCountryIsoAlpha2Parameter.class.getName());

    public static class ListPhoneNumbersFilterCountryIsoAlpha2ParameterSerializer extends StdSerializer<ListPhoneNumbersFilterCountryIsoAlpha2Parameter> {
        public ListPhoneNumbersFilterCountryIsoAlpha2ParameterSerializer(Class<ListPhoneNumbersFilterCountryIsoAlpha2Parameter> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(ListPhoneNumbersFilterCountryIsoAlpha2Parameter value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ListPhoneNumbersFilterCountryIsoAlpha2ParameterDeserializer extends StdDeserializer<ListPhoneNumbersFilterCountryIsoAlpha2Parameter> {
        ...
        public ListPhoneNumbersFilterCountryIsoAlpha2ParameterDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ListPhoneNumbersFilterCountryIsoAlpha2Parameter deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                ListPhoneNumbersFilterCountryIsoAlpha2Parameter ret = new ListPhoneNumbersFilterCountryIsoAlpha2Parameter();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for ListPhoneNumbersFilterCountryIsoAlpha2Parameter: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ListPhoneNumbersFilterCountryIsoAlpha2Parameter getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ListPhoneNumbersFilterCountryIsoAlpha2Parameter cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(ListPhoneNumbersFilterCountryIsoAlpha2Parameter.class, Collections.unmodifiableMap(schemas));
    }
