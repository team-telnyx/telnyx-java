...
import com.telnyx.sdk.models.webhooks.CallAiGatherEnded
...
internal class ProGuardCompatibilityTest {
    ...
    fun client() {
        ...
        assertThat(client.emailBlocks()).isNotNull()
        assertThat(client.emailDomains()).isNotNull()
        assertThat(client.emailEvents()).isNotNull()
        assertThat(client.emailInboxes()).isNotNull()
        assertThat(client.emailMessages()).isNotNull()
        assertThat(client.emailTemplates()).isNotNull()
