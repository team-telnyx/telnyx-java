...
[![Maven Central](https://img.shields.io/maven-central/v/com.telnyx.sdk/telnyx)](https://central.sonatype.com/artifact/com.telnyx.sdk/telnyx/6.19.0)
...
```kotlin
implementation("com.telnyx.sdk:telnyx:6.19.0")
```
