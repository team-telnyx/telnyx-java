...
[![Maven Central](https://img.shields.io/maven-central/v/com.telnyx.sdk/telnyx)](https://central.sonatype.com/artifact/com.telnyx.sdk/telnyx/6.57.1)
...
```kotlin
implementation("com.telnyx.sdk:telnyx:6.57.1")
```
