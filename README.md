...
[![Maven Central](https://img.shields.io/maven-central/v/com.telnyx.sdk/telnyx-java)](https://central.sonatype.com/artifact/com.telnyx.sdk/telnyx-java/6.75.0)
[![javadoc](https://javadoc.io/badge2/com.telnyx.sdk/telnyx-java/6.75.0/javadoc.svg)](https://javadoc.io/doc/com.telnyx.sdk/telnyx-java/6.75.0)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.telnyx.sdk/telnyx-java/6.75.0).
...
```kotlin
implementation("com.telnyx.sdk:telnyx-java:6.75.0")
```
...
When using the asynchronous client, the method returns an [`AsyncStreamResponse`](telnyx-java-core/src/main/kotlin/com/telnyx/sdk/core/http/AsyncStreamResponse.kt):
