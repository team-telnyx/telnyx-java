...
dependencies {
    testImplementation(project(":telnyx-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../telnyx-java-core/src/main/resources/META-INF/proguard/telnyx-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.telnyx.sdk.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../telnyx-java-core/src/main/resources/META-INF/proguard/telnyx-java-core.pro",
