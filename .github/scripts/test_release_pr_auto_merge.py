...
class ReleasePRAutoMergeGateTests(unittest.TestCase):
    ...
    def test_config_inventory_contains_exactly_the_seven_authorized_sdk_repositories(self):
        ...
        java = GateConfig.for_repository("team-telnyx/telnyx-java")
        self.assertEqual(
            java.release_files,
            frozenset({
                "CHANGELOG.md",
        ...
        self.assertEqual(
            set(java.expected_checks),
            {
                "build", "lint", "test", "protected-paths", "release doctor",
                "Analyze (actions)", "Analyze (java-kotlin)", "CodeQL",
            },
        )
