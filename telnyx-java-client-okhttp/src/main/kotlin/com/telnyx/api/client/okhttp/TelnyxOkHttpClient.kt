...
import com.telnyx.api.client.TelnyxClientImpl
...
/**
 * A class that allows building an instance of [TelnyxClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class TelnyxOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [TelnyxClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): TelnyxClient = builder().fromEnv().build()
    }

    /** A builder for [TelnyxOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TelnyxClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TelnyxClient =
            TelnyxClientImpl(
                clientOptions
                    .httpClient(
