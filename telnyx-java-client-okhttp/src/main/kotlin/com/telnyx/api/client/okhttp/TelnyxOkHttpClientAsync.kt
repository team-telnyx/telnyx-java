...
package com.telnyx.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.telnyx.api.client.TelnyxClientAsync
import com.telnyx.api.client.TelnyxClientAsyncImpl
import com.telnyx.api.core.ClientOptions
import com.telnyx.api.core.Sleeper
import com.telnyx.api.core.Timeout
import com.telnyx.api.core.http.Headers
import com.telnyx.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [TelnyxClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class TelnyxOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [TelnyxClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): TelnyxClientAsync = builder().fromEnv().build()
    }

    /** A builder for [TelnyxOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.telnyx.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [TelnyxClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TelnyxClientAsync =
            TelnyxClientAsyncImpl(
                clientOptions
                    .httpClient(
