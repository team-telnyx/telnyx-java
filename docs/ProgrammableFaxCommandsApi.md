...
> InlineResponse2001 listFaxes(filterCreatedAtGte, filterCreatedAtGt, filterCreatedAtLte, filterCreatedAtLt, filterDirectionEq, filterFromEq, pageSize, pageNumber)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            InlineResponse2001 result = apiInstance.listFaxes(filterCreatedAtGte, filterCreatedAtGt, filterCreatedAtLte, filterCreatedAtLt, filterDirectionEq, filterFromEq, pageSize, pageNumber);
...
> InlineResponse202 sendFax(sendFaxRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            InlineResponse202 result = apiInstance.sendFax(sendFaxRequest);
            System.out.println(result);
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        UUID id = new UUID(); // UUID | The unique identifier of a fax.
        try {
            InlineResponse202 result = apiInstance.viewFax(id);
            System.out.println(result);
        } catch (ApiException e) {
