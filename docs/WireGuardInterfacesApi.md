...
> CreateWireguardPeer202Response createWireguardPeer(wireguardPeerCreate)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CreateWireguardPeer202Response result = apiInstance.createWireguardPeer(wireguardPeerCreate);
            System.out.println(result);
        } catch (ApiException e) {
